...
+ (NSString *)getMessageWithRetrofit2Response:(Retrofit2Response *)response;
...
NSString *Retrofit2HttpException_getMessageWithRetrofit2Response_(Retrofit2Response *response) {
  ...
  return JreStrcat("$IC$", @"HTTP ", [response code], ' ', [response message]);
}

void Retrofit2HttpException_initWithRetrofit2Response_(Retrofit2HttpException *self, Retrofit2Response *response) {
  JavaLangException_initWithNSString_(self, Retrofit2HttpException_getMessageWithRetrofit2Response_(response));
