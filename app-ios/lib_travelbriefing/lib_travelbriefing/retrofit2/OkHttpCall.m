...
//  source: ../target/dependency/retrofit2/OkHttpCall.java
//
...
J2OBJC_FIELD_SETTER(Retrofit2OkHttpCall, creationFailure_, NSException *)
...
- (instancetype)initWithRetrofit2OkHttpCall:(Retrofit2OkHttpCall *)outer$
                      withRetrofit2Callback:(id<Retrofit2Callback>)capture$0;
...
- (void)callFailureWithNSException:(NSException *)e;

- (void)callSuccessWithRetrofit2Response:(Retrofit2Response *)response;
...
__attribute__((unused)) static void Retrofit2OkHttpCall_1_callFailureWithNSException_(Retrofit2OkHttpCall_1 *self, NSException *e);
...
- (instancetype)initWithRetrofit2OkHttpCall_ExceptionCatchingRequestBody:(Retrofit2OkHttpCall_ExceptionCatchingRequestBody *)outer$
...
__attribute__((unused)) static void Retrofit2OkHttpCall_ExceptionCatchingRequestBody_1_initWithRetrofit2OkHttpCall_ExceptionCatchingRequestBody_withOkioSource_(Retrofit2OkHttpCall_ExceptionCatchingRequestBody_1 *self, Retrofit2OkHttpCall_ExceptionCatchingRequestBody *outer$, id<OkioSource> delegate);

__attribute__((unused)) static Retrofit2OkHttpCall_ExceptionCatchingRequestBody_1 *new_Retrofit2OkHttpCall_ExceptionCatchingRequestBody_1_initWithRetrofit2OkHttpCall_ExceptionCatchingRequestBody_withOkioSource_(Retrofit2OkHttpCall_ExceptionCatchingRequestBody *outer$, id<OkioSource> delegate) NS_RETURNS_RETAINED;

__attribute__((unused)) static Retrofit2OkHttpCall_ExceptionCatchingRequestBody_1 *create_Retrofit2OkHttpCall_ExceptionCatchingRequestBody_1_initWithRetrofit2OkHttpCall_ExceptionCatchingRequestBody_withOkioSource_(Retrofit2OkHttpCall_ExceptionCatchingRequestBody *outer$, id<OkioSource> delegate);

@implementation Retrofit2OkHttpCall

- (instancetype)initWithRetrofit2ServiceMethod:(Retrofit2ServiceMethod *)serviceMethod
  ...
  @synchronized(self) {
    ...
    if (creationFailure_ != nil) {
      if ([creationFailure_ isKindOfClass:[JavaIoIOException class]]) {
        @throw create_JavaLangRuntimeException_initWithNSString_withNSException_(@"Unable to create request.", creationFailure_);
      }
      else {
    ...
    @try {
      return [((id<Okhttp3Call>) (JreStrongAssign(&rawCall_, Retrofit2OkHttpCall_createRawCall(self)))) request];
    }
    ...
    @catch (JavaIoIOException *e) {
      JreStrongAssign(&creationFailure_, e);
      @throw create_JavaLangRuntimeException_initWithNSString_withNSException_(@"Unable to create request.", e);
    }
  }
}

- (void)enqueueWithRetrofit2Callback:(id<Retrofit2Callback>)callback {
  if (callback == nil) @throw create_JavaLangNullPointerException_initWithNSString_(@"callback == null");
  id<Okhttp3Call> call;
  NSException *failure;
  @synchronized(self) {
    ...
    executed_ = true;
    call = rawCall_;
    failure = creationFailure_;
    if (call == nil && failure == nil) {
      @try {
        call = JreStrongAssign(&rawCall_, Retrofit2OkHttpCall_createRawCall(self));
      }
      @catch (NSException *t) {
        failure = JreStrongAssign(&creationFailure_, t);
      }
    }
  }
  if (failure != nil) {
    [callback onFailureWithRetrofit2Call:self withNSException:failure];
    return;
  }
...
- (Retrofit2Response *)parseResponseWithOkhttp3Response:(Okhttp3Response *)rawResponse {
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LRetrofit2OkHttpCall;", 0x1, 2, -1, -1, 3, -1, -1 },
    { NULL, "LOkhttp3Request;", 0x21, -1, -1, -1, -1, -1, -1 },
    { NULL, "V", 0x1, 4, 5, -1, 6, -1, -1 },
    { NULL, "Z", 0x21, -1, -1, -1, -1, -1, -1 },
    { NULL, "LRetrofit2Response;", 0x1, -1, -1, 7, 8, -1, -1 },
    { NULL, "LOkhttp3Call;", 0x2, -1, -1, 7, -1, -1, -1 },
    { NULL, "LRetrofit2Response;", 0x0, 9, 10, 7, 11, -1, -1 },
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "serviceMethod_", "LRetrofit2ServiceMethod;", .constantValue.asLong = 0, 0x12, -1, -1, 12, -1 },
    { "args_", "[LNSObject;", .constantValue.asLong = 0, 0x12, -1, -1, -1, -1 },
    { "canceled_", "Z", .constantValue.asLong = 0, 0x42, -1, -1, -1, -1 },
    { "rawCall_", "LOkhttp3Call;", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
    { "creationFailure_", "LNSException;", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
    { "executed_", "Z", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "LRetrofit2ServiceMethod;[LNSObject;", "(Lretrofit2/ServiceMethod<TT;*>;[Ljava/lang/Object;)V", "clone", "()Lretrofit2/OkHttpCall<TT;>;", "enqueue", "LRetrofit2Callback;", "(Lretrofit2/Callback<TT;>;)V", "LJavaIoIOException;", "()Lretrofit2/Response<TT;>;", "parseResponse", "LOkhttp3Response;", "(Lokhttp3/Response;)Lretrofit2/Response<TT;>;", "Lretrofit2/ServiceMethod<TT;*>;", "LRetrofit2OkHttpCall_NoContentResponseBody;LRetrofit2OkHttpCall_ExceptionCatchingRequestBody;", "<T:Ljava/lang/Object;>Ljava/lang/Object;Lretrofit2/Call<TT;>;" };
  static const J2ObjcClassInfo _Retrofit2OkHttpCall = { "OkHttpCall", "retrofit2", ptrTable, methods, fields, 7, 0x10, 10, 6, -1, 13, -1, 14, -1 };
...
- (void)onResponseWithOkhttp3Call:(id<Okhttp3Call>)call
  ...
  @catch (NSException *e) {
    Retrofit2OkHttpCall_1_callFailureWithNSException_(self, e);
    return;
  }
...
- (void)onFailureWithOkhttp3Call:(id<Okhttp3Call>)call
           withJavaIoIOException:(JavaIoIOException *)e {
  @try {
    [((id<Retrofit2Callback>) nil_chk(val$callback_)) onFailureWithRetrofit2Call:this$0_ withNSException:e];
  }
  @catch (NSException *t) {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[3].selector = @selector(callFailureWithNSException:);
...
void Retrofit2OkHttpCall_1_callFailureWithNSException_(Retrofit2OkHttpCall_1 *self, NSException *e) {
  @try {
    [((id<Retrofit2Callback>) nil_chk(self->val$callback_)) onFailureWithRetrofit2Call:self->this$0_ withNSException:e];
  }
  @catch (NSException *t) {
    [((NSException *) nil_chk(t)) printStackTrace];
  }
...
- (instancetype)initWithOkhttp3MediaType:(Okhttp3MediaType *)contentType
...
- (instancetype)initWithOkhttp3ResponseBody:(Okhttp3ResponseBody *)delegate {
...
- (instancetype)initWithRetrofit2OkHttpCall_ExceptionCatchingRequestBody:(Retrofit2OkHttpCall_ExceptionCatchingRequestBody *)outer$
                                                          withOkioSource:(id<OkioSource>)delegate {
  Retrofit2OkHttpCall_ExceptionCatchingRequestBody_1_initWithRetrofit2OkHttpCall_ExceptionCatchingRequestBody_withOkioSource_(self, outer$, delegate);
  return self;
}
...
void Retrofit2OkHttpCall_ExceptionCatchingRequestBody_1_initWithRetrofit2OkHttpCall_ExceptionCatchingRequestBody_withOkioSource_(Retrofit2OkHttpCall_ExceptionCatchingRequestBody_1 *self, Retrofit2OkHttpCall_ExceptionCatchingRequestBody *outer$, id<OkioSource> delegate) {
  JreStrongAssign(&self->this$0_, outer$);
  OkioForwardingSource_initWithOkioSource_(self, delegate);
}

Retrofit2OkHttpCall_ExceptionCatchingRequestBody_1 *new_Retrofit2OkHttpCall_ExceptionCatchingRequestBody_1_initWithRetrofit2OkHttpCall_ExceptionCatchingRequestBody_withOkioSource_(Retrofit2OkHttpCall_ExceptionCatchingRequestBody *outer$, id<OkioSource> delegate) {
  J2OBJC_NEW_IMPL(Retrofit2OkHttpCall_ExceptionCatchingRequestBody_1, initWithRetrofit2OkHttpCall_ExceptionCatchingRequestBody_withOkioSource_, outer$, delegate)
}

Retrofit2OkHttpCall_ExceptionCatchingRequestBody_1 *create_Retrofit2OkHttpCall_ExceptionCatchingRequestBody_1_initWithRetrofit2OkHttpCall_ExceptionCatchingRequestBody_withOkioSource_(Retrofit2OkHttpCall_ExceptionCatchingRequestBody *outer$, id<OkioSource> delegate) {
  J2OBJC_CREATE_IMPL(Retrofit2OkHttpCall_ExceptionCatchingRequestBody_1, initWithRetrofit2OkHttpCall_ExceptionCatchingRequestBody_withOkioSource_, outer$, delegate)
}
