...
//  source: ../target/dependency/com/google/gson/reflect/TypeToken.java
//
...
+ (ComGoogleGsonReflectTypeToken *)getParameterizedWithJavaLangReflectType:(id<JavaLangReflectType>)rawType
                                              withJavaLangReflectTypeArray:(IOSObjectArray *)typeArguments {
  return ComGoogleGsonReflectTypeToken_getParameterizedWithJavaLangReflectType_withJavaLangReflectTypeArray_(rawType, typeArguments);
}

+ (ComGoogleGsonReflectTypeToken *)getArrayWithJavaLangReflectType:(id<JavaLangReflectType>)componentType {
  return ComGoogleGsonReflectTypeToken_getArrayWithJavaLangReflectType_(componentType);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LComGoogleGsonReflectTypeToken;", 0x89, 31, 32, -1, 33, -1, -1 },
    { NULL, "LComGoogleGsonReflectTypeToken;", 0x9, 34, 0, -1, 29, -1, -1 },
  };
  ...
  static const J2ObjcClassInfo _ComGoogleGsonReflectTypeToken = { "TypeToken", "com.google.gson.reflect", ptrTable, methods, fields, 7, 0x1, 20, 3, -1, -1, -1, 36, -1 };
...
ComGoogleGsonReflectTypeToken *ComGoogleGsonReflectTypeToken_getParameterizedWithJavaLangReflectType_withJavaLangReflectTypeArray_(id<JavaLangReflectType> rawType, IOSObjectArray *typeArguments) {
  ComGoogleGsonReflectTypeToken_initialize();
  return create_ComGoogleGsonReflectTypeToken_initWithJavaLangReflectType_(ComGoogleGsonInternal_Gson_Types_newParameterizedTypeWithOwnerWithJavaLangReflectType_withJavaLangReflectType_withJavaLangReflectTypeArray_(nil, rawType, typeArguments));
}

ComGoogleGsonReflectTypeToken *ComGoogleGsonReflectTypeToken_getArrayWithJavaLangReflectType_(id<JavaLangReflectType> componentType) {
  ComGoogleGsonReflectTypeToken_initialize();
  return create_ComGoogleGsonReflectTypeToken_initWithJavaLangReflectType_(ComGoogleGsonInternal_Gson_Types_arrayOfWithJavaLangReflectType_(componentType));
}
