...
//  source: ../target/dependency/com/google/gson/internal/bind/JsonTreeWriter.java
//
...
- (ComGoogleGsonStreamJsonWriter *)valueWithJavaLangBoolean:(JavaLangBoolean *)value {
  ...
  ComGoogleGsonInternalBindJsonTreeWriter_putWithComGoogleGsonJsonElement_(self, create_ComGoogleGsonJsonPrimitive_initWithJavaLangBoolean_(value));
  return self;
}
