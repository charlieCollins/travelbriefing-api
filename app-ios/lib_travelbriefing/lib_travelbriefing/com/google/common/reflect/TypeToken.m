...
//  source: ../target/dependency/com/google/common/reflect/TypeToken.java
//
...
- (instancetype)initWithComGoogleCommonReflectTypeToken:(ComGoogleCommonReflectTypeToken *)outer$
                              withJavaLangReflectMethod:(JavaLangReflectMethod *)param0;
...
__attribute__((unused)) static void ComGoogleCommonReflectTypeToken_1_initWithComGoogleCommonReflectTypeToken_withJavaLangReflectMethod_(ComGoogleCommonReflectTypeToken_1 *self, ComGoogleCommonReflectTypeToken *outer$, JavaLangReflectMethod *param0);

__attribute__((unused)) static ComGoogleCommonReflectTypeToken_1 *new_ComGoogleCommonReflectTypeToken_1_initWithComGoogleCommonReflectTypeToken_withJavaLangReflectMethod_(ComGoogleCommonReflectTypeToken *outer$, JavaLangReflectMethod *param0) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonReflectTypeToken_1 *create_ComGoogleCommonReflectTypeToken_1_initWithComGoogleCommonReflectTypeToken_withJavaLangReflectMethod_(ComGoogleCommonReflectTypeToken *outer$, JavaLangReflectMethod *param0);
...
- (instancetype)initWithComGoogleCommonReflectTypeToken:(ComGoogleCommonReflectTypeToken *)outer$
                         withJavaLangReflectConstructor:(JavaLangReflectConstructor *)param0;
...
__attribute__((unused)) static void ComGoogleCommonReflectTypeToken_2_initWithComGoogleCommonReflectTypeToken_withJavaLangReflectConstructor_(ComGoogleCommonReflectTypeToken_2 *self, ComGoogleCommonReflectTypeToken *outer$, JavaLangReflectConstructor *param0);

__attribute__((unused)) static ComGoogleCommonReflectTypeToken_2 *new_ComGoogleCommonReflectTypeToken_2_initWithComGoogleCommonReflectTypeToken_withJavaLangReflectConstructor_(ComGoogleCommonReflectTypeToken *outer$, JavaLangReflectConstructor *param0) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonReflectTypeToken_2 *create_ComGoogleCommonReflectTypeToken_2_initWithComGoogleCommonReflectTypeToken_withJavaLangReflectConstructor_(ComGoogleCommonReflectTypeToken *outer$, JavaLangReflectConstructor *param0);
...
- (instancetype)initWithComGoogleCommonReflectTypeToken_TypeCollector:(ComGoogleCommonReflectTypeToken_TypeCollector *)param0;
...
__attribute__((unused)) static void ComGoogleCommonReflectTypeToken_TypeCollector_3_initWithComGoogleCommonReflectTypeToken_TypeCollector_(ComGoogleCommonReflectTypeToken_TypeCollector_3 *self, ComGoogleCommonReflectTypeToken_TypeCollector *param0);

__attribute__((unused)) static ComGoogleCommonReflectTypeToken_TypeCollector_3 *new_ComGoogleCommonReflectTypeToken_TypeCollector_3_initWithComGoogleCommonReflectTypeToken_TypeCollector_(ComGoogleCommonReflectTypeToken_TypeCollector *param0) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonReflectTypeToken_TypeCollector_3 *create_ComGoogleCommonReflectTypeToken_TypeCollector_3_initWithComGoogleCommonReflectTypeToken_TypeCollector_(ComGoogleCommonReflectTypeToken_TypeCollector *param0);
...
- (ComGoogleCommonReflectInvokable *)methodWithJavaLangReflectMethod:(JavaLangReflectMethod *)method {
  ...
  return create_ComGoogleCommonReflectTypeToken_1_initWithComGoogleCommonReflectTypeToken_withJavaLangReflectMethod_(self, method);
}
...
- (ComGoogleCommonReflectInvokable *)constructorWithJavaLangReflectConstructor:(JavaLangReflectConstructor *)constructor {
  ...
  return create_ComGoogleCommonReflectTypeToken_2_initWithComGoogleCommonReflectTypeToken_withJavaLangReflectConstructor_(self, constructor);
}
...
- (id)writeReplace {
  return ComGoogleCommonReflectTypeToken_ofWithJavaLangReflectType_([create_ComGoogleCommonReflectTypeResolver_init() resolveTypeWithJavaLangReflectType:runtimeType_]);
}

- (ComGoogleCommonReflectTypeToken *)rejectTypeVariables {
  [create_ComGoogleCommonReflectTypeToken_3_initWithComGoogleCommonReflectTypeToken_(self) visitWithJavaLangReflectTypeArray:[IOSObjectArray arrayWithObjects:(id[]){ runtimeType_ } count:1 type:JavaLangReflectType_class_()]];
  return self;
}
...
- (void)dealloc {
  RELEASE_(runtimeType_);
  RELEASE_(typeResolver_);
  [super dealloc];
}
...
void ComGoogleCommonReflectTypeToken_init(ComGoogleCommonReflectTypeToken *self) {
  ...
  JreStrongAssign(&self->runtimeType_, [self capture]);
...
void ComGoogleCommonReflectTypeToken_initWithIOSClass_(ComGoogleCommonReflectTypeToken *self, IOSClass *declaringClass) {
  ...
  if ([captured isKindOfClass:[IOSClass class]]) {
    JreStrongAssign(&self->runtimeType_, captured);
  }
  else {
    JreStrongAssign(&self->runtimeType_, ((ComGoogleCommonReflectTypeToken *) nil_chk(ComGoogleCommonReflectTypeToken_resolveTypeWithJavaLangReflectType_(nil_chk(ComGoogleCommonReflectTypeToken_ofWithIOSClass_(declaringClass)), captured)))->runtimeType_);
  }
}
...
void ComGoogleCommonReflectTypeToken_initWithJavaLangReflectType_(ComGoogleCommonReflectTypeToken *self, id<JavaLangReflectType> type) {
  ComGoogleCommonReflectTypeCapture_init(self);
  JreStrongAssign(&self->runtimeType_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(type));
}
...
ComGoogleCommonReflectTypeToken *ComGoogleCommonReflectTypeToken_ofWithIOSClass_(IOSClass *type) {
  ...
  return create_ComGoogleCommonReflectTypeToken_SimpleTypeToken_initWithJavaLangReflectType_(type);
}
...
ComGoogleCommonReflectTypeToken *ComGoogleCommonReflectTypeToken_whereWithComGoogleCommonReflectTypeParameter_withComGoogleCommonReflectTypeToken_(ComGoogleCommonReflectTypeToken *self, ComGoogleCommonReflectTypeParameter *typeParam, ComGoogleCommonReflectTypeToken *typeArg) {
  ComGoogleCommonReflectTypeResolver *resolver = [create_ComGoogleCommonReflectTypeResolver_init() whereWithJavaUtilMap:ComGoogleCommonCollectImmutableMap_ofWithId_withId_(create_ComGoogleCommonReflectTypeResolver_TypeVariableKey_initWithJavaLangReflectTypeVariable_(((ComGoogleCommonReflectTypeParameter *) nil_chk(typeParam))->typeVariable_), ((ComGoogleCommonReflectTypeToken *) nil_chk(typeArg))->runtimeType_)];
  return create_ComGoogleCommonReflectTypeToken_SimpleTypeToken_initWithJavaLangReflectType_([((ComGoogleCommonReflectTypeResolver *) nil_chk(resolver)) resolveTypeWithJavaLangReflectType:self->runtimeType_]);
}
...
ComGoogleCommonReflectTypeToken *ComGoogleCommonReflectTypeToken_resolveTypeWithJavaLangReflectType_(ComGoogleCommonReflectTypeToken *self, id<JavaLangReflectType> type) {
  ...
  if (resolver == nil) {
    resolver = (JreStrongAssign(&self->typeResolver_, ComGoogleCommonReflectTypeResolver_accordingToWithJavaLangReflectType_(self->runtimeType_)));
  }
...
IOSObjectArray *ComGoogleCommonReflectTypeToken_resolveInPlaceWithJavaLangReflectTypeArray_(ComGoogleCommonReflectTypeToken *self, IOSObjectArray *types) {
  for (jint i = 0; i < ((IOSObjectArray *) nil_chk(types))->size_; i++) {
    IOSObjectArray_Set(types, i, ComGoogleCommonReflectTypeToken_getType(nil_chk(ComGoogleCommonReflectTypeToken_resolveTypeWithJavaLangReflectType_(self, IOSObjectArray_Get(types, i)))));
  }
  return types;
}
...
ComGoogleCommonReflectTypeToken *ComGoogleCommonReflectTypeToken_resolveSupertypeWithJavaLangReflectType_(ComGoogleCommonReflectTypeToken *self, id<JavaLangReflectType> type) {
  ...
  JreStrongAssign(&((ComGoogleCommonReflectTypeToken *) nil_chk(supertype))->typeResolver_, self->typeResolver_);
  return supertype;
}
...
ComGoogleCommonCollectImmutableList *ComGoogleCommonReflectTypeToken_getGenericInterfaces(ComGoogleCommonReflectTypeToken *self) {
  ...
  ComGoogleCommonCollectImmutableList_Builder *builder = ComGoogleCommonCollectImmutableList_builder();
  {
    ...
    while (b__ < e__) {
      ...
      [((ComGoogleCommonCollectImmutableList_Builder *) nil_chk(builder)) addWithId:resolvedInterface];
    }
  }
  ...
  ComGoogleCommonCollectImmutableList_Builder *builder = ComGoogleCommonCollectImmutableList_builder();
  {
    ...
    while (b__ < e__) {
      ...
      if ([((IOSClass *) nil_chk(ComGoogleCommonReflectTypeToken_getRawType(nil_chk(boundType)))) isInterface]) {
        [((ComGoogleCommonCollectImmutableList_Builder *) nil_chk(builder)) addWithId:boundType];
      }
    }
  }
  return [((ComGoogleCommonCollectImmutableList_Builder *) nil_chk(builder)) build];
...
ComGoogleCommonReflectTypeToken_TypeSet *ComGoogleCommonReflectTypeToken_getTypes(ComGoogleCommonReflectTypeToken *self) {
  return create_ComGoogleCommonReflectTypeToken_TypeSet_initWithComGoogleCommonReflectTypeToken_(self);
}
...
jboolean ComGoogleCommonReflectTypeToken_isSubtypeOfWithJavaLangReflectType_(ComGoogleCommonReflectTypeToken *self, id<JavaLangReflectType> supertype) {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(supertype);
...
ComGoogleCommonReflectTypeToken_Bounds *ComGoogleCommonReflectTypeToken_everyWithJavaLangReflectTypeArray_(IOSObjectArray *bounds) {
  ComGoogleCommonReflectTypeToken_initialize();
  return create_ComGoogleCommonReflectTypeToken_Bounds_initWithJavaLangReflectTypeArray_withBoolean_(bounds, false);
}
...
ComGoogleCommonReflectTypeToken_Bounds *ComGoogleCommonReflectTypeToken_anyWithJavaLangReflectTypeArray_(IOSObjectArray *bounds) {
  ComGoogleCommonReflectTypeToken_initialize();
  return create_ComGoogleCommonReflectTypeToken_Bounds_initWithJavaLangReflectTypeArray_withBoolean_(bounds, true);
}
...
ComGoogleCommonCollectImmutableSet *ComGoogleCommonReflectTypeToken_getRawTypes(ComGoogleCommonReflectTypeToken *self) {
  ...
  [create_ComGoogleCommonReflectTypeToken_4_initWithComGoogleCommonCollectImmutableSet_Builder_(builder) visitWithJavaLangReflectTypeArray:[IOSObjectArray arrayWithObjects:(id[]){ self->runtimeType_ } count:1 type:JavaLangReflectType_class_()]];
...
ComGoogleCommonReflectTypeToken *ComGoogleCommonReflectTypeToken_getSupertypeFromUpperBoundsWithIOSClass_withJavaLangReflectTypeArray_(ComGoogleCommonReflectTypeToken *self, IOSClass *supertype, IOSObjectArray *upperBounds) {
  ...
  @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("@$@", supertype, @" isn't a super type of ", self));
}
...
ComGoogleCommonReflectTypeToken *ComGoogleCommonReflectTypeToken_getSubtypeFromLowerBoundsWithIOSClass_withJavaLangReflectTypeArray_(ComGoogleCommonReflectTypeToken *self, IOSClass *subclass, IOSObjectArray *lowerBounds) {
  ...
  @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("@$@", subclass, @" isn't a subclass of ", self));
}
...
id<JavaLangReflectType> ComGoogleCommonReflectTypeToken_resolveTypeArgsForSubclassWithIOSClass_(ComGoogleCommonReflectTypeToken *self, IOSClass *subclass) {
  ...
  return [((ComGoogleCommonReflectTypeResolver *) nil_chk([create_ComGoogleCommonReflectTypeResolver_init() whereWithJavaLangReflectType:supertypeWithArgsFromSubtype withJavaLangReflectType:self->runtimeType_])) resolveTypeWithJavaLangReflectType:genericSubtype->runtimeType_];
}
...
- (instancetype)initWithComGoogleCommonReflectTypeToken:(ComGoogleCommonReflectTypeToken *)outer$
                              withJavaLangReflectMethod:(JavaLangReflectMethod *)param0 {
  ComGoogleCommonReflectTypeToken_1_initWithComGoogleCommonReflectTypeToken_withJavaLangReflectMethod_(self, outer$, param0);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonReflectTypeToken_1 = { "", "com.google.common.reflect", ptrTable, methods, fields, 7, 0x8008, 6, 1, 4, -1, 5, 6, -1 };
  return &_ComGoogleCommonReflectTypeToken_1;
}

@end

void ComGoogleCommonReflectTypeToken_1_initWithComGoogleCommonReflectTypeToken_withJavaLangReflectMethod_(ComGoogleCommonReflectTypeToken_1 *self, ComGoogleCommonReflectTypeToken *outer$, JavaLangReflectMethod *param0) {
  JreStrongAssign(&self->this$0_, outer$);
  ComGoogleCommonReflectInvokable_MethodInvokable_initWithJavaLangReflectMethod_(self, param0);
}

ComGoogleCommonReflectTypeToken_1 *new_ComGoogleCommonReflectTypeToken_1_initWithComGoogleCommonReflectTypeToken_withJavaLangReflectMethod_(ComGoogleCommonReflectTypeToken *outer$, JavaLangReflectMethod *param0) {
  J2OBJC_NEW_IMPL(ComGoogleCommonReflectTypeToken_1, initWithComGoogleCommonReflectTypeToken_withJavaLangReflectMethod_, outer$, param0)
}

ComGoogleCommonReflectTypeToken_1 *create_ComGoogleCommonReflectTypeToken_1_initWithComGoogleCommonReflectTypeToken_withJavaLangReflectMethod_(ComGoogleCommonReflectTypeToken *outer$, JavaLangReflectMethod *param0) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonReflectTypeToken_1, initWithComGoogleCommonReflectTypeToken_withJavaLangReflectMethod_, outer$, param0)
}
...
- (instancetype)initWithComGoogleCommonReflectTypeToken:(ComGoogleCommonReflectTypeToken *)outer$
                         withJavaLangReflectConstructor:(JavaLangReflectConstructor *)param0 {
  ComGoogleCommonReflectTypeToken_2_initWithComGoogleCommonReflectTypeToken_withJavaLangReflectConstructor_(self, outer$, param0);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonReflectTypeToken_2 = { "", "com.google.common.reflect", ptrTable, methods, fields, 7, 0x8008, 6, 1, 5, -1, 6, 7, -1 };
  return &_ComGoogleCommonReflectTypeToken_2;
}

@end

void ComGoogleCommonReflectTypeToken_2_initWithComGoogleCommonReflectTypeToken_withJavaLangReflectConstructor_(ComGoogleCommonReflectTypeToken_2 *self, ComGoogleCommonReflectTypeToken *outer$, JavaLangReflectConstructor *param0) {
  JreStrongAssign(&self->this$0_, outer$);
  ComGoogleCommonReflectInvokable_ConstructorInvokable_initWithJavaLangReflectConstructor_(self, param0);
}

ComGoogleCommonReflectTypeToken_2 *new_ComGoogleCommonReflectTypeToken_2_initWithComGoogleCommonReflectTypeToken_withJavaLangReflectConstructor_(ComGoogleCommonReflectTypeToken *outer$, JavaLangReflectConstructor *param0) {
  J2OBJC_NEW_IMPL(ComGoogleCommonReflectTypeToken_2, initWithComGoogleCommonReflectTypeToken_withJavaLangReflectConstructor_, outer$, param0)
}

ComGoogleCommonReflectTypeToken_2 *create_ComGoogleCommonReflectTypeToken_2_initWithComGoogleCommonReflectTypeToken_withJavaLangReflectConstructor_(ComGoogleCommonReflectTypeToken *outer$, JavaLangReflectConstructor *param0) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonReflectTypeToken_2, initWithComGoogleCommonReflectTypeToken_withJavaLangReflectConstructor_, outer$, param0)
}
...
- (ComGoogleCommonReflectTypeToken_TypeSet *)interfaces {
  return create_ComGoogleCommonReflectTypeToken_InterfaceSet_initWithComGoogleCommonReflectTypeToken_withComGoogleCommonReflectTypeToken_TypeSet_(this$0_, self);
}

- (ComGoogleCommonReflectTypeToken_TypeSet *)classes {
  return create_ComGoogleCommonReflectTypeToken_ClassSet_initWithComGoogleCommonReflectTypeToken_(this$0_);
}
...
- (id<JavaUtilSet>)delegate {
  ...
  if (result == nil) {
    return (JreStrongAssign(&interfaces_, [((ComGoogleCommonCollectFluentIterable *) nil_chk([((ComGoogleCommonCollectFluentIterable *) nil_chk(ComGoogleCommonCollectFluentIterable_fromWithJavaLangIterable_(allTypes_))) filterWithComGoogleCommonBasePredicate:JreLoadEnum(ComGoogleCommonReflectTypeToken_TypeFilter, INTERFACE_ONLY)])) toSet]));
  }
  else {
    return result;
  }
...
- (id<JavaUtilSet>)rawTypes {
  ...
  return [((ComGoogleCommonCollectFluentIterable *) nil_chk([((ComGoogleCommonCollectFluentIterable *) nil_chk(ComGoogleCommonCollectFluentIterable_fromWithJavaLangIterable_(collectedTypes))) filterWithComGoogleCommonBasePredicate:create_ComGoogleCommonReflectTypeToken_InterfaceSet_1_init()])) toSet];
}

- (ComGoogleCommonReflectTypeToken_TypeSet *)classes {
  @throw create_JavaLangUnsupportedOperationException_initWithNSString_(@"interfaces().classes() not supported.");
}
...
void ComGoogleCommonReflectTypeToken_InterfaceSet_initWithComGoogleCommonReflectTypeToken_withComGoogleCommonReflectTypeToken_TypeSet_(ComGoogleCommonReflectTypeToken_InterfaceSet *self, ComGoogleCommonReflectTypeToken *outer$, ComGoogleCommonReflectTypeToken_TypeSet *allTypes) {
  ...
  ComGoogleCommonReflectTypeToken_TypeSet_initWithComGoogleCommonReflectTypeToken_(self, outer$);
  JreStrongAssign(&self->allTypes_, allTypes);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonReflectTypeToken_InterfaceSet_1 = { "", "com.google.common.reflect", ptrTable, methods, NULL, 7, 0x8008, 2, 0, 3, -1, 4, 5, -1 };
...
- (id<JavaUtilSet>)delegate {
  ...
  if (result == nil) {
    ...
    return (JreStrongAssign(&classes_, [((ComGoogleCommonCollectFluentIterable *) nil_chk([((ComGoogleCommonCollectFluentIterable *) nil_chk(ComGoogleCommonCollectFluentIterable_fromWithJavaLangIterable_(collectedTypes))) filterWithComGoogleCommonBasePredicate:JreLoadEnum(ComGoogleCommonReflectTypeToken_TypeFilter, IGNORE_TYPE_VARIABLE_OR_WILDCARD)])) toSet]));
  }
  else {
    return result;
  }
...
- (ComGoogleCommonReflectTypeToken_TypeSet *)interfaces {
  @throw create_JavaLangUnsupportedOperationException_initWithNSString_(@"classes().interfaces() not supported.");
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonReflectTypeToken_TypeFilter class]) {
    size_t allocSize = 0;
    size_t objSize_IGNORE_TYPE_VARIABLE_OR_WILDCARD = class_getInstanceSize([ComGoogleCommonReflectTypeToken_TypeFilter_1 class]);
    allocSize += objSize_IGNORE_TYPE_VARIABLE_OR_WILDCARD;
    size_t objSize_INTERFACE_ONLY = class_getInstanceSize([ComGoogleCommonReflectTypeToken_TypeFilter_2 class]);
    allocSize += objSize_INTERFACE_ONLY;
    uintptr_t ptr = (uintptr_t)calloc(allocSize, 1);
    id e;
    (JreEnum(ComGoogleCommonReflectTypeToken_TypeFilter, IGNORE_TYPE_VARIABLE_OR_WILDCARD) = e = objc_constructInstance([ComGoogleCommonReflectTypeToken_TypeFilter_1 class], (void *)ptr), ptr += objSize_IGNORE_TYPE_VARIABLE_OR_WILDCARD);
    ComGoogleCommonReflectTypeToken_TypeFilter_1_initWithNSString_withInt_(e, @"IGNORE_TYPE_VARIABLE_OR_WILDCARD", 0);
    (JreEnum(ComGoogleCommonReflectTypeToken_TypeFilter, INTERFACE_ONLY) = e = objc_constructInstance([ComGoogleCommonReflectTypeToken_TypeFilter_2 class], (void *)ptr), ptr += objSize_INTERFACE_ONLY);
    ComGoogleCommonReflectTypeToken_TypeFilter_2_initWithNSString_withInt_(e, @"INTERFACE_ONLY", 1);
...
- (void)visitTypeVariableWithJavaLangReflectTypeVariable:(id<JavaLangReflectTypeVariable>)type {
  @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("@$", this$0_->runtimeType_, @"contains a type variable and is not safe for the operation"));
}
...
- (void)visitParameterizedTypeWithJavaLangReflectParameterizedType:(id<JavaLangReflectParameterizedType>)type {
  ...
  [self visitWithJavaLangReflectTypeArray:[IOSObjectArray arrayWithObjects:(id[]){ [type getOwnerType] } count:1 type:JavaLangReflectType_class_()]];
}

- (void)visitGenericArrayTypeWithJavaLangReflectGenericArrayType:(id<JavaLangReflectGenericArrayType>)type {
  [self visitWithJavaLangReflectTypeArray:[IOSObjectArray arrayWithObjects:(id[]){ [((id<JavaLangReflectGenericArrayType>) nil_chk(type)) getGenericComponentType] } count:1 type:JavaLangReflectType_class_()]];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonReflectTypeToken_3 = { "", "com.google.common.reflect", ptrTable, methods, fields, 7, 0x8008, 5, 1, 10, -1, 11, -1, -1 };
...
- (void)visitParameterizedTypeWithJavaLangReflectParameterizedType:(id<JavaLangReflectParameterizedType>)t {
  [((ComGoogleCommonCollectImmutableSet_Builder *) nil_chk(val$builder_)) addWithId:(IOSClass *) cast_chk([((id<JavaLangReflectParameterizedType>) nil_chk(t)) getRawType], [IOSClass class])];
}

- (void)visitClassWithIOSClass:(IOSClass *)t {
  [((ComGoogleCommonCollectImmutableSet_Builder *) nil_chk(val$builder_)) addWithId:t];
}

- (void)visitGenericArrayTypeWithJavaLangReflectGenericArrayType:(id<JavaLangReflectGenericArrayType>)t {
  [((ComGoogleCommonCollectImmutableSet_Builder *) nil_chk(val$builder_)) addWithId:ComGoogleCommonReflectTypes_getArrayClassWithIOSClass_(ComGoogleCommonReflectTypeToken_getRawType(nil_chk(ComGoogleCommonReflectTypeToken_ofWithJavaLangReflectType_([((id<JavaLangReflectGenericArrayType>) nil_chk(t)) getGenericComponentType]))))];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonReflectTypeToken_4 = { "", "com.google.common.reflect", ptrTable, methods, fields, 7, 0x8008, 6, 1, 13, -1, 14, -1, -1 };
...
+ (void)initialize {
  if (self == [ComGoogleCommonReflectTypeToken_TypeCollector class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonReflectTypeToken_TypeCollector_FOR_GENERIC_TYPE, new_ComGoogleCommonReflectTypeToken_TypeCollector_1_init());
    JreStrongAssignAndConsume(&ComGoogleCommonReflectTypeToken_TypeCollector_FOR_RAW_TYPE, new_ComGoogleCommonReflectTypeToken_TypeCollector_2_init());
...
ComGoogleCommonReflectTypeToken_TypeCollector *ComGoogleCommonReflectTypeToken_TypeCollector_classesOnly(ComGoogleCommonReflectTypeToken_TypeCollector *self) {
  return create_ComGoogleCommonReflectTypeToken_TypeCollector_3_initWithComGoogleCommonReflectTypeToken_TypeCollector_(self);
}
...
jint ComGoogleCommonReflectTypeToken_TypeCollector_collectTypesWithId_withJavaUtilMap_(ComGoogleCommonReflectTypeToken_TypeCollector *self, id type, id<JavaUtilMap> map) {
  ...
  [map putWithId:type withId:JavaLangInteger_valueOfWithInt_(aboveMe + 1)];
  return aboveMe + 1;
}
...
ComGoogleCommonCollectImmutableList *ComGoogleCommonReflectTypeToken_TypeCollector_sortKeysByValueWithJavaUtilMap_withJavaUtilComparator_(id<JavaUtilMap> map, id<JavaUtilComparator> valueComparator) {
  ...
  ComGoogleCommonCollectOrdering *keyOrdering = create_ComGoogleCommonReflectTypeToken_TypeCollector_4_initWithJavaUtilComparator_withJavaUtilMap_(valueComparator, map);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonReflectTypeToken_TypeCollector_1 = { "", "com.google.common.reflect", ptrTable, methods, NULL, 7, 0x8008, 4, 0, 8, -1, -1, 9, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonReflectTypeToken_TypeCollector_2 = { "", "com.google.common.reflect", ptrTable, methods, NULL, 7, 0x8008, 4, 0, 7, -1, -1, 8, -1 };
...
- (instancetype)initWithComGoogleCommonReflectTypeToken_TypeCollector:(ComGoogleCommonReflectTypeToken_TypeCollector *)param0 {
  ComGoogleCommonReflectTypeToken_TypeCollector_3_initWithComGoogleCommonReflectTypeToken_TypeCollector_(self, param0);
  return self;
}
...
- (ComGoogleCommonCollectImmutableList *)collectTypesWithJavaLangIterable:(id<JavaLangIterable>)types {
  ...
  for (id __strong type in nil_chk(types)) {
    if (![((IOSClass *) nil_chk([self getRawTypeWithId:type])) isInterface]) {
      [((ComGoogleCommonCollectImmutableList_Builder *) nil_chk(builder)) addWithId:type];
    }
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonReflectTypeToken_TypeCollector_3 = { "", "com.google.common.reflect", ptrTable, methods, NULL, 7, 0x8008, 3, 0, 0, -1, 8, 9, -1 };
  return &_ComGoogleCommonReflectTypeToken_TypeCollector_3;
}

@end

void ComGoogleCommonReflectTypeToken_TypeCollector_3_initWithComGoogleCommonReflectTypeToken_TypeCollector_(ComGoogleCommonReflectTypeToken_TypeCollector_3 *self, ComGoogleCommonReflectTypeToken_TypeCollector *param0) {
  ComGoogleCommonReflectTypeToken_TypeCollector_ForwardingTypeCollector_initWithComGoogleCommonReflectTypeToken_TypeCollector_(self, param0);
}

ComGoogleCommonReflectTypeToken_TypeCollector_3 *new_ComGoogleCommonReflectTypeToken_TypeCollector_3_initWithComGoogleCommonReflectTypeToken_TypeCollector_(ComGoogleCommonReflectTypeToken_TypeCollector *param0) {
  J2OBJC_NEW_IMPL(ComGoogleCommonReflectTypeToken_TypeCollector_3, initWithComGoogleCommonReflectTypeToken_TypeCollector_, param0)
}

ComGoogleCommonReflectTypeToken_TypeCollector_3 *create_ComGoogleCommonReflectTypeToken_TypeCollector_3_initWithComGoogleCommonReflectTypeToken_TypeCollector_(ComGoogleCommonReflectTypeToken_TypeCollector *param0) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonReflectTypeToken_TypeCollector_3, initWithComGoogleCommonReflectTypeToken_TypeCollector_, param0)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonReflectTypeToken_TypeCollector_4 = { "", "com.google.common.reflect", ptrTable, methods, fields, 7, 0x8008, 2, 2, 5, -1, 6, 7, -1 };
...
void ComGoogleCommonReflectTypeToken_TypeCollector_4_initWithJavaUtilComparator_withJavaUtilMap_(ComGoogleCommonReflectTypeToken_TypeCollector_4 *self, id<JavaUtilComparator> capture$0, id<JavaUtilMap> capture$1) {
  JreStrongAssign(&self->val$valueComparator_, capture$0);
