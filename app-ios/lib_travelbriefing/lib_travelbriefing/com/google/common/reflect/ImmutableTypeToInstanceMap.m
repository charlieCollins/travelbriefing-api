...
//  source: ../target/dependency/com/google/common/reflect/ImmutableTypeToInstanceMap.java
//
...
ComGoogleCommonReflectImmutableTypeToInstanceMap *ComGoogleCommonReflectImmutableTypeToInstanceMap_of() {
  ...
  return create_ComGoogleCommonReflectImmutableTypeToInstanceMap_initWithComGoogleCommonCollectImmutableMap_(ComGoogleCommonCollectImmutableMap_of());
}

ComGoogleCommonReflectImmutableTypeToInstanceMap_Builder *ComGoogleCommonReflectImmutableTypeToInstanceMap_builder() {
  ComGoogleCommonReflectImmutableTypeToInstanceMap_initialize();
  return create_ComGoogleCommonReflectImmutableTypeToInstanceMap_Builder_init();
}
...
- (ComGoogleCommonReflectImmutableTypeToInstanceMap_Builder *)putWithIOSClass:(IOSClass *)key
                                                                       withId:(id)value {
  [((ComGoogleCommonCollectImmutableMap_Builder *) nil_chk(mapBuilder_)) putWithId:ComGoogleCommonReflectTypeToken_ofWithIOSClass_(key) withId:value];
  return self;
}
...
- (ComGoogleCommonReflectImmutableTypeToInstanceMap_Builder *)putWithComGoogleCommonReflectTypeToken:(ComGoogleCommonReflectTypeToken *)key
                                                                                              withId:(id)value {
  [((ComGoogleCommonCollectImmutableMap_Builder *) nil_chk(mapBuilder_)) putWithId:[((ComGoogleCommonReflectTypeToken *) nil_chk(key)) rejectTypeVariables] withId:value];
  return self;
}

- (ComGoogleCommonReflectImmutableTypeToInstanceMap *)build {
  return create_ComGoogleCommonReflectImmutableTypeToInstanceMap_initWithComGoogleCommonCollectImmutableMap_([((ComGoogleCommonCollectImmutableMap_Builder *) nil_chk(mapBuilder_)) build]);
}
