...
//  source: ../target/dependency/com/google/common/reflect/Types.java
//
...
+ (void)initialize {
  if (self == [ComGoogleCommonReflectTypes class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonReflectTypes_TYPE_NAME, new_ComGoogleCommonReflectTypes_1_init());
    JreStrongAssign(&ComGoogleCommonReflectTypes_COMMA_JOINER, [((ComGoogleCommonBaseJoiner *) nil_chk(ComGoogleCommonBaseJoiner_onWithNSString_(@", "))) useForNullWithNSString:@"null"]);
...
id<JavaLangReflectParameterizedType> ComGoogleCommonReflectTypes_newParameterizedTypeWithOwnerWithJavaLangReflectType_withIOSClass_withJavaLangReflectTypeArray_(id<JavaLangReflectType> ownerType, IOSClass *rawType, IOSObjectArray *arguments) {
  ...
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(arguments);
  ...
  return create_ComGoogleCommonReflectTypes_ParameterizedTypeImpl_initWithJavaLangReflectType_withIOSClass_withJavaLangReflectTypeArray_(ownerType, rawType, arguments);
}
...
id<JavaLangReflectTypeVariable> ComGoogleCommonReflectTypes_newArtificialTypeVariableWithJavaLangReflectGenericDeclaration_withNSString_withJavaLangReflectTypeArray_(id<JavaLangReflectGenericDeclaration> declaration, NSString *name, IOSObjectArray *bounds) {
  ComGoogleCommonReflectTypes_initialize();
  return ComGoogleCommonReflectTypes_newTypeVariableImplWithJavaLangReflectGenericDeclaration_withNSString_withJavaLangReflectTypeArray_(declaration, name, (((IOSObjectArray *) nil_chk(bounds))->size_ == 0) ? [IOSObjectArray arrayWithObjects:(id[]){ NSObject_class_() } count:1 type:JavaLangReflectType_class_()] : bounds);
}
...
id<JavaLangReflectWildcardType> ComGoogleCommonReflectTypes_subtypeOfWithJavaLangReflectType_(id<JavaLangReflectType> upperBound) {
  ComGoogleCommonReflectTypes_initialize();
  return create_ComGoogleCommonReflectTypes_WildcardTypeImpl_initWithJavaLangReflectTypeArray_withJavaLangReflectTypeArray_([IOSObjectArray arrayWithLength:0 type:JavaLangReflectType_class_()], [IOSObjectArray arrayWithObjects:(id[]){ upperBound } count:1 type:JavaLangReflectType_class_()]);
}
...
id<JavaLangReflectWildcardType> ComGoogleCommonReflectTypes_supertypeOfWithJavaLangReflectType_(id<JavaLangReflectType> lowerBound) {
  ComGoogleCommonReflectTypes_initialize();
  return create_ComGoogleCommonReflectTypes_WildcardTypeImpl_initWithJavaLangReflectTypeArray_withJavaLangReflectTypeArray_([IOSObjectArray arrayWithObjects:(id[]){ lowerBound } count:1 type:JavaLangReflectType_class_()], [IOSObjectArray arrayWithObjects:(id[]){ NSObject_class_() } count:1 type:JavaLangReflectType_class_()]);
}
...
id<JavaLangReflectType> ComGoogleCommonReflectTypes_getComponentTypeWithJavaLangReflectType_(id<JavaLangReflectType> type) {
  ...
  JavaUtilConcurrentAtomicAtomicReference *result = create_JavaUtilConcurrentAtomicAtomicReference_init();
  [create_ComGoogleCommonReflectTypes_2_initWithJavaUtilConcurrentAtomicAtomicReference_(result) visitWithJavaLangReflectTypeArray:[IOSObjectArray arrayWithObjects:(id[]){ type } count:1 type:JavaLangReflectType_class_()]];
  return [result get];
}
...
id<JavaLangReflectTypeVariable> ComGoogleCommonReflectTypes_newTypeVariableImplWithJavaLangReflectGenericDeclaration_withNSString_withJavaLangReflectTypeArray_(id<JavaLangReflectGenericDeclaration> genericDeclaration, NSString *name, IOSObjectArray *bounds) {
  ComGoogleCommonReflectTypes_initialize();
  ComGoogleCommonReflectTypes_TypeVariableImpl *typeVariableImpl = create_ComGoogleCommonReflectTypes_TypeVariableImpl_initWithJavaLangReflectGenericDeclaration_withNSString_withJavaLangReflectTypeArray_(genericDeclaration, name, bounds);
  id<JavaLangReflectTypeVariable> typeVariable = ComGoogleCommonReflectReflection_newProxyWithIOSClass_withJavaLangReflectInvocationHandler_(JavaLangReflectTypeVariable_class_(), create_ComGoogleCommonReflectTypes_TypeVariableInvocationHandler_initWithComGoogleCommonReflectTypes_TypeVariableImpl_(typeVariableImpl));
  return typeVariable;
}

IOSObjectArray *ComGoogleCommonReflectTypes_toArrayWithJavaUtilCollection_(id<JavaUtilCollection> types) {
  ComGoogleCommonReflectTypes_initialize();
  return [((id<JavaUtilCollection>) nil_chk(types)) toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:[types size] type:JavaLangReflectType_class_()]];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonReflectTypes_1 = { "", "com.google.common.reflect", ptrTable, methods, NULL, 7, 0x8008, 2, 0, 2, -1, -1, 3, -1 };
...
+ (void)initialize {
  if (self == [ComGoogleCommonReflectTypes_ClassOwnership class]) {
    size_t allocSize = 0;
    size_t objSize_OWNED_BY_ENCLOSING_CLASS = class_getInstanceSize([ComGoogleCommonReflectTypes_ClassOwnership_1 class]);
    allocSize += objSize_OWNED_BY_ENCLOSING_CLASS;
    size_t objSize_LOCAL_CLASS_HAS_NO_OWNER = class_getInstanceSize([ComGoogleCommonReflectTypes_ClassOwnership_2 class]);
    allocSize += objSize_LOCAL_CLASS_HAS_NO_OWNER;
    uintptr_t ptr = (uintptr_t)calloc(allocSize, 1);
    id e;
    (JreEnum(ComGoogleCommonReflectTypes_ClassOwnership, OWNED_BY_ENCLOSING_CLASS) = e = objc_constructInstance([ComGoogleCommonReflectTypes_ClassOwnership_1 class], (void *)ptr), ptr += objSize_OWNED_BY_ENCLOSING_CLASS);
    ComGoogleCommonReflectTypes_ClassOwnership_1_initWithNSString_withInt_(e, @"OWNED_BY_ENCLOSING_CLASS", 0);
    (JreEnum(ComGoogleCommonReflectTypes_ClassOwnership, LOCAL_CLASS_HAS_NO_OWNER) = e = objc_constructInstance([ComGoogleCommonReflectTypes_ClassOwnership_2 class], (void *)ptr), ptr += objSize_LOCAL_CLASS_HAS_NO_OWNER);
    ComGoogleCommonReflectTypes_ClassOwnership_2_initWithNSString_withInt_(e, @"LOCAL_CLASS_HAS_NO_OWNER", 1);
    JreStrongAssign(&ComGoogleCommonReflectTypes_ClassOwnership_JVM_BEHAVIOR, ComGoogleCommonReflectTypes_ClassOwnership_detectJvmBehavior());
...
ComGoogleCommonReflectTypes_ClassOwnership *ComGoogleCommonReflectTypes_ClassOwnership_detectJvmBehavior() {
  ...
  IOSClass *subclass = [create_ComGoogleCommonReflectTypes_ClassOwnership_3_init() java_getClass];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonReflectTypes_ClassOwnership_3 = { "", "com.google.common.reflect", ptrTable, methods, NULL, 7, 0x8008, 1, 0, 0, -1, 1, 2, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonReflectTypes_2 = { "", "com.google.common.reflect", ptrTable, methods, fields, 7, 0x8008, 5, 1, 11, -1, 12, -1, -1 };
...
void ComGoogleCommonReflectTypes_GenericArrayTypeImpl_initWithJavaLangReflectType_(ComGoogleCommonReflectTypes_GenericArrayTypeImpl *self, id<JavaLangReflectType> componentType) {
  NSObject_init(self);
  JreStrongAssign(&self->componentType_, [((ComGoogleCommonReflectTypes_JavaVersion *) nil_chk(JreLoadStatic(ComGoogleCommonReflectTypes_JavaVersion, CURRENT))) usedInGenericTypeWithJavaLangReflectType:componentType]);
}
...
- (NSString *)description {
  ...
  if (ownerType_ != nil) {
    [((JavaLangStringBuilder *) nil_chk([builder appendWithNSString:[((ComGoogleCommonReflectTypes_JavaVersion *) nil_chk(JreLoadStatic(ComGoogleCommonReflectTypes_JavaVersion, CURRENT))) typeNameWithJavaLangReflectType:ownerType_]])) appendWithChar:'.'];
  }
...
void ComGoogleCommonReflectTypes_ParameterizedTypeImpl_initWithJavaLangReflectType_withIOSClass_withJavaLangReflectTypeArray_(ComGoogleCommonReflectTypes_ParameterizedTypeImpl *self, id<JavaLangReflectType> ownerType, IOSClass *rawType, IOSObjectArray *typeArguments) {
  NSObject_init(self);
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(rawType);
  ...
  JreStrongAssign(&self->argumentsList_, ComGoogleCommonReflectTypes_JavaVersion_usedInGenericTypeWithJavaLangReflectTypeArray_(nil_chk(JreLoadStatic(ComGoogleCommonReflectTypes_JavaVersion, CURRENT)), typeArguments));
}
...
withJavaLangReflectMethod:(JavaLangReflectMethod *)method
 withNSObjectArray:(IOSObjectArray *)args {
  ...
  if (typeVariableMethod == nil) {
    @throw create_JavaLangUnsupportedOperationException_initWithNSString_(methodName);
  }
  else {
    @try {
      ...
      ComGoogleCommonCollectImmutableMap_Builder *builder = ComGoogleCommonCollectImmutableMap_builder();
      {
        ...
        while (b__ < e__) {
          ...
          if ([((IOSClass *) nil_chk([((JavaLangReflectMethod *) nil_chk(method)) getDeclaringClass])) isEqual:ComGoogleCommonReflectTypes_TypeVariableImpl_class_()]) {
            ...
            [((ComGoogleCommonCollectImmutableMap_Builder *) nil_chk(builder)) putWithId:[method getName] withId:method];
          }
        }
      }
      JreStrongAssign(&ComGoogleCommonReflectTypes_TypeVariableInvocationHandler_typeVariableMethods, [((ComGoogleCommonCollectImmutableMap_Builder *) nil_chk(builder)) build]);
    }
...
void ComGoogleCommonReflectTypes_TypeVariableInvocationHandler_initWithComGoogleCommonReflectTypes_TypeVariableImpl_(ComGoogleCommonReflectTypes_TypeVariableInvocationHandler *self, ComGoogleCommonReflectTypes_TypeVariableImpl *typeVariableImpl) {
  NSObject_init(self);
  JreStrongAssign(&self->typeVariableImpl_, typeVariableImpl);
}
...
void ComGoogleCommonReflectTypes_TypeVariableImpl_initWithJavaLangReflectGenericDeclaration_withNSString_withJavaLangReflectTypeArray_(ComGoogleCommonReflectTypes_TypeVariableImpl *self, id<JavaLangReflectGenericDeclaration> genericDeclaration, NSString *name, IOSObjectArray *bounds) {
  ...
  JreStrongAssign(&self->genericDeclaration_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(genericDeclaration));
  JreStrongAssign(&self->name_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(name));
  JreStrongAssign(&self->bounds_, ComGoogleCommonCollectImmutableList_copyOfWithNSObjectArray_(bounds));
}
...
- (NSString *)description {
  ...
  for (id<JavaLangReflectType> __strong lowerBound in nil_chk(lowerBounds_)) {
    [((JavaLangStringBuilder *) nil_chk([builder appendWithNSString:@" super "])) appendWithNSString:[((ComGoogleCommonReflectTypes_JavaVersion *) nil_chk(JreLoadStatic(ComGoogleCommonReflectTypes_JavaVersion, CURRENT))) typeNameWithJavaLangReflectType:lowerBound]];
  }
  for (id<JavaLangReflectType> __strong upperBound in nil_chk(ComGoogleCommonReflectTypes_filterUpperBoundsWithJavaLangIterable_(upperBounds_))) {
    [((JavaLangStringBuilder *) nil_chk([builder appendWithNSString:@" extends "])) appendWithNSString:[((ComGoogleCommonReflectTypes_JavaVersion *) nil_chk(JreLoadStatic(ComGoogleCommonReflectTypes_JavaVersion, CURRENT))) typeNameWithJavaLangReflectType:upperBound]];
  }
...
void ComGoogleCommonReflectTypes_WildcardTypeImpl_initWithJavaLangReflectTypeArray_withJavaLangReflectTypeArray_(ComGoogleCommonReflectTypes_WildcardTypeImpl *self, IOSObjectArray *lowerBounds, IOSObjectArray *upperBounds) {
  ...
  JreStrongAssign(&self->lowerBounds_, ComGoogleCommonReflectTypes_JavaVersion_usedInGenericTypeWithJavaLangReflectTypeArray_(nil_chk(JreLoadStatic(ComGoogleCommonReflectTypes_JavaVersion, CURRENT)), lowerBounds));
  JreStrongAssign(&self->upperBounds_, ComGoogleCommonReflectTypes_JavaVersion_usedInGenericTypeWithJavaLangReflectTypeArray_(JreLoadStatic(ComGoogleCommonReflectTypes_JavaVersion, CURRENT), upperBounds));
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonReflectTypes_JavaVersion class]) {
    size_t allocSize = 0;
    size_t objSize_JAVA6 = class_getInstanceSize([ComGoogleCommonReflectTypes_JavaVersion_1 class]);
    allocSize += objSize_JAVA6;
    size_t objSize_JAVA7 = class_getInstanceSize([ComGoogleCommonReflectTypes_JavaVersion_2 class]);
    allocSize += objSize_JAVA7;
    size_t objSize_JAVA8 = class_getInstanceSize([ComGoogleCommonReflectTypes_JavaVersion_3 class]);
    allocSize += objSize_JAVA8;
    uintptr_t ptr = (uintptr_t)calloc(allocSize, 1);
    id e;
    (JreEnum(ComGoogleCommonReflectTypes_JavaVersion, JAVA6) = e = objc_constructInstance([ComGoogleCommonReflectTypes_JavaVersion_1 class], (void *)ptr), ptr += objSize_JAVA6);
    ComGoogleCommonReflectTypes_JavaVersion_1_initWithNSString_withInt_(e, @"JAVA6", 0);
    (JreEnum(ComGoogleCommonReflectTypes_JavaVersion, JAVA7) = e = objc_constructInstance([ComGoogleCommonReflectTypes_JavaVersion_2 class], (void *)ptr), ptr += objSize_JAVA7);
    ComGoogleCommonReflectTypes_JavaVersion_2_initWithNSString_withInt_(e, @"JAVA7", 1);
    (JreEnum(ComGoogleCommonReflectTypes_JavaVersion, JAVA8) = e = objc_constructInstance([ComGoogleCommonReflectTypes_JavaVersion_3 class], (void *)ptr), ptr += objSize_JAVA8);
    ComGoogleCommonReflectTypes_JavaVersion_3_initWithNSString_withInt_(e, @"JAVA8", 2);
    {
      if ([JavaLangReflectAnnotatedElement_class_() isAssignableFrom:JavaLangReflectTypeVariable_class_()]) {
        JreStrongAssign(&ComGoogleCommonReflectTypes_JavaVersion_CURRENT, JreEnum(ComGoogleCommonReflectTypes_JavaVersion, JAVA8));
      }
      else if ([[create_ComGoogleCommonReflectTypes_JavaVersion_4_init() capture] isKindOfClass:[IOSClass class]]) {
        JreStrongAssign(&ComGoogleCommonReflectTypes_JavaVersion_CURRENT, JreEnum(ComGoogleCommonReflectTypes_JavaVersion, JAVA7));
      }
      else {
        JreStrongAssign(&ComGoogleCommonReflectTypes_JavaVersion_CURRENT, JreEnum(ComGoogleCommonReflectTypes_JavaVersion, JAVA6));
      }
    }
...
ComGoogleCommonCollectImmutableList *ComGoogleCommonReflectTypes_JavaVersion_usedInGenericTypeWithJavaLangReflectTypeArray_(ComGoogleCommonReflectTypes_JavaVersion *self, IOSObjectArray *types) {
  ComGoogleCommonCollectImmutableList_Builder *builder = ComGoogleCommonCollectImmutableList_builder();
  {
    ...
    while (b__ < e__) {
      id<JavaLangReflectType> type = *b__++;
      [((ComGoogleCommonCollectImmutableList_Builder *) nil_chk(builder)) addWithId:[self usedInGenericTypeWithJavaLangReflectType:type]];
    }
  }
...
- (id<JavaLangReflectGenericArrayType>)newArrayTypeWithJavaLangReflectType:(id<JavaLangReflectType>)componentType {
  return create_ComGoogleCommonReflectTypes_GenericArrayTypeImpl_initWithJavaLangReflectType_(componentType);
}
...
- (id<JavaLangReflectType>)usedInGenericTypeWithJavaLangReflectType:(id<JavaLangReflectType>)type {
  ...
  if ([type isKindOfClass:[IOSClass class]]) {
    ...
    if ([((IOSClass *) nil_chk(cls)) isArray]) {
      return create_ComGoogleCommonReflectTypes_GenericArrayTypeImpl_initWithJavaLangReflectType_([cls getComponentType]);
    }
  }
  return type;
}
...
- (NSString *)typeNameWithJavaLangReflectType:(id<JavaLangReflectType>)type {
  @try {
    JavaLangReflectMethod *getTypeName = [JavaLangReflectType_class_() getMethod:@"getTypeName" parameterTypes:[IOSObjectArray arrayWithLength:0 type:IOSClass_class_()]];
    return (NSString *) cast_chk([((JavaLangReflectMethod *) nil_chk(getTypeName)) invokeWithId:type withNSObjectArray:[IOSObjectArray arrayWithLength:0 type:NSObject_class_()]], [NSString class]);
  }
  @catch (JavaLangNoSuchMethodException *e) {
    @throw create_JavaLangAssertionError_initWithId_(@"Type.getTypeName should be available in Java 8");
  }
  @catch (JavaLangReflectInvocationTargetException *e) {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonReflectTypes_JavaVersion_4 = { "", "com.google.common.reflect", ptrTable, methods, NULL, 7, 0x8008, 1, 0, 0, -1, -1, 1, -1 };
