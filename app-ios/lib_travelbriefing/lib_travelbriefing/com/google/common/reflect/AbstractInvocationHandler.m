...
//  source: ../target/dependency/com/google/common/reflect/AbstractInvocationHandler.java
//
...
+ (void)initialize {
  if (self == [ComGoogleCommonReflectAbstractInvocationHandler class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonReflectAbstractInvocationHandler_NO_ARGS, [IOSObjectArray newArrayWithObjects:(id[]){  } count:0 type:NSObject_class_()]);
