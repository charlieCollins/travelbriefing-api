...
//  source: ../target/dependency/com/google/common/primitives/UnsignedInts.java
//
...
NSString *ComGoogleCommonPrimitivesUnsignedInts_joinWithNSString_withIntArray_(NSString *separator, IOSIntArray *array) {
  ...
  [builder appendWithNSString:ComGoogleCommonPrimitivesUnsignedInts_toStringWithInt_(IOSIntArray_Get(array, 0))];
  for (jint i = 1; i < array->size_; i++) {
    [((JavaLangStringBuilder *) nil_chk([builder appendWithNSString:separator])) appendWithNSString:ComGoogleCommonPrimitivesUnsignedInts_toStringWithInt_(IOSIntArray_Get(array, i))];
  }
...
jint ComGoogleCommonPrimitivesUnsignedInts_parseUnsignedIntWithNSString_withInt_(NSString *string, jint radix) {
  ...
  if ((result & ComGoogleCommonPrimitivesUnsignedInts_INT_MASK) != result) {
    @throw create_JavaLangNumberFormatException_initWithNSString_(JreStrcat("$$$I$", @"Input ", string, @" in base ", radix, @" is not in the range of an unsigned integer"));
  }
  return (jint) result;
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonPrimitivesUnsignedInts_LexicographicalComparator class]) {
    ...
    for (jint i = 0; i < 1; i++) {
      (ComGoogleCommonPrimitivesUnsignedInts_LexicographicalComparator_values_[i] = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
      ComGoogleCommonPrimitivesUnsignedInts_LexicographicalComparator_initWithNSString_withInt_(e, names[i], i);
    }
