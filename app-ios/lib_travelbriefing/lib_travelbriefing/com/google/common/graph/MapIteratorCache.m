...
//  source: ../target/dependency/com/google/common/graph/MapIteratorCache.java
//
...
- (id<JavaUtilSet>)unmodifiableKeySet {
  return create_ComGoogleCommonGraphMapIteratorCache_1_initWithComGoogleCommonGraphMapIteratorCache_(self);
}
...
- (void)clearCache {
  JreStrongAssign(&entrySetCache_, nil);
}

- (void)dealloc {
  RELEASE_(backingMap_);
  RELEASE_(entrySetCache_);
  [super dealloc];
}
...
- (ComGoogleCommonCollectUnmodifiableIterator *)iterator {
  ...
  return create_ComGoogleCommonGraphMapIteratorCache_1_1_initWithComGoogleCommonGraphMapIteratorCache_1_withJavaUtilIterator_(self, entryIterator);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonGraphMapIteratorCache_1 = { "", "com.google.common.graph", ptrTable, methods, fields, 7, 0x8008, 4, 1, 5, -1, 6, 7, -1 };
...
- (id)next {
  ...
  JreStrongAssign(&this$0_->this$0_->entrySetCache_, entry_);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonGraphMapIteratorCache_1_1 = { "", "com.google.common.graph", ptrTable, methods, fields, 7, 0x8008, 3, 2, 2, -1, 3, 4, -1 };
