...
//  source: ../target/dependency/com/google/common/util/concurrent/ServiceManager.java
//
...
inline ComGoogleCommonUtilConcurrentListenerCallQueue_Callback *ComGoogleCommonUtilConcurrentServiceManager_get_HEALTHY_CALLBACK();
static ComGoogleCommonUtilConcurrentListenerCallQueue_Callback *ComGoogleCommonUtilConcurrentServiceManager_HEALTHY_CALLBACK;
J2OBJC_STATIC_FIELD_OBJ_FINAL(ComGoogleCommonUtilConcurrentServiceManager, HEALTHY_CALLBACK, ComGoogleCommonUtilConcurrentListenerCallQueue_Callback *)

inline ComGoogleCommonUtilConcurrentListenerCallQueue_Callback *ComGoogleCommonUtilConcurrentServiceManager_get_STOPPED_CALLBACK();
static ComGoogleCommonUtilConcurrentListenerCallQueue_Callback *ComGoogleCommonUtilConcurrentServiceManager_STOPPED_CALLBACK;
J2OBJC_STATIC_FIELD_OBJ_FINAL(ComGoogleCommonUtilConcurrentServiceManager, STOPPED_CALLBACK, ComGoogleCommonUtilConcurrentListenerCallQueue_Callback *)

@interface ComGoogleCommonUtilConcurrentServiceManager_1 : ComGoogleCommonUtilConcurrentListenerCallQueue_Callback
...
__attribute__((unused)) static void ComGoogleCommonUtilConcurrentServiceManager_1_initWithNSString_(ComGoogleCommonUtilConcurrentServiceManager_1 *self, NSString *param0);

__attribute__((unused)) static ComGoogleCommonUtilConcurrentServiceManager_1 *new_ComGoogleCommonUtilConcurrentServiceManager_1_initWithNSString_(NSString *param0) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonUtilConcurrentServiceManager_1 *create_ComGoogleCommonUtilConcurrentServiceManager_1_initWithNSString_(NSString *param0);

@interface ComGoogleCommonUtilConcurrentServiceManager_2 : ComGoogleCommonUtilConcurrentListenerCallQueue_Callback
...
__attribute__((unused)) static void ComGoogleCommonUtilConcurrentServiceManager_2_initWithNSString_(ComGoogleCommonUtilConcurrentServiceManager_2 *self, NSString *param0);

__attribute__((unused)) static ComGoogleCommonUtilConcurrentServiceManager_2 *new_ComGoogleCommonUtilConcurrentServiceManager_2_initWithNSString_(NSString *param0) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonUtilConcurrentServiceManager_2 *create_ComGoogleCommonUtilConcurrentServiceManager_2_initWithNSString_(NSString *param0);
...
- (void)fireFailedListenersWithComGoogleCommonUtilConcurrentService:(id<ComGoogleCommonUtilConcurrentService>)service;
...
@interface ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_2 : ComGoogleCommonUtilConcurrentListenerCallQueue_Callback {
 @public
...
__attribute__((unused)) static void ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_2_initWithComGoogleCommonUtilConcurrentService_withNSString_(ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_2 *self, id<ComGoogleCommonUtilConcurrentService> capture$0, NSString *param0);

__attribute__((unused)) static ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_2 *new_ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_2_initWithComGoogleCommonUtilConcurrentService_withNSString_(id<ComGoogleCommonUtilConcurrentService> capture$0, NSString *param0) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_2 *create_ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_2_initWithComGoogleCommonUtilConcurrentService_withNSString_(id<ComGoogleCommonUtilConcurrentService> capture$0, NSString *param0);
...
- (ComGoogleCommonUtilConcurrentServiceManager *)startAsync {
  ...
  for (id<ComGoogleCommonUtilConcurrentService> __strong service in services_) {
    @try {
      ...
      [((id<ComGoogleCommonUtilConcurrentService>) nil_chk(service)) startAsync];
    }
...
- (ComGoogleCommonUtilConcurrentServiceManager *)stopAsync {
  for (id<ComGoogleCommonUtilConcurrentService> __strong service in nil_chk(services_)) {
    [((id<ComGoogleCommonUtilConcurrentService>) nil_chk(service)) stopAsync];
  }
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "HEALTHY_CALLBACK", "LComGoogleCommonUtilConcurrentListenerCallQueue_Callback;", .constantValue.asLong = 0, 0x1a, -1, 13, 14, -1 },
    { "STOPPED_CALLBACK", "LComGoogleCommonUtilConcurrentListenerCallQueue_Callback;", .constantValue.asLong = 0, 0x1a, -1, 15, 14, -1 },
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentServiceManager class]) {
    JreStrongAssign(&ComGoogleCommonUtilConcurrentServiceManager_logger, JavaUtilLoggingLogger_getLoggerWithNSString_([ComGoogleCommonUtilConcurrentServiceManager_class_() getName]));
    JreStrongAssignAndConsume(&ComGoogleCommonUtilConcurrentServiceManager_HEALTHY_CALLBACK, new_ComGoogleCommonUtilConcurrentServiceManager_1_initWithNSString_(@"healthy()"));
    JreStrongAssignAndConsume(&ComGoogleCommonUtilConcurrentServiceManager_STOPPED_CALLBACK, new_ComGoogleCommonUtilConcurrentServiceManager_2_initWithNSString_(@"stopped()"));
...
void ComGoogleCommonUtilConcurrentServiceManager_initWithJavaLangIterable_(ComGoogleCommonUtilConcurrentServiceManager *self, id<JavaLangIterable> services) {
  ...
  if ([((ComGoogleCommonCollectImmutableList *) nil_chk(copy_)) isEmpty]) {
    [((JavaUtilLoggingLogger *) nil_chk(ComGoogleCommonUtilConcurrentServiceManager_logger)) logWithJavaUtilLoggingLevel:JreLoadStatic(JavaUtilLoggingLevel, WARNING) withNSString:@"ServiceManager configured with no services.  Is your application configured properly?" withNSException:create_ComGoogleCommonUtilConcurrentServiceManager_EmptyServiceManagerWarning_init()];
    copy_ = ComGoogleCommonCollectImmutableList_ofWithId_(create_ComGoogleCommonUtilConcurrentServiceManager_NoOpService_init());
  }
  JreStrongAssignAndConsume(&self->state_, new_ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_initWithComGoogleCommonCollectImmutableCollection_(copy_));
  JreStrongAssign(&self->services_, copy_);
  JavaLangRefWeakReference *stateReference = create_JavaLangRefWeakReference_initWithId_(self->state_);
...
- (instancetype)initWithNSString:(NSString *)param0 {
  ComGoogleCommonUtilConcurrentServiceManager_1_initWithNSString_(self, param0);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "LNSString;", "call", "LComGoogleCommonUtilConcurrentServiceManager_Listener;", "LComGoogleCommonUtilConcurrentServiceManager;", "Lcom/google/common/util/concurrent/ListenerCallQueue$Callback<Lcom/google/common/util/concurrent/ServiceManager$Listener;>;" };
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentServiceManager_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, NULL, 7, 0x8008, 2, 0, 3, -1, -1, 4, -1 };
  return &_ComGoogleCommonUtilConcurrentServiceManager_1;
}

@end

void ComGoogleCommonUtilConcurrentServiceManager_1_initWithNSString_(ComGoogleCommonUtilConcurrentServiceManager_1 *self, NSString *param0) {
  ComGoogleCommonUtilConcurrentListenerCallQueue_Callback_initWithNSString_(self, param0);
}

ComGoogleCommonUtilConcurrentServiceManager_1 *new_ComGoogleCommonUtilConcurrentServiceManager_1_initWithNSString_(NSString *param0) {
  J2OBJC_NEW_IMPL(ComGoogleCommonUtilConcurrentServiceManager_1, initWithNSString_, param0)
}

ComGoogleCommonUtilConcurrentServiceManager_1 *create_ComGoogleCommonUtilConcurrentServiceManager_1_initWithNSString_(NSString *param0) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonUtilConcurrentServiceManager_1, initWithNSString_, param0)
}

@implementation ComGoogleCommonUtilConcurrentServiceManager_2

- (instancetype)initWithNSString:(NSString *)param0 {
  ComGoogleCommonUtilConcurrentServiceManager_2_initWithNSString_(self, param0);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "LNSString;", "call", "LComGoogleCommonUtilConcurrentServiceManager_Listener;", "LComGoogleCommonUtilConcurrentServiceManager;", "Lcom/google/common/util/concurrent/ListenerCallQueue$Callback<Lcom/google/common/util/concurrent/ServiceManager$Listener;>;" };
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentServiceManager_2 = { "", "com.google.common.util.concurrent", ptrTable, methods, NULL, 7, 0x8008, 2, 0, 3, -1, -1, 4, -1 };
  return &_ComGoogleCommonUtilConcurrentServiceManager_2;
}

@end

void ComGoogleCommonUtilConcurrentServiceManager_2_initWithNSString_(ComGoogleCommonUtilConcurrentServiceManager_2 *self, NSString *param0) {
  ComGoogleCommonUtilConcurrentListenerCallQueue_Callback_initWithNSString_(self, param0);
}

ComGoogleCommonUtilConcurrentServiceManager_2 *new_ComGoogleCommonUtilConcurrentServiceManager_2_initWithNSString_(NSString *param0) {
  J2OBJC_NEW_IMPL(ComGoogleCommonUtilConcurrentServiceManager_2, initWithNSString_, param0)
}

ComGoogleCommonUtilConcurrentServiceManager_2 *create_ComGoogleCommonUtilConcurrentServiceManager_2_initWithNSString_(NSString *param0) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonUtilConcurrentServiceManager_2, initWithNSString_, param0)
}
...
- (void)tryStartTimingWithComGoogleCommonUtilConcurrentService:(id<ComGoogleCommonUtilConcurrentService>)service {
  ...
  @try {
    ...
    if (stopwatch == nil) {
      [startupTimers_ putWithId:service withId:ComGoogleCommonBaseStopwatch_createStarted()];
    }
  }
  @finally {
    [monitor_ leave];
...
- (void)markReady {
  ...
  @try {
    if (!transitioned_) {
      ...
      @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@", @"Services started transitioning asynchronously before the ServiceManager was constructed: ", servicesInBadStates));
    }
  }
  @finally {
    [monitor_ leave];
...
- (void)addListenerWithComGoogleCommonUtilConcurrentServiceManager_Listener:(ComGoogleCommonUtilConcurrentServiceManager_Listener *)listener
  ...
  [((ComGoogleCommonUtilConcurrentMonitor *) nil_chk(monitor_)) enter];
  @try {
    if (![((ComGoogleCommonUtilConcurrentMonitor_Guard *) nil_chk(stoppedGuard_)) isSatisfied]) {
  ...
  @try {
    for (id<JavaUtilMap_Entry> __strong entry_ in nil_chk([((id<ComGoogleCommonCollectSetMultimap>) nil_chk(servicesByState_)) entries])) {
      if (!([[((id<JavaUtilMap_Entry>) nil_chk(entry_)) getValue] isKindOfClass:[ComGoogleCommonUtilConcurrentServiceManager_NoOpService class]])) {
        [((ComGoogleCommonCollectImmutableSetMultimap_Builder *) nil_chk(builder)) putWithJavaUtilMap_Entry:entry_];
      }
    }
  }
  @finally {
...
- (ComGoogleCommonCollectImmutableMap *)startupTimes {
  ...
  JavaUtilCollections_sortWithJavaUtilList_withJavaUtilComparator_(loadTimes, [((ComGoogleCommonCollectOrdering *) nil_chk(ComGoogleCommonCollectOrdering_natural())) onResultOfWithComGoogleCommonBaseFunction:create_ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_1_init()]);
...
- (void)transitionServiceWithComGoogleCommonUtilConcurrentService:(id<ComGoogleCommonUtilConcurrentService>)service
                   withComGoogleCommonUtilConcurrentService_State:(ComGoogleCommonUtilConcurrentService_State *)from
                   withComGoogleCommonUtilConcurrentService_State:(ComGoogleCommonUtilConcurrentService_State *)to {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(service);
  ...
  @try {
    ...
    if (stopwatch == nil) {
      ...
      [startupTimers_ putWithId:service withId:stopwatch];
    }
    if ([((ComGoogleCommonUtilConcurrentService_State *) nil_chk(to)) compareToWithId:JreLoadEnum(ComGoogleCommonUtilConcurrentService_State, RUNNING)] >= 0 && [((ComGoogleCommonBaseStopwatch *) nil_chk(stopwatch)) isRunning]) {
      ...
      if (!([service isKindOfClass:[ComGoogleCommonUtilConcurrentServiceManager_NoOpService class]])) {
        [((JavaUtilLoggingLogger *) nil_chk(JreLoadStatic(ComGoogleCommonUtilConcurrentServiceManager, logger))) logWithJavaUtilLoggingLevel:JreLoadStatic(JavaUtilLoggingLevel, FINE) withNSString:@"Started {0} in {1}." withNSObjectArray:[IOSObjectArray arrayWithObjects:(id[]){ service, stopwatch } count:2 type:NSObject_class_()]];
      }
    }
    if (to == JreLoadEnum(ComGoogleCommonUtilConcurrentService_State, FAILED)) {
      [self fireFailedListenersWithComGoogleCommonUtilConcurrentService:service];
    }
...
- (void)fireStoppedListeners {
  [((ComGoogleCommonUtilConcurrentListenerCallQueue_Callback *) nil_chk(JreLoadStatic(ComGoogleCommonUtilConcurrentServiceManager, STOPPED_CALLBACK))) enqueueOnWithJavaLangIterable:listeners_];
}

- (void)fireHealthyListeners {
  [((ComGoogleCommonUtilConcurrentListenerCallQueue_Callback *) nil_chk(JreLoadStatic(ComGoogleCommonUtilConcurrentServiceManager, HEALTHY_CALLBACK))) enqueueOnWithJavaLangIterable:listeners_];
}

- (void)fireFailedListenersWithComGoogleCommonUtilConcurrentService:(id<ComGoogleCommonUtilConcurrentService>)service {
  [create_ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_2_initWithComGoogleCommonUtilConcurrentService_withNSString_(service, JreStrcat("$@$", @"failed({service=", service, @"})")) enqueueOnWithJavaLangIterable:listeners_];
}
...
- (void)dealloc {
  RELEASE_(monitor_);
  RELEASE_(servicesByState_);
  RELEASE_(states_);
  RELEASE_(startupTimers_);
  RELEASE_(awaitHealthGuard_);
  RELEASE_(stoppedGuard_);
  RELEASE_(listeners_);
  [super dealloc];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[11].selector = @selector(fireStoppedListeners);
  methods[12].selector = @selector(fireHealthyListeners);
  methods[13].selector = @selector(fireFailedListenersWithComGoogleCommonUtilConcurrentService:);
  methods[14].selector = @selector(executeListeners);
...
void ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_initWithComGoogleCommonCollectImmutableCollection_(ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState *self, ComGoogleCommonCollectImmutableCollection *services) {
  ...
  JreStrongAssign(&self->servicesByState_, [((ComGoogleCommonCollectMultimapBuilder_SetMultimapBuilder *) nil_chk([((ComGoogleCommonCollectMultimapBuilder_MultimapBuilderWithKeys *) nil_chk(ComGoogleCommonCollectMultimapBuilder_enumKeysWithIOSClass_(ComGoogleCommonUtilConcurrentService_State_class_()))) linkedHashSetValues])) build]);
  JreStrongAssign(&self->states_, [((id<ComGoogleCommonCollectSetMultimap>) nil_chk(self->servicesByState_)) keys]);
  JreStrongAssign(&self->startupTimers_, ComGoogleCommonCollectMaps_newIdentityHashMap());
  JreStrongAssignAndConsume(&self->awaitHealthGuard_, new_ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_AwaitHealthGuard_initWithComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_(self));
  JreStrongAssignAndConsume(&self->stoppedGuard_, new_ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_StoppedGuard_initWithComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_(self));
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, NULL, 7, 0x8008, 2, 0, 3, -1, 4, 5, -1 };
...
- (instancetype)initWithComGoogleCommonUtilConcurrentService:(id<ComGoogleCommonUtilConcurrentService>)capture$0
                                                withNSString:(NSString *)param0 {
  ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_2_initWithComGoogleCommonUtilConcurrentService_withNSString_(self, capture$0, param0);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  methods[0].selector = @selector(initWithComGoogleCommonUtilConcurrentService:withNSString:);
  methods[1].selector = @selector(callWithId:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "val$service_", "LComGoogleCommonUtilConcurrentService;", .constantValue.asLong = 0, 0x1012, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "LNSString;", "call", "LComGoogleCommonUtilConcurrentServiceManager_Listener;", "LComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState;", "fireFailedListenersWithComGoogleCommonUtilConcurrentService:", "Lcom/google/common/util/concurrent/ListenerCallQueue$Callback<Lcom/google/common/util/concurrent/ServiceManager$Listener;>;" };
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_2 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 1, 3, -1, 4, 5, -1 };
  return &_ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_2;
}

@end

void ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_2_initWithComGoogleCommonUtilConcurrentService_withNSString_(ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_2 *self, id<ComGoogleCommonUtilConcurrentService> capture$0, NSString *param0) {
  JreStrongAssign(&self->val$service_, capture$0);
  ComGoogleCommonUtilConcurrentListenerCallQueue_Callback_initWithNSString_(self, param0);
}

ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_2 *new_ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_2_initWithComGoogleCommonUtilConcurrentService_withNSString_(id<ComGoogleCommonUtilConcurrentService> capture$0, NSString *param0) {
  J2OBJC_NEW_IMPL(ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_2, initWithComGoogleCommonUtilConcurrentService_withNSString_, capture$0, param0)
}

ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_2 *create_ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_2_initWithComGoogleCommonUtilConcurrentService_withNSString_(id<ComGoogleCommonUtilConcurrentService> capture$0, NSString *param0) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonUtilConcurrentServiceManager_ServiceManagerState_2, initWithComGoogleCommonUtilConcurrentService_withNSString_, capture$0, param0)
}
...
void ComGoogleCommonUtilConcurrentServiceManager_ServiceListener_initWithComGoogleCommonUtilConcurrentService_withJavaLangRefWeakReference_(ComGoogleCommonUtilConcurrentServiceManager_ServiceListener *self, id<ComGoogleCommonUtilConcurrentService> service, JavaLangRefWeakReference *state) {
  ...
  JreStrongAssign(&self->service_, service);
