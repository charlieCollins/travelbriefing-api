...
//  source: ../target/dependency/com/google/common/util/concurrent/AbstractTransformFuture.java
//
...
- (void)run {
  ...
  JreStrongAssign(&inputFuture_, nil);
  JreStrongAssign(&function_, nil);
  id sourceResult;
  @try {
  ...
  @catch (JavaUtilConcurrentExecutionException *e) {
    [self setExceptionWithNSException:[((JavaUtilConcurrentExecutionException *) nil_chk(e)) getCause]];
    return;
  }
  ...
  @catch (JavaLangReflectUndeclaredThrowableException *e) {
    [self setExceptionWithNSException:[((JavaLangReflectUndeclaredThrowableException *) nil_chk(e)) getCause]];
    return;
  }
  @catch (NSException *t) {
...
- (void)afterDone {
  ...
  JreStrongAssign(&self->inputFuture_, nil);
  JreStrongAssign(&self->function_, nil);
}

- (void)dealloc {
  RELEASE_(inputFuture_);
  RELEASE_(function_);
  [super dealloc];
}
...
id<ComGoogleCommonUtilConcurrentListenableFuture> ComGoogleCommonUtilConcurrentAbstractTransformFuture_createWithComGoogleCommonUtilConcurrentListenableFuture_withComGoogleCommonUtilConcurrentAsyncFunction_(id<ComGoogleCommonUtilConcurrentListenableFuture> input, id<ComGoogleCommonUtilConcurrentAsyncFunction> function) {
  ...
  ComGoogleCommonUtilConcurrentAbstractTransformFuture_AsyncTransformFuture *output = create_ComGoogleCommonUtilConcurrentAbstractTransformFuture_AsyncTransformFuture_initWithComGoogleCommonUtilConcurrentListenableFuture_withComGoogleCommonUtilConcurrentAsyncFunction_(input, function);
...
id<ComGoogleCommonUtilConcurrentListenableFuture> ComGoogleCommonUtilConcurrentAbstractTransformFuture_createWithComGoogleCommonUtilConcurrentListenableFuture_withComGoogleCommonBaseFunction_(id<ComGoogleCommonUtilConcurrentListenableFuture> input, id<ComGoogleCommonBaseFunction> function) {
  ...
  ComGoogleCommonUtilConcurrentAbstractTransformFuture_TransformFuture *output = create_ComGoogleCommonUtilConcurrentAbstractTransformFuture_TransformFuture_initWithComGoogleCommonUtilConcurrentListenableFuture_withComGoogleCommonBaseFunction_(input, function);
  [((id<ComGoogleCommonUtilConcurrentListenableFuture>) nil_chk(input)) addListenerWithJavaLangRunnable:output withJavaUtilConcurrentExecutor:ComGoogleCommonUtilConcurrentMoreExecutors_directExecutor()];
  return output;
}
...
void ComGoogleCommonUtilConcurrentAbstractTransformFuture_initWithComGoogleCommonUtilConcurrentListenableFuture_withId_(ComGoogleCommonUtilConcurrentAbstractTransformFuture *self, id<ComGoogleCommonUtilConcurrentListenableFuture> inputFuture, id function) {
  ...
  JreStrongAssign(&self->inputFuture_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(inputFuture));
...
- (id<ComGoogleCommonUtilConcurrentListenableFuture>)doTransformWithId:(id<ComGoogleCommonUtilConcurrentAsyncFunction>)function
  ...
  ComGoogleCommonBasePreconditions_checkNotNullWithId_withId_(outputFuture, @"AsyncFunction.apply returned null instead of a Future. Did you mean to return immediateFuture(null)?");
  return outputFuture;
}
