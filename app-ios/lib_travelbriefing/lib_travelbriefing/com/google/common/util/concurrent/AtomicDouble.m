...
//  source: ../target/dependency/com/google/common/util/concurrent/AtomicDouble.java
//
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentAtomicDouble class]) {
    JreStrongAssign(&ComGoogleCommonUtilConcurrentAtomicDouble_updater, JavaUtilConcurrentAtomicAtomicLongFieldUpdater_newUpdaterWithIOSClass_withNSString_(ComGoogleCommonUtilConcurrentAtomicDouble_class_(), @"value"));
