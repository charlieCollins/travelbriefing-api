...
//  source: ../target/dependency/com/google/common/util/concurrent/ExecutionList.java
//
...
- (void)addWithJavaLangRunnable:(id<JavaLangRunnable>)runnable
 withJavaUtilConcurrentExecutor:(id<JavaUtilConcurrentExecutor>)executor {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_withId_(runnable, @"Runnable was null.");
  ComGoogleCommonBasePreconditions_checkNotNullWithId_withId_(executor, @"Executor was null.");
  @synchronized(self) {
    if (!executed_) {
      JreStrongAssignAndConsume(&runnables_, new_ComGoogleCommonUtilConcurrentExecutionList_RunnableExecutorPair_initWithJavaLangRunnable_withJavaUtilConcurrentExecutor_withComGoogleCommonUtilConcurrentExecutionList_RunnableExecutorPair_(runnable, executor, runnables_));
      return;
    }
  }
...
- (void)execute {
  ...
  @synchronized(self) {
    ...
    executed_ = true;
    list = runnables_;
    JreStrongAssign(&runnables_, nil);
  }
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentExecutionList class]) {
    JreStrongAssign(&ComGoogleCommonUtilConcurrentExecutionList_log, JavaUtilLoggingLogger_getLoggerWithNSString_([ComGoogleCommonUtilConcurrentExecutionList_class_() getName]));
