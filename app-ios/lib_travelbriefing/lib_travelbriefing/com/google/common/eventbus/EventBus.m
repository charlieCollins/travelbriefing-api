...
//  source: ../target/dependency/com/google/common/eventbus/EventBus.java
//
...
withComGoogleCommonEventbusSubscriberExceptionContext:(ComGoogleCommonEventbusSubscriberExceptionContext *)context {
  ...
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(context);
  @try {
...
+ (void)initialize {
  if (self == [ComGoogleCommonEventbusEventBus class]) {
    JreStrongAssign(&ComGoogleCommonEventbusEventBus_logger, JavaUtilLoggingLogger_getLoggerWithNSString_([ComGoogleCommonEventbusEventBus_class_() getName]));
...
void ComGoogleCommonEventbusEventBus_initWithNSString_withJavaUtilConcurrentExecutor_withComGoogleCommonEventbusDispatcher_withComGoogleCommonEventbusSubscriberExceptionHandler_(ComGoogleCommonEventbusEventBus *self, NSString *identifier, id<JavaUtilConcurrentExecutor> executor, ComGoogleCommonEventbusDispatcher *dispatcher, id<ComGoogleCommonEventbusSubscriberExceptionHandler> exceptionHandler) {
  NSObject_init(self);
  JreStrongAssignAndConsume(&self->subscribers_, new_ComGoogleCommonEventbusSubscriberRegistry_initWithComGoogleCommonEventbusEventBus_(self));
  JreStrongAssign(&self->identifier_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(identifier));
  JreStrongAssign(&self->executor_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(executor));
  JreStrongAssign(&self->dispatcher_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(dispatcher));
  JreStrongAssign(&self->exceptionHandler_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(exceptionHandler));
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonEventbusEventBus_LoggingHandler class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonEventbusEventBus_LoggingHandler_INSTANCE, new_ComGoogleCommonEventbusEventBus_LoggingHandler_init());
