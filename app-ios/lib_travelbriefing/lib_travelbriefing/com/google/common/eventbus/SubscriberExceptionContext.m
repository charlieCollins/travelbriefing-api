...
//  source: ../target/dependency/com/google/common/eventbus/SubscriberExceptionContext.java
//
...
void ComGoogleCommonEventbusSubscriberExceptionContext_initWithComGoogleCommonEventbusEventBus_withId_withId_withJavaLangReflectMethod_(ComGoogleCommonEventbusSubscriberExceptionContext *self, ComGoogleCommonEventbusEventBus *eventBus, id event, id subscriber, JavaLangReflectMethod *subscriberMethod) {
  NSObject_init(self);
  JreStrongAssign(&self->eventBus_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(eventBus));
  JreStrongAssign(&self->event_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(event));
  JreStrongAssign(&self->subscriber_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(subscriber));
  JreStrongAssign(&self->subscriberMethod_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(subscriberMethod));
}
