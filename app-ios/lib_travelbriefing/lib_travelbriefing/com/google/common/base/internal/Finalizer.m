...
//  source: ../target/dependency/com/google/common/base/internal/Finalizer.java
//
...
- (void)dealloc {
  RELEASE_(finalizableReferenceClassReference_);
  RELEASE_(frqReference_);
  RELEASE_(queue_);
  [super dealloc];
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonBaseInternalFinalizer class]) {
    JreStrongAssign(&ComGoogleCommonBaseInternalFinalizer_logger, JavaUtilLoggingLogger_getLoggerWithNSString_([ComGoogleCommonBaseInternalFinalizer_class_() getName]));
    JreStrongAssign(&ComGoogleCommonBaseInternalFinalizer_inheritableThreadLocals, ComGoogleCommonBaseInternalFinalizer_getInheritableThreadLocalsField());
...
void ComGoogleCommonBaseInternalFinalizer_startFinalizerWithIOSClass_withJavaLangRefReferenceQueue_withJavaLangRefPhantomReference_(IOSClass *finalizableReferenceClass, JavaLangRefReferenceQueue *queue, JavaLangRefPhantomReference *frqReference) {
  ...
  if (![((NSString *) nil_chk([((IOSClass *) nil_chk(finalizableReferenceClass)) getName])) isEqual:ComGoogleCommonBaseInternalFinalizer_FINALIZABLE_REFERENCE]) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$C", @"Expected ", ComGoogleCommonBaseInternalFinalizer_FINALIZABLE_REFERENCE, '.'));
  }
  ComGoogleCommonBaseInternalFinalizer *finalizer = create_ComGoogleCommonBaseInternalFinalizer_initWithIOSClass_withJavaLangRefReferenceQueue_withJavaLangRefPhantomReference_(finalizableReferenceClass, queue, frqReference);
  JavaLangThread *thread = create_JavaLangThread_initWithJavaLangRunnable_(finalizer);
...
void ComGoogleCommonBaseInternalFinalizer_initWithIOSClass_withJavaLangRefReferenceQueue_withJavaLangRefPhantomReference_(ComGoogleCommonBaseInternalFinalizer *self, IOSClass *finalizableReferenceClass, JavaLangRefReferenceQueue *queue, JavaLangRefPhantomReference *frqReference) {
  ...
  JreStrongAssignAndConsume(&self->finalizableReferenceClassReference_, new_JavaLangRefWeakReference_initWithId_(finalizableReferenceClass));
  JreStrongAssign(&self->frqReference_, frqReference);
}
...
jboolean ComGoogleCommonBaseInternalFinalizer_cleanUpWithJavaLangRefReference_(ComGoogleCommonBaseInternalFinalizer *self, JavaLangRefReference *reference) {
  ...
  do {
    ...
    @try {
      [finalizeReferentMethod invokeWithId:reference withNSObjectArray:[IOSObjectArray arrayWithLength:0 type:NSObject_class_()]];
    }
    @catch (NSException *t) {
...
JavaLangReflectMethod *ComGoogleCommonBaseInternalFinalizer_getFinalizeReferentMethod(ComGoogleCommonBaseInternalFinalizer *self) {
  ...
  @try {
    return [finalizableReferenceClass getMethod:@"finalizeReferent" parameterTypes:[IOSObjectArray arrayWithLength:0 type:IOSClass_class_()]];
  }
