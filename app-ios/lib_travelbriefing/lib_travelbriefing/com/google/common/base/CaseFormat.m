...
//  source: ../target/dependency/com/google/common/base/CaseFormat.java
//
...
__attribute__((unused)) static void ComGoogleCommonBaseCaseFormat_1_initWithComGoogleCommonBaseCharMatcher_withNSString_withNSString_withInt_(ComGoogleCommonBaseCaseFormat_1 *self, ComGoogleCommonBaseCharMatcher *param0, NSString *param1, NSString *__name, jint __ordinal);
...
__attribute__((unused)) static void ComGoogleCommonBaseCaseFormat_2_initWithComGoogleCommonBaseCharMatcher_withNSString_withNSString_withInt_(ComGoogleCommonBaseCaseFormat_2 *self, ComGoogleCommonBaseCharMatcher *param0, NSString *param1, NSString *__name, jint __ordinal);
...
__attribute__((unused)) static void ComGoogleCommonBaseCaseFormat_3_initWithComGoogleCommonBaseCharMatcher_withNSString_withNSString_withInt_(ComGoogleCommonBaseCaseFormat_3 *self, ComGoogleCommonBaseCharMatcher *param0, NSString *param1, NSString *__name, jint __ordinal);
...
__attribute__((unused)) static void ComGoogleCommonBaseCaseFormat_4_initWithComGoogleCommonBaseCharMatcher_withNSString_withNSString_withInt_(ComGoogleCommonBaseCaseFormat_4 *self, ComGoogleCommonBaseCharMatcher *param0, NSString *param1, NSString *__name, jint __ordinal);
...
__attribute__((unused)) static void ComGoogleCommonBaseCaseFormat_5_initWithComGoogleCommonBaseCharMatcher_withNSString_withNSString_withInt_(ComGoogleCommonBaseCaseFormat_5 *self, ComGoogleCommonBaseCharMatcher *param0, NSString *param1, NSString *__name, jint __ordinal);
...
- (NSString *)convertWithComGoogleCommonBaseCaseFormat:(ComGoogleCommonBaseCaseFormat *)format
  ...
  while (true) {
    ...
    if (i == 0) {
      out = create_JavaLangStringBuilder_initWithInt_(((jint) [((NSString *) nil_chk(s)) length]) + 4 * ((jint) [((NSString *) nil_chk(wordSeparator_)) length]));
      [out appendWithNSString:ComGoogleCommonBaseCaseFormat_normalizeFirstWordWithNSString_(nil_chk(format), [s java_substring:i endIndex:j])];
    }
    else {
      [((JavaLangStringBuilder *) nil_chk(out)) appendWithNSString:[((ComGoogleCommonBaseCaseFormat *) nil_chk(format)) normalizeWordWithNSString:[((NSString *) nil_chk(s)) java_substring:i endIndex:j]]];
    }
    [out appendWithNSString:format->wordSeparator_];
    i = j + ((jint) [((NSString *) nil_chk(wordSeparator_)) length]);
  }
...
- (ComGoogleCommonBaseConverter *)converterToWithComGoogleCommonBaseCaseFormat:(ComGoogleCommonBaseCaseFormat *)targetFormat {
  return create_ComGoogleCommonBaseCaseFormat_StringConverter_initWithComGoogleCommonBaseCaseFormat_withComGoogleCommonBaseCaseFormat_(self, targetFormat);
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonBaseCaseFormat class]) {
    size_t allocSize = 0;
    size_t objSize_LOWER_HYPHEN = class_getInstanceSize([ComGoogleCommonBaseCaseFormat_1 class]);
    allocSize += objSize_LOWER_HYPHEN;
    size_t objSize_LOWER_UNDERSCORE = class_getInstanceSize([ComGoogleCommonBaseCaseFormat_2 class]);
    allocSize += objSize_LOWER_UNDERSCORE;
    size_t objSize_LOWER_CAMEL = class_getInstanceSize([ComGoogleCommonBaseCaseFormat_3 class]);
    allocSize += objSize_LOWER_CAMEL;
    size_t objSize_UPPER_CAMEL = class_getInstanceSize([ComGoogleCommonBaseCaseFormat_4 class]);
    allocSize += objSize_UPPER_CAMEL;
    size_t objSize_UPPER_UNDERSCORE = class_getInstanceSize([ComGoogleCommonBaseCaseFormat_5 class]);
    allocSize += objSize_UPPER_UNDERSCORE;
    uintptr_t ptr = (uintptr_t)calloc(allocSize, 1);
    id e;
    (JreEnum(ComGoogleCommonBaseCaseFormat, LOWER_HYPHEN) = e = objc_constructInstance([ComGoogleCommonBaseCaseFormat_1 class], (void *)ptr), ptr += objSize_LOWER_HYPHEN);
    ComGoogleCommonBaseCaseFormat_1_initWithComGoogleCommonBaseCharMatcher_withNSString_withNSString_withInt_(e, ComGoogleCommonBaseCharMatcher_isWithChar_('-'), @"-", @"LOWER_HYPHEN", 0);
    (JreEnum(ComGoogleCommonBaseCaseFormat, LOWER_UNDERSCORE) = e = objc_constructInstance([ComGoogleCommonBaseCaseFormat_2 class], (void *)ptr), ptr += objSize_LOWER_UNDERSCORE);
    ComGoogleCommonBaseCaseFormat_2_initWithComGoogleCommonBaseCharMatcher_withNSString_withNSString_withInt_(e, ComGoogleCommonBaseCharMatcher_isWithChar_('_'), @"_", @"LOWER_UNDERSCORE", 1);
    (JreEnum(ComGoogleCommonBaseCaseFormat, LOWER_CAMEL) = e = objc_constructInstance([ComGoogleCommonBaseCaseFormat_3 class], (void *)ptr), ptr += objSize_LOWER_CAMEL);
    ComGoogleCommonBaseCaseFormat_3_initWithComGoogleCommonBaseCharMatcher_withNSString_withNSString_withInt_(e, ComGoogleCommonBaseCharMatcher_inRangeWithChar_withChar_('A', 'Z'), @"", @"LOWER_CAMEL", 2);
    (JreEnum(ComGoogleCommonBaseCaseFormat, UPPER_CAMEL) = e = objc_constructInstance([ComGoogleCommonBaseCaseFormat_4 class], (void *)ptr), ptr += objSize_UPPER_CAMEL);
    ComGoogleCommonBaseCaseFormat_4_initWithComGoogleCommonBaseCharMatcher_withNSString_withNSString_withInt_(e, ComGoogleCommonBaseCharMatcher_inRangeWithChar_withChar_('A', 'Z'), @"", @"UPPER_CAMEL", 3);
    (JreEnum(ComGoogleCommonBaseCaseFormat, UPPER_UNDERSCORE) = e = objc_constructInstance([ComGoogleCommonBaseCaseFormat_5 class], (void *)ptr), ptr += objSize_UPPER_UNDERSCORE);
    ComGoogleCommonBaseCaseFormat_5_initWithComGoogleCommonBaseCharMatcher_withNSString_withNSString_withInt_(e, ComGoogleCommonBaseCharMatcher_isWithChar_('_'), @"_", @"UPPER_UNDERSCORE", 4);
...
void ComGoogleCommonBaseCaseFormat_initWithComGoogleCommonBaseCharMatcher_withNSString_withNSString_withInt_(ComGoogleCommonBaseCaseFormat *self, ComGoogleCommonBaseCharMatcher *wordBoundary, NSString *wordSeparator, NSString *__name, jint __ordinal) {
  ...
  JreStrongAssign(&self->wordBoundary_, wordBoundary);
  JreStrongAssign(&self->wordSeparator_, wordSeparator);
}
...
NSString *ComGoogleCommonBaseCaseFormat_toWithComGoogleCommonBaseCaseFormat_withNSString_(ComGoogleCommonBaseCaseFormat *self, ComGoogleCommonBaseCaseFormat *format, NSString *str) {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(format);
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(str);
...
void ComGoogleCommonBaseCaseFormat_1_initWithComGoogleCommonBaseCharMatcher_withNSString_withNSString_withInt_(ComGoogleCommonBaseCaseFormat_1 *self, ComGoogleCommonBaseCharMatcher *param0, NSString *param1, NSString *__name, jint __ordinal) {
  ComGoogleCommonBaseCaseFormat_initWithComGoogleCommonBaseCharMatcher_withNSString_withNSString_withInt_(self, param0, param1, __name, __ordinal);
}
...
void ComGoogleCommonBaseCaseFormat_2_initWithComGoogleCommonBaseCharMatcher_withNSString_withNSString_withInt_(ComGoogleCommonBaseCaseFormat_2 *self, ComGoogleCommonBaseCharMatcher *param0, NSString *param1, NSString *__name, jint __ordinal) {
  ComGoogleCommonBaseCaseFormat_initWithComGoogleCommonBaseCharMatcher_withNSString_withNSString_withInt_(self, param0, param1, __name, __ordinal);
}
...
void ComGoogleCommonBaseCaseFormat_3_initWithComGoogleCommonBaseCharMatcher_withNSString_withNSString_withInt_(ComGoogleCommonBaseCaseFormat_3 *self, ComGoogleCommonBaseCharMatcher *param0, NSString *param1, NSString *__name, jint __ordinal) {
  ComGoogleCommonBaseCaseFormat_initWithComGoogleCommonBaseCharMatcher_withNSString_withNSString_withInt_(self, param0, param1, __name, __ordinal);
}
...
void ComGoogleCommonBaseCaseFormat_4_initWithComGoogleCommonBaseCharMatcher_withNSString_withNSString_withInt_(ComGoogleCommonBaseCaseFormat_4 *self, ComGoogleCommonBaseCharMatcher *param0, NSString *param1, NSString *__name, jint __ordinal) {
  ComGoogleCommonBaseCaseFormat_initWithComGoogleCommonBaseCharMatcher_withNSString_withNSString_withInt_(self, param0, param1, __name, __ordinal);
}
...
void ComGoogleCommonBaseCaseFormat_5_initWithComGoogleCommonBaseCharMatcher_withNSString_withNSString_withInt_(ComGoogleCommonBaseCaseFormat_5 *self, ComGoogleCommonBaseCharMatcher *param0, NSString *param1, NSString *__name, jint __ordinal) {
  ComGoogleCommonBaseCaseFormat_initWithComGoogleCommonBaseCharMatcher_withNSString_withNSString_withInt_(self, param0, param1, __name, __ordinal);
}
...
- (void)dealloc {
  RELEASE_(sourceFormat_);
  RELEASE_(targetFormat_);
  [super dealloc];
}
...
void ComGoogleCommonBaseCaseFormat_StringConverter_initWithComGoogleCommonBaseCaseFormat_withComGoogleCommonBaseCaseFormat_(ComGoogleCommonBaseCaseFormat_StringConverter *self, ComGoogleCommonBaseCaseFormat *sourceFormat, ComGoogleCommonBaseCaseFormat *targetFormat) {
  ...
  JreStrongAssign(&self->sourceFormat_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(sourceFormat));
  JreStrongAssign(&self->targetFormat_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(targetFormat));
}
