...
//  source: ../target/dependency/com/google/common/base/Optional.java
//
...
ComGoogleCommonBaseOptional *ComGoogleCommonBaseOptional_ofWithId_(id reference) {
  ComGoogleCommonBaseOptional_initialize();
  return create_ComGoogleCommonBasePresent_initWithId_(ComGoogleCommonBasePreconditions_checkNotNullWithId_(reference));
}

ComGoogleCommonBaseOptional *ComGoogleCommonBaseOptional_fromNullableWithId_(id nullableReference) {
  ComGoogleCommonBaseOptional_initialize();
  return (nullableReference == nil) ? ComGoogleCommonBaseOptional_absent() : create_ComGoogleCommonBasePresent_initWithId_(nullableReference);
}
...
id<JavaLangIterable> ComGoogleCommonBaseOptional_presentInstancesWithJavaLangIterable_(id<JavaLangIterable> optionals) {
  ComGoogleCommonBaseOptional_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(optionals);
  return create_ComGoogleCommonBaseOptional_1_initWithJavaLangIterable_(optionals);
}
...
- (id<JavaUtilIterator>)iterator {
  return create_ComGoogleCommonBaseOptional_1_1_initWithComGoogleCommonBaseOptional_1_(self);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonBaseOptional_1 = { "", "com.google.common.base", ptrTable, methods, fields, 7, 0x8008, 2, 1, 2, -1, 3, 4, -1 };
...
void ComGoogleCommonBaseOptional_1_initWithJavaLangIterable_(ComGoogleCommonBaseOptional_1 *self, id<JavaLangIterable> capture$0) {
  JreStrongAssign(&self->val$optionals_, capture$0);
  NSObject_init(self);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonBaseOptional_1_1 = { "", "com.google.common.base", ptrTable, methods, fields, 7, 0x8008, 2, 1, 2, -1, 3, 4, -1 };
...
void ComGoogleCommonBaseOptional_1_1_initWithComGoogleCommonBaseOptional_1_(ComGoogleCommonBaseOptional_1_1 *self, ComGoogleCommonBaseOptional_1 *outer$) {
  ...
  JreStrongAssign(&self->iterator_, ComGoogleCommonBasePreconditions_checkNotNullWithId_([((id<JavaLangIterable>) nil_chk(outer$->val$optionals_)) iterator]));
}
