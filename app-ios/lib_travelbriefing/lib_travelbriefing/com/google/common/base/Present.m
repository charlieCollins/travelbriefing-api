...
//  source: ../target/dependency/com/google/common/base/Present.java
//
...
- (id)or__WithId:(id)defaultValue {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_withId_(defaultValue, @"use Optional.orNull() instead of Optional.or(null)");
  return reference_;
}

- (ComGoogleCommonBaseOptional *)or__WithComGoogleCommonBaseOptional:(ComGoogleCommonBaseOptional *)secondChoice {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(secondChoice);
  return self;
}
...
- (ComGoogleCommonBaseOptional *)transformWithComGoogleCommonBaseFunction:(id<ComGoogleCommonBaseFunction>)function {
  return create_ComGoogleCommonBasePresent_initWithId_(ComGoogleCommonBasePreconditions_checkNotNullWithId_withId_([((id<ComGoogleCommonBaseFunction>) nil_chk(function)) applyWithId:reference_], @"the Function passed to Optional.transform() must not return null."));
}
