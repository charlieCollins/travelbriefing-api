...
//  source: ../target/dependency/com/google/common/base/Utf8.java
//
    ...
    if (c < (jint) 0x800) {
      ...
      if (JavaLangCharacter_MIN_SURROGATE <= c && c <= JavaLangCharacter_MAX_SURROGATE) {
        if (JavaLangCharacter_codePointAtWithJavaLangCharSequence_withInt_(sequence, i) == c) {
          @throw create_JavaLangIllegalArgumentException_initWithNSString_(ComGoogleCommonBaseUtf8_unpairedSurrogateMsgWithInt_(i));
        }
        i++;
      }
    }
