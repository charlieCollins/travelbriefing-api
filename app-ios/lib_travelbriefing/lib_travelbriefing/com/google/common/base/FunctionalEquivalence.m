...
//  source: ../target/dependency/com/google/common/base/FunctionalEquivalence.java
//
...
- (NSUInteger)hash {
  return ComGoogleCommonBaseObjects_hashCodeWithNSObjectArray_([IOSObjectArray arrayWithObjects:(id[]){ function_, resultEquivalence_ } count:2 type:NSObject_class_()]);
}
...
void ComGoogleCommonBaseFunctionalEquivalence_initWithComGoogleCommonBaseFunction_withComGoogleCommonBaseEquivalence_(ComGoogleCommonBaseFunctionalEquivalence *self, id<ComGoogleCommonBaseFunction> function, ComGoogleCommonBaseEquivalence *resultEquivalence) {
  ...
  JreStrongAssign(&self->resultEquivalence_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(resultEquivalence));
}
