...
//  source: ../target/dependency/com/google/common/io/LittleEndianDataInputStream.java
//
...
- (NSString *)readLine {
  @throw create_JavaLangUnsupportedOperationException_initWithNSString_(@"readLine is not supported");
}
...
- (NSString *)readUTF {
  return [create_JavaIoDataInputStream_initWithJavaIoInputStream_(JreLoadVolatileId(&in_)) readUTF];
}
