...
//  source: ../target/dependency/com/google/common/io/BaseEncoding.java
//
...
- (ComGoogleCommonIoByteSink *)encodingSinkWithComGoogleCommonIoCharSink:(ComGoogleCommonIoCharSink *)encodedSink {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(encodedSink);
  return create_ComGoogleCommonIoBaseEncoding_1_initWithComGoogleCommonIoBaseEncoding_withComGoogleCommonIoCharSink_(self, encodedSink);
}
...
- (IOSByteArray *)decodeWithJavaLangCharSequence:(id<JavaLangCharSequence>)chars {
  ...
  @catch (ComGoogleCommonIoBaseEncoding_DecodingException *badInput) {
    @throw create_JavaLangIllegalArgumentException_initWithNSException_(badInput);
  }
}
...
- (ComGoogleCommonIoByteSource *)decodingSourceWithComGoogleCommonIoCharSource:(ComGoogleCommonIoCharSource *)encodedSource {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(encodedSource);
  return create_ComGoogleCommonIoBaseEncoding_2_initWithComGoogleCommonIoBaseEncoding_withComGoogleCommonIoCharSource_(self, encodedSource);
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonIoBaseEncoding class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonIoBaseEncoding_BASE64, new_ComGoogleCommonIoBaseEncoding_Base64Encoding_initWithNSString_withNSString_withJavaLangCharacter_(@"base64()", @"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", JavaLangCharacter_valueOfWithChar_('=')));
    JreStrongAssignAndConsume(&ComGoogleCommonIoBaseEncoding_BASE64_URL, new_ComGoogleCommonIoBaseEncoding_Base64Encoding_initWithNSString_withNSString_withJavaLangCharacter_(@"base64Url()", @"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_", JavaLangCharacter_valueOfWithChar_('=')));
    JreStrongAssignAndConsume(&ComGoogleCommonIoBaseEncoding_BASE32, new_ComGoogleCommonIoBaseEncoding_StandardBaseEncoding_initWithNSString_withNSString_withJavaLangCharacter_(@"base32()", @"ABCDEFGHIJKLMNOPQRSTUVWXYZ234567", JavaLangCharacter_valueOfWithChar_('=')));
    JreStrongAssignAndConsume(&ComGoogleCommonIoBaseEncoding_BASE32_HEX, new_ComGoogleCommonIoBaseEncoding_StandardBaseEncoding_initWithNSString_withNSString_withJavaLangCharacter_(@"base32Hex()", @"0123456789ABCDEFGHIJKLMNOPQRSTUV", JavaLangCharacter_valueOfWithChar_('=')));
    JreStrongAssignAndConsume(&ComGoogleCommonIoBaseEncoding_BASE16, new_ComGoogleCommonIoBaseEncoding_Base16Encoding_initWithNSString_withNSString_(@"base16()", @"0123456789ABCDEF"));
...
NSString *ComGoogleCommonIoBaseEncoding_encodeWithByteArray_withInt_withInt_(ComGoogleCommonIoBaseEncoding *self, IOSByteArray *bytes, jint off, jint len) {
  ...
  JavaLangStringBuilder *result = create_JavaLangStringBuilder_initWithInt_([self maxEncodedSizeWithInt:len]);
  @try {
...
IOSByteArray *ComGoogleCommonIoBaseEncoding_extractWithByteArray_withInt_(IOSByteArray *result, jint length) {
  ...
  if (length == ((IOSByteArray *) nil_chk(result))->size_) {
    ...
    IOSByteArray *trunc = [IOSByteArray arrayWithLength:length];
...
IOSByteArray *ComGoogleCommonIoBaseEncoding_decodeCheckedWithJavaLangCharSequence_(ComGoogleCommonIoBaseEncoding *self, id<JavaLangCharSequence> chars) {
  ...
  IOSByteArray *tmp = [IOSByteArray arrayWithLength:[self maxDecodedSizeWithInt:[((id<JavaLangCharSequence>) nil_chk(chars)) length]]];
...
JavaIoReader *ComGoogleCommonIoBaseEncoding_ignoringReaderWithJavaIoReader_withComGoogleCommonBaseCharMatcher_(JavaIoReader *delegate, ComGoogleCommonBaseCharMatcher *toIgnore) {
  ...
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(toIgnore);
  return create_ComGoogleCommonIoBaseEncoding_3_initWithComGoogleCommonBaseCharMatcher_withJavaIoReader_(toIgnore, delegate);
}
...
id<JavaLangAppendable> ComGoogleCommonIoBaseEncoding_separatingAppendableWithJavaLangAppendable_withNSString_withInt_(id<JavaLangAppendable> delegate, NSString *separator, jint afterEveryChars) {
  ComGoogleCommonIoBaseEncoding_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(delegate);
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(separator);
  ComGoogleCommonBasePreconditions_checkArgumentWithBoolean_(afterEveryChars > 0);
  return create_ComGoogleCommonIoBaseEncoding_4_initWithInt_withJavaLangAppendable_withNSString_(afterEveryChars, delegate, separator);
}
...
JavaIoWriter *ComGoogleCommonIoBaseEncoding_separatingWriterWithJavaIoWriter_withNSString_withInt_(JavaIoWriter *delegate, NSString *separator, jint afterEveryChars) {
  ...
  return create_ComGoogleCommonIoBaseEncoding_5_initWithJavaLangAppendable_withJavaIoWriter_(seperatingAppendable, delegate);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonIoBaseEncoding_1 = { "", "com.google.common.io", ptrTable, methods, fields, 7, 0x8008, 2, 2, 1, -1, 2, -1, -1 };
...
void ComGoogleCommonIoBaseEncoding_1_initWithComGoogleCommonIoBaseEncoding_withComGoogleCommonIoCharSink_(ComGoogleCommonIoBaseEncoding_1 *self, ComGoogleCommonIoBaseEncoding *outer$, ComGoogleCommonIoCharSink *capture$0) {
  ...
  JreStrongAssign(&self->val$encodedSink_, capture$0);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonIoBaseEncoding_2 = { "", "com.google.common.io", ptrTable, methods, fields, 7, 0x8008, 2, 2, 1, -1, 2, -1, -1 };
...
void ComGoogleCommonIoBaseEncoding_2_initWithComGoogleCommonIoBaseEncoding_withComGoogleCommonIoCharSource_(ComGoogleCommonIoBaseEncoding_2 *self, ComGoogleCommonIoBaseEncoding *outer$, ComGoogleCommonIoCharSource *capture$0) {
  JreStrongAssign(&self->this$0_, outer$);
  JreStrongAssign(&self->val$encodedSource_, capture$0);
...
- (jint)decodeWithChar:(jchar)ch {
  if (ch > ComGoogleCommonBaseAscii_MAX || IOSByteArray_Get(nil_chk(decodabet_), ch) == -1) {
    @throw create_ComGoogleCommonIoBaseEncoding_DecodingException_initWithNSString_(JreStrcat("$@", @"Unrecognized character: ", ([((ComGoogleCommonBaseCharMatcher *) nil_chk(ComGoogleCommonBaseCharMatcher_invisible())) matchesWithChar:ch] ? JreStrcat("$$", @"0x", JavaLangInteger_toHexStringWithInt_(ch)) : (id) JavaLangCharacter_valueOfWithChar_(ch))));
  }
...
- (ComGoogleCommonIoBaseEncoding_Alphabet *)upperCase {
  if (!ComGoogleCommonIoBaseEncoding_Alphabet_hasLowerCase(self)) {
    ...
    IOSCharArray *upperCased = [IOSCharArray arrayWithLength:((IOSCharArray *) nil_chk(chars_))->size_];
    ...
    return create_ComGoogleCommonIoBaseEncoding_Alphabet_initWithNSString_withCharArray_(JreStrcat("$$", name_, @".upperCase()"), upperCased);
  }
}
...
- (ComGoogleCommonIoBaseEncoding_Alphabet *)lowerCase {
  if (!ComGoogleCommonIoBaseEncoding_Alphabet_hasUpperCase(self)) {
    ...
    IOSCharArray *lowerCased = [IOSCharArray arrayWithLength:((IOSCharArray *) nil_chk(chars_))->size_];
    for (jint i = 0; i < chars_->size_; i++) {
      *IOSCharArray_GetRef(lowerCased, i) = ComGoogleCommonBaseAscii_toLowerCaseWithChar_(IOSCharArray_Get(chars_, i));
    }
    return create_ComGoogleCommonIoBaseEncoding_Alphabet_initWithNSString_withCharArray_(JreStrcat("$$", name_, @".lowerCase()"), lowerCased);
  }
}
...
void ComGoogleCommonIoBaseEncoding_Alphabet_initWithNSString_withCharArray_(ComGoogleCommonIoBaseEncoding_Alphabet *self, NSString *name, IOSCharArray *chars) {
  ...
  JreStrongAssign(&self->name_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(name));
  JreStrongAssign(&self->chars_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(chars));
  @try {
  ...
  @catch (JavaLangArithmeticException *e) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_withNSException_(JreStrcat("$I", @"Illegal alphabet length ", chars->size_), e);
  }
  ...
  @catch (JavaLangArithmeticException *e) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_withNSException_(JreStrcat("$$", @"Illegal alphabet ", [NSString java_stringWithCharacters:chars]), e);
  }
  self->mask_ = chars->size_ - 1;
  IOSByteArray *decodabet = [IOSByteArray arrayWithLength:ComGoogleCommonBaseAscii_MAX + 1];
  ...
  JreStrongAssign(&self->decodabet_, decodabet);
  IOSBooleanArray *validPadding = [IOSBooleanArray arrayWithLength:self->charsPerChunk_];
  ...
  JreStrongAssign(&self->validPadding_, validPadding);
}
...
- (JavaIoOutputStream *)encodingStreamWithJavaIoWriter:(JavaIoWriter *)outArg {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(outArg);
  return create_ComGoogleCommonIoBaseEncoding_StandardBaseEncoding_1_initWithComGoogleCommonIoBaseEncoding_StandardBaseEncoding_withJavaIoWriter_(self, outArg);
}
...
- (void)encodeChunkToWithJavaLangAppendable:(id<JavaLangAppendable>)target
  ...
  while (bitsProcessed < len * 8) {
    ...
    [((id<JavaLangAppendable>) nil_chk(target)) appendWithChar:[alphabet_ encodeWithInt:charIndex]];
    bitsProcessed += alphabet_->bitsPerChar_;
  }
  if (paddingChar_ != nil) {
    while (bitsProcessed < alphabet_->bytesPerChunk_ * 8) {
      [((id<JavaLangAppendable>) nil_chk(target)) appendWithChar:[paddingChar_ charValue]];
      bitsProcessed += alphabet_->bitsPerChar_;
    }
  }
}
...
- (jboolean)canDecodeWithJavaLangCharSequence:(id<JavaLangCharSequence>)chars {
  chars = [((ComGoogleCommonBaseCharMatcher *) nil_chk([self padding])) trimTrailingFromWithJavaLangCharSequence:chars];
  if (![((ComGoogleCommonIoBaseEncoding_Alphabet *) nil_chk(alphabet_)) isValidPaddingStartPositionWithInt:[((id<JavaLangCharSequence>) nil_chk(chars)) length]]) {
    return false;
  }
  for (jint i = 0; i < [chars length]; i++) {
...
- (jint)decodeToWithByteArray:(IOSByteArray *)target
  ...
  chars = [((ComGoogleCommonBaseCharMatcher *) nil_chk([self padding])) trimTrailingFromWithJavaLangCharSequence:chars];
  if (![((ComGoogleCommonIoBaseEncoding_Alphabet *) nil_chk(alphabet_)) isValidPaddingStartPositionWithInt:[((id<JavaLangCharSequence>) nil_chk(chars)) length]]) {
    @throw create_ComGoogleCommonIoBaseEncoding_DecodingException_initWithNSString_(JreStrcat("$I", @"Invalid input length ", [chars length]));
  }
  jint bytesWritten = 0;
  for (jint charIdx = 0; charIdx < [chars length]; charIdx += alphabet_->charsPerChunk_) {
    jlong chunk = 0;
...
- (JavaIoInputStream *)decodingStreamWithJavaIoReader:(JavaIoReader *)reader {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(reader);
  return create_ComGoogleCommonIoBaseEncoding_StandardBaseEncoding_2_initWithComGoogleCommonIoBaseEncoding_StandardBaseEncoding_withJavaIoReader_(self, reader);
}
...
- (ComGoogleCommonIoBaseEncoding *)withSeparatorWithNSString:(NSString *)separator
  ...
  return create_ComGoogleCommonIoBaseEncoding_SeparatedBaseEncoding_initWithComGoogleCommonIoBaseEncoding_withNSString_withInt_(self, separator, afterEveryChars);
}
...
- (ComGoogleCommonIoBaseEncoding *)upperCase {
  ...
  if (result == nil) {
    ...
    result = JreStrongAssign(&upperCase_, (upper == alphabet_) ? self : [self newInstanceWithComGoogleCommonIoBaseEncoding_Alphabet:upper withJavaLangCharacter:paddingChar_]);
  }
  return result;
}
...
- (ComGoogleCommonIoBaseEncoding *)lowerCase {
  ...
  if (result == nil) {
    ...
    result = JreStrongAssign(&lowerCase_, (lower == alphabet_) ? self : [self newInstanceWithComGoogleCommonIoBaseEncoding_Alphabet:lower withJavaLangCharacter:paddingChar_]);
  }
  return result;
}
...
- (ComGoogleCommonIoBaseEncoding *)newInstanceWithComGoogleCommonIoBaseEncoding_Alphabet:(ComGoogleCommonIoBaseEncoding_Alphabet *)alphabet
                                                                   withJavaLangCharacter:(JavaLangCharacter *)paddingChar {
  return create_ComGoogleCommonIoBaseEncoding_StandardBaseEncoding_initWithComGoogleCommonIoBaseEncoding_Alphabet_withJavaLangCharacter_(alphabet, paddingChar);
}

- (NSString *)description {
  JavaLangStringBuilder *builder = create_JavaLangStringBuilder_initWithNSString_(@"BaseEncoding.");
  [builder appendWithNSString:[((ComGoogleCommonIoBaseEncoding_Alphabet *) nil_chk(alphabet_)) description]];
  if (8 % alphabet_->bitsPerChar_ != 0) {
    if (paddingChar_ == nil) {
      [builder appendWithNSString:@".omitPadding()"];
    }
    else {
      [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([builder appendWithNSString:@".withPadChar('"])) appendWithId:paddingChar_])) appendWithNSString:@"')"];
    }
  }
...
- (NSUInteger)hash {
  return ((jint) [((ComGoogleCommonIoBaseEncoding_Alphabet *) nil_chk(alphabet_)) hash]) ^ ComGoogleCommonBaseObjects_hashCodeWithNSObjectArray_([IOSObjectArray arrayWithObjects:(id[]){ paddingChar_ } count:1 type:NSObject_class_()]);
}

- (void)dealloc {
  RELEASE_(alphabet_);
  RELEASE_(paddingChar_);
  RELEASE_(upperCase_);
  RELEASE_(lowerCase_);
  [super dealloc];
}
...
void ComGoogleCommonIoBaseEncoding_StandardBaseEncoding_initWithNSString_withNSString_withJavaLangCharacter_(ComGoogleCommonIoBaseEncoding_StandardBaseEncoding *self, NSString *name, NSString *alphabetChars, JavaLangCharacter *paddingChar) {
  ComGoogleCommonIoBaseEncoding_StandardBaseEncoding_initWithComGoogleCommonIoBaseEncoding_Alphabet_withJavaLangCharacter_(self, create_ComGoogleCommonIoBaseEncoding_Alphabet_initWithNSString_withCharArray_(name, [((NSString *) nil_chk(alphabetChars)) java_toCharArray]), paddingChar);
}
...
void ComGoogleCommonIoBaseEncoding_StandardBaseEncoding_initWithComGoogleCommonIoBaseEncoding_Alphabet_withJavaLangCharacter_(ComGoogleCommonIoBaseEncoding_StandardBaseEncoding *self, ComGoogleCommonIoBaseEncoding_Alphabet *alphabet, JavaLangCharacter *paddingChar) {
  ComGoogleCommonIoBaseEncoding_init(self);
  JreStrongAssign(&self->alphabet_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(alphabet));
  ...
  JreStrongAssign(&self->paddingChar_, paddingChar);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonIoBaseEncoding_StandardBaseEncoding_1 = { "", "com.google.common.io", ptrTable, methods, fields, 7, 0x8008, 4, 5, 3, -1, 4, -1, -1 };
  ...
  while (true) {
    ...
    if (readChar == -1) {
      if (!hitPadding_ && ![((ComGoogleCommonIoBaseEncoding_Alphabet *) nil_chk(this$0_->alphabet_)) isValidPaddingStartPositionWithInt:readChars_]) {
        @throw create_ComGoogleCommonIoBaseEncoding_DecodingException_initWithNSString_(JreStrcat("$I", @"Invalid input length ", readChars_));
      }
      return -1;
    }
    readChars_++;
    ...
    if ([((ComGoogleCommonBaseCharMatcher *) nil_chk(paddingMatcher_)) matchesWithChar:ch]) {
      if (!hitPadding_ && (readChars_ == 1 || ![((ComGoogleCommonIoBaseEncoding_Alphabet *) nil_chk(this$0_->alphabet_)) isValidPaddingStartPositionWithInt:readChars_ - 1])) {
        @throw create_ComGoogleCommonIoBaseEncoding_DecodingException_initWithNSString_(JreStrcat("$I", @"Padding cannot start at index ", readChars_));
      }
      hitPadding_ = true;
    }
    else if (hitPadding_) {
      @throw create_ComGoogleCommonIoBaseEncoding_DecodingException_initWithNSString_(JreStrcat("$C$I", @"Expected padding character but found '", ch, @"' at index ", readChars_));
    }
    else {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonIoBaseEncoding_StandardBaseEncoding_2 = { "", "com.google.common.io", ptrTable, methods, fields, 7, 0x8008, 3, 7, 1, -1, 2, -1, -1 };
...
void ComGoogleCommonIoBaseEncoding_StandardBaseEncoding_2_initWithComGoogleCommonIoBaseEncoding_StandardBaseEncoding_withJavaIoReader_(ComGoogleCommonIoBaseEncoding_StandardBaseEncoding_2 *self, ComGoogleCommonIoBaseEncoding_StandardBaseEncoding *outer$, JavaIoReader *capture$0) {
  ...
  JreStrongAssign(&self->paddingMatcher_, [outer$ padding]);
}
...
- (void)encodeToWithJavaLangAppendable:(id<JavaLangAppendable>)target
  ...
  for (jint i = 0; i < len; ++i) {
    ...
    [((id<JavaLangAppendable>) nil_chk(target)) appendWithChar:IOSCharArray_Get(nil_chk(encoding_), b)];
    [target appendWithChar:IOSCharArray_Get(encoding_, b | (jint) 0x100)];
  }
}
...
- (jint)decodeToWithByteArray:(IOSByteArray *)target
     withJavaLangCharSequence:(id<JavaLangCharSequence>)chars {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(target);
  if ([((id<JavaLangCharSequence>) nil_chk(chars)) length] % 2 == 1) {
    @throw create_ComGoogleCommonIoBaseEncoding_DecodingException_initWithNSString_(JreStrcat("$I", @"Invalid input length ", [chars length]));
  }
  jint bytesWritten = 0;
  for (jint i = 0; i < [chars length]; i += 2) {
...
- (ComGoogleCommonIoBaseEncoding *)newInstanceWithComGoogleCommonIoBaseEncoding_Alphabet:(ComGoogleCommonIoBaseEncoding_Alphabet *)alphabet
                                                                   withJavaLangCharacter:(JavaLangCharacter *)paddingChar {
  return create_ComGoogleCommonIoBaseEncoding_Base16Encoding_initWithComGoogleCommonIoBaseEncoding_Alphabet_(alphabet);
}
...
void ComGoogleCommonIoBaseEncoding_Base16Encoding_initWithNSString_withNSString_(ComGoogleCommonIoBaseEncoding_Base16Encoding *self, NSString *name, NSString *alphabetChars) {
  ComGoogleCommonIoBaseEncoding_Base16Encoding_initWithComGoogleCommonIoBaseEncoding_Alphabet_(self, create_ComGoogleCommonIoBaseEncoding_Alphabet_initWithNSString_withCharArray_(name, [((NSString *) nil_chk(alphabetChars)) java_toCharArray]));
}
...
void ComGoogleCommonIoBaseEncoding_Base16Encoding_initWithComGoogleCommonIoBaseEncoding_Alphabet_(ComGoogleCommonIoBaseEncoding_Base16Encoding *self, ComGoogleCommonIoBaseEncoding_Alphabet *alphabet) {
  ...
  JreStrongAssignAndConsume(&self->encoding_, [IOSCharArray newArrayWithLength:512]);
...
- (void)encodeToWithJavaLangAppendable:(id<JavaLangAppendable>)target
  ...
  for (jint remaining = len; remaining >= 3; remaining -= 3) {
    ...
    [((id<JavaLangAppendable>) nil_chk(target)) appendWithChar:[((ComGoogleCommonIoBaseEncoding_Alphabet *) nil_chk(alphabet_)) encodeWithInt:JreURShift32(chunk, 18)]];
    [target appendWithChar:[alphabet_ encodeWithInt:(JreURShift32(chunk, 12)) & (jint) 0x3F]];
    [target appendWithChar:[alphabet_ encodeWithInt:(JreURShift32(chunk, 6)) & (jint) 0x3F]];
    [target appendWithChar:[alphabet_ encodeWithInt:chunk & (jint) 0x3F]];
  }
  if (i < off + len) {
...
- (ComGoogleCommonIoBaseEncoding *)newInstanceWithComGoogleCommonIoBaseEncoding_Alphabet:(ComGoogleCommonIoBaseEncoding_Alphabet *)alphabet
                                                                   withJavaLangCharacter:(JavaLangCharacter *)paddingChar {
  return create_ComGoogleCommonIoBaseEncoding_Base64Encoding_initWithComGoogleCommonIoBaseEncoding_Alphabet_withJavaLangCharacter_(alphabet, paddingChar);
}
...
void ComGoogleCommonIoBaseEncoding_Base64Encoding_initWithNSString_withNSString_withJavaLangCharacter_(ComGoogleCommonIoBaseEncoding_Base64Encoding *self, NSString *name, NSString *alphabetChars, JavaLangCharacter *paddingChar) {
  ComGoogleCommonIoBaseEncoding_Base64Encoding_initWithComGoogleCommonIoBaseEncoding_Alphabet_withJavaLangCharacter_(self, create_ComGoogleCommonIoBaseEncoding_Alphabet_initWithNSString_withCharArray_(name, [((NSString *) nil_chk(alphabetChars)) java_toCharArray]), paddingChar);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonIoBaseEncoding_3 = { "", "com.google.common.io", ptrTable, methods, fields, 7, 0x8008, 4, 2, 3, -1, 4, -1, -1 };
...
void ComGoogleCommonIoBaseEncoding_3_initWithComGoogleCommonBaseCharMatcher_withJavaIoReader_(ComGoogleCommonIoBaseEncoding_3 *self, ComGoogleCommonBaseCharMatcher *capture$0, JavaIoReader *capture$1) {
  JreStrongAssign(&self->val$toIgnore_, capture$0);
  JreStrongAssign(&self->val$delegate_, capture$1);
...
- (id<JavaLangAppendable>)appendWithChar:(jchar)c {
  if (charsUntilSeparator_ == 0) {
    [((id<JavaLangAppendable>) nil_chk(val$delegate_)) appendWithJavaLangCharSequence:val$separator_];
    charsUntilSeparator_ = val$afterEveryChars_;
  }
  [((id<JavaLangAppendable>) nil_chk(val$delegate_)) appendWithChar:c];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonIoBaseEncoding_4 = { "", "com.google.common.io", ptrTable, methods, fields, 7, 0x8008, 4, 4, 5, -1, 6, -1, -1 };
...
void ComGoogleCommonIoBaseEncoding_4_initWithInt_withJavaLangAppendable_withNSString_(ComGoogleCommonIoBaseEncoding_4 *self, jint capture$0, id<JavaLangAppendable> capture$1, NSString *capture$2) {
  ...
  JreStrongAssign(&self->val$delegate_, capture$1);
  JreStrongAssign(&self->val$separator_, capture$2);
  NSObject_init(self);
...
- (void)writeWithInt:(jint)c {
  [((id<JavaLangAppendable>) nil_chk(val$seperatingAppendable_)) appendWithChar:(jchar) c];
}
...
- (void)dealloc {
  RELEASE_(val$seperatingAppendable_);
  RELEASE_(val$delegate_);
  [super dealloc];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonIoBaseEncoding_5 = { "", "com.google.common.io", ptrTable, methods, fields, 7, 0x8008, 5, 2, 4, -1, 5, -1, -1 };
...
void ComGoogleCommonIoBaseEncoding_5_initWithJavaLangAppendable_withJavaIoWriter_(ComGoogleCommonIoBaseEncoding_5 *self, id<JavaLangAppendable> capture$0, JavaIoWriter *capture$1) {
  JreStrongAssign(&self->val$seperatingAppendable_, capture$0);
  JreStrongAssign(&self->val$delegate_, capture$1);
...
- (jint)maxEncodedSizeWithInt:(jint)bytes {
  ...
  return unseparatedSize + ((jint) [((NSString *) nil_chk(separator_)) length]) * ComGoogleCommonMathIntMath_divideWithInt_withInt_withJavaMathRoundingMode_(JavaLangMath_maxWithInt_withInt_(0, unseparatedSize - 1), afterEveryChars_, JreLoadEnum(JavaMathRoundingMode, FLOOR));
}
...
- (ComGoogleCommonIoBaseEncoding *)withSeparatorWithNSString:(NSString *)separator
                                                     withInt:(jint)afterEveryChars {
  @throw create_JavaLangUnsupportedOperationException_initWithNSString_(@"Already have a separator");
}
...
void ComGoogleCommonIoBaseEncoding_SeparatedBaseEncoding_initWithComGoogleCommonIoBaseEncoding_withNSString_withInt_(ComGoogleCommonIoBaseEncoding_SeparatedBaseEncoding *self, ComGoogleCommonIoBaseEncoding *delegate, NSString *separator, jint afterEveryChars) {
  ...
  JreStrongAssign(&self->separator_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(separator));
  ...
  JreStrongAssign(&self->separatorChars_, [((ComGoogleCommonBaseCharMatcher *) nil_chk(ComGoogleCommonBaseCharMatcher_anyOfWithJavaLangCharSequence_(separator))) precomputed]);
}
