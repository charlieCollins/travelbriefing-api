...
FOUNDATION_EXPORT id<JavaUtilCollection> ComGoogleCommonCollectAbstractMapBasedMultimap_unmodifiableCollectionSubclassWithJavaUtilCollection_(id<JavaUtilCollection> collection);
