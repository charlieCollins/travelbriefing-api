...
//  source: ../target/dependency/com/google/common/net/InternetDomainName.java
//
...
+ (void)initialize {
  if (self == [ComGoogleCommonNetInternetDomainName class]) {
    JreStrongAssign(&ComGoogleCommonNetInternetDomainName_DOTS_MATCHER, ComGoogleCommonBaseCharMatcher_anyOfWithJavaLangCharSequence_(@".\u3002\uff0e\uff61"));
    JreStrongAssign(&ComGoogleCommonNetInternetDomainName_DOT_SPLITTER, ComGoogleCommonBaseSplitter_onWithChar_('.'));
    JreStrongAssign(&ComGoogleCommonNetInternetDomainName_DOT_JOINER, ComGoogleCommonBaseJoiner_onWithChar_('.'));
    JreStrongAssign(&ComGoogleCommonNetInternetDomainName_DASH_MATCHER, ComGoogleCommonBaseCharMatcher_anyOfWithJavaLangCharSequence_(@"-_"));
    JreStrongAssign(&ComGoogleCommonNetInternetDomainName_PART_CHAR_MATCHER, [((ComGoogleCommonBaseCharMatcher *) nil_chk(ComGoogleCommonBaseCharMatcher_javaLetterOrDigit())) or__WithComGoogleCommonBaseCharMatcher:ComGoogleCommonNetInternetDomainName_DASH_MATCHER]);
...
void ComGoogleCommonNetInternetDomainName_initWithNSString_(ComGoogleCommonNetInternetDomainName *self, NSString *name) {
  ...
  if ([((NSString *) nil_chk(name)) hasSuffix:@"."]) {
    name = [name java_substring:0 endIndex:((jint) [name length]) - 1];
  }
  ComGoogleCommonBasePreconditions_checkArgumentWithBoolean_withNSString_withId_(((jint) [((NSString *) nil_chk(name)) length]) <= ComGoogleCommonNetInternetDomainName_MAX_LENGTH, @"Domain name too long: '%s':", name);
  JreStrongAssign(&self->name_, name);
  JreStrongAssign(&self->parts_, ComGoogleCommonCollectImmutableList_copyOfWithJavaLangIterable_([((ComGoogleCommonBaseSplitter *) nil_chk(ComGoogleCommonNetInternetDomainName_DOT_SPLITTER)) splitWithJavaLangCharSequence:name]));
...
ComGoogleCommonNetInternetDomainName *ComGoogleCommonNetInternetDomainName_fromWithNSString_(NSString *domain) {
  ...
  return create_ComGoogleCommonNetInternetDomainName_initWithNSString_(ComGoogleCommonBasePreconditions_checkNotNullWithId_(domain));
}
...
jboolean ComGoogleCommonNetInternetDomainName_validatePartWithNSString_withBoolean_(NSString *part, jboolean isFinalPart) {
  ComGoogleCommonNetInternetDomainName_initialize();
  if (((jint) [((NSString *) nil_chk(part)) length]) < 1 || ((jint) [part length]) > ComGoogleCommonNetInternetDomainName_MAX_DOMAIN_PART_LENGTH) {
    return false;
  }
  ...
  if ([((ComGoogleCommonBaseCharMatcher *) nil_chk(ComGoogleCommonNetInternetDomainName_DASH_MATCHER)) matchesWithChar:[part charAtWithInt:0]] || [ComGoogleCommonNetInternetDomainName_DASH_MATCHER matchesWithChar:[part charAtWithInt:((jint) [part length]) - 1]]) {
    return false;
  }
...
jboolean ComGoogleCommonNetInternetDomainName_isValidWithNSString_(NSString *name) {
  ComGoogleCommonNetInternetDomainName_initialize();
  @try {
    ComGoogleCommonNetInternetDomainName_fromWithNSString_(name);
    return true;
  }
