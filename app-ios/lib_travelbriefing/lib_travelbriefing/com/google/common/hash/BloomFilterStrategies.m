...
//  source: ../target/dependency/com/google/common/hash/BloomFilterStrategies.java
//
...
+ (void)initialize {
  if (self == [ComGoogleCommonHashBloomFilterStrategies class]) {
    size_t allocSize = 0;
    size_t objSize_MURMUR128_MITZ_32 = class_getInstanceSize([ComGoogleCommonHashBloomFilterStrategies_1 class]);
    allocSize += objSize_MURMUR128_MITZ_32;
    size_t objSize_MURMUR128_MITZ_64 = class_getInstanceSize([ComGoogleCommonHashBloomFilterStrategies_2 class]);
    allocSize += objSize_MURMUR128_MITZ_64;
    uintptr_t ptr = (uintptr_t)calloc(allocSize, 1);
    id e;
    (JreEnum(ComGoogleCommonHashBloomFilterStrategies, MURMUR128_MITZ_32) = e = objc_constructInstance([ComGoogleCommonHashBloomFilterStrategies_1 class], (void *)ptr), ptr += objSize_MURMUR128_MITZ_32);
    ComGoogleCommonHashBloomFilterStrategies_1_initWithNSString_withInt_(e, @"MURMUR128_MITZ_32", 0);
    (JreEnum(ComGoogleCommonHashBloomFilterStrategies, MURMUR128_MITZ_64) = e = objc_constructInstance([ComGoogleCommonHashBloomFilterStrategies_2 class], (void *)ptr), ptr += objSize_MURMUR128_MITZ_64);
    ComGoogleCommonHashBloomFilterStrategies_2_initWithNSString_withInt_(e, @"MURMUR128_MITZ_64", 1);
...
- (ComGoogleCommonHashBloomFilterStrategies_BitArray *)copy__ {
  return create_ComGoogleCommonHashBloomFilterStrategies_BitArray_initWithLongArray_([((IOSLongArray *) nil_chk(data_)) java_clone]);
}
...
void ComGoogleCommonHashBloomFilterStrategies_BitArray_initWithLong_(ComGoogleCommonHashBloomFilterStrategies_BitArray *self, jlong bits) {
  ComGoogleCommonHashBloomFilterStrategies_BitArray_initWithLongArray_(self, [IOSLongArray arrayWithLength:ComGoogleCommonPrimitivesInts_checkedCastWithLong_(ComGoogleCommonMathLongMath_divideWithLong_withLong_withJavaMathRoundingMode_(bits, 64, JreLoadEnum(JavaMathRoundingMode, CEILING)))]);
}
