...
//  source: ../target/dependency/com/google/common/hash/FarmHashFingerprint64.java
//
...
jlong ComGoogleCommonHashFarmHashFingerprint64_hashLength65PlusWithByteArray_withInt_withInt_(IOSByteArray *bytes, jint offset, jint length) {
  ...
  IOSLongArray *v = [IOSLongArray arrayWithLength:2], *w = [IOSLongArray arrayWithLength:2];
