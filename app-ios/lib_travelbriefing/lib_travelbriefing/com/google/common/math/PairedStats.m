...
//  source: ../target/dependency/com/google/common/math/PairedStats.java
//
...
- (NSUInteger)hash {
  return ComGoogleCommonBaseObjects_hashCodeWithNSObjectArray_([IOSObjectArray arrayWithObjects:(id[]){ xStats_, yStats_, JavaLangDouble_valueOfWithDouble_(sumOfProductsOfDeltas_) } count:3 type:NSObject_class_()]);
}
...
- (IOSByteArray *)toByteArray {
  ...
  [((JavaNioByteBuffer *) nil_chk(buffer)) putDoubleWithDouble:sumOfProductsOfDeltas_];
  return [buffer array];
}
...
void ComGoogleCommonMathPairedStats_initWithComGoogleCommonMathStats_withComGoogleCommonMathStats_withDouble_(ComGoogleCommonMathPairedStats *self, ComGoogleCommonMathStats *xStats, ComGoogleCommonMathStats *yStats, jdouble sumOfProductsOfDeltas) {
  NSObject_init(self);
  JreStrongAssign(&self->xStats_, xStats);
  JreStrongAssign(&self->yStats_, yStats);
...
ComGoogleCommonMathPairedStats *ComGoogleCommonMathPairedStats_fromByteArrayWithByteArray_(IOSByteArray *byteArray) {
  ...
  return create_ComGoogleCommonMathPairedStats_initWithComGoogleCommonMathStats_withComGoogleCommonMathStats_withDouble_(xStats, yStats, sumOfProductsOfDeltas);
}
