...
- (void)drainRegularWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)a {
  ...
  for (; ; ) {
    ...
    if (r == e && [self checkTerminatedWithBoolean:JreLoadVolatileBoolean(&done_) withBoolean:[((IoReactivexInternalQueueSpscLinkedArrayQueue *) nil_chk(q)) isEmpty] withOrgReactivestreamsSubscriber:a withIoReactivexInternalQueueSpscLinkedArrayQueue:q]) {
      return;
    }
...
- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  if (![((JavaUtilConcurrentAtomicAtomicBoolean *) nil_chk(once_)) get] && [once_ compareAndSetWithBoolean:false withBoolean:true]) {
    ...
    IoReactivexInternalSubscriptionsEmptySubscription_errorWithNSException_withOrgReactivestreamsSubscriber_(create_JavaLangIllegalStateException_initWithNSString_(@"This processor allows only a single Subscriber"), s);
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[5].selector = @selector(doTerminate);
  methods[6].selector = @selector(drainRegularWithOrgReactivestreamsSubscriber:);
  methods[7].selector = @selector(drainFusedWithOrgReactivestreamsSubscriber:);
  methods[8].selector = @selector(drain);
  methods[9].selector = @selector(checkTerminatedWithBoolean:withBoolean:withOrgReactivestreamsSubscriber:withIoReactivexInternalQueueSpscLinkedArrayQueue:);
  methods[10].selector = @selector(onSubscribeWithOrgReactivestreamsSubscription:);
  methods[11].selector = @selector(onNextWithId:);
  methods[12].selector = @selector(onErrorWithNSException:);
  methods[13].selector = @selector(onComplete);
  methods[14].selector = @selector(subscribeActualWithOrgReactivestreamsSubscriber:);
  methods[15].selector = @selector(hasSubscribers);
  methods[16].selector = @selector(getThrowable);
  methods[17].selector = @selector(hasComplete);
  methods[18].selector = @selector(hasThrowable);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "queue_", "LIoReactivexInternalQueueSpscLinkedArrayQueue;", .constantValue.asLong = 0, 0x10, -1, -1, 24, -1 },
    { "onTerminate_", "LJavaUtilConcurrentAtomicAtomicReference;", .constantValue.asLong = 0, 0x10, -1, -1, 25, -1 },
    { "done_", "Z", .constantValue.asLong = 0, 0x40, -1, -1, -1, -1 },
    { "error_", "LNSException;", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "actual_", "LJavaUtilConcurrentAtomicAtomicReference;", .constantValue.asLong = 0, 0x10, -1, -1, 26, -1 },
    { "cancelled_", "Z", .constantValue.asLong = 0, 0x40, -1, -1, -1, -1 },
    { "once_", "LJavaUtilConcurrentAtomicAtomicBoolean;", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
    { "wip_", "LIoReactivexInternalSubscriptionsBasicIntQueueSubscription;", .constantValue.asLong = 0, 0x10, -1, -1, 27, -1 },
    { "requested_", "LJavaUtilConcurrentAtomicAtomicLong;", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
    { "enableOperatorFusion_", "Z", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "<T:Ljava/lang/Object;>()Lio/reactivex/processors/UnicastProcessor<TT;>;", (void *)&IoReactivexProcessorsUnicastProcessor__Annotations$0, "create", "I", "<T:Ljava/lang/Object;>(I)Lio/reactivex/processors/UnicastProcessor<TT;>;", (void *)&IoReactivexProcessorsUnicastProcessor__Annotations$1, "ILJavaLangRunnable;", "<T:Ljava/lang/Object;>(ILjava/lang/Runnable;)Lio/reactivex/processors/UnicastProcessor<TT;>;", (void *)&IoReactivexProcessorsUnicastProcessor__Annotations$2, "drainRegular", "LOrgReactivestreamsSubscriber;", "(Lorg/reactivestreams/Subscriber<-TT;>;)V", "drainFused", "checkTerminated", "ZZLOrgReactivestreamsSubscriber;LIoReactivexInternalQueueSpscLinkedArrayQueue;", "(ZZLorg/reactivestreams/Subscriber<-TT;>;Lio/reactivex/internal/queue/SpscLinkedArrayQueue<TT;>;)Z", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "subscribeActual", "Lio/reactivex/internal/queue/SpscLinkedArrayQueue<TT;>;", "Ljava/util/concurrent/atomic/AtomicReference<Ljava/lang/Runnable;>;", "Ljava/util/concurrent/atomic/AtomicReference<Lorg/reactivestreams/Subscriber<-TT;>;>;", "Lio/reactivex/internal/subscriptions/BasicIntQueueSubscription<TT;>;", "LIoReactivexProcessorsUnicastProcessor_UnicastQueueSubscription;", "<T:Ljava/lang/Object;>Lio/reactivex/processors/FlowableProcessor<TT;>;" };
  static const J2ObjcClassInfo _IoReactivexProcessorsUnicastProcessor = { "UnicastProcessor", "io.reactivex.processors", ptrTable, methods, fields, 7, 0x11, 19, 10, -1, 28, -1, 29, -1 };
