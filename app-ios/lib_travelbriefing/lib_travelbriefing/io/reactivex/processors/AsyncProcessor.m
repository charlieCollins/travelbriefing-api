...
//  source: ../target/dependency/io/reactivex/processors/AsyncProcessor.java
//
...
#include "io/reactivex/processors/AsyncProcessor.h"
...
+ (IoReactivexProcessorsAsyncProcessor *)create {
...
- (void)nullOnNext {
  ...
  JreStrongAssign(&error_, ex);
  {
    ...
    while (b__ < e__) {
      ...
      [((IoReactivexProcessorsAsyncProcessor_AsyncSubscription *) nil_chk(as)) onErrorWithNSException:ex];
    }
  }
}
...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  JreStrongAssign(&error_, t);
  {
    ...
    while (b__ < e__) {
      IoReactivexProcessorsAsyncProcessor_AsyncSubscription *as = *b__++;
      [((IoReactivexProcessorsAsyncProcessor_AsyncSubscription *) nil_chk(as)) onErrorWithNSException:t];
    }
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LIoReactivexProcessorsAsyncProcessor;", "(Lorg/reactivestreams/Subscriber<-TT;>;Lio/reactivex/processors/AsyncProcessor<TT;>;)V", "onError", "LNSException;", "Lio/reactivex/processors/AsyncProcessor<TT;>;", "LIoReactivexProcessorsAsyncProcessor;", "<T:Ljava/lang/Object;>Lio/reactivex/internal/subscriptions/DeferredScalarSubscription<TT;>;" };
