...
#include "io/reactivex/observers/ResourceMaybeObserver.h"
#include "java/util/concurrent/atomic/AtomicReference.h"

#pragma clang diagnostic ignored "-Wprotocol"

@interface IoReactivexObserversResourceMaybeObserver () {
 @public
...
J2OBJC_FIELD_SETTER(IoReactivexObserversResourceMaybeObserver, s_, JavaUtilConcurrentAtomicAtomicReference *)
J2OBJC_FIELD_SETTER(IoReactivexObserversResourceMaybeObserver, resources_, IoReactivexInternalDisposablesListCompositeDisposable *)

@implementation IoReactivexObserversResourceMaybeObserver

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  IoReactivexObserversResourceMaybeObserver_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "add", "LIoReactivexDisposablesDisposable;", "onSubscribe", "Ljava/util/concurrent/atomic/AtomicReference<Lio/reactivex/disposables/Disposable;>;", "<T:Ljava/lang/Object;>Ljava/lang/Object;Lio/reactivex/MaybeObserver<TT;>;Lio/reactivex/disposables/Disposable;" };
  static const J2ObjcClassInfo _IoReactivexObserversResourceMaybeObserver = { "ResourceMaybeObserver", "io.reactivex.observers", ptrTable, methods, fields, 7, 0x401, 6, 2, -1, -1, -1, 4, -1 };
  return &_IoReactivexObserversResourceMaybeObserver;
}

@end

void IoReactivexObserversResourceMaybeObserver_init(IoReactivexObserversResourceMaybeObserver *self) {
  NSObject_init(self);
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(IoReactivexObserversResourceMaybeObserver)
