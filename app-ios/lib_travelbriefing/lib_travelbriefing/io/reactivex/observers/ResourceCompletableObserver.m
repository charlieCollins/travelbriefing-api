...
#include "io/reactivex/observers/ResourceCompletableObserver.h"
#include "java/util/concurrent/atomic/AtomicReference.h"

#pragma clang diagnostic ignored "-Wprotocol"

@interface IoReactivexObserversResourceCompletableObserver () {
 @public
...
J2OBJC_FIELD_SETTER(IoReactivexObserversResourceCompletableObserver, s_, JavaUtilConcurrentAtomicAtomicReference *)
J2OBJC_FIELD_SETTER(IoReactivexObserversResourceCompletableObserver, resources_, IoReactivexInternalDisposablesListCompositeDisposable *)

@implementation IoReactivexObserversResourceCompletableObserver

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  IoReactivexObserversResourceCompletableObserver_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "add", "LIoReactivexDisposablesDisposable;", "onSubscribe", "Ljava/util/concurrent/atomic/AtomicReference<Lio/reactivex/disposables/Disposable;>;" };
  static const J2ObjcClassInfo _IoReactivexObserversResourceCompletableObserver = { "ResourceCompletableObserver", "io.reactivex.observers", ptrTable, methods, fields, 7, 0x401, 6, 2, -1, -1, -1, -1, -1 };
  return &_IoReactivexObserversResourceCompletableObserver;
}

@end

void IoReactivexObserversResourceCompletableObserver_init(IoReactivexObserversResourceCompletableObserver *self) {
  NSObject_init(self);
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(IoReactivexObserversResourceCompletableObserver)
