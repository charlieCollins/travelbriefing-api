...
//  source: ../target/dependency/io/reactivex/subjects/BehaviorSubject.java
//
...
#include "io/reactivex/subjects/BehaviorSubject.h"
...
- (void)subscribeActualWithIoReactivexObserver:(id<IoReactivexObserver>)observer {
  ...
  if ([self addWithIoReactivexSubjectsBehaviorSubject_BehaviorDisposable:bs]) {
    ...
    if (IoReactivexInternalUtilNotificationLite_isCompleteWithId_(o)) {
      ...
      [observer onErrorWithNSException:IoReactivexInternalUtilNotificationLite_getErrorWithId_(o)];
    }
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "<T:Ljava/lang/Object;>()Lio/reactivex/subjects/BehaviorSubject<TT;>;", (void *)&IoReactivexSubjectsBehaviorSubject__Annotations$0, "createDefault", "LNSObject;", "<T:Ljava/lang/Object;>(TT;)Lio/reactivex/subjects/BehaviorSubject<TT;>;", (void *)&IoReactivexSubjectsBehaviorSubject__Annotations$1, "(TT;)V", "subscribeActual", "LIoReactivexObserver;", "(Lio/reactivex/Observer<-TT;>;)V", "onSubscribe", "LIoReactivexDisposablesDisposable;", "onNext", "onError", "LNSException;", "()TT;", "getValues", "[LNSObject;", "([TT;)[TT;", "add", "LIoReactivexSubjectsBehaviorSubject_BehaviorDisposable;", "(Lio/reactivex/subjects/BehaviorSubject$BehaviorDisposable<TT;>;)Z", "remove", "(Lio/reactivex/subjects/BehaviorSubject$BehaviorDisposable<TT;>;)V", "terminate", "(Ljava/lang/Object;)[Lio/reactivex/subjects/BehaviorSubject$BehaviorDisposable<TT;>;", "setCurrent", &IoReactivexSubjectsBehaviorSubject_EMPTY_ARRAY, "Ljava/util/concurrent/atomic/AtomicReference<Ljava/lang/Object;>;", "Ljava/util/concurrent/atomic/AtomicReference<[Lio/reactivex/subjects/BehaviorSubject$BehaviorDisposable<TT;>;>;", &IoReactivexSubjectsBehaviorSubject_EMPTY, &IoReactivexSubjectsBehaviorSubject_TERMINATED, "<T:Ljava/lang/Object;>Lio/reactivex/subjects/Subject<TT;>;" };
  static const J2ObjcClassInfo _IoReactivexSubjectsBehaviorSubject = { "BehaviorSubject", "io.reactivex.subjects", ptrTable, methods, fields, 7, 0x11, 22, 10, -1, 20, -1, 32, -1 };
