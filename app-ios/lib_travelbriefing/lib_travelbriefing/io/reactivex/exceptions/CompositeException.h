...
FOUNDATION_EXPORT void IoReactivexExceptionsCompositeException_initWithNSExceptionArray_(IoReactivexExceptionsCompositeException *self, IOSObjectArray *exceptions);

FOUNDATION_EXPORT IoReactivexExceptionsCompositeException *new_IoReactivexExceptionsCompositeException_initWithNSExceptionArray_(IOSObjectArray *exceptions) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT IoReactivexExceptionsCompositeException *create_IoReactivexExceptionsCompositeException_initWithNSExceptionArray_(IOSObjectArray *exceptions);
