...
@implementation IoReactivexInternalObserversFutureSingleObserver

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  IoReactivexInternalObserversFutureSingleObserver_init(self);
  return self;
}
...
- (void)onSuccessWithId:(id)t {
  ...
  [s_ compareAndSetWithId:a withId:self];
  [self countDown];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[7].selector = @selector(onSuccessWithId:);
  ...
  static const void *ptrTable[] = { "cancel", "Z", "LJavaLangInterruptedException;LJavaUtilConcurrentExecutionException;", "()TT;", "get", "JLJavaUtilConcurrentTimeUnit;", "LJavaLangInterruptedException;LJavaUtilConcurrentExecutionException;LJavaUtilConcurrentTimeoutException;", "(JLjava/util/concurrent/TimeUnit;)TT;", "onSubscribe", "LIoReactivexDisposablesDisposable;", "onSuccess", "LNSObject;", "(TT;)V", "onError", "LNSException;", "TT;", "Ljava/util/concurrent/atomic/AtomicReference<Lio/reactivex/disposables/Disposable;>;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/CountDownLatch;Lio/reactivex/SingleObserver<TT;>;Ljava/util/concurrent/Future<TT;>;Lio/reactivex/disposables/Disposable;" };
  static const J2ObjcClassInfo _IoReactivexInternalObserversFutureSingleObserver = { "FutureSingleObserver", "io.reactivex.internal.observers", ptrTable, methods, fields, 7, 0x11, 11, 3, -1, -1, -1, 17, -1 };
  return &_IoReactivexInternalObserversFutureSingleObserver;
}

@end

void IoReactivexInternalObserversFutureSingleObserver_init(IoReactivexInternalObserversFutureSingleObserver *self) {
...
IoReactivexInternalObserversFutureSingleObserver *new_IoReactivexInternalObserversFutureSingleObserver_init() {
  J2OBJC_NEW_IMPL(IoReactivexInternalObserversFutureSingleObserver, init)
}

IoReactivexInternalObserversFutureSingleObserver *create_IoReactivexInternalObserversFutureSingleObserver_init() {
  J2OBJC_CREATE_IMPL(IoReactivexInternalObserversFutureSingleObserver, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(IoReactivexInternalObserversFutureSingleObserver)
