...
//  source: ../target/dependency/io/reactivex/internal/disposables/ObserverFullArbiter.java
//
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[6].selector = @selector(onErrorWithNSException:withIoReactivexDisposablesDisposable:);
  ...
  static const void *ptrTable[] = { "LIoReactivexObserver;LIoReactivexDisposablesDisposable;I", "(Lio/reactivex/Observer<-TT;>;Lio/reactivex/disposables/Disposable;I)V", "setDisposable", "LIoReactivexDisposablesDisposable;", "onNext", "LNSObject;LIoReactivexDisposablesDisposable;", "(TT;Lio/reactivex/disposables/Disposable;)Z", "onError", "LNSException;LIoReactivexDisposablesDisposable;", "onComplete", "Lio/reactivex/Observer<-TT;>;", "Lio/reactivex/internal/queue/SpscLinkedArrayQueue<Ljava/lang/Object;>;", "<T:Ljava/lang/Object;>Lio/reactivex/internal/disposables/FullArbiterPad1;Lio/reactivex/disposables/Disposable;" };
