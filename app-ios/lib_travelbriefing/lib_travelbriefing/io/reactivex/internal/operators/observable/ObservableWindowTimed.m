...
//  source: ../target/dependency/io/reactivex/internal/operators/observable/ObservableWindowTimed.java
//
...
@interface IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_1 : NSObject < JavaLangRunnable > {
 @public
  IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver *this$0_;
  IoReactivexSubjectsUnicastSubject *val$w_;
}
...
- (instancetype)initWithIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver:(IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver *)outer$
                                                                 withIoReactivexSubjectsUnicastSubject:(IoReactivexSubjectsUnicastSubject *)capture$0;

- (void)run;

@end

J2OBJC_EMPTY_STATIC_INIT(IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_1)

__attribute__((unused)) static void IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_1_initWithIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_withIoReactivexSubjectsUnicastSubject_(IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_1 *self, IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver *outer$, IoReactivexSubjectsUnicastSubject *capture$0);

__attribute__((unused)) static IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_1 *new_IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_1_initWithIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_withIoReactivexSubjectsUnicastSubject_(IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver *outer$, IoReactivexSubjectsUnicastSubject *capture$0) NS_RETURNS_RETAINED;

__attribute__((unused)) static IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_1 *create_IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_1_initWithIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_withIoReactivexSubjectsUnicastSubject_(IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver *outer$, IoReactivexSubjectsUnicastSubject *capture$0);

@interface IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_2 : NSObject < JavaLangRunnable > {
 @public
  IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver *this$0_;
  IoReactivexSubjectsUnicastSubject *val$w_;
}
...
J2OBJC_EMPTY_STATIC_INIT(IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_2)

__attribute__((unused)) static void IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_2_initWithIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_withIoReactivexSubjectsUnicastSubject_(IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_2 *self, IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver *outer$, IoReactivexSubjectsUnicastSubject *capture$0);

__attribute__((unused)) static IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_2 *new_IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_2_initWithIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_withIoReactivexSubjectsUnicastSubject_(IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver *outer$, IoReactivexSubjectsUnicastSubject *capture$0) NS_RETURNS_RETAINED;

__attribute__((unused)) static IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_2 *create_IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_2_initWithIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_withIoReactivexSubjectsUnicastSubject_(IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver *outer$, IoReactivexSubjectsUnicastSubject *capture$0);
...
- (void)run {
  ...
  [((id<IoReactivexInternalFuseableSimpleQueue>) nil_chk(queue_)) offerWithId:IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowExactUnboundedObserver_NEXT];
  if ([self enter]) {
    [self drainLoop];
  }
}
  ...
  for (; ; ) {
    for (; ; ) {
      ...
      if (d && (o == nil || o == IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowExactUnboundedObserver_NEXT)) {
        ...
        if (err != nil) {
          [((IoReactivexSubjectsUnicastSubject *) nil_chk(w)) onErrorWithNSException:err];
        }
        else {
  ...
  for (; ; ) {
    for (; ; ) {
      ...
      if (isHolder) {
        ...
        if (producerIndex_ == ((IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowExactBoundedObserver_ConsumerIndexHolder *) nil_chk(consumerIndexHolder))->index_) {
          w = IoReactivexSubjectsUnicastSubject_createWithInt_(bufferSize_);
          JreStrongAssign(&window_, w);
          [((id<IoReactivexObserver>) nil_chk(a)) onNextWithId:w];
        }
...
- (void)run {
  ...
  if (!JreLoadVolatileBoolean(&((IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowExactBoundedObserver *) nil_chk(p))->cancelled_)) {
    [((id<IoReactivexInternalFuseableSimpleQueue>) nil_chk(p->queue_)) offerWithId:self];
  }
  else {
...
- (void)onSubscribeWithIoReactivexDisposablesDisposable:(id<IoReactivexDisposablesDisposable>)s {
  if (IoReactivexInternalDisposablesDisposableHelper_validateWithIoReactivexDisposablesDisposable_withIoReactivexDisposablesDisposable_(self->s_, s)) {
    ...
    [((IoReactivexScheduler_Worker *) nil_chk(worker_)) scheduleWithJavaLangRunnable:create_IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_1_initWithIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_withIoReactivexSubjectsUnicastSubject_(self, w) withLong:timespan_ withJavaUtilConcurrentTimeUnit:unit_];
...
- (void)completeWithIoReactivexSubjectsUnicastSubject:(IoReactivexSubjectsUnicastSubject *)w {
  [((id<IoReactivexInternalFuseableSimpleQueue>) nil_chk(queue_)) offerWithId:create_IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_SubjectWork_initWithIoReactivexSubjectsUnicastSubject_withBoolean_(w, false)];
  if ([self enter]) {
    [self drainLoop];
  }
}
    ...
    for (; ; ) {
      ...
      if (sw) {
        ...
        if (((IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_SubjectWork *) nil_chk(work))->open_) {
          ...
          [((id<IoReactivexObserver>) nil_chk(a)) onNextWithId:w];
          [((IoReactivexScheduler_Worker *) nil_chk(worker_)) scheduleWithJavaLangRunnable:create_IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_2_initWithIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_withIoReactivexSubjectsUnicastSubject_(self, w) withLong:timespan_ withJavaUtilConcurrentTimeUnit:unit_];
        }
        else {
...
- (void)run {
  ...
  if (!JreLoadVolatileBoolean(&cancelled_)) {
    [((id<IoReactivexInternalFuseableSimpleQueue>) nil_chk(queue_)) offerWithId:sw];
  }
  if ([self enter]) {
    [self drainLoop];
  }
...
@implementation IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_1

- (instancetype)initWithIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver:(IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver *)outer$
                                                                 withIoReactivexSubjectsUnicastSubject:(IoReactivexSubjectsUnicastSubject *)capture$0 {
  IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_1_initWithIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_withIoReactivexSubjectsUnicastSubject_(self, outer$, capture$0);
  return self;
}

- (void)run {
  [this$0_ completeWithIoReactivexSubjectsUnicastSubject:val$w_];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "this$0_", "LIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver;", .constantValue.asLong = 0, 0x1012, -1, -1, 0, -1 },
    { "val$w_", "LIoReactivexSubjectsUnicastSubject;", .constantValue.asLong = 0, 0x1012, -1, -1, 1, -1 },
  };
  static const void *ptrTable[] = { "Lio/reactivex/internal/operators/observable/ObservableWindowTimed$WindowSkipObserver<TT;>;", "Lio/reactivex/subjects/UnicastSubject<TT;>;", "LIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver;", "onSubscribeWithIoReactivexDisposablesDisposable:" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_1 = { "", "io.reactivex.internal.operators.observable", ptrTable, methods, fields, 7, 0x8018, 2, 2, 2, -1, 3, -1, -1 };
  return &_IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_1;
}
...
IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_1 *new_IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_1_initWithIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_withIoReactivexSubjectsUnicastSubject_(IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver *outer$, IoReactivexSubjectsUnicastSubject *capture$0) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_1, initWithIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_withIoReactivexSubjectsUnicastSubject_, outer$, capture$0)
}

IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_1 *create_IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_1_initWithIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_withIoReactivexSubjectsUnicastSubject_(IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver *outer$, IoReactivexSubjectsUnicastSubject *capture$0) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_1, initWithIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_withIoReactivexSubjectsUnicastSubject_, outer$, capture$0)
}

@implementation IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_2

- (instancetype)initWithIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver:(IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver *)outer$
                                                                 withIoReactivexSubjectsUnicastSubject:(IoReactivexSubjectsUnicastSubject *)capture$0 {
  IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_2_initWithIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_withIoReactivexSubjectsUnicastSubject_(self, outer$, capture$0);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "Lio/reactivex/internal/operators/observable/ObservableWindowTimed$WindowSkipObserver<TT;>;", "Lio/reactivex/subjects/UnicastSubject<TT;>;", "LIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver;", "drainLoop" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_2 = { "", "io.reactivex.internal.operators.observable", ptrTable, methods, fields, 7, 0x8018, 2, 2, 2, -1, 3, -1, -1 };
  return &_IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_2;
}
...
IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_2 *new_IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_2_initWithIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_withIoReactivexSubjectsUnicastSubject_(IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver *outer$, IoReactivexSubjectsUnicastSubject *capture$0) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_2, initWithIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_withIoReactivexSubjectsUnicastSubject_, outer$, capture$0)
}

IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_2 *create_IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_2_initWithIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_withIoReactivexSubjectsUnicastSubject_(IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver *outer$, IoReactivexSubjectsUnicastSubject *capture$0) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_2, initWithIoReactivexInternalOperatorsObservableObservableWindowTimed_WindowSkipObserver_withIoReactivexSubjectsUnicastSubject_, outer$, capture$0)
}
