...
- (void)onErrorWithNSException:(NSException *)t {
  if (JreLoadVolatileBoolean(&done_) || ![((IoReactivexInternalUtilAtomicThrowable *) nil_chk(errors_)) addThrowableWithNSException:t]) {
    if (!delayErrors_) {
      [self disposeInner];
    }
...
- (void)innerErrorWithIoReactivexInternalOperatorsObservableObservableSwitchMap_SwitchMapInnerObserver:(IoReactivexInternalOperatorsObservableObservableSwitchMap_SwitchMapInnerObserver *)inner
  ...
  if (((IoReactivexInternalOperatorsObservableObservableSwitchMap_SwitchMapInnerObserver *) nil_chk(inner))->index_ == JreLoadVolatileLong(&unique_) && [((IoReactivexInternalUtilAtomicThrowable *) nil_chk(errors_)) addThrowableWithNSException:ex]) {
    if (!delayErrors_) {
      [((id<IoReactivexDisposablesDisposable>) nil_chk(s_)) dispose];
    }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[9].selector = @selector(innerErrorWithIoReactivexInternalOperatorsObservableObservableSwitchMap_SwitchMapInnerObserver:withNSException:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
...
- (void)onErrorWithNSException:(NSException *)t {
  [((IoReactivexInternalOperatorsObservableObservableSwitchMap_SwitchMapObserver *) nil_chk(parent_)) innerErrorWithIoReactivexInternalOperatorsObservableObservableSwitchMap_SwitchMapInnerObserver:self withNSException:t];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexInternalOperatorsObservableObservableSwitchMap_SwitchMapObserver;JI", "(Lio/reactivex/internal/operators/observable/ObservableSwitchMap$SwitchMapObserver<TT;TR;>;JI)V", "onSubscribe", "LIoReactivexDisposablesDisposable;", "onNext", "LNSObject;", "(TR;)V", "onError", "LNSException;", "Lio/reactivex/internal/operators/observable/ObservableSwitchMap$SwitchMapObserver<TT;TR;>;", "Lio/reactivex/internal/queue/SpscLinkedArrayQueue<TR;>;", "LIoReactivexInternalOperatorsObservableObservableSwitchMap;", "<T:Ljava/lang/Object;R:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicReference<Lio/reactivex/disposables/Disposable;>;Lio/reactivex/Observer<TR;>;" };
