...
//  source: ../target/dependency/io/reactivex/internal/operators/observable/ObservableWindow.java
//
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexObserver;JI", "(Lio/reactivex/Observer<-Lio/reactivex/Observable<TT;>;>;JI)V", "onSubscribe", "LIoReactivexDisposablesDisposable;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lio/reactivex/Observer<-Lio/reactivex/Observable<TT;>;>;", "Lio/reactivex/subjects/UnicastSubject<TT;>;", "LIoReactivexInternalOperatorsObservableObservableWindow;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicInteger;Lio/reactivex/Observer<TT;>;Lio/reactivex/disposables/Disposable;Ljava/lang/Runnable;" };
...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  while (![((JavaUtilArrayDeque *) nil_chk(ws)) isEmpty]) {
    [((IoReactivexSubjectsUnicastSubject *) nil_chk([ws poll])) onErrorWithNSException:t];
  }
  [((id<IoReactivexObserver>) nil_chk(actual_)) onErrorWithNSException:t];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexObserver;JJI", "(Lio/reactivex/Observer<-Lio/reactivex/Observable<TT;>;>;JJI)V", "onSubscribe", "LIoReactivexDisposablesDisposable;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lio/reactivex/Observer<-Lio/reactivex/Observable<TT;>;>;", "Ljava/util/ArrayDeque<Lio/reactivex/subjects/UnicastSubject<TT;>;>;", "LIoReactivexInternalOperatorsObservableObservableWindow;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicBoolean;Lio/reactivex/Observer<TT;>;Lio/reactivex/disposables/Disposable;Ljava/lang/Runnable;" };
