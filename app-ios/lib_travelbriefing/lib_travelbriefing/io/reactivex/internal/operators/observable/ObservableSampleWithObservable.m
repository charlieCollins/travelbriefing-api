...
//  source: ../target/dependency/io/reactivex/internal/operators/observable/ObservableSampleWithObservable.java
//
...
- (void)onErrorWithNSException:(NSException *)t {
  [((IoReactivexInternalOperatorsObservableObservableSampleWithObservable_SampleMainObserver *) nil_chk(parent_)) errorWithNSException:t];
}
