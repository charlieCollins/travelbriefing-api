...
//  source: ../target/dependency/io/reactivex/internal/operators/observable/ObservableDebounce.java
//
...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  done_ = true;
  [((IoReactivexInternalOperatorsObservableObservableDebounce_DebounceObserver *) nil_chk(parent_)) onErrorWithNSException:t];
}
