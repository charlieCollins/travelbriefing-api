...
//  source: ../target/dependency/io/reactivex/internal/operators/observable/ObservableDistinct.java
//
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexObserver;LIoReactivexFunctionsFunction;LJavaUtilCollection;", "(Lio/reactivex/Observer<-TT;>;Lio/reactivex/functions/Function<-TT;TK;>;Ljava/util/Collection<-TK;>;)V", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "requestFusion", "I", "LJavaLangException;", "()TT;", "Ljava/util/Collection<-TK;>;", "Lio/reactivex/functions/Function<-TT;TK;>;", "LIoReactivexInternalOperatorsObservableObservableDistinct;", "<T:Ljava/lang/Object;K:Ljava/lang/Object;>Lio/reactivex/internal/observers/BasicFuseableObserver<TT;TT;>;" };
