...
//  source: ../target/dependency/io/reactivex/internal/operators/observable/ObservableObserveOn.java
//
...
- (void)drainFused {
  ...
  for (; ; ) {
    ...
    if (!delayError_ && d && ex != nil) {
      [((id<IoReactivexObserver>) nil_chk(actual_)) onErrorWithNSException:error_];
      [((IoReactivexScheduler_Worker *) nil_chk(worker_)) dispose];
      return;
    }
