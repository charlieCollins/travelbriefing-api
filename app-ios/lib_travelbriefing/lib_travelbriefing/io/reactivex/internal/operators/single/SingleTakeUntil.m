...
//  source: ../target/dependency/io/reactivex/internal/operators/single/SingleTakeUntil.java
//
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[6].selector = @selector(otherErrorWithNSException:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
...
- (void)onNextWithId:(id)t {
  if (IoReactivexInternalSubscriptionsSubscriptionHelper_cancelWithJavaUtilConcurrentAtomicAtomicReference_(self)) {
    [((IoReactivexInternalOperatorsSingleSingleTakeUntil_TakeUntilMainObserver *) nil_chk(parent_)) otherErrorWithNSException:create_JavaUtilConcurrentCancellationException_init()];
  }
}

- (void)onErrorWithNSException:(NSException *)t {
  [((IoReactivexInternalOperatorsSingleSingleTakeUntil_TakeUntilMainObserver *) nil_chk(parent_)) otherErrorWithNSException:t];
}
