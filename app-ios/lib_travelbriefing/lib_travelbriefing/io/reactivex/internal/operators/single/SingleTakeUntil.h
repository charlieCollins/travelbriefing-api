...
@interface IoReactivexInternalOperatorsSingleSingleTakeUntil_TakeUntilOtherSubscriber : JavaUtilConcurrentAtomicAtomicReference < OrgReactivestreamsSubscriber > {
 @public
