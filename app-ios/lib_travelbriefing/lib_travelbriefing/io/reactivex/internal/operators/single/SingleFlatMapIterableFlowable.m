  ...
  for (; ; ) {
    if (iter != nil) {
      ...
      if (r == JavaLangLong_MAX_VALUE) {
        [self slowPathWithOrgReactivestreamsSubscriber:a withJavaUtilIterator:iter];
        return;
      }
      while (e != r) {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LIoReactivexFunctionsFunction;", "(Lorg/reactivestreams/Subscriber<-TR;>;Lio/reactivex/functions/Function<-TT;+Ljava/lang/Iterable<+TR;>;>;)V", "onSubscribe", "LIoReactivexDisposablesDisposable;", "onSuccess", "LNSObject;", "(TT;)V", "onError", "LNSException;", "request", "J", "slowPath", "LOrgReactivestreamsSubscriber;LJavaUtilIterator;", "(Lorg/reactivestreams/Subscriber<-TR;>;Ljava/util/Iterator<+TR;>;)V", "requestFusion", "I", "LJavaLangException;", "()TR;", "Lorg/reactivestreams/Subscriber<-TR;>;", "Lio/reactivex/functions/Function<-TT;+Ljava/lang/Iterable<+TR;>;>;", "Ljava/util/Iterator<+TR;>;", "LIoReactivexInternalOperatorsSingleSingleFlatMapIterableFlowable;", "<T:Ljava/lang/Object;R:Ljava/lang/Object;>Lio/reactivex/internal/subscriptions/BasicIntQueueSubscription<TR;>;Lio/reactivex/SingleObserver<TT;>;" };
