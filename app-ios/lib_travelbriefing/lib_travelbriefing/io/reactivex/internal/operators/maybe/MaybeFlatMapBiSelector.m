...
- (void)onSuccessWithId:(id)value {
  ...
  @catch (NSException *ex) {
    ...
    [((id<IoReactivexMaybeObserver>) nil_chk(((IoReactivexInternalOperatorsMaybeMaybeFlatMapBiSelector_FlatMapBiMainObserver_InnerObserver *) nil_chk(inner_))->actual_)) onErrorWithNSException:ex];
    return;
  }
...
- (void)onErrorWithNSException:(NSException *)e {
  [((id<IoReactivexMaybeObserver>) nil_chk(((IoReactivexInternalOperatorsMaybeMaybeFlatMapBiSelector_FlatMapBiMainObserver_InnerObserver *) nil_chk(inner_))->actual_)) onErrorWithNSException:e];
}
