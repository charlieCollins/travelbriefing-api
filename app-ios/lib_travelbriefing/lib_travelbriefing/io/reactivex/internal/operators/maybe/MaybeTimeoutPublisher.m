...
- (void)onErrorWithNSException:(NSException *)e {
  [((IoReactivexInternalOperatorsMaybeMaybeTimeoutPublisher_TimeoutMainMaybeObserver *) nil_chk(parent_)) otherErrorWithNSException:e];
}
