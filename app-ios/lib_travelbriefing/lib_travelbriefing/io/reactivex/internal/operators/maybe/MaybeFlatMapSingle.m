...
inline jlong IoReactivexInternalOperatorsMaybeMaybeFlatMapSingle_FlatMapMaybeObserver_get_serialVersionUID();
...
- (void)subscribeActualWithIoReactivexSingleObserver:(id<IoReactivexSingleObserver>)actual {
  [((id<IoReactivexMaybeSource>) nil_chk(source_)) subscribeWithIoReactivexMaybeObserver:create_IoReactivexInternalOperatorsMaybeMaybeFlatMapSingle_FlatMapMaybeObserver_initWithIoReactivexSingleObserver_withIoReactivexFunctionsFunction_(actual, mapper_)];
}
...
- (void)onSuccessWithId:(id)value {
  ...
  if (![self isDisposed]) {
    [((id<IoReactivexSingleSource>) nil_chk(ss)) subscribeWithIoReactivexSingleObserver:create_IoReactivexInternalOperatorsMaybeMaybeFlatMapSingle_FlatMapSingleObserver_initWithJavaUtilConcurrentAtomicAtomicReference_withIoReactivexSingleObserver_(self, actual_)];
  }
}
...
- (instancetype)initWithJavaUtilConcurrentAtomicAtomicReference:(JavaUtilConcurrentAtomicAtomicReference *)parent
  ...
  IoReactivexInternalOperatorsMaybeMaybeFlatMapSingle_FlatMapSingleObserver_initWithJavaUtilConcurrentAtomicAtomicReference_withIoReactivexSingleObserver_(self, parent, actual);
  return self;
}
...
IoReactivexInternalOperatorsMaybeMaybeFlatMapSingle_FlatMapSingleObserver *new_IoReactivexInternalOperatorsMaybeMaybeFlatMapSingle_FlatMapSingleObserver_initWithJavaUtilConcurrentAtomicAtomicReference_withIoReactivexSingleObserver_(JavaUtilConcurrentAtomicAtomicReference *parent, id<IoReactivexSingleObserver> actual) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsMaybeMaybeFlatMapSingle_FlatMapSingleObserver, initWithJavaUtilConcurrentAtomicAtomicReference_withIoReactivexSingleObserver_, parent, actual)
}
...
IoReactivexInternalOperatorsMaybeMaybeFlatMapSingle_FlatMapSingleObserver *create_IoReactivexInternalOperatorsMaybeMaybeFlatMapSingle_FlatMapSingleObserver_initWithJavaUtilConcurrentAtomicAtomicReference_withIoReactivexSingleObserver_(JavaUtilConcurrentAtomicAtomicReference *parent, id<IoReactivexSingleObserver> actual) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsMaybeMaybeFlatMapSingle_FlatMapSingleObserver, initWithJavaUtilConcurrentAtomicAtomicReference_withIoReactivexSingleObserver_, parent, actual)
}
