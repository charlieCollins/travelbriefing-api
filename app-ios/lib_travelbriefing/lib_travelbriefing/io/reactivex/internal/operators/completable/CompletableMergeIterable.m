...
- (void)subscribeActualWithIoReactivexCompletableObserver:(id<IoReactivexCompletableObserver>)s {
  ...
  for (; ; ) {
    ...
    @catch (NSException *e) {
      IoReactivexExceptionsExceptions_throwIfFatalWithNSException_(e);
      [set dispose];
      [shared onErrorWithNSException:e];
      return;
    }
    if (!b) {
      break;
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexCompletableObserver;LIoReactivexDisposablesCompositeDisposable;LJavaUtilConcurrentAtomicAtomicInteger;", "onSubscribe", "LIoReactivexDisposablesDisposable;", "onError", "LNSException;", "LIoReactivexInternalOperatorsCompletableCompletableMergeIterable;" };
