...
//  source: ../target/dependency/io/reactivex/internal/operators/completable/CompletableDisposeOn.java
//
...
- (void)onErrorWithNSException:(NSException *)e {
  ...
  [((id<IoReactivexCompletableObserver>) nil_chk(s_)) onErrorWithNSException:e];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexCompletableObserver;LIoReactivexScheduler;", "onError", "LNSException;", "onSubscribe", "LIoReactivexDisposablesDisposable;", "LIoReactivexInternalOperatorsCompletableCompletableDisposeOn;" };
