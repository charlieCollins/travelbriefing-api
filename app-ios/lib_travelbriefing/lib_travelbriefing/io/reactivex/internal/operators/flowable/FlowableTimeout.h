...
FOUNDATION_EXPORT IoReactivexInternalOperatorsFlowableFlowableTimeout *new_IoReactivexInternalOperatorsFlowableFlowableTimeout_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withOrgReactivestreamsPublisher_(id<OrgReactivestreamsPublisher> source, id<OrgReactivestreamsPublisher> firstTimeoutIndicator, id<IoReactivexFunctionsFunction> itemTimeoutIndicator, id<OrgReactivestreamsPublisher> other) NS_RETURNS_RETAINED;
...
@interface IoReactivexInternalOperatorsFlowableFlowableTimeout_TimeoutSubscriber : NSObject < OrgReactivestreamsSubscriber, OrgReactivestreamsSubscription, IoReactivexInternalOperatorsFlowableFlowableTimeout_OnTimeout > {
 @public
...
@interface IoReactivexInternalOperatorsFlowableFlowableTimeout_TimeoutOtherSubscriber : NSObject < OrgReactivestreamsSubscriber, IoReactivexDisposablesDisposable, IoReactivexInternalOperatorsFlowableFlowableTimeout_OnTimeout > {
 @public
  id<OrgReactivestreamsSubscriber> actual_;
  id<OrgReactivestreamsPublisher> firstTimeoutIndicator_;
  id<IoReactivexFunctionsFunction> itemTimeoutIndicator_;
