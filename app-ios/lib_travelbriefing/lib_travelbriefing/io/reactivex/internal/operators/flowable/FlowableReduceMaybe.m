...
//  source: ../target/dependency/io/reactivex/internal/operators/flowable/FlowableReduceMaybe.java
//
...
- (IoReactivexFlowable *)fuseToFlowable {
  return IoReactivexPluginsRxJavaPlugins_onAssemblyWithIoReactivexFlowable_(create_IoReactivexInternalOperatorsFlowableFlowableReduce_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsBiFunction_(source_, reducer_));
}

- (void)subscribeActualWithIoReactivexMaybeObserver:(id<IoReactivexMaybeObserver>)observer {
  [((IoReactivexFlowable *) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableReduceMaybe_ReduceSubscriber_initWithIoReactivexMaybeObserver_withIoReactivexFunctionsBiFunction_(observer, reducer_)];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexMaybeObserver;LIoReactivexFunctionsBiFunction;", "(Lio/reactivex/MaybeObserver<-TT;>;Lio/reactivex/functions/BiFunction<TT;TT;TT;>;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lio/reactivex/MaybeObserver<-TT;>;", "Lio/reactivex/functions/BiFunction<TT;TT;TT;>;", "TT;", "LIoReactivexInternalOperatorsFlowableFlowableReduceMaybe;", "<T:Ljava/lang/Object;>Ljava/lang/Object;Lorg/reactivestreams/Subscriber<TT;>;Lio/reactivex/disposables/Disposable;" };
