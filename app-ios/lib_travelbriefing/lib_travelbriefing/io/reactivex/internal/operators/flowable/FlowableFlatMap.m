...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableFlatMap_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withBoolean_withInt_withInt_(self, source, mapper, delayErrors, maxConcurrency, bufferSize);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LOrgReactivestreamsSubscriber;", 0x9, 5, 6, -1, 7, -1, -1 },
  };
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsPublisher;LIoReactivexFunctionsFunction;ZII", "(Lorg/reactivestreams/Publisher<TT;>;Lio/reactivex/functions/Function<-TT;+Lorg/reactivestreams/Publisher<+TU;>;>;ZII)V", "subscribeActual", "LOrgReactivestreamsSubscriber;", "(Lorg/reactivestreams/Subscriber<-TU;>;)V", "subscribe", "LOrgReactivestreamsSubscriber;LIoReactivexFunctionsFunction;ZII", "<T:Ljava/lang/Object;U:Ljava/lang/Object;>(Lorg/reactivestreams/Subscriber<-TU;>;Lio/reactivex/functions/Function<-TT;+Lorg/reactivestreams/Publisher<+TU;>;>;ZII)Lorg/reactivestreams/Subscriber<TT;>;", "Lio/reactivex/functions/Function<-TT;+Lorg/reactivestreams/Publisher<+TU;>;>;", "LIoReactivexInternalOperatorsFlowableFlowableFlatMap_MergeSubscriber;LIoReactivexInternalOperatorsFlowableFlowableFlatMap_InnerSubscriber;", "<T:Ljava/lang/Object;U:Ljava/lang/Object;>Lio/reactivex/internal/operators/flowable/AbstractFlowableWithUpstream<TT;TU;>;" };
...
IoReactivexInternalOperatorsFlowableFlowableFlatMap *new_IoReactivexInternalOperatorsFlowableFlowableFlatMap_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withBoolean_withInt_withInt_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> mapper, jboolean delayErrors, jint maxConcurrency, jint bufferSize) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableFlatMap, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withBoolean_withInt_withInt_, source, mapper, delayErrors, maxConcurrency, bufferSize)
}
...
IoReactivexInternalOperatorsFlowableFlowableFlatMap *create_IoReactivexInternalOperatorsFlowableFlowableFlatMap_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withBoolean_withInt_withInt_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> mapper, jboolean delayErrors, jint maxConcurrency, jint bufferSize) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableFlatMap, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withBoolean_withInt_withInt_, source, mapper, delayErrors, maxConcurrency, bufferSize)
}
...
- (void)onNextWithId:(id)t {
  ...
  if ([JavaUtilConcurrentCallable_class_() isInstance:p]) {
    ...
    @catch (NSException *ex) {
      ...
      [((IoReactivexInternalUtilAtomicThrowable *) nil_chk(errs_)) addThrowableWithNSException:ex];
      [self drain];
      return;
    }
    if (u != nil) {
  ...
  if ([self get] == 0 && [self compareAndSetWithInt:0 withInt:1]) {
    ...
    if (r != 0LL && (q == nil || [q isEmpty])) {
      ...
      if (![((id<IoReactivexInternalFuseableSimpleQueue>) nil_chk(q)) offerWithId:value]) {
        [self onErrorWithNSException:create_JavaLangIllegalStateException_initWithNSString_(@"Scalar queue full?!")];
        return;
      }
    }
...
withIoReactivexInternalOperatorsFlowableFlowableFlatMap_InnerSubscriber:(IoReactivexInternalOperatorsFlowableFlowableFlatMap_InnerSubscriber *)inner {
  if ([self get] == 0 && [self compareAndSetWithInt:0 withInt:1]) {
    ...
    if (r != 0LL && (q == nil || [q isEmpty])) {
      ...
      if (![((id<IoReactivexInternalFuseableSimpleQueue>) nil_chk(q)) offerWithId:value]) {
        [self onErrorWithNSException:create_IoReactivexExceptionsMissingBackpressureException_initWithNSString_(@"Inner queue full?!")];
        return;
      }
    }
    if ([self decrementAndGet] == 0) {
...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  if ([((IoReactivexInternalUtilAtomicThrowable *) nil_chk(errs_)) addThrowableWithNSException:t]) {
...
- (void)drainLoop {
  ...
  for (; ; ) {
    ...
    if (d && (svq == nil || [svq isEmpty]) && n == 0) {
      NSException *ex = [((IoReactivexInternalUtilAtomicThrowable *) nil_chk(errs_)) terminate];
      if (ex == nil) {
        [((id<OrgReactivestreamsSubscriber>) nil_chk(child)) onComplete];
      }
      else {
        [((id<OrgReactivestreamsSubscriber>) nil_chk(child)) onErrorWithNSException:ex];
      }
      return;
    }
...
- (jboolean)checkTerminate {
  ...
  if (!delayErrors_ && [((IoReactivexInternalUtilAtomicThrowable *) nil_chk(errs_)) get] != nil) {
    [((id<OrgReactivestreamsSubscriber>) nil_chk(actual_)) onErrorWithNSException:[((IoReactivexInternalUtilAtomicThrowable *) nil_chk(errs_)) terminate]];
    return true;
  }
  return false;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[16].selector = @selector(disposeAll);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "mapper_", "LIoReactivexFunctionsFunction;", .constantValue.asLong = 0, 0x10, -1, -1, 25, -1 },
    { "delayErrors_", "Z", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
    { "maxConcurrency_", "I", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
    { "bufferSize_", "I", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
    { "queue_", "LIoReactivexInternalFuseableSimplePlainQueue;", .constantValue.asLong = 0, 0x40, -1, -1, 26, -1 },
    { "done_", "Z", .constantValue.asLong = 0, 0x40, -1, -1, -1, -1 },
    { "errs_", "LIoReactivexInternalUtilAtomicThrowable;", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
    { "cancelled_", "Z", .constantValue.asLong = 0, 0x40, -1, -1, -1, -1 },
    { "subscribers_", "LJavaUtilConcurrentAtomicAtomicReference;", .constantValue.asLong = 0, 0x10, -1, -1, 27, -1 },
    { "EMPTY", "[LIoReactivexInternalOperatorsFlowableFlowableFlatMap_InnerSubscriber;", .constantValue.asLong = 0, 0x18, -1, 28, 29, -1 },
    { "CANCELLED", "[LIoReactivexInternalOperatorsFlowableFlowableFlatMap_InnerSubscriber;", .constantValue.asLong = 0, 0x18, -1, 30, 29, -1 },
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LIoReactivexFunctionsFunction;ZII", "(Lorg/reactivestreams/Subscriber<-TU;>;Lio/reactivex/functions/Function<-TT;+Lorg/reactivestreams/Publisher<+TU;>;>;ZII)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "addInner", "LIoReactivexInternalOperatorsFlowableFlowableFlatMap_InnerSubscriber;", "(Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber<TT;TU;>;)Z", "removeInner", "(Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber<TT;TU;>;)V", "()Lio/reactivex/internal/fuseable/SimpleQueue<TU;>;", "tryEmitScalar", "(TU;)V", "getInnerQueue", "(Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber<TT;TU;>;)Lio/reactivex/internal/fuseable/SimpleQueue<TU;>;", "tryEmit", "LNSObject;LIoReactivexInternalOperatorsFlowableFlowableFlatMap_InnerSubscriber;", "(TU;Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber<TT;TU;>;)V", "onError", "LNSException;", "request", "J", "Lorg/reactivestreams/Subscriber<-TU;>;", "Lio/reactivex/functions/Function<-TT;+Lorg/reactivestreams/Publisher<+TU;>;>;", "Lio/reactivex/internal/fuseable/SimplePlainQueue<TU;>;", "Ljava/util/concurrent/atomic/AtomicReference<[Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber<**>;>;", &IoReactivexInternalOperatorsFlowableFlowableFlatMap_MergeSubscriber_EMPTY, "[Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber<**>;", &IoReactivexInternalOperatorsFlowableFlowableFlatMap_MergeSubscriber_CANCELLED, "LIoReactivexInternalOperatorsFlowableFlowableFlatMap;", "<T:Ljava/lang/Object;U:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicInteger;Lorg/reactivestreams/Subscription;Lorg/reactivestreams/Subscriber<TT;>;" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsFlowableFlowableFlatMap_MergeSubscriber = { "MergeSubscriber", "io.reactivex.internal.operators.flowable", ptrTable, methods, fields, 7, 0x18, 17, 20, 31, -1, -1, 32, -1 };
...
- (void)onErrorWithNSException:(NSException *)t {
  if ([((IoReactivexInternalUtilAtomicThrowable *) nil_chk(((IoReactivexInternalOperatorsFlowableFlowableFlatMap_MergeSubscriber *) nil_chk(parent_))->errs_)) addThrowableWithNSException:t]) {
    JreAssignVolatileBoolean(&done_, true);
    [parent_ drain];
  }
  else {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexInternalOperatorsFlowableFlowableFlatMap_MergeSubscriber;J", "(Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber<TT;TU;>;J)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TU;)V", "onError", "LNSException;", "requestMore", "J", "id", "Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber<TT;TU;>;", "Lio/reactivex/internal/fuseable/SimpleQueue<TU;>;", "LIoReactivexInternalOperatorsFlowableFlowableFlatMap;", "<T:Ljava/lang/Object;U:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicReference<Lorg/reactivestreams/Subscription;>;Lorg/reactivestreams/Subscriber<TU;>;Lio/reactivex/disposables/Disposable;" };
