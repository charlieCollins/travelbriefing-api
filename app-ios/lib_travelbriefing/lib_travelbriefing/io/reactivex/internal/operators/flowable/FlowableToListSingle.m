...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source {
  IoReactivexInternalOperatorsFlowableFlowableToListSingle_initWithOrgReactivestreamsPublisher_(self, source);
  return self;
}

- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
                     withJavaUtilConcurrentCallable:(id<JavaUtilConcurrentCallable>)collectionSupplier {
  IoReactivexInternalOperatorsFlowableFlowableToListSingle_initWithOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_(self, source, collectionSupplier);
  return self;
}
...
- (void)subscribeActualWithIoReactivexSingleObserver:(id<IoReactivexSingleObserver>)s {
  ...
  [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableToListSingle_ToListSubscriber_initWithIoReactivexSingleObserver_withJavaUtilCollection_(s, coll)];
}

- (IoReactivexFlowable *)fuseToFlowable {
  return IoReactivexPluginsRxJavaPlugins_onAssemblyWithIoReactivexFlowable_(create_IoReactivexInternalOperatorsFlowableFlowableToList_initWithOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_(source_, collectionSupplier_));
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[1].selector = @selector(initWithOrgReactivestreamsPublisher:withJavaUtilConcurrentCallable:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "source_", "LOrgReactivestreamsPublisher;", .constantValue.asLong = 0, 0x10, -1, -1, 8, -1 },
    { "collectionSupplier_", "LJavaUtilConcurrentCallable;", .constantValue.asLong = 0, 0x10, -1, -1, 9, -1 },
  };
  static const void *ptrTable[] = { "LOrgReactivestreamsPublisher;", "(Lorg/reactivestreams/Publisher<TT;>;)V", "LOrgReactivestreamsPublisher;LJavaUtilConcurrentCallable;", "(Lorg/reactivestreams/Publisher<TT;>;Ljava/util/concurrent/Callable<TU;>;)V", "subscribeActual", "LIoReactivexSingleObserver;", "(Lio/reactivex/SingleObserver<-TU;>;)V", "()Lio/reactivex/Flowable<TU;>;", "Lorg/reactivestreams/Publisher<TT;>;", "Ljava/util/concurrent/Callable<TU;>;", "LIoReactivexInternalOperatorsFlowableFlowableToListSingle_ToListSubscriber;", "<T:Ljava/lang/Object;U::Ljava/util/Collection<-TT;>;>Lio/reactivex/Single<TU;>;Lio/reactivex/internal/fuseable/FuseToFlowable<TU;>;" };
...
void IoReactivexInternalOperatorsFlowableFlowableToListSingle_initWithOrgReactivestreamsPublisher_(IoReactivexInternalOperatorsFlowableFlowableToListSingle *self, id<OrgReactivestreamsPublisher> source) {
  IoReactivexInternalOperatorsFlowableFlowableToListSingle_initWithOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_(self, source, IoReactivexInternalUtilArrayListSupplier_asCallable());
}

IoReactivexInternalOperatorsFlowableFlowableToListSingle *new_IoReactivexInternalOperatorsFlowableFlowableToListSingle_initWithOrgReactivestreamsPublisher_(id<OrgReactivestreamsPublisher> source) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableToListSingle, initWithOrgReactivestreamsPublisher_, source)
}

IoReactivexInternalOperatorsFlowableFlowableToListSingle *create_IoReactivexInternalOperatorsFlowableFlowableToListSingle_initWithOrgReactivestreamsPublisher_(id<OrgReactivestreamsPublisher> source) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableToListSingle, initWithOrgReactivestreamsPublisher_, source)
}

void IoReactivexInternalOperatorsFlowableFlowableToListSingle_initWithOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_(IoReactivexInternalOperatorsFlowableFlowableToListSingle *self, id<OrgReactivestreamsPublisher> source, id<JavaUtilConcurrentCallable> collectionSupplier) {
  IoReactivexSingle_init(self);
  JreStrongAssign(&self->source_, source);
  JreStrongAssign(&self->collectionSupplier_, collectionSupplier);
}

IoReactivexInternalOperatorsFlowableFlowableToListSingle *new_IoReactivexInternalOperatorsFlowableFlowableToListSingle_initWithOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_(id<OrgReactivestreamsPublisher> source, id<JavaUtilConcurrentCallable> collectionSupplier) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableToListSingle, initWithOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_, source, collectionSupplier)
}

IoReactivexInternalOperatorsFlowableFlowableToListSingle *create_IoReactivexInternalOperatorsFlowableFlowableToListSingle_initWithOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_(id<OrgReactivestreamsPublisher> source, id<JavaUtilConcurrentCallable> collectionSupplier) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableToListSingle, initWithOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_, source, collectionSupplier)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexSingleObserver;LJavaUtilCollection;", "(Lio/reactivex/SingleObserver<-TU;>;TU;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lio/reactivex/SingleObserver<-TU;>;", "TU;", "LIoReactivexInternalOperatorsFlowableFlowableToListSingle;", "<T:Ljava/lang/Object;U::Ljava/util/Collection<-TT;>;>Ljava/lang/Object;Lorg/reactivestreams/Subscriber<TT;>;Lio/reactivex/disposables/Disposable;" };
