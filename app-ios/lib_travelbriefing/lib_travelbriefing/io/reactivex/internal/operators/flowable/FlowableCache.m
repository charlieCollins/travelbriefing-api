...
//  source: ../target/dependency/io/reactivex/internal/operators/flowable/FlowableCache.java
//
...
- (void)connect {
  [((IoReactivexFlowable *) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:self];
...
- (void)onErrorWithNSException:(NSException *)e {
  if (!sourceDone_) {
    sourceDone_ = true;
    id o = IoReactivexInternalUtilNotificationLite_errorWithNSException_(e);
    [self addWithId:o];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexFlowable;I", "(Lio/reactivex/Flowable<+TT;>;I)V", "addChild", "LIoReactivexInternalOperatorsFlowableFlowableCache_ReplaySubscription;", "(Lio/reactivex/internal/operators/flowable/FlowableCache$ReplaySubscription<TT;>;)V", "removeChild", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lio/reactivex/Flowable<+TT;>;", "Ljava/util/concurrent/atomic/AtomicReference<Lorg/reactivestreams/Subscription;>;", "Ljava/util/concurrent/atomic/AtomicReference<[Lio/reactivex/internal/operators/flowable/FlowableCache$ReplaySubscription<TT;>;>;", &IoReactivexInternalOperatorsFlowableFlowableCache_CacheState_EMPTY, &IoReactivexInternalOperatorsFlowableFlowableCache_CacheState_TERMINATED, "LIoReactivexInternalOperatorsFlowableFlowableCache;", "<T:Ljava/lang/Object;>Lio/reactivex/internal/util/LinkedArrayList;Lorg/reactivestreams/Subscriber<TT;>;" };
    ...
    if (s != 0) {
      ...
      if (r == 0) {
        ...
        if (IoReactivexInternalUtilNotificationLite_isCompleteWithId_(o)) {
          ...
          [((id<OrgReactivestreamsSubscriber>) nil_chk(child)) onErrorWithNSException:IoReactivexInternalUtilNotificationLite_getErrorWithId_(o)];
          return;
        }
      }
      if (valuesProduced != 0) {
