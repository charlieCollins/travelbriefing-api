...
#include "io/reactivex/internal/operators/flowable/FlowableReduce.h"
...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableReduce_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsBiFunction_(self, source, reducer);
  return self;
}

- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableReduce_ReduceSubscriber_initWithOrgReactivestreamsSubscriber_withIoReactivexFunctionsBiFunction_(s, reducer_)];
}
...
void IoReactivexInternalOperatorsFlowableFlowableReduce_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsBiFunction_(IoReactivexInternalOperatorsFlowableFlowableReduce *self, id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsBiFunction> reducer) {
...
IoReactivexInternalOperatorsFlowableFlowableReduce *new_IoReactivexInternalOperatorsFlowableFlowableReduce_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsBiFunction_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsBiFunction> reducer) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableReduce, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsBiFunction_, source, reducer)
}

IoReactivexInternalOperatorsFlowableFlowableReduce *create_IoReactivexInternalOperatorsFlowableFlowableReduce_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsBiFunction_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsBiFunction> reducer) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableReduce, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsBiFunction_, source, reducer)
}
...
- (void)onNextWithId:(id)t {
  if (s_ == JreLoadEnum(IoReactivexInternalSubscriptionsSubscriptionHelper, CANCELLED)) {
    return;
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LIoReactivexFunctionsBiFunction;", "(Lorg/reactivestreams/Subscriber<-TT;>;Lio/reactivex/functions/BiFunction<TT;TT;TT;>;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lio/reactivex/functions/BiFunction<TT;TT;TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableReduce;", "<T:Ljava/lang/Object;>Lio/reactivex/internal/subscriptions/DeferredScalarSubscription<TT;>;Lorg/reactivestreams/Subscriber<TT;>;" };
