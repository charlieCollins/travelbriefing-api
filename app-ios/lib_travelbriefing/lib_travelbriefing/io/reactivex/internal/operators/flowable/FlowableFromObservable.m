...
//  source: ../target/dependency/io/reactivex/internal/operators/flowable/FlowableFromObservable.java
//
...
- (void)onErrorWithNSException:(NSException *)e {
  [((id<OrgReactivestreamsSubscriber>) nil_chk(s_)) onErrorWithNSException:e];
}
