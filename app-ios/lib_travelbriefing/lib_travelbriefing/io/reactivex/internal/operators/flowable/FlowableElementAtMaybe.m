...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableElementAtMaybe_initWithOrgReactivestreamsPublisher_withLong_(self, source, index);
  return self;
}

- (void)subscribeActualWithIoReactivexMaybeObserver:(id<IoReactivexMaybeObserver>)s {
  [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableElementAtMaybe_ElementAtSubscriber_initWithIoReactivexMaybeObserver_withLong_(s, index_)];
}

- (IoReactivexFlowable *)fuseToFlowable {
  return IoReactivexPluginsRxJavaPlugins_onAssemblyWithIoReactivexFlowable_(create_IoReactivexInternalOperatorsFlowableFlowableElementAt_initWithOrgReactivestreamsPublisher_withLong_withId_withBoolean_(source_, index_, nil, false));
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsPublisher;J", "(Lorg/reactivestreams/Publisher<TT;>;J)V", "subscribeActual", "LIoReactivexMaybeObserver;", "(Lio/reactivex/MaybeObserver<-TT;>;)V", "()Lio/reactivex/Flowable<TT;>;", "Lorg/reactivestreams/Publisher<TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableElementAtMaybe_ElementAtSubscriber;", "<T:Ljava/lang/Object;>Lio/reactivex/Maybe<TT;>;Lio/reactivex/internal/fuseable/FuseToFlowable<TT;>;" };
...
void IoReactivexInternalOperatorsFlowableFlowableElementAtMaybe_initWithOrgReactivestreamsPublisher_withLong_(IoReactivexInternalOperatorsFlowableFlowableElementAtMaybe *self, id<OrgReactivestreamsPublisher> source, jlong index) {
  IoReactivexMaybe_init(self);
  JreStrongAssign(&self->source_, source);
  self->index_ = index;
}

IoReactivexInternalOperatorsFlowableFlowableElementAtMaybe *new_IoReactivexInternalOperatorsFlowableFlowableElementAtMaybe_initWithOrgReactivestreamsPublisher_withLong_(id<OrgReactivestreamsPublisher> source, jlong index) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableElementAtMaybe, initWithOrgReactivestreamsPublisher_withLong_, source, index)
}

IoReactivexInternalOperatorsFlowableFlowableElementAtMaybe *create_IoReactivexInternalOperatorsFlowableFlowableElementAtMaybe_initWithOrgReactivestreamsPublisher_withLong_(id<OrgReactivestreamsPublisher> source, jlong index) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableElementAtMaybe, initWithOrgReactivestreamsPublisher_withLong_, source, index)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexMaybeObserver;J", "(Lio/reactivex/MaybeObserver<-TT;>;J)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lio/reactivex/MaybeObserver<-TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableElementAtMaybe;", "<T:Ljava/lang/Object;>Ljava/lang/Object;Lorg/reactivestreams/Subscriber<TT;>;Lio/reactivex/disposables/Disposable;" };
