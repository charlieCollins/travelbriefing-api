...
//  source: ../target/dependency/io/reactivex/internal/operators/flowable/FlowableOnErrorNext.java
//
...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableOnErrorNext_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withBoolean_(self, source, nextSupplier, allowFatal);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithOrgReactivestreamsPublisher:withIoReactivexFunctionsFunction:withBoolean:);
...
void IoReactivexInternalOperatorsFlowableFlowableOnErrorNext_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withBoolean_(IoReactivexInternalOperatorsFlowableFlowableOnErrorNext *self, id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> nextSupplier, jboolean allowFatal) {
...
IoReactivexInternalOperatorsFlowableFlowableOnErrorNext *new_IoReactivexInternalOperatorsFlowableFlowableOnErrorNext_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withBoolean_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> nextSupplier, jboolean allowFatal) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableOnErrorNext, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withBoolean_, source, nextSupplier, allowFatal)
}

IoReactivexInternalOperatorsFlowableFlowableOnErrorNext *create_IoReactivexInternalOperatorsFlowableFlowableOnErrorNext_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withBoolean_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> nextSupplier, jboolean allowFatal) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableOnErrorNext, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withBoolean_, source, nextSupplier, allowFatal)
}
...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  if (p == nil) {
    ...
    [npe initCauseWithNSException:t];
    [((id<OrgReactivestreamsSubscriber>) nil_chk(actual_)) onErrorWithNSException:npe];
    return;
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LIoReactivexFunctionsFunction;Z", "(Lorg/reactivestreams/Subscriber<-TT;>;Lio/reactivex/functions/Function<-Ljava/lang/Throwable;+Lorg/reactivestreams/Publisher<+TT;>;>;Z)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lorg/reactivestreams/Subscriber<-TT;>;", "Lio/reactivex/functions/Function<-Ljava/lang/Throwable;+Lorg/reactivestreams/Publisher<+TT;>;>;", "LIoReactivexInternalOperatorsFlowableFlowableOnErrorNext;", "<T:Ljava/lang/Object;>Ljava/lang/Object;Lorg/reactivestreams/Subscriber<TT;>;" };
