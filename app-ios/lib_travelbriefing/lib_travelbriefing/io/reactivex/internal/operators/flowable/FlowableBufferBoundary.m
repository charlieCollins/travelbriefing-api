...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableBufferBoundary_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withJavaUtilConcurrentCallable_(self, source, bufferOpen, bufferClose, bufferSupplier);
  return self;
}

- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableBufferBoundary_BufferBoundarySubscriber_initWithOrgReactivestreamsSubscriber_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withJavaUtilConcurrentCallable_(create_IoReactivexSubscribersSerializedSubscriber_initWithOrgReactivestreamsSubscriber_(s), bufferOpen_, bufferClose_, bufferSupplier_)];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithOrgReactivestreamsPublisher:withOrgReactivestreamsPublisher:withIoReactivexFunctionsFunction:withJavaUtilConcurrentCallable:);
...
IoReactivexInternalOperatorsFlowableFlowableBufferBoundary *new_IoReactivexInternalOperatorsFlowableFlowableBufferBoundary_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withJavaUtilConcurrentCallable_(id<OrgReactivestreamsPublisher> source, id<OrgReactivestreamsPublisher> bufferOpen, id<IoReactivexFunctionsFunction> bufferClose, id<JavaUtilConcurrentCallable> bufferSupplier) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableBufferBoundary, initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withJavaUtilConcurrentCallable_, source, bufferOpen, bufferClose, bufferSupplier)
}
...
IoReactivexInternalOperatorsFlowableFlowableBufferBoundary *create_IoReactivexInternalOperatorsFlowableFlowableBufferBoundary_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withJavaUtilConcurrentCallable_(id<OrgReactivestreamsPublisher> source, id<OrgReactivestreamsPublisher> bufferOpen, id<IoReactivexFunctionsFunction> bufferClose, id<JavaUtilConcurrentCallable> bufferSupplier) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableBufferBoundary, initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withJavaUtilConcurrentCallable_, source, bufferOpen, bufferClose, bufferSupplier)
}
...
- (void)complete {
  ...
  @synchronized(self) {
    list = create_JavaUtilArrayList_initWithJavaUtilCollection_(buffers_);
    [((id<JavaUtilList>) nil_chk(buffers_)) clear];
  }
  id<IoReactivexInternalFuseableSimpleQueue> q = queue_;
  for (id<JavaUtilCollection> __strong u in list) {
    [((id<IoReactivexInternalFuseableSimpleQueue>) nil_chk(q)) offerWithId:u];
  }
  JreAssignVolatileBoolean(&done_, true);
  if ([self enter]) {
    IoReactivexInternalUtilQueueDrainHelper_drainMaxLoopWithIoReactivexInternalFuseableSimpleQueue_withOrgReactivestreamsSubscriber_withBoolean_withIoReactivexDisposablesDisposable_withIoReactivexInternalUtilQueueDrain_(q, actual_, false, self, self);
  }
}
...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  done_ = true;
  [((IoReactivexInternalOperatorsFlowableFlowableBufferBoundary_BufferBoundarySubscriber *) nil_chk(parent_)) onErrorWithNSException:t];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexInternalOperatorsFlowableFlowableBufferBoundary_BufferBoundarySubscriber;", "(Lio/reactivex/internal/operators/flowable/FlowableBufferBoundary$BufferBoundarySubscriber<TT;TU;TOpen;TClose;>;)V", "onNext", "LNSObject;", "(TOpen;)V", "onError", "LNSException;", "Lio/reactivex/internal/operators/flowable/FlowableBufferBoundary$BufferBoundarySubscriber<TT;TU;TOpen;TClose;>;", "LIoReactivexInternalOperatorsFlowableFlowableBufferBoundary;", "<T:Ljava/lang/Object;U::Ljava/util/Collection<-TT;>;Open:Ljava/lang/Object;Close:Ljava/lang/Object;>Lio/reactivex/subscribers/DisposableSubscriber<TOpen;>;" };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LJavaUtilCollection;LIoReactivexInternalOperatorsFlowableFlowableBufferBoundary_BufferBoundarySubscriber;", "(TU;Lio/reactivex/internal/operators/flowable/FlowableBufferBoundary$BufferBoundarySubscriber<TT;TU;TOpen;TClose;>;)V", "onNext", "LNSObject;", "(TClose;)V", "onError", "LNSException;", "Lio/reactivex/internal/operators/flowable/FlowableBufferBoundary$BufferBoundarySubscriber<TT;TU;TOpen;TClose;>;", "TU;", "LIoReactivexInternalOperatorsFlowableFlowableBufferBoundary;", "<T:Ljava/lang/Object;U::Ljava/util/Collection<-TT;>;Open:Ljava/lang/Object;Close:Ljava/lang/Object;>Lio/reactivex/subscribers/DisposableSubscriber<TClose;>;" };
