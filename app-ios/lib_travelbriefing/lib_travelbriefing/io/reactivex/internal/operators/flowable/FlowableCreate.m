...
//  source: ../target/dependency/io/reactivex/internal/operators/flowable/FlowableCreate.java
//
...
- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)t {
  ...
  @catch (NSException *ex) {
    ...
    [((IoReactivexInternalOperatorsFlowableFlowableCreate_BaseEmitter *) nil_chk(emitter)) onErrorWithNSException:ex];
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LIoReactivexFlowableEmitter;", 0x1, -1, -1, -1, 11, -1, -1 },
  };
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  ...
  methods[8].selector = @selector(requested);
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "emitter_", "LIoReactivexInternalOperatorsFlowableFlowableCreate_BaseEmitter;", .constantValue.asLong = 0, 0x10, -1, -1, 12, -1 },
  ...
  static const void *ptrTable[] = { "LIoReactivexInternalOperatorsFlowableFlowableCreate_BaseEmitter;", "(Lio/reactivex/internal/operators/flowable/FlowableCreate$BaseEmitter<TT;>;)V", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "setDisposable", "LIoReactivexDisposablesDisposable;", "setCancellable", "LIoReactivexFunctionsCancellable;", "()Lio/reactivex/FlowableEmitter<TT;>;", "Lio/reactivex/internal/operators/flowable/FlowableCreate$BaseEmitter<TT;>;", "Lio/reactivex/internal/fuseable/SimplePlainQueue<TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableCreate;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicInteger;Lio/reactivex/FlowableEmitter<TT;>;" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsFlowableFlowableCreate_SerializedEmitter = { "SerializedEmitter", "io.reactivex.internal.operators.flowable", ptrTable, methods, fields, 7, 0x18, 11, 5, 14, -1, -1, 15, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LIoReactivexFlowableEmitter;", 0x11, -1, -1, -1, 10, -1, -1 },
  };
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  ...
  methods[8].selector = @selector(setDisposableWithIoReactivexDisposablesDisposable:);
  methods[9].selector = @selector(setCancellableWithIoReactivexFunctionsCancellable:);
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;", "(Lorg/reactivestreams/Subscriber<-TT;>;)V", "onError", "LNSException;", "request", "J", "setDisposable", "LIoReactivexDisposablesDisposable;", "setCancellable", "LIoReactivexFunctionsCancellable;", "()Lio/reactivex/FlowableEmitter<TT;>;", "Lorg/reactivestreams/Subscriber<-TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableCreate;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicLong;Lio/reactivex/FlowableEmitter<TT;>;Lorg/reactivestreams/Subscription;" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsFlowableFlowableCreate_BaseEmitter = { "BaseEmitter", "io.reactivex.internal.operators.flowable", ptrTable, methods, fields, 7, 0x408, 12, 3, 12, -1, -1, 13, -1 };
...
- (void)onOverflow {
  [self onErrorWithNSException:create_IoReactivexExceptionsMissingBackpressureException_initWithNSString_(@"create: could not emit value due to lack of requests")];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;I", "(Lorg/reactivestreams/Subscriber<-TT;>;I)V", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lio/reactivex/internal/queue/SpscLinkedArrayQueue<TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableCreate;", "<T:Ljava/lang/Object;>Lio/reactivex/internal/operators/flowable/FlowableCreate$BaseEmitter<TT;>;" };
...
- (void)onErrorWithNSException:(NSException *)e {
  ...
  if (e == nil) {
    [self onErrorWithNSException:create_JavaLangNullPointerException_initWithNSString_(@"onError called with null. Null values are generally not allowed in 2.x operators and sources.")];
  }
  JreStrongAssign(&error_, e);
  JreAssignVolatileBoolean(&done_, true);
  [self drain];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;", "(Lorg/reactivestreams/Subscriber<-TT;>;)V", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Ljava/util/concurrent/atomic/AtomicReference<TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableCreate;", "<T:Ljava/lang/Object;>Lio/reactivex/internal/operators/flowable/FlowableCreate$BaseEmitter<TT;>;" };
