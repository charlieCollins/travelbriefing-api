...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableConcatMap_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_withIoReactivexInternalUtilErrorMode_(self, source, mapper, prefetch, errorMode);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsPublisher;LIoReactivexFunctionsFunction;ILIoReactivexInternalUtilErrorMode;", "(Lorg/reactivestreams/Publisher<TT;>;Lio/reactivex/functions/Function<-TT;+Lorg/reactivestreams/Publisher<+TR;>;>;ILio/reactivex/internal/util/ErrorMode;)V", "subscribe", "LOrgReactivestreamsSubscriber;LIoReactivexFunctionsFunction;ILIoReactivexInternalUtilErrorMode;", "<T:Ljava/lang/Object;R:Ljava/lang/Object;>(Lorg/reactivestreams/Subscriber<-TR;>;Lio/reactivex/functions/Function<-TT;+Lorg/reactivestreams/Publisher<+TR;>;>;ILio/reactivex/internal/util/ErrorMode;)Lorg/reactivestreams/Subscriber<TT;>;", "subscribeActual", "LOrgReactivestreamsSubscriber;", "(Lorg/reactivestreams/Subscriber<-TR;>;)V", "Lio/reactivex/functions/Function<-TT;+Lorg/reactivestreams/Publisher<+TR;>;>;", "LIoReactivexInternalOperatorsFlowableFlowableConcatMap_BaseConcatMapSubscriber;LIoReactivexInternalOperatorsFlowableFlowableConcatMap_ConcatMapImmediate;LIoReactivexInternalOperatorsFlowableFlowableConcatMap_WeakScalarSubscription;LIoReactivexInternalOperatorsFlowableFlowableConcatMap_ConcatMapDelayed;LIoReactivexInternalOperatorsFlowableFlowableConcatMap_ConcatMapSupport;LIoReactivexInternalOperatorsFlowableFlowableConcatMap_ConcatMapInner;", "<T:Ljava/lang/Object;R:Ljava/lang/Object;>Lio/reactivex/internal/operators/flowable/AbstractFlowableWithUpstream<TT;TR;>;" };
...
IoReactivexInternalOperatorsFlowableFlowableConcatMap *new_IoReactivexInternalOperatorsFlowableFlowableConcatMap_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_withIoReactivexInternalUtilErrorMode_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> mapper, jint prefetch, IoReactivexInternalUtilErrorMode *errorMode) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableConcatMap, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_withIoReactivexInternalUtilErrorMode_, source, mapper, prefetch, errorMode)
}

IoReactivexInternalOperatorsFlowableFlowableConcatMap *create_IoReactivexInternalOperatorsFlowableFlowableConcatMap_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_withIoReactivexInternalUtilErrorMode_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> mapper, jint prefetch, IoReactivexInternalUtilErrorMode *errorMode) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableConcatMap, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_withIoReactivexInternalUtilErrorMode_, source, mapper, prefetch, errorMode)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[2].selector = @selector(innerErrorWithNSException:);
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "innerNext", "LNSObject;", "(TT;)V", "innerError", "LNSException;", "LIoReactivexInternalOperatorsFlowableFlowableConcatMap;", "<T:Ljava/lang/Object;>Ljava/lang/Object;" };
...
- (void)onNextWithId:(id)t {
  if (sourceMode_ != IoReactivexInternalFuseableQueueFuseable_ASYNC) {
    if (![((id<IoReactivexInternalFuseableSimpleQueue>) nil_chk(queue_)) offerWithId:t]) {
      ...
      [self onErrorWithNSException:create_JavaLangIllegalStateException_initWithNSString_(@"Queue full?!")];
      return;
    }
  }
  [self drain];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexFunctionsFunction;I", "(Lio/reactivex/functions/Function<-TT;+Lorg/reactivestreams/Publisher<+TR;>;>;I)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "Lio/reactivex/internal/operators/flowable/FlowableConcatMap$ConcatMapInner<TR;>;", "Lio/reactivex/functions/Function<-TT;+Lorg/reactivestreams/Publisher<+TR;>;>;", "Lio/reactivex/internal/fuseable/SimpleQueue<TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableConcatMap;", "<T:Ljava/lang/Object;R:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicInteger;Lorg/reactivestreams/Subscriber<TT;>;Lio/reactivex/internal/operators/flowable/FlowableConcatMap$ConcatMapSupport<TR;>;Lorg/reactivestreams/Subscription;" };
...
- (void)onErrorWithNSException:(NSException *)t {
  if ([((IoReactivexInternalUtilAtomicThrowable *) nil_chk(errors_)) addThrowableWithNSException:t]) {
    ...
    if ([self getAndIncrement] == 0) {
      [((id<OrgReactivestreamsSubscriber>) nil_chk(actual_)) onErrorWithNSException:[errors_ terminate]];
    }
  }
  else {
...
- (void)innerNextWithId:(id)value {
  if ([self get] == 0 && [self compareAndSetWithInt:0 withInt:1]) {
    ...
    [actual_ onErrorWithNSException:[((IoReactivexInternalUtilAtomicThrowable *) nil_chk(errors_)) terminate]];
  }
}
    ...
    for (; ; ) {
      ...
      if (!JreLoadVolatileBoolean(&active_)) {
        ...
        @catch (NSException *e) {
          ...
          [((id<OrgReactivestreamsSubscription>) nil_chk(s_)) cancel];
          [((IoReactivexInternalUtilAtomicThrowable *) nil_chk(errors_)) addThrowableWithNSException:e];
          [((id<OrgReactivestreamsSubscriber>) nil_chk(actual_)) onErrorWithNSException:[errors_ terminate]];
          return;
        }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LIoReactivexFunctionsFunction;I", "(Lorg/reactivestreams/Subscriber<-TR;>;Lio/reactivex/functions/Function<-TT;+Lorg/reactivestreams/Publisher<+TR;>;>;I)V", "onError", "LNSException;", "innerNext", "LNSObject;", "(TR;)V", "innerError", "request", "J", "Lorg/reactivestreams/Subscriber<-TR;>;", "LIoReactivexInternalOperatorsFlowableFlowableConcatMap;", "<T:Ljava/lang/Object;R:Ljava/lang/Object;>Lio/reactivex/internal/operators/flowable/FlowableConcatMap$BaseConcatMapSubscriber<TT;TR;>;" };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LIoReactivexFunctionsFunction;IZ", "(Lorg/reactivestreams/Subscriber<-TR;>;Lio/reactivex/functions/Function<-TT;+Lorg/reactivestreams/Publisher<+TR;>;>;IZ)V", "onError", "LNSException;", "innerNext", "LNSObject;", "(TR;)V", "innerError", "request", "J", "Lorg/reactivestreams/Subscriber<-TR;>;", "LIoReactivexInternalOperatorsFlowableFlowableConcatMap;", "<T:Ljava/lang/Object;R:Ljava/lang/Object;>Lio/reactivex/internal/operators/flowable/FlowableConcatMap$BaseConcatMapSubscriber<TT;TR;>;" };
...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  [((id<IoReactivexInternalOperatorsFlowableFlowableConcatMap_ConcatMapSupport>) nil_chk(parent_)) innerErrorWithNSException:t];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexInternalOperatorsFlowableFlowableConcatMap_ConcatMapSupport;", "(Lio/reactivex/internal/operators/flowable/FlowableConcatMap$ConcatMapSupport<TR;>;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TR;)V", "onError", "LNSException;", "Lio/reactivex/internal/operators/flowable/FlowableConcatMap$ConcatMapSupport<TR;>;", "LIoReactivexInternalOperatorsFlowableFlowableConcatMap;", "<R:Ljava/lang/Object;>Lio/reactivex/internal/subscriptions/SubscriptionArbiter;Lorg/reactivestreams/Subscriber<TR;>;" };
