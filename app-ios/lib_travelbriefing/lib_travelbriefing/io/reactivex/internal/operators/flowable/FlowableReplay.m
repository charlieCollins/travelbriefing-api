...
__attribute__((unused)) static void IoReactivexInternalOperatorsFlowableFlowableReplay_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withJavaUtilConcurrentAtomicAtomicReference_withJavaUtilConcurrentCallable_(IoReactivexInternalOperatorsFlowableFlowableReplay *self, id<OrgReactivestreamsPublisher> onSubscribe, id<OrgReactivestreamsPublisher> source, JavaUtilConcurrentAtomicAtomicReference *current, id<JavaUtilConcurrentCallable> bufferFactory);

__attribute__((unused)) static IoReactivexInternalOperatorsFlowableFlowableReplay *new_IoReactivexInternalOperatorsFlowableFlowableReplay_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withJavaUtilConcurrentAtomicAtomicReference_withJavaUtilConcurrentCallable_(id<OrgReactivestreamsPublisher> onSubscribe, id<OrgReactivestreamsPublisher> source, JavaUtilConcurrentAtomicAtomicReference *current, id<JavaUtilConcurrentCallable> bufferFactory) NS_RETURNS_RETAINED;

__attribute__((unused)) static IoReactivexInternalOperatorsFlowableFlowableReplay *create_IoReactivexInternalOperatorsFlowableFlowableReplay_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withJavaUtilConcurrentAtomicAtomicReference_withJavaUtilConcurrentCallable_(id<OrgReactivestreamsPublisher> onSubscribe, id<OrgReactivestreamsPublisher> source, JavaUtilConcurrentAtomicAtomicReference *current, id<JavaUtilConcurrentCallable> bufferFactory);

@interface IoReactivexInternalOperatorsFlowableFlowableReplay_1 : NSObject < JavaUtilConcurrentCallable >
...
J2OBJC_EMPTY_STATIC_INIT(IoReactivexInternalOperatorsFlowableFlowableReplay_1)

__attribute__((unused)) static void IoReactivexInternalOperatorsFlowableFlowableReplay_1_init(IoReactivexInternalOperatorsFlowableFlowableReplay_1 *self);

__attribute__((unused)) static IoReactivexInternalOperatorsFlowableFlowableReplay_1 *new_IoReactivexInternalOperatorsFlowableFlowableReplay_1_init() NS_RETURNS_RETAINED;

__attribute__((unused)) static IoReactivexInternalOperatorsFlowableFlowableReplay_1 *create_IoReactivexInternalOperatorsFlowableFlowableReplay_1_init();

@interface IoReactivexInternalOperatorsFlowableFlowableReplay_2 : NSObject < OrgReactivestreamsPublisher > {
 @public
...
J2OBJC_EMPTY_STATIC_INIT(IoReactivexInternalOperatorsFlowableFlowableReplay_2)

__attribute__((unused)) static void IoReactivexInternalOperatorsFlowableFlowableReplay_2_initWithJavaUtilConcurrentCallable_withIoReactivexFunctionsFunction_(IoReactivexInternalOperatorsFlowableFlowableReplay_2 *self, id<JavaUtilConcurrentCallable> capture$0, id<IoReactivexFunctionsFunction> capture$1);

__attribute__((unused)) static IoReactivexInternalOperatorsFlowableFlowableReplay_2 *new_IoReactivexInternalOperatorsFlowableFlowableReplay_2_initWithJavaUtilConcurrentCallable_withIoReactivexFunctionsFunction_(id<JavaUtilConcurrentCallable> capture$0, id<IoReactivexFunctionsFunction> capture$1) NS_RETURNS_RETAINED;

__attribute__((unused)) static IoReactivexInternalOperatorsFlowableFlowableReplay_2 *create_IoReactivexInternalOperatorsFlowableFlowableReplay_2_initWithJavaUtilConcurrentCallable_withIoReactivexFunctionsFunction_(id<JavaUtilConcurrentCallable> capture$0, id<IoReactivexFunctionsFunction> capture$1);

@interface IoReactivexInternalOperatorsFlowableFlowableReplay_2_1 : NSObject < IoReactivexFunctionsConsumer > {
 @public
  IoReactivexInternalSubscribersSubscriberResourceWrapper *val$srw_;
}

- (instancetype)initWithIoReactivexInternalSubscribersSubscriberResourceWrapper:(IoReactivexInternalSubscribersSubscriberResourceWrapper *)capture$0;

- (void)acceptWithId:(id<IoReactivexDisposablesDisposable>)r;

@end

J2OBJC_EMPTY_STATIC_INIT(IoReactivexInternalOperatorsFlowableFlowableReplay_2_1)

__attribute__((unused)) static void IoReactivexInternalOperatorsFlowableFlowableReplay_2_1_initWithIoReactivexInternalSubscribersSubscriberResourceWrapper_(IoReactivexInternalOperatorsFlowableFlowableReplay_2_1 *self, IoReactivexInternalSubscribersSubscriberResourceWrapper *capture$0);

__attribute__((unused)) static IoReactivexInternalOperatorsFlowableFlowableReplay_2_1 *new_IoReactivexInternalOperatorsFlowableFlowableReplay_2_1_initWithIoReactivexInternalSubscribersSubscriberResourceWrapper_(IoReactivexInternalSubscribersSubscriberResourceWrapper *capture$0) NS_RETURNS_RETAINED;

__attribute__((unused)) static IoReactivexInternalOperatorsFlowableFlowableReplay_2_1 *create_IoReactivexInternalOperatorsFlowableFlowableReplay_2_1_initWithIoReactivexInternalSubscribersSubscriberResourceWrapper_(IoReactivexInternalSubscribersSubscriberResourceWrapper *capture$0);

@interface IoReactivexInternalOperatorsFlowableFlowableReplay_3 : IoReactivexFlowablesConnectableFlowable {
 @public
  IoReactivexFlowablesConnectableFlowable *val$co_;
  IoReactivexFlowable *val$observable_;
}

- (instancetype)initWithIoReactivexFlowablesConnectableFlowable:(IoReactivexFlowablesConnectableFlowable *)capture$0
                                        withIoReactivexFlowable:(IoReactivexFlowable *)capture$1;
...
J2OBJC_EMPTY_STATIC_INIT(IoReactivexInternalOperatorsFlowableFlowableReplay_3)

__attribute__((unused)) static void IoReactivexInternalOperatorsFlowableFlowableReplay_3_initWithIoReactivexFlowablesConnectableFlowable_withIoReactivexFlowable_(IoReactivexInternalOperatorsFlowableFlowableReplay_3 *self, IoReactivexFlowablesConnectableFlowable *capture$0, IoReactivexFlowable *capture$1);

__attribute__((unused)) static IoReactivexInternalOperatorsFlowableFlowableReplay_3 *new_IoReactivexInternalOperatorsFlowableFlowableReplay_3_initWithIoReactivexFlowablesConnectableFlowable_withIoReactivexFlowable_(IoReactivexFlowablesConnectableFlowable *capture$0, IoReactivexFlowable *capture$1) NS_RETURNS_RETAINED;

__attribute__((unused)) static IoReactivexInternalOperatorsFlowableFlowableReplay_3 *create_IoReactivexInternalOperatorsFlowableFlowableReplay_3_initWithIoReactivexFlowablesConnectableFlowable_withIoReactivexFlowable_(IoReactivexFlowablesConnectableFlowable *capture$0, IoReactivexFlowable *capture$1);

@interface IoReactivexInternalOperatorsFlowableFlowableReplay_4 : NSObject < JavaUtilConcurrentCallable > {
 @public
...
J2OBJC_EMPTY_STATIC_INIT(IoReactivexInternalOperatorsFlowableFlowableReplay_4)

__attribute__((unused)) static void IoReactivexInternalOperatorsFlowableFlowableReplay_4_initWithInt_(IoReactivexInternalOperatorsFlowableFlowableReplay_4 *self, jint capture$0);

__attribute__((unused)) static IoReactivexInternalOperatorsFlowableFlowableReplay_4 *new_IoReactivexInternalOperatorsFlowableFlowableReplay_4_initWithInt_(jint capture$0) NS_RETURNS_RETAINED;

__attribute__((unused)) static IoReactivexInternalOperatorsFlowableFlowableReplay_4 *create_IoReactivexInternalOperatorsFlowableFlowableReplay_4_initWithInt_(jint capture$0);

@interface IoReactivexInternalOperatorsFlowableFlowableReplay_5 : NSObject < JavaUtilConcurrentCallable > {
 @public
  jint val$bufferSize_;
  jlong val$maxAge_;
...
J2OBJC_EMPTY_STATIC_INIT(IoReactivexInternalOperatorsFlowableFlowableReplay_5)

__attribute__((unused)) static void IoReactivexInternalOperatorsFlowableFlowableReplay_5_initWithInt_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_(IoReactivexInternalOperatorsFlowableFlowableReplay_5 *self, jint capture$0, jlong capture$1, JavaUtilConcurrentTimeUnit *capture$2, IoReactivexScheduler *capture$3);

__attribute__((unused)) static IoReactivexInternalOperatorsFlowableFlowableReplay_5 *new_IoReactivexInternalOperatorsFlowableFlowableReplay_5_initWithInt_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_(jint capture$0, jlong capture$1, JavaUtilConcurrentTimeUnit *capture$2, IoReactivexScheduler *capture$3) NS_RETURNS_RETAINED;

__attribute__((unused)) static IoReactivexInternalOperatorsFlowableFlowableReplay_5 *create_IoReactivexInternalOperatorsFlowableFlowableReplay_5_initWithInt_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_(jint capture$0, jlong capture$1, JavaUtilConcurrentTimeUnit *capture$2, IoReactivexScheduler *capture$3);

@interface IoReactivexInternalOperatorsFlowableFlowableReplay_6 : NSObject < OrgReactivestreamsPublisher > {
 @public
  JavaUtilConcurrentAtomicAtomicReference *val$curr_;
  id<JavaUtilConcurrentCallable> val$bufferFactory_;
}
...
J2OBJC_EMPTY_STATIC_INIT(IoReactivexInternalOperatorsFlowableFlowableReplay_6)

__attribute__((unused)) static void IoReactivexInternalOperatorsFlowableFlowableReplay_6_initWithJavaUtilConcurrentAtomicAtomicReference_withJavaUtilConcurrentCallable_(IoReactivexInternalOperatorsFlowableFlowableReplay_6 *self, JavaUtilConcurrentAtomicAtomicReference *capture$0, id<JavaUtilConcurrentCallable> capture$1);

__attribute__((unused)) static IoReactivexInternalOperatorsFlowableFlowableReplay_6 *new_IoReactivexInternalOperatorsFlowableFlowableReplay_6_initWithJavaUtilConcurrentAtomicAtomicReference_withJavaUtilConcurrentCallable_(JavaUtilConcurrentAtomicAtomicReference *capture$0, id<JavaUtilConcurrentCallable> capture$1) NS_RETURNS_RETAINED;

__attribute__((unused)) static IoReactivexInternalOperatorsFlowableFlowableReplay_6 *create_IoReactivexInternalOperatorsFlowableFlowableReplay_6_initWithJavaUtilConcurrentAtomicAtomicReference_withJavaUtilConcurrentCallable_(JavaUtilConcurrentAtomicAtomicReference *capture$0, id<JavaUtilConcurrentCallable> capture$1);
...
+ (IoReactivexFlowablesConnectableFlowable *)createFromWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source {
  return IoReactivexInternalOperatorsFlowableFlowableReplay_createFromWithOrgReactivestreamsPublisher_(source);
}

+ (IoReactivexFlowablesConnectableFlowable *)createWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
                                                                           withInt:(jint)bufferSize {
  return IoReactivexInternalOperatorsFlowableFlowableReplay_createWithOrgReactivestreamsPublisher_withInt_(source, bufferSize);
}
...
+ (IoReactivexFlowablesConnectableFlowable *)createWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
                                                    ...
                                                    withJavaUtilConcurrentTimeUnit:(JavaUtilConcurrentTimeUnit *)unit
                                                          withIoReactivexScheduler:(IoReactivexScheduler *)scheduler {
  return IoReactivexInternalOperatorsFlowableFlowableReplay_createWithOrgReactivestreamsPublisher_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_(source, maxAge, unit, scheduler);
}
...
+ (IoReactivexFlowablesConnectableFlowable *)createWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
                                                    ...
                                                    withJavaUtilConcurrentTimeUnit:(JavaUtilConcurrentTimeUnit *)unit
                                                          withIoReactivexScheduler:(IoReactivexScheduler *)scheduler
                                                                           withInt:(jint)bufferSize {
  return IoReactivexInternalOperatorsFlowableFlowableReplay_createWithOrgReactivestreamsPublisher_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_withInt_(source, maxAge, unit, scheduler, bufferSize);
}

+ (IoReactivexFlowablesConnectableFlowable *)createWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
                                                    withJavaUtilConcurrentCallable:(id<JavaUtilConcurrentCallable>)bufferFactory {
  return IoReactivexInternalOperatorsFlowableFlowableReplay_createWithOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_(source, bufferFactory);
}
...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)onSubscribe
        ...
        withJavaUtilConcurrentAtomicAtomicReference:(JavaUtilConcurrentAtomicAtomicReference *)current
                     withJavaUtilConcurrentCallable:(id<JavaUtilConcurrentCallable>)bufferFactory {
  IoReactivexInternalOperatorsFlowableFlowableReplay_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withJavaUtilConcurrentAtomicAtomicReference_withJavaUtilConcurrentCallable_(self, onSubscribe, source, current, bufferFactory);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[2].selector = @selector(createFromWithOrgReactivestreamsPublisher:);
  methods[3].selector = @selector(createWithOrgReactivestreamsPublisher:withInt:);
  methods[4].selector = @selector(createWithOrgReactivestreamsPublisher:withLong:withJavaUtilConcurrentTimeUnit:withIoReactivexScheduler:);
  methods[5].selector = @selector(createWithOrgReactivestreamsPublisher:withLong:withJavaUtilConcurrentTimeUnit:withIoReactivexScheduler:withInt:);
  methods[6].selector = @selector(createWithOrgReactivestreamsPublisher:withJavaUtilConcurrentCallable:);
  methods[7].selector = @selector(initWithOrgReactivestreamsPublisher:withOrgReactivestreamsPublisher:withJavaUtilConcurrentAtomicAtomicReference:withJavaUtilConcurrentCallable:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "source_", "LOrgReactivestreamsPublisher;", .constantValue.asLong = 0, 0x10, -1, -1, 27, -1 },
...
+ (void)initialize {
  if (self == [IoReactivexInternalOperatorsFlowableFlowableReplay class]) {
    JreStrongAssignAndConsume(&IoReactivexInternalOperatorsFlowableFlowableReplay_DEFAULT_UNBOUNDED_FACTORY, new_IoReactivexInternalOperatorsFlowableFlowableReplay_1_init());
...
IoReactivexFlowable *IoReactivexInternalOperatorsFlowableFlowableReplay_multicastSelectorWithJavaUtilConcurrentCallable_withIoReactivexFunctionsFunction_(id<JavaUtilConcurrentCallable> connectableFactory, id<IoReactivexFunctionsFunction> selector) {
  ...
  return IoReactivexFlowable_unsafeCreateWithOrgReactivestreamsPublisher_(create_IoReactivexInternalOperatorsFlowableFlowableReplay_2_initWithJavaUtilConcurrentCallable_withIoReactivexFunctionsFunction_(connectableFactory, selector));
}
...
IoReactivexFlowablesConnectableFlowable *IoReactivexInternalOperatorsFlowableFlowableReplay_observeOnWithIoReactivexFlowablesConnectableFlowable_withIoReactivexScheduler_(IoReactivexFlowablesConnectableFlowable *co, IoReactivexScheduler *scheduler) {
  ...
  return IoReactivexPluginsRxJavaPlugins_onAssemblyWithIoReactivexFlowablesConnectableFlowable_(create_IoReactivexInternalOperatorsFlowableFlowableReplay_3_initWithIoReactivexFlowablesConnectableFlowable_withIoReactivexFlowable_(co, observable));
}

IoReactivexFlowablesConnectableFlowable *IoReactivexInternalOperatorsFlowableFlowableReplay_createFromWithOrgReactivestreamsPublisher_(id<OrgReactivestreamsPublisher> source) {
  IoReactivexInternalOperatorsFlowableFlowableReplay_initialize();
  return IoReactivexInternalOperatorsFlowableFlowableReplay_createWithOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_(source, IoReactivexInternalOperatorsFlowableFlowableReplay_DEFAULT_UNBOUNDED_FACTORY);
}

IoReactivexFlowablesConnectableFlowable *IoReactivexInternalOperatorsFlowableFlowableReplay_createWithOrgReactivestreamsPublisher_withInt_(id<OrgReactivestreamsPublisher> source, jint bufferSize) {
  IoReactivexInternalOperatorsFlowableFlowableReplay_initialize();
  if (bufferSize == JavaLangInteger_MAX_VALUE) {
    return IoReactivexInternalOperatorsFlowableFlowableReplay_createFromWithOrgReactivestreamsPublisher_(source);
  }
  return IoReactivexInternalOperatorsFlowableFlowableReplay_createWithOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_(source, create_IoReactivexInternalOperatorsFlowableFlowableReplay_4_initWithInt_(bufferSize));
}

IoReactivexFlowablesConnectableFlowable *IoReactivexInternalOperatorsFlowableFlowableReplay_createWithOrgReactivestreamsPublisher_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_(id<OrgReactivestreamsPublisher> source, jlong maxAge, JavaUtilConcurrentTimeUnit *unit, IoReactivexScheduler *scheduler) {
  IoReactivexInternalOperatorsFlowableFlowableReplay_initialize();
  return IoReactivexInternalOperatorsFlowableFlowableReplay_createWithOrgReactivestreamsPublisher_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_withInt_(source, maxAge, unit, scheduler, JavaLangInteger_MAX_VALUE);
}

IoReactivexFlowablesConnectableFlowable *IoReactivexInternalOperatorsFlowableFlowableReplay_createWithOrgReactivestreamsPublisher_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_withInt_(id<OrgReactivestreamsPublisher> source, jlong maxAge, JavaUtilConcurrentTimeUnit *unit, IoReactivexScheduler *scheduler, jint bufferSize) {
  IoReactivexInternalOperatorsFlowableFlowableReplay_initialize();
  return IoReactivexInternalOperatorsFlowableFlowableReplay_createWithOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_(source, create_IoReactivexInternalOperatorsFlowableFlowableReplay_5_initWithInt_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_(bufferSize, maxAge, unit, scheduler));
}

IoReactivexFlowablesConnectableFlowable *IoReactivexInternalOperatorsFlowableFlowableReplay_createWithOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_(id<OrgReactivestreamsPublisher> source, id<JavaUtilConcurrentCallable> bufferFactory) {
  IoReactivexInternalOperatorsFlowableFlowableReplay_initialize();
  JavaUtilConcurrentAtomicAtomicReference *curr = create_JavaUtilConcurrentAtomicAtomicReference_init();
  id<OrgReactivestreamsPublisher> onSubscribe = create_IoReactivexInternalOperatorsFlowableFlowableReplay_6_initWithJavaUtilConcurrentAtomicAtomicReference_withJavaUtilConcurrentCallable_(curr, bufferFactory);
...
IoReactivexInternalOperatorsFlowableFlowableReplay *new_IoReactivexInternalOperatorsFlowableFlowableReplay_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withJavaUtilConcurrentAtomicAtomicReference_withJavaUtilConcurrentCallable_(id<OrgReactivestreamsPublisher> onSubscribe, id<OrgReactivestreamsPublisher> source, JavaUtilConcurrentAtomicAtomicReference *current, id<JavaUtilConcurrentCallable> bufferFactory) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableReplay, initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withJavaUtilConcurrentAtomicAtomicReference_withJavaUtilConcurrentCallable_, onSubscribe, source, current, bufferFactory)
}

IoReactivexInternalOperatorsFlowableFlowableReplay *create_IoReactivexInternalOperatorsFlowableFlowableReplay_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withJavaUtilConcurrentAtomicAtomicReference_withJavaUtilConcurrentCallable_(id<OrgReactivestreamsPublisher> onSubscribe, id<OrgReactivestreamsPublisher> source, JavaUtilConcurrentAtomicAtomicReference *current, id<JavaUtilConcurrentCallable> bufferFactory) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableReplay, initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withJavaUtilConcurrentAtomicAtomicReference_withJavaUtilConcurrentCallable_, onSubscribe, source, current, bufferFactory)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(IoReactivexInternalOperatorsFlowableFlowableReplay)

@implementation IoReactivexInternalOperatorsFlowableFlowableReplay_1

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  IoReactivexInternalOperatorsFlowableFlowableReplay_1_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "LIoReactivexInternalOperatorsFlowableFlowableReplay;" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsFlowableFlowableReplay_1 = { "", "io.reactivex.internal.operators.flowable", ptrTable, methods, NULL, 7, 0x8018, 2, 0, 0, -1, -1, -1, -1 };
  return &_IoReactivexInternalOperatorsFlowableFlowableReplay_1;
}

@end

void IoReactivexInternalOperatorsFlowableFlowableReplay_1_init(IoReactivexInternalOperatorsFlowableFlowableReplay_1 *self) {
  NSObject_init(self);
}

IoReactivexInternalOperatorsFlowableFlowableReplay_1 *new_IoReactivexInternalOperatorsFlowableFlowableReplay_1_init() {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableReplay_1, init)
}

IoReactivexInternalOperatorsFlowableFlowableReplay_1 *create_IoReactivexInternalOperatorsFlowableFlowableReplay_1_init() {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableReplay_1, init)
}

@implementation IoReactivexInternalOperatorsFlowableFlowableReplay_2

- (instancetype)initWithJavaUtilConcurrentCallable:(id<JavaUtilConcurrentCallable>)capture$0
                  withIoReactivexFunctionsFunction:(id<IoReactivexFunctionsFunction>)capture$1 {
  IoReactivexInternalOperatorsFlowableFlowableReplay_2_initWithJavaUtilConcurrentCallable_withIoReactivexFunctionsFunction_(self, capture$0, capture$1);
  return self;
}
...
- (void)subscribeWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)child {
  ...
  @try {
    co = IoReactivexInternalFunctionsObjectHelper_requireNonNullWithId_withNSString_([((id<JavaUtilConcurrentCallable>) nil_chk(val$connectableFactory_)) call], @"The connectableFactory returned null");
  }
  @catch (NSException *e) {
    IoReactivexExceptionsExceptions_throwIfFatalWithNSException_(e);
    IoReactivexInternalSubscriptionsEmptySubscription_errorWithNSException_withOrgReactivestreamsSubscriber_(e, child);
    return;
  }
  id<OrgReactivestreamsPublisher> observable;
  @try {
    observable = IoReactivexInternalFunctionsObjectHelper_requireNonNullWithId_withNSString_([((id<IoReactivexFunctionsFunction>) nil_chk(val$selector_)) applyWithId:co], @"The selector returned a null Publisher");
  }
  @catch (NSException *e) {
    IoReactivexExceptionsExceptions_throwIfFatalWithNSException_(e);
    IoReactivexInternalSubscriptionsEmptySubscription_errorWithNSException_withOrgReactivestreamsSubscriber_(e, child);
  ...
  [((IoReactivexFlowablesConnectableFlowable *) nil_chk(co)) connectWithIoReactivexFunctionsConsumer:create_IoReactivexInternalOperatorsFlowableFlowableReplay_2_1_initWithIoReactivexInternalSubscribersSubscriberResourceWrapper_(srw)];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "subscribe", "LOrgReactivestreamsSubscriber;", "(Lorg/reactivestreams/Subscriber<-TR;>;)V", "Ljava/util/concurrent/Callable<+Lio/reactivex/flowables/ConnectableFlowable<TU;>;>;", "Lio/reactivex/functions/Function<-Lio/reactivex/Flowable<TU;>;+Lorg/reactivestreams/Publisher<TR;>;>;", "LIoReactivexInternalOperatorsFlowableFlowableReplay;", "multicastSelectorWithJavaUtilConcurrentCallable:withIoReactivexFunctionsFunction:", "Ljava/lang/Object;Lorg/reactivestreams/Publisher<TR;>;" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsFlowableFlowableReplay_2 = { "", "io.reactivex.internal.operators.flowable", ptrTable, methods, fields, 7, 0x8018, 2, 2, 5, -1, 6, 7, -1 };
  return &_IoReactivexInternalOperatorsFlowableFlowableReplay_2;
}

@end

void IoReactivexInternalOperatorsFlowableFlowableReplay_2_initWithJavaUtilConcurrentCallable_withIoReactivexFunctionsFunction_(IoReactivexInternalOperatorsFlowableFlowableReplay_2 *self, id<JavaUtilConcurrentCallable> capture$0, id<IoReactivexFunctionsFunction> capture$1) {
  JreStrongAssign(&self->val$connectableFactory_, capture$0);
  JreStrongAssign(&self->val$selector_, capture$1);
  NSObject_init(self);
}

IoReactivexInternalOperatorsFlowableFlowableReplay_2 *new_IoReactivexInternalOperatorsFlowableFlowableReplay_2_initWithJavaUtilConcurrentCallable_withIoReactivexFunctionsFunction_(id<JavaUtilConcurrentCallable> capture$0, id<IoReactivexFunctionsFunction> capture$1) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableReplay_2, initWithJavaUtilConcurrentCallable_withIoReactivexFunctionsFunction_, capture$0, capture$1)
}

IoReactivexInternalOperatorsFlowableFlowableReplay_2 *create_IoReactivexInternalOperatorsFlowableFlowableReplay_2_initWithJavaUtilConcurrentCallable_withIoReactivexFunctionsFunction_(id<JavaUtilConcurrentCallable> capture$0, id<IoReactivexFunctionsFunction> capture$1) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableReplay_2, initWithJavaUtilConcurrentCallable_withIoReactivexFunctionsFunction_, capture$0, capture$1)
}

@implementation IoReactivexInternalOperatorsFlowableFlowableReplay_2_1

- (instancetype)initWithIoReactivexInternalSubscribersSubscriberResourceWrapper:(IoReactivexInternalSubscribersSubscriberResourceWrapper *)capture$0 {
  IoReactivexInternalOperatorsFlowableFlowableReplay_2_1_initWithIoReactivexInternalSubscribersSubscriberResourceWrapper_(self, capture$0);
  return self;
}

- (void)acceptWithId:(id<IoReactivexDisposablesDisposable>)r {
  [((IoReactivexInternalSubscribersSubscriberResourceWrapper *) nil_chk(val$srw_)) setResourceWithIoReactivexDisposablesDisposable:r];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  methods[0].selector = @selector(initWithIoReactivexInternalSubscribersSubscriberResourceWrapper:);
  methods[1].selector = @selector(acceptWithId:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "val$srw_", "LIoReactivexInternalSubscribersSubscriberResourceWrapper;", .constantValue.asLong = 0, 0x1012, -1, -1, 2, -1 },
  };
  static const void *ptrTable[] = { "accept", "LIoReactivexDisposablesDisposable;", "Lio/reactivex/internal/subscribers/SubscriberResourceWrapper<TR;>;", "LIoReactivexInternalOperatorsFlowableFlowableReplay_2;", "subscribeWithOrgReactivestreamsSubscriber:", "Ljava/lang/Object;Lio/reactivex/functions/Consumer<Lio/reactivex/disposables/Disposable;>;" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsFlowableFlowableReplay_2_1 = { "", "io.reactivex.internal.operators.flowable", ptrTable, methods, fields, 7, 0x8018, 2, 1, 3, -1, 4, 5, -1 };
  return &_IoReactivexInternalOperatorsFlowableFlowableReplay_2_1;
}

@end

void IoReactivexInternalOperatorsFlowableFlowableReplay_2_1_initWithIoReactivexInternalSubscribersSubscriberResourceWrapper_(IoReactivexInternalOperatorsFlowableFlowableReplay_2_1 *self, IoReactivexInternalSubscribersSubscriberResourceWrapper *capture$0) {
  JreStrongAssign(&self->val$srw_, capture$0);
  NSObject_init(self);
}

IoReactivexInternalOperatorsFlowableFlowableReplay_2_1 *new_IoReactivexInternalOperatorsFlowableFlowableReplay_2_1_initWithIoReactivexInternalSubscribersSubscriberResourceWrapper_(IoReactivexInternalSubscribersSubscriberResourceWrapper *capture$0) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableReplay_2_1, initWithIoReactivexInternalSubscribersSubscriberResourceWrapper_, capture$0)
}

IoReactivexInternalOperatorsFlowableFlowableReplay_2_1 *create_IoReactivexInternalOperatorsFlowableFlowableReplay_2_1_initWithIoReactivexInternalSubscribersSubscriberResourceWrapper_(IoReactivexInternalSubscribersSubscriberResourceWrapper *capture$0) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableReplay_2_1, initWithIoReactivexInternalSubscribersSubscriberResourceWrapper_, capture$0)
}

@implementation IoReactivexInternalOperatorsFlowableFlowableReplay_3

- (instancetype)initWithIoReactivexFlowablesConnectableFlowable:(IoReactivexFlowablesConnectableFlowable *)capture$0
                                        withIoReactivexFlowable:(IoReactivexFlowable *)capture$1 {
  IoReactivexInternalOperatorsFlowableFlowableReplay_3_initWithIoReactivexFlowablesConnectableFlowable_withIoReactivexFlowable_(self, capture$0, capture$1);
  return self;
}

- (void)connectWithIoReactivexFunctionsConsumer:(id<IoReactivexFunctionsConsumer>)connection {
  [((IoReactivexFlowablesConnectableFlowable *) nil_chk(val$co_)) connectWithIoReactivexFunctionsConsumer:connection];
}

- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  [((IoReactivexFlowable *) nil_chk(val$observable_)) subscribeWithOrgReactivestreamsSubscriber:s];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "val$co_", "LIoReactivexFlowablesConnectableFlowable;", .constantValue.asLong = 0, 0x1012, -1, -1, 6, -1 },
    { "val$observable_", "LIoReactivexFlowable;", .constantValue.asLong = 0, 0x1012, -1, -1, 7, -1 },
  };
  static const void *ptrTable[] = { "connect", "LIoReactivexFunctionsConsumer;", "(Lio/reactivex/functions/Consumer<-Lio/reactivex/disposables/Disposable;>;)V", "subscribeActual", "LOrgReactivestreamsSubscriber;", "(Lorg/reactivestreams/Subscriber<-TT;>;)V", "Lio/reactivex/flowables/ConnectableFlowable<TT;>;", "Lio/reactivex/Flowable<TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableReplay;", "observeOnWithIoReactivexFlowablesConnectableFlowable:withIoReactivexScheduler:" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsFlowableFlowableReplay_3 = { "", "io.reactivex.internal.operators.flowable", ptrTable, methods, fields, 7, 0x8018, 3, 2, 8, -1, 9, 6, -1 };
  return &_IoReactivexInternalOperatorsFlowableFlowableReplay_3;
}

@end

void IoReactivexInternalOperatorsFlowableFlowableReplay_3_initWithIoReactivexFlowablesConnectableFlowable_withIoReactivexFlowable_(IoReactivexInternalOperatorsFlowableFlowableReplay_3 *self, IoReactivexFlowablesConnectableFlowable *capture$0, IoReactivexFlowable *capture$1) {
  JreStrongAssign(&self->val$co_, capture$0);
  JreStrongAssign(&self->val$observable_, capture$1);
  IoReactivexFlowablesConnectableFlowable_init(self);
}

IoReactivexInternalOperatorsFlowableFlowableReplay_3 *new_IoReactivexInternalOperatorsFlowableFlowableReplay_3_initWithIoReactivexFlowablesConnectableFlowable_withIoReactivexFlowable_(IoReactivexFlowablesConnectableFlowable *capture$0, IoReactivexFlowable *capture$1) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableReplay_3, initWithIoReactivexFlowablesConnectableFlowable_withIoReactivexFlowable_, capture$0, capture$1)
}

IoReactivexInternalOperatorsFlowableFlowableReplay_3 *create_IoReactivexInternalOperatorsFlowableFlowableReplay_3_initWithIoReactivexFlowablesConnectableFlowable_withIoReactivexFlowable_(IoReactivexFlowablesConnectableFlowable *capture$0, IoReactivexFlowable *capture$1) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableReplay_3, initWithIoReactivexFlowablesConnectableFlowable_withIoReactivexFlowable_, capture$0, capture$1)
}

@implementation IoReactivexInternalOperatorsFlowableFlowableReplay_4

- (instancetype)initWithInt:(jint)capture$0 {
  IoReactivexInternalOperatorsFlowableFlowableReplay_4_initWithInt_(self, capture$0);
  return self;
}

- (id<IoReactivexInternalOperatorsFlowableFlowableReplay_ReplayBuffer>)call {
  return create_IoReactivexInternalOperatorsFlowableFlowableReplay_SizeBoundReplayBuffer_initWithInt_(val$bufferSize_);
}

+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    { NULL, NULL, 0x0, -1, -1, -1, -1, -1, -1 },
    { NULL, "LIoReactivexInternalOperatorsFlowableFlowableReplay_ReplayBuffer;", 0x1, -1, -1, -1, 0, -1, -1 },
  };
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  ...
  static const void *ptrTable[] = { "()Lio/reactivex/internal/operators/flowable/FlowableReplay$ReplayBuffer<TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableReplay;", "createWithOrgReactivestreamsPublisher:withInt:", "Ljava/lang/Object;Ljava/util/concurrent/Callable<Lio/reactivex/internal/operators/flowable/FlowableReplay$ReplayBuffer<TT;>;>;" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsFlowableFlowableReplay_4 = { "", "io.reactivex.internal.operators.flowable", ptrTable, methods, fields, 7, 0x8018, 2, 1, 1, -1, 2, 3, -1 };
  return &_IoReactivexInternalOperatorsFlowableFlowableReplay_4;
}

@end

void IoReactivexInternalOperatorsFlowableFlowableReplay_4_initWithInt_(IoReactivexInternalOperatorsFlowableFlowableReplay_4 *self, jint capture$0) {
  self->val$bufferSize_ = capture$0;
  NSObject_init(self);
}

IoReactivexInternalOperatorsFlowableFlowableReplay_4 *new_IoReactivexInternalOperatorsFlowableFlowableReplay_4_initWithInt_(jint capture$0) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableReplay_4, initWithInt_, capture$0)
}

IoReactivexInternalOperatorsFlowableFlowableReplay_4 *create_IoReactivexInternalOperatorsFlowableFlowableReplay_4_initWithInt_(jint capture$0) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableReplay_4, initWithInt_, capture$0)
}

@implementation IoReactivexInternalOperatorsFlowableFlowableReplay_5

- (instancetype)initWithInt:(jint)capture$0
                   withLong:(jlong)capture$1
withJavaUtilConcurrentTimeUnit:(JavaUtilConcurrentTimeUnit *)capture$2
   withIoReactivexScheduler:(IoReactivexScheduler *)capture$3 {
  IoReactivexInternalOperatorsFlowableFlowableReplay_5_initWithInt_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_(self, capture$0, capture$1, capture$2, capture$3);
  return self;
}

- (id<IoReactivexInternalOperatorsFlowableFlowableReplay_ReplayBuffer>)call {
  return create_IoReactivexInternalOperatorsFlowableFlowableReplay_SizeAndTimeBoundReplayBuffer_initWithInt_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_(val$bufferSize_, val$maxAge_, val$unit_, val$scheduler_);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "()Lio/reactivex/internal/operators/flowable/FlowableReplay$ReplayBuffer<TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableReplay;", "createWithOrgReactivestreamsPublisher:withLong:withJavaUtilConcurrentTimeUnit:withIoReactivexScheduler:withInt:", "Ljava/lang/Object;Ljava/util/concurrent/Callable<Lio/reactivex/internal/operators/flowable/FlowableReplay$ReplayBuffer<TT;>;>;" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsFlowableFlowableReplay_5 = { "", "io.reactivex.internal.operators.flowable", ptrTable, methods, fields, 7, 0x8018, 2, 4, 1, -1, 2, 3, -1 };
  return &_IoReactivexInternalOperatorsFlowableFlowableReplay_5;
}

@end

void IoReactivexInternalOperatorsFlowableFlowableReplay_5_initWithInt_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_(IoReactivexInternalOperatorsFlowableFlowableReplay_5 *self, jint capture$0, jlong capture$1, JavaUtilConcurrentTimeUnit *capture$2, IoReactivexScheduler *capture$3) {
  self->val$bufferSize_ = capture$0;
...
IoReactivexInternalOperatorsFlowableFlowableReplay_5 *new_IoReactivexInternalOperatorsFlowableFlowableReplay_5_initWithInt_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_(jint capture$0, jlong capture$1, JavaUtilConcurrentTimeUnit *capture$2, IoReactivexScheduler *capture$3) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableReplay_5, initWithInt_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_, capture$0, capture$1, capture$2, capture$3)
}

IoReactivexInternalOperatorsFlowableFlowableReplay_5 *create_IoReactivexInternalOperatorsFlowableFlowableReplay_5_initWithInt_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_(jint capture$0, jlong capture$1, JavaUtilConcurrentTimeUnit *capture$2, IoReactivexScheduler *capture$3) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableReplay_5, initWithInt_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_, capture$0, capture$1, capture$2, capture$3)
}

@implementation IoReactivexInternalOperatorsFlowableFlowableReplay_6

- (instancetype)initWithJavaUtilConcurrentAtomicAtomicReference:(JavaUtilConcurrentAtomicAtomicReference *)capture$0
                                 withJavaUtilConcurrentCallable:(id<JavaUtilConcurrentCallable>)capture$1 {
  IoReactivexInternalOperatorsFlowableFlowableReplay_6_initWithJavaUtilConcurrentAtomicAtomicReference_withJavaUtilConcurrentCallable_(self, capture$0, capture$1);
  return self;
}

- (void)subscribeWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)child {
  for (; ; ) {
    IoReactivexInternalOperatorsFlowableFlowableReplay_ReplaySubscriber *r = [((JavaUtilConcurrentAtomicAtomicReference *) nil_chk(val$curr_)) get];
    if (r == nil) {
      id<IoReactivexInternalOperatorsFlowableFlowableReplay_ReplayBuffer> buf;
      @try {
        buf = [((id<JavaUtilConcurrentCallable>) nil_chk(val$bufferFactory_)) call];
      }
      @catch (NSException *ex) {
        IoReactivexExceptionsExceptions_throwIfFatalWithNSException_(ex);
        @throw IoReactivexInternalUtilExceptionHelper_wrapOrThrowWithNSException_(ex);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "val$bufferFactory_", "LJavaUtilConcurrentCallable;", .constantValue.asLong = 0, 0x1012, -1, -1, 4, -1 },
  };
  static const void *ptrTable[] = { "subscribe", "LOrgReactivestreamsSubscriber;", "(Lorg/reactivestreams/Subscriber<-TT;>;)V", "Ljava/util/concurrent/atomic/AtomicReference<Lio/reactivex/internal/operators/flowable/FlowableReplay$ReplaySubscriber<TT;>;>;", "Ljava/util/concurrent/Callable<+Lio/reactivex/internal/operators/flowable/FlowableReplay$ReplayBuffer<TT;>;>;", "LIoReactivexInternalOperatorsFlowableFlowableReplay;", "createWithOrgReactivestreamsPublisher:withJavaUtilConcurrentCallable:", "Ljava/lang/Object;Lorg/reactivestreams/Publisher<TT;>;" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsFlowableFlowableReplay_6 = { "", "io.reactivex.internal.operators.flowable", ptrTable, methods, fields, 7, 0x8018, 2, 2, 5, -1, 6, 7, -1 };
  return &_IoReactivexInternalOperatorsFlowableFlowableReplay_6;
}

@end

void IoReactivexInternalOperatorsFlowableFlowableReplay_6_initWithJavaUtilConcurrentAtomicAtomicReference_withJavaUtilConcurrentCallable_(IoReactivexInternalOperatorsFlowableFlowableReplay_6 *self, JavaUtilConcurrentAtomicAtomicReference *capture$0, id<JavaUtilConcurrentCallable> capture$1) {
  JreStrongAssign(&self->val$curr_, capture$0);
  JreStrongAssign(&self->val$bufferFactory_, capture$1);
  NSObject_init(self);
}

IoReactivexInternalOperatorsFlowableFlowableReplay_6 *new_IoReactivexInternalOperatorsFlowableFlowableReplay_6_initWithJavaUtilConcurrentAtomicAtomicReference_withJavaUtilConcurrentCallable_(JavaUtilConcurrentAtomicAtomicReference *capture$0, id<JavaUtilConcurrentCallable> capture$1) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableReplay_6, initWithJavaUtilConcurrentAtomicAtomicReference_withJavaUtilConcurrentCallable_, capture$0, capture$1)
}

IoReactivexInternalOperatorsFlowableFlowableReplay_6 *create_IoReactivexInternalOperatorsFlowableFlowableReplay_6_initWithJavaUtilConcurrentAtomicAtomicReference_withJavaUtilConcurrentCallable_(JavaUtilConcurrentAtomicAtomicReference *capture$0, id<JavaUtilConcurrentCallable> capture$1) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableReplay_6, initWithJavaUtilConcurrentAtomicAtomicReference_withJavaUtilConcurrentCallable_, capture$0, capture$1)
}
...
- (void)onErrorWithNSException:(NSException *)e {
  if (!done_) {
    done_ = true;
    [((id<IoReactivexInternalOperatorsFlowableFlowableReplay_ReplayBuffer>) nil_chk(buffer_)) errorWithNSException:e];
    {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "next", "LNSObject;", "(TT;)V", "error", "LNSException;", "replay", "LIoReactivexInternalOperatorsFlowableFlowableReplay_InnerSubscription;", "(Lio/reactivex/internal/operators/flowable/FlowableReplay$InnerSubscription<TT;>;)V", "LIoReactivexInternalOperatorsFlowableFlowableReplay;", "<T:Ljava/lang/Object;>Ljava/lang/Object;" };
  ...
  for (; ; ) {
    ...
    while (r != 0LL && destinationIndex < sourceIndex) {
      ...
      @catch (NSException *err) {
        IoReactivexExceptionsExceptions_throwIfFatalWithNSException_(err);
        [output dispose];
        if (!IoReactivexInternalUtilNotificationLite_isErrorWithId_(o) && !IoReactivexInternalUtilNotificationLite_isCompleteWithId_(o)) {
          [((id<OrgReactivestreamsSubscriber>) nil_chk(child)) onErrorWithNSException:err];
        }
        return;
      }
      if ([output isDisposed]) {
    ...
    while (r != 0) {
      ...
      if (v != nil) {
        ...
        @catch (NSException *err) {
          ...
          [output dispose];
          if (!IoReactivexInternalUtilNotificationLite_isErrorWithId_(o) && !IoReactivexInternalUtilNotificationLite_isCompleteWithId_(o)) {
            [((id<OrgReactivestreamsSubscriber>) nil_chk(output->child_)) onErrorWithNSException:err];
          }
          return;
        }
        e++;
...
- (void)collectWithJavaUtilCollection:(id<JavaUtilCollection>)output {
  IoReactivexInternalOperatorsFlowableFlowableReplay_Node *n = [self get];
  for (; ; ) {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsFlowableFlowableReplay_SizeAndTimeBoundReplayBuffer = { "SizeAndTimeBoundReplayBuffer", "io.reactivex.internal.operators.flowable", ptrTable, methods, fields, 7, 0x18, 5, 5, 4, -1, -1, 5, -1 };
