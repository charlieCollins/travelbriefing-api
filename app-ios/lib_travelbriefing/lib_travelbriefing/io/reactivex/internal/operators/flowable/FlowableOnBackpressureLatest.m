...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source {
  IoReactivexInternalOperatorsFlowableFlowableOnBackpressureLatest_initWithOrgReactivestreamsPublisher_(self, source);
  return self;
}

- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableOnBackpressureLatest_BackpressureLatestSubscriber_initWithOrgReactivestreamsSubscriber_(s)];
}
...
void IoReactivexInternalOperatorsFlowableFlowableOnBackpressureLatest_initWithOrgReactivestreamsPublisher_(IoReactivexInternalOperatorsFlowableFlowableOnBackpressureLatest *self, id<OrgReactivestreamsPublisher> source) {
  IoReactivexInternalOperatorsFlowableAbstractFlowableWithUpstream_initWithOrgReactivestreamsPublisher_(self, source);
}

IoReactivexInternalOperatorsFlowableFlowableOnBackpressureLatest *new_IoReactivexInternalOperatorsFlowableFlowableOnBackpressureLatest_initWithOrgReactivestreamsPublisher_(id<OrgReactivestreamsPublisher> source) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableOnBackpressureLatest, initWithOrgReactivestreamsPublisher_, source)
}

IoReactivexInternalOperatorsFlowableFlowableOnBackpressureLatest *create_IoReactivexInternalOperatorsFlowableFlowableOnBackpressureLatest_initWithOrgReactivestreamsPublisher_(id<OrgReactivestreamsPublisher> source) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableOnBackpressureLatest, initWithOrgReactivestreamsPublisher_, source)
}
