...
//  source: ../target/dependency/io/reactivex/internal/operators/flowable/FlowableElementAt.java
//
...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableElementAt_initWithOrgReactivestreamsPublisher_withLong_withId_withBoolean_(self, source, index, defaultValue, errorOnFewer);
  return self;
}

- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableElementAt_ElementAtSubscriber_initWithOrgReactivestreamsSubscriber_withLong_withId_withBoolean_(s, index_, defaultValue_, errorOnFewer_)];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithOrgReactivestreamsPublisher:withLong:withId:withBoolean:);
...
void IoReactivexInternalOperatorsFlowableFlowableElementAt_initWithOrgReactivestreamsPublisher_withLong_withId_withBoolean_(IoReactivexInternalOperatorsFlowableFlowableElementAt *self, id<OrgReactivestreamsPublisher> source, jlong index, id defaultValue, jboolean errorOnFewer) {
...
IoReactivexInternalOperatorsFlowableFlowableElementAt *new_IoReactivexInternalOperatorsFlowableFlowableElementAt_initWithOrgReactivestreamsPublisher_withLong_withId_withBoolean_(id<OrgReactivestreamsPublisher> source, jlong index, id defaultValue, jboolean errorOnFewer) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableElementAt, initWithOrgReactivestreamsPublisher_withLong_withId_withBoolean_, source, index, defaultValue, errorOnFewer)
}

IoReactivexInternalOperatorsFlowableFlowableElementAt *create_IoReactivexInternalOperatorsFlowableFlowableElementAt_initWithOrgReactivestreamsPublisher_withLong_withId_withBoolean_(id<OrgReactivestreamsPublisher> source, jlong index, id defaultValue, jboolean errorOnFewer) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableElementAt, initWithOrgReactivestreamsPublisher_withLong_withId_withBoolean_, source, index, defaultValue, errorOnFewer)
}
...
- (void)onComplete {
  if (!done_) {
    ...
    if (v == nil) {
      if (errorOnFewer_) {
        [((id<OrgReactivestreamsSubscriber>) nil_chk(actual_)) onErrorWithNSException:create_JavaUtilNoSuchElementException_init()];
      }
      else {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;JLNSObject;Z", "(Lorg/reactivestreams/Subscriber<-TT;>;JTT;Z)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "TT;", "LIoReactivexInternalOperatorsFlowableFlowableElementAt;", "<T:Ljava/lang/Object;>Lio/reactivex/internal/subscriptions/DeferredScalarSubscription<TT;>;Lorg/reactivestreams/Subscriber<TT;>;" };
