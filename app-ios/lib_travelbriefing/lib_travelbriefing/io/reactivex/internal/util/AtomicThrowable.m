...
- (jboolean)addThrowableWithNSException:(NSException *)t {
  return IoReactivexInternalUtilExceptionHelper_addThrowableWithJavaUtilConcurrentAtomicAtomicReference_withNSException_(self, t);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[1].selector = @selector(addThrowableWithNSException:);
  ...
  static const void *ptrTable[] = { "addThrowable", "LNSException;", "Ljava/util/concurrent/atomic/AtomicReference<Ljava/lang/Throwable;>;" };
