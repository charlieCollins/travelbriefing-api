...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "accept", "LNSException;", "Ljava/util/concurrent/CountDownLatch;Lio/reactivex/functions/Consumer<Ljava/lang/Throwable;>;Lio/reactivex/functions/Action;" };
