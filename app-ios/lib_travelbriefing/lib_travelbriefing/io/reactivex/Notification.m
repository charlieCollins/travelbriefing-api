...
+ (IoReactivexNotification *)createOnErrorWithNSException:(NSException *)error {
  return IoReactivexNotification_createOnErrorWithNSException_(error);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[10].selector = @selector(createOnErrorWithNSException:);
  ...
  static const void *ptrTable[] = { "LNSObject;", "()TT;", "equals", "hashCode", "toString", "createOnNext", "<T:Ljava/lang/Object;>(TT;)Lio/reactivex/Notification<TT;>;", "createOnError", "LNSException;", "<T:Ljava/lang/Object;>(Ljava/lang/Throwable;)Lio/reactivex/Notification<TT;>;", "<T:Ljava/lang/Object;>()Lio/reactivex/Notification<TT;>;", &IoReactivexNotification_COMPLETE, "Lio/reactivex/Notification<Ljava/lang/Object;>;", "<T:Ljava/lang/Object;>Ljava/lang/Object;" };
...
IoReactivexNotification *IoReactivexNotification_createOnErrorWithNSException_(NSException *error) {
  IoReactivexNotification_initialize();
  IoReactivexInternalFunctionsObjectHelper_requireNonNullWithId_withNSString_(error, @"error is null");
  return create_IoReactivexNotification_initWithId_(IoReactivexInternalUtilNotificationLite_errorWithNSException_(error));
}
