...
FOUNDATION_EXPORT OrgJunitRulesTimeout_Builder *OrgJunitRulesTimeout_builder();
...
FOUNDATION_EXPORT OrgJunitRulesTimeout_Builder *new_OrgJunitRulesTimeout_Builder_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgJunitRulesTimeout_Builder *create_OrgJunitRulesTimeout_Builder_init();
