...
FOUNDATION_EXPORT void OrgJunitAssume_assumeNoExceptionWithNSException_(NSException *e);

FOUNDATION_EXPORT void OrgJunitAssume_assumeNoExceptionWithNSString_withNSException_(NSString *message, NSException *e);
