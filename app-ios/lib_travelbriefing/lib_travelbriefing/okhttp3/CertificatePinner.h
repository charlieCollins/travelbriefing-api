...
FOUNDATION_EXPORT void Okhttp3CertificatePinner_initWithJavaUtilSet_withOkhttp3InternalTlsCertificateChainCleaner_(Okhttp3CertificatePinner *self, id<JavaUtilSet> pins, Okhttp3InternalTlsCertificateChainCleaner *certificateChainCleaner);

FOUNDATION_EXPORT Okhttp3CertificatePinner *new_Okhttp3CertificatePinner_initWithJavaUtilSet_withOkhttp3InternalTlsCertificateChainCleaner_(id<JavaUtilSet> pins, Okhttp3InternalTlsCertificateChainCleaner *certificateChainCleaner) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT Okhttp3CertificatePinner *create_Okhttp3CertificatePinner_initWithJavaUtilSet_withOkhttp3InternalTlsCertificateChainCleaner_(id<JavaUtilSet> pins, Okhttp3InternalTlsCertificateChainCleaner *certificateChainCleaner);
