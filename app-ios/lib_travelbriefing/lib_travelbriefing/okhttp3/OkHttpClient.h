...
@interface Okhttp3OkHttpClient : NSObject < NSCopying, Okhttp3Call_Factory, Okhttp3WebSocket_Factory > {
 @public
  ...
  Okhttp3CertificatePinner *certificatePinner_;
...
J2OBJC_FIELD_SETTER(Okhttp3OkHttpClient, certificateChainCleaner_, Okhttp3InternalTlsCertificateChainCleaner *)
J2OBJC_FIELD_SETTER(Okhttp3OkHttpClient, hostnameVerifier_, id<JavaxNetSslHostnameVerifier>)
J2OBJC_FIELD_SETTER(Okhttp3OkHttpClient, certificatePinner_, Okhttp3CertificatePinner *)
...
FOUNDATION_EXPORT id<JavaUtilList> Okhttp3OkHttpClient_DEFAULT_PROTOCOLS;
...
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT id<JavaUtilList> Okhttp3OkHttpClient_DEFAULT_CONNECTION_SPECS;
...
FOUNDATION_EXPORT void Okhttp3OkHttpClient_initWithOkhttp3OkHttpClient_Builder_(Okhttp3OkHttpClient *self, Okhttp3OkHttpClient_Builder *builder);

FOUNDATION_EXPORT Okhttp3OkHttpClient *new_Okhttp3OkHttpClient_initWithOkhttp3OkHttpClient_Builder_(Okhttp3OkHttpClient_Builder *builder) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT Okhttp3OkHttpClient *create_Okhttp3OkHttpClient_initWithOkhttp3OkHttpClient_Builder_(Okhttp3OkHttpClient_Builder *builder);
...
J2OBJC_FIELD_SETTER(Okhttp3OkHttpClient_Builder, certificateChainCleaner_, Okhttp3InternalTlsCertificateChainCleaner *)
J2OBJC_FIELD_SETTER(Okhttp3OkHttpClient_Builder, hostnameVerifier_, id<JavaxNetSslHostnameVerifier>)
J2OBJC_FIELD_SETTER(Okhttp3OkHttpClient_Builder, certificatePinner_, Okhttp3CertificatePinner *)
