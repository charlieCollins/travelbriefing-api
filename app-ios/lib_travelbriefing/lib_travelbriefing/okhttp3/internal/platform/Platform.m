...
#include "okhttp3/internal/platform/JdkWithJettyBootPlatform.h"
...
- (void)logWithInt:(jint)level
  ...
  [((JavaUtilLoggingLogger *) nil_chk(Okhttp3InternalPlatformPlatform_logger)) logWithJavaUtilLoggingLevel:logLevel withNSString:message withNSException:t];
}
...
- (id)getStackTraceForCloseableWithNSString:(NSString *)closer {
  if ([((JavaUtilLoggingLogger *) nil_chk(Okhttp3InternalPlatformPlatform_logger)) isLoggableWithJavaUtilLoggingLevel:JreLoadStatic(JavaUtilLoggingLevel, FINE)]) {
    return create_NSException_initWithNSString_(closer);
  }
  return nil;
}
...
- (void)logCloseableLeakWithNSString:(NSString *)message
  ...
  if (stackTrace == nil) {
    JreStrAppend(&message, "$", @" To see where this was allocated, set the OkHttpClient logger level to FINE: Logger.getLogger(OkHttpClient.class.getName()).setLevel(Level.FINE);");
  }
  [self logWithInt:Okhttp3InternalPlatformPlatform_WARN withNSString:message withNSException:(NSException *) cast_chk(stackTrace, [NSException class])];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LNSObject;", 0x1, 15, 14, -1, -1, -1, -1 },
    { NULL, "V", 0x1, 16, 17, -1, -1, -1, -1 },
    { NULL, "LJavaUtilList;", 0x9, 18, 19, -1, 20, -1, -1 },
    { NULL, "LOkhttp3InternalTlsCertificateChainCleaner;", 0x1, 21, 22, -1, -1, -1, -1 },
    { NULL, "LOkhttp3InternalPlatformPlatform;", 0xa, -1, -1, -1, -1, -1, -1 },
    { NULL, "[B", 0x8, 23, 19, -1, 24, -1, -1 },
    { NULL, "LNSObject;", 0x8, 25, 26, -1, 27, -1, -1 },
  };
  ...
  methods[8].selector = @selector(logWithInt:withNSString:withNSException:);
  methods[9].selector = @selector(isCleartextTrafficPermittedWithNSString:);
  methods[10].selector = @selector(getStackTraceForCloseableWithNSString:);
  methods[11].selector = @selector(logCloseableLeakWithNSString:withId:);
  methods[12].selector = @selector(alpnProtocolNamesWithJavaUtilList:);
  methods[13].selector = @selector(buildCertificateChainCleanerWithJavaxNetSslX509TrustManager:);
  methods[14].selector = @selector(findPlatform);
  methods[15].selector = @selector(concatLengthPrefixedWithJavaUtilList:);
  methods[16].selector = @selector(readFieldOrNullWithId:withIOSClass:withNSString:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "PLATFORM", "LOkhttp3InternalPlatformPlatform;", .constantValue.asLong = 0, 0x1a, -1, 28, -1, -1 },
  ...
  static const void *ptrTable[] = { "trustManager", "LJavaxNetSslSSLSocketFactory;", "configureTlsExtensions", "LJavaxNetSslSSLSocket;LNSString;LJavaUtilList;", "(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List<Lokhttp3/Protocol;>;)V", "afterHandshake", "LJavaxNetSslSSLSocket;", "getSelectedProtocol", "connectSocket", "LJavaNetSocket;LJavaNetInetSocketAddress;I", "LJavaIoIOException;", "log", "ILNSString;LNSException;", "isCleartextTrafficPermitted", "LNSString;", "getStackTraceForCloseable", "logCloseableLeak", "LNSString;LNSObject;", "alpnProtocolNames", "LJavaUtilList;", "(Ljava/util/List<Lokhttp3/Protocol;>;)Ljava/util/List<Ljava/lang/String;>;", "buildCertificateChainCleaner", "LJavaxNetSslX509TrustManager;", "concatLengthPrefixed", "(Ljava/util/List<Lokhttp3/Protocol;>;)[B", "readFieldOrNull", "LNSObject;LIOSClass;LNSString;", "<T:Ljava/lang/Object;>(Ljava/lang/Object;Ljava/lang/Class<TT;>;Ljava/lang/String;)TT;", &Okhttp3InternalPlatformPlatform_PLATFORM, &Okhttp3InternalPlatformPlatform_logger };
  static const J2ObjcClassInfo _Okhttp3InternalPlatformPlatform = { "Platform", "okhttp3.internal.platform", ptrTable, methods, fields, 7, 0x1, 17, 4, -1, -1, -1, -1, -1 };
...
IOSByteArray *Okhttp3InternalPlatformPlatform_concatLengthPrefixedWithJavaUtilList_(id<JavaUtilList> protocols) {
  ...
  for (jint i = 0, size = [((id<JavaUtilList>) nil_chk(protocols)) size]; i < size; i++) {
    Okhttp3Protocol *protocol = [protocols getWithInt:i];
    if (protocol == JreLoadEnum(Okhttp3Protocol, HTTP_1_0)) continue;
    [result writeByteWithInt:((jint) [((NSString *) nil_chk([((Okhttp3Protocol *) nil_chk(protocol)) description])) length])];
