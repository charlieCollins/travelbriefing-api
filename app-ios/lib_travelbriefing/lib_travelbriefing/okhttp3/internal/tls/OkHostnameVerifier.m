...
//  source: ../target/dependency/okhttp3/internal/tls/OkHostnameVerifier.java
//
...
jboolean Okhttp3InternalTlsOkHostnameVerifier_verifyHostnameWithNSString_withNSString_(Okhttp3InternalTlsOkHostnameVerifier *self, NSString *hostname, NSString *pattern) {
  if ((hostname == nil) || (((jint) [((NSString *) nil_chk(hostname)) length]) == 0) || ([hostname hasPrefix:@"."]) || ([hostname hasSuffix:@".."])) {
    return false;
  }
  if ((pattern == nil) || (((jint) [((NSString *) nil_chk(pattern)) length]) == 0) || ([pattern hasPrefix:@"."]) || ([pattern hasSuffix:@".."])) {
    return false;
  }
  ...
  if ((![pattern hasPrefix:@"*."]) || ([pattern java_indexOf:'*' fromIndex:1] != -1)) {
    return false;
  }
