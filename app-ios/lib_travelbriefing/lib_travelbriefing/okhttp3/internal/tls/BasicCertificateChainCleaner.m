...
//  source: ../target/dependency/okhttp3/internal/tls/BasicCertificateChainCleaner.java
//
...
- (NSUInteger)hash {
  return ((jint) [((Okhttp3InternalTlsTrustRootIndex *) nil_chk(trustRootIndex_)) hash]);
}

- (jboolean)isEqual:(id)other {
  if (other == self) return true;
  return [other isKindOfClass:[Okhttp3InternalTlsBasicCertificateChainCleaner class]] && [((Okhttp3InternalTlsTrustRootIndex *) nil_chk(((Okhttp3InternalTlsBasicCertificateChainCleaner *) nil_chk(((Okhttp3InternalTlsBasicCertificateChainCleaner *) cast_chk(other, [Okhttp3InternalTlsBasicCertificateChainCleaner class]))))->trustRootIndex_)) isEqual:trustRootIndex_];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _Okhttp3InternalTlsBasicCertificateChainCleaner = { "BasicCertificateChainCleaner", "okhttp3.internal.tls", ptrTable, methods, fields, 7, 0x11, 5, 2, -1, -1, -1, -1, -1 };
