...
//  source: ../target/dependency/okhttp3/internal/Util.java
//
...
inline OkioByteString *Okhttp3InternalUtil_get_UTF_8_BOM();
static OkioByteString *Okhttp3InternalUtil_UTF_8_BOM;
J2OBJC_STATIC_FIELD_OBJ_FINAL(Okhttp3InternalUtil, UTF_8_BOM, OkioByteString *)

inline OkioByteString *Okhttp3InternalUtil_get_UTF_16_BE_BOM();
static OkioByteString *Okhttp3InternalUtil_UTF_16_BE_BOM;
J2OBJC_STATIC_FIELD_OBJ_FINAL(Okhttp3InternalUtil, UTF_16_BE_BOM, OkioByteString *)

inline OkioByteString *Okhttp3InternalUtil_get_UTF_16_LE_BOM();
static OkioByteString *Okhttp3InternalUtil_UTF_16_LE_BOM;
J2OBJC_STATIC_FIELD_OBJ_FINAL(Okhttp3InternalUtil, UTF_16_LE_BOM, OkioByteString *)

inline OkioByteString *Okhttp3InternalUtil_get_UTF_32_BE_BOM();
static OkioByteString *Okhttp3InternalUtil_UTF_32_BE_BOM;
J2OBJC_STATIC_FIELD_OBJ_FINAL(Okhttp3InternalUtil, UTF_32_BE_BOM, OkioByteString *)

inline OkioByteString *Okhttp3InternalUtil_get_UTF_32_LE_BOM();
static OkioByteString *Okhttp3InternalUtil_UTF_32_LE_BOM;
J2OBJC_STATIC_FIELD_OBJ_FINAL(Okhttp3InternalUtil, UTF_32_LE_BOM, OkioByteString *)

inline JavaNioCharsetCharset *Okhttp3InternalUtil_get_UTF_16_BE();
static JavaNioCharsetCharset *Okhttp3InternalUtil_UTF_16_BE;
J2OBJC_STATIC_FIELD_OBJ_FINAL(Okhttp3InternalUtil, UTF_16_BE, JavaNioCharsetCharset *)

inline JavaNioCharsetCharset *Okhttp3InternalUtil_get_UTF_16_LE();
static JavaNioCharsetCharset *Okhttp3InternalUtil_UTF_16_LE;
J2OBJC_STATIC_FIELD_OBJ_FINAL(Okhttp3InternalUtil, UTF_16_LE, JavaNioCharsetCharset *)

inline JavaNioCharsetCharset *Okhttp3InternalUtil_get_UTF_32_BE();
static JavaNioCharsetCharset *Okhttp3InternalUtil_UTF_32_BE;
J2OBJC_STATIC_FIELD_OBJ_FINAL(Okhttp3InternalUtil, UTF_32_BE, JavaNioCharsetCharset *)

inline JavaNioCharsetCharset *Okhttp3InternalUtil_get_UTF_32_LE();
static JavaNioCharsetCharset *Okhttp3InternalUtil_UTF_32_LE;
J2OBJC_STATIC_FIELD_OBJ_FINAL(Okhttp3InternalUtil, UTF_32_LE, JavaNioCharsetCharset *)
...
Okhttp3ResponseBody *Okhttp3InternalUtil_EMPTY_RESPONSE;
Okhttp3RequestBody *Okhttp3InternalUtil_EMPTY_REQUEST;
...
+ (jint)indexOfControlOrNonAsciiWithNSString:(NSString *)input {
  return Okhttp3InternalUtil_indexOfControlOrNonAsciiWithNSString_(input);
}
...
+ (JavaNioCharsetCharset *)bomAwareCharsetWithOkioBufferedSource:(id<OkioBufferedSource>)source
                                       withJavaNioCharsetCharset:(JavaNioCharsetCharset *)charset {
  return Okhttp3InternalUtil_bomAwareCharsetWithOkioBufferedSource_withJavaNioCharsetCharset_(source, charset);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "Z", 0x9, 10, 9, 11, -1, -1, -1 },
    { NULL, "LJavaUtilList;", 0x9, 12, 13, -1, 14, -1, -1 },
    { NULL, "LJavaUtilList;", 0x89, 12, 15, -1, 16, -1, -1 },
    { NULL, "LJavaUtilConcurrentThreadFactory;", 0x9, 17, 18, -1, -1, -1, -1 },
    { NULL, "[LNSObject;", 0x9, 19, 20, -1, 21, -1, -1 },
    { NULL, "LJavaUtilList;", 0xa, 19, 22, -1, 23, -1, -1 },
    { NULL, "LNSString;", 0x9, 24, 25, -1, -1, -1, -1 },
    { NULL, "LNSString;", 0x9, 26, 27, -1, -1, -1, -1 },
    { NULL, "Z", 0x9, 28, 29, -1, -1, -1, -1 },
    { NULL, "I", 0x9, 30, 31, -1, 32, -1, -1 },
    { NULL, "[LNSString;", 0x9, 33, 34, -1, -1, -1, -1 },
    { NULL, "I", 0x9, 35, 36, -1, -1, -1, -1 },
    { NULL, "I", 0x9, 37, 36, -1, -1, -1, -1 },
    { NULL, "LNSString;", 0x9, 38, 36, -1, -1, -1, -1 },
    { NULL, "I", 0x9, 39, 40, -1, -1, -1, -1 },
    { NULL, "I", 0x9, 39, 41, -1, -1, -1, -1 },
    { NULL, "LNSString;", 0x9, 42, 27, -1, -1, -1, -1 },
    { NULL, "Z", 0xa, 43, 27, -1, -1, -1, -1 },
    { NULL, "I", 0x9, 44, 27, -1, -1, -1, -1 },
    { NULL, "Z", 0x9, 45, 27, -1, -1, -1, -1 },
    { NULL, "LNSString;", 0x89, 46, 47, -1, -1, -1, -1 },
    { NULL, "LJavaNioCharsetCharset;", 0x9, 48, 49, 11, -1, -1, -1 },
  };
  ...
  methods[6].selector = @selector(discardWithOkioSource:withInt:withJavaUtilConcurrentTimeUnit:);
  methods[7].selector = @selector(skipAllWithOkioSource:withInt:withJavaUtilConcurrentTimeUnit:);
  methods[8].selector = @selector(immutableListWithJavaUtilList:);
  methods[9].selector = @selector(immutableListWithNSObjectArray:);
  methods[10].selector = @selector(threadFactoryWithNSString:withBoolean:);
  methods[11].selector = @selector(intersectWithIOSClass:withNSObjectArray:withNSObjectArray:);
  methods[12].selector = @selector(intersectWithNSObjectArray:withNSObjectArray:);
  methods[13].selector = @selector(hostHeaderWithOkhttp3HttpUrl:withBoolean:);
  methods[14].selector = @selector(toHumanReadableAsciiWithNSString:);
  methods[15].selector = @selector(isAndroidGetsocknameErrorWithJavaLangAssertionError:);
  methods[16].selector = @selector(indexOfWithNSObjectArray:withId:);
  methods[17].selector = @selector(concatWithNSStringArray:withNSString:);
  methods[18].selector = @selector(skipLeadingAsciiWhitespaceWithNSString:withInt:withInt:);
  methods[19].selector = @selector(skipTrailingAsciiWhitespaceWithNSString:withInt:withInt:);
  methods[20].selector = @selector(trimSubstringWithNSString:withInt:withInt:);
  methods[21].selector = @selector(delimiterOffsetWithNSString:withInt:withInt:withNSString:);
  methods[22].selector = @selector(delimiterOffsetWithNSString:withInt:withInt:withChar:);
  methods[23].selector = @selector(domainToAsciiWithNSString:);
  methods[24].selector = @selector(containsInvalidHostnameAsciiCodesWithNSString:);
  methods[25].selector = @selector(indexOfControlOrNonAsciiWithNSString:);
  methods[26].selector = @selector(verifyAsIpAddressWithNSString:);
  methods[27].selector = @selector(formatWithNSString:withNSObjectArray:);
  methods[28].selector = @selector(bomAwareCharsetWithOkioBufferedSource:withJavaNioCharsetCharset:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "EMPTY_BYTE_ARRAY", "[B", .constantValue.asLong = 0, 0x19, -1, 50, -1, -1 },
    { "EMPTY_STRING_ARRAY", "[LNSString;", .constantValue.asLong = 0, 0x19, -1, 51, -1, -1 },
    { "EMPTY_RESPONSE", "LOkhttp3ResponseBody;", .constantValue.asLong = 0, 0x19, -1, 52, -1, -1 },
    { "EMPTY_REQUEST", "LOkhttp3RequestBody;", .constantValue.asLong = 0, 0x19, -1, 53, -1, -1 },
    { "UTF_8_BOM", "LOkioByteString;", .constantValue.asLong = 0, 0x1a, -1, 54, -1, -1 },
    { "UTF_16_BE_BOM", "LOkioByteString;", .constantValue.asLong = 0, 0x1a, -1, 55, -1, -1 },
    { "UTF_16_LE_BOM", "LOkioByteString;", .constantValue.asLong = 0, 0x1a, -1, 56, -1, -1 },
    { "UTF_32_BE_BOM", "LOkioByteString;", .constantValue.asLong = 0, 0x1a, -1, 57, -1, -1 },
    { "UTF_32_LE_BOM", "LOkioByteString;", .constantValue.asLong = 0, 0x1a, -1, 58, -1, -1 },
    { "UTF_8", "LJavaNioCharsetCharset;", .constantValue.asLong = 0, 0x19, -1, 59, -1, -1 },
    { "UTF_16_BE", "LJavaNioCharsetCharset;", .constantValue.asLong = 0, 0x1a, -1, 60, -1, -1 },
    { "UTF_16_LE", "LJavaNioCharsetCharset;", .constantValue.asLong = 0, 0x1a, -1, 61, -1, -1 },
    { "UTF_32_BE", "LJavaNioCharsetCharset;", .constantValue.asLong = 0, 0x1a, -1, 62, -1, -1 },
    { "UTF_32_LE", "LJavaNioCharsetCharset;", .constantValue.asLong = 0, 0x1a, -1, 63, -1, -1 },
    { "UTC", "LJavaUtilTimeZone;", .constantValue.asLong = 0, 0x19, -1, 64, -1, -1 },
    { "VERIFY_AS_IP_ADDRESS", "LJavaUtilRegexPattern;", .constantValue.asLong = 0, 0x1a, -1, 65, -1, -1 },
  };
  static const void *ptrTable[] = { "checkOffsetAndCount", "JJJ", "equal", "LNSObject;LNSObject;", "closeQuietly", "LJavaIoCloseable;", "LJavaNetSocket;", "LJavaNetServerSocket;", "discard", "LOkioSource;ILJavaUtilConcurrentTimeUnit;", "skipAll", "LJavaIoIOException;", "immutableList", "LJavaUtilList;", "<T:Ljava/lang/Object;>(Ljava/util/List<TT;>;)Ljava/util/List<TT;>;", "[LNSObject;", "<T:Ljava/lang/Object;>([TT;)Ljava/util/List<TT;>;", "threadFactory", "LNSString;Z", "intersect", "LIOSClass;[LNSObject;[LNSObject;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;[TT;[TT;)[TT;", "[LNSObject;[LNSObject;", "<T:Ljava/lang/Object;>([TT;[TT;)Ljava/util/List<TT;>;", "hostHeader", "LOkhttp3HttpUrl;Z", "toHumanReadableAscii", "LNSString;", "isAndroidGetsocknameError", "LJavaLangAssertionError;", "indexOf", "[LNSObject;LNSObject;", "<T:Ljava/lang/Object;>([TT;TT;)I", "concat", "[LNSString;LNSString;", "skipLeadingAsciiWhitespace", "LNSString;II", "skipTrailingAsciiWhitespace", "trimSubstring", "delimiterOffset", "LNSString;IILNSString;", "LNSString;IIC", "domainToAscii", "containsInvalidHostnameAsciiCodes", "indexOfControlOrNonAscii", "verifyAsIpAddress", "format", "LNSString;[LNSObject;", "bomAwareCharset", "LOkioBufferedSource;LJavaNioCharsetCharset;", &Okhttp3InternalUtil_EMPTY_BYTE_ARRAY, &Okhttp3InternalUtil_EMPTY_STRING_ARRAY, &Okhttp3InternalUtil_EMPTY_RESPONSE, &Okhttp3InternalUtil_EMPTY_REQUEST, &Okhttp3InternalUtil_UTF_8_BOM, &Okhttp3InternalUtil_UTF_16_BE_BOM, &Okhttp3InternalUtil_UTF_16_LE_BOM, &Okhttp3InternalUtil_UTF_32_BE_BOM, &Okhttp3InternalUtil_UTF_32_LE_BOM, &Okhttp3InternalUtil_UTF_8, &Okhttp3InternalUtil_UTF_16_BE, &Okhttp3InternalUtil_UTF_16_LE, &Okhttp3InternalUtil_UTF_32_BE, &Okhttp3InternalUtil_UTF_32_LE, &Okhttp3InternalUtil_UTC, &Okhttp3InternalUtil_VERIFY_AS_IP_ADDRESS };
  static const J2ObjcClassInfo _Okhttp3InternalUtil = { "Util", "okhttp3.internal", ptrTable, methods, fields, 7, 0x11, 29, 16, -1, -1, -1, -1, -1 };
...
+ (void)initialize {
  if (self == [Okhttp3InternalUtil class]) {
    ...
    JreStrongAssign(&Okhttp3InternalUtil_EMPTY_RESPONSE, Okhttp3ResponseBody_createWithOkhttp3MediaType_withByteArray_(nil, Okhttp3InternalUtil_EMPTY_BYTE_ARRAY));
    JreStrongAssign(&Okhttp3InternalUtil_EMPTY_REQUEST, Okhttp3RequestBody_createWithOkhttp3MediaType_withByteArray_(nil, Okhttp3InternalUtil_EMPTY_BYTE_ARRAY));
    JreStrongAssign(&Okhttp3InternalUtil_UTF_8_BOM, OkioByteString_decodeHexWithNSString_(@"efbbbf"));
    JreStrongAssign(&Okhttp3InternalUtil_UTF_16_BE_BOM, OkioByteString_decodeHexWithNSString_(@"feff"));
    JreStrongAssign(&Okhttp3InternalUtil_UTF_16_LE_BOM, OkioByteString_decodeHexWithNSString_(@"fffe"));
    JreStrongAssign(&Okhttp3InternalUtil_UTF_32_BE_BOM, OkioByteString_decodeHexWithNSString_(@"0000ffff"));
    JreStrongAssign(&Okhttp3InternalUtil_UTF_32_LE_BOM, OkioByteString_decodeHexWithNSString_(@"ffff0000"));
    JreStrongAssign(&Okhttp3InternalUtil_UTF_8, JavaNioCharsetCharset_forNameWithNSString_(@"UTF-8"));
    JreStrongAssign(&Okhttp3InternalUtil_UTF_16_BE, JavaNioCharsetCharset_forNameWithNSString_(@"UTF-16BE"));
    JreStrongAssign(&Okhttp3InternalUtil_UTF_16_LE, JavaNioCharsetCharset_forNameWithNSString_(@"UTF-16LE"));
    JreStrongAssign(&Okhttp3InternalUtil_UTF_32_BE, JavaNioCharsetCharset_forNameWithNSString_(@"UTF-32BE"));
    JreStrongAssign(&Okhttp3InternalUtil_UTF_32_LE, JavaNioCharsetCharset_forNameWithNSString_(@"UTF-32LE"));
...
NSString *Okhttp3InternalUtil_toHumanReadableAsciiWithNSString_(NSString *s) {
  Okhttp3InternalUtil_initialize();
  for (jint i = 0, length = ((jint) [((NSString *) nil_chk(s)) length]), c; i < length; i += JavaLangCharacter_charCountWithInt_(c)) {
...
NSString *Okhttp3InternalUtil_domainToAsciiWithNSString_(NSString *input) {
  Okhttp3InternalUtil_initialize();
  @try {
    NSString *result = [((NSString *) nil_chk(JavaNetIDN_toASCIIWithNSString_(input))) java_lowercaseStringWithJRELocale:JreLoadStatic(JavaUtilLocale, US)];
...
jboolean Okhttp3InternalUtil_containsInvalidHostnameAsciiCodesWithNSString_(NSString *hostnameAscii) {
  Okhttp3InternalUtil_initialize();
  for (jint i = 0; i < ((jint) [((NSString *) nil_chk(hostnameAscii)) length]); i++) {
...
jint Okhttp3InternalUtil_indexOfControlOrNonAsciiWithNSString_(NSString *input) {
  Okhttp3InternalUtil_initialize();
  for (jint i = 0, length = ((jint) [((NSString *) nil_chk(input)) length]); i < length; i++) {
...
JavaNioCharsetCharset *Okhttp3InternalUtil_bomAwareCharsetWithOkioBufferedSource_withJavaNioCharsetCharset_(id<OkioBufferedSource> source, JavaNioCharsetCharset *charset) {
  Okhttp3InternalUtil_initialize();
  if ([((id<OkioBufferedSource>) nil_chk(source)) rangeEqualsWithLong:0 withOkioByteString:Okhttp3InternalUtil_UTF_8_BOM]) {
    [source skipWithLong:[((OkioByteString *) nil_chk(Okhttp3InternalUtil_UTF_8_BOM)) size]];
    return Okhttp3InternalUtil_UTF_8;
  }
  if ([source rangeEqualsWithLong:0 withOkioByteString:Okhttp3InternalUtil_UTF_16_BE_BOM]) {
    [source skipWithLong:[((OkioByteString *) nil_chk(Okhttp3InternalUtil_UTF_16_BE_BOM)) size]];
    return Okhttp3InternalUtil_UTF_16_BE;
  }
  if ([source rangeEqualsWithLong:0 withOkioByteString:Okhttp3InternalUtil_UTF_16_LE_BOM]) {
    [source skipWithLong:[((OkioByteString *) nil_chk(Okhttp3InternalUtil_UTF_16_LE_BOM)) size]];
    return Okhttp3InternalUtil_UTF_16_LE;
  }
  if ([source rangeEqualsWithLong:0 withOkioByteString:Okhttp3InternalUtil_UTF_32_BE_BOM]) {
    [source skipWithLong:[((OkioByteString *) nil_chk(Okhttp3InternalUtil_UTF_32_BE_BOM)) size]];
    return Okhttp3InternalUtil_UTF_32_BE;
  }
  if ([source rangeEqualsWithLong:0 withOkioByteString:Okhttp3InternalUtil_UTF_32_LE_BOM]) {
    [source skipWithLong:[((OkioByteString *) nil_chk(Okhttp3InternalUtil_UTF_32_LE_BOM)) size]];
    return Okhttp3InternalUtil_UTF_32_LE;
  }
  return charset;
}
