...
//  source: ../target/dependency/okhttp3/internal/http/HttpMethod.java
//
...
+ (jboolean)redirectsWithBodyWithNSString:(NSString *)method {
  return Okhttp3InternalHttpHttpMethod_redirectsWithBodyWithNSString_(method);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[3].selector = @selector(redirectsWithBodyWithNSString:);
  methods[4].selector = @selector(redirectsToGetWithNSString:);
  methods[5].selector = @selector(init);
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "invalidatesCache", "LNSString;", "requiresRequestBody", "permitsRequestBody", "redirectsWithBody", "redirectsToGet" };
  static const J2ObjcClassInfo _Okhttp3InternalHttpHttpMethod = { "HttpMethod", "okhttp3.internal.http", ptrTable, methods, NULL, 7, 0x11, 6, 0, -1, -1, -1, -1, -1 };
...
jboolean Okhttp3InternalHttpHttpMethod_redirectsWithBodyWithNSString_(NSString *method) {
  Okhttp3InternalHttpHttpMethod_initialize();
