...
FOUNDATION_EXPORT NSString *Okhttp3Cache_keyWithOkhttp3HttpUrl_(Okhttp3HttpUrl *url);

FOUNDATION_EXPORT jint Okhttp3Cache_readIntWithOkioBufferedSource_(id<OkioBufferedSource> source);
