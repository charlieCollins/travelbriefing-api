...
- (id<JavaUtilList>)cipherSuites {
  ...
  id<JavaUtilList> result = create_JavaUtilArrayList_initWithInt_(cipherSuites_->size_);
  {
    IOSObjectArray *a__ = cipherSuites_;
    NSString * const *b__ = a__->buffer_;
    NSString * const *e__ = b__ + a__->size_;
    while (b__ < e__) {
      NSString *cipherSuite = *b__++;
      [result addWithId:Okhttp3CipherSuite_forJavaNameWithNSString_(cipherSuite)];
    }
  }
...
- (id<JavaUtilList>)tlsVersions {
  ...
  id<JavaUtilList> result = create_JavaUtilArrayList_initWithInt_(tlsVersions_->size_);
  {
    IOSObjectArray *a__ = tlsVersions_;
    NSString * const *b__ = a__->buffer_;
    NSString * const *e__ = b__ + a__->size_;
    while (b__ < e__) {
      NSString *tlsVersion = *b__++;
      [result addWithId:Okhttp3TlsVersion_forJavaNameWithNSString_(tlsVersion)];
    }
  }
  return JavaUtilCollections_unmodifiableListWithJavaUtilList_(result);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "tls_", "Z", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
    { "supportsTlsExtensions_", "Z", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
    { "cipherSuites_", "[LNSString;", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
    { "tlsVersions_", "[LNSString;", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
  };
...
+ (void)initialize {
  if (self == [Okhttp3ConnectionSpec class]) {
    JreStrongAssignAndConsume(&Okhttp3ConnectionSpec_APPROVED_CIPHER_SUITES, [IOSObjectArray newArrayWithObjects:(id[]){ JreLoadStatic(Okhttp3CipherSuite, TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256), JreLoadStatic(Okhttp3CipherSuite, TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256), JreLoadStatic(Okhttp3CipherSuite, TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384), JreLoadStatic(Okhttp3CipherSuite, TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384), JreLoadStatic(Okhttp3CipherSuite, TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256), JreLoadStatic(Okhttp3CipherSuite, TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256), JreLoadStatic(Okhttp3CipherSuite, TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA), JreLoadStatic(Okhttp3CipherSuite, TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA), JreLoadStatic(Okhttp3CipherSuite, TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA), JreLoadStatic(Okhttp3CipherSuite, TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA), JreLoadStatic(Okhttp3CipherSuite, TLS_RSA_WITH_AES_128_GCM_SHA256), JreLoadStatic(Okhttp3CipherSuite, TLS_RSA_WITH_AES_256_GCM_SHA384), JreLoadStatic(Okhttp3CipherSuite, TLS_RSA_WITH_AES_128_CBC_SHA), JreLoadStatic(Okhttp3CipherSuite, TLS_RSA_WITH_AES_256_CBC_SHA), JreLoadStatic(Okhttp3CipherSuite, TLS_RSA_WITH_3DES_EDE_CBC_SHA) } count:15 type:Okhttp3CipherSuite_class_()]);
    JreStrongAssign(&Okhttp3ConnectionSpec_MODERN_TLS, [((Okhttp3ConnectionSpec_Builder *) nil_chk([((Okhttp3ConnectionSpec_Builder *) nil_chk([((Okhttp3ConnectionSpec_Builder *) nil_chk([create_Okhttp3ConnectionSpec_Builder_initWithBoolean_(true) cipherSuitesWithOkhttp3CipherSuiteArray:Okhttp3ConnectionSpec_APPROVED_CIPHER_SUITES])) tlsVersionsWithOkhttp3TlsVersionArray:[IOSObjectArray arrayWithObjects:(id[]){ JreLoadEnum(Okhttp3TlsVersion, TLS_1_3), JreLoadEnum(Okhttp3TlsVersion, TLS_1_2), JreLoadEnum(Okhttp3TlsVersion, TLS_1_1), JreLoadEnum(Okhttp3TlsVersion, TLS_1_0) } count:4 type:Okhttp3TlsVersion_class_()]])) supportsTlsExtensionsWithBoolean:true])) build]);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "tls_", "Z", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "cipherSuites_", "[LNSString;", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "tlsVersions_", "[LNSString;", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "supportsTlsExtensions_", "Z", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
  };
