...
FOUNDATION_EXPORT void Okhttp3Cookie_initWithOkhttp3Cookie_Builder_(Okhttp3Cookie *self, Okhttp3Cookie_Builder *builder);

FOUNDATION_EXPORT Okhttp3Cookie *new_Okhttp3Cookie_initWithOkhttp3Cookie_Builder_(Okhttp3Cookie_Builder *builder) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT Okhttp3Cookie *create_Okhttp3Cookie_initWithOkhttp3Cookie_Builder_(Okhttp3Cookie_Builder *builder);
