...
FOUNDATION_EXPORT void OrgJunitRunnerJUnitCommandLineParseResult_init(OrgJunitRunnerJUnitCommandLineParseResult *self);

FOUNDATION_EXPORT OrgJunitRunnerJUnitCommandLineParseResult *new_OrgJunitRunnerJUnitCommandLineParseResult_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgJunitRunnerJUnitCommandLineParseResult *create_OrgJunitRunnerJUnitCommandLineParseResult_init();
