...
FOUNDATION_EXPORT ComGoogleGsonReflectTypeToken *ComGoogleGsonReflectTypeToken_getParameterizedWithJavaLangReflectType_withJavaLangReflectTypeArray_(id<JavaLangReflectType> rawType, IOSObjectArray *typeArguments);

FOUNDATION_EXPORT ComGoogleGsonReflectTypeToken *ComGoogleGsonReflectTypeToken_getArrayWithJavaLangReflectType_(id<JavaLangReflectType> componentType);
