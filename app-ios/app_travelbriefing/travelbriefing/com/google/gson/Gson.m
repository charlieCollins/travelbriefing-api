...
//  source: ../target/dependency/com/google/gson/Gson.java
//
...
@interface ComGoogleGsonGson_1 : ComGoogleGsonReflectTypeToken
...
__attribute__((unused)) static void ComGoogleGsonGson_1_init(ComGoogleGsonGson_1 *self);

__attribute__((unused)) static ComGoogleGsonGson_1 *new_ComGoogleGsonGson_1_init() NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleGsonGson_1 *create_ComGoogleGsonGson_1_init();

@interface ComGoogleGsonGson_2 : ComGoogleGsonTypeAdapter
...
__attribute__((unused)) static void ComGoogleGsonGson_2_init(ComGoogleGsonGson_2 *self);

__attribute__((unused)) static ComGoogleGsonGson_2 *new_ComGoogleGsonGson_2_init() NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleGsonGson_2 *create_ComGoogleGsonGson_2_init();
...
__attribute__((unused)) static void ComGoogleGsonGson_5_initWithComGoogleGsonTypeAdapter_(ComGoogleGsonGson_5 *self, ComGoogleGsonTypeAdapter *capture$0);

__attribute__((unused)) static ComGoogleGsonGson_5 *new_ComGoogleGsonGson_5_initWithComGoogleGsonTypeAdapter_(ComGoogleGsonTypeAdapter *capture$0) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleGsonGson_5 *create_ComGoogleGsonGson_5_initWithComGoogleGsonTypeAdapter_(ComGoogleGsonTypeAdapter *capture$0);
...
- (void)dealloc {
  ...
  RELEASE_(excluder_);
  RELEASE_(fieldNamingStrategy_);
  RELEASE_(jsonAdapterFactory_);
  [super dealloc];
}
...
+ (void)initialize {
  if (self == [ComGoogleGsonGson class]) {
    JreStrongAssignAndConsume(&ComGoogleGsonGson_NULL_KEY_SURROGATE, new_ComGoogleGsonGson_1_init());
...
void ComGoogleGsonGson_initWithComGoogleGsonInternalExcluder_withComGoogleGsonFieldNamingStrategy_withJavaUtilMap_withBoolean_withBoolean_withBoolean_withBoolean_withBoolean_withBoolean_withBoolean_withComGoogleGsonLongSerializationPolicy_withJavaUtilList_(ComGoogleGsonGson *self, ComGoogleGsonInternalExcluder *excluder, id<ComGoogleGsonFieldNamingStrategy> fieldNamingStrategy, id<JavaUtilMap> instanceCreators, jboolean serializeNulls, jboolean complexMapKeySerialization, jboolean generateNonExecutableGson, jboolean htmlSafe, jboolean prettyPrinting, jboolean lenient, jboolean serializeSpecialFloatingPointValues, ComGoogleGsonLongSerializationPolicy *longSerializationPolicy, id<JavaUtilList> typeAdapterFactories) {
  ...
  JreStrongAssignAndConsume(&self->typeTokenCache_, new_JavaUtilConcurrentConcurrentHashMap_init());
  ...
  JreStrongAssign(&self->fieldNamingStrategy_, fieldNamingStrategy);
  ...
  JreStrongAssignAndConsume(&self->jsonAdapterFactory_, new_ComGoogleGsonInternalBindJsonAdapterAnnotationTypeAdapterFactory_initWithComGoogleGsonInternalConstructorConstructor_(self->constructorConstructor_));
  ...
  [factories addWithId:create_ComGoogleGsonInternalBindReflectiveTypeAdapterFactory_initWithComGoogleGsonInternalConstructorConstructor_withComGoogleGsonFieldNamingStrategy_withComGoogleGsonInternalExcluder_withComGoogleGsonInternalBindJsonAdapterAnnotationTypeAdapterFactory_(self->constructorConstructor_, fieldNamingStrategy, excluder, self->jsonAdapterFactory_)];
...
ComGoogleGsonTypeAdapter *ComGoogleGsonGson_doubleAdapterWithBoolean_(ComGoogleGsonGson *self, jboolean serializeSpecialFloatingPointValues) {
  ...
  return create_ComGoogleGsonGson_2_init();
}
...
ComGoogleGsonTypeAdapter *ComGoogleGsonGson_atomicLongAdapterWithComGoogleGsonTypeAdapter_(ComGoogleGsonTypeAdapter *longAdapter) {
  ComGoogleGsonGson_initialize();
  return [create_ComGoogleGsonGson_5_initWithComGoogleGsonTypeAdapter_(longAdapter) nullSafe];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleGsonGson_1 = { "", "com.google.gson", ptrTable, methods, NULL, 7, 0x8008, 1, 0, 0, -1, -1, 1, -1 };
  return &_ComGoogleGsonGson_1;
}

@end

void ComGoogleGsonGson_1_init(ComGoogleGsonGson_1 *self) {
  ComGoogleGsonReflectTypeToken_init(self);
}

ComGoogleGsonGson_1 *new_ComGoogleGsonGson_1_init() {
  J2OBJC_NEW_IMPL(ComGoogleGsonGson_1, init)
}

ComGoogleGsonGson_1 *create_ComGoogleGsonGson_1_init() {
  J2OBJC_CREATE_IMPL(ComGoogleGsonGson_1, init)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleGsonGson_2 = { "", "com.google.gson", ptrTable, methods, NULL, 7, 0x8008, 3, 0, 5, -1, 6, 7, -1 };
  return &_ComGoogleGsonGson_2;
}

@end

void ComGoogleGsonGson_2_init(ComGoogleGsonGson_2 *self) {
  ComGoogleGsonTypeAdapter_init(self);
}

ComGoogleGsonGson_2 *new_ComGoogleGsonGson_2_init() {
  J2OBJC_NEW_IMPL(ComGoogleGsonGson_2, init)
}

ComGoogleGsonGson_2 *create_ComGoogleGsonGson_2_init() {
  J2OBJC_CREATE_IMPL(ComGoogleGsonGson_2, init)
}
...
- (instancetype)initWithComGoogleGsonTypeAdapter:(ComGoogleGsonTypeAdapter *)capture$0 {
  ComGoogleGsonGson_5_initWithComGoogleGsonTypeAdapter_(self, capture$0);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleGsonGson_5 = { "", "com.google.gson", ptrTable, methods, fields, 7, 0x8008, 3, 1, 6, -1, 7, 8, -1 };
  return &_ComGoogleGsonGson_5;
}

@end

void ComGoogleGsonGson_5_initWithComGoogleGsonTypeAdapter_(ComGoogleGsonGson_5 *self, ComGoogleGsonTypeAdapter *capture$0) {
  JreStrongAssign(&self->val$longAdapter_, capture$0);
  ComGoogleGsonTypeAdapter_init(self);
}

ComGoogleGsonGson_5 *new_ComGoogleGsonGson_5_initWithComGoogleGsonTypeAdapter_(ComGoogleGsonTypeAdapter *capture$0) {
  J2OBJC_NEW_IMPL(ComGoogleGsonGson_5, initWithComGoogleGsonTypeAdapter_, capture$0)
}

ComGoogleGsonGson_5 *create_ComGoogleGsonGson_5_initWithComGoogleGsonTypeAdapter_(ComGoogleGsonTypeAdapter *capture$0) {
  J2OBJC_CREATE_IMPL(ComGoogleGsonGson_5, initWithComGoogleGsonTypeAdapter_, capture$0)
}
