...
FOUNDATION_EXPORT ComGoogleCommonGraphEndpointPairIterator *ComGoogleCommonGraphEndpointPairIterator_ofWithComGoogleCommonGraphGraph_(id<ComGoogleCommonGraphGraph> graph);
