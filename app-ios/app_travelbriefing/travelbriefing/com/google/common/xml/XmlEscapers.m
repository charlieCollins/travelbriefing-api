...
//  source: ../target/dependency/com/google/common/xml/XmlEscapers.java
//
  ...
  if (self == [ComGoogleCommonXmlXmlEscapers class]) {
    {
      ...
      [((ComGoogleCommonEscapeEscapers_Builder *) nil_chk(builder)) setSafeRangeWithChar:JavaLangCharacter_MIN_VALUE withChar:0xfffd];
      [builder setUnsafeReplacementWithNSString:@"\ufffd"];
      for (jchar c = ComGoogleCommonXmlXmlEscapers_MIN_ASCII_CONTROL_CHAR; c <= ComGoogleCommonXmlXmlEscapers_MAX_ASCII_CONTROL_CHAR; c++) {
        if (c != 0x0009 && c != 0x000a && c != 0x000d) {
          [builder addEscapeWithChar:c withNSString:@"\ufffd"];
        }
      }
      [builder addEscapeWithChar:'&' withNSString:@"&amp;"];
      [builder addEscapeWithChar:'<' withNSString:@"&lt;"];
      [builder addEscapeWithChar:'>' withNSString:@"&gt;"];
      JreStrongAssign(&ComGoogleCommonXmlXmlEscapers_XML_CONTENT_ESCAPER, [builder build]);
      [builder addEscapeWithChar:'\'' withNSString:@"&apos;"];
      [builder addEscapeWithChar:'"' withNSString:@"&quot;"];
      JreStrongAssign(&ComGoogleCommonXmlXmlEscapers_XML_ESCAPER, [builder build]);
      [builder addEscapeWithChar:0x0009 withNSString:@"&#x9;"];
      [builder addEscapeWithChar:0x000a withNSString:@"&#xA;"];
      [builder addEscapeWithChar:0x000d withNSString:@"&#xD;"];
      JreStrongAssign(&ComGoogleCommonXmlXmlEscapers_XML_ATTRIBUTE_ESCAPER, [builder build]);
    }
