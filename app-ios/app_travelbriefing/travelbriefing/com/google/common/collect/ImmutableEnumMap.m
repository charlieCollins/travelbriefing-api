...
//  source: ../target/dependency/com/google/common/collect/ImmutableEnumMap.java
//
...
- (id)writeReplace {
  return create_ComGoogleCommonCollectImmutableEnumMap_EnumSerializedForm_initWithJavaUtilEnumMap_(delegate_);
}
...
ComGoogleCommonCollectImmutableMap *ComGoogleCommonCollectImmutableEnumMap_asImmutableWithJavaUtilEnumMap_(JavaUtilEnumMap *map) {
  ComGoogleCommonCollectImmutableEnumMap_initialize();
  {
    ...
    switch ([((JavaUtilEnumMap *) nil_chk(map)) size]) {
      ...
      default:
      return create_ComGoogleCommonCollectImmutableEnumMap_initWithJavaUtilEnumMap_(map);
    }
  }
}
...
- (id)readResolve {
  return create_ComGoogleCommonCollectImmutableEnumMap_initWithJavaUtilEnumMap_(delegate_);
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonCollectImmutableEnumMap_$Lambda$1 class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonCollectImmutableEnumMap_$Lambda$1_instance, new_ComGoogleCommonCollectImmutableEnumMap_$Lambda$1_init());
