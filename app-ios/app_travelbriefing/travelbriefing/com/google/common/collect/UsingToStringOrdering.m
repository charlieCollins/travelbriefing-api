...
//  source: ../target/dependency/com/google/common/collect/UsingToStringOrdering.java
//
...
+ (void)initialize {
  if (self == [ComGoogleCommonCollectUsingToStringOrdering class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonCollectUsingToStringOrdering_INSTANCE, new_ComGoogleCommonCollectUsingToStringOrdering_init());
