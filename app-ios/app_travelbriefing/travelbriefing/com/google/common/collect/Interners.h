...
#if !defined (ComGoogleCommonCollectInterners_StrongInterner_) && (INCLUDE_ALL_ComGoogleCommonCollectInterners || defined(INCLUDE_ComGoogleCommonCollectInterners_StrongInterner))
#define ComGoogleCommonCollectInterners_StrongInterner_
...
@interface ComGoogleCommonCollectInterners_StrongInterner : NSObject < ComGoogleCommonCollectInterner > {
 @public
...
J2OBJC_EMPTY_STATIC_INIT(ComGoogleCommonCollectInterners_StrongInterner)

J2OBJC_FIELD_SETTER(ComGoogleCommonCollectInterners_StrongInterner, map_, id<JavaUtilConcurrentConcurrentMap>)

J2OBJC_TYPE_LITERAL_HEADER(ComGoogleCommonCollectInterners_StrongInterner)

#endif

#if !defined (ComGoogleCommonCollectInterners_WeakInterner_) && (INCLUDE_ALL_ComGoogleCommonCollectInterners || defined(INCLUDE_ComGoogleCommonCollectInterners_WeakInterner))
#define ComGoogleCommonCollectInterners_WeakInterner_
