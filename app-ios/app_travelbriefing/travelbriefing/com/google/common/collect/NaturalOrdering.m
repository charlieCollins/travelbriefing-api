...
//  source: ../target/dependency/com/google/common/collect/NaturalOrdering.java
//
...
- (ComGoogleCommonCollectOrdering *)nullsFirst {
  ...
  if (result == nil) {
    result = JreStrongAssign(&nullsFirst_, [super nullsFirst]);
  }
  return result;
}
...
- (ComGoogleCommonCollectOrdering *)nullsLast {
  ...
  if (result == nil) {
    result = JreStrongAssign(&nullsLast_, [super nullsLast]);
  }
  return result;
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonCollectNaturalOrdering class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonCollectNaturalOrdering_INSTANCE, new_ComGoogleCommonCollectNaturalOrdering_init());
