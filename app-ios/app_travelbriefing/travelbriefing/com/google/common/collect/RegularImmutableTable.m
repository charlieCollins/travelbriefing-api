...
- (ComGoogleCommonCollectImmutableSet *)createCellSet {
  return [self isEmpty] ? ComGoogleCommonCollectImmutableSet_of() : create_ComGoogleCommonCollectRegularImmutableTable_CellSet_initWithComGoogleCommonCollectRegularImmutableTable_(self);
}
...
- (ComGoogleCommonCollectImmutableCollection *)createValues {
  return [self isEmpty] ? ComGoogleCommonCollectImmutableList_of() : create_ComGoogleCommonCollectRegularImmutableTable_Values_initWithComGoogleCommonCollectRegularImmutableTable_(self);
}
...
ComGoogleCommonCollectRegularImmutableTable *ComGoogleCommonCollectRegularImmutableTable_forCellsWithJavaUtilList_withJavaUtilComparator_withJavaUtilComparator_(id<JavaUtilList> cells, id<JavaUtilComparator> rowComparator, id<JavaUtilComparator> columnComparator) {
  ...
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(cells);
  if (rowComparator != nil || columnComparator != nil) {
    id<JavaUtilComparator> comparator = create_ComGoogleCommonCollectRegularImmutableTable_1_initWithJavaUtilComparator_withJavaUtilComparator_(rowComparator, columnComparator);
...
ComGoogleCommonCollectRegularImmutableTable *ComGoogleCommonCollectRegularImmutableTable_forCellsInternalWithJavaLangIterable_withJavaUtilComparator_withJavaUtilComparator_(id<JavaLangIterable> cells, id<JavaUtilComparator> rowComparator, id<JavaUtilComparator> columnComparator) {
  ComGoogleCommonCollectRegularImmutableTable_initialize();
  id<JavaUtilSet> rowSpaceBuilder = create_JavaUtilLinkedHashSet_init();
  id<JavaUtilSet> columnSpaceBuilder = create_JavaUtilLinkedHashSet_init();
...
ComGoogleCommonCollectRegularImmutableTable *ComGoogleCommonCollectRegularImmutableTable_forOrderedComponentsWithComGoogleCommonCollectImmutableList_withComGoogleCommonCollectImmutableSet_withComGoogleCommonCollectImmutableSet_(ComGoogleCommonCollectImmutableList *cellList, ComGoogleCommonCollectImmutableSet *rowSpace, ComGoogleCommonCollectImmutableSet *columnSpace) {
  ComGoogleCommonCollectRegularImmutableTable_initialize();
  return ([((ComGoogleCommonCollectImmutableList *) nil_chk(cellList)) size] > (((jlong) [((ComGoogleCommonCollectImmutableSet *) nil_chk(rowSpace)) size] * [((ComGoogleCommonCollectImmutableSet *) nil_chk(columnSpace)) size]) / 2)) ? create_ComGoogleCommonCollectDenseImmutableTable_initWithComGoogleCommonCollectImmutableList_withComGoogleCommonCollectImmutableSet_withComGoogleCommonCollectImmutableSet_(cellList, rowSpace, columnSpace) : (id) create_ComGoogleCommonCollectSparseImmutableTable_initWithComGoogleCommonCollectImmutableList_withComGoogleCommonCollectImmutableSet_withComGoogleCommonCollectImmutableSet_(cellList, rowSpace, columnSpace);
}
...
- (void)dealloc {
  RELEASE_(val$rowComparator_);
  RELEASE_(val$columnComparator_);
  [super dealloc];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonCollectRegularImmutableTable_1 = { "", "com.google.common.collect", ptrTable, methods, fields, 7, 0x8008, 2, 2, 5, -1, 6, 7, -1 };
...
void ComGoogleCommonCollectRegularImmutableTable_1_initWithJavaUtilComparator_withJavaUtilComparator_(ComGoogleCommonCollectRegularImmutableTable_1 *self, id<JavaUtilComparator> capture$0, id<JavaUtilComparator> capture$1) {
  JreStrongAssign(&self->val$rowComparator_, capture$0);
  JreStrongAssign(&self->val$columnComparator_, capture$1);
  NSObject_init(self);
}
