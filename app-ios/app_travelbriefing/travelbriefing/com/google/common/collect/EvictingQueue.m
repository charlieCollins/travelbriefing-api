...
//  source: ../target/dependency/com/google/common/collect/EvictingQueue.java
//
...
- (jboolean)addWithId:(id)e {
  ...
  if ([self size] == maxSize_) {
    [((id<JavaUtilQueue>) nil_chk(delegate_)) remove];
  }
...
void ComGoogleCommonCollectEvictingQueue_initWithInt_(ComGoogleCommonCollectEvictingQueue *self, jint maxSize) {
  ...
  JreStrongAssignAndConsume(&self->delegate_, new_JavaUtilArrayDeque_initWithInt_(maxSize));
...
ComGoogleCommonCollectEvictingQueue *ComGoogleCommonCollectEvictingQueue_createWithInt_(jint maxSize) {
  ...
  return create_ComGoogleCommonCollectEvictingQueue_initWithInt_(maxSize);
}
