...
//  source: ../target/dependency/com/google/common/hash/Crc32cHashFunction.java
//
...
- (id<ComGoogleCommonHashHasher>)newHasher {
  return create_ComGoogleCommonHashCrc32cHashFunction_Crc32cHasher_init();
}
