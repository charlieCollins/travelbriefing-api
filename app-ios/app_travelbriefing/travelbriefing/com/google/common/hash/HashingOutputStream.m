...
//  source: ../target/dependency/com/google/common/hash/HashingOutputStream.java
//
...
- (void)writeWithByteArray:(IOSByteArray *)bytes
                   withInt:(jint)off
                   withInt:(jint)len {
  [((id<ComGoogleCommonHashHasher>) nil_chk(hasher_)) putBytesWithByteArray:bytes withInt:off withInt:len];
