...
//  source: ../target/dependency/com/google/common/hash/AbstractByteHasher.java
//
...
- (id<ComGoogleCommonHashHasher>)putShortWithShort:(jshort)s {
  [((JavaNioByteBuffer *) nil_chk(scratch_)) putShortWithShort:s];
...
- (id<ComGoogleCommonHashHasher>)putIntWithInt:(jint)i {
  [((JavaNioByteBuffer *) nil_chk(scratch_)) putIntWithInt:i];
...
- (id<ComGoogleCommonHashHasher>)putLongWithLong:(jlong)l {
  [((JavaNioByteBuffer *) nil_chk(scratch_)) putLongWithLong:l];
...
- (id<ComGoogleCommonHashHasher>)putCharWithChar:(jchar)c {
  [((JavaNioByteBuffer *) nil_chk(scratch_)) putCharWithChar:c];
...
void ComGoogleCommonHashAbstractByteHasher_init(ComGoogleCommonHashAbstractByteHasher *self) {
  ...
  JreStrongAssign(&self->scratch_, [((JavaNioByteBuffer *) nil_chk(JavaNioByteBuffer_allocateWithInt_(8))) orderWithJavaNioByteOrder:JreLoadStatic(JavaNioByteOrder, LITTLE_ENDIAN)]);
}
