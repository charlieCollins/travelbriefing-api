...
//  source: ../target/dependency/com/google/common/hash/BloomFilter.java
//
...
- (ComGoogleCommonHashBloomFilter *)copy__ {
  return create_ComGoogleCommonHashBloomFilter_initWithComGoogleCommonHashBloomFilterStrategies_BitArray_withInt_withComGoogleCommonHashFunnel_withComGoogleCommonHashBloomFilter_Strategy_([((ComGoogleCommonHashBloomFilterStrategies_BitArray *) nil_chk(bits_)) copy__], numHashFunctions_, funnel_, strategy_);
}
...
- (jboolean)isCompatibleWithComGoogleCommonHashBloomFilter:(ComGoogleCommonHashBloomFilter *)that {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(that);
...
- (NSUInteger)hash {
  return ComGoogleCommonBaseObjects_hashCodeWithNSObjectArray_([IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(numHashFunctions_), funnel_, strategy_, bits_ } count:4 type:NSObject_class_()]);
}
...
- (id)writeReplace {
  return create_ComGoogleCommonHashBloomFilter_SerialForm_initWithComGoogleCommonHashBloomFilter_(self);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[6].selector = @selector(bitSize);
  methods[7].selector = @selector(isCompatibleWithComGoogleCommonHashBloomFilter:);
  methods[8].selector = @selector(putAllWithComGoogleCommonHashBloomFilter:);
  methods[9].selector = @selector(isEqual:);
  methods[10].selector = @selector(hash);
  methods[11].selector = @selector(createWithComGoogleCommonHashFunnel:withInt:withDouble:);
  methods[12].selector = @selector(createWithComGoogleCommonHashFunnel:withLong:withDouble:);
  methods[13].selector = @selector(createWithComGoogleCommonHashFunnel:withLong:withDouble:withComGoogleCommonHashBloomFilter_Strategy:);
  methods[14].selector = @selector(createWithComGoogleCommonHashFunnel:withInt:);
  methods[15].selector = @selector(createWithComGoogleCommonHashFunnel:withLong:);
  methods[16].selector = @selector(optimalNumOfHashFunctionsWithLong:withLong:);
  methods[17].selector = @selector(optimalNumOfBitsWithLong:withDouble:);
  methods[18].selector = @selector(writeReplace);
  methods[19].selector = @selector(writeToWithJavaIoOutputStream:);
  methods[20].selector = @selector(readFromWithJavaIoInputStream:withComGoogleCommonHashFunnel:);
  ...
  static const J2ObjcClassInfo _ComGoogleCommonHashBloomFilter = { "BloomFilter", "com.google.common.hash", ptrTable, methods, fields, 7, 0x11, 21, 4, -1, 40, -1, 41, -1 };
...
void ComGoogleCommonHashBloomFilter_initWithComGoogleCommonHashBloomFilterStrategies_BitArray_withInt_withComGoogleCommonHashFunnel_withComGoogleCommonHashBloomFilter_Strategy_(ComGoogleCommonHashBloomFilter *self, ComGoogleCommonHashBloomFilterStrategies_BitArray *bits, jint numHashFunctions, id<ComGoogleCommonHashFunnel> funnel, id<ComGoogleCommonHashBloomFilter_Strategy> strategy) {
  ...
  JreStrongAssign(&self->bits_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(bits));
  self->numHashFunctions_ = numHashFunctions;
  JreStrongAssign(&self->funnel_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(funnel));
  JreStrongAssign(&self->strategy_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(strategy));
}
...
ComGoogleCommonHashBloomFilter *ComGoogleCommonHashBloomFilter_createWithComGoogleCommonHashFunnel_withLong_withDouble_withComGoogleCommonHashBloomFilter_Strategy_(id<ComGoogleCommonHashFunnel> funnel, jlong expectedInsertions, jdouble fpp, id<ComGoogleCommonHashBloomFilter_Strategy> strategy) {
  ComGoogleCommonHashBloomFilter_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(funnel);
  ...
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(strategy);
  ...
  @try {
    return create_ComGoogleCommonHashBloomFilter_initWithComGoogleCommonHashBloomFilterStrategies_BitArray_withInt_withComGoogleCommonHashFunnel_withComGoogleCommonHashBloomFilter_Strategy_(create_ComGoogleCommonHashBloomFilterStrategies_BitArray_initWithLong_(numBits), numHashFunctions, funnel, strategy);
  }
  @catch (JavaLangIllegalArgumentException *e) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_withNSException_(JreStrcat("$J$", @"Could not create BloomFilter of ", numBits, @" bits"), e);
  }
}
...
ComGoogleCommonHashBloomFilter *ComGoogleCommonHashBloomFilter_readFromWithJavaIoInputStream_withComGoogleCommonHashFunnel_(JavaIoInputStream *inArg, id<ComGoogleCommonHashFunnel> funnel) {
  ComGoogleCommonHashBloomFilter_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_withId_(inArg, @"InputStream");
  ComGoogleCommonBasePreconditions_checkNotNullWithId_withId_(funnel, @"Funnel");
  ...
  @try {
    ...
    IOSLongArray *data = [IOSLongArray arrayWithLength:dataLength];
    for (jint i = 0; i < data->size_; i++) {
      *IOSLongArray_GetRef(data, i) = [din readLong];
    }
    return create_ComGoogleCommonHashBloomFilter_initWithComGoogleCommonHashBloomFilterStrategies_BitArray_withInt_withComGoogleCommonHashFunnel_withComGoogleCommonHashBloomFilter_Strategy_(create_ComGoogleCommonHashBloomFilterStrategies_BitArray_initWithLongArray_(data), numHashFunctions, funnel, strategy);
  }
  @catch (JavaLangRuntimeException *e) {
    ...
    @throw create_JavaIoIOException_initWithNSString_withNSException_(message, e);
  }
}
...
- (id)readResolve {
  return create_ComGoogleCommonHashBloomFilter_initWithComGoogleCommonHashBloomFilterStrategies_BitArray_withInt_withComGoogleCommonHashFunnel_withComGoogleCommonHashBloomFilter_Strategy_(create_ComGoogleCommonHashBloomFilterStrategies_BitArray_initWithLongArray_(data_), numHashFunctions_, funnel_, strategy_);
}
...
void ComGoogleCommonHashBloomFilter_SerialForm_initWithComGoogleCommonHashBloomFilter_(ComGoogleCommonHashBloomFilter_SerialForm *self, ComGoogleCommonHashBloomFilter *bf) {
  NSObject_init(self);
  JreStrongAssign(&self->data_, ((ComGoogleCommonHashBloomFilterStrategies_BitArray *) nil_chk(((ComGoogleCommonHashBloomFilter *) nil_chk(bf))->bits_))->data_);
  self->numHashFunctions_ = bf->numHashFunctions_;
  JreStrongAssign(&self->funnel_, bf->funnel_);
  JreStrongAssign(&self->strategy_, bf->strategy_);
}
