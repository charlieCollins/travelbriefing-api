...
//  source: ../target/dependency/com/google/common/hash/Murmur3_128HashFunction.java
//
...
- (id<ComGoogleCommonHashHasher>)newHasher {
  return create_ComGoogleCommonHashMurmur3_128HashFunction_Murmur3_128Hasher_initWithInt_(seed_);
}
...
- (ComGoogleCommonHashHashCode *)makeHash {
  ...
  h1_ += h2_;
  h2_ += h1_;
  return ComGoogleCommonHashHashCode_fromBytesNoCopyWithByteArray_([((JavaNioByteBuffer *) nil_chk([((JavaNioByteBuffer *) nil_chk([((JavaNioByteBuffer *) nil_chk([((JavaNioByteBuffer *) nil_chk(JavaNioByteBuffer_wrapWithByteArray_([IOSByteArray arrayWithLength:ComGoogleCommonHashMurmur3_128HashFunction_Murmur3_128Hasher_CHUNK_SIZE]))) orderWithJavaNioByteOrder:JreLoadStatic(JavaNioByteOrder, LITTLE_ENDIAN)])) putLongWithLong:h1_])) putLongWithLong:h2_])) array]);
}
