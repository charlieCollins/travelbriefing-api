...
//  source: ../target/dependency/com/google/common/hash/Funnels.java
//
...
id<ComGoogleCommonHashFunnel> ComGoogleCommonHashFunnels_stringFunnelWithJavaNioCharsetCharset_(JavaNioCharsetCharset *charset) {
  ComGoogleCommonHashFunnels_initialize();
  return create_ComGoogleCommonHashFunnels_StringCharsetFunnel_initWithJavaNioCharsetCharset_(charset);
}
...
id<ComGoogleCommonHashFunnel> ComGoogleCommonHashFunnels_sequentialFunnelWithComGoogleCommonHashFunnel_(id<ComGoogleCommonHashFunnel> elementFunnel) {
  ComGoogleCommonHashFunnels_initialize();
  return create_ComGoogleCommonHashFunnels_SequentialFunnel_initWithComGoogleCommonHashFunnel_(elementFunnel);
}
...
JavaIoOutputStream *ComGoogleCommonHashFunnels_asOutputStreamWithComGoogleCommonHashPrimitiveSink_(id<ComGoogleCommonHashPrimitiveSink> sink) {
  ComGoogleCommonHashFunnels_initialize();
  return create_ComGoogleCommonHashFunnels_SinkAsStream_initWithComGoogleCommonHashPrimitiveSink_(sink);
}
...
- (void)funnelWithId:(IOSByteArray *)from
withComGoogleCommonHashPrimitiveSink:(id<ComGoogleCommonHashPrimitiveSink>)into {
  [((id<ComGoogleCommonHashPrimitiveSink>) nil_chk(into)) putBytesWithByteArray:from];
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonHashFunnels_ByteArrayFunnel class]) {
    ...
    for (jint i = 0; i < 1; i++) {
      (ComGoogleCommonHashFunnels_ByteArrayFunnel_values_[i] = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
      ComGoogleCommonHashFunnels_ByteArrayFunnel_initWithNSString_withInt_(e, names[i], i);
    }
...
- (void)funnelWithId:(id<JavaLangCharSequence>)from
withComGoogleCommonHashPrimitiveSink:(id<ComGoogleCommonHashPrimitiveSink>)into {
  [((id<ComGoogleCommonHashPrimitiveSink>) nil_chk(into)) putUnencodedCharsWithJavaLangCharSequence:from];
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonHashFunnels_UnencodedCharsFunnel class]) {
    ...
    for (jint i = 0; i < 1; i++) {
      (ComGoogleCommonHashFunnels_UnencodedCharsFunnel_values_[i] = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
      ComGoogleCommonHashFunnels_UnencodedCharsFunnel_initWithNSString_withInt_(e, names[i], i);
    }
...
- (void)funnelWithId:(id<JavaLangCharSequence>)from
withComGoogleCommonHashPrimitiveSink:(id<ComGoogleCommonHashPrimitiveSink>)into {
  [((id<ComGoogleCommonHashPrimitiveSink>) nil_chk(into)) putStringWithJavaLangCharSequence:from withJavaNioCharsetCharset:charset_];
}
...
- (id)writeReplace {
  return create_ComGoogleCommonHashFunnels_StringCharsetFunnel_SerializedForm_initWithJavaNioCharsetCharset_(charset_);
}
...
- (void)dealloc {
  RELEASE_(charsetCanonicalName_);
  [super dealloc];
}
...
void ComGoogleCommonHashFunnels_StringCharsetFunnel_SerializedForm_initWithJavaNioCharsetCharset_(ComGoogleCommonHashFunnels_StringCharsetFunnel_SerializedForm *self, JavaNioCharsetCharset *charset) {
  NSObject_init(self);
  JreStrongAssign(&self->charsetCanonicalName_, [((JavaNioCharsetCharset *) nil_chk(charset)) name]);
}
...
- (void)funnelWithId:(JavaLangInteger *)from
withComGoogleCommonHashPrimitiveSink:(id<ComGoogleCommonHashPrimitiveSink>)into {
  [((id<ComGoogleCommonHashPrimitiveSink>) nil_chk(into)) putIntWithInt:[((JavaLangInteger *) nil_chk(from)) intValue]];
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonHashFunnels_IntegerFunnel class]) {
    ...
    for (jint i = 0; i < 1; i++) {
      (ComGoogleCommonHashFunnels_IntegerFunnel_values_[i] = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
      ComGoogleCommonHashFunnels_IntegerFunnel_initWithNSString_withInt_(e, names[i], i);
    }
...
void ComGoogleCommonHashFunnels_SequentialFunnel_initWithComGoogleCommonHashFunnel_(ComGoogleCommonHashFunnels_SequentialFunnel *self, id<ComGoogleCommonHashFunnel> elementFunnel) {
  NSObject_init(self);
  JreStrongAssign(&self->elementFunnel_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(elementFunnel));
}
...
- (void)funnelWithId:(JavaLangLong *)from
withComGoogleCommonHashPrimitiveSink:(id<ComGoogleCommonHashPrimitiveSink>)into {
  [((id<ComGoogleCommonHashPrimitiveSink>) nil_chk(into)) putLongWithLong:[((JavaLangLong *) nil_chk(from)) longLongValue]];
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonHashFunnels_LongFunnel class]) {
    ...
    for (jint i = 0; i < 1; i++) {
      (ComGoogleCommonHashFunnels_LongFunnel_values_[i] = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
      ComGoogleCommonHashFunnels_LongFunnel_initWithNSString_withInt_(e, names[i], i);
    }
...
- (void)writeWithInt:(jint)b {
  [((id<ComGoogleCommonHashPrimitiveSink>) nil_chk(sink_)) putByteWithByte:(jbyte) b];
}

- (void)writeWithByteArray:(IOSByteArray *)bytes {
  [((id<ComGoogleCommonHashPrimitiveSink>) nil_chk(sink_)) putBytesWithByteArray:bytes];
}

- (void)writeWithByteArray:(IOSByteArray *)bytes
                   withInt:(jint)off
                   withInt:(jint)len {
  [((id<ComGoogleCommonHashPrimitiveSink>) nil_chk(sink_)) putBytesWithByteArray:bytes withInt:off withInt:len];
}
...
void ComGoogleCommonHashFunnels_SinkAsStream_initWithComGoogleCommonHashPrimitiveSink_(ComGoogleCommonHashFunnels_SinkAsStream *self, id<ComGoogleCommonHashPrimitiveSink> sink) {
  ...
  JreStrongAssign(&self->sink_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(sink));
}
