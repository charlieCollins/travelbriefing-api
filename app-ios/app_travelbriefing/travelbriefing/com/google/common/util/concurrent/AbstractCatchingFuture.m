...
//  source: ../target/dependency/com/google/common/util/concurrent/AbstractCatchingFuture.java
//
...
- (void)run {
  ...
  JreStrongAssign(&exceptionType_, nil);
  ...
  @catch (JavaUtilConcurrentExecutionException *e) {
    throwable = ComGoogleCommonBasePreconditions_checkNotNullWithId_([((JavaUtilConcurrentExecutionException *) nil_chk(e)) getCause]);
  }
  @catch (NSException *e) {
    throwable = e;
  }
...
- (void)afterDone {
  ...
  JreStrongAssign(&self->exceptionType_, nil);
  JreStrongAssign(&self->fallback_, nil);
}

- (void)dealloc {
  RELEASE_(inputFuture_);
  RELEASE_(exceptionType_);
  RELEASE_(fallback_);
  [super dealloc];
}
...
id<ComGoogleCommonUtilConcurrentListenableFuture> ComGoogleCommonUtilConcurrentAbstractCatchingFuture_createWithComGoogleCommonUtilConcurrentListenableFuture_withIOSClass_withComGoogleCommonBaseFunction_(id<ComGoogleCommonUtilConcurrentListenableFuture> input, IOSClass *exceptionType, id<ComGoogleCommonBaseFunction> fallback) {
  ...
  ComGoogleCommonUtilConcurrentAbstractCatchingFuture_CatchingFuture *future = create_ComGoogleCommonUtilConcurrentAbstractCatchingFuture_CatchingFuture_initWithComGoogleCommonUtilConcurrentListenableFuture_withIOSClass_withComGoogleCommonBaseFunction_(input, exceptionType, fallback);
...
id<ComGoogleCommonUtilConcurrentListenableFuture> ComGoogleCommonUtilConcurrentAbstractCatchingFuture_createWithComGoogleCommonUtilConcurrentListenableFuture_withIOSClass_withComGoogleCommonUtilConcurrentAsyncFunction_(id<ComGoogleCommonUtilConcurrentListenableFuture> input, IOSClass *exceptionType, id<ComGoogleCommonUtilConcurrentAsyncFunction> fallback) {
  ComGoogleCommonUtilConcurrentAbstractCatchingFuture_initialize();
  ComGoogleCommonUtilConcurrentAbstractCatchingFuture_AsyncCatchingFuture *future = create_ComGoogleCommonUtilConcurrentAbstractCatchingFuture_AsyncCatchingFuture_initWithComGoogleCommonUtilConcurrentListenableFuture_withIOSClass_withComGoogleCommonUtilConcurrentAsyncFunction_(input, exceptionType, fallback);
  [((id<ComGoogleCommonUtilConcurrentListenableFuture>) nil_chk(input)) addListenerWithJavaLangRunnable:future withJavaUtilConcurrentExecutor:ComGoogleCommonUtilConcurrentMoreExecutors_directExecutor()];
  return future;
}
...
void ComGoogleCommonUtilConcurrentAbstractCatchingFuture_initWithComGoogleCommonUtilConcurrentListenableFuture_withIOSClass_withId_(ComGoogleCommonUtilConcurrentAbstractCatchingFuture *self, id<ComGoogleCommonUtilConcurrentListenableFuture> inputFuture, IOSClass *exceptionType, id fallback) {
  ...
  JreStrongAssign(&self->exceptionType_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(exceptionType));
  JreStrongAssign(&self->fallback_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(fallback));
}
...
- (id<ComGoogleCommonUtilConcurrentListenableFuture>)doFallbackWithId:(id<ComGoogleCommonUtilConcurrentAsyncFunction>)fallback
  ...
  ComGoogleCommonBasePreconditions_checkNotNullWithId_withId_(replacement, @"AsyncFunction.apply returned null instead of a Future. Did you mean to return immediateFuture(null)?");
  return replacement;
}
