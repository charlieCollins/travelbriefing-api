...
//  source: ../target/dependency/com/google/common/util/concurrent/WrappingScheduledExecutorService.java
//
...
- (void)dealloc {
  RELEASE_(delegate_WrappingScheduledExecutorService_);
  [super dealloc];
}
...
void ComGoogleCommonUtilConcurrentWrappingScheduledExecutorService_initWithJavaUtilConcurrentScheduledExecutorService_(ComGoogleCommonUtilConcurrentWrappingScheduledExecutorService *self, id<JavaUtilConcurrentScheduledExecutorService> delegate) {
  ...
  JreStrongAssign(&self->delegate_WrappingScheduledExecutorService_, delegate);
}
