...
//  source: ../target/dependency/com/google/common/util/concurrent/AbstractFuture.java
//
...
__attribute__((unused)) static void ComGoogleCommonUtilConcurrentAbstractFuture_Failure_1_initWithNSString_(ComGoogleCommonUtilConcurrentAbstractFuture_Failure_1 *self, NSString *param0);

__attribute__((unused)) static ComGoogleCommonUtilConcurrentAbstractFuture_Failure_1 *new_ComGoogleCommonUtilConcurrentAbstractFuture_Failure_1_initWithNSString_(NSString *param0) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonUtilConcurrentAbstractFuture_Failure_1 *create_ComGoogleCommonUtilConcurrentAbstractFuture_Failure_1_initWithNSString_(NSString *param0);
...
withJavaUtilConcurrentTimeUnit:(JavaUtilConcurrentTimeUnit *)unit {
  ...
  if (JavaLangThread_interrupted()) {
    @throw create_JavaLangInterruptedException_init();
  }
  ...
  if (remainingNanos >= ComGoogleCommonUtilConcurrentAbstractFuture_SPIN_THRESHOLD_NANOS) {
    ...
    if (oldHead != JreLoadStatic(ComGoogleCommonUtilConcurrentAbstractFuture_Waiter, TOMBSTONE)) {
      ComGoogleCommonUtilConcurrentAbstractFuture_Waiter *node = create_ComGoogleCommonUtilConcurrentAbstractFuture_Waiter_init();
      do {
...
- (jboolean)cancelWithBoolean:(jboolean)mayInterruptIfRunning {
  ...
  if ((localValue == nil) | [localValue isKindOfClass:[ComGoogleCommonUtilConcurrentAbstractFuture_SetFuture class]]) {
    NSException *cause = ComGoogleCommonUtilConcurrentAbstractFuture_GENERATE_CANCELLATION_CAUSES ? create_JavaUtilConcurrentCancellationException_initWithNSString_(@"Future.cancel() was called.") : nil;
    id valueToSet = create_ComGoogleCommonUtilConcurrentAbstractFuture_Cancellation_initWithBoolean_withNSException_(mayInterruptIfRunning, cause);
...
- (void)addListenerWithJavaLangRunnable:(id<JavaLangRunnable>)listener
         withJavaUtilConcurrentExecutor:(id<JavaUtilConcurrentExecutor>)executor {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_withId_(listener, @"Runnable was null.");
  ComGoogleCommonBasePreconditions_checkNotNullWithId_withId_(executor, @"Executor was null.");
  ...
  if (oldHead != JreLoadStatic(ComGoogleCommonUtilConcurrentAbstractFuture_Listener, TOMBSTONE)) {
    ComGoogleCommonUtilConcurrentAbstractFuture_Listener *newNode = create_ComGoogleCommonUtilConcurrentAbstractFuture_Listener_initWithJavaLangRunnable_withJavaUtilConcurrentExecutor_(listener, executor);
    do {
      JreStrongAssign(&newNode->next_, oldHead);
...
- (jboolean)setExceptionWithNSException:(NSException *)throwable {
  id valueToSet = create_ComGoogleCommonUtilConcurrentAbstractFuture_Failure_initWithNSException_(ComGoogleCommonBasePreconditions_checkNotNullWithId_(throwable));
  if ([((ComGoogleCommonUtilConcurrentAbstractFuture_AtomicHelper *) nil_chk(ComGoogleCommonUtilConcurrentAbstractFuture_ATOMIC_HELPER)) casValueWithComGoogleCommonUtilConcurrentAbstractFuture:self withId:nil withId:valueToSet]) {
    ComGoogleCommonUtilConcurrentAbstractFuture_completeWithComGoogleCommonUtilConcurrentAbstractFuture_(self);
    return true;
  }
...
- (jboolean)setFutureWithComGoogleCommonUtilConcurrentListenableFuture:(id<ComGoogleCommonUtilConcurrentListenableFuture>)future {
  ...
  if (localValue == nil) {
    ...
    ComGoogleCommonUtilConcurrentAbstractFuture_SetFuture *valueToSet = create_ComGoogleCommonUtilConcurrentAbstractFuture_SetFuture_initWithComGoogleCommonUtilConcurrentAbstractFuture_withComGoogleCommonUtilConcurrentListenableFuture_(self, future);
    if ([((ComGoogleCommonUtilConcurrentAbstractFuture_AtomicHelper *) nil_chk(ComGoogleCommonUtilConcurrentAbstractFuture_ATOMIC_HELPER)) casValueWithComGoogleCommonUtilConcurrentAbstractFuture:self withId:nil withId:valueToSet]) {
      @try {
      ...
      @catch (NSException *t) {
        ...
        @try {
          failure = create_ComGoogleCommonUtilConcurrentAbstractFuture_Failure_initWithNSException_(t);
        }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentAbstractFuture = { "AbstractFuture", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x401, 23, 8, -1, 43, -1, 44, -1 };
    ...
    JreStrongAssign(&ComGoogleCommonUtilConcurrentAbstractFuture_log, JavaUtilLoggingLogger_getLoggerWithNSString_([ComGoogleCommonUtilConcurrentAbstractFuture_class_() getName]));
    {
      ...
      @catch (NSException *unsafeFailure) {
        ...
        @catch (NSException *atomicReferenceFieldUpdaterFailure) {
          ...
          helper = create_ComGoogleCommonUtilConcurrentAbstractFuture_SynchronizedHelper_init();
        }
      }
      JreStrongAssign(&ComGoogleCommonUtilConcurrentAbstractFuture_ATOMIC_HELPER, helper);
      __unused IOSClass *ensureLoaded = JavaUtilConcurrentLocksLockSupport_class_();
    }
    JreStrongAssignAndConsume(&ComGoogleCommonUtilConcurrentAbstractFuture_NULL, new_NSObject_init());
...
void ComGoogleCommonUtilConcurrentAbstractFuture_removeWaiterWithComGoogleCommonUtilConcurrentAbstractFuture_Waiter_(ComGoogleCommonUtilConcurrentAbstractFuture *self, ComGoogleCommonUtilConcurrentAbstractFuture_Waiter *node) {
  JreVolatileStrongAssign(&((ComGoogleCommonUtilConcurrentAbstractFuture_Waiter *) nil_chk(node))->thread_, nil);
  while (true) {
    {
      ...
      while (curr != nil) {
        ...
        if (JreLoadVolatileId(&curr->thread_) != nil) {
          ...
          JreVolatileStrongAssign(&pred->next_, succ);
...
id ComGoogleCommonUtilConcurrentAbstractFuture_getDoneValueWithId_(ComGoogleCommonUtilConcurrentAbstractFuture *self, id obj) {
  if ([obj isKindOfClass:[ComGoogleCommonUtilConcurrentAbstractFuture_Cancellation class]]) {
    @throw ComGoogleCommonUtilConcurrentAbstractFuture_cancellationExceptionWithCauseWithNSString_withNSException_(@"Task was cancelled.", ((ComGoogleCommonUtilConcurrentAbstractFuture_Cancellation *) nil_chk(((ComGoogleCommonUtilConcurrentAbstractFuture_Cancellation *) cast_chk(obj, [ComGoogleCommonUtilConcurrentAbstractFuture_Cancellation class]))))->cause_);
  }
  else if ([obj isKindOfClass:[ComGoogleCommonUtilConcurrentAbstractFuture_Failure class]]) {
    @throw create_JavaUtilConcurrentExecutionException_initWithNSException_(((ComGoogleCommonUtilConcurrentAbstractFuture_Failure *) nil_chk(((ComGoogleCommonUtilConcurrentAbstractFuture_Failure *) cast_chk(obj, [ComGoogleCommonUtilConcurrentAbstractFuture_Failure class]))))->exception_);
  }
...
id ComGoogleCommonUtilConcurrentAbstractFuture_getFutureValueWithComGoogleCommonUtilConcurrentListenableFuture_(id<ComGoogleCommonUtilConcurrentListenableFuture> future) {
  ...
  if ([future isKindOfClass:[ComGoogleCommonUtilConcurrentAbstractFuture_TrustedFuture class]]) {
    ...
    @catch (JavaUtilConcurrentExecutionException *exception) {
      valueToSet = create_ComGoogleCommonUtilConcurrentAbstractFuture_Failure_initWithNSException_([((JavaUtilConcurrentExecutionException *) nil_chk(exception)) getCause]);
    }
    @catch (JavaUtilConcurrentCancellationException *cancellation) {
      valueToSet = create_ComGoogleCommonUtilConcurrentAbstractFuture_Cancellation_initWithBoolean_withNSException_(false, cancellation);
    }
    @catch (NSException *t) {
      valueToSet = create_ComGoogleCommonUtilConcurrentAbstractFuture_Failure_initWithNSException_(t);
    }
  }
  return valueToSet;
}
...
ComGoogleCommonUtilConcurrentAbstractFuture_Listener *ComGoogleCommonUtilConcurrentAbstractFuture_clearListenersWithComGoogleCommonUtilConcurrentAbstractFuture_Listener_(ComGoogleCommonUtilConcurrentAbstractFuture *self, ComGoogleCommonUtilConcurrentAbstractFuture_Listener *onto) {
  ...
  while (head != nil) {
    ...
    head = head->next_;
    JreStrongAssign(&tmp->next_, reversedList);
    reversedList = tmp;
  }
  return reversedList;
}
...
JavaUtilConcurrentCancellationException *ComGoogleCommonUtilConcurrentAbstractFuture_cancellationExceptionWithCauseWithNSString_withNSException_(NSString *message, NSException *cause) {
  ComGoogleCommonUtilConcurrentAbstractFuture_initialize();
  JavaUtilConcurrentCancellationException *exception = create_JavaUtilConcurrentCancellationException_initWithNSString_(message);
  [exception initCauseWithNSException:cause];
  return exception;
}
...
- (void)unpark {
  ...
  if (w != nil) {
    JreVolatileStrongAssign(&thread_, nil);
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentAbstractFuture_Waiter class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonUtilConcurrentAbstractFuture_Waiter_TOMBSTONE, new_ComGoogleCommonUtilConcurrentAbstractFuture_Waiter_initWithBoolean_(false));
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentAbstractFuture_Listener class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonUtilConcurrentAbstractFuture_Listener_TOMBSTONE, new_ComGoogleCommonUtilConcurrentAbstractFuture_Listener_initWithJavaLangRunnable_withJavaUtilConcurrentExecutor_(nil, nil));
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentAbstractFuture_Failure class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonUtilConcurrentAbstractFuture_Failure_FALLBACK_INSTANCE, new_ComGoogleCommonUtilConcurrentAbstractFuture_Failure_initWithNSException_(create_ComGoogleCommonUtilConcurrentAbstractFuture_Failure_1_initWithNSString_(@"Failure occurred while trying to finish a future.")));
...
void ComGoogleCommonUtilConcurrentAbstractFuture_Failure_initWithNSException_(ComGoogleCommonUtilConcurrentAbstractFuture_Failure *self, NSException *exception) {
  NSObject_init(self);
  JreStrongAssign(&self->exception_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(exception));
}
...
- (instancetype)initWithNSString:(NSString *)param0 {
  ComGoogleCommonUtilConcurrentAbstractFuture_Failure_1_initWithNSString_(self, param0);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentAbstractFuture_Failure_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, NULL, 7, 0x8008, 2, 0, 1, -1, -1, -1, -1 };
  return &_ComGoogleCommonUtilConcurrentAbstractFuture_Failure_1;
}

@end

void ComGoogleCommonUtilConcurrentAbstractFuture_Failure_1_initWithNSString_(ComGoogleCommonUtilConcurrentAbstractFuture_Failure_1 *self, NSString *param0) {
  NSException_initWithNSString_(self, param0);
}

ComGoogleCommonUtilConcurrentAbstractFuture_Failure_1 *new_ComGoogleCommonUtilConcurrentAbstractFuture_Failure_1_initWithNSString_(NSString *param0) {
  J2OBJC_NEW_IMPL(ComGoogleCommonUtilConcurrentAbstractFuture_Failure_1, initWithNSString_, param0)
}

ComGoogleCommonUtilConcurrentAbstractFuture_Failure_1 *create_ComGoogleCommonUtilConcurrentAbstractFuture_Failure_1_initWithNSString_(NSString *param0) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonUtilConcurrentAbstractFuture_Failure_1, initWithNSString_, param0)
}
  ...
  if (self == [ComGoogleCommonUtilConcurrentAbstractFuture_UnsafeAtomicHelper class]) {
    {
      ...
      @catch (JavaLangSecurityException *tryReflectionInstead) {
        @try {
          unsafe = JavaSecurityAccessController_doPrivilegedWithJavaSecurityPrivilegedExceptionAction_(create_ComGoogleCommonUtilConcurrentAbstractFuture_UnsafeAtomicHelper_1_init());
        }
        @catch (JavaSecurityPrivilegedActionException *e) {
          @throw create_JavaLangRuntimeException_initWithNSString_withNSException_(@"Could not initialize intrinsics", [((JavaSecurityPrivilegedActionException *) nil_chk(e)) getCause]);
        }
      }
      @try {
        ...
        JreStrongAssign(&ComGoogleCommonUtilConcurrentAbstractFuture_UnsafeAtomicHelper_UNSAFE, unsafe);
      }
...
- (SunMiscUnsafe *)run {
  ...
  @throw create_JavaLangNoSuchFieldError_initWithNSString_(@"the Unsafe");
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentAbstractFuture_UnsafeAtomicHelper_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, NULL, 7, 0x8008, 2, 0, 1, -1, -1, 2, -1 };
...
- (void)dealloc {
  RELEASE_(waiterThreadUpdater_);
  RELEASE_(waiterNextUpdater_);
  RELEASE_(waitersUpdater_);
  RELEASE_(listenersUpdater_);
  RELEASE_(valueUpdater_);
  [super dealloc];
}
...
void ComGoogleCommonUtilConcurrentAbstractFuture_SafeAtomicHelper_initWithJavaUtilConcurrentAtomicAtomicReferenceFieldUpdater_withJavaUtilConcurrentAtomicAtomicReferenceFieldUpdater_withJavaUtilConcurrentAtomicAtomicReferenceFieldUpdater_withJavaUtilConcurrentAtomicAtomicReferenceFieldUpdater_withJavaUtilConcurrentAtomicAtomicReferenceFieldUpdater_(ComGoogleCommonUtilConcurrentAbstractFuture_SafeAtomicHelper *self, JavaUtilConcurrentAtomicAtomicReferenceFieldUpdater *waiterThreadUpdater, JavaUtilConcurrentAtomicAtomicReferenceFieldUpdater *waiterNextUpdater, JavaUtilConcurrentAtomicAtomicReferenceFieldUpdater *waitersUpdater, JavaUtilConcurrentAtomicAtomicReferenceFieldUpdater *listenersUpdater, JavaUtilConcurrentAtomicAtomicReferenceFieldUpdater *valueUpdater) {
  ComGoogleCommonUtilConcurrentAbstractFuture_AtomicHelper_init(self);
  JreStrongAssign(&self->waiterThreadUpdater_, waiterThreadUpdater);
  JreStrongAssign(&self->waiterNextUpdater_, waiterNextUpdater);
  JreStrongAssign(&self->waitersUpdater_, waitersUpdater);
  JreStrongAssign(&self->listenersUpdater_, listenersUpdater);
  JreStrongAssign(&self->valueUpdater_, valueUpdater);
}
...
- (void)putThreadWithComGoogleCommonUtilConcurrentAbstractFuture_Waiter:(ComGoogleCommonUtilConcurrentAbstractFuture_Waiter *)waiter
                                                     withJavaLangThread:(JavaLangThread *)newValue {
  JreVolatileStrongAssign(&((ComGoogleCommonUtilConcurrentAbstractFuture_Waiter *) nil_chk(waiter))->thread_, newValue);
}

- (void)putNextWithComGoogleCommonUtilConcurrentAbstractFuture_Waiter:(ComGoogleCommonUtilConcurrentAbstractFuture_Waiter *)waiter
               withComGoogleCommonUtilConcurrentAbstractFuture_Waiter:(ComGoogleCommonUtilConcurrentAbstractFuture_Waiter *)newValue {
  JreVolatileStrongAssign(&((ComGoogleCommonUtilConcurrentAbstractFuture_Waiter *) nil_chk(waiter))->next_, newValue);
}
...
- (jboolean)casWaitersWithComGoogleCommonUtilConcurrentAbstractFuture:(ComGoogleCommonUtilConcurrentAbstractFuture *)future
  ...
  @synchronized(future) {
    if (JreLoadVolatileId(&((ComGoogleCommonUtilConcurrentAbstractFuture *) nil_chk(future))->waiters_) == expect) {
      JreVolatileStrongAssign(&future->waiters_, update);
      return true;
    }
    return false;
  }
...
- (jboolean)casListenersWithComGoogleCommonUtilConcurrentAbstractFuture:(ComGoogleCommonUtilConcurrentAbstractFuture *)future
  ...
  @synchronized(future) {
    if (JreLoadVolatileId(&((ComGoogleCommonUtilConcurrentAbstractFuture *) nil_chk(future))->listeners_) == expect) {
      JreVolatileStrongAssign(&future->listeners_, update);
      return true;
    }
    return false;
  }
...
- (jboolean)casValueWithComGoogleCommonUtilConcurrentAbstractFuture:(ComGoogleCommonUtilConcurrentAbstractFuture *)future
  ...
  @synchronized(future) {
    if (JreLoadVolatileId(&((ComGoogleCommonUtilConcurrentAbstractFuture *) nil_chk(future))->value_) == expect) {
      JreVolatileStrongAssign(&future->value_, update);
      return true;
    }
    return false;
  }
