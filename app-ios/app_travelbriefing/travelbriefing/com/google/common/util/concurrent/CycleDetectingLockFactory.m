...
//  source: ../target/dependency/com/google/common/util/concurrent/CycleDetectingLockFactory.java
//
...
- (JavaUtilConcurrentLocksReentrantLock *)newReentrantLockWithNSString:(NSString *)lockName
                                                           withBoolean:(jboolean)fair {
  return policy_ == JreLoadEnum(ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policies, DISABLED) ? create_JavaUtilConcurrentLocksReentrantLock_initWithBoolean_(fair) : create_ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_CycleDetectingReentrantLock_initWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_withComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_withBoolean_(self, create_ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_initWithNSString_(lockName), fair);
}
...
- (JavaUtilConcurrentLocksReentrantReadWriteLock *)newReentrantReadWriteLockWithNSString:(NSString *)lockName
                                                                             withBoolean:(jboolean)fair {
  return policy_ == JreLoadEnum(ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policies, DISABLED) ? create_JavaUtilConcurrentLocksReentrantReadWriteLock_initWithBoolean_(fair) : create_ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_CycleDetectingReentrantReadWriteLock_initWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_withComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_withBoolean_(self, create_ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_initWithNSString_(lockName), fair);
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentCycleDetectingLockFactory class]) {
    JreStrongAssign(&ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_lockGraphNodesPerType, [((ComGoogleCommonCollectMapMaker *) nil_chk([create_ComGoogleCommonCollectMapMaker_init() weakKeys])) makeMap]);
    JreStrongAssign(&ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_logger, JavaUtilLoggingLogger_getLoggerWithNSString_([ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_class_() getName]));
    JreStrongAssignAndConsume(&ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_acquiredLocks, new_ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_1_init());
...
ComGoogleCommonUtilConcurrentCycleDetectingLockFactory *ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_newInstanceWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policy_(id<ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policy> policy) {
  ...
  return create_ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_initWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policy_(policy);
}
...
ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_WithExplicitOrdering *ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_newInstanceWithExplicitOrderingWithIOSClass_withComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policy_(IOSClass *enumClass, id<ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policy> policy) {
  ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(enumClass);
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(policy);
  ...
  return create_ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_WithExplicitOrdering_initWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policy_withJavaUtilMap_(policy, lockGraphNodes);
}
...
id<JavaUtilMap> ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_createNodesWithIOSClass_(IOSClass *clazz) {
  ...
  JavaUtilArrayList *nodes = ComGoogleCommonCollectLists_newArrayListWithCapacityWithInt_(numKeys);
  {
    ...
    while (b__ < e__) {
      ...
      ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode *node = create_ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_initWithNSString_(ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_getLockNameWithJavaLangEnum_(key));
      [((JavaUtilArrayList *) nil_chk(nodes)) addWithId:node];
      [((JavaUtilEnumMap *) nil_chk(map)) putWithId:key withId:node];
    }
  }
...
void ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_initWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policy_(ComGoogleCommonUtilConcurrentCycleDetectingLockFactory *self, id<ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policy> policy) {
  NSObject_init(self);
  JreStrongAssign(&self->policy_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(policy));
}
  ...
  if (![((id<ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_CycleDetectingLock>) nil_chk(lock)) isAcquiredByCurrentThread]) {
    ...
    for (jint i = [((JavaUtilArrayList *) nil_chk(acquiredLockList)) size] - 1; i >= 0; i--) {
      if ([acquiredLockList getWithInt:i] == node) {
        [acquiredLockList removeWithInt:i];
        break;
      }
    }
  }
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policies class]) {
    size_t allocSize = 0;
    size_t objSize_THROW = class_getInstanceSize([ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policies_1 class]);
    allocSize += objSize_THROW;
    size_t objSize_WARN = class_getInstanceSize([ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policies_2 class]);
    allocSize += objSize_WARN;
    size_t objSize_DISABLED = class_getInstanceSize([ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policies_3 class]);
    allocSize += objSize_DISABLED;
    uintptr_t ptr = (uintptr_t)calloc(allocSize, 1);
    id e;
    (JreEnum(ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policies, THROW) = e = objc_constructInstance([ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policies_1 class], (void *)ptr), ptr += objSize_THROW);
    ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policies_1_initWithNSString_withInt_(e, @"THROW", 0);
    (JreEnum(ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policies, WARN) = e = objc_constructInstance([ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policies_2 class], (void *)ptr), ptr += objSize_WARN);
    ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policies_2_initWithNSString_withInt_(e, @"WARN", 1);
    (JreEnum(ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policies, DISABLED) = e = objc_constructInstance([ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policies_3 class], (void *)ptr), ptr += objSize_DISABLED);
    ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policies_3_initWithNSString_withInt_(e, @"DISABLED", 2);
...
void ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_WithExplicitOrdering_initWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policy_withJavaUtilMap_(ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_WithExplicitOrdering *self, id<ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policy> policy, id<JavaUtilMap> lockGraphNodes) {
  ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_initWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policy_(self, policy);
  JreStrongAssign(&self->lockGraphNodes_, lockGraphNodes);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, NULL, 7, 0x8008, 2, 0, 1, -1, -1, 2, -1 };
...
id<JavaUtilSet> ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_ExampleStackTrace_EXCLUDED_CLASS_NAMES;
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_ExampleStackTrace class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_ExampleStackTrace_EMPTY_STACK_TRACE, [IOSObjectArray newArrayWithLength:0 type:JavaLangStackTraceElement_class_()]);
    JreStrongAssign(&ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_ExampleStackTrace_EXCLUDED_CLASS_NAMES, ComGoogleCommonCollectImmutableSet_ofWithId_withId_withId_([ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_class_() getName], [ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_ExampleStackTrace_class_() getName], [ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_class_() getName]));
...
void ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_ExampleStackTrace_initWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_withComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_(ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_ExampleStackTrace *self, ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode *node1, ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode *node2) {
  ...
  for (jint i = 0, n = ((IOSObjectArray *) nil_chk(origStackTrace))->size_; i < n; i++) {
    ...
    if (![((id<JavaUtilSet>) nil_chk(ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_ExampleStackTrace_EXCLUDED_CLASS_NAMES)) containsWithId:[((JavaLangStackTraceElement *) nil_chk(IOSObjectArray_Get(origStackTrace, i))) getClassName]]) {
...
- (NSString *)getMessage {
  JavaLangStringBuilder *message = create_JavaLangStringBuilder_initWithNSString_([super getMessage]);
  for (NSException *t = conflictingStackTrace_; t != nil; t = [t getCause]) {
    [((JavaLangStringBuilder *) nil_chk([message appendWithNSString:@", "])) appendWithNSString:[t getMessage]];
  }
  return [message description];
}

- (void)dealloc {
  RELEASE_(conflictingStackTrace_);
  [super dealloc];
}
...
void ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_PotentialDeadlockException_initWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_withComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_withComGoogleCommonUtilConcurrentCycleDetectingLockFactory_ExampleStackTrace_(ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_PotentialDeadlockException *self, ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode *node1, ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode *node2, ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_ExampleStackTrace *conflictingStackTrace) {
  ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_ExampleStackTrace_initWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_withComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_(self, node1, node2);
  JreStrongAssign(&self->conflictingStackTrace_, conflictingStackTrace);
  [self initCauseWithNSException:conflictingStackTrace];
}
...
- (void)checkAcquiredLockWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policy:(id<ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policy>)policy
  ...
  if (previousDeadlockException != nil) {
    ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_PotentialDeadlockException *exception = create_ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_PotentialDeadlockException_initWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_withComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_withComGoogleCommonUtilConcurrentCycleDetectingLockFactory_ExampleStackTrace_(acquiredLock, self, [previousDeadlockException getConflictingStackTrace]);
  ...
  if (path == nil) {
    [allowedPriorLocks_ putWithId:acquiredLock withId:create_ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_ExampleStackTrace_initWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_withComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_(acquiredLock, self)];
  }
  else {
    ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_PotentialDeadlockException *exception = create_ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_PotentialDeadlockException_initWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_withComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_withComGoogleCommonUtilConcurrentCycleDetectingLockFactory_ExampleStackTrace_(acquiredLock, self, path);
    [disallowedPriorLocks_ putWithId:acquiredLock withId:exception];
    [((id<ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_Policy>) nil_chk(policy)) handlePotentialDeadlockWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_PotentialDeadlockException:exception];
  }
}
...
- (void)dealloc {
  RELEASE_(allowedPriorLocks_);
  RELEASE_(disallowedPriorLocks_);
  RELEASE_(lockName_);
  [super dealloc];
}
...
void ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_initWithNSString_(ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode *self, NSString *lockName) {
  NSObject_init(self);
  JreStrongAssign(&self->allowedPriorLocks_, [((ComGoogleCommonCollectMapMaker *) nil_chk([create_ComGoogleCommonCollectMapMaker_init() weakKeys])) makeMap]);
  JreStrongAssign(&self->disallowedPriorLocks_, [((ComGoogleCommonCollectMapMaker *) nil_chk([create_ComGoogleCommonCollectMapMaker_init() weakKeys])) makeMap]);
  JreStrongAssign(&self->lockName_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(lockName));
}
...
ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_ExampleStackTrace *ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_findPathToWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_withJavaUtilSet_(ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode *self, ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode *node, id<JavaUtilSet> seen) {
  ...
  for (id<JavaUtilMap_Entry> __strong entry_ in nil_chk([self->allowedPriorLocks_ entrySet])) {
    ...
    if (found != nil) {
      ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_ExampleStackTrace *path = create_ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_ExampleStackTrace_initWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_withComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_(preAcquiredLock, self);
      ...
      [path initCauseWithNSException:found];
      return path;
    }
  }
  return nil;
...
void ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_CycleDetectingReentrantLock_initWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_withComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_withBoolean_(ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_CycleDetectingReentrantLock *self, ComGoogleCommonUtilConcurrentCycleDetectingLockFactory *outer$, ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode *lockGraphNode, jboolean fair) {
  ...
  JreStrongAssign(&self->lockGraphNode_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(lockGraphNode));
}
...
void ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_CycleDetectingReentrantReadWriteLock_initWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_withComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode_withBoolean_(ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_CycleDetectingReentrantReadWriteLock *self, ComGoogleCommonUtilConcurrentCycleDetectingLockFactory *outer$, ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_LockGraphNode *lockGraphNode, jboolean fair) {
  ...
  JreStrongAssignAndConsume(&self->readLock_, new_ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_CycleDetectingReentrantReadLock_initWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_withComGoogleCommonUtilConcurrentCycleDetectingLockFactory_CycleDetectingReentrantReadWriteLock_(outer$, self));
  JreStrongAssignAndConsume(&self->writeLock_, new_ComGoogleCommonUtilConcurrentCycleDetectingLockFactory_CycleDetectingReentrantWriteLock_initWithComGoogleCommonUtilConcurrentCycleDetectingLockFactory_withComGoogleCommonUtilConcurrentCycleDetectingLockFactory_CycleDetectingReentrantReadWriteLock_(outer$, self));
  JreStrongAssign(&self->lockGraphNode_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(lockGraphNode));
}
