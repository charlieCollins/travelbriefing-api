...
//  source: ../target/dependency/com/google/common/util/concurrent/WrappingExecutorService.java
//
...
- (id<JavaLangRunnable>)wrapTaskWithJavaLangRunnable:(id<JavaLangRunnable>)command {
  ...
  return create_ComGoogleCommonUtilConcurrentWrappingExecutorService_1_initWithJavaUtilConcurrentCallable_(wrapped);
}
...
ComGoogleCommonCollectImmutableList *ComGoogleCommonUtilConcurrentWrappingExecutorService_wrapTasksWithJavaUtilCollection_(ComGoogleCommonUtilConcurrentWrappingExecutorService *self, id<JavaUtilCollection> tasks) {
  ...
  for (id<JavaUtilConcurrentCallable> __strong task in nil_chk(tasks)) {
    [((ComGoogleCommonCollectImmutableList_Builder *) nil_chk(builder)) addWithId:[self wrapTaskWithJavaUtilConcurrentCallable:task]];
  }
...
- (void)run {
  @try {
    [((id<JavaUtilConcurrentCallable>) nil_chk(val$wrapped_)) call];
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentWrappingExecutorService_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 1, 1, -1, 2, -1, -1 };
...
void ComGoogleCommonUtilConcurrentWrappingExecutorService_1_initWithJavaUtilConcurrentCallable_(ComGoogleCommonUtilConcurrentWrappingExecutorService_1 *self, id<JavaUtilConcurrentCallable> capture$0) {
  JreStrongAssign(&self->val$wrapped_, capture$0);
  NSObject_init(self);
}
