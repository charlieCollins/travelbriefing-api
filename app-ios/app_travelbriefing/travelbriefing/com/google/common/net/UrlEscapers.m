...
//  source: ../target/dependency/com/google/common/net/UrlEscapers.java
//
...
+ (void)initialize {
  if (self == [ComGoogleCommonNetUrlEscapers class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonNetUrlEscapers_URL_FORM_PARAMETER_ESCAPER, new_ComGoogleCommonNetPercentEscaper_initWithNSString_withBoolean_(ComGoogleCommonNetUrlEscapers_URL_FORM_PARAMETER_OTHER_SAFE_CHARS, true));
    JreStrongAssignAndConsume(&ComGoogleCommonNetUrlEscapers_URL_PATH_SEGMENT_ESCAPER, new_ComGoogleCommonNetPercentEscaper_initWithNSString_withBoolean_(JreStrcat("$C", ComGoogleCommonNetUrlEscapers_URL_PATH_OTHER_SAFE_CHARS_LACKING_PLUS, '+'), false));
    JreStrongAssignAndConsume(&ComGoogleCommonNetUrlEscapers_URL_FRAGMENT_ESCAPER, new_ComGoogleCommonNetPercentEscaper_initWithNSString_withBoolean_(JreStrcat("$$", ComGoogleCommonNetUrlEscapers_URL_PATH_OTHER_SAFE_CHARS_LACKING_PLUS, @"+/?"), false));
