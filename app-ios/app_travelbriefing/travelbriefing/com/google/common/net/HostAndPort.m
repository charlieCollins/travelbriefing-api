...
//  source: ../target/dependency/com/google/common/net/HostAndPort.java
//
...
__attribute__((unused)) static IOSObjectArray *ComGoogleCommonNetHostAndPort__Annotations$1();
...
- (ComGoogleCommonNetHostAndPort *)withDefaultPortWithInt:(jint)defaultPort {
  ...
  return create_ComGoogleCommonNetHostAndPort_initWithNSString_withInt_withBoolean_(host_, defaultPort, hasBracketlessColons_);
}
...
- (NSUInteger)hash {
  return ComGoogleCommonBaseObjects_hashCodeWithNSObjectArray_([IOSObjectArray arrayWithObjects:(id[]){ host_, JavaLangInteger_valueOfWithInt_(port_), JavaLangBoolean_valueOfWithBoolean_(hasBracketlessColons_) } count:3 type:NSObject_class_()]);
}

- (NSString *)description {
  JavaLangStringBuilder *builder = create_JavaLangStringBuilder_initWithInt_(((jint) [((NSString *) nil_chk(host_)) length]) + 8);
  if ([host_ java_indexOf:':'] >= 0) {
    [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([builder appendWithChar:'['])) appendWithNSString:host_])) appendWithChar:']'];
  }
  else {
    [builder appendWithNSString:host_];
  }
  if ([self hasPort]) {
    [((JavaLangStringBuilder *) nil_chk([builder appendWithChar:':'])) appendWithInt:port_];
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LComGoogleCommonNetHostAndPort;", 0x9, 4, 5, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonNetHostAndPort;", 0x9, 6, 7, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonNetHostAndPort;", 0x9, 8, 7, -1, -1, -1, -1 },
    { NULL, "[LNSString;", 0xa, 9, 7, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonNetHostAndPort;", 0x1, 10, 3, -1, -1, -1, -1 },
    ...
    { NULL, "Z", 0xa, 16, 3, -1, -1, -1, -1 },
  };
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  methods[0].selector = @selector(initWithNSString:withInt:withBoolean:);
  methods[1].selector = @selector(getHost);
  methods[2].selector = @selector(getHostText);
  methods[3].selector = @selector(hasPort);
  methods[4].selector = @selector(getPort);
  methods[5].selector = @selector(getPortOrDefaultWithInt:);
  methods[6].selector = @selector(fromPartsWithNSString:withInt:);
  methods[7].selector = @selector(fromHostWithNSString:);
  methods[8].selector = @selector(fromStringWithNSString:);
  methods[9].selector = @selector(getHostAndPortFromBracketedHostWithNSString:);
  methods[10].selector = @selector(withDefaultPortWithInt:);
  methods[11].selector = @selector(requireBracketsForIPv6);
  methods[12].selector = @selector(isEqual:);
  methods[13].selector = @selector(hash);
  methods[14].selector = @selector(description);
  methods[15].selector = @selector(isValidPortWithInt:);
  ...
  static const void *ptrTable[] = { "LNSString;IZ", (void *)&ComGoogleCommonNetHostAndPort__Annotations$0, "getPortOrDefault", "I", "fromParts", "LNSString;I", "fromHost", "LNSString;", "fromString", "getHostAndPortFromBracketedHost", "withDefaultPort", "equals", "LNSObject;", (void *)&ComGoogleCommonNetHostAndPort__Annotations$1, "hashCode", "toString", "isValidPort" };
  static const J2ObjcClassInfo _ComGoogleCommonNetHostAndPort = { "HostAndPort", "com.google.common.net", ptrTable, methods, fields, 7, 0x11, 16, 5, -1, -1, -1, -1, -1 };
...
ComGoogleCommonNetHostAndPort *ComGoogleCommonNetHostAndPort_fromPartsWithNSString_withInt_(NSString *host, jint port) {
  ...
  return create_ComGoogleCommonNetHostAndPort_initWithNSString_withInt_withBoolean_(parsedHost->host_, port, parsedHost->hasBracketlessColons_);
}
...
ComGoogleCommonNetHostAndPort *ComGoogleCommonNetHostAndPort_fromStringWithNSString_(NSString *hostPortString) {
  ComGoogleCommonNetHostAndPort_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(hostPortString);
  NSString *host;
  NSString *portString = nil;
  jboolean hasBracketlessColons = false;
  if ([((NSString *) nil_chk(hostPortString)) hasPrefix:@"["]) {
  ...
  if (!ComGoogleCommonBaseStrings_isNullOrEmptyWithNSString_(portString)) {
    ComGoogleCommonBasePreconditions_checkArgumentWithBoolean_withNSString_withId_(![((NSString *) nil_chk(portString)) hasPrefix:@"+"], @"Unparseable port number: %s", hostPortString);
    @try {
      port = JavaLangInteger_parseIntWithNSString_(portString);
    }
    @catch (JavaLangNumberFormatException *e) {
      @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"Unparseable port number: ", hostPortString));
    }
  ...
  return create_ComGoogleCommonNetHostAndPort_initWithNSString_withInt_withBoolean_(host, port, hasBracketlessColons);
}
...
IOSObjectArray *ComGoogleCommonNetHostAndPort_getHostAndPortFromBracketedHostWithNSString_(NSString *hostPortString) {
  ...
  if (closeBracketIndex + 1 == ((jint) [hostPortString length])) {
    return [IOSObjectArray arrayWithObjects:(id[]){ host, @"" } count:2 type:NSString_class_()];
  }
  else {
    ...
    for (jint i = closeBracketIndex + 2; i < ((jint) [hostPortString length]); ++i) {
    ...
    return [IOSObjectArray arrayWithObjects:(id[]){ host, [hostPortString java_substring:closeBracketIndex + 2] } count:2 type:NSString_class_()];
  }
}
...
IOSObjectArray *ComGoogleCommonNetHostAndPort__Annotations$1() {
