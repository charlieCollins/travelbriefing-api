...
//  source: ../target/dependency/com/google/common/reflect/TypeParameter.java
//
...
void ComGoogleCommonReflectTypeParameter_init(ComGoogleCommonReflectTypeParameter *self) {
  ...
  JreStrongAssign(&self->typeVariable_, (id<JavaLangReflectTypeVariable>) cast_check(type, JavaLangReflectTypeVariable_class_()));
}
