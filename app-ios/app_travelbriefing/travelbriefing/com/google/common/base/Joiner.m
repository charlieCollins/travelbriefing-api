...
//  source: ../target/dependency/com/google/common/base/Joiner.java
//
...
- (instancetype)initWithComGoogleCommonBaseJoiner:(ComGoogleCommonBaseJoiner *)outer$
                    ...
                    withComGoogleCommonBaseJoiner:(ComGoogleCommonBaseJoiner *)param0;
...
__attribute__((unused)) static void ComGoogleCommonBaseJoiner_1_initWithComGoogleCommonBaseJoiner_withNSString_withComGoogleCommonBaseJoiner_(ComGoogleCommonBaseJoiner_1 *self, ComGoogleCommonBaseJoiner *outer$, NSString *capture$0, ComGoogleCommonBaseJoiner *param0);

__attribute__((unused)) static ComGoogleCommonBaseJoiner_1 *new_ComGoogleCommonBaseJoiner_1_initWithComGoogleCommonBaseJoiner_withNSString_withComGoogleCommonBaseJoiner_(ComGoogleCommonBaseJoiner *outer$, NSString *capture$0, ComGoogleCommonBaseJoiner *param0) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonBaseJoiner_1 *create_ComGoogleCommonBaseJoiner_1_initWithComGoogleCommonBaseJoiner_withNSString_withComGoogleCommonBaseJoiner_(ComGoogleCommonBaseJoiner *outer$, NSString *capture$0, ComGoogleCommonBaseJoiner *param0);
...
__attribute__((unused)) static void ComGoogleCommonBaseJoiner_2_initWithComGoogleCommonBaseJoiner_withComGoogleCommonBaseJoiner_(ComGoogleCommonBaseJoiner_2 *self, ComGoogleCommonBaseJoiner *outer$, ComGoogleCommonBaseJoiner *param0);

__attribute__((unused)) static ComGoogleCommonBaseJoiner_2 *new_ComGoogleCommonBaseJoiner_2_initWithComGoogleCommonBaseJoiner_withComGoogleCommonBaseJoiner_(ComGoogleCommonBaseJoiner *outer$, ComGoogleCommonBaseJoiner *param0) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonBaseJoiner_2 *create_ComGoogleCommonBaseJoiner_2_initWithComGoogleCommonBaseJoiner_withComGoogleCommonBaseJoiner_(ComGoogleCommonBaseJoiner *outer$, ComGoogleCommonBaseJoiner *param0);
...
- (id<JavaLangAppendable>)appendToWithJavaLangAppendable:(id<JavaLangAppendable>)appendable
  ...
  if ([((id<JavaUtilIterator>) nil_chk(parts)) hasNext]) {
    [((id<JavaLangAppendable>) nil_chk(appendable)) appendWithJavaLangCharSequence:[self toStringWithId:[parts next]]];
    while ([parts hasNext]) {
      [appendable appendWithJavaLangCharSequence:separator_];
      [appendable appendWithJavaLangCharSequence:[self toStringWithId:[parts next]]];
    }
  }
  return appendable;
}
...
- (ComGoogleCommonBaseJoiner *)useForNullWithNSString:(NSString *)nullText {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(nullText);
  return create_ComGoogleCommonBaseJoiner_1_initWithComGoogleCommonBaseJoiner_withNSString_withComGoogleCommonBaseJoiner_(self, nullText, self);
}

- (ComGoogleCommonBaseJoiner *)skipNulls {
  return create_ComGoogleCommonBaseJoiner_2_initWithComGoogleCommonBaseJoiner_withComGoogleCommonBaseJoiner_(self, self);
}
...
- (ComGoogleCommonBaseJoiner_MapJoiner *)withKeyValueSeparatorWithNSString:(NSString *)keyValueSeparator {
  return create_ComGoogleCommonBaseJoiner_MapJoiner_initWithComGoogleCommonBaseJoiner_withNSString_(self, keyValueSeparator);
}

- (id<JavaLangCharSequence>)toStringWithId:(id)part {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(part);
...
ComGoogleCommonBaseJoiner *ComGoogleCommonBaseJoiner_onWithNSString_(NSString *separator) {
  ...
  return create_ComGoogleCommonBaseJoiner_initWithNSString_(separator);
}

ComGoogleCommonBaseJoiner *ComGoogleCommonBaseJoiner_onWithChar_(jchar separator) {
  ComGoogleCommonBaseJoiner_initialize();
  return create_ComGoogleCommonBaseJoiner_initWithNSString_(NSString_java_valueOfChar_(separator));
}
...
void ComGoogleCommonBaseJoiner_initWithComGoogleCommonBaseJoiner_(ComGoogleCommonBaseJoiner *self, ComGoogleCommonBaseJoiner *prototype) {
  NSObject_init(self);
  JreStrongAssign(&self->separator_, ((ComGoogleCommonBaseJoiner *) nil_chk(prototype))->separator_);
}
...
JavaLangStringBuilder *ComGoogleCommonBaseJoiner_appendToWithJavaLangStringBuilder_withJavaUtilIterator_(ComGoogleCommonBaseJoiner *self, JavaLangStringBuilder *builder, id<JavaUtilIterator> parts) {
  @try {
    [self appendToWithJavaLangAppendable:builder withJavaUtilIterator:parts];
  }
...
NSString *ComGoogleCommonBaseJoiner_joinWithJavaUtilIterator_(ComGoogleCommonBaseJoiner *self, id<JavaUtilIterator> parts) {
  return [((JavaLangStringBuilder *) nil_chk(ComGoogleCommonBaseJoiner_appendToWithJavaLangStringBuilder_withJavaUtilIterator_(self, create_JavaLangStringBuilder_init(), parts))) description];
}
...
id<JavaLangIterable> ComGoogleCommonBaseJoiner_iterableWithId_withId_withNSObjectArray_(id first, id second, IOSObjectArray *rest) {
  ComGoogleCommonBaseJoiner_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(rest);
  return create_ComGoogleCommonBaseJoiner_3_initWithNSObjectArray_withId_withId_(rest, first, second);
}
...
- (instancetype)initWithComGoogleCommonBaseJoiner:(ComGoogleCommonBaseJoiner *)outer$
                                     withNSString:(NSString *)capture$0
                    withComGoogleCommonBaseJoiner:(ComGoogleCommonBaseJoiner *)param0 {
  ComGoogleCommonBaseJoiner_1_initWithComGoogleCommonBaseJoiner_withNSString_withComGoogleCommonBaseJoiner_(self, outer$, capture$0, param0);
  return self;
}
...
- (ComGoogleCommonBaseJoiner *)useForNullWithNSString:(NSString *)nullText {
  @throw create_JavaLangUnsupportedOperationException_initWithNSString_(@"already specified useForNull");
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonBaseJoiner_1 = { "", "com.google.common.base", ptrTable, methods, fields, 7, 0x8008, 4, 2, 0, -1, 6, -1, -1 };
  return &_ComGoogleCommonBaseJoiner_1;
}

@end

void ComGoogleCommonBaseJoiner_1_initWithComGoogleCommonBaseJoiner_withNSString_withComGoogleCommonBaseJoiner_(ComGoogleCommonBaseJoiner_1 *self, ComGoogleCommonBaseJoiner *outer$, NSString *capture$0, ComGoogleCommonBaseJoiner *param0) {
  JreStrongAssign(&self->this$0_, outer$);
  JreStrongAssign(&self->val$nullText_, capture$0);
  ComGoogleCommonBaseJoiner_initWithComGoogleCommonBaseJoiner_(self, param0);
}

ComGoogleCommonBaseJoiner_1 *new_ComGoogleCommonBaseJoiner_1_initWithComGoogleCommonBaseJoiner_withNSString_withComGoogleCommonBaseJoiner_(ComGoogleCommonBaseJoiner *outer$, NSString *capture$0, ComGoogleCommonBaseJoiner *param0) {
  J2OBJC_NEW_IMPL(ComGoogleCommonBaseJoiner_1, initWithComGoogleCommonBaseJoiner_withNSString_withComGoogleCommonBaseJoiner_, outer$, capture$0, param0)
}

ComGoogleCommonBaseJoiner_1 *create_ComGoogleCommonBaseJoiner_1_initWithComGoogleCommonBaseJoiner_withNSString_withComGoogleCommonBaseJoiner_(ComGoogleCommonBaseJoiner *outer$, NSString *capture$0, ComGoogleCommonBaseJoiner *param0) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonBaseJoiner_1, initWithComGoogleCommonBaseJoiner_withNSString_withComGoogleCommonBaseJoiner_, outer$, capture$0, param0)
}
...
- (instancetype)initWithComGoogleCommonBaseJoiner:(ComGoogleCommonBaseJoiner *)outer$
                    withComGoogleCommonBaseJoiner:(ComGoogleCommonBaseJoiner *)param0 {
  ComGoogleCommonBaseJoiner_2_initWithComGoogleCommonBaseJoiner_withComGoogleCommonBaseJoiner_(self, outer$, param0);
  return self;
}

- (id<JavaLangAppendable>)appendToWithJavaLangAppendable:(id<JavaLangAppendable>)appendable
                                    withJavaUtilIterator:(id<JavaUtilIterator>)parts {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_withId_(appendable, @"appendable");
  ComGoogleCommonBasePreconditions_checkNotNullWithId_withId_(parts, @"parts");
  while ([((id<JavaUtilIterator>) nil_chk(parts)) hasNext]) {
    id part = [parts next];
    if (part != nil) {
      [((id<JavaLangAppendable>) nil_chk(appendable)) appendWithJavaLangCharSequence:[this$0_ toStringWithId:part]];
      break;
    }
  }
  while ([parts hasNext]) {
    id part = [parts next];
    if (part != nil) {
      [((id<JavaLangAppendable>) nil_chk(appendable)) appendWithJavaLangCharSequence:separator_];
      [appendable appendWithJavaLangCharSequence:[this$0_ toStringWithId:part]];
    }
  }
  return appendable;
}
...
- (ComGoogleCommonBaseJoiner *)useForNullWithNSString:(NSString *)nullText {
  @throw create_JavaLangUnsupportedOperationException_initWithNSString_(@"already specified skipNulls");
}

- (ComGoogleCommonBaseJoiner_MapJoiner *)withKeyValueSeparatorWithNSString:(NSString *)kvs {
  @throw create_JavaLangUnsupportedOperationException_initWithNSString_(@"can't use .skipNulls() with maps");
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonBaseJoiner_2 = { "", "com.google.common.base", ptrTable, methods, fields, 7, 0x8008, 4, 1, 0, -1, 8, -1, -1 };
  return &_ComGoogleCommonBaseJoiner_2;
}

@end

void ComGoogleCommonBaseJoiner_2_initWithComGoogleCommonBaseJoiner_withComGoogleCommonBaseJoiner_(ComGoogleCommonBaseJoiner_2 *self, ComGoogleCommonBaseJoiner *outer$, ComGoogleCommonBaseJoiner *param0) {
  JreStrongAssign(&self->this$0_, outer$);
  ComGoogleCommonBaseJoiner_initWithComGoogleCommonBaseJoiner_(self, param0);
}

ComGoogleCommonBaseJoiner_2 *new_ComGoogleCommonBaseJoiner_2_initWithComGoogleCommonBaseJoiner_withComGoogleCommonBaseJoiner_(ComGoogleCommonBaseJoiner *outer$, ComGoogleCommonBaseJoiner *param0) {
  J2OBJC_NEW_IMPL(ComGoogleCommonBaseJoiner_2, initWithComGoogleCommonBaseJoiner_withComGoogleCommonBaseJoiner_, outer$, param0)
}

ComGoogleCommonBaseJoiner_2 *create_ComGoogleCommonBaseJoiner_2_initWithComGoogleCommonBaseJoiner_withComGoogleCommonBaseJoiner_(ComGoogleCommonBaseJoiner *outer$, ComGoogleCommonBaseJoiner *param0) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonBaseJoiner_2, initWithComGoogleCommonBaseJoiner_withComGoogleCommonBaseJoiner_, outer$, param0)
}
...
- (id<JavaLangAppendable>)appendToWithJavaLangAppendable:(id<JavaLangAppendable>)appendable
  ...
  if ([((id<JavaUtilIterator>) nil_chk(parts)) hasNext]) {
    ...
    [((id<JavaLangAppendable>) nil_chk(appendable)) appendWithJavaLangCharSequence:[((ComGoogleCommonBaseJoiner *) nil_chk(joiner_)) toStringWithId:[((id<JavaUtilMap_Entry>) nil_chk(entry_)) getKey]]];
    [appendable appendWithJavaLangCharSequence:keyValueSeparator_];
    [appendable appendWithJavaLangCharSequence:[joiner_ toStringWithId:[entry_ getValue]]];
    while ([parts hasNext]) {
      [appendable appendWithJavaLangCharSequence:joiner_->separator_];
      id<JavaUtilMap_Entry> e = [parts next];
      [appendable appendWithJavaLangCharSequence:[joiner_ toStringWithId:[((id<JavaUtilMap_Entry>) nil_chk(e)) getKey]]];
      [appendable appendWithJavaLangCharSequence:keyValueSeparator_];
      [appendable appendWithJavaLangCharSequence:[joiner_ toStringWithId:[e getValue]]];
    }
  }
  return appendable;
}
...
- (JavaLangStringBuilder *)appendToWithJavaLangStringBuilder:(JavaLangStringBuilder *)builder
  ...
  @try {
    [self appendToWithJavaLangAppendable:builder withJavaUtilIterator:entries];
  }
  @catch (JavaIoIOException *impossible) {
    @throw create_JavaLangAssertionError_initWithId_(impossible);
  }
...
- (NSString *)joinWithJavaUtilIterator:(id<JavaUtilIterator>)entries {
  return [((JavaLangStringBuilder *) nil_chk([self appendToWithJavaLangStringBuilder:create_JavaLangStringBuilder_init() withJavaUtilIterator:entries])) description];
}

- (ComGoogleCommonBaseJoiner_MapJoiner *)useForNullWithNSString:(NSString *)nullText {
  return create_ComGoogleCommonBaseJoiner_MapJoiner_initWithComGoogleCommonBaseJoiner_withNSString_([((ComGoogleCommonBaseJoiner *) nil_chk(joiner_)) useForNullWithNSString:nullText], keyValueSeparator_);
}

- (void)dealloc {
  RELEASE_(joiner_);
  RELEASE_(keyValueSeparator_);
  [super dealloc];
}
...
void ComGoogleCommonBaseJoiner_MapJoiner_initWithComGoogleCommonBaseJoiner_withNSString_(ComGoogleCommonBaseJoiner_MapJoiner *self, ComGoogleCommonBaseJoiner *joiner, NSString *keyValueSeparator) {
  NSObject_init(self);
  JreStrongAssign(&self->joiner_, joiner);
  JreStrongAssign(&self->keyValueSeparator_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(keyValueSeparator));
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonBaseJoiner_3 = { "", "com.google.common.base", ptrTable, methods, fields, 7, 0x8008, 3, 3, 2, -1, 3, 4, -1 };
...
void ComGoogleCommonBaseJoiner_3_initWithNSObjectArray_withId_withId_(ComGoogleCommonBaseJoiner_3 *self, IOSObjectArray *capture$0, id capture$1, id capture$2) {
  JreStrongAssign(&self->val$rest_, capture$0);
