...
//  source: ../target/dependency/com/google/common/base/CharMatcher.java
//
...
withComGoogleCommonBaseCharMatcher:(ComGoogleCommonBaseCharMatcher *)param0;
...
__attribute__((unused)) static void ComGoogleCommonBaseCharMatcher_1_initWithNSString_withComGoogleCommonBaseCharMatcher_(ComGoogleCommonBaseCharMatcher_1 *self, NSString *capture$0, ComGoogleCommonBaseCharMatcher *param0);

__attribute__((unused)) static ComGoogleCommonBaseCharMatcher_1 *new_ComGoogleCommonBaseCharMatcher_1_initWithNSString_withComGoogleCommonBaseCharMatcher_(NSString *capture$0, ComGoogleCommonBaseCharMatcher *param0) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonBaseCharMatcher_1 *create_ComGoogleCommonBaseCharMatcher_1_initWithNSString_withComGoogleCommonBaseCharMatcher_(NSString *capture$0, ComGoogleCommonBaseCharMatcher *param0);
...
- (ComGoogleCommonBaseCharMatcher *)negate {
  return create_ComGoogleCommonBaseCharMatcher_Negated_initWithComGoogleCommonBaseCharMatcher_(self);
}

- (ComGoogleCommonBaseCharMatcher *)and__WithComGoogleCommonBaseCharMatcher:(ComGoogleCommonBaseCharMatcher *)other {
  return create_ComGoogleCommonBaseCharMatcher_And_initWithComGoogleCommonBaseCharMatcher_withComGoogleCommonBaseCharMatcher_(self, other);
}

- (ComGoogleCommonBaseCharMatcher *)or__WithComGoogleCommonBaseCharMatcher:(ComGoogleCommonBaseCharMatcher *)other {
  return create_ComGoogleCommonBaseCharMatcher_Or_initWithComGoogleCommonBaseCharMatcher_withComGoogleCommonBaseCharMatcher_(self, other);
}
...
- (ComGoogleCommonBaseCharMatcher *)precomputedInternal {
  JavaUtilBitSet *table = create_JavaUtilBitSet_init();
  ...
  if (totalCharacters * 2 <= ComGoogleCommonBaseCharMatcher_DISTINCT_CHARS) {
    ...
    NSString *negatedDescription = [((NSString *) nil_chk(description_)) hasSuffix:suffix] ? [description_ java_substring:0 endIndex:((jint) [description_ length]) - ((jint) [suffix length])] : JreStrcat("$$", description_, suffix);
    return create_ComGoogleCommonBaseCharMatcher_1_initWithNSString_withComGoogleCommonBaseCharMatcher_(description_, ComGoogleCommonBaseCharMatcher_precomputedPositiveWithInt_withJavaUtilBitSet_withNSString_(negatedCharacters, table, negatedDescription));
  }
}
...
- (jboolean)matchesAllOfWithJavaLangCharSequence:(id<JavaLangCharSequence>)sequence {
  for (jint i = [((id<JavaLangCharSequence>) nil_chk(sequence)) length] - 1; i >= 0; i--) {
...
- (jint)indexInWithJavaLangCharSequence:(id<JavaLangCharSequence>)sequence
                                withInt:(jint)start {
  jint length = [((id<JavaLangCharSequence>) nil_chk(sequence)) length];
...
- (jint)countInWithJavaLangCharSequence:(id<JavaLangCharSequence>)sequence {
  jint count = 0;
  for (jint i = 0; i < [((id<JavaLangCharSequence>) nil_chk(sequence)) length]; i++) {
    if ([self matchesWithChar:[sequence charAtWithInt:i]]) {
      count++;
    }
  }
...
- (NSString *)replaceFromWithJavaLangCharSequence:(id<JavaLangCharSequence>)sequence
                         withJavaLangCharSequence:(id<JavaLangCharSequence>)replacement {
  jint replacementLen = [((id<JavaLangCharSequence>) nil_chk(replacement)) length];
  if (replacementLen == 0) {
  ...
  JavaLangStringBuilder *buf = create_JavaLangStringBuilder_initWithInt_((len * 3 / 2) + 16);
  jint oldpos = 0;
  do {
    [buf appendWithJavaLangCharSequence:string withInt:oldpos withInt:pos];
    [buf appendWithJavaLangCharSequence:replacement];
    oldpos = pos + 1;
    pos = [self indexInWithJavaLangCharSequence:string withInt:oldpos];
  }
  while (pos != -1);
  [buf appendWithJavaLangCharSequence:string withInt:oldpos withInt:len];
  return [buf description];
}

- (NSString *)trimFromWithJavaLangCharSequence:(id<JavaLangCharSequence>)sequence {
  jint len = [((id<JavaLangCharSequence>) nil_chk(sequence)) length];
  jint first;
  jint last;
  ...
  for (jint i = 0; i < len; i++) {
    ...
    if ([self matchesWithChar:c]) {
      if (c == replacement && (i == len - 1 || ![self matchesWithChar:[sequence charAtWithInt:i + 1]])) {
        ...
        JavaLangStringBuilder *builder = [((JavaLangStringBuilder *) nil_chk([create_JavaLangStringBuilder_initWithInt_(len) appendWithJavaLangCharSequence:sequence withInt:0 withInt:i])) appendWithChar:replacement];
...
+ (void)initialize {
  if (self == [ComGoogleCommonBaseCharMatcher class]) {
    JreStrongAssign(&ComGoogleCommonBaseCharMatcher_WHITESPACE, ComGoogleCommonBaseCharMatcher_whitespace());
    JreStrongAssign(&ComGoogleCommonBaseCharMatcher_BREAKING_WHITESPACE, ComGoogleCommonBaseCharMatcher_breakingWhitespace());
    JreStrongAssign(&ComGoogleCommonBaseCharMatcher_ASCII, ComGoogleCommonBaseCharMatcher_ascii());
    JreStrongAssign(&ComGoogleCommonBaseCharMatcher_DIGIT, ComGoogleCommonBaseCharMatcher_digit());
    JreStrongAssign(&ComGoogleCommonBaseCharMatcher_JAVA_DIGIT, ComGoogleCommonBaseCharMatcher_javaDigit());
    JreStrongAssign(&ComGoogleCommonBaseCharMatcher_JAVA_LETTER, ComGoogleCommonBaseCharMatcher_javaLetter());
    JreStrongAssign(&ComGoogleCommonBaseCharMatcher_JAVA_LETTER_OR_DIGIT, ComGoogleCommonBaseCharMatcher_javaLetterOrDigit());
    JreStrongAssign(&ComGoogleCommonBaseCharMatcher_JAVA_UPPER_CASE, ComGoogleCommonBaseCharMatcher_javaUpperCase());
    JreStrongAssign(&ComGoogleCommonBaseCharMatcher_JAVA_LOWER_CASE, ComGoogleCommonBaseCharMatcher_javaLowerCase());
    JreStrongAssign(&ComGoogleCommonBaseCharMatcher_JAVA_ISO_CONTROL, ComGoogleCommonBaseCharMatcher_javaIsoControl());
    JreStrongAssign(&ComGoogleCommonBaseCharMatcher_INVISIBLE, ComGoogleCommonBaseCharMatcher_invisible());
    JreStrongAssign(&ComGoogleCommonBaseCharMatcher_SINGLE_WIDTH, ComGoogleCommonBaseCharMatcher_singleWidth());
    JreStrongAssign(&ComGoogleCommonBaseCharMatcher_ANY, ComGoogleCommonBaseCharMatcher_any());
    JreStrongAssign(&ComGoogleCommonBaseCharMatcher_NONE, ComGoogleCommonBaseCharMatcher_none());
...
ComGoogleCommonBaseCharMatcher *ComGoogleCommonBaseCharMatcher_isWithChar_(jchar match) {
  ComGoogleCommonBaseCharMatcher_initialize();
  return create_ComGoogleCommonBaseCharMatcher_Is_initWithChar_(match);
}

ComGoogleCommonBaseCharMatcher *ComGoogleCommonBaseCharMatcher_isNotWithChar_(jchar match) {
  ComGoogleCommonBaseCharMatcher_initialize();
  return create_ComGoogleCommonBaseCharMatcher_IsNot_initWithChar_(match);
}
...
ComGoogleCommonBaseCharMatcher *ComGoogleCommonBaseCharMatcher_anyOfWithJavaLangCharSequence_(id<JavaLangCharSequence> sequence) {
  ComGoogleCommonBaseCharMatcher_initialize();
  switch ([((id<JavaLangCharSequence>) nil_chk(sequence)) length]) {
    case 0:
    return ComGoogleCommonBaseCharMatcher_none();
    case 1:
    ...
    default:
    return create_ComGoogleCommonBaseCharMatcher_AnyOf_initWithJavaLangCharSequence_(sequence);
  }
}
...
ComGoogleCommonBaseCharMatcher *ComGoogleCommonBaseCharMatcher_inRangeWithChar_withChar_(jchar startInclusive, jchar endInclusive) {
  ComGoogleCommonBaseCharMatcher_initialize();
  return create_ComGoogleCommonBaseCharMatcher_InRange_initWithChar_withChar_(startInclusive, endInclusive);
}
...
ComGoogleCommonBaseCharMatcher *ComGoogleCommonBaseCharMatcher_forPredicateWithComGoogleCommonBasePredicate_(id<ComGoogleCommonBasePredicate> predicate) {
  ComGoogleCommonBaseCharMatcher_initialize();
  return [predicate isKindOfClass:[ComGoogleCommonBaseCharMatcher class]] ? (ComGoogleCommonBaseCharMatcher *) cast_chk(predicate, [ComGoogleCommonBaseCharMatcher class]) : create_ComGoogleCommonBaseCharMatcher_ForPredicate_initWithComGoogleCommonBasePredicate_(predicate);
}
...
ComGoogleCommonBaseCharMatcher *ComGoogleCommonBaseCharMatcher_precomputedPositiveWithInt_withJavaUtilBitSet_withNSString_(jint totalCharacters, JavaUtilBitSet *table, NSString *description_) {
  ComGoogleCommonBaseCharMatcher_initialize();
  {
    ...
    switch (totalCharacters) {
      ...
      return ComGoogleCommonBaseCharMatcher_isEitherWithChar_withChar_(c1, c2);
      default:
      return ComGoogleCommonBaseCharMatcher_isSmallWithInt_withInt_(totalCharacters, [((JavaUtilBitSet *) nil_chk(table)) length]) ? ComGoogleCommonBaseSmallCharMatcher_fromWithJavaUtilBitSet_withNSString_(table, description_) : create_ComGoogleCommonBaseCharMatcher_BitSetMatcher_initWithJavaUtilBitSet_withNSString_(table, description_);
    }
  }
}
...
NSString *ComGoogleCommonBaseCharMatcher_finishCollapseFromWithJavaLangCharSequence_withInt_withInt_withChar_withJavaLangStringBuilder_withBoolean_(ComGoogleCommonBaseCharMatcher *self, id<JavaLangCharSequence> sequence, jint start, jint end, jchar replacement, JavaLangStringBuilder *builder, jboolean inMatchingGroup) {
  for (jint i = start; i < end; i++) {
    ...
    if ([self matchesWithChar:c]) {
      if (!inMatchingGroup) {
        [((JavaLangStringBuilder *) nil_chk(builder)) appendWithChar:replacement];
...
NSString *ComGoogleCommonBaseCharMatcher_showCharacterWithChar_(jchar c) {
  ...
  IOSCharArray *tmp = [IOSCharArray arrayWithChars:(jchar[]){ '\\', 'u', 0x0000, 0x0000, 0x0000, 0x0000 } count:6];
  for (jint i = 0; i < 4; i++) {
...
ComGoogleCommonBaseCharMatcher_IsEither *ComGoogleCommonBaseCharMatcher_isEitherWithChar_withChar_(jchar c1, jchar c2) {
  ComGoogleCommonBaseCharMatcher_initialize();
  return create_ComGoogleCommonBaseCharMatcher_IsEither_initWithChar_withChar_(c1, c2);
}
...
- (jint)countInWithJavaLangCharSequence:(id<JavaLangCharSequence>)sequence {
  return [((id<JavaLangCharSequence>) nil_chk(sequence)) length] - [((ComGoogleCommonBaseCharMatcher *) nil_chk(original_)) countInWithJavaLangCharSequence:sequence];
}

- (void)setBitsWithJavaUtilBitSet:(JavaUtilBitSet *)table {
  JavaUtilBitSet *tmp = create_JavaUtilBitSet_init();
...
void ComGoogleCommonBaseCharMatcher_Negated_initWithComGoogleCommonBaseCharMatcher_(ComGoogleCommonBaseCharMatcher_Negated *self, ComGoogleCommonBaseCharMatcher *original) {
  ComGoogleCommonBaseCharMatcher_init(self);
  JreStrongAssign(&self->original_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(original));
}
...
- (instancetype)initWithNSString:(NSString *)capture$0
withComGoogleCommonBaseCharMatcher:(ComGoogleCommonBaseCharMatcher *)param0 {
  ComGoogleCommonBaseCharMatcher_1_initWithNSString_withComGoogleCommonBaseCharMatcher_(self, capture$0, param0);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonBaseCharMatcher_1 = { "", "com.google.common.base", ptrTable, methods, fields, 7, 0x8008, 2, 1, 0, -1, 2, -1, -1 };
  return &_ComGoogleCommonBaseCharMatcher_1;
}

@end

void ComGoogleCommonBaseCharMatcher_1_initWithNSString_withComGoogleCommonBaseCharMatcher_(ComGoogleCommonBaseCharMatcher_1 *self, NSString *capture$0, ComGoogleCommonBaseCharMatcher *param0) {
  JreStrongAssign(&self->val$description_, capture$0);
  ComGoogleCommonBaseCharMatcher_NegatedFastMatcher_initWithComGoogleCommonBaseCharMatcher_(self, param0);
}

ComGoogleCommonBaseCharMatcher_1 *new_ComGoogleCommonBaseCharMatcher_1_initWithNSString_withComGoogleCommonBaseCharMatcher_(NSString *capture$0, ComGoogleCommonBaseCharMatcher *param0) {
  J2OBJC_NEW_IMPL(ComGoogleCommonBaseCharMatcher_1, initWithNSString_withComGoogleCommonBaseCharMatcher_, capture$0, param0)
}

ComGoogleCommonBaseCharMatcher_1 *create_ComGoogleCommonBaseCharMatcher_1_initWithNSString_withComGoogleCommonBaseCharMatcher_(NSString *capture$0, ComGoogleCommonBaseCharMatcher *param0) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonBaseCharMatcher_1, initWithNSString_withComGoogleCommonBaseCharMatcher_, capture$0, param0)
}
...
- (ComGoogleCommonBaseCharMatcher *)negate {
  return create_ComGoogleCommonBaseCharMatcher_NegatedFastMatcher_initWithComGoogleCommonBaseCharMatcher_(self);
}
...
void ComGoogleCommonBaseCharMatcher_NamedFastMatcher_initWithNSString_(ComGoogleCommonBaseCharMatcher_NamedFastMatcher *self, NSString *description_) {
  ComGoogleCommonBaseCharMatcher_FastMatcher_init(self);
  JreStrongAssign(&self->description__, ComGoogleCommonBasePreconditions_checkNotNullWithId_(description_));
}
...
- (jint)indexInWithJavaLangCharSequence:(id<JavaLangCharSequence>)sequence {
  return ([((id<JavaLangCharSequence>) nil_chk(sequence)) length] == 0) ? -1 : 0;
}
...
- (jint)lastIndexInWithJavaLangCharSequence:(id<JavaLangCharSequence>)sequence {
  return [((id<JavaLangCharSequence>) nil_chk(sequence)) length] - 1;
}
...
- (jboolean)matchesNoneOfWithJavaLangCharSequence:(id<JavaLangCharSequence>)sequence {
  return [((id<JavaLangCharSequence>) nil_chk(sequence)) length] == 0;
}
...
- (NSString *)replaceFromWithJavaLangCharSequence:(id<JavaLangCharSequence>)sequence
                                         withChar:(jchar)replacement {
  IOSCharArray *array = [IOSCharArray arrayWithLength:[((id<JavaLangCharSequence>) nil_chk(sequence)) length]];
...
- (NSString *)replaceFromWithJavaLangCharSequence:(id<JavaLangCharSequence>)sequence
                         withJavaLangCharSequence:(id<JavaLangCharSequence>)replacement {
  JavaLangStringBuilder *result = create_JavaLangStringBuilder_initWithInt_([((id<JavaLangCharSequence>) nil_chk(sequence)) length] * [((id<JavaLangCharSequence>) nil_chk(replacement)) length]);
  for (jint i = 0; i < [sequence length]; i++) {
    [result appendWithJavaLangCharSequence:replacement];
  }
...
- (NSString *)collapseFromWithJavaLangCharSequence:(id<JavaLangCharSequence>)sequence
                                          withChar:(jchar)replacement {
  return ([((id<JavaLangCharSequence>) nil_chk(sequence)) length] == 0) ? @"" : NSString_java_valueOfChar_(replacement);
}
...
- (jint)countInWithJavaLangCharSequence:(id<JavaLangCharSequence>)sequence {
  return [((id<JavaLangCharSequence>) nil_chk(sequence)) length];
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonBaseCharMatcher_Any class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonBaseCharMatcher_Any_INSTANCE, new_ComGoogleCommonBaseCharMatcher_Any_init());
...
- (NSString *)replaceFromWithJavaLangCharSequence:(id<JavaLangCharSequence>)sequence
                         withJavaLangCharSequence:(id<JavaLangCharSequence>)replacement {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(replacement);
  return [((id<JavaLangCharSequence>) nil_chk(sequence)) description];
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonBaseCharMatcher_None class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonBaseCharMatcher_None_INSTANCE, new_ComGoogleCommonBaseCharMatcher_None_init());
...
- (void)setBitsWithJavaUtilBitSet:(JavaUtilBitSet *)table {
  for (jint i = 0; i < ((jint) [((NSString *) nil_chk(ComGoogleCommonBaseCharMatcher_Whitespace_TABLE)) length]); i++) {
...
+ (void)initialize {
  if (self == [ComGoogleCommonBaseCharMatcher_Whitespace class]) {
    ComGoogleCommonBaseCharMatcher_Whitespace_SHIFT = JavaLangInteger_numberOfLeadingZerosWithInt_(((jint) [((NSString *) nil_chk(ComGoogleCommonBaseCharMatcher_Whitespace_TABLE)) length]) - 1);
    JreStrongAssignAndConsume(&ComGoogleCommonBaseCharMatcher_Whitespace_INSTANCE, new_ComGoogleCommonBaseCharMatcher_Whitespace_init());
...
+ (void)initialize {
  if (self == [ComGoogleCommonBaseCharMatcher_BreakingWhitespace class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonBaseCharMatcher_BreakingWhitespace_INSTANCE, new_ComGoogleCommonBaseCharMatcher_BreakingWhitespace_init());
...
+ (void)initialize {
  if (self == [ComGoogleCommonBaseCharMatcher_Ascii class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonBaseCharMatcher_Ascii_INSTANCE, new_ComGoogleCommonBaseCharMatcher_Ascii_init());
...
void ComGoogleCommonBaseCharMatcher_RangesMatcher_initWithNSString_withCharArray_withCharArray_(ComGoogleCommonBaseCharMatcher_RangesMatcher *self, NSString *description_, IOSCharArray *rangeStarts, IOSCharArray *rangeEnds) {
  ...
  JreStrongAssign(&self->rangeStarts_, rangeStarts);
  JreStrongAssign(&self->rangeEnds_, rangeEnds);
...
+ (void)initialize {
  if (self == [ComGoogleCommonBaseCharMatcher_Digit class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonBaseCharMatcher_Digit_INSTANCE, new_ComGoogleCommonBaseCharMatcher_Digit_init());
...
IOSCharArray *ComGoogleCommonBaseCharMatcher_Digit_nines() {
  ComGoogleCommonBaseCharMatcher_Digit_initialize();
  IOSCharArray *nines = [IOSCharArray arrayWithLength:((jint) [((NSString *) nil_chk(ComGoogleCommonBaseCharMatcher_Digit_ZEROES)) length])];
  for (jint i = 0; i < ((jint) [ComGoogleCommonBaseCharMatcher_Digit_ZEROES length]); i++) {
...
+ (void)initialize {
  if (self == [ComGoogleCommonBaseCharMatcher_JavaDigit class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonBaseCharMatcher_JavaDigit_INSTANCE, new_ComGoogleCommonBaseCharMatcher_JavaDigit_init());
...
+ (void)initialize {
  if (self == [ComGoogleCommonBaseCharMatcher_JavaLetter class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonBaseCharMatcher_JavaLetter_INSTANCE, new_ComGoogleCommonBaseCharMatcher_JavaLetter_init());
...
+ (void)initialize {
  if (self == [ComGoogleCommonBaseCharMatcher_JavaLetterOrDigit class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonBaseCharMatcher_JavaLetterOrDigit_INSTANCE, new_ComGoogleCommonBaseCharMatcher_JavaLetterOrDigit_init());
...
+ (void)initialize {
  if (self == [ComGoogleCommonBaseCharMatcher_JavaUpperCase class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonBaseCharMatcher_JavaUpperCase_INSTANCE, new_ComGoogleCommonBaseCharMatcher_JavaUpperCase_init());
...
+ (void)initialize {
  if (self == [ComGoogleCommonBaseCharMatcher_JavaLowerCase class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonBaseCharMatcher_JavaLowerCase_INSTANCE, new_ComGoogleCommonBaseCharMatcher_JavaLowerCase_init());
...
+ (void)initialize {
  if (self == [ComGoogleCommonBaseCharMatcher_JavaIsoControl class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonBaseCharMatcher_JavaIsoControl_INSTANCE, new_ComGoogleCommonBaseCharMatcher_JavaIsoControl_init());
...
+ (void)initialize {
  if (self == [ComGoogleCommonBaseCharMatcher_Invisible class]) {
    JreStrongAssign(&ComGoogleCommonBaseCharMatcher_Invisible_RANGE_STARTS, JreStrcat("$$", @"\x00\x7f\u00ad\u0600\u061c\u06dd\u070f\u1680\u180e\u2000\u2028\u205f\u2066\u2067", [NSString stringWithCharacters:(jchar[]) { (int) 0x2068, (int) 0x2069, (int) 0x206a, (int) 0x3000, (int) 0xd800, (int) 0xfeff, (int) 0xfff9, (int) 0xfffa } length:8]));
    JreStrongAssignAndConsume(&ComGoogleCommonBaseCharMatcher_Invisible_INSTANCE, new_ComGoogleCommonBaseCharMatcher_Invisible_init());
...
+ (void)initialize {
  if (self == [ComGoogleCommonBaseCharMatcher_SingleWidth class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonBaseCharMatcher_SingleWidth_INSTANCE, new_ComGoogleCommonBaseCharMatcher_SingleWidth_init());
...
- (void)setBitsWithJavaUtilBitSet:(JavaUtilBitSet *)table {
  JavaUtilBitSet *tmp1 = create_JavaUtilBitSet_init();
  [((ComGoogleCommonBaseCharMatcher *) nil_chk(first_)) setBitsWithJavaUtilBitSet:tmp1];
  JavaUtilBitSet *tmp2 = create_JavaUtilBitSet_init();
...
void ComGoogleCommonBaseCharMatcher_And_initWithComGoogleCommonBaseCharMatcher_withComGoogleCommonBaseCharMatcher_(ComGoogleCommonBaseCharMatcher_And *self, ComGoogleCommonBaseCharMatcher *a, ComGoogleCommonBaseCharMatcher *b) {
  ComGoogleCommonBaseCharMatcher_init(self);
  JreStrongAssign(&self->first_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(a));
  JreStrongAssign(&self->second_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(b));
}
...
- (NSString *)description {
  JavaLangStringBuilder *description_ = create_JavaLangStringBuilder_initWithNSString_(@"CharMatcher.anyOf(\"");
  {
    IOSCharArray *a__ = chars_;
    jchar const *b__ = ((IOSCharArray *) nil_chk(a__))->buffer_;
    jchar const *e__ = b__ + a__->size_;
    while (b__ < e__) {
      jchar c = *b__++;
      [description_ appendWithNSString:ComGoogleCommonBaseCharMatcher_showCharacterWithChar_(c)];
    }
  }
  [description_ appendWithNSString:@"\")"];
...
void ComGoogleCommonBaseCharMatcher_AnyOf_initWithJavaLangCharSequence_(ComGoogleCommonBaseCharMatcher_AnyOf *self, id<JavaLangCharSequence> chars) {
  ComGoogleCommonBaseCharMatcher_init(self);
  JreStrongAssign(&self->chars_, [((NSString *) nil_chk([((id<JavaLangCharSequence>) nil_chk(chars)) description])) java_toCharArray]);
