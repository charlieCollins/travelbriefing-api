...
//  source: ../target/dependency/com/google/common/base/Splitter.java
//
...
- (instancetype)initWithComGoogleCommonBaseSplitter_1:(ComGoogleCommonBaseSplitter_1 *)outer$
                      withComGoogleCommonBaseSplitter:(ComGoogleCommonBaseSplitter *)param0
                             withJavaLangCharSequence:(id<JavaLangCharSequence>)param1;
...
__attribute__((unused)) static void ComGoogleCommonBaseSplitter_1_1_initWithComGoogleCommonBaseSplitter_1_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(ComGoogleCommonBaseSplitter_1_1 *self, ComGoogleCommonBaseSplitter_1 *outer$, ComGoogleCommonBaseSplitter *param0, id<JavaLangCharSequence> param1);

__attribute__((unused)) static ComGoogleCommonBaseSplitter_1_1 *new_ComGoogleCommonBaseSplitter_1_1_initWithComGoogleCommonBaseSplitter_1_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(ComGoogleCommonBaseSplitter_1 *outer$, ComGoogleCommonBaseSplitter *param0, id<JavaLangCharSequence> param1) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonBaseSplitter_1_1 *create_ComGoogleCommonBaseSplitter_1_1_initWithComGoogleCommonBaseSplitter_1_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(ComGoogleCommonBaseSplitter_1 *outer$, ComGoogleCommonBaseSplitter *param0, id<JavaLangCharSequence> param1);
...
__attribute__((unused)) static void ComGoogleCommonBaseSplitter_2_1_initWithComGoogleCommonBaseSplitter_2_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(ComGoogleCommonBaseSplitter_2_1 *self, ComGoogleCommonBaseSplitter_2 *outer$, ComGoogleCommonBaseSplitter *param0, id<JavaLangCharSequence> param1);
...
__attribute__((unused)) static ComGoogleCommonBaseSplitter_2_1 *create_ComGoogleCommonBaseSplitter_2_1_initWithComGoogleCommonBaseSplitter_2_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(ComGoogleCommonBaseSplitter_2 *outer$, ComGoogleCommonBaseSplitter *param0, id<JavaLangCharSequence> param1);
...
__attribute__((unused)) static void ComGoogleCommonBaseSplitter_4_1_initWithComGoogleCommonBaseSplitter_4_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(ComGoogleCommonBaseSplitter_4_1 *self, ComGoogleCommonBaseSplitter_4 *outer$, ComGoogleCommonBaseSplitter *param0, id<JavaLangCharSequence> param1);
...
__attribute__((unused)) static ComGoogleCommonBaseSplitter_4_1 *create_ComGoogleCommonBaseSplitter_4_1_initWithComGoogleCommonBaseSplitter_4_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(ComGoogleCommonBaseSplitter_4 *outer$, ComGoogleCommonBaseSplitter *param0, id<JavaLangCharSequence> param1);
...
- (ComGoogleCommonBaseSplitter *)omitEmptyStrings {
  return create_ComGoogleCommonBaseSplitter_initWithComGoogleCommonBaseSplitter_Strategy_withBoolean_withComGoogleCommonBaseCharMatcher_withInt_(strategy_, true, trimmer_, limit_);
}
...
- (ComGoogleCommonBaseSplitter *)limitWithInt:(jint)limit {
  ...
  return create_ComGoogleCommonBaseSplitter_initWithComGoogleCommonBaseSplitter_Strategy_withBoolean_withComGoogleCommonBaseCharMatcher_withInt_(strategy_, omitEmptyStrings_, trimmer_, limit);
}
...
- (ComGoogleCommonBaseSplitter *)trimResultsWithComGoogleCommonBaseCharMatcher:(ComGoogleCommonBaseCharMatcher *)trimmer {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(trimmer);
  return create_ComGoogleCommonBaseSplitter_initWithComGoogleCommonBaseSplitter_Strategy_withBoolean_withComGoogleCommonBaseCharMatcher_withInt_(strategy_, omitEmptyStrings_, trimmer, limit_);
}

- (id<JavaLangIterable>)splitWithJavaLangCharSequence:(id<JavaLangCharSequence>)sequence {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(sequence);
  return create_ComGoogleCommonBaseSplitter_5_initWithComGoogleCommonBaseSplitter_withJavaLangCharSequence_(self, sequence);
}
...
- (ComGoogleCommonBaseSplitter_MapSplitter *)withKeyValueSeparatorWithComGoogleCommonBaseSplitter:(ComGoogleCommonBaseSplitter *)keyValueSplitter {
  return create_ComGoogleCommonBaseSplitter_MapSplitter_initWithComGoogleCommonBaseSplitter_withComGoogleCommonBaseSplitter_(self, keyValueSplitter);
}
...
void ComGoogleCommonBaseSplitter_initWithComGoogleCommonBaseSplitter_Strategy_withBoolean_withComGoogleCommonBaseCharMatcher_withInt_(ComGoogleCommonBaseSplitter *self, id<ComGoogleCommonBaseSplitter_Strategy> strategy, jboolean omitEmptyStrings, ComGoogleCommonBaseCharMatcher *trimmer, jint limit) {
  ...
  JreStrongAssign(&self->trimmer_, trimmer);
  self->limit_ = limit;
}
...
ComGoogleCommonBaseSplitter *ComGoogleCommonBaseSplitter_onWithComGoogleCommonBaseCharMatcher_(ComGoogleCommonBaseCharMatcher *separatorMatcher) {
  ComGoogleCommonBaseSplitter_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(separatorMatcher);
  return create_ComGoogleCommonBaseSplitter_initWithComGoogleCommonBaseSplitter_Strategy_(create_ComGoogleCommonBaseSplitter_1_initWithComGoogleCommonBaseCharMatcher_(separatorMatcher));
}

ComGoogleCommonBaseSplitter *ComGoogleCommonBaseSplitter_onWithNSString_(NSString *separator) {
  ComGoogleCommonBaseSplitter_initialize();
  ComGoogleCommonBasePreconditions_checkArgumentWithBoolean_withId_(((jint) [((NSString *) nil_chk(separator)) length]) != 0, @"The separator may not be the empty string.");
  if (((jint) [separator length]) == 1) {
    return ComGoogleCommonBaseSplitter_onWithChar_([separator charAtWithInt:0]);
  }
  return create_ComGoogleCommonBaseSplitter_initWithComGoogleCommonBaseSplitter_Strategy_(create_ComGoogleCommonBaseSplitter_2_initWithNSString_(separator));
}
...
ComGoogleCommonBaseSplitter *ComGoogleCommonBaseSplitter_onWithJavaUtilRegexPattern_(JavaUtilRegexPattern *separatorPattern) {
  ComGoogleCommonBaseSplitter_initialize();
  return ComGoogleCommonBaseSplitter_onWithComGoogleCommonBaseCommonPattern_(create_ComGoogleCommonBaseJdkPattern_initWithJavaUtilRegexPattern_(separatorPattern));
}
...
ComGoogleCommonBaseSplitter *ComGoogleCommonBaseSplitter_onWithComGoogleCommonBaseCommonPattern_(ComGoogleCommonBaseCommonPattern *separatorPattern) {
  ...
  return create_ComGoogleCommonBaseSplitter_initWithComGoogleCommonBaseSplitter_Strategy_(create_ComGoogleCommonBaseSplitter_3_initWithComGoogleCommonBaseCommonPattern_(separatorPattern));
}
...
ComGoogleCommonBaseSplitter *ComGoogleCommonBaseSplitter_fixedLengthWithInt_(jint length) {
  ...
  return create_ComGoogleCommonBaseSplitter_initWithComGoogleCommonBaseSplitter_Strategy_(create_ComGoogleCommonBaseSplitter_4_initWithInt_(length));
}
...
- (ComGoogleCommonBaseSplitter_SplittingIterator *)iteratorWithComGoogleCommonBaseSplitter:(ComGoogleCommonBaseSplitter *)splitter
                                                                  withJavaLangCharSequence:(id<JavaLangCharSequence>)toSplit {
  return create_ComGoogleCommonBaseSplitter_1_1_initWithComGoogleCommonBaseSplitter_1_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(self, splitter, toSplit);
}

- (void)dealloc {
  RELEASE_(val$separatorMatcher_);
  [super dealloc];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonBaseSplitter_1 = { "", "com.google.common.base", ptrTable, methods, fields, 7, 0x8008, 2, 1, 2, -1, 3, -1, -1 };
...
void ComGoogleCommonBaseSplitter_1_initWithComGoogleCommonBaseCharMatcher_(ComGoogleCommonBaseSplitter_1 *self, ComGoogleCommonBaseCharMatcher *capture$0) {
  JreStrongAssign(&self->val$separatorMatcher_, capture$0);
  NSObject_init(self);
}
...
- (NSString *)computeNext {
  ...
  while (offset_ != -1) {
    ...
    if (separatorPosition == -1) {
      end = [((id<JavaLangCharSequence>) nil_chk(toSplit_)) length];
      offset_ = -1;
    }
    else {
    ...
    if (offset_ == nextStart) {
      offset_++;
      if (offset_ > [((id<JavaLangCharSequence>) nil_chk(toSplit_)) length]) {
        offset_ = -1;
      }
      continue;
    }
...
void ComGoogleCommonBaseSplitter_SplittingIterator_initWithComGoogleCommonBaseSplitter_withJavaLangCharSequence_(ComGoogleCommonBaseSplitter_SplittingIterator *self, ComGoogleCommonBaseSplitter *splitter, id<JavaLangCharSequence> toSplit) {
  ...
  self->offset_ = 0;
  JreStrongAssign(&self->trimmer_, ((ComGoogleCommonBaseSplitter *) nil_chk(splitter))->trimmer_);
  self->omitEmptyStrings_ = splitter->omitEmptyStrings_;
  self->limit_ = splitter->limit_;
  JreStrongAssign(&self->toSplit_, toSplit);
}
...
- (instancetype)initWithComGoogleCommonBaseSplitter_1:(ComGoogleCommonBaseSplitter_1 *)outer$
                      withComGoogleCommonBaseSplitter:(ComGoogleCommonBaseSplitter *)param0
                             withJavaLangCharSequence:(id<JavaLangCharSequence>)param1 {
  ComGoogleCommonBaseSplitter_1_1_initWithComGoogleCommonBaseSplitter_1_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(self, outer$, param0, param1);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonBaseSplitter_1_1 = { "", "com.google.common.base", ptrTable, methods, fields, 7, 0x8008, 3, 1, 4, -1, 5, -1, -1 };
  return &_ComGoogleCommonBaseSplitter_1_1;
}

@end

void ComGoogleCommonBaseSplitter_1_1_initWithComGoogleCommonBaseSplitter_1_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(ComGoogleCommonBaseSplitter_1_1 *self, ComGoogleCommonBaseSplitter_1 *outer$, ComGoogleCommonBaseSplitter *param0, id<JavaLangCharSequence> param1) {
  JreStrongAssign(&self->this$0_, outer$);
  ComGoogleCommonBaseSplitter_SplittingIterator_initWithComGoogleCommonBaseSplitter_withJavaLangCharSequence_(self, param0, param1);
}

ComGoogleCommonBaseSplitter_1_1 *new_ComGoogleCommonBaseSplitter_1_1_initWithComGoogleCommonBaseSplitter_1_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(ComGoogleCommonBaseSplitter_1 *outer$, ComGoogleCommonBaseSplitter *param0, id<JavaLangCharSequence> param1) {
  J2OBJC_NEW_IMPL(ComGoogleCommonBaseSplitter_1_1, initWithComGoogleCommonBaseSplitter_1_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_, outer$, param0, param1)
}

ComGoogleCommonBaseSplitter_1_1 *create_ComGoogleCommonBaseSplitter_1_1_initWithComGoogleCommonBaseSplitter_1_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(ComGoogleCommonBaseSplitter_1 *outer$, ComGoogleCommonBaseSplitter *param0, id<JavaLangCharSequence> param1) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonBaseSplitter_1_1, initWithComGoogleCommonBaseSplitter_1_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_, outer$, param0, param1)
}
...
- (ComGoogleCommonBaseSplitter_SplittingIterator *)iteratorWithComGoogleCommonBaseSplitter:(ComGoogleCommonBaseSplitter *)splitter
                                                                  withJavaLangCharSequence:(id<JavaLangCharSequence>)toSplit {
  return create_ComGoogleCommonBaseSplitter_2_1_initWithComGoogleCommonBaseSplitter_2_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(self, splitter, toSplit);
}

- (void)dealloc {
  RELEASE_(val$separator_);
  [super dealloc];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonBaseSplitter_2 = { "", "com.google.common.base", ptrTable, methods, fields, 7, 0x8008, 2, 1, 2, -1, 3, -1, -1 };
...
void ComGoogleCommonBaseSplitter_2_initWithNSString_(ComGoogleCommonBaseSplitter_2 *self, NSString *capture$0) {
  JreStrongAssign(&self->val$separator_, capture$0);
  NSObject_init(self);
}
...
- (instancetype)initWithComGoogleCommonBaseSplitter_2:(ComGoogleCommonBaseSplitter_2 *)outer$
                      withComGoogleCommonBaseSplitter:(ComGoogleCommonBaseSplitter *)param0
                             withJavaLangCharSequence:(id<JavaLangCharSequence>)param1 {
  ComGoogleCommonBaseSplitter_2_1_initWithComGoogleCommonBaseSplitter_2_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(self, outer$, param0, param1);
  return self;
}

- (jint)separatorStartWithInt:(jint)start {
  jint separatorLength = ((jint) [((NSString *) nil_chk(this$0_->val$separator_)) length]);
  for (jint p = start, last = [((id<JavaLangCharSequence>) nil_chk(toSplit_)) length] - separatorLength; p <= last; p++) {
    {
...
- (jint)separatorEndWithInt:(jint)separatorPosition {
  return separatorPosition + ((jint) [((NSString *) nil_chk(this$0_->val$separator_)) length]);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonBaseSplitter_2_1 = { "", "com.google.common.base", ptrTable, methods, fields, 7, 0x8008, 3, 1, 4, -1, 5, -1, -1 };
  return &_ComGoogleCommonBaseSplitter_2_1;
}

@end

void ComGoogleCommonBaseSplitter_2_1_initWithComGoogleCommonBaseSplitter_2_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(ComGoogleCommonBaseSplitter_2_1 *self, ComGoogleCommonBaseSplitter_2 *outer$, ComGoogleCommonBaseSplitter *param0, id<JavaLangCharSequence> param1) {
  JreStrongAssign(&self->this$0_, outer$);
  ComGoogleCommonBaseSplitter_SplittingIterator_initWithComGoogleCommonBaseSplitter_withJavaLangCharSequence_(self, param0, param1);
}

ComGoogleCommonBaseSplitter_2_1 *new_ComGoogleCommonBaseSplitter_2_1_initWithComGoogleCommonBaseSplitter_2_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(ComGoogleCommonBaseSplitter_2 *outer$, ComGoogleCommonBaseSplitter *param0, id<JavaLangCharSequence> param1) {
  J2OBJC_NEW_IMPL(ComGoogleCommonBaseSplitter_2_1, initWithComGoogleCommonBaseSplitter_2_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_, outer$, param0, param1)
}

ComGoogleCommonBaseSplitter_2_1 *create_ComGoogleCommonBaseSplitter_2_1_initWithComGoogleCommonBaseSplitter_2_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(ComGoogleCommonBaseSplitter_2 *outer$, ComGoogleCommonBaseSplitter *param0, id<JavaLangCharSequence> param1) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonBaseSplitter_2_1, initWithComGoogleCommonBaseSplitter_2_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_, outer$, param0, param1)
}
...
- (ComGoogleCommonBaseSplitter_SplittingIterator *)iteratorWithComGoogleCommonBaseSplitter:(ComGoogleCommonBaseSplitter *)splitter
  ...
  return create_ComGoogleCommonBaseSplitter_3_1_initWithComGoogleCommonBaseCommonMatcher_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(matcher, splitter, toSplit);
}

- (void)dealloc {
  RELEASE_(val$separatorPattern_);
  [super dealloc];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonBaseSplitter_3 = { "", "com.google.common.base", ptrTable, methods, fields, 7, 0x8008, 2, 1, 2, -1, 3, -1, -1 };
...
void ComGoogleCommonBaseSplitter_3_initWithComGoogleCommonBaseCommonPattern_(ComGoogleCommonBaseSplitter_3 *self, ComGoogleCommonBaseCommonPattern *capture$0) {
  JreStrongAssign(&self->val$separatorPattern_, capture$0);
  NSObject_init(self);
}
...
- (instancetype)initWithComGoogleCommonBaseCommonMatcher:(ComGoogleCommonBaseCommonMatcher *)capture$0
                         withComGoogleCommonBaseSplitter:(ComGoogleCommonBaseSplitter *)param0
                                withJavaLangCharSequence:(id<JavaLangCharSequence>)param1 {
  ComGoogleCommonBaseSplitter_3_1_initWithComGoogleCommonBaseCommonMatcher_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(self, capture$0, param0, param1);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonBaseSplitter_3_1 = { "", "com.google.common.base", ptrTable, methods, fields, 7, 0x8008, 3, 1, 4, -1, 5, -1, -1 };
  return &_ComGoogleCommonBaseSplitter_3_1;
}

@end

void ComGoogleCommonBaseSplitter_3_1_initWithComGoogleCommonBaseCommonMatcher_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(ComGoogleCommonBaseSplitter_3_1 *self, ComGoogleCommonBaseCommonMatcher *capture$0, ComGoogleCommonBaseSplitter *param0, id<JavaLangCharSequence> param1) {
  JreStrongAssign(&self->val$matcher_, capture$0);
  ComGoogleCommonBaseSplitter_SplittingIterator_initWithComGoogleCommonBaseSplitter_withJavaLangCharSequence_(self, param0, param1);
}

ComGoogleCommonBaseSplitter_3_1 *new_ComGoogleCommonBaseSplitter_3_1_initWithComGoogleCommonBaseCommonMatcher_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(ComGoogleCommonBaseCommonMatcher *capture$0, ComGoogleCommonBaseSplitter *param0, id<JavaLangCharSequence> param1) {
  J2OBJC_NEW_IMPL(ComGoogleCommonBaseSplitter_3_1, initWithComGoogleCommonBaseCommonMatcher_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_, capture$0, param0, param1)
}

ComGoogleCommonBaseSplitter_3_1 *create_ComGoogleCommonBaseSplitter_3_1_initWithComGoogleCommonBaseCommonMatcher_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(ComGoogleCommonBaseCommonMatcher *capture$0, ComGoogleCommonBaseSplitter *param0, id<JavaLangCharSequence> param1) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonBaseSplitter_3_1, initWithComGoogleCommonBaseCommonMatcher_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_, capture$0, param0, param1)
}
...
- (ComGoogleCommonBaseSplitter_SplittingIterator *)iteratorWithComGoogleCommonBaseSplitter:(ComGoogleCommonBaseSplitter *)splitter
                                                                  withJavaLangCharSequence:(id<JavaLangCharSequence>)toSplit {
  return create_ComGoogleCommonBaseSplitter_4_1_initWithComGoogleCommonBaseSplitter_4_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(self, splitter, toSplit);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonBaseSplitter_4 = { "", "com.google.common.base", ptrTable, methods, fields, 7, 0x8008, 2, 1, 2, -1, 3, -1, -1 };
...
- (instancetype)initWithComGoogleCommonBaseSplitter_4:(ComGoogleCommonBaseSplitter_4 *)outer$
                      withComGoogleCommonBaseSplitter:(ComGoogleCommonBaseSplitter *)param0
                             withJavaLangCharSequence:(id<JavaLangCharSequence>)param1 {
  ComGoogleCommonBaseSplitter_4_1_initWithComGoogleCommonBaseSplitter_4_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(self, outer$, param0, param1);
  return self;
}

- (jint)separatorStartWithInt:(jint)start {
  jint nextChunkStart = start + this$0_->val$length_;
  return (nextChunkStart < [((id<JavaLangCharSequence>) nil_chk(toSplit_)) length] ? nextChunkStart : -1);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonBaseSplitter_4_1 = { "", "com.google.common.base", ptrTable, methods, fields, 7, 0x8008, 3, 1, 4, -1, 5, -1, -1 };
  return &_ComGoogleCommonBaseSplitter_4_1;
}

@end

void ComGoogleCommonBaseSplitter_4_1_initWithComGoogleCommonBaseSplitter_4_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(ComGoogleCommonBaseSplitter_4_1 *self, ComGoogleCommonBaseSplitter_4 *outer$, ComGoogleCommonBaseSplitter *param0, id<JavaLangCharSequence> param1) {
  JreStrongAssign(&self->this$0_, outer$);
  ComGoogleCommonBaseSplitter_SplittingIterator_initWithComGoogleCommonBaseSplitter_withJavaLangCharSequence_(self, param0, param1);
}

ComGoogleCommonBaseSplitter_4_1 *new_ComGoogleCommonBaseSplitter_4_1_initWithComGoogleCommonBaseSplitter_4_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(ComGoogleCommonBaseSplitter_4 *outer$, ComGoogleCommonBaseSplitter *param0, id<JavaLangCharSequence> param1) {
  J2OBJC_NEW_IMPL(ComGoogleCommonBaseSplitter_4_1, initWithComGoogleCommonBaseSplitter_4_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_, outer$, param0, param1)
}

ComGoogleCommonBaseSplitter_4_1 *create_ComGoogleCommonBaseSplitter_4_1_initWithComGoogleCommonBaseSplitter_4_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_(ComGoogleCommonBaseSplitter_4 *outer$, ComGoogleCommonBaseSplitter *param0, id<JavaLangCharSequence> param1) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonBaseSplitter_4_1, initWithComGoogleCommonBaseSplitter_4_withComGoogleCommonBaseSplitter_withJavaLangCharSequence_, outer$, param0, param1)
}
...
- (NSString *)description {
  return [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((ComGoogleCommonBaseJoiner *) nil_chk(ComGoogleCommonBaseJoiner_onWithNSString_(@", "))) appendToWithJavaLangStringBuilder:[create_JavaLangStringBuilder_init() appendWithChar:'['] withJavaLangIterable:self])) appendWithChar:']'])) description];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonBaseSplitter_5 = { "", "com.google.common.base", ptrTable, methods, fields, 7, 0x8008, 3, 2, 2, -1, 3, 4, -1 };
...
void ComGoogleCommonBaseSplitter_5_initWithComGoogleCommonBaseSplitter_withJavaLangCharSequence_(ComGoogleCommonBaseSplitter_5 *self, ComGoogleCommonBaseSplitter *outer$, id<JavaLangCharSequence> capture$0) {
  JreStrongAssign(&self->this$0_, outer$);
  JreStrongAssign(&self->val$sequence_, capture$0);
  NSObject_init(self);
}
...
- (void)dealloc {
  RELEASE_(outerSplitter_);
  RELEASE_(entrySplitter_);
  [super dealloc];
}
...
void ComGoogleCommonBaseSplitter_MapSplitter_initWithComGoogleCommonBaseSplitter_withComGoogleCommonBaseSplitter_(ComGoogleCommonBaseSplitter_MapSplitter *self, ComGoogleCommonBaseSplitter *outerSplitter, ComGoogleCommonBaseSplitter *entrySplitter) {
  NSObject_init(self);
  JreStrongAssign(&self->outerSplitter_, outerSplitter);
  JreStrongAssign(&self->entrySplitter_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(entrySplitter));
}
