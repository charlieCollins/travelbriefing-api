...
//  source: ../target/dependency/io/reactivex/processors/SerializedProcessor.java
//
...
#include "io/reactivex/processors/SerializedProcessor.h"
...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  @synchronized(self) {
    if (JreLoadVolatileBoolean(&done_)) {
      ...
      if (emitting_) {
        ...
        [q setFirstWithId:IoReactivexInternalUtilNotificationLite_errorWithNSException_(t)];
        return;
      }
      reportError = false;
      emitting_ = true;
  ...
  [((IoReactivexProcessorsFlowableProcessor *) nil_chk(actual_)) onErrorWithNSException:t];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexProcessorsFlowableProcessor;", "(Lio/reactivex/processors/FlowableProcessor<TT;>;)V", "subscribeActual", "LOrgReactivestreamsSubscriber;", "(Lorg/reactivestreams/Subscriber<-TT;>;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lio/reactivex/processors/FlowableProcessor<TT;>;", "Lio/reactivex/internal/util/AppendOnlyLinkedArrayList<Ljava/lang/Object;>;", "<T:Ljava/lang/Object;>Lio/reactivex/processors/FlowableProcessor<TT;>;" };
