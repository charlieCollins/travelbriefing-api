...
#include "io/reactivex/processors/BehaviorProcessor.h"
...
- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  ...
  if ([self addWithIoReactivexProcessorsBehaviorProcessor_BehaviorSubscription:bs]) {
    ...
    if (IoReactivexInternalUtilNotificationLite_isCompleteWithId_(o)) {
      ...
      [s onErrorWithNSException:IoReactivexInternalUtilNotificationLite_getErrorWithId_(o)];
    }
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "[LIoReactivexProcessorsBehaviorProcessor_BehaviorSubscription;", 0x0, 24, 3, -1, 25, -1, -1 },
  ...
  methods[18].selector = @selector(addWithIoReactivexProcessorsBehaviorProcessor_BehaviorSubscription:);
  methods[19].selector = @selector(removeWithIoReactivexProcessorsBehaviorProcessor_BehaviorSubscription:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "EMPTY_ARRAY", "[LNSObject;", .constantValue.asLong = 0, 0x18, -1, 28, -1, -1 },
    { "EMPTY", "[LIoReactivexProcessorsBehaviorProcessor_BehaviorSubscription;", .constantValue.asLong = 0, 0x18, -1, 29, -1, -1 },
    { "TERMINATED", "[LIoReactivexProcessorsBehaviorProcessor_BehaviorSubscription;", .constantValue.asLong = 0, 0x18, -1, 30, -1, -1 },
...
- (void)emitFirst {
  ...
  @synchronized(self) {
    ...
    index_ = s->index_;
    o = [((JavaUtilConcurrentAtomicAtomicReference *) nil_chk(s->value_)) get];
    [readLock unlock];
    emitting_ = (o != nil);
    next_ = true;
  }
...
- (jboolean)testWithId:(id)o {
  ...
  if (IoReactivexInternalUtilNotificationLite_isCompleteWithId_(o)) {
    ...
    [((id<OrgReactivestreamsSubscriber>) nil_chk(actual_)) onErrorWithNSException:IoReactivexInternalUtilNotificationLite_getErrorWithId_(o)];
    return true;
  }
  jlong r = [self get];
  if (r != 0LL) {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _IoReactivexProcessorsBehaviorProcessor_BehaviorSubscription = { "BehaviorSubscription", "io.reactivex.processors", ptrTable, methods, fields, 7, 0x18, 7, 9, 11, -1, -1, 12, -1 };
