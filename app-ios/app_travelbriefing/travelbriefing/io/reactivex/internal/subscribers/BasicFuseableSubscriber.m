...
//  source: ../target/dependency/io/reactivex/internal/subscribers/BasicFuseableSubscriber.java
//
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;", "(Lorg/reactivestreams/Subscriber<-TR;>;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onError", "LNSException;", "fail", "transitiveBoundaryFusion", "I", "request", "J", "offer", "LNSObject;", "(TR;)Z", "LNSObject;LNSObject;", "(TR;TR;)Z", "Lorg/reactivestreams/Subscriber<-TR;>;", "Lio/reactivex/internal/fuseable/QueueSubscription<TT;>;", "<T:Ljava/lang/Object;R:Ljava/lang/Object;>Ljava/lang/Object;Lorg/reactivestreams/Subscriber<TT;>;Lio/reactivex/internal/fuseable/QueueSubscription<TR;>;" };
