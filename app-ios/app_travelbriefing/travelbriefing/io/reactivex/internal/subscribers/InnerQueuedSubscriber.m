...
- (void)onErrorWithNSException:(NSException *)t {
  [((id<IoReactivexInternalSubscribersInnerQueuedSubscriberSupport>) nil_chk(parent_)) innerErrorWithIoReactivexInternalSubscribersInnerQueuedSubscriber:self withNSException:t];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexInternalSubscribersInnerQueuedSubscriberSupport;I", "(Lio/reactivex/internal/subscribers/InnerQueuedSubscriberSupport<TT;>;I)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "request", "J", "()Lio/reactivex/internal/fuseable/SimpleQueue<TT;>;", "Lio/reactivex/internal/subscribers/InnerQueuedSubscriberSupport<TT;>;", "Lio/reactivex/internal/fuseable/SimpleQueue<TT;>;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicReference<Lorg/reactivestreams/Subscription;>;Lorg/reactivestreams/Subscriber<TT;>;Lorg/reactivestreams/Subscription;" };
