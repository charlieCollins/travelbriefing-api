...
@interface IoReactivexInternalSubscribersFutureSubscriber : JavaUtilConcurrentCountDownLatch < OrgReactivestreamsSubscriber, JavaUtilConcurrentFuture, OrgReactivestreamsSubscription > {
 @public
  id value_;
  NSException *error_;
...
J2OBJC_FIELD_SETTER(IoReactivexInternalSubscribersFutureSubscriber, error_, NSException *)
