...
//  source: ../target/dependency/io/reactivex/internal/operators/parallel/ParallelRunOn.java
//
...
__attribute__((unused)) static void IoReactivexInternalOperatorsParallelParallelRunOn_BaseRunOnSubscriber_onErrorWithNSException_(IoReactivexInternalOperatorsParallelParallelRunOn_BaseRunOnSubscriber *self, NSException *t);
...
- (void)onNextWithId:(id)t {
  ...
  if (![((IoReactivexInternalQueueSpscArrayQueue *) nil_chk(queue_)) offerWithId:t]) {
    ...
    IoReactivexInternalOperatorsParallelParallelRunOn_BaseRunOnSubscriber_onErrorWithNSException_(self, create_IoReactivexExceptionsMissingBackpressureException_initWithNSString_(@"Queue is full?!"));
    return;
  }
...
- (void)onErrorWithNSException:(NSException *)t {
  IoReactivexInternalOperatorsParallelParallelRunOn_BaseRunOnSubscriber_onErrorWithNSException_(self, t);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "ILIoReactivexInternalQueueSpscArrayQueue;LIoReactivexScheduler_Worker;", "(ILio/reactivex/internal/queue/SpscArrayQueue<TT;>;Lio/reactivex/Scheduler$Worker;)V", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "request", "J", "Lio/reactivex/internal/queue/SpscArrayQueue<TT;>;", "LIoReactivexInternalOperatorsParallelParallelRunOn;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicInteger;Lorg/reactivestreams/Subscriber<TT;>;Lorg/reactivestreams/Subscription;Ljava/lang/Runnable;" };
...
void IoReactivexInternalOperatorsParallelParallelRunOn_BaseRunOnSubscriber_onErrorWithNSException_(IoReactivexInternalOperatorsParallelParallelRunOn_BaseRunOnSubscriber *self, NSException *t) {
