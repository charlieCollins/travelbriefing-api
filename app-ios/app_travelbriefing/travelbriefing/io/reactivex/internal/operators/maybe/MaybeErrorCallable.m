...
//  source: ../target/dependency/io/reactivex/internal/operators/maybe/MaybeErrorCallable.java
//
...
- (void)subscribeActualWithIoReactivexMaybeObserver:(id<IoReactivexMaybeObserver>)observer {
  ...
  @catch (NSException *ex1) {
    IoReactivexExceptionsExceptions_throwIfFatalWithNSException_(ex1);
    ex = ex1;
  }
