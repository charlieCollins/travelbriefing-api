...
//  source: ../target/dependency/io/reactivex/internal/operators/maybe/MaybeUsing.java
//
  ...
  @catch (NSException *ex) {
    ...
    if (eager_) {
      ...
      @catch (NSException *exc) {
        ...
        IoReactivexInternalDisposablesEmptyDisposable_errorWithNSException_withIoReactivexMaybeObserver_(create_IoReactivexExceptionsCompositeException_initWithNSExceptionArray_([IOSObjectArray arrayWithObjects:(id[]){ ex, exc } count:2 type:NSException_class_()]), observer);
        return;
      }
    }
    IoReactivexInternalDisposablesEmptyDisposable_errorWithNSException_withIoReactivexMaybeObserver_(ex, observer);
