...
//  source: ../target/dependency/io/reactivex/internal/operators/maybe/MaybeToSingle.java
//
...
- (void)onComplete {
  ...
  if (defaultValue_ != nil) {
    ...
    [((id<IoReactivexSingleObserver>) nil_chk(actual_)) onErrorWithNSException:create_JavaUtilNoSuchElementException_initWithNSString_(@"The MaybeSource is empty")];
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexSingleObserver;LNSObject;", "(Lio/reactivex/SingleObserver<-TT;>;TT;)V", "onSubscribe", "LIoReactivexDisposablesDisposable;", "onSuccess", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lio/reactivex/SingleObserver<-TT;>;", "TT;", "LIoReactivexInternalOperatorsMaybeMaybeToSingle;", "<T:Ljava/lang/Object;>Ljava/lang/Object;Lio/reactivex/MaybeObserver<TT;>;Lio/reactivex/disposables/Disposable;" };
