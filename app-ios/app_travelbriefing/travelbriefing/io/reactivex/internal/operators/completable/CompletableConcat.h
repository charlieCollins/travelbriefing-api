...
@interface IoReactivexInternalOperatorsCompletableCompletableConcat_CompletableConcatSubscriber : JavaUtilConcurrentAtomicAtomicInteger < OrgReactivestreamsSubscriber, IoReactivexDisposablesDisposable > {
 @public
...
J2OBJC_FIELD_SETTER(IoReactivexInternalOperatorsCompletableCompletableConcat_CompletableConcatSubscriber, s_, id<OrgReactivestreamsSubscription>)
