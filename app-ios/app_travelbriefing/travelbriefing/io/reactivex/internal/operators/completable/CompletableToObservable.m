...
//  source: ../target/dependency/io/reactivex/internal/operators/completable/CompletableToObservable.java
//
...
- (void)onErrorWithNSException:(NSException *)e {
  [((id<IoReactivexObserver>) nil_chk(observer_)) onErrorWithNSException:e];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexObserver;", "(Lio/reactivex/Observer<*>;)V", "onError", "LNSException;", "onSubscribe", "LIoReactivexDisposablesDisposable;", "Lio/reactivex/Observer<*>;", "LIoReactivexInternalOperatorsCompletableCompletableToObservable;" };
