...
//  source: ../target/dependency/io/reactivex/internal/operators/completable/CompletableHide.java
//
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexCompletableObserver;", "onSubscribe", "LIoReactivexDisposablesDisposable;", "onError", "LNSException;", "LIoReactivexInternalOperatorsCompletableCompletableHide;" };
