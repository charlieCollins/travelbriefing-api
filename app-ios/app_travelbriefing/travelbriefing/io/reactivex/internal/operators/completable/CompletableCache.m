...
//  source: ../target/dependency/io/reactivex/internal/operators/completable/CompletableCache.java
//
  ...
  JreStrongAssign(&error_, e);
  {
    ...
    while (b__ < e__) {
      ...
      if (![((IoReactivexInternalOperatorsCompletableCompletableCache_InnerCompletableCache *) nil_chk(inner)) get]) {
        [((id<IoReactivexCompletableObserver>) nil_chk(inner->actual_)) onErrorWithNSException:e];
      }
    }
  }
}
