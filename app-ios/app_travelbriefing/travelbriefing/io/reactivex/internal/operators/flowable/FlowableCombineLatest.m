...
@interface IoReactivexInternalOperatorsFlowableFlowableCombineLatest_1 : NSObject < IoReactivexFunctionsFunction > {
 @public
...
J2OBJC_EMPTY_STATIC_INIT(IoReactivexInternalOperatorsFlowableFlowableCombineLatest_1)

__attribute__((unused)) static void IoReactivexInternalOperatorsFlowableFlowableCombineLatest_1_initWithIoReactivexInternalOperatorsFlowableFlowableCombineLatest_(IoReactivexInternalOperatorsFlowableFlowableCombineLatest_1 *self, IoReactivexInternalOperatorsFlowableFlowableCombineLatest *outer$);

__attribute__((unused)) static IoReactivexInternalOperatorsFlowableFlowableCombineLatest_1 *new_IoReactivexInternalOperatorsFlowableFlowableCombineLatest_1_initWithIoReactivexInternalOperatorsFlowableFlowableCombineLatest_(IoReactivexInternalOperatorsFlowableFlowableCombineLatest *outer$) NS_RETURNS_RETAINED;

__attribute__((unused)) static IoReactivexInternalOperatorsFlowableFlowableCombineLatest_1 *create_IoReactivexInternalOperatorsFlowableFlowableCombineLatest_1_initWithIoReactivexInternalOperatorsFlowableFlowableCombineLatest_(IoReactivexInternalOperatorsFlowableFlowableCombineLatest *outer$);
...
- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  ...
  if (n == 1) {
    [create_IoReactivexInternalOperatorsFlowableFlowableMap_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_(IOSObjectArray_Get(a, 0), create_IoReactivexInternalOperatorsFlowableFlowableCombineLatest_1_initWithIoReactivexInternalOperatorsFlowableFlowableCombineLatest_(self)) subscribeWithOrgReactivestreamsSubscriber:s];
    return;
  }
...
@implementation IoReactivexInternalOperatorsFlowableFlowableCombineLatest_1

- (instancetype)initWithIoReactivexInternalOperatorsFlowableFlowableCombineLatest:(IoReactivexInternalOperatorsFlowableFlowableCombineLatest *)outer$ {
  IoReactivexInternalOperatorsFlowableFlowableCombineLatest_1_initWithIoReactivexInternalOperatorsFlowableFlowableCombineLatest_(self, outer$);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "apply", "LNSObject;", "LJavaLangException;", "(TT;)TR;", "Lio/reactivex/internal/operators/flowable/FlowableCombineLatest<TT;TR;>;", "LIoReactivexInternalOperatorsFlowableFlowableCombineLatest;", "subscribeActualWithOrgReactivestreamsSubscriber:", "Ljava/lang/Object;Lio/reactivex/functions/Function<TT;TR;>;" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsFlowableFlowableCombineLatest_1 = { "", "io.reactivex.internal.operators.flowable", ptrTable, methods, fields, 7, 0x8018, 2, 1, 5, -1, 6, 7, -1 };
  return &_IoReactivexInternalOperatorsFlowableFlowableCombineLatest_1;
}

@end

void IoReactivexInternalOperatorsFlowableFlowableCombineLatest_1_initWithIoReactivexInternalOperatorsFlowableFlowableCombineLatest_(IoReactivexInternalOperatorsFlowableFlowableCombineLatest_1 *self, IoReactivexInternalOperatorsFlowableFlowableCombineLatest *outer$) {
  JreStrongAssign(&self->this$0_, outer$);
  NSObject_init(self);
}

IoReactivexInternalOperatorsFlowableFlowableCombineLatest_1 *new_IoReactivexInternalOperatorsFlowableFlowableCombineLatest_1_initWithIoReactivexInternalOperatorsFlowableFlowableCombineLatest_(IoReactivexInternalOperatorsFlowableFlowableCombineLatest *outer$) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableCombineLatest_1, initWithIoReactivexInternalOperatorsFlowableFlowableCombineLatest_, outer$)
}

IoReactivexInternalOperatorsFlowableFlowableCombineLatest_1 *create_IoReactivexInternalOperatorsFlowableFlowableCombineLatest_1_initWithIoReactivexInternalOperatorsFlowableFlowableCombineLatest_(IoReactivexInternalOperatorsFlowableFlowableCombineLatest *outer$) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableCombineLatest_1, initWithIoReactivexInternalOperatorsFlowableFlowableCombineLatest_, outer$)
}
...
- (void)innerErrorWithInt:(jint)index
  ...
  if (IoReactivexInternalUtilExceptionHelper_addThrowableWithJavaUtilConcurrentAtomicAtomicReference_withNSException_(error_, e)) {
    if (!delayErrors_) {
      [self cancelAll];
      JreAssignVolatileBoolean(&done_, true);
      [self drain];
...
withIoReactivexInternalQueueSpscLinkedArrayQueue:(IoReactivexInternalQueueSpscLinkedArrayQueue *)q {
  ...
  if (d) {
    if (delayErrors_) {
      if (empty) {
        [self cancelAll];
        NSException *e = IoReactivexInternalUtilExceptionHelper_terminateWithJavaUtilConcurrentAtomicAtomicReference_(error_);
...
- (id)poll {
  ...
  id r = [((id<IoReactivexFunctionsFunction>) nil_chk(combiner_)) applyWithId:a];
...
- (void)onErrorWithNSException:(NSException *)t {
  [((IoReactivexInternalOperatorsFlowableFlowableCombineLatest_CombineLatestCoordinator *) nil_chk(parent_)) innerErrorWithInt:index_ withNSException:t];
}
