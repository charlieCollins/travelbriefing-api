...
#include "io/reactivex/internal/subscribers/InnerQueuedSubscriber.h"
...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableConcatMapEager_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_withInt_withIoReactivexInternalUtilErrorMode_(self, source, mapper, maxConcurrency, prefetch, errorMode);
  return self;
}
...
IoReactivexInternalOperatorsFlowableFlowableConcatMapEager *new_IoReactivexInternalOperatorsFlowableFlowableConcatMapEager_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_withInt_withIoReactivexInternalUtilErrorMode_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> mapper, jint maxConcurrency, jint prefetch, IoReactivexInternalUtilErrorMode *errorMode) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableConcatMapEager, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_withInt_withIoReactivexInternalUtilErrorMode_, source, mapper, maxConcurrency, prefetch, errorMode)
}
...
IoReactivexInternalOperatorsFlowableFlowableConcatMapEager *create_IoReactivexInternalOperatorsFlowableFlowableConcatMapEager_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_withInt_withIoReactivexInternalUtilErrorMode_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> mapper, jint maxConcurrency, jint prefetch, IoReactivexInternalUtilErrorMode *errorMode) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableConcatMapEager, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_withInt_withIoReactivexInternalUtilErrorMode_, source, mapper, maxConcurrency, prefetch, errorMode)
}
...
- (void)innerNextWithIoReactivexInternalSubscribersInnerQueuedSubscriber:(IoReactivexInternalSubscribersInnerQueuedSubscriber *)inner
  ...
  if ([((id<IoReactivexInternalFuseableSimpleQueue>) nil_chk([((IoReactivexInternalSubscribersInnerQueuedSubscriber *) nil_chk(inner)) queue])) offerWithId:value]) {
    ...
    [inner cancel];
    [self innerErrorWithIoReactivexInternalSubscribersInnerQueuedSubscriber:inner withNSException:create_IoReactivexExceptionsMissingBackpressureException_init()];
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[10].selector = @selector(innerErrorWithIoReactivexInternalSubscribersInnerQueuedSubscriber:withNSException:);
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LIoReactivexFunctionsFunction;IILIoReactivexInternalUtilErrorMode;", "(Lorg/reactivestreams/Subscriber<-TR;>;Lio/reactivex/functions/Function<-TT;+Lorg/reactivestreams/Publisher<+TR;>;>;IILio/reactivex/internal/util/ErrorMode;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "request", "J", "innerNext", "LIoReactivexInternalSubscribersInnerQueuedSubscriber;LNSObject;", "(Lio/reactivex/internal/subscribers/InnerQueuedSubscriber<TR;>;TR;)V", "innerError", "LIoReactivexInternalSubscribersInnerQueuedSubscriber;LNSException;", "(Lio/reactivex/internal/subscribers/InnerQueuedSubscriber<TR;>;Ljava/lang/Throwable;)V", "innerComplete", "LIoReactivexInternalSubscribersInnerQueuedSubscriber;", "(Lio/reactivex/internal/subscribers/InnerQueuedSubscriber<TR;>;)V", "Lorg/reactivestreams/Subscriber<-TR;>;", "Lio/reactivex/functions/Function<-TT;+Lorg/reactivestreams/Publisher<+TR;>;>;", "Lio/reactivex/internal/queue/SpscLinkedArrayQueue<Lio/reactivex/internal/subscribers/InnerQueuedSubscriber<TR;>;>;", "Lio/reactivex/internal/subscribers/InnerQueuedSubscriber<TR;>;", "LIoReactivexInternalOperatorsFlowableFlowableConcatMapEager;", "<T:Ljava/lang/Object;R:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicInteger;Lorg/reactivestreams/Subscriber<TT;>;Lorg/reactivestreams/Subscription;Lio/reactivex/internal/subscribers/InnerQueuedSubscriberSupport<TR;>;" };
