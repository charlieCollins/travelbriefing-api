...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableScan_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsBiFunction_(self, source, accumulator);
  return self;
}

- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableScan_ScanSubscriber_initWithOrgReactivestreamsSubscriber_withIoReactivexFunctionsBiFunction_(s, accumulator_)];
}
...
void IoReactivexInternalOperatorsFlowableFlowableScan_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsBiFunction_(IoReactivexInternalOperatorsFlowableFlowableScan *self, id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsBiFunction> accumulator) {
...
IoReactivexInternalOperatorsFlowableFlowableScan *new_IoReactivexInternalOperatorsFlowableFlowableScan_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsBiFunction_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsBiFunction> accumulator) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableScan, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsBiFunction_, source, accumulator)
}

IoReactivexInternalOperatorsFlowableFlowableScan *create_IoReactivexInternalOperatorsFlowableFlowableScan_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsBiFunction_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsBiFunction> accumulator) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableScan, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsBiFunction_, source, accumulator)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LIoReactivexFunctionsBiFunction;", "(Lorg/reactivestreams/Subscriber<-TT;>;Lio/reactivex/functions/BiFunction<TT;TT;TT;>;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "request", "J", "Lorg/reactivestreams/Subscriber<-TT;>;", "Lio/reactivex/functions/BiFunction<TT;TT;TT;>;", "TT;", "LIoReactivexInternalOperatorsFlowableFlowableScan;", "<T:Ljava/lang/Object;>Ljava/lang/Object;Lorg/reactivestreams/Subscriber<TT;>;Lorg/reactivestreams/Subscription;" };
