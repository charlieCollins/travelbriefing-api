...
//  source: ../target/dependency/io/reactivex/internal/operators/flowable/FlowableTimeout.java
//
...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableTimeout_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withOrgReactivestreamsPublisher_(self, source, firstTimeoutIndicator, itemTimeoutIndicator, other);
  return self;
}

- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  if (other_ == nil) {
    [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableTimeout_TimeoutSubscriber_initWithOrgReactivestreamsSubscriber_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_(create_IoReactivexSubscribersSerializedSubscriber_initWithOrgReactivestreamsSubscriber_(s), firstTimeoutIndicator_, itemTimeoutIndicator_)];
  }
  else {
    [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableTimeout_TimeoutOtherSubscriber_initWithOrgReactivestreamsSubscriber_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withOrgReactivestreamsPublisher_(s, firstTimeoutIndicator_, itemTimeoutIndicator_, other_)];
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithOrgReactivestreamsPublisher:withOrgReactivestreamsPublisher:withIoReactivexFunctionsFunction:withOrgReactivestreamsPublisher:);
...
void IoReactivexInternalOperatorsFlowableFlowableTimeout_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withOrgReactivestreamsPublisher_(IoReactivexInternalOperatorsFlowableFlowableTimeout *self, id<OrgReactivestreamsPublisher> source, id<OrgReactivestreamsPublisher> firstTimeoutIndicator, id<IoReactivexFunctionsFunction> itemTimeoutIndicator, id<OrgReactivestreamsPublisher> other) {
...
IoReactivexInternalOperatorsFlowableFlowableTimeout *new_IoReactivexInternalOperatorsFlowableFlowableTimeout_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withOrgReactivestreamsPublisher_(id<OrgReactivestreamsPublisher> source, id<OrgReactivestreamsPublisher> firstTimeoutIndicator, id<IoReactivexFunctionsFunction> itemTimeoutIndicator, id<OrgReactivestreamsPublisher> other) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableTimeout, initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withOrgReactivestreamsPublisher_, source, firstTimeoutIndicator, itemTimeoutIndicator, other)
}

IoReactivexInternalOperatorsFlowableFlowableTimeout *create_IoReactivexInternalOperatorsFlowableFlowableTimeout_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withOrgReactivestreamsPublisher_(id<OrgReactivestreamsPublisher> source, id<OrgReactivestreamsPublisher> firstTimeoutIndicator, id<IoReactivexFunctionsFunction> itemTimeoutIndicator, id<OrgReactivestreamsPublisher> other) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableTimeout, initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withOrgReactivestreamsPublisher_, source, firstTimeoutIndicator, itemTimeoutIndicator, other)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "timeout", "J", "onError", "LNSException;", "LIoReactivexInternalOperatorsFlowableFlowableTimeout;" };
...
- (void)timeoutWithLong:(jlong)idx {
  if (idx == JreLoadVolatileLong(&index_)) {
    [self cancel];
    [((id<OrgReactivestreamsSubscriber>) nil_chk(actual_)) onErrorWithNSException:create_JavaUtilConcurrentTimeoutException_init()];
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LOrgReactivestreamsPublisher;LIoReactivexFunctionsFunction;", "(Lorg/reactivestreams/Subscriber<-TT;>;Lorg/reactivestreams/Publisher<TU;>;Lio/reactivex/functions/Function<-TT;+Lorg/reactivestreams/Publisher<TV;>;>;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "request", "J", "timeout", "Lorg/reactivestreams/Subscriber<-TT;>;", "Lorg/reactivestreams/Publisher<TU;>;", "Lio/reactivex/functions/Function<-TT;+Lorg/reactivestreams/Publisher<TV;>;>;", "Ljava/util/concurrent/atomic/AtomicReference<Lio/reactivex/disposables/Disposable;>;", "LIoReactivexInternalOperatorsFlowableFlowableTimeout;", "<T:Ljava/lang/Object;U:Ljava/lang/Object;V:Ljava/lang/Object;>Ljava/lang/Object;Lorg/reactivestreams/Subscriber<TT;>;Lorg/reactivestreams/Subscription;Lio/reactivex/internal/operators/flowable/FlowableTimeout$OnTimeout;" };
...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  done_ = true;
  [((id<IoReactivexInternalOperatorsFlowableFlowableTimeout_OnTimeout>) nil_chk(parent_)) onErrorWithNSException:t];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexInternalOperatorsFlowableFlowableTimeout_OnTimeout;J", "onNext", "LNSObject;", "onError", "LNSException;", "LIoReactivexInternalOperatorsFlowableFlowableTimeout;", "<T:Ljava/lang/Object;U:Ljava/lang/Object;V:Ljava/lang/Object;>Lio/reactivex/subscribers/DisposableSubscriber<Ljava/lang/Object;>;" };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LOrgReactivestreamsPublisher;LIoReactivexFunctionsFunction;LOrgReactivestreamsPublisher;", "(Lorg/reactivestreams/Subscriber<-TT;>;Lorg/reactivestreams/Publisher<TU;>;Lio/reactivex/functions/Function<-TT;+Lorg/reactivestreams/Publisher<TV;>;>;Lorg/reactivestreams/Publisher<+TT;>;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "timeout", "J", "Lorg/reactivestreams/Subscriber<-TT;>;", "Lorg/reactivestreams/Publisher<TU;>;", "Lio/reactivex/functions/Function<-TT;+Lorg/reactivestreams/Publisher<TV;>;>;", "Lorg/reactivestreams/Publisher<+TT;>;", "Lio/reactivex/internal/subscriptions/FullArbiter<TT;>;", "Ljava/util/concurrent/atomic/AtomicReference<Lio/reactivex/disposables/Disposable;>;", "LIoReactivexInternalOperatorsFlowableFlowableTimeout;", "<T:Ljava/lang/Object;U:Ljava/lang/Object;V:Ljava/lang/Object;>Ljava/lang/Object;Lorg/reactivestreams/Subscriber<TT;>;Lio/reactivex/disposables/Disposable;Lio/reactivex/internal/operators/flowable/FlowableTimeout$OnTimeout;" };
