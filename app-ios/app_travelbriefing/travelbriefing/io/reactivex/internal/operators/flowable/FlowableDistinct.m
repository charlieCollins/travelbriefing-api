...
//  source: ../target/dependency/io/reactivex/internal/operators/flowable/FlowableDistinct.java
//
...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableDistinct_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withJavaUtilConcurrentCallable_(self, source, keySelector, collectionSupplier);
  return self;
}
...
- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)observer {
  ...
  @catch (NSException *ex) {
    ...
    IoReactivexInternalSubscriptionsEmptySubscription_errorWithNSException_withOrgReactivestreamsSubscriber_(ex, observer);
    return;
  }
  [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableDistinct_DistinctSubscriber_initWithOrgReactivestreamsSubscriber_withIoReactivexFunctionsFunction_withJavaUtilCollection_(observer, keySelector_, collection)];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithOrgReactivestreamsPublisher:withIoReactivexFunctionsFunction:withJavaUtilConcurrentCallable:);
...
void IoReactivexInternalOperatorsFlowableFlowableDistinct_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withJavaUtilConcurrentCallable_(IoReactivexInternalOperatorsFlowableFlowableDistinct *self, id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> keySelector, id<JavaUtilConcurrentCallable> collectionSupplier) {
...
IoReactivexInternalOperatorsFlowableFlowableDistinct *new_IoReactivexInternalOperatorsFlowableFlowableDistinct_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withJavaUtilConcurrentCallable_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> keySelector, id<JavaUtilConcurrentCallable> collectionSupplier) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableDistinct, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withJavaUtilConcurrentCallable_, source, keySelector, collectionSupplier)
}

IoReactivexInternalOperatorsFlowableFlowableDistinct *create_IoReactivexInternalOperatorsFlowableFlowableDistinct_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withJavaUtilConcurrentCallable_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> keySelector, id<JavaUtilConcurrentCallable> collectionSupplier) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableDistinct, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withJavaUtilConcurrentCallable_, source, keySelector, collectionSupplier)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LIoReactivexFunctionsFunction;LJavaUtilCollection;", "(Lorg/reactivestreams/Subscriber<-TT;>;Lio/reactivex/functions/Function<-TT;TK;>;Ljava/util/Collection<-TK;>;)V", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "requestFusion", "I", "LJavaLangException;", "()TT;", "Ljava/util/Collection<-TK;>;", "Lio/reactivex/functions/Function<-TT;TK;>;", "LIoReactivexInternalOperatorsFlowableFlowableDistinct;", "<T:Ljava/lang/Object;K:Ljava/lang/Object;>Lio/reactivex/internal/subscribers/BasicFuseableSubscriber<TT;TT;>;" };
