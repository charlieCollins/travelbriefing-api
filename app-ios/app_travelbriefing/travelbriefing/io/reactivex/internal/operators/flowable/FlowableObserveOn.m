...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableObserveOn_initWithOrgReactivestreamsPublisher_withIoReactivexScheduler_withBoolean_withInt_(self, source, scheduler, delayError, prefetch);
  return self;
}
...
- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  ...
  if ([IoReactivexInternalFuseableConditionalSubscriber_class_() isInstance:s]) {
    [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableObserveOn_ObserveOnConditionalSubscriber_initWithIoReactivexInternalFuseableConditionalSubscriber_withIoReactivexScheduler_Worker_withBoolean_withInt_((id<IoReactivexInternalFuseableConditionalSubscriber>) cast_check(s, IoReactivexInternalFuseableConditionalSubscriber_class_()), worker, delayError_, prefetch_)];
  }
  else {
    [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableObserveOn_ObserveOnSubscriber_initWithOrgReactivestreamsSubscriber_withIoReactivexScheduler_Worker_withBoolean_withInt_(s, worker, delayError_, prefetch_)];
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithOrgReactivestreamsPublisher:withIoReactivexScheduler:withBoolean:withInt:);
...
IoReactivexInternalOperatorsFlowableFlowableObserveOn *new_IoReactivexInternalOperatorsFlowableFlowableObserveOn_initWithOrgReactivestreamsPublisher_withIoReactivexScheduler_withBoolean_withInt_(id<OrgReactivestreamsPublisher> source, IoReactivexScheduler *scheduler, jboolean delayError, jint prefetch) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableObserveOn, initWithOrgReactivestreamsPublisher_withIoReactivexScheduler_withBoolean_withInt_, source, scheduler, delayError, prefetch)
}

IoReactivexInternalOperatorsFlowableFlowableObserveOn *create_IoReactivexInternalOperatorsFlowableFlowableObserveOn_initWithOrgReactivestreamsPublisher_withIoReactivexScheduler_withBoolean_withInt_(id<OrgReactivestreamsPublisher> source, IoReactivexScheduler *scheduler, jboolean delayError, jint prefetch) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableObserveOn, initWithOrgReactivestreamsPublisher_withIoReactivexScheduler_withBoolean_withInt_, source, scheduler, delayError, prefetch)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexScheduler_Worker;ZI", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "request", "J", "checkTerminated", "ZZLOrgReactivestreamsSubscriber;", "(ZZLorg/reactivestreams/Subscriber<*>;)Z", "requestFusion", "I", "Lio/reactivex/internal/fuseable/SimpleQueue<TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableObserveOn;", "<T:Ljava/lang/Object;>Lio/reactivex/internal/subscriptions/BasicIntQueueSubscription<TT;>;Ljava/lang/Runnable;Lorg/reactivestreams/Subscriber<TT;>;" };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LIoReactivexScheduler_Worker;ZI", "(Lorg/reactivestreams/Subscriber<-TT;>;Lio/reactivex/Scheduler$Worker;ZI)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "LJavaLangException;", "()TT;", "Lorg/reactivestreams/Subscriber<-TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableObserveOn;", "<T:Ljava/lang/Object;>Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber<TT;>;Lorg/reactivestreams/Subscriber<TT;>;" };
  ...
  for (; ; ) {
    ...
    while (e != r) {
      ...
      @catch (NSException *ex) {
        IoReactivexExceptionsExceptions_throwIfFatalWithNSException_(ex);
        [((id<OrgReactivestreamsSubscription>) nil_chk(s_)) cancel];
        [((id<IoReactivexInternalFuseableConditionalSubscriber>) nil_chk(a)) onErrorWithNSException:ex];
        [((IoReactivexScheduler_Worker *) nil_chk(worker_)) dispose];
        return;
      }
      if (JreLoadVolatileBoolean(&cancelled_)) {
