...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableRepeatWhen_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_(self, source, handler);
  return self;
}
...
void IoReactivexInternalOperatorsFlowableFlowableRepeatWhen_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_(IoReactivexInternalOperatorsFlowableFlowableRepeatWhen *self, id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> handler) {
...
IoReactivexInternalOperatorsFlowableFlowableRepeatWhen *new_IoReactivexInternalOperatorsFlowableFlowableRepeatWhen_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> handler) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableRepeatWhen, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_, source, handler)
}

IoReactivexInternalOperatorsFlowableFlowableRepeatWhen *create_IoReactivexInternalOperatorsFlowableFlowableRepeatWhen_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> handler) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableRepeatWhen, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_, source, handler)
}
...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  [((id<OrgReactivestreamsSubscriber>) nil_chk(((IoReactivexInternalOperatorsFlowableFlowableRepeatWhen_WhenSourceSubscriber *) nil_chk(subscriber_))->actual_WhenSourceSubscriber_)) onErrorWithNSException:t];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsPublisher;", "(Lorg/reactivestreams/Publisher<TT;>;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "onError", "LNSException;", "request", "J", "Lorg/reactivestreams/Publisher<TT;>;", "Ljava/util/concurrent/atomic/AtomicReference<Lorg/reactivestreams/Subscription;>;", "Lio/reactivex/internal/operators/flowable/FlowableRepeatWhen$WhenSourceSubscriber<TT;TU;>;", "LIoReactivexInternalOperatorsFlowableFlowableRepeatWhen;", "<T:Ljava/lang/Object;U:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicInteger;Lorg/reactivestreams/Subscriber<Ljava/lang/Object;>;Lorg/reactivestreams/Subscription;" };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LIoReactivexProcessorsFlowableProcessor;LOrgReactivestreamsSubscription;", "(Lorg/reactivestreams/Subscriber<-TT;>;Lio/reactivex/processors/FlowableProcessor<TU;>;Lorg/reactivestreams/Subscription;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "again", "(TU;)V", "actual", "Lorg/reactivestreams/Subscriber<-TT;>;", "Lio/reactivex/processors/FlowableProcessor<TU;>;", "LIoReactivexInternalOperatorsFlowableFlowableRepeatWhen;", "<T:Ljava/lang/Object;U:Ljava/lang/Object;>Lio/reactivex/internal/subscriptions/SubscriptionArbiter;Lorg/reactivestreams/Subscriber<TT;>;" };
...
- (void)onErrorWithNSException:(NSException *)t {
  [((id<OrgReactivestreamsSubscription>) nil_chk(receiver_)) cancel];
  [((id<OrgReactivestreamsSubscriber>) nil_chk(actual_WhenSourceSubscriber_)) onErrorWithNSException:t];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LIoReactivexProcessorsFlowableProcessor;LOrgReactivestreamsSubscription;", "(Lorg/reactivestreams/Subscriber<-TT;>;Lio/reactivex/processors/FlowableProcessor<Ljava/lang/Object;>;Lorg/reactivestreams/Subscription;)V", "onError", "LNSException;", "LIoReactivexInternalOperatorsFlowableFlowableRepeatWhen;", "<T:Ljava/lang/Object;>Lio/reactivex/internal/operators/flowable/FlowableRepeatWhen$WhenSourceSubscriber<TT;Ljava/lang/Object;>;" };
