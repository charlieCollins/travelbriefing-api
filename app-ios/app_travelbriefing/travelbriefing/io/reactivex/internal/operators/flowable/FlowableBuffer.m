...
//  source: ../target/dependency/io/reactivex/internal/operators/flowable/FlowableBuffer.java
//
...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableBuffer_initWithOrgReactivestreamsPublisher_withInt_withInt_withJavaUtilConcurrentCallable_(self, source, size, skip, bufferSupplier);
  return self;
}

- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  if (size_ == skip_) {
    [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableBuffer_PublisherBufferExactSubscriber_initWithOrgReactivestreamsSubscriber_withInt_withJavaUtilConcurrentCallable_(s, size_, bufferSupplier_)];
  }
  else if (skip_ > size_) {
    [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableBuffer_PublisherBufferSkipSubscriber_initWithOrgReactivestreamsSubscriber_withInt_withInt_withJavaUtilConcurrentCallable_(s, size_, skip_, bufferSupplier_)];
  }
  else {
    [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableBuffer_PublisherBufferOverlappingSubscriber_initWithOrgReactivestreamsSubscriber_withInt_withInt_withJavaUtilConcurrentCallable_(s, size_, skip_, bufferSupplier_)];
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithOrgReactivestreamsPublisher:withInt:withInt:withJavaUtilConcurrentCallable:);
...
void IoReactivexInternalOperatorsFlowableFlowableBuffer_initWithOrgReactivestreamsPublisher_withInt_withInt_withJavaUtilConcurrentCallable_(IoReactivexInternalOperatorsFlowableFlowableBuffer *self, id<OrgReactivestreamsPublisher> source, jint size, jint skip, id<JavaUtilConcurrentCallable> bufferSupplier) {
...
IoReactivexInternalOperatorsFlowableFlowableBuffer *new_IoReactivexInternalOperatorsFlowableFlowableBuffer_initWithOrgReactivestreamsPublisher_withInt_withInt_withJavaUtilConcurrentCallable_(id<OrgReactivestreamsPublisher> source, jint size, jint skip, id<JavaUtilConcurrentCallable> bufferSupplier) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableBuffer, initWithOrgReactivestreamsPublisher_withInt_withInt_withJavaUtilConcurrentCallable_, source, size, skip, bufferSupplier)
}

IoReactivexInternalOperatorsFlowableFlowableBuffer *create_IoReactivexInternalOperatorsFlowableFlowableBuffer_initWithOrgReactivestreamsPublisher_withInt_withInt_withJavaUtilConcurrentCallable_(id<OrgReactivestreamsPublisher> source, jint size, jint skip, id<JavaUtilConcurrentCallable> bufferSupplier) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableBuffer, initWithOrgReactivestreamsPublisher_withInt_withInt_withJavaUtilConcurrentCallable_, source, size, skip, bufferSupplier)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;ILJavaUtilConcurrentCallable;", "(Lorg/reactivestreams/Subscriber<-TC;>;ILjava/util/concurrent/Callable<TC;>;)V", "request", "J", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lorg/reactivestreams/Subscriber<-TC;>;", "Ljava/util/concurrent/Callable<TC;>;", "TC;", "LIoReactivexInternalOperatorsFlowableFlowableBuffer;", "<T:Ljava/lang/Object;C::Ljava/util/Collection<-TT;>;>Ljava/lang/Object;Lorg/reactivestreams/Subscriber<TT;>;Lorg/reactivestreams/Subscription;" };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;IILJavaUtilConcurrentCallable;", "(Lorg/reactivestreams/Subscriber<-TC;>;IILjava/util/concurrent/Callable<TC;>;)V", "request", "J", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lorg/reactivestreams/Subscriber<-TC;>;", "Ljava/util/concurrent/Callable<TC;>;", "TC;", "LIoReactivexInternalOperatorsFlowableFlowableBuffer;", "<T:Ljava/lang/Object;C::Ljava/util/Collection<-TT;>;>Ljava/util/concurrent/atomic/AtomicInteger;Lorg/reactivestreams/Subscriber<TT;>;Lorg/reactivestreams/Subscription;" };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;IILJavaUtilConcurrentCallable;", "(Lorg/reactivestreams/Subscriber<-TC;>;IILjava/util/concurrent/Callable<TC;>;)V", "request", "J", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lorg/reactivestreams/Subscriber<-TC;>;", "Ljava/util/concurrent/Callable<TC;>;", "Ljava/util/ArrayDeque<TC;>;", "LIoReactivexInternalOperatorsFlowableFlowableBuffer;", "<T:Ljava/lang/Object;C::Ljava/util/Collection<-TT;>;>Ljava/util/concurrent/atomic/AtomicLong;Lorg/reactivestreams/Subscriber<TT;>;Lorg/reactivestreams/Subscription;Lio/reactivex/functions/BooleanSupplier;" };
