...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableBlockingFlowableIterable_initWithOrgReactivestreamsPublisher_withInt_(self, source, bufferSize);
  return self;
}
...
- (id<JavaUtilIterator>)iterator {
  ...
  [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:it];
  return it;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsPublisher;I", "(Lorg/reactivestreams/Publisher<+TT;>;I)V", "()Ljava/util/Iterator<TT;>;", "Lorg/reactivestreams/Publisher<+TT;>;", "LIoReactivexInternalOperatorsFlowableBlockingFlowableIterable_BlockingFlowableIterator;", "<T:Ljava/lang/Object;>Ljava/lang/Object;Ljava/lang/Iterable<TT;>;" };
...
void IoReactivexInternalOperatorsFlowableBlockingFlowableIterable_initWithOrgReactivestreamsPublisher_withInt_(IoReactivexInternalOperatorsFlowableBlockingFlowableIterable *self, id<OrgReactivestreamsPublisher> source, jint bufferSize) {
  NSObject_init(self);
  JreStrongAssign(&self->source_, source);
  self->bufferSize_ = bufferSize;
}

IoReactivexInternalOperatorsFlowableBlockingFlowableIterable *new_IoReactivexInternalOperatorsFlowableBlockingFlowableIterable_initWithOrgReactivestreamsPublisher_withInt_(id<OrgReactivestreamsPublisher> source, jint bufferSize) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableBlockingFlowableIterable, initWithOrgReactivestreamsPublisher_withInt_, source, bufferSize)
}

IoReactivexInternalOperatorsFlowableBlockingFlowableIterable *create_IoReactivexInternalOperatorsFlowableBlockingFlowableIterable_initWithOrgReactivestreamsPublisher_withInt_(id<OrgReactivestreamsPublisher> source, jint bufferSize) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableBlockingFlowableIterable, initWithOrgReactivestreamsPublisher_withInt_, source, bufferSize)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "I", "()TT;", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lio/reactivex/internal/queue/SpscArrayQueue<TT;>;", "LIoReactivexInternalOperatorsFlowableBlockingFlowableIterable;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicReference<Lorg/reactivestreams/Subscription;>;Lorg/reactivestreams/Subscriber<TT;>;Ljava/util/Iterator<TT;>;Ljava/lang/Runnable;Lio/reactivex/disposables/Disposable;" };
