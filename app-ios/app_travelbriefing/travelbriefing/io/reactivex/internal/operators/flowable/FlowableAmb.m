  ...
  if (sources == nil) {
    ...
    @try {
      for (id<OrgReactivestreamsPublisher> __strong p in nil_chk(sourcesIterable_)) {
        if (p == nil) {
          IoReactivexInternalSubscriptionsEmptySubscription_errorWithNSException_withOrgReactivestreamsSubscriber_(create_JavaLangNullPointerException_initWithNSString_(@"One of the sources is null"), s);
          return;
        }
