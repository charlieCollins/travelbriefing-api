...
FOUNDATION_EXPORT void IoReactivexInternalOperatorsFlowableFlowableElementAt_initWithOrgReactivestreamsPublisher_withLong_withId_withBoolean_(IoReactivexInternalOperatorsFlowableFlowableElementAt *self, id<OrgReactivestreamsPublisher> source, jlong index, id defaultValue, jboolean errorOnFewer);

FOUNDATION_EXPORT IoReactivexInternalOperatorsFlowableFlowableElementAt *new_IoReactivexInternalOperatorsFlowableFlowableElementAt_initWithOrgReactivestreamsPublisher_withLong_withId_withBoolean_(id<OrgReactivestreamsPublisher> source, jlong index, id defaultValue, jboolean errorOnFewer) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT IoReactivexInternalOperatorsFlowableFlowableElementAt *create_IoReactivexInternalOperatorsFlowableFlowableElementAt_initWithOrgReactivestreamsPublisher_withLong_withId_withBoolean_(id<OrgReactivestreamsPublisher> source, jlong index, id defaultValue, jboolean errorOnFewer);
...
@interface IoReactivexInternalOperatorsFlowableFlowableElementAt_ElementAtSubscriber : IoReactivexInternalSubscriptionsDeferredScalarSubscription < OrgReactivestreamsSubscriber > {
 @public
  jlong index_;
  id defaultValue_;
  jboolean errorOnFewer_;
