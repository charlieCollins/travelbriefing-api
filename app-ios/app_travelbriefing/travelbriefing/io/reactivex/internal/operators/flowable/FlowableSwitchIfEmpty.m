...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableSwitchIfEmpty_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_(self, source, other);
  return self;
}
...
void IoReactivexInternalOperatorsFlowableFlowableSwitchIfEmpty_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_(IoReactivexInternalOperatorsFlowableFlowableSwitchIfEmpty *self, id<OrgReactivestreamsPublisher> source, id<OrgReactivestreamsPublisher> other) {
  IoReactivexInternalOperatorsFlowableAbstractFlowableWithUpstream_initWithOrgReactivestreamsPublisher_(self, source);
  JreStrongAssign(&self->other_, other);
}

IoReactivexInternalOperatorsFlowableFlowableSwitchIfEmpty *new_IoReactivexInternalOperatorsFlowableFlowableSwitchIfEmpty_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_(id<OrgReactivestreamsPublisher> source, id<OrgReactivestreamsPublisher> other) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableSwitchIfEmpty, initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_, source, other)
}

IoReactivexInternalOperatorsFlowableFlowableSwitchIfEmpty *create_IoReactivexInternalOperatorsFlowableFlowableSwitchIfEmpty_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_(id<OrgReactivestreamsPublisher> source, id<OrgReactivestreamsPublisher> other) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableSwitchIfEmpty, initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_, source, other)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LOrgReactivestreamsPublisher;", "(Lorg/reactivestreams/Subscriber<-TT;>;Lorg/reactivestreams/Publisher<+TT;>;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lorg/reactivestreams/Subscriber<-TT;>;", "Lorg/reactivestreams/Publisher<+TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableSwitchIfEmpty;", "<T:Ljava/lang/Object;>Ljava/lang/Object;Lorg/reactivestreams/Subscriber<TT;>;" };
