...
//  source: ../target/dependency/io/reactivex/internal/operators/flowable/FlowableSampleTimed.java
//
...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableSampleTimed_initWithOrgReactivestreamsPublisher_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_withBoolean_(self, source, period, unit, scheduler, emitLast);
  return self;
}
...
- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  ...
  if (emitLast_) {
    [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableSampleTimed_SampleTimedEmitLast_initWithOrgReactivestreamsSubscriber_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_(serial, period_, unit_, scheduler_)];
  }
  else {
    [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableSampleTimed_SampleTimedNoLast_initWithOrgReactivestreamsSubscriber_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_(serial, period_, unit_, scheduler_)];
  }
}
...
void IoReactivexInternalOperatorsFlowableFlowableSampleTimed_initWithOrgReactivestreamsPublisher_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_withBoolean_(IoReactivexInternalOperatorsFlowableFlowableSampleTimed *self, id<OrgReactivestreamsPublisher> source, jlong period, JavaUtilConcurrentTimeUnit *unit, IoReactivexScheduler *scheduler, jboolean emitLast) {
...
IoReactivexInternalOperatorsFlowableFlowableSampleTimed *new_IoReactivexInternalOperatorsFlowableFlowableSampleTimed_initWithOrgReactivestreamsPublisher_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_withBoolean_(id<OrgReactivestreamsPublisher> source, jlong period, JavaUtilConcurrentTimeUnit *unit, IoReactivexScheduler *scheduler, jboolean emitLast) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableSampleTimed, initWithOrgReactivestreamsPublisher_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_withBoolean_, source, period, unit, scheduler, emitLast)
}

IoReactivexInternalOperatorsFlowableFlowableSampleTimed *create_IoReactivexInternalOperatorsFlowableFlowableSampleTimed_initWithOrgReactivestreamsPublisher_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_withBoolean_(id<OrgReactivestreamsPublisher> source, jlong period, JavaUtilConcurrentTimeUnit *unit, IoReactivexScheduler *scheduler, jboolean emitLast) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableSampleTimed, initWithOrgReactivestreamsPublisher_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_withBoolean_, source, period, unit, scheduler, emitLast)
}
...
- (void)emit {
  ...
  if (value != nil) {
    ...
    if (r != 0LL) {
      ...
      [self cancel];
      [((id<OrgReactivestreamsSubscriber>) nil_chk(actual_)) onErrorWithNSException:create_IoReactivexExceptionsMissingBackpressureException_initWithNSString_(@"Couldn't emit value due to lack of requests!")];
    }
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;JLJavaUtilConcurrentTimeUnit;LIoReactivexScheduler;", "(Lorg/reactivestreams/Subscriber<-TT;>;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "request", "J", "Lorg/reactivestreams/Subscriber<-TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableSampleTimed;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicReference<TT;>;Lorg/reactivestreams/Subscriber<TT;>;Lorg/reactivestreams/Subscription;Ljava/lang/Runnable;" };
