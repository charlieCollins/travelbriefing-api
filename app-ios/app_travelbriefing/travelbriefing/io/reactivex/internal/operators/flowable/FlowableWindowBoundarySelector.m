...
//  source: ../target/dependency/io/reactivex/internal/operators/flowable/FlowableWindowBoundarySelector.java
//
...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySelector_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_(self, source, open, close, bufferSize);
  return self;
}

- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySelector_WindowBoundaryMainSubscriber_initWithOrgReactivestreamsSubscriber_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_(create_IoReactivexSubscribersSerializedSubscriber_initWithOrgReactivestreamsSubscriber_(s), open_, close_, bufferSize_)];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithOrgReactivestreamsPublisher:withOrgReactivestreamsPublisher:withIoReactivexFunctionsFunction:withInt:);
...
void IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySelector_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_(IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySelector *self, id<OrgReactivestreamsPublisher> source, id<OrgReactivestreamsPublisher> open, id<IoReactivexFunctionsFunction> close, jint bufferSize) {
...
IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySelector *new_IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySelector_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_(id<OrgReactivestreamsPublisher> source, id<OrgReactivestreamsPublisher> open, id<IoReactivexFunctionsFunction> close, jint bufferSize) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySelector, initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_, source, open, close, bufferSize)
}

IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySelector *create_IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySelector_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_(id<OrgReactivestreamsPublisher> source, id<OrgReactivestreamsPublisher> open, id<IoReactivexFunctionsFunction> close, jint bufferSize) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySelector, initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_, source, open, close, bufferSize)
}
    ...
    for (; ; ) {
      ...
      if ([o isKindOfClass:[IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySelector_WindowOperation class]]) {
        ...
        if (r != 0LL) {
          ...
          JreAssignVolatileBoolean(&cancelled_, true);
          [((id<OrgReactivestreamsSubscriber>) nil_chk(a)) onErrorWithNSException:create_IoReactivexExceptionsMissingBackpressureException_initWithNSString_(@"Could not deliver new window due to lack of requests")];
          continue;
        }
...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  done_ = true;
  [((IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySelector_WindowBoundaryMainSubscriber *) nil_chk(parent_)) errorWithNSException:t];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexInternalOperatorsFlowableFlowableWindowBoundarySelector_WindowBoundaryMainSubscriber;", "(Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySelector$WindowBoundaryMainSubscriber<TT;TB;*>;)V", "onNext", "LNSObject;", "(TB;)V", "onError", "LNSException;", "Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySelector$WindowBoundaryMainSubscriber<TT;TB;*>;", "LIoReactivexInternalOperatorsFlowableFlowableWindowBoundarySelector;", "<T:Ljava/lang/Object;B:Ljava/lang/Object;>Lio/reactivex/subscribers/DisposableSubscriber<TB;>;" };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexInternalOperatorsFlowableFlowableWindowBoundarySelector_WindowBoundaryMainSubscriber;LIoReactivexProcessorsUnicastProcessor;", "(Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySelector$WindowBoundaryMainSubscriber<TT;*TV;>;Lio/reactivex/processors/UnicastProcessor<TT;>;)V", "onNext", "LNSObject;", "(TV;)V", "onError", "LNSException;", "Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySelector$WindowBoundaryMainSubscriber<TT;*TV;>;", "Lio/reactivex/processors/UnicastProcessor<TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableWindowBoundarySelector;", "<T:Ljava/lang/Object;V:Ljava/lang/Object;>Lio/reactivex/subscribers/DisposableSubscriber<TV;>;" };
