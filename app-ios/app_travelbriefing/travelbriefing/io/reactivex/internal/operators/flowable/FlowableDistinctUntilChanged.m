...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableDistinctUntilChanged_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withIoReactivexFunctionsBiPredicate_(self, source, keySelector, comparer);
  return self;
}
...
- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  if ([IoReactivexInternalFuseableConditionalSubscriber_class_() isInstance:s]) {
    ...
    [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableDistinctUntilChanged_DistinctUntilChangedConditionalSubscriber_initWithIoReactivexInternalFuseableConditionalSubscriber_withIoReactivexFunctionsFunction_withIoReactivexFunctionsBiPredicate_(cs, keySelector_, comparer_)];
  }
  else {
    [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableDistinctUntilChanged_DistinctUntilChangedSubscriber_initWithOrgReactivestreamsSubscriber_withIoReactivexFunctionsFunction_withIoReactivexFunctionsBiPredicate_(s, keySelector_, comparer_)];
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithOrgReactivestreamsPublisher:withIoReactivexFunctionsFunction:withIoReactivexFunctionsBiPredicate:);
...
IoReactivexInternalOperatorsFlowableFlowableDistinctUntilChanged *new_IoReactivexInternalOperatorsFlowableFlowableDistinctUntilChanged_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withIoReactivexFunctionsBiPredicate_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> keySelector, id<IoReactivexFunctionsBiPredicate> comparer) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableDistinctUntilChanged, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withIoReactivexFunctionsBiPredicate_, source, keySelector, comparer)
}
...
IoReactivexInternalOperatorsFlowableFlowableDistinctUntilChanged *create_IoReactivexInternalOperatorsFlowableFlowableDistinctUntilChanged_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withIoReactivexFunctionsBiPredicate_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> keySelector, id<IoReactivexFunctionsBiPredicate> comparer) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableDistinctUntilChanged, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withIoReactivexFunctionsBiPredicate_, source, keySelector, comparer)
}
