...
FOUNDATION_EXPORT void IoReactivexInternalOperatorsFlowableFlowableBuffer_initWithOrgReactivestreamsPublisher_withInt_withInt_withJavaUtilConcurrentCallable_(IoReactivexInternalOperatorsFlowableFlowableBuffer *self, id<OrgReactivestreamsPublisher> source, jint size, jint skip, id<JavaUtilConcurrentCallable> bufferSupplier);

FOUNDATION_EXPORT IoReactivexInternalOperatorsFlowableFlowableBuffer *new_IoReactivexInternalOperatorsFlowableFlowableBuffer_initWithOrgReactivestreamsPublisher_withInt_withInt_withJavaUtilConcurrentCallable_(id<OrgReactivestreamsPublisher> source, jint size, jint skip, id<JavaUtilConcurrentCallable> bufferSupplier) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT IoReactivexInternalOperatorsFlowableFlowableBuffer *create_IoReactivexInternalOperatorsFlowableFlowableBuffer_initWithOrgReactivestreamsPublisher_withInt_withInt_withJavaUtilConcurrentCallable_(id<OrgReactivestreamsPublisher> source, jint size, jint skip, id<JavaUtilConcurrentCallable> bufferSupplier);
...
@interface IoReactivexInternalOperatorsFlowableFlowableBuffer_PublisherBufferExactSubscriber : NSObject < OrgReactivestreamsSubscriber, OrgReactivestreamsSubscription > {
 @public
...
@interface IoReactivexInternalOperatorsFlowableFlowableBuffer_PublisherBufferSkipSubscriber : JavaUtilConcurrentAtomicAtomicInteger < OrgReactivestreamsSubscriber, OrgReactivestreamsSubscription > {
 @public
  id<OrgReactivestreamsSubscriber> actual_;
  id<JavaUtilConcurrentCallable> bufferSupplier_;
  jint size_;
...
@interface IoReactivexInternalOperatorsFlowableFlowableBuffer_PublisherBufferOverlappingSubscriber : JavaUtilConcurrentAtomicAtomicLong < OrgReactivestreamsSubscriber, OrgReactivestreamsSubscription, IoReactivexFunctionsBooleanSupplier > {
 @public
  id<OrgReactivestreamsSubscriber> actual_;
  id<JavaUtilConcurrentCallable> bufferSupplier_;
  jint size_;
