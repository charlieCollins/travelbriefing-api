...
FOUNDATION_EXPORT IoReactivexInternalOperatorsFlowableFlowableOnErrorNext *new_IoReactivexInternalOperatorsFlowableFlowableOnErrorNext_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withBoolean_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> nextSupplier, jboolean allowFatal) NS_RETURNS_RETAINED;
...
@interface IoReactivexInternalOperatorsFlowableFlowableOnErrorNext_OnErrorNextSubscriber : NSObject < OrgReactivestreamsSubscriber > {
 @public
