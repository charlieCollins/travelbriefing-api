...
FOUNDATION_EXPORT IoReactivexInternalOperatorsFlowableFlowableSampleTimed *new_IoReactivexInternalOperatorsFlowableFlowableSampleTimed_initWithOrgReactivestreamsPublisher_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_withBoolean_(id<OrgReactivestreamsPublisher> source, jlong period, JavaUtilConcurrentTimeUnit *unit, IoReactivexScheduler *scheduler, jboolean emitLast) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT IoReactivexInternalOperatorsFlowableFlowableSampleTimed *create_IoReactivexInternalOperatorsFlowableFlowableSampleTimed_initWithOrgReactivestreamsPublisher_withLong_withJavaUtilConcurrentTimeUnit_withIoReactivexScheduler_withBoolean_(id<OrgReactivestreamsPublisher> source, jlong period, JavaUtilConcurrentTimeUnit *unit, IoReactivexScheduler *scheduler, jboolean emitLast);
...
@interface IoReactivexInternalOperatorsFlowableFlowableSampleTimed_SampleTimedSubscriber : JavaUtilConcurrentAtomicAtomicReference < OrgReactivestreamsSubscriber, OrgReactivestreamsSubscription, JavaLangRunnable > {
 @public
