...
//  source: ../target/dependency/io/reactivex/internal/operators/observable/ObservablePublish.java
//
...
@interface IoReactivexInternalOperatorsObservableObservablePublish_1 : NSObject < IoReactivexObservableSource > {
 @public
...
J2OBJC_EMPTY_STATIC_INIT(IoReactivexInternalOperatorsObservableObservablePublish_1)

__attribute__((unused)) static void IoReactivexInternalOperatorsObservableObservablePublish_1_initWithJavaUtilConcurrentAtomicAtomicReference_(IoReactivexInternalOperatorsObservableObservablePublish_1 *self, JavaUtilConcurrentAtomicAtomicReference *capture$0);

__attribute__((unused)) static IoReactivexInternalOperatorsObservableObservablePublish_1 *new_IoReactivexInternalOperatorsObservableObservablePublish_1_initWithJavaUtilConcurrentAtomicAtomicReference_(JavaUtilConcurrentAtomicAtomicReference *capture$0) NS_RETURNS_RETAINED;

__attribute__((unused)) static IoReactivexInternalOperatorsObservableObservablePublish_1 *create_IoReactivexInternalOperatorsObservableObservablePublish_1_initWithJavaUtilConcurrentAtomicAtomicReference_(JavaUtilConcurrentAtomicAtomicReference *capture$0);
...
IoReactivexObservablesConnectableObservable *IoReactivexInternalOperatorsObservableObservablePublish_createWithIoReactivexObservableSource_(id<IoReactivexObservableSource> source) {
  ...
  id<IoReactivexObservableSource> onSubscribe = create_IoReactivexInternalOperatorsObservableObservablePublish_1_initWithJavaUtilConcurrentAtomicAtomicReference_(curr);
...
@implementation IoReactivexInternalOperatorsObservableObservablePublish_1

- (instancetype)initWithJavaUtilConcurrentAtomicAtomicReference:(JavaUtilConcurrentAtomicAtomicReference *)capture$0 {
  IoReactivexInternalOperatorsObservableObservablePublish_1_initWithJavaUtilConcurrentAtomicAtomicReference_(self, capture$0);
  return self;
}
...
- (void)subscribeWithIoReactivexObserver:(id<IoReactivexObserver>)child {
  ...
  for (; ; ) {
    IoReactivexInternalOperatorsObservableObservablePublish_PublishObserver *r = [((JavaUtilConcurrentAtomicAtomicReference *) nil_chk(val$curr_)) get];
    if (r == nil || [r isDisposed]) {
      IoReactivexInternalOperatorsObservableObservablePublish_PublishObserver *u = create_IoReactivexInternalOperatorsObservableObservablePublish_PublishObserver_initWithJavaUtilConcurrentAtomicAtomicReference_(val$curr_);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "subscribe", "LIoReactivexObserver;", "(Lio/reactivex/Observer<-TT;>;)V", "Ljava/util/concurrent/atomic/AtomicReference<Lio/reactivex/internal/operators/observable/ObservablePublish$PublishObserver<TT;>;>;", "LIoReactivexInternalOperatorsObservableObservablePublish;", "createWithIoReactivexObservableSource:", "Ljava/lang/Object;Lio/reactivex/ObservableSource<TT;>;" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsObservableObservablePublish_1 = { "", "io.reactivex.internal.operators.observable", ptrTable, methods, fields, 7, 0x8018, 2, 1, 4, -1, 5, 6, -1 };
  return &_IoReactivexInternalOperatorsObservableObservablePublish_1;
}

@end

void IoReactivexInternalOperatorsObservableObservablePublish_1_initWithJavaUtilConcurrentAtomicAtomicReference_(IoReactivexInternalOperatorsObservableObservablePublish_1 *self, JavaUtilConcurrentAtomicAtomicReference *capture$0) {
  JreStrongAssign(&self->val$curr_, capture$0);
  NSObject_init(self);
}

IoReactivexInternalOperatorsObservableObservablePublish_1 *new_IoReactivexInternalOperatorsObservableObservablePublish_1_initWithJavaUtilConcurrentAtomicAtomicReference_(JavaUtilConcurrentAtomicAtomicReference *capture$0) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsObservableObservablePublish_1, initWithJavaUtilConcurrentAtomicAtomicReference_, capture$0)
}

IoReactivexInternalOperatorsObservableObservablePublish_1 *create_IoReactivexInternalOperatorsObservableObservablePublish_1_initWithJavaUtilConcurrentAtomicAtomicReference_(JavaUtilConcurrentAtomicAtomicReference *capture$0) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsObservableObservablePublish_1, initWithJavaUtilConcurrentAtomicAtomicReference_, capture$0)
}
  ...
  if (((IOSObjectArray *) nil_chk(a))->size_ != 0) {
    {
      ...
      while (b__ < e__) {
        IoReactivexInternalOperatorsObservableObservablePublish_InnerDisposable *inner = *b__++;
        [((id<IoReactivexObserver>) nil_chk(((IoReactivexInternalOperatorsObservableObservablePublish_InnerDisposable *) nil_chk(inner))->child_)) onErrorWithNSException:e];
      }
    }
  }
  else {
