...
//  source: ../target/dependency/io/reactivex/internal/operators/observable/ObservableBufferExactBoundary.java
//
...
- (void)onErrorWithNSException:(NSException *)t {
  [((IoReactivexInternalOperatorsObservableObservableBufferExactBoundary_BufferExactBoundaryObserver *) nil_chk(parent_)) onErrorWithNSException:t];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexInternalOperatorsObservableObservableBufferExactBoundary_BufferExactBoundaryObserver;", "(Lio/reactivex/internal/operators/observable/ObservableBufferExactBoundary$BufferExactBoundaryObserver<TT;TU;TB;>;)V", "onNext", "LNSObject;", "(TB;)V", "onError", "LNSException;", "Lio/reactivex/internal/operators/observable/ObservableBufferExactBoundary$BufferExactBoundaryObserver<TT;TU;TB;>;", "LIoReactivexInternalOperatorsObservableObservableBufferExactBoundary;", "<T:Ljava/lang/Object;U::Ljava/util/Collection<-TT;>;B:Ljava/lang/Object;>Lio/reactivex/observers/DisposableObserver<TB;>;" };
