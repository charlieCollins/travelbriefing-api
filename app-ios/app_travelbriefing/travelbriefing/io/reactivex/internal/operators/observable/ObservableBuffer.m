...
//  source: ../target/dependency/io/reactivex/internal/operators/observable/ObservableBuffer.java
//
...
- (jboolean)createBuffer {
  ...
  @catch (NSException *t) {
    ...
    if (s_ == nil) {
      IoReactivexInternalDisposablesEmptyDisposable_errorWithNSException_withIoReactivexObserver_(t, actual_);
    }
    else {
      [s_ dispose];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexObserver;ILJavaUtilConcurrentCallable;", "(Lio/reactivex/Observer<-TU;>;ILjava/util/concurrent/Callable<TU;>;)V", "onSubscribe", "LIoReactivexDisposablesDisposable;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lio/reactivex/Observer<-TU;>;", "Ljava/util/concurrent/Callable<TU;>;", "TU;", "LIoReactivexInternalOperatorsObservableObservableBuffer;", "<T:Ljava/lang/Object;U::Ljava/util/Collection<-TT;>;>Ljava/lang/Object;Lio/reactivex/Observer<TT;>;Lio/reactivex/disposables/Disposable;" };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexObserver;IILJavaUtilConcurrentCallable;", "(Lio/reactivex/Observer<-TU;>;IILjava/util/concurrent/Callable<TU;>;)V", "onSubscribe", "LIoReactivexDisposablesDisposable;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lio/reactivex/Observer<-TU;>;", "Ljava/util/concurrent/Callable<TU;>;", "Ljava/util/ArrayDeque<TU;>;", "LIoReactivexInternalOperatorsObservableObservableBuffer;", "<T:Ljava/lang/Object;U::Ljava/util/Collection<-TT;>;>Ljava/util/concurrent/atomic/AtomicBoolean;Lio/reactivex/Observer<TT;>;Lio/reactivex/disposables/Disposable;" };
