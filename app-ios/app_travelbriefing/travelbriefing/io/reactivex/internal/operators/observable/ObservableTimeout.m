...
//  source: ../target/dependency/io/reactivex/internal/operators/observable/ObservableTimeout.java
//
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "timeout", "J", "innerError", "LNSException;", "LIoReactivexInternalOperatorsObservableObservableTimeout;" };
...
- (void)timeoutWithLong:(jlong)idx {
  if (idx == JreLoadVolatileLong(&index_)) {
    [self dispose];
    [((id<IoReactivexObserver>) nil_chk(actual_)) onErrorWithNSException:create_JavaUtilConcurrentTimeoutException_init()];
  }
}
...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  done_ = true;
  [((id<IoReactivexInternalOperatorsObservableObservableTimeout_OnTimeout>) nil_chk(parent_)) innerErrorWithNSException:t];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexInternalOperatorsObservableObservableTimeout_OnTimeout;J", "onNext", "LNSObject;", "onError", "LNSException;", "LIoReactivexInternalOperatorsObservableObservableTimeout;", "<T:Ljava/lang/Object;U:Ljava/lang/Object;V:Ljava/lang/Object;>Lio/reactivex/observers/DisposableObserver<Ljava/lang/Object;>;" };
