...
//  source: ../target/dependency/io/reactivex/internal/operators/observable/ObservableBufferBoundary.java
//
...
- (void)complete {
  ...
  if ([self enter]) {
    IoReactivexInternalUtilQueueDrainHelper_drainLoopWithIoReactivexInternalFuseableSimpleQueue_withIoReactivexObserver_withBoolean_withIoReactivexDisposablesDisposable_withIoReactivexInternalUtilObservableQueueDrain_(q, actual_, false, self, self);
  }
}
...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  done_ = true;
  [((IoReactivexInternalOperatorsObservableObservableBufferBoundary_BufferBoundaryObserver *) nil_chk(parent_)) onErrorWithNSException:t];
}
