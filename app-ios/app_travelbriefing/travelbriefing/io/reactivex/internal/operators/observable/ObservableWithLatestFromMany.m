...
@interface IoReactivexInternalOperatorsObservableObservableWithLatestFromMany_1 : NSObject < IoReactivexFunctionsFunction > {
 @public
...
J2OBJC_EMPTY_STATIC_INIT(IoReactivexInternalOperatorsObservableObservableWithLatestFromMany_1)

__attribute__((unused)) static void IoReactivexInternalOperatorsObservableObservableWithLatestFromMany_1_initWithIoReactivexInternalOperatorsObservableObservableWithLatestFromMany_(IoReactivexInternalOperatorsObservableObservableWithLatestFromMany_1 *self, IoReactivexInternalOperatorsObservableObservableWithLatestFromMany *outer$);

__attribute__((unused)) static IoReactivexInternalOperatorsObservableObservableWithLatestFromMany_1 *new_IoReactivexInternalOperatorsObservableObservableWithLatestFromMany_1_initWithIoReactivexInternalOperatorsObservableObservableWithLatestFromMany_(IoReactivexInternalOperatorsObservableObservableWithLatestFromMany *outer$) NS_RETURNS_RETAINED;

__attribute__((unused)) static IoReactivexInternalOperatorsObservableObservableWithLatestFromMany_1 *create_IoReactivexInternalOperatorsObservableObservableWithLatestFromMany_1_initWithIoReactivexInternalOperatorsObservableObservableWithLatestFromMany_(IoReactivexInternalOperatorsObservableObservableWithLatestFromMany *outer$);
...
- (void)subscribeActualWithIoReactivexObserver:(id<IoReactivexObserver>)s {
  ...
  if (others == nil) {
    ...
    @catch (NSException *ex) {
      ...
      IoReactivexInternalDisposablesEmptyDisposable_errorWithNSException_withIoReactivexObserver_(ex, s);
      return;
    }
  }
  else {
...
@implementation IoReactivexInternalOperatorsObservableObservableWithLatestFromMany_1

- (instancetype)initWithIoReactivexInternalOperatorsObservableObservableWithLatestFromMany:(IoReactivexInternalOperatorsObservableObservableWithLatestFromMany *)outer$ {
  IoReactivexInternalOperatorsObservableObservableWithLatestFromMany_1_initWithIoReactivexInternalOperatorsObservableObservableWithLatestFromMany_(self, outer$);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "apply", "LNSObject;", "LJavaLangException;", "(TT;)TR;", "Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany<TT;TR;>;", "LIoReactivexInternalOperatorsObservableObservableWithLatestFromMany;", "subscribeActualWithIoReactivexObserver:", "Ljava/lang/Object;Lio/reactivex/functions/Function<TT;TR;>;" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsObservableObservableWithLatestFromMany_1 = { "", "io.reactivex.internal.operators.observable", ptrTable, methods, fields, 7, 0x8018, 2, 1, 5, -1, 6, 7, -1 };
  return &_IoReactivexInternalOperatorsObservableObservableWithLatestFromMany_1;
}

@end

void IoReactivexInternalOperatorsObservableObservableWithLatestFromMany_1_initWithIoReactivexInternalOperatorsObservableObservableWithLatestFromMany_(IoReactivexInternalOperatorsObservableObservableWithLatestFromMany_1 *self, IoReactivexInternalOperatorsObservableObservableWithLatestFromMany *outer$) {
  JreStrongAssign(&self->this$0_, outer$);
  NSObject_init(self);
}

IoReactivexInternalOperatorsObservableObservableWithLatestFromMany_1 *new_IoReactivexInternalOperatorsObservableObservableWithLatestFromMany_1_initWithIoReactivexInternalOperatorsObservableObservableWithLatestFromMany_(IoReactivexInternalOperatorsObservableObservableWithLatestFromMany *outer$) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsObservableObservableWithLatestFromMany_1, initWithIoReactivexInternalOperatorsObservableObservableWithLatestFromMany_, outer$)
}

IoReactivexInternalOperatorsObservableObservableWithLatestFromMany_1 *create_IoReactivexInternalOperatorsObservableObservableWithLatestFromMany_1_initWithIoReactivexInternalOperatorsObservableObservableWithLatestFromMany_(IoReactivexInternalOperatorsObservableObservableWithLatestFromMany *outer$) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsObservableObservableWithLatestFromMany_1, initWithIoReactivexInternalOperatorsObservableObservableWithLatestFromMany_, outer$)
}
...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  IoReactivexInternalUtilHalfSerializer_onErrorWithIoReactivexObserver_withNSException_withJavaUtilConcurrentAtomicAtomicInteger_withIoReactivexInternalUtilAtomicThrowable_(actual_, t, self, error_);
}
...
- (void)onErrorWithNSException:(NSException *)t {
  [((IoReactivexInternalOperatorsObservableObservableWithLatestFromMany_WithLatestFromObserver *) nil_chk(parent_)) innerErrorWithInt:index_ withNSException:t];
}
