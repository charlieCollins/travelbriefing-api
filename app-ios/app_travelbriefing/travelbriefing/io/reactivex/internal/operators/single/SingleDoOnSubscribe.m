...
//  source: ../target/dependency/io/reactivex/internal/operators/single/SingleDoOnSubscribe.java
//
...
- (void)onSubscribeWithIoReactivexDisposablesDisposable:(id<IoReactivexDisposablesDisposable>)d {
  ...
  @catch (NSException *ex) {
    ...
    IoReactivexInternalDisposablesEmptyDisposable_errorWithNSException_withIoReactivexSingleObserver_(ex, actual_);
    return;
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexSingleObserver;LIoReactivexFunctionsConsumer;", "(Lio/reactivex/SingleObserver<-TT;>;Lio/reactivex/functions/Consumer<-Lio/reactivex/disposables/Disposable;>;)V", "onSubscribe", "LIoReactivexDisposablesDisposable;", "onSuccess", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lio/reactivex/SingleObserver<-TT;>;", "Lio/reactivex/functions/Consumer<-Lio/reactivex/disposables/Disposable;>;", "LIoReactivexInternalOperatorsSingleSingleDoOnSubscribe;", "<T:Ljava/lang/Object;>Ljava/lang/Object;Lio/reactivex/SingleObserver<TT;>;" };
