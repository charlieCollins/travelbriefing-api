...
- (void)onNextWithId:(id)t {
  ...
  if (value_ != nil) {
    ...
    [((id<IoReactivexSingleObserver>) nil_chk(actual_)) onErrorWithNSException:create_JavaLangIndexOutOfBoundsException_initWithNSString_(@"Too many elements in the Publisher")];
  }
  else {
...
- (void)onComplete {
  ...
  JreStrongAssign(&self->value_, nil);
  if (v == nil) {
    [((id<IoReactivexSingleObserver>) nil_chk(actual_)) onErrorWithNSException:create_JavaUtilNoSuchElementException_initWithNSString_(@"The source Publisher is empty")];
  }
  else {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexSingleObserver;", "(Lio/reactivex/SingleObserver<-TT;>;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lio/reactivex/SingleObserver<-TT;>;", "TT;", "LIoReactivexInternalOperatorsSingleSingleFromPublisher;", "<T:Ljava/lang/Object;>Ljava/lang/Object;Lorg/reactivestreams/Subscriber<TT;>;Lio/reactivex/disposables/Disposable;" };
