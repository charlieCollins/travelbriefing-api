...
//  source: ../target/dependency/io/reactivex/internal/observers/BlockingBaseObserver.java
//
...
J2OBJC_FIELD_SETTER(IoReactivexInternalObserversBlockingBaseObserver, error_, NSException *)
