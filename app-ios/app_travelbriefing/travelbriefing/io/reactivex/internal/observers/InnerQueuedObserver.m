...
- (void)onErrorWithNSException:(NSException *)t {
  [((id<IoReactivexInternalObserversInnerQueuedObserverSupport>) nil_chk(parent_)) innerErrorWithIoReactivexInternalObserversInnerQueuedObserver:self withNSException:t];
}
