...
//  source: ../target/dependency/io/reactivex/internal/disposables/DisposableHelper.java
//
...
+ (void)initialize {
  if (self == [IoReactivexInternalDisposablesDisposableHelper class]) {
    ...
    for (jint i = 0; i < 1; i++) {
      ...
      IoReactivexInternalDisposablesDisposableHelper_initWithNSString_withInt_(e, names[i], i);
    }
...
void IoReactivexInternalDisposablesDisposableHelper_reportDisposableSet() {
  IoReactivexInternalDisposablesDisposableHelper_initialize();
  IoReactivexPluginsRxJavaPlugins_onErrorWithNSException_(create_IoReactivexExceptionsProtocolViolationException_initWithNSString_(@"Disposable already set!"));
}
