...
//  source: ../target/dependency/io/reactivex/subjects/PublishSubject.java
//
...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  JreStrongAssign(&error_, t);
  {
    ...
    while (b__ < e__) {
      IoReactivexSubjectsPublishSubject_PublishDisposable *s = *b__++;
      [((IoReactivexSubjectsPublishSubject_PublishDisposable *) nil_chk(s)) onErrorWithNSException:t];
    }
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexObserver;LIoReactivexSubjectsPublishSubject;", "(Lio/reactivex/Observer<-TT;>;Lio/reactivex/subjects/PublishSubject<TT;>;)V", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lio/reactivex/Observer<-TT;>;", "Lio/reactivex/subjects/PublishSubject<TT;>;", "LIoReactivexSubjectsPublishSubject;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicBoolean;Lio/reactivex/disposables/Disposable;" };
