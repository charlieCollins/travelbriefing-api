...
@interface Okhttp3ResponseBody_BomAwareReader () {
 @public
  id<OkioBufferedSource> source_;
  JavaNioCharsetCharset *charset_;
  jboolean closed_;
  JavaIoReader *delegate_;
}

@end

J2OBJC_FIELD_SETTER(Okhttp3ResponseBody_BomAwareReader, source_, id<OkioBufferedSource>)
J2OBJC_FIELD_SETTER(Okhttp3ResponseBody_BomAwareReader, charset_, JavaNioCharsetCharset *)
J2OBJC_FIELD_SETTER(Okhttp3ResponseBody_BomAwareReader, delegate_, JavaIoReader *)
...
- (IOSByteArray *)bytes {
  ...
  if (contentLength != -1 && contentLength != ((IOSByteArray *) nil_chk(bytes))->size_) {
    @throw create_JavaIoIOException_initWithNSString_(JreStrcat("$J$I$", @"Content-Length (", contentLength, @") and stream length (", ((IOSByteArray *) nil_chk(bytes))->size_, @") disagree"));
  }
  return bytes;
}
...
- (JavaIoReader *)charStream {
  ...
  return r != nil ? r : (JreStrongAssignAndConsume(&reader_, new_Okhttp3ResponseBody_BomAwareReader_initWithOkioBufferedSource_withJavaNioCharsetCharset_([self source], Okhttp3ResponseBody_charset(self))));
}

- (NSString *)string {
  id<OkioBufferedSource> source = [self source];
  @try {
    JavaNioCharsetCharset *charset = Okhttp3InternalUtil_bomAwareCharsetWithOkioBufferedSource_withJavaNioCharsetCharset_(source, Okhttp3ResponseBody_charset(self));
    return [((id<OkioBufferedSource>) nil_chk(source)) readStringWithJavaNioCharsetCharset:charset];
  }
  @finally {
    Okhttp3InternalUtil_closeQuietlyWithJavaIoCloseable_(source);
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LJavaIoIOException;", "create", "LOkhttp3MediaType;LNSString;", "LOkhttp3MediaType;[B", "LOkhttp3MediaType;JLOkioBufferedSource;", "LOkhttp3ResponseBody_BomAwareReader;" };
  static const J2ObjcClassInfo _Okhttp3ResponseBody = { "ResponseBody", "okhttp3", ptrTable, methods, fields, 7, 0x401, 13, 1, -1, 5, -1, -1, -1 };
...
@implementation Okhttp3ResponseBody_BomAwareReader

- (instancetype)initWithOkioBufferedSource:(id<OkioBufferedSource>)source
                 withJavaNioCharsetCharset:(JavaNioCharsetCharset *)charset {
  Okhttp3ResponseBody_BomAwareReader_initWithOkioBufferedSource_withJavaNioCharsetCharset_(self, source, charset);
  return self;
}
...
- (jint)readWithCharArray:(IOSCharArray *)cbuf
                  withInt:(jint)off
                  withInt:(jint)len {
  if (closed_) @throw create_JavaIoIOException_initWithNSString_(@"Stream closed");
  JavaIoReader *delegate = self->delegate_;
  if (delegate == nil) {
    JavaNioCharsetCharset *charset = Okhttp3InternalUtil_bomAwareCharsetWithOkioBufferedSource_withJavaNioCharsetCharset_(source_, self->charset_);
    delegate = JreStrongAssignAndConsume(&self->delegate_, new_JavaIoInputStreamReader_initWithJavaIoInputStream_withJavaNioCharsetCharset_([((id<OkioBufferedSource>) nil_chk(source_)) inputStream], charset));
  }
  return [delegate readWithCharArray:cbuf withInt:off withInt:len];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  methods[0].selector = @selector(initWithOkioBufferedSource:withJavaNioCharsetCharset:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "delegate_", "LJavaIoReader;", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "LOkioBufferedSource;LJavaNioCharsetCharset;", "read", "[CII", "LJavaIoIOException;", "LOkhttp3ResponseBody;" };
  static const J2ObjcClassInfo _Okhttp3ResponseBody_BomAwareReader = { "BomAwareReader", "okhttp3", ptrTable, methods, fields, 7, 0x18, 3, 4, 4, -1, -1, -1, -1 };
  return &_Okhttp3ResponseBody_BomAwareReader;
}

@end

void Okhttp3ResponseBody_BomAwareReader_initWithOkioBufferedSource_withJavaNioCharsetCharset_(Okhttp3ResponseBody_BomAwareReader *self, id<OkioBufferedSource> source, JavaNioCharsetCharset *charset) {
  JavaIoReader_init(self);
  JreStrongAssign(&self->source_, source);
  JreStrongAssign(&self->charset_, charset);
}

Okhttp3ResponseBody_BomAwareReader *new_Okhttp3ResponseBody_BomAwareReader_initWithOkioBufferedSource_withJavaNioCharsetCharset_(id<OkioBufferedSource> source, JavaNioCharsetCharset *charset) {
  J2OBJC_NEW_IMPL(Okhttp3ResponseBody_BomAwareReader, initWithOkioBufferedSource_withJavaNioCharsetCharset_, source, charset)
}

Okhttp3ResponseBody_BomAwareReader *create_Okhttp3ResponseBody_BomAwareReader_initWithOkioBufferedSource_withJavaNioCharsetCharset_(id<OkioBufferedSource> source, JavaNioCharsetCharset *charset) {
  J2OBJC_CREATE_IMPL(Okhttp3ResponseBody_BomAwareReader, initWithOkioBufferedSource_withJavaNioCharsetCharset_, source, charset)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(Okhttp3ResponseBody_BomAwareReader)
