...
//  source: ../target/dependency/okhttp3/Address.java
//
...
- (instancetype)initWithNSString:(NSString *)uriHost
 ...
 withJavaxNetSslHostnameVerifier:(id<JavaxNetSslHostnameVerifier>)hostnameVerifier
    withOkhttp3CertificatePinner:(Okhttp3CertificatePinner *)certificatePinner
  ...
  Okhttp3Address_initWithNSString_withInt_withOkhttp3Dns_withJavaxNetSocketFactory_withJavaxNetSslSSLSocketFactory_withJavaxNetSslHostnameVerifier_withOkhttp3CertificatePinner_withOkhttp3Authenticator_withJavaNetProxy_withJavaUtilList_withJavaUtilList_withJavaNetProxySelector_(self, uriHost, uriPort, dns, socketFactory, sslSocketFactory, hostnameVerifier, certificatePinner, proxyAuthenticator, proxy, protocols, connectionSpecs, proxySelector);
  return self;
}
...
- (NSString *)description {
  JavaLangStringBuilder *result = [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([create_JavaLangStringBuilder_init() appendWithNSString:@"Address{"])) appendWithNSString:[((Okhttp3HttpUrl *) nil_chk(url_)) host]])) appendWithNSString:@":"])) appendWithInt:[url_ port]];
  if (proxy_ != nil) {
    [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@", proxy="])) appendWithId:proxy_];
  }
  else {
    [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk(result)) appendWithNSString:@", proxySelector="])) appendWithId:proxySelector_];
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithNSString:withInt:withOkhttp3Dns:withJavaxNetSocketFactory:withJavaxNetSslSSLSocketFactory:withJavaxNetSslHostnameVerifier:withOkhttp3CertificatePinner:withOkhttp3Authenticator:withJavaNetProxy:withJavaUtilList:withJavaUtilList:withJavaNetProxySelector:);
  ...
  methods[11].selector = @selector(certificatePinner);
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "protocols_", "LJavaUtilList;", .constantValue.asLong = 0, 0x10, -1, -1, 8, -1 },
  ...
  static const void *ptrTable[] = { "LNSString;ILOkhttp3Dns;LJavaxNetSocketFactory;LJavaxNetSslSSLSocketFactory;LJavaxNetSslHostnameVerifier;LOkhttp3CertificatePinner;LOkhttp3Authenticator;LJavaNetProxy;LJavaUtilList;LJavaUtilList;LJavaNetProxySelector;", "(Ljava/lang/String;ILokhttp3/Dns;Ljavax/net/SocketFactory;Ljavax/net/ssl/SSLSocketFactory;Ljavax/net/ssl/HostnameVerifier;Lokhttp3/CertificatePinner;Lokhttp3/Authenticator;Ljava/net/Proxy;Ljava/util/List<Lokhttp3/Protocol;>;Ljava/util/List<Lokhttp3/ConnectionSpec;>;Ljava/net/ProxySelector;)V", "()Ljava/util/List<Lokhttp3/Protocol;>;", "()Ljava/util/List<Lokhttp3/ConnectionSpec;>;", "equals", "LNSObject;", "hashCode", "toString", "Ljava/util/List<Lokhttp3/Protocol;>;", "Ljava/util/List<Lokhttp3/ConnectionSpec;>;" };
  static const J2ObjcClassInfo _Okhttp3Address = { "Address", "okhttp3", ptrTable, methods, fields, 7, 0x11, 15, 11, -1, -1, -1, -1, -1 };
  return &_Okhttp3Address;
}

@end

void Okhttp3Address_initWithNSString_withInt_withOkhttp3Dns_withJavaxNetSocketFactory_withJavaxNetSslSSLSocketFactory_withJavaxNetSslHostnameVerifier_withOkhttp3CertificatePinner_withOkhttp3Authenticator_withJavaNetProxy_withJavaUtilList_withJavaUtilList_withJavaNetProxySelector_(Okhttp3Address *self, NSString *uriHost, jint uriPort, id<Okhttp3Dns> dns, JavaxNetSocketFactory *socketFactory, JavaxNetSslSSLSocketFactory *sslSocketFactory, id<JavaxNetSslHostnameVerifier> hostnameVerifier, Okhttp3CertificatePinner *certificatePinner, id<Okhttp3Authenticator> proxyAuthenticator, JavaNetProxy *proxy, id<JavaUtilList> protocols, id<JavaUtilList> connectionSpecs, JavaNetProxySelector *proxySelector) {
  NSObject_init(self);
...
Okhttp3Address *new_Okhttp3Address_initWithNSString_withInt_withOkhttp3Dns_withJavaxNetSocketFactory_withJavaxNetSslSSLSocketFactory_withJavaxNetSslHostnameVerifier_withOkhttp3CertificatePinner_withOkhttp3Authenticator_withJavaNetProxy_withJavaUtilList_withJavaUtilList_withJavaNetProxySelector_(NSString *uriHost, jint uriPort, id<Okhttp3Dns> dns, JavaxNetSocketFactory *socketFactory, JavaxNetSslSSLSocketFactory *sslSocketFactory, id<JavaxNetSslHostnameVerifier> hostnameVerifier, Okhttp3CertificatePinner *certificatePinner, id<Okhttp3Authenticator> proxyAuthenticator, JavaNetProxy *proxy, id<JavaUtilList> protocols, id<JavaUtilList> connectionSpecs, JavaNetProxySelector *proxySelector) {
  J2OBJC_NEW_IMPL(Okhttp3Address, initWithNSString_withInt_withOkhttp3Dns_withJavaxNetSocketFactory_withJavaxNetSslSSLSocketFactory_withJavaxNetSslHostnameVerifier_withOkhttp3CertificatePinner_withOkhttp3Authenticator_withJavaNetProxy_withJavaUtilList_withJavaUtilList_withJavaNetProxySelector_, uriHost, uriPort, dns, socketFactory, sslSocketFactory, hostnameVerifier, certificatePinner, proxyAuthenticator, proxy, protocols, connectionSpecs, proxySelector)
}

Okhttp3Address *create_Okhttp3Address_initWithNSString_withInt_withOkhttp3Dns_withJavaxNetSocketFactory_withJavaxNetSslSSLSocketFactory_withJavaxNetSslHostnameVerifier_withOkhttp3CertificatePinner_withOkhttp3Authenticator_withJavaNetProxy_withJavaUtilList_withJavaUtilList_withJavaNetProxySelector_(NSString *uriHost, jint uriPort, id<Okhttp3Dns> dns, JavaxNetSocketFactory *socketFactory, JavaxNetSslSSLSocketFactory *sslSocketFactory, id<JavaxNetSslHostnameVerifier> hostnameVerifier, Okhttp3CertificatePinner *certificatePinner, id<Okhttp3Authenticator> proxyAuthenticator, JavaNetProxy *proxy, id<JavaUtilList> protocols, id<JavaUtilList> connectionSpecs, JavaNetProxySelector *proxySelector) {
  J2OBJC_CREATE_IMPL(Okhttp3Address, initWithNSString_withInt_withOkhttp3Dns_withJavaxNetSocketFactory_withJavaxNetSslSSLSocketFactory_withJavaxNetSslHostnameVerifier_withOkhttp3CertificatePinner_withOkhttp3Authenticator_withJavaNetProxy_withJavaUtilList_withJavaUtilList_withJavaNetProxySelector_, uriHost, uriPort, dns, socketFactory, sslSocketFactory, hostnameVerifier, certificatePinner, proxyAuthenticator, proxy, protocols, connectionSpecs, proxySelector)
}
