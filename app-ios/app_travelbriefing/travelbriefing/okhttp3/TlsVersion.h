...
typedef NS_ENUM(NSUInteger, Okhttp3TlsVersion_Enum) {
  Okhttp3TlsVersion_Enum_TLS_1_3 = 0,
  Okhttp3TlsVersion_Enum_TLS_1_2 = 1,
  Okhttp3TlsVersion_Enum_TLS_1_1 = 2,
  Okhttp3TlsVersion_Enum_TLS_1_0 = 3,
  Okhttp3TlsVersion_Enum_SSL_3_0 = 4,
};
...
inline Okhttp3TlsVersion *Okhttp3TlsVersion_get_TLS_1_3();
J2OBJC_ENUM_CONSTANT(Okhttp3TlsVersion, TLS_1_3)
