...
//  source: ../target/dependency/okhttp3/TlsVersion.java
//
...
Okhttp3TlsVersion *Okhttp3TlsVersion_values_[5];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "TLS_1_3", "LOkhttp3TlsVersion;", .constantValue.asLong = 0, 0x4019, -1, 3, -1, -1 },
    { "TLS_1_2", "LOkhttp3TlsVersion;", .constantValue.asLong = 0, 0x4019, -1, 4, -1, -1 },
    { "TLS_1_1", "LOkhttp3TlsVersion;", .constantValue.asLong = 0, 0x4019, -1, 5, -1, -1 },
    { "TLS_1_0", "LOkhttp3TlsVersion;", .constantValue.asLong = 0, 0x4019, -1, 6, -1, -1 },
    { "SSL_3_0", "LOkhttp3TlsVersion;", .constantValue.asLong = 0, 0x4019, -1, 7, -1, -1 },
    { "javaName_", "LNSString;", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "forJavaName", "LNSString;", "valueOf", &JreEnum(Okhttp3TlsVersion, TLS_1_3), &JreEnum(Okhttp3TlsVersion, TLS_1_2), &JreEnum(Okhttp3TlsVersion, TLS_1_1), &JreEnum(Okhttp3TlsVersion, TLS_1_0), &JreEnum(Okhttp3TlsVersion, SSL_3_0), "Ljava/lang/Enum<Lokhttp3/TlsVersion;>;" };
  static const J2ObjcClassInfo _Okhttp3TlsVersion = { "TlsVersion", "okhttp3", ptrTable, methods, fields, 7, 0x4011, 4, 6, -1, -1, -1, 8, -1 };
...
+ (void)initialize {
  if (self == [Okhttp3TlsVersion class]) {
    ...
    id e;
    (JreEnum(Okhttp3TlsVersion, TLS_1_3) = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
    Okhttp3TlsVersion_initWithNSString_withNSString_withInt_(e, @"TLSv1.3", @"TLS_1_3", 0);
    (JreEnum(Okhttp3TlsVersion, TLS_1_2) = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
    Okhttp3TlsVersion_initWithNSString_withNSString_withInt_(e, @"TLSv1.2", @"TLS_1_2", 1);
    (JreEnum(Okhttp3TlsVersion, TLS_1_1) = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
    Okhttp3TlsVersion_initWithNSString_withNSString_withInt_(e, @"TLSv1.1", @"TLS_1_1", 2);
    (JreEnum(Okhttp3TlsVersion, TLS_1_0) = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
    Okhttp3TlsVersion_initWithNSString_withNSString_withInt_(e, @"TLSv1", @"TLS_1_0", 3);
    (JreEnum(Okhttp3TlsVersion, SSL_3_0) = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
    Okhttp3TlsVersion_initWithNSString_withNSString_withInt_(e, @"SSLv3", @"SSL_3_0", 4);
...
Okhttp3TlsVersion *Okhttp3TlsVersion_forJavaNameWithNSString_(NSString *javaName) {
  ...
  switch (JreIndexOfStr(javaName, (id[]){ @"TLSv1.3", @"TLSv1.2", @"TLSv1.1", @"TLSv1", @"SSLv3" }, 5)) {
    case 0:
    return JreEnum(Okhttp3TlsVersion, TLS_1_3);
    case 1:
...
IOSObjectArray *Okhttp3TlsVersion_values() {
  Okhttp3TlsVersion_initialize();
  return [IOSObjectArray arrayWithObjects:Okhttp3TlsVersion_values_ count:5 type:Okhttp3TlsVersion_class_()];
}
