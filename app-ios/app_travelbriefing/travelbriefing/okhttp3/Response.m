...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "message_", "LNSString;", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
    { "handshake_", "LOkhttp3Handshake;", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
    { "headers_", "LOkhttp3Headers;", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
    { "body_", "LOkhttp3ResponseBody;", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
    { "networkResponse_", "LOkhttp3Response;", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
    { "cacheResponse_", "LOkhttp3Response;", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
    { "priorResponse_", "LOkhttp3Response;", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
    { "sentRequestAtMillis_", "J", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
    { "receivedResponseAtMillis_", "J", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "request_", "LOkhttp3Request;", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "protocol_", "LOkhttp3Protocol;", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "code_", "I", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "message_", "LNSString;", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "handshake_", "LOkhttp3Handshake;", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "headers_", "LOkhttp3Headers_Builder;", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "body_", "LOkhttp3ResponseBody;", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "networkResponse_", "LOkhttp3Response;", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "cacheResponse_", "LOkhttp3Response;", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "priorResponse_", "LOkhttp3Response;", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "sentRequestAtMillis_", "J", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "receivedResponseAtMillis_", "J", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
  };
