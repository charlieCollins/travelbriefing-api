...
#include "okhttp3/internal/platform/AndroidPlatform.h"
#include "okhttp3/internal/platform/OptionalMethod.h"
...
@interface Okhttp3InternalPlatformAndroidPlatform () {
 @public
  ...
  Okhttp3InternalPlatformAndroidPlatform_CloseGuard *closeGuard_;
}
...
J2OBJC_FIELD_SETTER(Okhttp3InternalPlatformAndroidPlatform, closeGuard_, Okhttp3InternalPlatformAndroidPlatform_CloseGuard *)
...
@interface Okhttp3InternalPlatformAndroidPlatform_CloseGuard () {
 @public
  JavaLangReflectMethod *getMethod_;
  JavaLangReflectMethod *openMethod_;
  JavaLangReflectMethod *warnIfOpenMethod_;
}

@end

J2OBJC_FIELD_SETTER(Okhttp3InternalPlatformAndroidPlatform_CloseGuard, getMethod_, JavaLangReflectMethod *)
J2OBJC_FIELD_SETTER(Okhttp3InternalPlatformAndroidPlatform_CloseGuard, openMethod_, JavaLangReflectMethod *)
J2OBJC_FIELD_SETTER(Okhttp3InternalPlatformAndroidPlatform_CloseGuard, warnIfOpenMethod_, JavaLangReflectMethod *)
...
- (void)connectSocketWithJavaNetSocket:(JavaNetSocket *)socket
  ...
  @catch (JavaLangSecurityException *e) {
    ...
    [ioException initCauseWithNSException:e];
    @throw ioException;
  }
}
...
- (void)logWithInt:(jint)level
  ...
  if (t != nil) message = JreStrcat("$C$", message, 0x000a, AndroidUtilLog_getStackTraceStringWithNSException_(t));
  for (jint i = 0, length = ((jint) [((NSString *) nil_chk(message)) length]); i < length; i++) {
...
- (id)getStackTraceForCloseableWithNSString:(NSString *)closer {
  return [((Okhttp3InternalPlatformAndroidPlatform_CloseGuard *) nil_chk(closeGuard_)) createAndOpenWithNSString:closer];
}

- (void)logCloseableLeakWithNSString:(NSString *)message
                              withId:(id)stackTrace {
  jboolean reported = [((Okhttp3InternalPlatformAndroidPlatform_CloseGuard *) nil_chk(closeGuard_)) warnIfOpenWithId:stackTrace];
  if (!reported) {
    [self logWithInt:Okhttp3InternalPlatformPlatform_WARN withNSString:message withNSException:nil];
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "Z", 0x1, 18, 15, -1, -1, -1, -1 },
    { NULL, "LOkhttp3InternalTlsCertificateChainCleaner;", 0x1, 19, 20, -1, -1, -1, -1 },
  ...
  methods[5].selector = @selector(logWithInt:withNSString:withNSException:);
  methods[6].selector = @selector(getStackTraceForCloseableWithNSString:);
  methods[7].selector = @selector(logCloseableLeakWithNSString:withId:);
  methods[8].selector = @selector(isCleartextTrafficPermittedWithNSString:);
  methods[9].selector = @selector(buildCertificateChainCleanerWithJavaxNetSslX509TrustManager:);
  methods[10].selector = @selector(buildIfSupported);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "MAX_LOG_LENGTH", "I", .constantValue.asInt = Okhttp3InternalPlatformAndroidPlatform_MAX_LOG_LENGTH, 0x1a, -1, -1, -1, -1 },
    { "sslParametersClass_", "LIOSClass;", .constantValue.asLong = 0, 0x12, -1, -1, 21, -1 },
    { "setUseSessionTickets_", "LOkhttp3InternalPlatformOptionalMethod;", .constantValue.asLong = 0, 0x12, -1, -1, 22, -1 },
    { "setHostname_", "LOkhttp3InternalPlatformOptionalMethod;", .constantValue.asLong = 0, 0x12, -1, -1, 22, -1 },
    { "getAlpnSelectedProtocol_", "LOkhttp3InternalPlatformOptionalMethod;", .constantValue.asLong = 0, 0x12, -1, -1, 22, -1 },
    { "setAlpnProtocols_", "LOkhttp3InternalPlatformOptionalMethod;", .constantValue.asLong = 0, 0x12, -1, -1, 22, -1 },
    { "closeGuard_", "LOkhttp3InternalPlatformAndroidPlatform_CloseGuard;", .constantValue.asLong = 0, 0x12, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "LIOSClass;LOkhttp3InternalPlatformOptionalMethod;LOkhttp3InternalPlatformOptionalMethod;LOkhttp3InternalPlatformOptionalMethod;LOkhttp3InternalPlatformOptionalMethod;", "(Ljava/lang/Class<*>;Lokhttp3/internal/platform/OptionalMethod<Ljava/net/Socket;>;Lokhttp3/internal/platform/OptionalMethod<Ljava/net/Socket;>;Lokhttp3/internal/platform/OptionalMethod<Ljava/net/Socket;>;Lokhttp3/internal/platform/OptionalMethod<Ljava/net/Socket;>;)V", "connectSocket", "LJavaNetSocket;LJavaNetInetSocketAddress;I", "LJavaIoIOException;", "trustManager", "LJavaxNetSslSSLSocketFactory;", "configureTlsExtensions", "LJavaxNetSslSSLSocket;LNSString;LJavaUtilList;", "(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List<Lokhttp3/Protocol;>;)V", "getSelectedProtocol", "LJavaxNetSslSSLSocket;", "log", "ILNSString;LNSException;", "getStackTraceForCloseable", "LNSString;", "logCloseableLeak", "LNSString;LNSObject;", "isCleartextTrafficPermitted", "buildCertificateChainCleaner", "LJavaxNetSslX509TrustManager;", "Ljava/lang/Class<*>;", "Lokhttp3/internal/platform/OptionalMethod<Ljava/net/Socket;>;", "LOkhttp3InternalPlatformAndroidPlatform_AndroidCertificateChainCleaner;LOkhttp3InternalPlatformAndroidPlatform_CloseGuard;" };
  static const J2ObjcClassInfo _Okhttp3InternalPlatformAndroidPlatform = { "AndroidPlatform", "okhttp3.internal.platform", ptrTable, methods, fields, 7, 0x0, 11, 7, -1, 23, -1, -1, -1 };
...
void Okhttp3InternalPlatformAndroidPlatform_initWithIOSClass_withOkhttp3InternalPlatformOptionalMethod_withOkhttp3InternalPlatformOptionalMethod_withOkhttp3InternalPlatformOptionalMethod_withOkhttp3InternalPlatformOptionalMethod_(Okhttp3InternalPlatformAndroidPlatform *self, IOSClass *sslParametersClass, Okhttp3InternalPlatformOptionalMethod *setUseSessionTickets, Okhttp3InternalPlatformOptionalMethod *setHostname, Okhttp3InternalPlatformOptionalMethod *getAlpnSelectedProtocol, Okhttp3InternalPlatformOptionalMethod *setAlpnProtocols) {
  ...
  JreStrongAssign(&self->closeGuard_, Okhttp3InternalPlatformAndroidPlatform_CloseGuard_get());
...
- (id<JavaUtilList>)cleanWithJavaUtilList:(id<JavaUtilList>)chain
  ...
  @catch (JavaLangReflectInvocationTargetException *e) {
    JavaxNetSslSSLPeerUnverifiedException *exception = create_JavaxNetSslSSLPeerUnverifiedException_initWithNSString_([((JavaLangReflectInvocationTargetException *) nil_chk(e)) getMessage]);
...
- (jboolean)isEqual:(id)other {
  return [other isKindOfClass:[Okhttp3InternalPlatformAndroidPlatform_AndroidCertificateChainCleaner class]];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LNSObject;LJavaLangReflectMethod;", "clean", "LJavaUtilList;LNSString;", "LJavaxNetSslSSLPeerUnverifiedException;", "(Ljava/util/List<Ljava/security/cert/Certificate;>;Ljava/lang/String;)Ljava/util/List<Ljava/security/cert/Certificate;>;", "equals", "LNSObject;", "hashCode", "LOkhttp3InternalPlatformAndroidPlatform;" };
  static const J2ObjcClassInfo _Okhttp3InternalPlatformAndroidPlatform_AndroidCertificateChainCleaner = { "AndroidCertificateChainCleaner", "okhttp3.internal.platform", ptrTable, methods, fields, 7, 0x18, 4, 2, 8, -1, -1, -1, -1 };
...
@implementation Okhttp3InternalPlatformAndroidPlatform_CloseGuard
...
- (instancetype)initWithJavaLangReflectMethod:(JavaLangReflectMethod *)getMethod
  ...
  Okhttp3InternalPlatformAndroidPlatform_CloseGuard_initWithJavaLangReflectMethod_withJavaLangReflectMethod_withJavaLangReflectMethod_(self, getMethod, openMethod, warnIfOpenMethod);
  return self;
}
...
- (id)createAndOpenWithNSString:(NSString *)closer {
  if (getMethod_ != nil) {
    @try {
      id closeGuardInstance = [getMethod_ invokeWithId:nil withNSObjectArray:[IOSObjectArray arrayWithLength:0 type:NSObject_class_()]];
      [((JavaLangReflectMethod *) nil_chk(openMethod_)) invokeWithId:closeGuardInstance withNSObjectArray:[IOSObjectArray arrayWithObjects:(id[]){ closer } count:1 type:NSObject_class_()]];
...
- (jboolean)warnIfOpenWithId:(id)closeGuardInstance {
  jboolean reported = false;
  if (closeGuardInstance != nil) {
    @try {
      [((JavaLangReflectMethod *) nil_chk(warnIfOpenMethod_)) invokeWithId:closeGuardInstance withNSObjectArray:[IOSObjectArray arrayWithLength:0 type:NSObject_class_()]];
      reported = true;
    }
    @catch (JavaLangException *ignored) {
    }
...
+ (Okhttp3InternalPlatformAndroidPlatform_CloseGuard *)get {
  return Okhttp3InternalPlatformAndroidPlatform_CloseGuard_get();
}

- (void)dealloc {
  RELEASE_(getMethod_);
  RELEASE_(openMethod_);
  RELEASE_(warnIfOpenMethod_);
  [super dealloc];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LOkhttp3InternalPlatformAndroidPlatform_CloseGuard;", 0x8, -1, -1, -1, -1, -1, -1 },
  };
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  methods[0].selector = @selector(initWithJavaLangReflectMethod:withJavaLangReflectMethod:withJavaLangReflectMethod:);
  methods[1].selector = @selector(createAndOpenWithNSString:);
  methods[2].selector = @selector(warnIfOpenWithId:);
  methods[3].selector = @selector(get);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "getMethod_", "LJavaLangReflectMethod;", .constantValue.asLong = 0, 0x12, -1, -1, -1, -1 },
    { "openMethod_", "LJavaLangReflectMethod;", .constantValue.asLong = 0, 0x12, -1, -1, -1, -1 },
    { "warnIfOpenMethod_", "LJavaLangReflectMethod;", .constantValue.asLong = 0, 0x12, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "LJavaLangReflectMethod;LJavaLangReflectMethod;LJavaLangReflectMethod;", "createAndOpen", "LNSString;", "warnIfOpen", "LNSObject;", "LOkhttp3InternalPlatformAndroidPlatform;" };
  static const J2ObjcClassInfo _Okhttp3InternalPlatformAndroidPlatform_CloseGuard = { "CloseGuard", "okhttp3.internal.platform", ptrTable, methods, fields, 7, 0x18, 4, 3, 5, -1, -1, -1, -1 };
  return &_Okhttp3InternalPlatformAndroidPlatform_CloseGuard;
}

@end

void Okhttp3InternalPlatformAndroidPlatform_CloseGuard_initWithJavaLangReflectMethod_withJavaLangReflectMethod_withJavaLangReflectMethod_(Okhttp3InternalPlatformAndroidPlatform_CloseGuard *self, JavaLangReflectMethod *getMethod, JavaLangReflectMethod *openMethod, JavaLangReflectMethod *warnIfOpenMethod) {
  NSObject_init(self);
  JreStrongAssign(&self->getMethod_, getMethod);
  JreStrongAssign(&self->openMethod_, openMethod);
  JreStrongAssign(&self->warnIfOpenMethod_, warnIfOpenMethod);
}

Okhttp3InternalPlatformAndroidPlatform_CloseGuard *new_Okhttp3InternalPlatformAndroidPlatform_CloseGuard_initWithJavaLangReflectMethod_withJavaLangReflectMethod_withJavaLangReflectMethod_(JavaLangReflectMethod *getMethod, JavaLangReflectMethod *openMethod, JavaLangReflectMethod *warnIfOpenMethod) {
  J2OBJC_NEW_IMPL(Okhttp3InternalPlatformAndroidPlatform_CloseGuard, initWithJavaLangReflectMethod_withJavaLangReflectMethod_withJavaLangReflectMethod_, getMethod, openMethod, warnIfOpenMethod)
}

Okhttp3InternalPlatformAndroidPlatform_CloseGuard *create_Okhttp3InternalPlatformAndroidPlatform_CloseGuard_initWithJavaLangReflectMethod_withJavaLangReflectMethod_withJavaLangReflectMethod_(JavaLangReflectMethod *getMethod, JavaLangReflectMethod *openMethod, JavaLangReflectMethod *warnIfOpenMethod) {
  J2OBJC_CREATE_IMPL(Okhttp3InternalPlatformAndroidPlatform_CloseGuard, initWithJavaLangReflectMethod_withJavaLangReflectMethod_withJavaLangReflectMethod_, getMethod, openMethod, warnIfOpenMethod)
}

Okhttp3InternalPlatformAndroidPlatform_CloseGuard *Okhttp3InternalPlatformAndroidPlatform_CloseGuard_get() {
  Okhttp3InternalPlatformAndroidPlatform_CloseGuard_initialize();
  JavaLangReflectMethod *getMethod;
  JavaLangReflectMethod *openMethod;
  JavaLangReflectMethod *warnIfOpenMethod;
  @try {
    IOSClass *closeGuardClass = IOSClass_forName_(@"dalvik.system.CloseGuard");
    getMethod = [((IOSClass *) nil_chk(closeGuardClass)) getMethod:@"get" parameterTypes:[IOSObjectArray arrayWithLength:0 type:IOSClass_class_()]];
    openMethod = [closeGuardClass getMethod:@"open" parameterTypes:[IOSObjectArray arrayWithObjects:(id[]){ NSString_class_() } count:1 type:IOSClass_class_()]];
    warnIfOpenMethod = [closeGuardClass getMethod:@"warnIfOpen" parameterTypes:[IOSObjectArray arrayWithLength:0 type:IOSClass_class_()]];
  }
  @catch (JavaLangException *ignored) {
    getMethod = nil;
    openMethod = nil;
    warnIfOpenMethod = nil;
  }
  return create_Okhttp3InternalPlatformAndroidPlatform_CloseGuard_initWithJavaLangReflectMethod_withJavaLangReflectMethod_withJavaLangReflectMethod_(getMethod, openMethod, warnIfOpenMethod);
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(Okhttp3InternalPlatformAndroidPlatform_CloseGuard)
