...
//  source: ../target/dependency/okhttp3/internal/http/RealInterceptorChain.java
//
...
@interface Okhttp3InternalHttpRealInterceptorChain () {
 @public
  ...
  id<Okhttp3InternalHttpHttpCodec> httpCodec_;
...
J2OBJC_FIELD_SETTER(Okhttp3InternalHttpRealInterceptorChain, httpCodec_, id<Okhttp3InternalHttpHttpCodec>)
...
withOkhttp3InternalConnectionStreamAllocation:(Okhttp3InternalConnectionStreamAllocation *)streamAllocation
    withOkhttp3InternalHttpHttpCodec:(id<Okhttp3InternalHttpHttpCodec>)httpCodec
               withOkhttp3Connection:(id<Okhttp3Connection>)connection
                             withInt:(jint)index
                  withOkhttp3Request:(Okhttp3Request *)request {
  Okhttp3InternalHttpRealInterceptorChain_initWithJavaUtilList_withOkhttp3InternalConnectionStreamAllocation_withOkhttp3InternalHttpHttpCodec_withOkhttp3Connection_withInt_withOkhttp3Request_(self, interceptors, streamAllocation, httpCodec, connection, index, request);
  return self;
}
...
- (id<Okhttp3InternalHttpHttpCodec>)httpStream {
  return httpCodec_;
}
...
- (Okhttp3Response *)proceedWithOkhttp3Request:(Okhttp3Request *)request {
  return [self proceedWithOkhttp3Request:request withOkhttp3InternalConnectionStreamAllocation:streamAllocation_ withOkhttp3InternalHttpHttpCodec:httpCodec_ withOkhttp3Connection:connection_];
}
...
- (Okhttp3Response *)proceedWithOkhttp3Request:(Okhttp3Request *)request
 withOkhttp3InternalConnectionStreamAllocation:(Okhttp3InternalConnectionStreamAllocation *)streamAllocation
  ...
  calls_++;
  if (self->httpCodec_ != nil && !Okhttp3InternalHttpRealInterceptorChain_sameConnectionWithOkhttp3HttpUrl_(self, [((Okhttp3Request *) nil_chk(request)) url])) {
  ...
  if (self->httpCodec_ != nil && calls_ > 1) {
  ...
  Okhttp3InternalHttpRealInterceptorChain *next = create_Okhttp3InternalHttpRealInterceptorChain_initWithJavaUtilList_withOkhttp3InternalConnectionStreamAllocation_withOkhttp3InternalHttpHttpCodec_withOkhttp3Connection_withInt_withOkhttp3Request_(interceptors_, streamAllocation, httpCodec, connection, index_ + 1, request);
  ...
  if (httpCodec != nil && index_ + 1 < [interceptors_ size] && next->calls_ != 1) {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithJavaUtilList:withOkhttp3InternalConnectionStreamAllocation:withOkhttp3InternalHttpHttpCodec:withOkhttp3Connection:withInt:withOkhttp3Request:);
  ...
  methods[6].selector = @selector(proceedWithOkhttp3Request:withOkhttp3InternalConnectionStreamAllocation:withOkhttp3InternalHttpHttpCodec:withOkhttp3Connection:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "httpCodec_", "LOkhttp3InternalHttpHttpCodec;", .constantValue.asLong = 0, 0x12, -1, -1, -1, -1 },
  ...
  static const void *ptrTable[] = { "LJavaUtilList;LOkhttp3InternalConnectionStreamAllocation;LOkhttp3InternalHttpHttpCodec;LOkhttp3Connection;ILOkhttp3Request;", "(Ljava/util/List<Lokhttp3/Interceptor;>;Lokhttp3/internal/connection/StreamAllocation;Lokhttp3/internal/http/HttpCodec;Lokhttp3/Connection;ILokhttp3/Request;)V", "proceed", "LOkhttp3Request;", "LJavaIoIOException;", "LOkhttp3Request;LOkhttp3InternalConnectionStreamAllocation;LOkhttp3InternalHttpHttpCodec;LOkhttp3Connection;", "sameConnection", "LOkhttp3HttpUrl;", "Ljava/util/List<Lokhttp3/Interceptor;>;" };
...
void Okhttp3InternalHttpRealInterceptorChain_initWithJavaUtilList_withOkhttp3InternalConnectionStreamAllocation_withOkhttp3InternalHttpHttpCodec_withOkhttp3Connection_withInt_withOkhttp3Request_(Okhttp3InternalHttpRealInterceptorChain *self, id<JavaUtilList> interceptors, Okhttp3InternalConnectionStreamAllocation *streamAllocation, id<Okhttp3InternalHttpHttpCodec> httpCodec, id<Okhttp3Connection> connection, jint index, Okhttp3Request *request) {
  NSObject_init(self);
  ...
  JreStrongAssign(&self->httpCodec_, httpCodec);
  self->index_ = index;
  JreStrongAssign(&self->request_, request);
}

Okhttp3InternalHttpRealInterceptorChain *new_Okhttp3InternalHttpRealInterceptorChain_initWithJavaUtilList_withOkhttp3InternalConnectionStreamAllocation_withOkhttp3InternalHttpHttpCodec_withOkhttp3Connection_withInt_withOkhttp3Request_(id<JavaUtilList> interceptors, Okhttp3InternalConnectionStreamAllocation *streamAllocation, id<Okhttp3InternalHttpHttpCodec> httpCodec, id<Okhttp3Connection> connection, jint index, Okhttp3Request *request) {
  J2OBJC_NEW_IMPL(Okhttp3InternalHttpRealInterceptorChain, initWithJavaUtilList_withOkhttp3InternalConnectionStreamAllocation_withOkhttp3InternalHttpHttpCodec_withOkhttp3Connection_withInt_withOkhttp3Request_, interceptors, streamAllocation, httpCodec, connection, index, request)
}

Okhttp3InternalHttpRealInterceptorChain *create_Okhttp3InternalHttpRealInterceptorChain_initWithJavaUtilList_withOkhttp3InternalConnectionStreamAllocation_withOkhttp3InternalHttpHttpCodec_withOkhttp3Connection_withInt_withOkhttp3Request_(id<JavaUtilList> interceptors, Okhttp3InternalConnectionStreamAllocation *streamAllocation, id<Okhttp3InternalHttpHttpCodec> httpCodec, id<Okhttp3Connection> connection, jint index, Okhttp3Request *request) {
  J2OBJC_CREATE_IMPL(Okhttp3InternalHttpRealInterceptorChain, initWithJavaUtilList_withOkhttp3InternalConnectionStreamAllocation_withOkhttp3InternalHttpHttpCodec_withOkhttp3Connection_withInt_withOkhttp3Request_, interceptors, streamAllocation, httpCodec, connection, index, request)
}
