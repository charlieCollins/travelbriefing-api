...
//  source: ../target/dependency/okhttp3/internal/connection/RouteException.java
//
  ...
  if (self == [Okhttp3InternalConnectionRouteException class]) {
    {
      ...
      @try {
        m = [NSException_class_() getDeclaredMethod:@"addSuppressed" parameterTypes:[IOSObjectArray arrayWithObjects:(id[]){ NSException_class_() } count:1 type:IOSClass_class_()]];
      }
