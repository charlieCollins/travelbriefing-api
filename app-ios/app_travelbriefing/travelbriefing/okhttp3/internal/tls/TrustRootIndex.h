...
#endif
#ifdef INCLUDE_Okhttp3InternalTlsTrustRootIndex_AndroidTrustRootIndex
#define INCLUDE_Okhttp3InternalTlsTrustRootIndex 1
#endif
...
#if !defined (Okhttp3InternalTlsTrustRootIndex_AndroidTrustRootIndex_) && (INCLUDE_ALL_Okhttp3InternalTlsTrustRootIndex || defined(INCLUDE_Okhttp3InternalTlsTrustRootIndex_AndroidTrustRootIndex))
#define Okhttp3InternalTlsTrustRootIndex_AndroidTrustRootIndex_

@class JavaLangReflectMethod;
@class JavaSecurityCertX509Certificate;
@protocol JavaxNetSslX509TrustManager;

@interface Okhttp3InternalTlsTrustRootIndex_AndroidTrustRootIndex : Okhttp3InternalTlsTrustRootIndex
...
J2OBJC_EMPTY_STATIC_INIT(Okhttp3InternalTlsTrustRootIndex_AndroidTrustRootIndex)

FOUNDATION_EXPORT void Okhttp3InternalTlsTrustRootIndex_AndroidTrustRootIndex_initWithJavaxNetSslX509TrustManager_withJavaLangReflectMethod_(Okhttp3InternalTlsTrustRootIndex_AndroidTrustRootIndex *self, id<JavaxNetSslX509TrustManager> trustManager, JavaLangReflectMethod *findByIssuerAndSignatureMethod);

FOUNDATION_EXPORT Okhttp3InternalTlsTrustRootIndex_AndroidTrustRootIndex *new_Okhttp3InternalTlsTrustRootIndex_AndroidTrustRootIndex_initWithJavaxNetSslX509TrustManager_withJavaLangReflectMethod_(id<JavaxNetSslX509TrustManager> trustManager, JavaLangReflectMethod *findByIssuerAndSignatureMethod) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT Okhttp3InternalTlsTrustRootIndex_AndroidTrustRootIndex *create_Okhttp3InternalTlsTrustRootIndex_AndroidTrustRootIndex_initWithJavaxNetSslX509TrustManager_withJavaLangReflectMethod_(id<JavaxNetSslX509TrustManager> trustManager, JavaLangReflectMethod *findByIssuerAndSignatureMethod);

J2OBJC_TYPE_LITERAL_HEADER(Okhttp3InternalTlsTrustRootIndex_AndroidTrustRootIndex)
