...
inline Okhttp3ResponseBody *Okhttp3InternalUtil_get_EMPTY_RESPONSE();
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT Okhttp3ResponseBody *Okhttp3InternalUtil_EMPTY_RESPONSE;
J2OBJC_STATIC_FIELD_OBJ_FINAL(Okhttp3InternalUtil, EMPTY_RESPONSE, Okhttp3ResponseBody *)

inline Okhttp3RequestBody *Okhttp3InternalUtil_get_EMPTY_REQUEST();
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT Okhttp3RequestBody *Okhttp3InternalUtil_EMPTY_REQUEST;
J2OBJC_STATIC_FIELD_OBJ_FINAL(Okhttp3InternalUtil, EMPTY_REQUEST, Okhttp3RequestBody *)
...
FOUNDATION_EXPORT jint Okhttp3InternalUtil_indexOfControlOrNonAsciiWithNSString_(NSString *input);
...
FOUNDATION_EXPORT JavaNioCharsetCharset *Okhttp3InternalUtil_bomAwareCharsetWithOkioBufferedSource_withJavaNioCharsetCharset_(id<OkioBufferedSource> source, JavaNioCharsetCharset *charset);
