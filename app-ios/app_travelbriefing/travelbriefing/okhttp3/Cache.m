...
//  source: ../target/dependency/okhttp3/Cache.java
//
...
__attribute__((unused)) static void Okhttp3Cache_CacheRequestImpl_1_initWithOkhttp3Cache_CacheRequestImpl_withOkhttp3InternalCacheDiskLruCache_Editor_withOkioSink_(Okhttp3Cache_CacheRequestImpl_1 *self, Okhttp3Cache_CacheRequestImpl *outer$, Okhttp3InternalCacheDiskLruCache_Editor *capture$0, id<OkioSink> delegate);
...
__attribute__((unused)) static Okhttp3Cache_CacheRequestImpl_1 *create_Okhttp3Cache_CacheRequestImpl_1_initWithOkhttp3Cache_CacheRequestImpl_withOkhttp3InternalCacheDiskLruCache_Editor_withOkioSink_(Okhttp3Cache_CacheRequestImpl *outer$, Okhttp3InternalCacheDiskLruCache_Editor *capture$0, id<OkioSink> delegate);
...
__attribute__((unused)) static void Okhttp3Cache_CacheResponseBody_1_initWithOkhttp3InternalCacheDiskLruCache_Snapshot_withOkioSource_(Okhttp3Cache_CacheResponseBody_1 *self, Okhttp3InternalCacheDiskLruCache_Snapshot *capture$0, id<OkioSource> delegate);

__attribute__((unused)) static Okhttp3Cache_CacheResponseBody_1 *new_Okhttp3Cache_CacheResponseBody_1_initWithOkhttp3InternalCacheDiskLruCache_Snapshot_withOkioSource_(Okhttp3InternalCacheDiskLruCache_Snapshot *capture$0, id<OkioSource> delegate) NS_RETURNS_RETAINED;

__attribute__((unused)) static Okhttp3Cache_CacheResponseBody_1 *create_Okhttp3Cache_CacheResponseBody_1_initWithOkhttp3InternalCacheDiskLruCache_Snapshot_withOkioSource_(Okhttp3InternalCacheDiskLruCache_Snapshot *capture$0, id<OkioSource> delegate);
...
+ (NSString *)keyWithOkhttp3HttpUrl:(Okhttp3HttpUrl *)url {
  return Okhttp3Cache_keyWithOkhttp3HttpUrl_(url);
}

- (Okhttp3Response *)getWithOkhttp3Request:(Okhttp3Request *)request {
  NSString *key = Okhttp3Cache_keyWithOkhttp3HttpUrl_([((Okhttp3Request *) nil_chk(request)) url]);
...
- (id<Okhttp3InternalCacheCacheRequest>)putWithOkhttp3Response:(Okhttp3Response *)response {
  ...
  if (Okhttp3InternalHttpHttpMethod_invalidatesCacheWithNSString_([((Okhttp3Request *) nil_chk([response request])) method])) {
    @try {
      [self removeWithOkhttp3Request:[response request]];
    }
  ...
  @try {
    editor = [((Okhttp3InternalCacheDiskLruCache *) nil_chk(cache_)) editWithNSString:Okhttp3Cache_keyWithOkhttp3HttpUrl_([((Okhttp3Request *) nil_chk([response request])) url])];
    if (editor == nil) {
      return nil;
    }
...
- (void)removeWithOkhttp3Request:(Okhttp3Request *)request {
  [((Okhttp3InternalCacheDiskLruCache *) nil_chk(cache_)) removeWithNSString:Okhttp3Cache_keyWithOkhttp3HttpUrl_([((Okhttp3Request *) nil_chk(request)) url])];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LOkhttp3Response;", 0x0, 4, 5, -1, -1, -1, -1 },
    { NULL, "LOkhttp3InternalCacheCacheRequest;", 0x0, 6, 7, -1, -1, -1, -1 },
    { NULL, "V", 0x0, 8, 5, 9, -1, -1, -1 },
    { NULL, "V", 0x0, 10, 11, -1, -1, -1, -1 },
    { NULL, "V", 0x2, 12, 13, -1, -1, -1, -1 },
    { NULL, "V", 0x1, 14, -1, 9, -1, -1, -1 },
    { NULL, "V", 0x1, 15, -1, 9, -1, -1, -1 },
    { NULL, "V", 0x1, -1, -1, 9, -1, -1, -1 },
    { NULL, "LJavaUtilIterator;", 0x1, -1, -1, 9, 16, -1, -1 },
    { NULL, "I", 0x21, -1, -1, -1, -1, -1, -1 },
    { NULL, "I", 0x21, -1, -1, -1, -1, -1, -1 },
    { NULL, "J", 0x1, -1, -1, 9, -1, -1, -1 },
    { NULL, "J", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "V", 0x1, -1, -1, 9, -1, -1, -1 },
    { NULL, "V", 0x1, -1, -1, 9, -1, -1, -1 },
    { NULL, "LJavaIoFile;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "Z", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "V", 0x20, 17, 18, -1, -1, -1, -1 },
    { NULL, "V", 0x20, -1, -1, -1, -1, -1, -1 },
    { NULL, "I", 0x21, -1, -1, -1, -1, -1, -1 },
    { NULL, "I", 0x21, -1, -1, -1, -1, -1, -1 },
    { NULL, "I", 0x21, -1, -1, -1, -1, -1, -1 },
    { NULL, "I", 0x8, 19, 20, 9, -1, -1, -1 },
  };
  ...
  methods[2].selector = @selector(keyWithOkhttp3HttpUrl:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "cache_", "LOkhttp3InternalCacheDiskLruCache;", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
    { "writeSuccessCount_", "I", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "writeAbortCount_", "I", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
  ...
  static const void *ptrTable[] = { "LJavaIoFile;J", "LJavaIoFile;JLOkhttp3InternalIoFileSystem;", "key", "LOkhttp3HttpUrl;", "get", "LOkhttp3Request;", "put", "LOkhttp3Response;", "remove", "LJavaIoIOException;", "update", "LOkhttp3Response;LOkhttp3Response;", "abortQuietly", "LOkhttp3InternalCacheDiskLruCache_Editor;", "initialize", "delete", "()Ljava/util/Iterator<Ljava/lang/String;>;", "trackResponse", "LOkhttp3InternalCacheCacheStrategy;", "readInt", "LOkioBufferedSource;", "LOkhttp3Cache_CacheRequestImpl;LOkhttp3Cache_Entry;LOkhttp3Cache_CacheResponseBody;" };
  static const J2ObjcClassInfo _Okhttp3Cache = { "Cache", "okhttp3", ptrTable, methods, fields, 7, 0x11, 26, 11, -1, 21, -1, -1, -1 };
...
NSString *Okhttp3Cache_keyWithOkhttp3HttpUrl_(Okhttp3HttpUrl *url) {
  Okhttp3Cache_initialize();
  return [((OkioByteString *) nil_chk([((OkioByteString *) nil_chk(OkioByteString_encodeUtf8WithNSString_([((Okhttp3HttpUrl *) nil_chk(url)) description]))) md5])) hex];
}
...
jint Okhttp3Cache_readIntWithOkioBufferedSource_(id<OkioBufferedSource> source) {
  ...
  @catch (JavaLangNumberFormatException *e) {
    @throw create_JavaIoIOException_initWithNSString_([((JavaLangNumberFormatException *) nil_chk(e)) getMessage]);
  }
}
...
- (id<Okhttp3InternalCacheCacheRequest>)putWithOkhttp3Response:(Okhttp3Response *)response {
  return [this$0_ putWithOkhttp3Response:response];
}

- (void)removeWithOkhttp3Request:(Okhttp3Request *)request {
  [this$0_ removeWithOkhttp3Request:request];
}

- (void)updateWithOkhttp3Response:(Okhttp3Response *)cached
              withOkhttp3Response:(Okhttp3Response *)network {
  [this$0_ updateWithOkhttp3Response:cached withOkhttp3Response:network];
}

- (void)trackConditionalCacheHit {
  [this$0_ trackConditionalCacheHit];
}

- (void)trackResponseWithOkhttp3InternalCacheCacheStrategy:(Okhttp3InternalCacheCacheStrategy *)cacheStrategy {
  [this$0_ trackResponseWithOkhttp3InternalCacheCacheStrategy:cacheStrategy];
}
...
- (instancetype)initWithOkhttp3Cache_CacheRequestImpl:(Okhttp3Cache_CacheRequestImpl *)outer$
          withOkhttp3InternalCacheDiskLruCache_Editor:(Okhttp3InternalCacheDiskLruCache_Editor *)capture$0
                                         withOkioSink:(id<OkioSink>)delegate {
  Okhttp3Cache_CacheRequestImpl_1_initWithOkhttp3Cache_CacheRequestImpl_withOkhttp3InternalCacheDiskLruCache_Editor_withOkioSink_(self, outer$, capture$0, delegate);
  return self;
}
...
void Okhttp3Cache_CacheRequestImpl_1_initWithOkhttp3Cache_CacheRequestImpl_withOkhttp3InternalCacheDiskLruCache_Editor_withOkioSink_(Okhttp3Cache_CacheRequestImpl_1 *self, Okhttp3Cache_CacheRequestImpl *outer$, Okhttp3InternalCacheDiskLruCache_Editor *capture$0, id<OkioSink> delegate) {
  JreStrongAssign(&self->this$0_, outer$);
  JreStrongAssign(&self->val$editor_, capture$0);
  OkioForwardingSink_initWithOkioSink_(self, delegate);
}

Okhttp3Cache_CacheRequestImpl_1 *new_Okhttp3Cache_CacheRequestImpl_1_initWithOkhttp3Cache_CacheRequestImpl_withOkhttp3InternalCacheDiskLruCache_Editor_withOkioSink_(Okhttp3Cache_CacheRequestImpl *outer$, Okhttp3InternalCacheDiskLruCache_Editor *capture$0, id<OkioSink> delegate) {
  J2OBJC_NEW_IMPL(Okhttp3Cache_CacheRequestImpl_1, initWithOkhttp3Cache_CacheRequestImpl_withOkhttp3InternalCacheDiskLruCache_Editor_withOkioSink_, outer$, capture$0, delegate)
}

Okhttp3Cache_CacheRequestImpl_1 *create_Okhttp3Cache_CacheRequestImpl_1_initWithOkhttp3Cache_CacheRequestImpl_withOkhttp3InternalCacheDiskLruCache_Editor_withOkioSink_(Okhttp3Cache_CacheRequestImpl *outer$, Okhttp3InternalCacheDiskLruCache_Editor *capture$0, id<OkioSink> delegate) {
  J2OBJC_CREATE_IMPL(Okhttp3Cache_CacheRequestImpl_1, initWithOkhttp3Cache_CacheRequestImpl_withOkhttp3InternalCacheDiskLruCache_Editor_withOkioSink_, outer$, capture$0, delegate)
}
...
id<JavaUtilList> Okhttp3Cache_Entry_readCertificateListWithOkioBufferedSource_(Okhttp3Cache_Entry *self, id<OkioBufferedSource> source) {
  ...
  @catch (JavaSecurityCertCertificateException *e) {
    @throw create_JavaIoIOException_initWithNSString_([((JavaSecurityCertCertificateException *) nil_chk(e)) getMessage]);
  }
}
...
void Okhttp3Cache_Entry_writeCertListWithOkioBufferedSink_withJavaUtilList_(Okhttp3Cache_Entry *self, id<OkioBufferedSink> sink, id<JavaUtilList> certificates) {
  ...
  @catch (JavaSecurityCertCertificateEncodingException *e) {
    @throw create_JavaIoIOException_initWithNSString_([((JavaSecurityCertCertificateEncodingException *) nil_chk(e)) getMessage]);
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "snapshot_", "LOkhttp3InternalCacheDiskLruCache_Snapshot;", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
...
- (instancetype)initWithOkhttp3InternalCacheDiskLruCache_Snapshot:(Okhttp3InternalCacheDiskLruCache_Snapshot *)capture$0
                                                   withOkioSource:(id<OkioSource>)delegate {
  Okhttp3Cache_CacheResponseBody_1_initWithOkhttp3InternalCacheDiskLruCache_Snapshot_withOkioSource_(self, capture$0, delegate);
  return self;
}
...
void Okhttp3Cache_CacheResponseBody_1_initWithOkhttp3InternalCacheDiskLruCache_Snapshot_withOkioSource_(Okhttp3Cache_CacheResponseBody_1 *self, Okhttp3InternalCacheDiskLruCache_Snapshot *capture$0, id<OkioSource> delegate) {
  JreStrongAssign(&self->val$snapshot_, capture$0);
  OkioForwardingSource_initWithOkioSource_(self, delegate);
}

Okhttp3Cache_CacheResponseBody_1 *new_Okhttp3Cache_CacheResponseBody_1_initWithOkhttp3InternalCacheDiskLruCache_Snapshot_withOkioSource_(Okhttp3InternalCacheDiskLruCache_Snapshot *capture$0, id<OkioSource> delegate) {
  J2OBJC_NEW_IMPL(Okhttp3Cache_CacheResponseBody_1, initWithOkhttp3InternalCacheDiskLruCache_Snapshot_withOkioSource_, capture$0, delegate)
}

Okhttp3Cache_CacheResponseBody_1 *create_Okhttp3Cache_CacheResponseBody_1_initWithOkhttp3InternalCacheDiskLruCache_Snapshot_withOkioSource_(Okhttp3InternalCacheDiskLruCache_Snapshot *capture$0, id<OkioSource> delegate) {
  J2OBJC_CREATE_IMPL(Okhttp3Cache_CacheResponseBody_1, initWithOkhttp3InternalCacheDiskLruCache_Snapshot_withOkioSource_, capture$0, delegate)
}
