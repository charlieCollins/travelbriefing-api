...
FOUNDATION_EXPORT id<JavaUtilComparator> ComGoogleCommonPrimitivesBooleans_trueFirst();

FOUNDATION_EXPORT id<JavaUtilComparator> ComGoogleCommonPrimitivesBooleans_falseFirst();
