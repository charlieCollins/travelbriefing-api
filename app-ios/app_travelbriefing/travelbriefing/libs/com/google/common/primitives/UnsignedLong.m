...
//  source: ../target/dependency/com/google/common/primitives/UnsignedLong.java
//
...
- (jint)compareToWithId:(ComGoogleCommonPrimitivesUnsignedLong *)o {
  cast_chk(o, [ComGoogleCommonPrimitivesUnsignedLong class]);
...
+ (void)initialize {
  if (self == [ComGoogleCommonPrimitivesUnsignedLong class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonPrimitivesUnsignedLong_ZERO, new_ComGoogleCommonPrimitivesUnsignedLong_initWithLong_(0));
    JreStrongAssignAndConsume(&ComGoogleCommonPrimitivesUnsignedLong_ONE, new_ComGoogleCommonPrimitivesUnsignedLong_initWithLong_(1));
    JreStrongAssignAndConsume(&ComGoogleCommonPrimitivesUnsignedLong_MAX_VALUE, new_ComGoogleCommonPrimitivesUnsignedLong_initWithLong_(-1LL));
...
ComGoogleCommonPrimitivesUnsignedLong *ComGoogleCommonPrimitivesUnsignedLong_fromLongBitsWithLong_(jlong bits) {
  ...
  return create_ComGoogleCommonPrimitivesUnsignedLong_initWithLong_(bits);
}
