...
//  source: ../target/dependency/com/google/common/primitives/UnsignedInteger.java
//
...
- (jint)compareToWithId:(ComGoogleCommonPrimitivesUnsignedInteger *)other {
  cast_chk(other, [ComGoogleCommonPrimitivesUnsignedInteger class]);
...
+ (void)initialize {
  if (self == [ComGoogleCommonPrimitivesUnsignedInteger class]) {
    JreStrongAssign(&ComGoogleCommonPrimitivesUnsignedInteger_ZERO, ComGoogleCommonPrimitivesUnsignedInteger_fromIntBitsWithInt_(0));
    JreStrongAssign(&ComGoogleCommonPrimitivesUnsignedInteger_ONE, ComGoogleCommonPrimitivesUnsignedInteger_fromIntBitsWithInt_(1));
    JreStrongAssign(&ComGoogleCommonPrimitivesUnsignedInteger_MAX_VALUE, ComGoogleCommonPrimitivesUnsignedInteger_fromIntBitsWithInt_(-1));
...
ComGoogleCommonPrimitivesUnsignedInteger *ComGoogleCommonPrimitivesUnsignedInteger_fromIntBitsWithInt_(jint bits) {
  ...
  return create_ComGoogleCommonPrimitivesUnsignedInteger_initWithInt_(bits);
}
