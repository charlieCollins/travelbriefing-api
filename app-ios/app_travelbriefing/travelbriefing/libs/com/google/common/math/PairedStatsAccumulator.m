...
//  source: ../target/dependency/com/google/common/math/PairedStatsAccumulator.java
//
...
- (ComGoogleCommonMathPairedStats *)snapshot {
  return create_ComGoogleCommonMathPairedStats_initWithComGoogleCommonMathStats_withComGoogleCommonMathStats_withDouble_([((ComGoogleCommonMathStatsAccumulator *) nil_chk(xStats_)) snapshot], [((ComGoogleCommonMathStatsAccumulator *) nil_chk(yStats_)) snapshot], sumOfProductsOfDeltas_);
}
...
void ComGoogleCommonMathPairedStatsAccumulator_init(ComGoogleCommonMathPairedStatsAccumulator *self) {
  NSObject_init(self);
  JreStrongAssignAndConsume(&self->xStats_, new_ComGoogleCommonMathStatsAccumulator_init());
  JreStrongAssignAndConsume(&self->yStats_, new_ComGoogleCommonMathStatsAccumulator_init());
