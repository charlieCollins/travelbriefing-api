...
//  source: ../target/dependency/com/google/common/collect/ConcurrentHashMultiset.java
//
...
- (jint)addWithId:(id)element
  ...
  while (true) {
    ...
    if (existingCounter == nil) {
      existingCounter = [((id<JavaUtilConcurrentConcurrentMap>) nil_chk(countMap_)) putIfAbsentWithId:element withId:create_JavaUtilConcurrentAtomicAtomicInteger_initWithInt_(occurrences)];
      if (existingCounter == nil) {
        return 0;
      }
    }
    while (true) {
      ...
      if (oldValue != 0) {
        ...
        @catch (JavaLangArithmeticException *overflow) {
          @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$I$I", @"Overflow adding ", occurrences, @" occurrences to a count of ", oldValue));
        }
      }
      else {
        JavaUtilConcurrentAtomicAtomicInteger *newCounter = create_JavaUtilConcurrentAtomicAtomicInteger_initWithInt_(occurrences);
  ...
  while (true) {
    ...
    if (existingCounter == nil) {
      if (count == 0) {
        ...
        existingCounter = [((id<JavaUtilConcurrentConcurrentMap>) nil_chk(countMap_)) putIfAbsentWithId:element withId:create_JavaUtilConcurrentAtomicAtomicInteger_initWithInt_(count)];
        if (existingCounter == nil) {
          return 0;
        }
      }
    ...
    while (true) {
      ...
      if (oldValue == 0) {
        if (count == 0) {
          ...
          JavaUtilConcurrentAtomicAtomicInteger *newCounter = create_JavaUtilConcurrentAtomicAtomicInteger_initWithInt_(count);
          if (([((id<JavaUtilConcurrentConcurrentMap>) nil_chk(countMap_)) putIfAbsentWithId:element withId:newCounter] == nil) || [countMap_ replaceWithId:element withId:existingCounter withId:newCounter]) {
            return 0;
          }
        }
...
- (jboolean)setCountWithId:(id)element
  ...
  if (existingCounter == nil) {
    if (expectedOldCount != 0) {
      ...
      return [((id<JavaUtilConcurrentConcurrentMap>) nil_chk(countMap_)) putIfAbsentWithId:element withId:create_JavaUtilConcurrentAtomicAtomicInteger_initWithInt_(newCount)] == nil;
    }
  }
  jint oldValue = [existingCounter get];
  if (oldValue == expectedOldCount) {
    if (oldValue == 0) {
      if (newCount == 0) {
        ...
        JavaUtilConcurrentAtomicAtomicInteger *newCounter = create_JavaUtilConcurrentAtomicAtomicInteger_initWithInt_(newCount);
...
- (id<JavaUtilSet>)createElementSet {
  ...
  return create_ComGoogleCommonCollectConcurrentHashMultiset_1_initWithJavaUtilSet_(delegate);
}

- (id<JavaUtilSet>)createEntrySet {
  return create_ComGoogleCommonCollectConcurrentHashMultiset_EntrySet_initWithComGoogleCommonCollectConcurrentHashMultiset_(self);
}
...
- (id<JavaUtilIterator>)entryIterator {
  id<JavaUtilIterator> readOnlyIterator = create_ComGoogleCommonCollectConcurrentHashMultiset_2_initWithComGoogleCommonCollectConcurrentHashMultiset_(self);
  return create_ComGoogleCommonCollectConcurrentHashMultiset_3_initWithComGoogleCommonCollectConcurrentHashMultiset_withJavaUtilIterator_(self, readOnlyIterator);
}
...
ComGoogleCommonCollectConcurrentHashMultiset *ComGoogleCommonCollectConcurrentHashMultiset_create() {
  ...
  return create_ComGoogleCommonCollectConcurrentHashMultiset_initWithJavaUtilConcurrentConcurrentMap_(create_JavaUtilConcurrentConcurrentHashMap_init());
}
...
ComGoogleCommonCollectConcurrentHashMultiset *ComGoogleCommonCollectConcurrentHashMultiset_createWithJavaUtilConcurrentConcurrentMap_(id<JavaUtilConcurrentConcurrentMap> countMap) {
  ComGoogleCommonCollectConcurrentHashMultiset_initialize();
  return create_ComGoogleCommonCollectConcurrentHashMultiset_initWithJavaUtilConcurrentConcurrentMap_(countMap);
}
...
void ComGoogleCommonCollectConcurrentHashMultiset_initWithJavaUtilConcurrentConcurrentMap_(ComGoogleCommonCollectConcurrentHashMultiset *self, id<JavaUtilConcurrentConcurrentMap> countMap) {
  ...
  JreStrongAssign(&self->countMap_, countMap);
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonCollectConcurrentHashMultiset_FieldSettersHolder class]) {
    JreStrongAssign(&ComGoogleCommonCollectConcurrentHashMultiset_FieldSettersHolder_COUNT_MAP_FIELD_SETTER, ComGoogleCommonCollectSerialization_getFieldSetterWithIOSClass_withNSString_(ComGoogleCommonCollectConcurrentHashMultiset_class_(), @"countMap"));
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonCollectConcurrentHashMultiset_1 = { "", "com.google.common.collect", ptrTable, methods, fields, 7, 0x8008, 6, 1, 10, -1, 11, 12, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonCollectConcurrentHashMultiset_2 = { "", "com.google.common.collect", ptrTable, methods, fields, 7, 0x8008, 2, 1, 2, -1, 3, 4, -1 };
...
void ComGoogleCommonCollectConcurrentHashMultiset_2_initWithComGoogleCommonCollectConcurrentHashMultiset_(ComGoogleCommonCollectConcurrentHashMultiset_2 *self, ComGoogleCommonCollectConcurrentHashMultiset *outer$) {
  ...
  JreStrongAssign(&self->mapEntries_, [((id<JavaUtilSet>) nil_chk([((id<JavaUtilConcurrentConcurrentMap>) nil_chk(outer$->countMap_)) entrySet])) iterator]);
}
...
- (id<ComGoogleCommonCollectMultiset_Entry>)next {
  JreStrongAssign(&last_, [super next]);
  return last_;
}
...
- (void)remove {
  ...
  JreStrongAssign(&last_, nil);
}

- (void)dealloc {
  RELEASE_(this$0_);
  RELEASE_(val$readOnlyIterator_);
  RELEASE_(last_);
  [super dealloc];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonCollectConcurrentHashMultiset_3 = { "", "com.google.common.collect", ptrTable, methods, fields, 7, 0x8008, 4, 3, 5, -1, 6, 7, -1 };
...
void ComGoogleCommonCollectConcurrentHashMultiset_3_initWithComGoogleCommonCollectConcurrentHashMultiset_withJavaUtilIterator_(ComGoogleCommonCollectConcurrentHashMultiset_3 *self, ComGoogleCommonCollectConcurrentHashMultiset *outer$, id<JavaUtilIterator> capture$0) {
  ...
  JreStrongAssign(&self->val$readOnlyIterator_, capture$0);
