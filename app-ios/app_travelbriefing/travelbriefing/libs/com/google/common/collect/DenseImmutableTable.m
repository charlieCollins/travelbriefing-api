...
//  source: ../target/dependency/com/google/common/collect/DenseImmutableTable.java
//
...
- (void)dealloc {
  ...
  RELEASE_(columnMap_);
  RELEASE_(rowCounts_);
  RELEASE_(columnCounts_);
  RELEASE_(values_DenseImmutableTable_);
...
void ComGoogleCommonCollectDenseImmutableTable_initWithComGoogleCommonCollectImmutableList_withComGoogleCommonCollectImmutableSet_withComGoogleCommonCollectImmutableSet_(ComGoogleCommonCollectDenseImmutableTable *self, ComGoogleCommonCollectImmutableList *cellList, ComGoogleCommonCollectImmutableSet *rowSpace, ComGoogleCommonCollectImmutableSet *columnSpace) {
  ...
  IOSObjectArray *array = [IOSObjectArray arrayWithDimensions:2 lengths:(jint[]){ [((ComGoogleCommonCollectImmutableSet *) nil_chk(rowSpace)) size], [((ComGoogleCommonCollectImmutableSet *) nil_chk(columnSpace)) size] } type:NSObject_class_()];
  JreStrongAssign(&self->values_DenseImmutableTable_, array);
  ...
  JreStrongAssignAndConsume(&self->rowCounts_, [IOSIntArray newArrayWithLength:[((ComGoogleCommonCollectImmutableMap *) nil_chk(self->rowKeyToIndex_)) size]]);
  JreStrongAssignAndConsume(&self->columnCounts_, [IOSIntArray newArrayWithLength:[((ComGoogleCommonCollectImmutableMap *) nil_chk(self->columnKeyToIndex_)) size]]);
  IOSIntArray *cellRowIndices = [IOSIntArray arrayWithLength:[((ComGoogleCommonCollectImmutableList *) nil_chk(cellList)) size]];
  IOSIntArray *cellColumnIndices = [IOSIntArray arrayWithLength:[cellList size]];
  for (jint i = 0; i < [cellList size]; i++) {
    ...
    IOSObjectArray_Set(nil_chk(IOSObjectArray_Get(self->values_DenseImmutableTable_, rowIndex)), columnIndex, [cell getValue]);
  ...
  JreStrongAssignAndConsume(&self->rowMap_, new_ComGoogleCommonCollectDenseImmutableTable_RowMap_initWithComGoogleCommonCollectDenseImmutableTable_(self));
  JreStrongAssignAndConsume(&self->columnMap_, new_ComGoogleCommonCollectDenseImmutableTable_ColumnMap_initWithComGoogleCommonCollectDenseImmutableTable_(self));
}
...
- (ComGoogleCommonCollectUnmodifiableIterator *)entryIterator {
  return create_ComGoogleCommonCollectDenseImmutableTable_ImmutableArrayMap_1_initWithComGoogleCommonCollectDenseImmutableTable_ImmutableArrayMap_(self);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonCollectDenseImmutableTable_ImmutableArrayMap_1 = { "", "com.google.common.collect", ptrTable, methods, fields, 7, 0x8008, 2, 3, 2, -1, 3, 4, -1 };
...
- (id<JavaUtilMap>)getValueWithInt:(jint)keyIndex {
  return create_ComGoogleCommonCollectDenseImmutableTable_Row_initWithComGoogleCommonCollectDenseImmutableTable_withInt_(this$0_, keyIndex);
}
...
- (id<JavaUtilMap>)getValueWithInt:(jint)keyIndex {
  return create_ComGoogleCommonCollectDenseImmutableTable_Column_initWithComGoogleCommonCollectDenseImmutableTable_withInt_(this$0_, keyIndex);
}
