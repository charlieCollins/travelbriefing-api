...
//  source: ../target/dependency/com/google/common/collect/AbstractMapBasedMultiset.java
//
...
- (id<JavaUtilIterator>)entryIterator {
  ...
  return create_ComGoogleCommonCollectAbstractMapBasedMultiset_1_initWithComGoogleCommonCollectAbstractMapBasedMultiset_withJavaUtilIterator_(self, backingEntries);
}
...
- (void)forEachEntryWithJavaUtilFunctionObjIntConsumer:(id<JavaUtilFunctionObjIntConsumer>)action {
  ...
  [((id<JavaUtilMap>) nil_chk(backingMap_)) forEachWithJavaUtilFunctionBiConsumer:create_ComGoogleCommonCollectAbstractMapBasedMultiset_$Lambda$1_initWithJavaUtilFunctionObjIntConsumer_(action)];
}
...
- (id<JavaUtilIterator>)iterator {
  return create_ComGoogleCommonCollectAbstractMapBasedMultiset_MapBasedMultisetIterator_initWithComGoogleCommonCollectAbstractMapBasedMultiset_(self);
}
...
- (jint)addWithId:(id)element
  ...
  if (frequency == nil) {
    oldCount = 0;
    [((id<JavaUtilMap>) nil_chk(backingMap_)) putWithId:element withId:create_ComGoogleCommonCollectCount_initWithInt_(occurrences)];
  }
  else {
...
- (jint)removeWithId:(id)element
  ...
  if (oldCount > occurrences) {
    ...
    [((id<JavaUtilMap>) nil_chk(backingMap_)) removeWithId:element];
  }
...
- (jint)setCountWithId:(id)element
  ...
  if (count == 0) {
    ...
    if (existingCounter == nil) {
      [((id<JavaUtilMap>) nil_chk(backingMap_)) putWithId:element withId:create_ComGoogleCommonCollectCount_initWithInt_(count)];
    }
  }
...
- (void)readObjectNoData {
  @throw create_JavaIoInvalidObjectException_initWithNSString_(@"Stream data required");
}
...
void ComGoogleCommonCollectAbstractMapBasedMultiset_initWithJavaUtilMap_(ComGoogleCommonCollectAbstractMapBasedMultiset *self, id<JavaUtilMap> backingMap) {
  ...
  JreStrongAssign(&self->backingMap_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(backingMap));
...
- (id<ComGoogleCommonCollectMultiset_Entry>)next {
  ...
  JreStrongAssign(&toRemove_, mapEntry);
  return create_ComGoogleCommonCollectAbstractMapBasedMultiset_1_1_initWithComGoogleCommonCollectAbstractMapBasedMultiset_1_withJavaUtilMap_Entry_(self, mapEntry);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonCollectAbstractMapBasedMultiset_1 = { "", "com.google.common.collect", ptrTable, methods, fields, 7, 0x8008, 4, 3, 4, -1, 5, 6, -1 };
...
void ComGoogleCommonCollectAbstractMapBasedMultiset_1_initWithComGoogleCommonCollectAbstractMapBasedMultiset_withJavaUtilIterator_(ComGoogleCommonCollectAbstractMapBasedMultiset_1 *self, ComGoogleCommonCollectAbstractMapBasedMultiset *outer$, id<JavaUtilIterator> capture$0) {
  ...
  JreStrongAssign(&self->val$backingEntries_, capture$0);
  NSObject_init(self);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonCollectAbstractMapBasedMultiset_1_1 = { "", "com.google.common.collect", ptrTable, methods, fields, 7, 0x8008, 3, 2, 2, -1, 3, 4, -1 };
...
void ComGoogleCommonCollectAbstractMapBasedMultiset_1_1_initWithComGoogleCommonCollectAbstractMapBasedMultiset_1_withJavaUtilMap_Entry_(ComGoogleCommonCollectAbstractMapBasedMultiset_1_1 *self, ComGoogleCommonCollectAbstractMapBasedMultiset_1 *outer$, id<JavaUtilMap_Entry> capture$0) {
  JreStrongAssign(&self->this$0_, outer$);
  JreStrongAssign(&self->val$mapEntry_, capture$0);
...
void ComGoogleCommonCollectAbstractMapBasedMultiset_MapBasedMultisetIterator_initWithComGoogleCommonCollectAbstractMapBasedMultiset_(ComGoogleCommonCollectAbstractMapBasedMultiset_MapBasedMultisetIterator *self, ComGoogleCommonCollectAbstractMapBasedMultiset *outer$) {
  JreStrongAssign(&self->this$0_, outer$);
  NSObject_init(self);
  JreStrongAssign(&self->entryIterator_, [((id<JavaUtilSet>) nil_chk([((id<JavaUtilMap>) nil_chk(outer$->backingMap_)) entrySet])) iterator]);
}
