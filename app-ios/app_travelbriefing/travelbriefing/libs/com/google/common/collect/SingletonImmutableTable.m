...
//  source: ../target/dependency/com/google/common/collect/SingletonImmutableTable.java
//
...
- (ComGoogleCommonCollectImmutableTable_SerializedForm *)createSerializedForm {
  return ComGoogleCommonCollectImmutableTable_SerializedForm_createWithComGoogleCommonCollectImmutableTable_withIntArray_withIntArray_(self, [IOSIntArray arrayWithInts:(jint[]){ 0 } count:1], [IOSIntArray arrayWithInts:(jint[]){ 0 } count:1]);
}

- (void)dealloc {
  RELEASE_(singleRowKey_);
  RELEASE_(singleColumnKey_);
...
void ComGoogleCommonCollectSingletonImmutableTable_initWithId_withId_withId_(ComGoogleCommonCollectSingletonImmutableTable *self, id rowKey, id columnKey, id value) {
  ...
  JreStrongAssign(&self->singleRowKey_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(rowKey));
  JreStrongAssign(&self->singleColumnKey_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(columnKey));
  JreStrongAssign(&self->singleValue_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(value));
}
