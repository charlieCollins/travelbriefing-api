...
//  source: ../target/dependency/com/google/common/collect/MinMaxPriorityQueue.java
//
...
- (ComGoogleCommonCollectMinMaxPriorityQueue_MoveDesc *)removeAtWithInt:(jint)index {
  ...
  size_--;
  if (size_ == index) {
    IOSObjectArray_Set(nil_chk(queue_), size_, nil);
    return nil;
  }
  ...
  if (lastElementAt < index) {
    if (changes == nil) {
      return create_ComGoogleCommonCollectMinMaxPriorityQueue_MoveDesc_initWithId_withId_(actualLastElement, toTrickle);
    }
    else {
      return create_ComGoogleCommonCollectMinMaxPriorityQueue_MoveDesc_initWithId_withId_(actualLastElement, changes->replaced_);
    }
  }
  return changes;
}
...
- (id<JavaUtilIterator>)iterator {
  return create_ComGoogleCommonCollectMinMaxPriorityQueue_QueueIterator_initWithComGoogleCommonCollectMinMaxPriorityQueue_(self);
}

- (void)clear {
  for (jint i = 0; i < size_; i++) {
    IOSObjectArray_Set(nil_chk(queue_), i, nil);
  }
  size_ = 0;
}

- (IOSObjectArray *)toArray {
  IOSObjectArray *copyTo = [IOSObjectArray arrayWithLength:size_ type:NSObject_class_()];
...
ComGoogleCommonCollectMinMaxPriorityQueue *ComGoogleCommonCollectMinMaxPriorityQueue_create() {
  ...
  return [create_ComGoogleCommonCollectMinMaxPriorityQueue_Builder_initWithJavaUtilComparator_(ComGoogleCommonCollectOrdering_natural()) create];
}
...
ComGoogleCommonCollectMinMaxPriorityQueue *ComGoogleCommonCollectMinMaxPriorityQueue_createWithJavaLangIterable_(id<JavaLangIterable> initialContents) {
  ComGoogleCommonCollectMinMaxPriorityQueue_initialize();
  return [create_ComGoogleCommonCollectMinMaxPriorityQueue_Builder_initWithJavaUtilComparator_(ComGoogleCommonCollectOrdering_natural()) createWithJavaLangIterable:initialContents];
}
...
ComGoogleCommonCollectMinMaxPriorityQueue_Builder *ComGoogleCommonCollectMinMaxPriorityQueue_orderedByWithJavaUtilComparator_(id<JavaUtilComparator> comparator) {
  ComGoogleCommonCollectMinMaxPriorityQueue_initialize();
  return create_ComGoogleCommonCollectMinMaxPriorityQueue_Builder_initWithJavaUtilComparator_(comparator);
}
...
ComGoogleCommonCollectMinMaxPriorityQueue_Builder *ComGoogleCommonCollectMinMaxPriorityQueue_expectedSizeWithInt_(jint expectedSize) {
  ComGoogleCommonCollectMinMaxPriorityQueue_initialize();
  return [create_ComGoogleCommonCollectMinMaxPriorityQueue_Builder_initWithJavaUtilComparator_(ComGoogleCommonCollectOrdering_natural()) expectedSizeWithInt:expectedSize];
}
...
ComGoogleCommonCollectMinMaxPriorityQueue_Builder *ComGoogleCommonCollectMinMaxPriorityQueue_maximumSizeWithInt_(jint maximumSize) {
  ComGoogleCommonCollectMinMaxPriorityQueue_initialize();
  return [create_ComGoogleCommonCollectMinMaxPriorityQueue_Builder_initWithJavaUtilComparator_(ComGoogleCommonCollectOrdering_natural()) maximumSizeWithInt:maximumSize];
}
...
void ComGoogleCommonCollectMinMaxPriorityQueue_initWithComGoogleCommonCollectMinMaxPriorityQueue_Builder_withInt_(ComGoogleCommonCollectMinMaxPriorityQueue *self, ComGoogleCommonCollectMinMaxPriorityQueue_Builder *builder, jint queueSize) {
  ...
  JreStrongAssignAndConsume(&self->minHeap_, new_ComGoogleCommonCollectMinMaxPriorityQueue_Heap_initWithComGoogleCommonCollectMinMaxPriorityQueue_withComGoogleCommonCollectOrdering_(self, ordering));
  JreStrongAssignAndConsume(&self->maxHeap_, new_ComGoogleCommonCollectMinMaxPriorityQueue_Heap_initWithComGoogleCommonCollectMinMaxPriorityQueue_withComGoogleCommonCollectOrdering_(self, [((ComGoogleCommonCollectOrdering *) nil_chk(ordering)) reverse]));
  self->minHeap_->otherHeap_ = self->maxHeap_;
  self->maxHeap_->otherHeap_ = self->minHeap_;
  self->maximumSize_ = builder->maximumSize_;
  JreStrongAssignAndConsume(&self->queue_, [IOSObjectArray newArrayWithLength:queueSize type:NSObject_class_()]);
}
...
ComGoogleCommonCollectMinMaxPriorityQueue_MoveDesc *ComGoogleCommonCollectMinMaxPriorityQueue_fillHoleWithInt_withId_(ComGoogleCommonCollectMinMaxPriorityQueue *self, jint index, id toTrickle) {
  ...
  if (bubbledTo == vacated) {
    ...
    return (bubbledTo < index) ? create_ComGoogleCommonCollectMinMaxPriorityQueue_MoveDesc_initWithId_withId_(toTrickle, [self elementDataWithInt:index]) : nil;
  }
}
...
void ComGoogleCommonCollectMinMaxPriorityQueue_growIfNeeded(ComGoogleCommonCollectMinMaxPriorityQueue *self) {
  if (self->size_ > ((IOSObjectArray *) nil_chk(self->queue_))->size_) {
    ...
    IOSObjectArray *newQueue = [IOSObjectArray arrayWithLength:newCapacity type:NSObject_class_()];
    ...
    JreStrongAssign(&self->queue_, newQueue);
  }
}
...
void ComGoogleCommonCollectMinMaxPriorityQueue_MoveDesc_initWithId_withId_(ComGoogleCommonCollectMinMaxPriorityQueue_MoveDesc *self, id toTrickle, id replaced) {
  NSObject_init(self);
  JreStrongAssign(&self->toTrickle_, toTrickle);
  JreStrongAssign(&self->replaced_, replaced);
}
...
- (ComGoogleCommonCollectMinMaxPriorityQueue_MoveDesc *)tryCrossOverAndBubbleUpWithInt:(jint)removeIndex
  ...
  if ([((ComGoogleCommonCollectMinMaxPriorityQueue_Heap *) nil_chk(otherHeap_)) bubbleUpAlternatingLevelsWithInt:crossOver withId:toTrickle] < removeIndex) {
    return create_ComGoogleCommonCollectMinMaxPriorityQueue_MoveDesc_initWithId_withId_(toTrickle, parent);
  }
  else {
    return nil;
  }
...
- (jint)bubbleUpAlternatingLevelsWithInt:(jint)index
  ...
  while (index > 2) {
    ...
    IOSObjectArray_Set(nil_chk(this$0_->queue_), index, e);
    index = grandParentIndex;
  }
  IOSObjectArray_Set(nil_chk(this$0_->queue_), index, x);
  return index;
}
...
- (jint)crossOverUpWithInt:(jint)index
                    withId:(id)x {
  if (index == 0) {
    IOSObjectArray_Set(nil_chk(this$0_->queue_), 0, x);
    return 0;
  }
  ...
  if ([((ComGoogleCommonCollectOrdering *) nil_chk(ordering_)) compareWithId:parentElement withId:x] < 0) {
    IOSObjectArray_Set(nil_chk(this$0_->queue_), index, parentElement);
    IOSObjectArray_Set(this$0_->queue_, parentIndex, x);
    return parentIndex;
  }
  IOSObjectArray_Set(nil_chk(this$0_->queue_), index, x);
  return index;
  ...
  if (parentIndex != 0) {
    ...
    if (uncleIndex != parentIndex && ComGoogleCommonCollectMinMaxPriorityQueue_Heap_getLeftChildIndexWithInt_(self, uncleIndex) >= this$0_->size_) {
      ...
      if ([((ComGoogleCommonCollectOrdering *) nil_chk(ordering_)) compareWithId:uncleElement withId:actualLastElement] < 0) {
        IOSObjectArray_Set(nil_chk(this$0_->queue_), uncleIndex, actualLastElement);
        IOSObjectArray_Set(this$0_->queue_, this$0_->size_, uncleElement);
        return uncleIndex;
      }
    }
  }
...
- (jint)crossOverWithInt:(jint)index
  ...
  if ((minChildIndex > 0) && ([((ComGoogleCommonCollectOrdering *) nil_chk(ordering_)) compareWithId:[this$0_ elementDataWithInt:minChildIndex] withId:x] < 0)) {
    IOSObjectArray_Set(nil_chk(this$0_->queue_), index, [this$0_ elementDataWithInt:minChildIndex]);
    IOSObjectArray_Set(nil_chk(this$0_->queue_), minChildIndex, x);
...
- (jint)fillHoleAtWithInt:(jint)index {
  ...
  while ((minGrandchildIndex = [self findMinGrandChildWithInt:index]) > 0) {
    IOSObjectArray_Set(nil_chk(this$0_->queue_), index, [this$0_ elementDataWithInt:minGrandchildIndex]);
...
void ComGoogleCommonCollectMinMaxPriorityQueue_Heap_initWithComGoogleCommonCollectMinMaxPriorityQueue_withComGoogleCommonCollectOrdering_(ComGoogleCommonCollectMinMaxPriorityQueue_Heap *self, ComGoogleCommonCollectMinMaxPriorityQueue *outer$, ComGoogleCommonCollectOrdering *ordering) {
  self->this$0_ = outer$;
  NSObject_init(self);
  JreStrongAssign(&self->ordering_, ordering);
}
...
- (id)next {
  ...
  if (nextCursor_ < [this$0_ size]) {
    ...
    JreStrongAssign(&lastFromForgetMeNot_, [((id<JavaUtilQueue>) nil_chk(forgetMeNot_)) poll]);
    if (lastFromForgetMeNot_ != nil) {
      canRemove_ = true;
      return lastFromForgetMeNot_;
    }
  }
  @throw create_JavaUtilNoSuchElementException_initWithNSString_(@"iterator moved past last element in queue.");
}
...
- (void)remove {
  ...
  if (cursor_ < [this$0_ size]) {
    ...
    if (moved != nil) {
      if (forgetMeNot_ == nil) {
        JreStrongAssignAndConsume(&forgetMeNot_, new_JavaUtilArrayDeque_init());
        JreStrongAssignAndConsume(&skipMe_, new_JavaUtilArrayList_initWithInt_(3));
      }
    ...
    JreStrongAssign(&lastFromForgetMeNot_, nil);
  }
}
...
- (void)dealloc {
  RELEASE_(this$0_);
  RELEASE_(forgetMeNot_);
  RELEASE_(skipMe_);
  RELEASE_(lastFromForgetMeNot_);
  [super dealloc];
}
...
jboolean ComGoogleCommonCollectMinMaxPriorityQueue_QueueIterator_removeExactWithId_(ComGoogleCommonCollectMinMaxPriorityQueue_QueueIterator *self, id target) {
  for (jint i = 0; i < self->this$0_->size_; i++) {
    if (IOSObjectArray_Get(nil_chk(self->this$0_->queue_), i) == target) {
      [self->this$0_ removeAtWithInt:i];
      return true;
    }
  }
  return false;
