...
inline jint ComGoogleCommonCollectImmutableSet_get_SPLITERATOR_CHARACTERISTICS();
...
FOUNDATION_EXPORT id<JavaUtilStreamCollector> ComGoogleCommonCollectImmutableSet_toImmutableSet();
