...
//  source: ../target/dependency/com/google/common/collect/Ordering.java
//
...
- (ComGoogleCommonCollectOrdering *)reverse {
  return create_ComGoogleCommonCollectReverseOrdering_initWithComGoogleCommonCollectOrdering_(self);
}

- (ComGoogleCommonCollectOrdering *)nullsFirst {
  return create_ComGoogleCommonCollectNullsFirstOrdering_initWithComGoogleCommonCollectOrdering_(self);
}

- (ComGoogleCommonCollectOrdering *)nullsLast {
  return create_ComGoogleCommonCollectNullsLastOrdering_initWithComGoogleCommonCollectOrdering_(self);
}

- (ComGoogleCommonCollectOrdering *)onResultOfWithComGoogleCommonBaseFunction:(id<ComGoogleCommonBaseFunction>)function {
  return create_ComGoogleCommonCollectByFunctionOrdering_initWithComGoogleCommonBaseFunction_withComGoogleCommonCollectOrdering_(function, self);
}
...
- (ComGoogleCommonCollectOrdering *)compoundWithJavaUtilComparator:(id<JavaUtilComparator>)secondaryComparator {
  return create_ComGoogleCommonCollectCompoundOrdering_initWithJavaUtilComparator_withJavaUtilComparator_(self, ComGoogleCommonBasePreconditions_checkNotNullWithId_(secondaryComparator));
}
...
- (ComGoogleCommonCollectOrdering *)lexicographical {
  return create_ComGoogleCommonCollectLexicographicalOrdering_initWithJavaUtilComparator_(self);
}
...
ComGoogleCommonCollectOrdering *ComGoogleCommonCollectOrdering_fromWithJavaUtilComparator_(id<JavaUtilComparator> comparator) {
  ComGoogleCommonCollectOrdering_initialize();
  return ([comparator isKindOfClass:[ComGoogleCommonCollectOrdering class]]) ? (ComGoogleCommonCollectOrdering *) cast_chk(comparator, [ComGoogleCommonCollectOrdering class]) : create_ComGoogleCommonCollectComparatorOrdering_initWithJavaUtilComparator_(comparator);
}
...
ComGoogleCommonCollectOrdering *ComGoogleCommonCollectOrdering_explicit__WithJavaUtilList_(id<JavaUtilList> valuesInOrder) {
  ComGoogleCommonCollectOrdering_initialize();
  return create_ComGoogleCommonCollectExplicitOrdering_initWithJavaUtilList_(valuesInOrder);
}
...
ComGoogleCommonCollectOrdering *ComGoogleCommonCollectOrdering_compoundWithJavaLangIterable_(id<JavaLangIterable> comparators) {
  ComGoogleCommonCollectOrdering_initialize();
  return create_ComGoogleCommonCollectCompoundOrdering_initWithJavaLangIterable_(comparators);
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonCollectOrdering_ArbitraryOrderingHolder class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonCollectOrdering_ArbitraryOrderingHolder_ARBITRARY_ORDERING, new_ComGoogleCommonCollectOrdering_ArbitraryOrdering_init());
...
void ComGoogleCommonCollectOrdering_ArbitraryOrdering_init(ComGoogleCommonCollectOrdering_ArbitraryOrdering *self) {
  ComGoogleCommonCollectOrdering_init(self);
  JreStrongAssignAndConsume(&self->counter_, new_JavaUtilConcurrentAtomicAtomicInteger_initWithInt_(0));
  JreStrongAssign(&self->uids_, [((ComGoogleCommonCollectMapMaker *) nil_chk(ComGoogleCommonCollectPlatform_tryWeakKeysWithComGoogleCommonCollectMapMaker_(create_ComGoogleCommonCollectMapMaker_init()))) makeMap]);
}
