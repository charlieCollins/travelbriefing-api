...
//  source: ../target/dependency/com/google/common/util/concurrent/Monitor.java
//
...
- (instancetype)initWithJavaUtilFunctionBooleanSupplier:(id<JavaUtilFunctionBooleanSupplier>)capture$0
               withComGoogleCommonUtilConcurrentMonitor:(ComGoogleCommonUtilConcurrentMonitor *)param0;
...
__attribute__((unused)) static void ComGoogleCommonUtilConcurrentMonitor_1_initWithJavaUtilFunctionBooleanSupplier_withComGoogleCommonUtilConcurrentMonitor_(ComGoogleCommonUtilConcurrentMonitor_1 *self, id<JavaUtilFunctionBooleanSupplier> capture$0, ComGoogleCommonUtilConcurrentMonitor *param0);

__attribute__((unused)) static ComGoogleCommonUtilConcurrentMonitor_1 *new_ComGoogleCommonUtilConcurrentMonitor_1_initWithJavaUtilFunctionBooleanSupplier_withComGoogleCommonUtilConcurrentMonitor_(id<JavaUtilFunctionBooleanSupplier> capture$0, ComGoogleCommonUtilConcurrentMonitor *param0) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonUtilConcurrentMonitor_1 *create_ComGoogleCommonUtilConcurrentMonitor_1_initWithJavaUtilFunctionBooleanSupplier_withComGoogleCommonUtilConcurrentMonitor_(id<JavaUtilFunctionBooleanSupplier> capture$0, ComGoogleCommonUtilConcurrentMonitor *param0);
...
- (ComGoogleCommonUtilConcurrentMonitor_Guard *)newGuardWithJavaUtilFunctionBooleanSupplier:(id<JavaUtilFunctionBooleanSupplier>)isSatisfied {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_withId_(isSatisfied, @"isSatisfied");
  return create_ComGoogleCommonUtilConcurrentMonitor_1_initWithJavaUtilFunctionBooleanSupplier_withComGoogleCommonUtilConcurrentMonitor_(isSatisfied, self);
}
...
- (void)enterWhenWithComGoogleCommonUtilConcurrentMonitor_Guard:(ComGoogleCommonUtilConcurrentMonitor_Guard *)guard {
  if (((ComGoogleCommonUtilConcurrentMonitor_Guard *) nil_chk(guard))->monitor_ != self) {
    @throw create_JavaLangIllegalMonitorStateException_init();
  }
  JavaUtilConcurrentLocksReentrantLock *lock = self->lock_;
...
void ComGoogleCommonUtilConcurrentMonitor_initWithBoolean_(ComGoogleCommonUtilConcurrentMonitor *self, jboolean fair) {
  NSObject_init(self);
  JreStrongAssign(&self->activeGuards_, nil);
  self->fair_ = fair;
  JreStrongAssignAndConsume(&self->lock_, new_JavaUtilConcurrentLocksReentrantLock_initWithBoolean_(fair));
}
...
jboolean ComGoogleCommonUtilConcurrentMonitor_isSatisfiedWithComGoogleCommonUtilConcurrentMonitor_Guard_(ComGoogleCommonUtilConcurrentMonitor *self, ComGoogleCommonUtilConcurrentMonitor_Guard *guard) {
  ...
  @catch (NSException *throwable) {
    ComGoogleCommonUtilConcurrentMonitor_signalAllWaiters(self);
    @throw ComGoogleCommonBaseThrowables_propagateWithNSException_(throwable);
  }
}
...
void ComGoogleCommonUtilConcurrentMonitor_beginWaitingForWithComGoogleCommonUtilConcurrentMonitor_Guard_(ComGoogleCommonUtilConcurrentMonitor *self, ComGoogleCommonUtilConcurrentMonitor_Guard *guard) {
  ...
  if (waiters == 0) {
    JreStrongAssign(&guard->next_, self->activeGuards_);
    JreStrongAssign(&self->activeGuards_, guard);
  }
}
...
void ComGoogleCommonUtilConcurrentMonitor_endWaitingForWithComGoogleCommonUtilConcurrentMonitor_Guard_(ComGoogleCommonUtilConcurrentMonitor *self, ComGoogleCommonUtilConcurrentMonitor_Guard *guard) {
  ...
  if (waiters == 0) {
    for (ComGoogleCommonUtilConcurrentMonitor_Guard *p = self->activeGuards_, *pred = nil; ; pred = p, p = ((ComGoogleCommonUtilConcurrentMonitor_Guard *) nil_chk(p))->next_) {
      if (p == guard) {
        if (pred == nil) {
          JreStrongAssign(&self->activeGuards_, ((ComGoogleCommonUtilConcurrentMonitor_Guard *) nil_chk(p))->next_);
        }
        else {
          JreStrongAssign(&pred->next_, ((ComGoogleCommonUtilConcurrentMonitor_Guard *) nil_chk(p))->next_);
        }
...
void ComGoogleCommonUtilConcurrentMonitor_Guard_initWithComGoogleCommonUtilConcurrentMonitor_(ComGoogleCommonUtilConcurrentMonitor_Guard *self, ComGoogleCommonUtilConcurrentMonitor *monitor) {
  ...
  JreStrongAssign(&self->condition_, [((JavaUtilConcurrentLocksReentrantLock *) nil_chk(((ComGoogleCommonUtilConcurrentMonitor *) nil_chk(monitor))->lock_)) newCondition]);
}
...
- (instancetype)initWithJavaUtilFunctionBooleanSupplier:(id<JavaUtilFunctionBooleanSupplier>)capture$0
               withComGoogleCommonUtilConcurrentMonitor:(ComGoogleCommonUtilConcurrentMonitor *)param0 {
  ComGoogleCommonUtilConcurrentMonitor_1_initWithJavaUtilFunctionBooleanSupplier_withComGoogleCommonUtilConcurrentMonitor_(self, capture$0, param0);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentMonitor_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 1, 0, -1, 1, -1, -1 };
  return &_ComGoogleCommonUtilConcurrentMonitor_1;
}

@end

void ComGoogleCommonUtilConcurrentMonitor_1_initWithJavaUtilFunctionBooleanSupplier_withComGoogleCommonUtilConcurrentMonitor_(ComGoogleCommonUtilConcurrentMonitor_1 *self, id<JavaUtilFunctionBooleanSupplier> capture$0, ComGoogleCommonUtilConcurrentMonitor *param0) {
  JreStrongAssign(&self->val$isSatisfied_, capture$0);
  ComGoogleCommonUtilConcurrentMonitor_Guard_initWithComGoogleCommonUtilConcurrentMonitor_(self, param0);
}

ComGoogleCommonUtilConcurrentMonitor_1 *new_ComGoogleCommonUtilConcurrentMonitor_1_initWithJavaUtilFunctionBooleanSupplier_withComGoogleCommonUtilConcurrentMonitor_(id<JavaUtilFunctionBooleanSupplier> capture$0, ComGoogleCommonUtilConcurrentMonitor *param0) {
  J2OBJC_NEW_IMPL(ComGoogleCommonUtilConcurrentMonitor_1, initWithJavaUtilFunctionBooleanSupplier_withComGoogleCommonUtilConcurrentMonitor_, capture$0, param0)
}

ComGoogleCommonUtilConcurrentMonitor_1 *create_ComGoogleCommonUtilConcurrentMonitor_1_initWithJavaUtilFunctionBooleanSupplier_withComGoogleCommonUtilConcurrentMonitor_(id<JavaUtilFunctionBooleanSupplier> capture$0, ComGoogleCommonUtilConcurrentMonitor *param0) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonUtilConcurrentMonitor_1, initWithJavaUtilFunctionBooleanSupplier_withComGoogleCommonUtilConcurrentMonitor_, capture$0, param0)
}
