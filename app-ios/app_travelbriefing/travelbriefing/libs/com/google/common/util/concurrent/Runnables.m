...
//  source: ../target/dependency/com/google/common/util/concurrent/Runnables.java
//
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentRunnables class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonUtilConcurrentRunnables_EMPTY_RUNNABLE, new_ComGoogleCommonUtilConcurrentRunnables_1_init());
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentRunnables_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, NULL, 7, 0x8008, 2, 0, 0, -1, -1, -1, -1 };
