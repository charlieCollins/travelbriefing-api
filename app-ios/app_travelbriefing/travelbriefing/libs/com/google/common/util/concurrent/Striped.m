...
//  source: ../target/dependency/com/google/common/util/concurrent/Striped.java
//
...
__attribute__((unused)) static void ComGoogleCommonUtilConcurrentStriped_3_init(ComGoogleCommonUtilConcurrentStriped_3 *self);

__attribute__((unused)) static ComGoogleCommonUtilConcurrentStriped_3 *new_ComGoogleCommonUtilConcurrentStriped_3_init() NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonUtilConcurrentStriped_3 *create_ComGoogleCommonUtilConcurrentStriped_3_init();
...
__attribute__((unused)) static void ComGoogleCommonUtilConcurrentStriped_5_initWithInt_(ComGoogleCommonUtilConcurrentStriped_5 *self, jint capture$0);

__attribute__((unused)) static ComGoogleCommonUtilConcurrentStriped_5 *new_ComGoogleCommonUtilConcurrentStriped_5_initWithInt_(jint capture$0) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonUtilConcurrentStriped_5 *create_ComGoogleCommonUtilConcurrentStriped_5_initWithInt_(jint capture$0);
...
- (id<JavaLangIterable>)bulkGetWithJavaLangIterable:(id<JavaLangIterable>)keys {
  ...
  IOSIntArray *stripes = [IOSIntArray arrayWithLength:array->size_];
  ...
  IOSObjectArray_Set(array, 0, [self getAtWithInt:previousStripe]);
  for (jint i = 1; i < array->size_; i++) {
    jint currentStripe = IOSIntArray_Get(stripes, i);
    if (currentStripe == previousStripe) {
      IOSObjectArray_Set(array, i, IOSObjectArray_Get(array, i - 1));
    }
    else {
      IOSObjectArray_Set(array, i, [self getAtWithInt:currentStripe]);
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentStriped class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonUtilConcurrentStriped_READ_WRITE_LOCK_SUPPLIER, new_ComGoogleCommonUtilConcurrentStriped_1_init());
...
ComGoogleCommonUtilConcurrentStriped *ComGoogleCommonUtilConcurrentStriped_lockWithInt_(jint stripes) {
  ...
  return create_ComGoogleCommonUtilConcurrentStriped_CompactStriped_initWithInt_withComGoogleCommonBaseSupplier_(stripes, create_ComGoogleCommonUtilConcurrentStriped_2_init());
}

ComGoogleCommonUtilConcurrentStriped *ComGoogleCommonUtilConcurrentStriped_lazyWeakLockWithInt_(jint stripes) {
  ComGoogleCommonUtilConcurrentStriped_initialize();
  return ComGoogleCommonUtilConcurrentStriped_lazyWithInt_withComGoogleCommonBaseSupplier_(stripes, create_ComGoogleCommonUtilConcurrentStriped_3_init());
}
...
ComGoogleCommonUtilConcurrentStriped *ComGoogleCommonUtilConcurrentStriped_lazyWithInt_withComGoogleCommonBaseSupplier_(jint stripes, id<ComGoogleCommonBaseSupplier> supplier) {
  ComGoogleCommonUtilConcurrentStriped_initialize();
  return stripes < ComGoogleCommonUtilConcurrentStriped_LARGE_LAZY_CUTOFF ? create_ComGoogleCommonUtilConcurrentStriped_SmallLazyStriped_initWithInt_withComGoogleCommonBaseSupplier_(stripes, supplier) : (id) create_ComGoogleCommonUtilConcurrentStriped_LargeLazyStriped_initWithInt_withComGoogleCommonBaseSupplier_(stripes, supplier);
}
...
ComGoogleCommonUtilConcurrentStriped *ComGoogleCommonUtilConcurrentStriped_semaphoreWithInt_withInt_(jint stripes, jint permits) {
  ComGoogleCommonUtilConcurrentStriped_initialize();
  return create_ComGoogleCommonUtilConcurrentStriped_CompactStriped_initWithInt_withComGoogleCommonBaseSupplier_(stripes, create_ComGoogleCommonUtilConcurrentStriped_4_initWithInt_(permits));
}
...
ComGoogleCommonUtilConcurrentStriped *ComGoogleCommonUtilConcurrentStriped_lazyWeakSemaphoreWithInt_withInt_(jint stripes, jint permits) {
  ComGoogleCommonUtilConcurrentStriped_initialize();
  return ComGoogleCommonUtilConcurrentStriped_lazyWithInt_withComGoogleCommonBaseSupplier_(stripes, create_ComGoogleCommonUtilConcurrentStriped_5_initWithInt_(permits));
}

ComGoogleCommonUtilConcurrentStriped *ComGoogleCommonUtilConcurrentStriped_readWriteLockWithInt_(jint stripes) {
  ComGoogleCommonUtilConcurrentStriped_initialize();
  return create_ComGoogleCommonUtilConcurrentStriped_CompactStriped_initWithInt_withComGoogleCommonBaseSupplier_(stripes, ComGoogleCommonUtilConcurrentStriped_READ_WRITE_LOCK_SUPPLIER);
}
...
- (id<JavaUtilConcurrentLocksLock>)get {
  return create_ComGoogleCommonUtilConcurrentStriped_PaddedLock_init();
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentStriped_2 = { "", "com.google.common.util.concurrent", ptrTable, methods, NULL, 7, 0x8008, 2, 0, 0, -1, 1, 2, -1 };
...
J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  ComGoogleCommonUtilConcurrentStriped_3_init(self);
  return self;
}
J2OBJC_IGNORE_DESIGNATED_END

- (id<JavaUtilConcurrentLocksLock>)get {
  return create_JavaUtilConcurrentLocksReentrantLock_initWithBoolean_(false);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentStriped_3 = { "", "com.google.common.util.concurrent", ptrTable, methods, NULL, 7, 0x8008, 2, 0, 0, -1, 1, 2, -1 };
  return &_ComGoogleCommonUtilConcurrentStriped_3;
}

@end

void ComGoogleCommonUtilConcurrentStriped_3_init(ComGoogleCommonUtilConcurrentStriped_3 *self) {
  NSObject_init(self);
}

ComGoogleCommonUtilConcurrentStriped_3 *new_ComGoogleCommonUtilConcurrentStriped_3_init() {
  J2OBJC_NEW_IMPL(ComGoogleCommonUtilConcurrentStriped_3, init)
}

ComGoogleCommonUtilConcurrentStriped_3 *create_ComGoogleCommonUtilConcurrentStriped_3_init() {
  J2OBJC_CREATE_IMPL(ComGoogleCommonUtilConcurrentStriped_3, init)
}
...
- (JavaUtilConcurrentSemaphore *)get {
  return create_ComGoogleCommonUtilConcurrentStriped_PaddedSemaphore_initWithInt_(val$permits_);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentStriped_4 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 1, 0, -1, 1, 2, -1 };
...
- (instancetype)initWithInt:(jint)capture$0 {
  ComGoogleCommonUtilConcurrentStriped_5_initWithInt_(self, capture$0);
  return self;
}

- (JavaUtilConcurrentSemaphore *)get {
  return create_JavaUtilConcurrentSemaphore_initWithInt_withBoolean_(val$permits_, false);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentStriped_5 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 1, 0, -1, 1, 2, -1 };
  return &_ComGoogleCommonUtilConcurrentStriped_5;
}

@end

void ComGoogleCommonUtilConcurrentStriped_5_initWithInt_(ComGoogleCommonUtilConcurrentStriped_5 *self, jint capture$0) {
  self->val$permits_ = capture$0;
  NSObject_init(self);
}

ComGoogleCommonUtilConcurrentStriped_5 *new_ComGoogleCommonUtilConcurrentStriped_5_initWithInt_(jint capture$0) {
  J2OBJC_NEW_IMPL(ComGoogleCommonUtilConcurrentStriped_5, initWithInt_, capture$0)
}

ComGoogleCommonUtilConcurrentStriped_5 *create_ComGoogleCommonUtilConcurrentStriped_5_initWithInt_(jint capture$0) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonUtilConcurrentStriped_5, initWithInt_, capture$0)
}
...
- (id<JavaUtilConcurrentLocksReadWriteLock>)get {
  return create_JavaUtilConcurrentLocksReentrantReadWriteLock_init();
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentStriped_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, NULL, 7, 0x8008, 2, 0, 0, -1, -1, 1, -1 };
...
void ComGoogleCommonUtilConcurrentStriped_CompactStriped_initWithInt_withComGoogleCommonBaseSupplier_(ComGoogleCommonUtilConcurrentStriped_CompactStriped *self, jint stripes, id<ComGoogleCommonBaseSupplier> supplier) {
  ...
  JreStrongAssignAndConsume(&self->array_, [IOSObjectArray newArrayWithLength:self->mask_ + 1 type:NSObject_class_()]);
  for (jint i = 0; i < self->array_->size_; i++) {
    IOSObjectArray_Set(self->array_, i, [((id<ComGoogleCommonBaseSupplier>) nil_chk(supplier)) get]);
  }
}
...
- (id)getAtWithInt:(jint)index {
  ...
  ComGoogleCommonUtilConcurrentStriped_SmallLazyStriped_ArrayReference *newRef = create_ComGoogleCommonUtilConcurrentStriped_SmallLazyStriped_ArrayReference_initWithId_withInt_withJavaLangRefReferenceQueue_(created, index, queue_);
...
void ComGoogleCommonUtilConcurrentStriped_SmallLazyStriped_initWithInt_withComGoogleCommonBaseSupplier_(ComGoogleCommonUtilConcurrentStriped_SmallLazyStriped *self, jint stripes, id<ComGoogleCommonBaseSupplier> supplier) {
  ...
  JreStrongAssignAndConsume(&self->locks_, new_JavaUtilConcurrentAtomicAtomicReferenceArray_initWithInt_(self->size_));
...
void ComGoogleCommonUtilConcurrentStriped_LargeLazyStriped_initWithInt_withComGoogleCommonBaseSupplier_(ComGoogleCommonUtilConcurrentStriped_LargeLazyStriped *self, jint stripes, id<ComGoogleCommonBaseSupplier> supplier) {
  ...
  self->size_ = (self->mask_ == ComGoogleCommonUtilConcurrentStriped_ALL_SET) ? JavaLangInteger_MAX_VALUE : self->mask_ + 1;
  JreStrongAssign(&self->supplier_, supplier);
  JreStrongAssign(&self->locks_, [((ComGoogleCommonCollectMapMaker *) nil_chk([create_ComGoogleCommonCollectMapMaker_init() weakValues])) makeMap]);
}
