...
//  source: ../target/dependency/com/google/common/util/concurrent/MoreExecutors.java
//
...
- (instancetype)initWithComGoogleCommonBaseSupplier:(id<ComGoogleCommonBaseSupplier>)capture$0
              withJavaUtilConcurrentExecutorService:(id<JavaUtilConcurrentExecutorService>)param0;
...
__attribute__((unused)) static void ComGoogleCommonUtilConcurrentMoreExecutors_3_initWithComGoogleCommonBaseSupplier_withJavaUtilConcurrentExecutorService_(ComGoogleCommonUtilConcurrentMoreExecutors_3 *self, id<ComGoogleCommonBaseSupplier> capture$0, id<JavaUtilConcurrentExecutorService> param0);
...
__attribute__((unused)) static ComGoogleCommonUtilConcurrentMoreExecutors_3 *create_ComGoogleCommonUtilConcurrentMoreExecutors_3_initWithComGoogleCommonBaseSupplier_withJavaUtilConcurrentExecutorService_(id<ComGoogleCommonBaseSupplier> capture$0, id<JavaUtilConcurrentExecutorService> param0);
...
- (instancetype)initWithComGoogleCommonBaseSupplier:(id<ComGoogleCommonBaseSupplier>)capture$0
     withJavaUtilConcurrentScheduledExecutorService:(id<JavaUtilConcurrentScheduledExecutorService>)param0;
...
id<JavaUtilConcurrentExecutorService> ComGoogleCommonUtilConcurrentMoreExecutors_getExitingExecutorServiceWithJavaUtilConcurrentThreadPoolExecutor_withLong_withJavaUtilConcurrentTimeUnit_(JavaUtilConcurrentThreadPoolExecutor *executor, jlong terminationTimeout, JavaUtilConcurrentTimeUnit *timeUnit) {
  ...
  return ComGoogleCommonUtilConcurrentMoreExecutors_Application_getExitingExecutorServiceWithJavaUtilConcurrentThreadPoolExecutor_withLong_withJavaUtilConcurrentTimeUnit_(create_ComGoogleCommonUtilConcurrentMoreExecutors_Application_init(), executor, terminationTimeout, timeUnit);
}
...
id<JavaUtilConcurrentScheduledExecutorService> ComGoogleCommonUtilConcurrentMoreExecutors_getExitingScheduledExecutorServiceWithJavaUtilConcurrentScheduledThreadPoolExecutor_withLong_withJavaUtilConcurrentTimeUnit_(JavaUtilConcurrentScheduledThreadPoolExecutor *executor, jlong terminationTimeout, JavaUtilConcurrentTimeUnit *timeUnit) {
  ComGoogleCommonUtilConcurrentMoreExecutors_initialize();
  return ComGoogleCommonUtilConcurrentMoreExecutors_Application_getExitingScheduledExecutorServiceWithJavaUtilConcurrentScheduledThreadPoolExecutor_withLong_withJavaUtilConcurrentTimeUnit_(create_ComGoogleCommonUtilConcurrentMoreExecutors_Application_init(), executor, terminationTimeout, timeUnit);
}
...
void ComGoogleCommonUtilConcurrentMoreExecutors_addDelayedShutdownHookWithJavaUtilConcurrentExecutorService_withLong_withJavaUtilConcurrentTimeUnit_(id<JavaUtilConcurrentExecutorService> service, jlong terminationTimeout, JavaUtilConcurrentTimeUnit *timeUnit) {
  ComGoogleCommonUtilConcurrentMoreExecutors_initialize();
  ComGoogleCommonUtilConcurrentMoreExecutors_Application_addDelayedShutdownHookWithJavaUtilConcurrentExecutorService_withLong_withJavaUtilConcurrentTimeUnit_(create_ComGoogleCommonUtilConcurrentMoreExecutors_Application_init(), service, terminationTimeout, timeUnit);
}
...
id<JavaUtilConcurrentExecutorService> ComGoogleCommonUtilConcurrentMoreExecutors_getExitingExecutorServiceWithJavaUtilConcurrentThreadPoolExecutor_(JavaUtilConcurrentThreadPoolExecutor *executor) {
  ComGoogleCommonUtilConcurrentMoreExecutors_initialize();
  return ComGoogleCommonUtilConcurrentMoreExecutors_Application_getExitingExecutorServiceWithJavaUtilConcurrentThreadPoolExecutor_(create_ComGoogleCommonUtilConcurrentMoreExecutors_Application_init(), executor);
}
...
id<JavaUtilConcurrentScheduledExecutorService> ComGoogleCommonUtilConcurrentMoreExecutors_getExitingScheduledExecutorServiceWithJavaUtilConcurrentScheduledThreadPoolExecutor_(JavaUtilConcurrentScheduledThreadPoolExecutor *executor) {
  ComGoogleCommonUtilConcurrentMoreExecutors_initialize();
  return ComGoogleCommonUtilConcurrentMoreExecutors_Application_getExitingScheduledExecutorServiceWithJavaUtilConcurrentScheduledThreadPoolExecutor_(create_ComGoogleCommonUtilConcurrentMoreExecutors_Application_init(), executor);
}
...
void ComGoogleCommonUtilConcurrentMoreExecutors_useDaemonThreadFactoryWithJavaUtilConcurrentThreadPoolExecutor_(JavaUtilConcurrentThreadPoolExecutor *executor) {
  ComGoogleCommonUtilConcurrentMoreExecutors_initialize();
  [((JavaUtilConcurrentThreadPoolExecutor *) nil_chk(executor)) setThreadFactoryWithJavaUtilConcurrentThreadFactory:[((ComGoogleCommonUtilConcurrentThreadFactoryBuilder *) nil_chk([((ComGoogleCommonUtilConcurrentThreadFactoryBuilder *) nil_chk([create_ComGoogleCommonUtilConcurrentThreadFactoryBuilder_init() setDaemonWithBoolean:true])) setThreadFactoryWithJavaUtilConcurrentThreadFactory:[executor getThreadFactory]])) build]];
}
...
id<ComGoogleCommonUtilConcurrentListeningExecutorService> ComGoogleCommonUtilConcurrentMoreExecutors_newDirectExecutorService() {
  ComGoogleCommonUtilConcurrentMoreExecutors_initialize();
  return create_ComGoogleCommonUtilConcurrentMoreExecutors_DirectExecutorService_init();
}
...
id<ComGoogleCommonUtilConcurrentListeningExecutorService> ComGoogleCommonUtilConcurrentMoreExecutors_listeningDecoratorWithJavaUtilConcurrentExecutorService_(id<JavaUtilConcurrentExecutorService> delegate) {
  ComGoogleCommonUtilConcurrentMoreExecutors_initialize();
  return ([ComGoogleCommonUtilConcurrentListeningExecutorService_class_() isInstance:delegate]) ? (id<ComGoogleCommonUtilConcurrentListeningExecutorService>) cast_check(delegate, ComGoogleCommonUtilConcurrentListeningExecutorService_class_()) : ([JavaUtilConcurrentScheduledExecutorService_class_() isInstance:delegate]) ? create_ComGoogleCommonUtilConcurrentMoreExecutors_ScheduledListeningDecorator_initWithJavaUtilConcurrentScheduledExecutorService_((id<JavaUtilConcurrentScheduledExecutorService>) cast_check(delegate, JavaUtilConcurrentScheduledExecutorService_class_())) : create_ComGoogleCommonUtilConcurrentMoreExecutors_ListeningDecorator_initWithJavaUtilConcurrentExecutorService_(delegate);
}
...
id<ComGoogleCommonUtilConcurrentListeningScheduledExecutorService> ComGoogleCommonUtilConcurrentMoreExecutors_listeningDecoratorWithJavaUtilConcurrentScheduledExecutorService_(id<JavaUtilConcurrentScheduledExecutorService> delegate) {
  ComGoogleCommonUtilConcurrentMoreExecutors_initialize();
  return ([ComGoogleCommonUtilConcurrentListeningScheduledExecutorService_class_() isInstance:delegate]) ? (id<ComGoogleCommonUtilConcurrentListeningScheduledExecutorService>) cast_check(delegate, ComGoogleCommonUtilConcurrentListeningScheduledExecutorService_class_()) : create_ComGoogleCommonUtilConcurrentMoreExecutors_ScheduledListeningDecorator_initWithJavaUtilConcurrentScheduledExecutorService_(delegate);
}
...
id ComGoogleCommonUtilConcurrentMoreExecutors_invokeAnyImplWithComGoogleCommonUtilConcurrentListeningExecutorService_withJavaUtilCollection_withBoolean_withLong_withJavaUtilConcurrentTimeUnit_(id<ComGoogleCommonUtilConcurrentListeningExecutorService> executorService, id<JavaUtilCollection> tasks, jboolean timed, jlong timeout, JavaUtilConcurrentTimeUnit *unit) {
  ComGoogleCommonUtilConcurrentMoreExecutors_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(executorService);
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(unit);
    ...
    while (true) {
      ...
      if (f != nil) {
        ...
        @catch (JavaLangRuntimeException *rex) {
          ee = create_JavaUtilConcurrentExecutionException_initWithNSException_(rex);
        }
      }
    }
    if (ee == nil) {
      ee = create_JavaUtilConcurrentExecutionException_initWithNSException_(nil);
    }
    @throw ee;
  }
  @finally {
...
id<ComGoogleCommonUtilConcurrentListenableFuture> ComGoogleCommonUtilConcurrentMoreExecutors_submitAndAddQueueListenerWithComGoogleCommonUtilConcurrentListeningExecutorService_withJavaUtilConcurrentCallable_withJavaUtilConcurrentBlockingQueue_(id<ComGoogleCommonUtilConcurrentListeningExecutorService> executorService, id<JavaUtilConcurrentCallable> task, id<JavaUtilConcurrentBlockingQueue> queue) {
  ...
  [((id<ComGoogleCommonUtilConcurrentListenableFuture>) nil_chk(future)) addListenerWithJavaLangRunnable:create_ComGoogleCommonUtilConcurrentMoreExecutors_1_initWithJavaUtilConcurrentBlockingQueue_withComGoogleCommonUtilConcurrentListenableFuture_(queue, future) withJavaUtilConcurrentExecutor:ComGoogleCommonUtilConcurrentMoreExecutors_directExecutor()];
  return future;
}
...
id<JavaUtilConcurrentThreadFactory> ComGoogleCommonUtilConcurrentMoreExecutors_platformThreadFactory() {
  ...
  @try {
    return (id<JavaUtilConcurrentThreadFactory>) cast_check([((JavaLangReflectMethod *) nil_chk([((IOSClass *) nil_chk(IOSClass_forName_(@"com.google.appengine.api.ThreadManager"))) getMethod:@"currentRequestThreadFactory" parameterTypes:[IOSObjectArray arrayWithLength:0 type:IOSClass_class_()]])) invokeWithId:nil withNSObjectArray:[IOSObjectArray arrayWithLength:0 type:NSObject_class_()]], JavaUtilConcurrentThreadFactory_class_());
  }
  @catch (JavaLangIllegalAccessException *e) {
    @throw create_JavaLangRuntimeException_initWithNSString_withNSException_(@"Couldn't invoke ThreadManager.currentRequestThreadFactory", e);
  }
  ...
  @catch (JavaLangReflectInvocationTargetException *e) {
    @throw ComGoogleCommonBaseThrowables_propagateWithNSException_([((JavaLangReflectInvocationTargetException *) nil_chk(e)) getCause]);
  }
}
...
jboolean ComGoogleCommonUtilConcurrentMoreExecutors_isAppEngine() {
  ...
  @try {
    return [((JavaLangReflectMethod *) nil_chk([((IOSClass *) nil_chk(IOSClass_forName_(@"com.google.apphosting.api.ApiProxy"))) getMethod:@"getCurrentEnvironment" parameterTypes:[IOSObjectArray arrayWithLength:0 type:IOSClass_class_()]])) invokeWithId:nil withNSObjectArray:[IOSObjectArray arrayWithLength:0 type:NSObject_class_()]] != nil;
  }
  @catch (JavaLangClassNotFoundException *e) {
    return false;
  }
...
JavaLangThread *ComGoogleCommonUtilConcurrentMoreExecutors_newThreadWithNSString_withJavaLangRunnable_(NSString *name, id<JavaLangRunnable> runnable) {
  ComGoogleCommonUtilConcurrentMoreExecutors_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(name);
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(runnable);
...
id<JavaUtilConcurrentExecutor> ComGoogleCommonUtilConcurrentMoreExecutors_renamingDecoratorWithJavaUtilConcurrentExecutor_withComGoogleCommonBaseSupplier_(id<JavaUtilConcurrentExecutor> executor, id<ComGoogleCommonBaseSupplier> nameSupplier) {
  ...
  return create_ComGoogleCommonUtilConcurrentMoreExecutors_2_initWithJavaUtilConcurrentExecutor_withComGoogleCommonBaseSupplier_(executor, nameSupplier);
}
...
id<JavaUtilConcurrentExecutorService> ComGoogleCommonUtilConcurrentMoreExecutors_renamingDecoratorWithJavaUtilConcurrentExecutorService_withComGoogleCommonBaseSupplier_(id<JavaUtilConcurrentExecutorService> service, id<ComGoogleCommonBaseSupplier> nameSupplier) {
  ...
  return create_ComGoogleCommonUtilConcurrentMoreExecutors_3_initWithComGoogleCommonBaseSupplier_withJavaUtilConcurrentExecutorService_(nameSupplier, service);
}
...
id<JavaUtilConcurrentScheduledExecutorService> ComGoogleCommonUtilConcurrentMoreExecutors_renamingDecoratorWithJavaUtilConcurrentScheduledExecutorService_withComGoogleCommonBaseSupplier_(id<JavaUtilConcurrentScheduledExecutorService> service, id<ComGoogleCommonBaseSupplier> nameSupplier) {
  ...
  return create_ComGoogleCommonUtilConcurrentMoreExecutors_4_initWithComGoogleCommonBaseSupplier_withJavaUtilConcurrentScheduledExecutorService_(nameSupplier, service);
}
...
id<JavaUtilConcurrentExecutor> ComGoogleCommonUtilConcurrentMoreExecutors_rejectionPropagatingExecutorWithJavaUtilConcurrentExecutor_withComGoogleCommonUtilConcurrentAbstractFuture_(id<JavaUtilConcurrentExecutor> delegate, ComGoogleCommonUtilConcurrentAbstractFuture *future) {
  ComGoogleCommonUtilConcurrentMoreExecutors_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(delegate);
  ...
  return create_ComGoogleCommonUtilConcurrentMoreExecutors_5_initWithJavaUtilConcurrentExecutor_withComGoogleCommonUtilConcurrentAbstractFuture_(delegate, future);
}
...
void ComGoogleCommonUtilConcurrentMoreExecutors_Application_addDelayedShutdownHookWithJavaUtilConcurrentExecutorService_withLong_withJavaUtilConcurrentTimeUnit_(ComGoogleCommonUtilConcurrentMoreExecutors_Application *self, id<JavaUtilConcurrentExecutorService> service, jlong terminationTimeout, JavaUtilConcurrentTimeUnit *timeUnit) {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(service);
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(timeUnit);
  [self addShutdownHookWithJavaLangThread:ComGoogleCommonUtilConcurrentMoreExecutors_newThreadWithNSString_withJavaLangRunnable_(JreStrcat("$@", @"DelayedShutdownHook-for-", service), create_ComGoogleCommonUtilConcurrentMoreExecutors_Application_1_initWithJavaUtilConcurrentExecutorService_withLong_withJavaUtilConcurrentTimeUnit_(service, terminationTimeout, timeUnit))];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentMoreExecutors_Application_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 3, 0, -1, 1, -1, -1 };
...
void ComGoogleCommonUtilConcurrentMoreExecutors_Application_1_initWithJavaUtilConcurrentExecutorService_withLong_withJavaUtilConcurrentTimeUnit_(ComGoogleCommonUtilConcurrentMoreExecutors_Application_1 *self, id<JavaUtilConcurrentExecutorService> capture$0, jlong capture$1, JavaUtilConcurrentTimeUnit *capture$2) {
  ...
  JreStrongAssign(&self->val$timeUnit_, capture$2);
  NSObject_init(self);
}
...
void ComGoogleCommonUtilConcurrentMoreExecutors_DirectExecutorService_startTask(ComGoogleCommonUtilConcurrentMoreExecutors_DirectExecutorService *self) {
  @synchronized(self->lock_) {
    if (self->shutdown_) {
      @throw create_JavaUtilConcurrentRejectedExecutionException_initWithNSString_(@"Executor already shutdown");
    }
    self->runningTasks_++;
  }
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentMoreExecutors_DirectExecutor class]) {
    ...
    for (jint i = 0; i < 1; i++) {
      (ComGoogleCommonUtilConcurrentMoreExecutors_DirectExecutor_values_[i] = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
      ComGoogleCommonUtilConcurrentMoreExecutors_DirectExecutor_initWithNSString_withInt_(e, names[i], i);
    }
...
- (id<ComGoogleCommonUtilConcurrentListenableScheduledFuture>)scheduleWithJavaLangRunnable:(id<JavaLangRunnable>)command
  ...
  return create_ComGoogleCommonUtilConcurrentMoreExecutors_ScheduledListeningDecorator_ListenableScheduledTask_initWithComGoogleCommonUtilConcurrentListenableFuture_withJavaUtilConcurrentScheduledFuture_(task, scheduled);
}
...
- (id<ComGoogleCommonUtilConcurrentListenableScheduledFuture>)scheduleAtFixedRateWithJavaLangRunnable:(id<JavaLangRunnable>)command
                                                                                             ...
                                                                                             withLong:(jlong)period
                                                                       withJavaUtilConcurrentTimeUnit:(JavaUtilConcurrentTimeUnit *)unit {
  ComGoogleCommonUtilConcurrentMoreExecutors_ScheduledListeningDecorator_NeverSuccessfulListenableFutureTask *task = create_ComGoogleCommonUtilConcurrentMoreExecutors_ScheduledListeningDecorator_NeverSuccessfulListenableFutureTask_initWithJavaLangRunnable_(command);
...
- (void)dealloc {
  RELEASE_(delegate_ScheduledListeningDecorator_);
  [super dealloc];
}
...
void ComGoogleCommonUtilConcurrentMoreExecutors_ScheduledListeningDecorator_initWithJavaUtilConcurrentScheduledExecutorService_(ComGoogleCommonUtilConcurrentMoreExecutors_ScheduledListeningDecorator *self, id<JavaUtilConcurrentScheduledExecutorService> delegate) {
  ComGoogleCommonUtilConcurrentMoreExecutors_ListeningDecorator_initWithJavaUtilConcurrentExecutorService_(self, delegate);
  JreStrongAssign(&self->delegate_ScheduledListeningDecorator_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(delegate));
}
...
void ComGoogleCommonUtilConcurrentMoreExecutors_ScheduledListeningDecorator_ListenableScheduledTask_initWithComGoogleCommonUtilConcurrentListenableFuture_withJavaUtilConcurrentScheduledFuture_(ComGoogleCommonUtilConcurrentMoreExecutors_ScheduledListeningDecorator_ListenableScheduledTask *self, id<ComGoogleCommonUtilConcurrentListenableFuture> listenableDelegate, id<JavaUtilConcurrentScheduledFuture> scheduledDelegate) {
  ...
  JreStrongAssign(&self->scheduledDelegate_, scheduledDelegate);
}
...
- (void)run {
  ...
  @catch (NSException *t) {
    ...
    @throw ComGoogleCommonBaseThrowables_propagateWithNSException_(t);
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentMoreExecutors_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 2, 2, -1, 3, -1, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentMoreExecutors_2 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 2, 3, -1, 4, -1, -1 };
...
void ComGoogleCommonUtilConcurrentMoreExecutors_2_initWithJavaUtilConcurrentExecutor_withComGoogleCommonBaseSupplier_(ComGoogleCommonUtilConcurrentMoreExecutors_2 *self, id<JavaUtilConcurrentExecutor> capture$0, id<ComGoogleCommonBaseSupplier> capture$1) {
  ...
  JreStrongAssign(&self->val$nameSupplier_, capture$1);
  NSObject_init(self);
}
...
- (instancetype)initWithComGoogleCommonBaseSupplier:(id<ComGoogleCommonBaseSupplier>)capture$0
              withJavaUtilConcurrentExecutorService:(id<JavaUtilConcurrentExecutorService>)param0 {
  ComGoogleCommonUtilConcurrentMoreExecutors_3_initWithComGoogleCommonBaseSupplier_withJavaUtilConcurrentExecutorService_(self, capture$0, param0);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentMoreExecutors_3 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 3, 1, 6, -1, 7, -1, -1 };
  return &_ComGoogleCommonUtilConcurrentMoreExecutors_3;
}

@end

void ComGoogleCommonUtilConcurrentMoreExecutors_3_initWithComGoogleCommonBaseSupplier_withJavaUtilConcurrentExecutorService_(ComGoogleCommonUtilConcurrentMoreExecutors_3 *self, id<ComGoogleCommonBaseSupplier> capture$0, id<JavaUtilConcurrentExecutorService> param0) {
  JreStrongAssign(&self->val$nameSupplier_, capture$0);
  ComGoogleCommonUtilConcurrentWrappingExecutorService_initWithJavaUtilConcurrentExecutorService_(self, param0);
}

ComGoogleCommonUtilConcurrentMoreExecutors_3 *new_ComGoogleCommonUtilConcurrentMoreExecutors_3_initWithComGoogleCommonBaseSupplier_withJavaUtilConcurrentExecutorService_(id<ComGoogleCommonBaseSupplier> capture$0, id<JavaUtilConcurrentExecutorService> param0) {
  J2OBJC_NEW_IMPL(ComGoogleCommonUtilConcurrentMoreExecutors_3, initWithComGoogleCommonBaseSupplier_withJavaUtilConcurrentExecutorService_, capture$0, param0)
}

ComGoogleCommonUtilConcurrentMoreExecutors_3 *create_ComGoogleCommonUtilConcurrentMoreExecutors_3_initWithComGoogleCommonBaseSupplier_withJavaUtilConcurrentExecutorService_(id<ComGoogleCommonBaseSupplier> capture$0, id<JavaUtilConcurrentExecutorService> param0) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonUtilConcurrentMoreExecutors_3, initWithComGoogleCommonBaseSupplier_withJavaUtilConcurrentExecutorService_, capture$0, param0)
}
...
- (instancetype)initWithComGoogleCommonBaseSupplier:(id<ComGoogleCommonBaseSupplier>)capture$0
     withJavaUtilConcurrentScheduledExecutorService:(id<JavaUtilConcurrentScheduledExecutorService>)param0 {
  ComGoogleCommonUtilConcurrentMoreExecutors_4_initWithComGoogleCommonBaseSupplier_withJavaUtilConcurrentScheduledExecutorService_(self, capture$0, param0);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentMoreExecutors_4 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 3, 1, 6, -1, 7, -1, -1 };
  return &_ComGoogleCommonUtilConcurrentMoreExecutors_4;
}

@end

void ComGoogleCommonUtilConcurrentMoreExecutors_4_initWithComGoogleCommonBaseSupplier_withJavaUtilConcurrentScheduledExecutorService_(ComGoogleCommonUtilConcurrentMoreExecutors_4 *self, id<ComGoogleCommonBaseSupplier> capture$0, id<JavaUtilConcurrentScheduledExecutorService> param0) {
  JreStrongAssign(&self->val$nameSupplier_, capture$0);
  ComGoogleCommonUtilConcurrentWrappingScheduledExecutorService_initWithJavaUtilConcurrentScheduledExecutorService_(self, param0);
}

ComGoogleCommonUtilConcurrentMoreExecutors_4 *new_ComGoogleCommonUtilConcurrentMoreExecutors_4_initWithComGoogleCommonBaseSupplier_withJavaUtilConcurrentScheduledExecutorService_(id<ComGoogleCommonBaseSupplier> capture$0, id<JavaUtilConcurrentScheduledExecutorService> param0) {
  J2OBJC_NEW_IMPL(ComGoogleCommonUtilConcurrentMoreExecutors_4, initWithComGoogleCommonBaseSupplier_withJavaUtilConcurrentScheduledExecutorService_, capture$0, param0)
}

ComGoogleCommonUtilConcurrentMoreExecutors_4 *create_ComGoogleCommonUtilConcurrentMoreExecutors_4_initWithComGoogleCommonBaseSupplier_withJavaUtilConcurrentScheduledExecutorService_(id<ComGoogleCommonBaseSupplier> capture$0, id<JavaUtilConcurrentScheduledExecutorService> param0) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonUtilConcurrentMoreExecutors_4, initWithComGoogleCommonBaseSupplier_withJavaUtilConcurrentScheduledExecutorService_, capture$0, param0)
}
...
- (void)executeWithJavaLangRunnable:(id<JavaLangRunnable>)command {
  @try {
    [((id<JavaUtilConcurrentExecutor>) nil_chk(val$delegate_)) executeWithJavaLangRunnable:create_ComGoogleCommonUtilConcurrentMoreExecutors_5_1_initWithComGoogleCommonUtilConcurrentMoreExecutors_5_withJavaLangRunnable_(self, command)];
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentMoreExecutors_5 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 3, 3, -1, 4, -1, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentMoreExecutors_5_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 2, 0, -1, 1, -1, -1 };
...
void ComGoogleCommonUtilConcurrentMoreExecutors_5_1_initWithComGoogleCommonUtilConcurrentMoreExecutors_5_withJavaLangRunnable_(ComGoogleCommonUtilConcurrentMoreExecutors_5_1 *self, ComGoogleCommonUtilConcurrentMoreExecutors_5 *outer$, id<JavaLangRunnable> capture$0) {
  ...
  JreStrongAssign(&self->val$command_, capture$0);
  NSObject_init(self);
}
