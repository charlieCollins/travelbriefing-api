...
//  source: ../target/dependency/com/google/common/util/concurrent/AbstractScheduledService.java
//
...
- (id<JavaUtilConcurrentScheduledExecutorService>)executor {
  id<JavaUtilConcurrentScheduledExecutorService> executor = JavaUtilConcurrentExecutors_newSingleThreadScheduledExecutorWithJavaUtilConcurrentThreadFactory_(create_ComGoogleCommonUtilConcurrentAbstractScheduledService_1ThreadFactoryImpl_initWithComGoogleCommonUtilConcurrentAbstractScheduledService_(self));
  ComGoogleCommonUtilConcurrentAbstractScheduledService_addListenerWithComGoogleCommonUtilConcurrentService_Listener_withJavaUtilConcurrentExecutor_(self, create_ComGoogleCommonUtilConcurrentAbstractScheduledService_1_initWithJavaUtilConcurrentScheduledExecutorService_(executor), ComGoogleCommonUtilConcurrentMoreExecutors_directExecutor());
  return executor;
}
...
- (id<ComGoogleCommonUtilConcurrentService>)startAsync {
  [((ComGoogleCommonUtilConcurrentAbstractService *) nil_chk(delegate_)) startAsync];
  return self;
}

- (id<ComGoogleCommonUtilConcurrentService>)stopAsync {
  [((ComGoogleCommonUtilConcurrentAbstractService *) nil_chk(delegate_)) stopAsync];
  return self;
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentAbstractScheduledService class]) {
    JreStrongAssign(&ComGoogleCommonUtilConcurrentAbstractScheduledService_logger, JavaUtilLoggingLogger_getLoggerWithNSString_([ComGoogleCommonUtilConcurrentAbstractScheduledService_class_() getName]));
...
void ComGoogleCommonUtilConcurrentAbstractScheduledService_init(ComGoogleCommonUtilConcurrentAbstractScheduledService *self) {
  NSObject_init(self);
  JreStrongAssignAndConsume(&self->delegate_, new_ComGoogleCommonUtilConcurrentAbstractScheduledService_ServiceDelegate_initWithComGoogleCommonUtilConcurrentAbstractScheduledService_(self));
}
...
ComGoogleCommonUtilConcurrentAbstractScheduledService_Scheduler *ComGoogleCommonUtilConcurrentAbstractScheduledService_Scheduler_newFixedDelayScheduleWithLong_withLong_withJavaUtilConcurrentTimeUnit_(jlong initialDelay, jlong delay, JavaUtilConcurrentTimeUnit *unit) {
  ...
  return create_ComGoogleCommonUtilConcurrentAbstractScheduledService_Scheduler_1_initWithLong_withLong_withJavaUtilConcurrentTimeUnit_(initialDelay, delay, unit);
}
...
ComGoogleCommonUtilConcurrentAbstractScheduledService_Scheduler *ComGoogleCommonUtilConcurrentAbstractScheduledService_Scheduler_newFixedRateScheduleWithLong_withLong_withJavaUtilConcurrentTimeUnit_(jlong initialDelay, jlong period, JavaUtilConcurrentTimeUnit *unit) {
  ...
  return create_ComGoogleCommonUtilConcurrentAbstractScheduledService_Scheduler_2_initWithLong_withLong_withJavaUtilConcurrentTimeUnit_(initialDelay, period, unit);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentAbstractScheduledService_Scheduler_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 3, 3, -1, 4, -1, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentAbstractScheduledService_Scheduler_2 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 3, 3, -1, 4, -1, -1 };
...
- (void)doStart {
  JreVolatileStrongAssign(&executorService_, ComGoogleCommonUtilConcurrentMoreExecutors_renamingDecoratorWithJavaUtilConcurrentScheduledExecutorService_withComGoogleCommonBaseSupplier_([this$0_ executor], create_ComGoogleCommonUtilConcurrentAbstractScheduledService_ServiceDelegate_1_initWithComGoogleCommonUtilConcurrentAbstractScheduledService_ServiceDelegate_(self)));
  [((id<JavaUtilConcurrentScheduledExecutorService>) nil_chk(JreLoadVolatileId(&executorService_))) executeWithJavaLangRunnable:create_ComGoogleCommonUtilConcurrentAbstractScheduledService_ServiceDelegate_2_initWithComGoogleCommonUtilConcurrentAbstractScheduledService_ServiceDelegate_(self)];
}

- (void)doStop {
  [((id<JavaUtilConcurrentFuture>) nil_chk(JreLoadVolatileId(&runningTask_))) cancelWithBoolean:false];
  [((id<JavaUtilConcurrentScheduledExecutorService>) nil_chk(JreLoadVolatileId(&executorService_))) executeWithJavaLangRunnable:create_ComGoogleCommonUtilConcurrentAbstractScheduledService_ServiceDelegate_3_initWithComGoogleCommonUtilConcurrentAbstractScheduledService_ServiceDelegate_(self)];
}
...
void ComGoogleCommonUtilConcurrentAbstractScheduledService_ServiceDelegate_initWithComGoogleCommonUtilConcurrentAbstractScheduledService_(ComGoogleCommonUtilConcurrentAbstractScheduledService_ServiceDelegate *self, ComGoogleCommonUtilConcurrentAbstractScheduledService *outer$) {
  ...
  JreStrongAssignAndConsume(&self->task_, new_ComGoogleCommonUtilConcurrentAbstractScheduledService_ServiceDelegate_Task_initWithComGoogleCommonUtilConcurrentAbstractScheduledService_ServiceDelegate_(self));
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentAbstractScheduledService_ServiceDelegate_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 1, 0, -1, 1, 2, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentAbstractScheduledService_ServiceDelegate_2 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 1, 0, -1, 1, -1, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentAbstractScheduledService_ServiceDelegate_3 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 1, 0, -1, 1, -1, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentAbstractScheduledService_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 3, 1, 4, -1, 5, -1, -1 };
...
- (id<JavaUtilConcurrentFuture>)scheduleWithComGoogleCommonUtilConcurrentAbstractService:(ComGoogleCommonUtilConcurrentAbstractService *)service
                                          withJavaUtilConcurrentScheduledExecutorService:(id<JavaUtilConcurrentScheduledExecutorService>)executor
                                                                    withJavaLangRunnable:(id<JavaLangRunnable>)runnable {
  ComGoogleCommonUtilConcurrentAbstractScheduledService_CustomScheduler_ReschedulableCallable *task = create_ComGoogleCommonUtilConcurrentAbstractScheduledService_CustomScheduler_ReschedulableCallable_initWithComGoogleCommonUtilConcurrentAbstractScheduledService_CustomScheduler_withComGoogleCommonUtilConcurrentAbstractService_withJavaUtilConcurrentScheduledExecutorService_withJavaLangRunnable_(self, service, executor, runnable);
  [task reschedule];
  return task;
}
...
- (void)reschedule {
  ...
  @try {
    if (currentFuture_ == nil || ![currentFuture_ isCancelled]) {
      JreStrongAssign(&currentFuture_, [((id<JavaUtilConcurrentScheduledExecutorService>) nil_chk(executor_)) scheduleWithJavaUtilConcurrentCallable:self withLong:((ComGoogleCommonUtilConcurrentAbstractScheduledService_CustomScheduler_Schedule *) nil_chk(schedule))->delay_ withJavaUtilConcurrentTimeUnit:schedule->unit_]);
    }
  }
  @catch (NSException *e) {
    scheduleFailure = e;
...
- (id<JavaUtilConcurrentFuture>)delegate {
  @throw create_JavaLangUnsupportedOperationException_initWithNSString_(@"Only cancel and isCancelled is supported by this future");
}

- (void)dealloc {
  RELEASE_(this$0_);
  RELEASE_(wrappedRunnable_);
  RELEASE_(executor_);
  RELEASE_(service_);
  RELEASE_(lock_);
  RELEASE_(currentFuture_);
  [super dealloc];
}
...
void ComGoogleCommonUtilConcurrentAbstractScheduledService_CustomScheduler_ReschedulableCallable_initWithComGoogleCommonUtilConcurrentAbstractScheduledService_CustomScheduler_withComGoogleCommonUtilConcurrentAbstractService_withJavaUtilConcurrentScheduledExecutorService_withJavaLangRunnable_(ComGoogleCommonUtilConcurrentAbstractScheduledService_CustomScheduler_ReschedulableCallable *self, ComGoogleCommonUtilConcurrentAbstractScheduledService_CustomScheduler *outer$, ComGoogleCommonUtilConcurrentAbstractService *service, id<JavaUtilConcurrentScheduledExecutorService> executor, id<JavaLangRunnable> runnable) {
  ...
  JreStrongAssignAndConsume(&self->lock_, new_JavaUtilConcurrentLocksReentrantLock_init());
  JreStrongAssign(&self->wrappedRunnable_, runnable);
...
void ComGoogleCommonUtilConcurrentAbstractScheduledService_CustomScheduler_Schedule_initWithLong_withJavaUtilConcurrentTimeUnit_(ComGoogleCommonUtilConcurrentAbstractScheduledService_CustomScheduler_Schedule *self, jlong delay, JavaUtilConcurrentTimeUnit *unit) {
  NSObject_init(self);
  self->delay_ = delay;
  JreStrongAssign(&self->unit_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(unit));
}
