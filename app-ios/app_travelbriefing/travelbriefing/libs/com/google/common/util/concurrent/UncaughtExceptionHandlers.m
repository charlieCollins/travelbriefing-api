...
//  source: ../target/dependency/com/google/common/util/concurrent/UncaughtExceptionHandlers.java
//
...
id<JavaLangThread_UncaughtExceptionHandler> ComGoogleCommonUtilConcurrentUncaughtExceptionHandlers_systemExit() {
  ...
  return create_ComGoogleCommonUtilConcurrentUncaughtExceptionHandlers_Exiter_initWithJavaLangRuntime_(JavaLangRuntime_getRuntime());
}
...
- (void)uncaughtExceptionWithJavaLangThread:(JavaLangThread *)t
  ...
  @catch (NSException *errorInLogging) {
    ...
    [JreLoadStatic(JavaLangSystem, err) printlnWithNSString:[((NSException *) nil_chk(errorInLogging)) getMessage]];
  }
  @finally {
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentUncaughtExceptionHandlers_Exiter class]) {
    JreStrongAssign(&ComGoogleCommonUtilConcurrentUncaughtExceptionHandlers_Exiter_logger, JavaUtilLoggingLogger_getLoggerWithNSString_([ComGoogleCommonUtilConcurrentUncaughtExceptionHandlers_Exiter_class_() getName]));
...
void ComGoogleCommonUtilConcurrentUncaughtExceptionHandlers_Exiter_initWithJavaLangRuntime_(ComGoogleCommonUtilConcurrentUncaughtExceptionHandlers_Exiter *self, JavaLangRuntime *runtime) {
  NSObject_init(self);
  JreStrongAssign(&self->runtime_, runtime);
}
