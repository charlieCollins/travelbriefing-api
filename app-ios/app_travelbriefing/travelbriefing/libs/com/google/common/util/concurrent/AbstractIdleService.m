...
//  source: ../target/dependency/com/google/common/util/concurrent/AbstractIdleService.java
//
...
- (id<JavaUtilConcurrentExecutor>)executor {
  return create_ComGoogleCommonUtilConcurrentAbstractIdleService_1_initWithComGoogleCommonUtilConcurrentAbstractIdleService_(self);
}
...
void ComGoogleCommonUtilConcurrentAbstractIdleService_init(ComGoogleCommonUtilConcurrentAbstractIdleService *self) {
  NSObject_init(self);
  JreStrongAssignAndConsume(&self->threadNameSupplier_, new_ComGoogleCommonUtilConcurrentAbstractIdleService_ThreadNameSupplier_initWithComGoogleCommonUtilConcurrentAbstractIdleService_(self));
  JreStrongAssignAndConsume(&self->delegate_, new_ComGoogleCommonUtilConcurrentAbstractIdleService_DelegateService_initWithComGoogleCommonUtilConcurrentAbstractIdleService_(self));
}
...
- (void)doStart {
  [((id<JavaUtilConcurrentExecutor>) nil_chk(ComGoogleCommonUtilConcurrentMoreExecutors_renamingDecoratorWithJavaUtilConcurrentExecutor_withComGoogleCommonBaseSupplier_([this$0_ executor], this$0_->threadNameSupplier_))) executeWithJavaLangRunnable:create_ComGoogleCommonUtilConcurrentAbstractIdleService_DelegateService_1_initWithComGoogleCommonUtilConcurrentAbstractIdleService_DelegateService_(self)];
}

- (void)doStop {
  [((id<JavaUtilConcurrentExecutor>) nil_chk(ComGoogleCommonUtilConcurrentMoreExecutors_renamingDecoratorWithJavaUtilConcurrentExecutor_withComGoogleCommonBaseSupplier_([this$0_ executor], this$0_->threadNameSupplier_))) executeWithJavaLangRunnable:create_ComGoogleCommonUtilConcurrentAbstractIdleService_DelegateService_2_initWithComGoogleCommonUtilConcurrentAbstractIdleService_DelegateService_(self)];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentAbstractIdleService_DelegateService_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 1, 0, -1, 1, -1, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentAbstractIdleService_DelegateService_2 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 1, 0, -1, 1, -1, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentAbstractIdleService_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 1, 2, -1, 3, -1, -1 };
