...
//  source: ../target/dependency/com/google/common/util/concurrent/ForwardingBlockingDeque.java
//
...
@implementation ComGoogleCommonUtilConcurrentForwardingBlockingDeque

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  ComGoogleCommonUtilConcurrentForwardingBlockingDeque_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentForwardingBlockingDeque = { "ForwardingBlockingDeque", "com.google.common.util.concurrent", ptrTable, methods, NULL, 7, 0x401, 17, 0, -1, -1, -1, 23, -1 };
  return &_ComGoogleCommonUtilConcurrentForwardingBlockingDeque;
}

@end

void ComGoogleCommonUtilConcurrentForwardingBlockingDeque_init(ComGoogleCommonUtilConcurrentForwardingBlockingDeque *self) {
  ComGoogleCommonCollectForwardingDeque_init(self);
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(ComGoogleCommonUtilConcurrentForwardingBlockingDeque)
