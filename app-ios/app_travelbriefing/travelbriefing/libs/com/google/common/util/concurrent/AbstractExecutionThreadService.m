...
//  source: ../target/dependency/com/google/common/util/concurrent/AbstractExecutionThreadService.java
//
...
- (id<JavaUtilConcurrentExecutor>)executor {
  return create_ComGoogleCommonUtilConcurrentAbstractExecutionThreadService_2_initWithComGoogleCommonUtilConcurrentAbstractExecutionThreadService_(self);
}
...
- (id<ComGoogleCommonUtilConcurrentService>)startAsync {
  [((id<ComGoogleCommonUtilConcurrentService>) nil_chk(delegate_)) startAsync];
  return self;
}

- (id<ComGoogleCommonUtilConcurrentService>)stopAsync {
  [((id<ComGoogleCommonUtilConcurrentService>) nil_chk(delegate_)) stopAsync];
  return self;
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentAbstractExecutionThreadService class]) {
    JreStrongAssign(&ComGoogleCommonUtilConcurrentAbstractExecutionThreadService_logger, JavaUtilLoggingLogger_getLoggerWithNSString_([ComGoogleCommonUtilConcurrentAbstractExecutionThreadService_class_() getName]));
...
void ComGoogleCommonUtilConcurrentAbstractExecutionThreadService_init(ComGoogleCommonUtilConcurrentAbstractExecutionThreadService *self) {
  NSObject_init(self);
  JreStrongAssignAndConsume(&self->delegate_, new_ComGoogleCommonUtilConcurrentAbstractExecutionThreadService_1_initWithComGoogleCommonUtilConcurrentAbstractExecutionThreadService_(self));
}
...
- (void)doStart {
  ...
  [((id<JavaUtilConcurrentExecutor>) nil_chk(executor)) executeWithJavaLangRunnable:create_ComGoogleCommonUtilConcurrentAbstractExecutionThreadService_1_2_initWithComGoogleCommonUtilConcurrentAbstractExecutionThreadService_1_(self)];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentAbstractExecutionThreadService_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 4, 1, 1, -1, -1, -1, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentAbstractExecutionThreadService_1_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 1, 0, -1, 1, 2, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentAbstractExecutionThreadService_1_2 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 1, 0, -1, 1, -1, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentAbstractExecutionThreadService_2 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 1, 2, -1, 3, -1, -1 };
