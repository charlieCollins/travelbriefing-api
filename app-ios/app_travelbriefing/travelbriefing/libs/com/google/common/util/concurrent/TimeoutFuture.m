...
//  source: ../target/dependency/com/google/common/util/concurrent/TimeoutFuture.java
//
...
- (void)afterDone {
  ...
  JreStrongAssign(&delegateRef_, nil);
  JreStrongAssign(&timer_, nil);
}

- (void)dealloc {
  RELEASE_(delegateRef_);
  RELEASE_(timer_);
  [super dealloc];
}
...
id<ComGoogleCommonUtilConcurrentListenableFuture> ComGoogleCommonUtilConcurrentTimeoutFuture_createWithComGoogleCommonUtilConcurrentListenableFuture_withLong_withJavaUtilConcurrentTimeUnit_withJavaUtilConcurrentScheduledExecutorService_(id<ComGoogleCommonUtilConcurrentListenableFuture> delegate, jlong time, JavaUtilConcurrentTimeUnit *unit, id<JavaUtilConcurrentScheduledExecutorService> scheduledExecutor) {
  ...
  ComGoogleCommonUtilConcurrentTimeoutFuture *result = create_ComGoogleCommonUtilConcurrentTimeoutFuture_initWithComGoogleCommonUtilConcurrentListenableFuture_(delegate);
  ComGoogleCommonUtilConcurrentTimeoutFuture_Fire *fire = create_ComGoogleCommonUtilConcurrentTimeoutFuture_Fire_initWithComGoogleCommonUtilConcurrentTimeoutFuture_(result);
  JreStrongAssign(&result->timer_, [((id<JavaUtilConcurrentScheduledExecutorService>) nil_chk(scheduledExecutor)) scheduleWithJavaLangRunnable:fire withLong:time withJavaUtilConcurrentTimeUnit:unit]);
...
void ComGoogleCommonUtilConcurrentTimeoutFuture_initWithComGoogleCommonUtilConcurrentListenableFuture_(ComGoogleCommonUtilConcurrentTimeoutFuture *self, id<ComGoogleCommonUtilConcurrentListenableFuture> delegate) {
  ...
  JreStrongAssign(&self->delegateRef_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(delegate));
}
...
- (void)run {
  ...
  JreStrongAssign(&timeoutFutureRef_, nil);
  if ([delegate isDone]) {
    [timeoutFuture setFutureWithComGoogleCommonUtilConcurrentListenableFuture:delegate];
  }
  else {
    @try {
      [timeoutFuture setExceptionWithNSException:create_JavaUtilConcurrentTimeoutException_initWithNSString_(JreStrcat("$@", @"Future timed out: ", delegate))];
    }
    @finally {
...
void ComGoogleCommonUtilConcurrentTimeoutFuture_Fire_initWithComGoogleCommonUtilConcurrentTimeoutFuture_(ComGoogleCommonUtilConcurrentTimeoutFuture_Fire *self, ComGoogleCommonUtilConcurrentTimeoutFuture *timeoutFuture) {
  NSObject_init(self);
  JreStrongAssign(&self->timeoutFutureRef_, timeoutFuture);
}
