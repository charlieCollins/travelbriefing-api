...
//  source: ../target/dependency/com/google/common/util/concurrent/JdkFutureAdapters.java
//
...
id<ComGoogleCommonUtilConcurrentListenableFuture> ComGoogleCommonUtilConcurrentJdkFutureAdapters_listenInPoolThreadWithJavaUtilConcurrentFuture_(id<JavaUtilConcurrentFuture> future) {
  ...
  return create_ComGoogleCommonUtilConcurrentJdkFutureAdapters_ListenableFutureAdapter_initWithJavaUtilConcurrentFuture_(future);
}
...
id<ComGoogleCommonUtilConcurrentListenableFuture> ComGoogleCommonUtilConcurrentJdkFutureAdapters_listenInPoolThreadWithJavaUtilConcurrentFuture_withJavaUtilConcurrentExecutor_(id<JavaUtilConcurrentFuture> future, id<JavaUtilConcurrentExecutor> executor) {
  ...
  return create_ComGoogleCommonUtilConcurrentJdkFutureAdapters_ListenableFutureAdapter_initWithJavaUtilConcurrentFuture_withJavaUtilConcurrentExecutor_(future, executor);
}
...
- (void)addListenerWithJavaLangRunnable:(id<JavaLangRunnable>)listener
  ...
  if ([((JavaUtilConcurrentAtomicAtomicBoolean *) nil_chk(hasListeners_)) compareAndSetWithBoolean:false withBoolean:true]) {
    ...
    [((id<JavaUtilConcurrentExecutor>) nil_chk(adapterExecutor_)) executeWithJavaLangRunnable:create_ComGoogleCommonUtilConcurrentJdkFutureAdapters_ListenableFutureAdapter_1_initWithComGoogleCommonUtilConcurrentJdkFutureAdapters_ListenableFutureAdapter_(self)];
  }
}

- (void)dealloc {
  RELEASE_(adapterExecutor_);
  RELEASE_(executionList_);
  RELEASE_(hasListeners_);
  RELEASE_(delegate_);
  [super dealloc];
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentJdkFutureAdapters_ListenableFutureAdapter class]) {
    JreStrongAssign(&ComGoogleCommonUtilConcurrentJdkFutureAdapters_ListenableFutureAdapter_threadFactory, [((ComGoogleCommonUtilConcurrentThreadFactoryBuilder *) nil_chk([((ComGoogleCommonUtilConcurrentThreadFactoryBuilder *) nil_chk([create_ComGoogleCommonUtilConcurrentThreadFactoryBuilder_init() setDaemonWithBoolean:true])) setNameFormatWithNSString:@"ListenableFutureAdapter-thread-%d"])) build]);
    JreStrongAssign(&ComGoogleCommonUtilConcurrentJdkFutureAdapters_ListenableFutureAdapter_defaultAdapterExecutor, JavaUtilConcurrentExecutors_newCachedThreadPoolWithJavaUtilConcurrentThreadFactory_(ComGoogleCommonUtilConcurrentJdkFutureAdapters_ListenableFutureAdapter_threadFactory));
...
void ComGoogleCommonUtilConcurrentJdkFutureAdapters_ListenableFutureAdapter_initWithJavaUtilConcurrentFuture_withJavaUtilConcurrentExecutor_(ComGoogleCommonUtilConcurrentJdkFutureAdapters_ListenableFutureAdapter *self, id<JavaUtilConcurrentFuture> delegate, id<JavaUtilConcurrentExecutor> adapterExecutor) {
  ...
  JreStrongAssignAndConsume(&self->executionList_, new_ComGoogleCommonUtilConcurrentExecutionList_init());
  JreStrongAssignAndConsume(&self->hasListeners_, new_JavaUtilConcurrentAtomicAtomicBoolean_initWithBoolean_(false));
  JreStrongAssign(&self->delegate_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(delegate));
  JreStrongAssign(&self->adapterExecutor_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(adapterExecutor));
}
...
- (void)run {
  @try {
    ComGoogleCommonUtilConcurrentUninterruptibles_getUninterruptiblyWithJavaUtilConcurrentFuture_(this$0_->delegate_);
  }
  @catch (NSException *e) {
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentJdkFutureAdapters_ListenableFutureAdapter_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 1, 1, -1, 2, -1, -1 };
