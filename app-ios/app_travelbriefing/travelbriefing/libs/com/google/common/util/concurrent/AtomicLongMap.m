...
//  source: ../target/dependency/com/google/common/util/concurrent/AtomicLongMap.java
//
...
withJavaUtilFunctionLongUnaryOperator:(id<JavaUtilFunctionLongUnaryOperator>)updaterFunction {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(updaterFunction);
  return [((JavaLangLong *) nil_chk([((JavaUtilConcurrentConcurrentHashMap *) nil_chk(map_)) computeWithId:key withJavaUtilFunctionBiFunction:create_ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$3_initWithJavaUtilFunctionLongUnaryOperator_(updaterFunction)])) longLongValue];
}

- (jlong)getAndUpdateWithId:(id)key
withJavaUtilFunctionLongUnaryOperator:(id<JavaUtilFunctionLongUnaryOperator>)updaterFunction {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(updaterFunction);
  JavaUtilConcurrentAtomicAtomicLong *holder = create_JavaUtilConcurrentAtomicAtomicLong_init();
  [((JavaUtilConcurrentConcurrentHashMap *) nil_chk(map_)) computeWithId:key withJavaUtilFunctionBiFunction:create_ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$4_initWithJavaUtilConcurrentAtomicAtomicLong_withJavaUtilFunctionLongUnaryOperator_(holder, updaterFunction)];
  return [holder get];
}
...
withJavaUtilFunctionLongBinaryOperator:(id<JavaUtilFunctionLongBinaryOperator>)accumulatorFunction {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(accumulatorFunction);
  return [self updateAndGetWithId:key withJavaUtilFunctionLongUnaryOperator:create_ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$5_initWithJavaUtilFunctionLongBinaryOperator_withLong_(accumulatorFunction, x)];
}
...
withJavaUtilFunctionLongBinaryOperator:(id<JavaUtilFunctionLongBinaryOperator>)accumulatorFunction {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(accumulatorFunction);
  return [self getAndUpdateWithId:key withJavaUtilFunctionLongUnaryOperator:create_ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$6_initWithJavaUtilFunctionLongBinaryOperator_withLong_(accumulatorFunction, x)];
}

- (jlong)putWithId:(id)key
          withLong:(jlong)newValue {
  return [self getAndUpdateWithId:key withJavaUtilFunctionLongUnaryOperator:create_ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$7_initWithLong_(newValue)];
}

- (void)putAllWithJavaUtilMap:(id<JavaUtilMap>)m {
  [((id<JavaUtilMap>) nil_chk(m)) forEachWithJavaUtilFunctionBiConsumer:create_ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$8_initWithComGoogleCommonUtilConcurrentAtomicLongMap_(self)];
}
...
- (id<JavaUtilMap>)asMap {
  ...
  return (result == nil) ? JreStrongAssign(&asMap_, ComGoogleCommonUtilConcurrentAtomicLongMap_createAsMap(self)) : result;
}
...
- (jlong)putIfAbsentWithId:(id)key
                  withLong:(jlong)newValue {
  JavaUtilConcurrentAtomicAtomicBoolean *noValue = create_JavaUtilConcurrentAtomicAtomicBoolean_initWithBoolean_(false);
  JavaLangLong *result = [((JavaUtilConcurrentConcurrentHashMap *) nil_chk(map_)) computeWithId:key withJavaUtilFunctionBiFunction:create_ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$11_initWithJavaUtilConcurrentAtomicAtomicBoolean_withLong_(noValue, newValue)];
...
ComGoogleCommonUtilConcurrentAtomicLongMap *ComGoogleCommonUtilConcurrentAtomicLongMap_create() {
  ...
  return create_ComGoogleCommonUtilConcurrentAtomicLongMap_initWithJavaUtilConcurrentConcurrentHashMap_(create_JavaUtilConcurrentConcurrentHashMap_init());
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$1 class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$1_instance, new_ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$1_init());
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$2 class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$2_instance, new_ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$2_init());
...
void ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$3_initWithJavaUtilFunctionLongUnaryOperator_(ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$3 *self, id<JavaUtilFunctionLongUnaryOperator> capture$0) {
  JreStrongAssign(&self->val$updaterFunction_, capture$0);
  NSObject_init(self);
}
...
void ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$4_initWithJavaUtilConcurrentAtomicAtomicLong_withJavaUtilFunctionLongUnaryOperator_(ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$4 *self, JavaUtilConcurrentAtomicAtomicLong *capture$0, id<JavaUtilFunctionLongUnaryOperator> capture$1) {
  ...
  JreStrongAssign(&self->val$updaterFunction_, capture$1);
  NSObject_init(self);
}
...
- (void)dealloc {
  RELEASE_(val$accumulatorFunction_);
  [super dealloc];
}
...
void ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$5_initWithJavaUtilFunctionLongBinaryOperator_withLong_(ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$5 *self, id<JavaUtilFunctionLongBinaryOperator> capture$0, jlong capture$1) {
  JreStrongAssign(&self->val$accumulatorFunction_, capture$0);
...
- (void)acceptWithId:(id)a
              withId:(id)b {
  [target$_ putWithId:a withLong:b];
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$9 class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$9_instance, new_ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$9_init());
...
- (jlong)applyAsLongWithId:(id)a {
  return [nil_chk(a) longLongValue];
}

+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$10 class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$10_instance, new_ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$10_init());
...
void ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$11_initWithJavaUtilConcurrentAtomicAtomicBoolean_withLong_(ComGoogleCommonUtilConcurrentAtomicLongMap_$Lambda$11 *self, JavaUtilConcurrentAtomicAtomicBoolean *capture$0, jlong capture$1) {
  JreStrongAssign(&self->val$noValue_, capture$0);
