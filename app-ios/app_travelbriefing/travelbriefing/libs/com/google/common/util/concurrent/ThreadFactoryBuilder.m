...
//  source: ../target/dependency/com/google/common/util/concurrent/ThreadFactoryBuilder.java
//
...
- (ComGoogleCommonUtilConcurrentThreadFactoryBuilder *)setNameFormatWithNSString:(NSString *)nameFormat {
  NSString *unused = ComGoogleCommonUtilConcurrentThreadFactoryBuilder_formatWithNSString_withNSObjectArray_(nameFormat, [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(0) } count:1 type:NSObject_class_()]);
  JreStrongAssign(&self->nameFormat_, nameFormat);
  return self;
}

- (ComGoogleCommonUtilConcurrentThreadFactoryBuilder *)setDaemonWithBoolean:(jboolean)daemon {
  JreStrongAssign(&self->daemon_, JavaLangBoolean_valueOfWithBoolean_(daemon));
  return self;
}
...
- (ComGoogleCommonUtilConcurrentThreadFactoryBuilder *)setPriorityWithInt:(jint)priority {
  ...
  JreStrongAssign(&self->priority_, JavaLangInteger_valueOfWithInt_(priority));
  return self;
}
...
- (ComGoogleCommonUtilConcurrentThreadFactoryBuilder *)setUncaughtExceptionHandlerWithJavaLangThread_UncaughtExceptionHandler:(id<JavaLangThread_UncaughtExceptionHandler>)uncaughtExceptionHandler {
  JreStrongAssign(&self->uncaughtExceptionHandler_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(uncaughtExceptionHandler));
  return self;
}
...
- (ComGoogleCommonUtilConcurrentThreadFactoryBuilder *)setThreadFactoryWithJavaUtilConcurrentThreadFactory:(id<JavaUtilConcurrentThreadFactory>)backingThreadFactory {
  JreStrongAssign(&self->backingThreadFactory_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(backingThreadFactory));
  return self;
}
...
- (void)dealloc {
  RELEASE_(nameFormat_);
  RELEASE_(daemon_);
  RELEASE_(priority_);
  RELEASE_(uncaughtExceptionHandler_);
  RELEASE_(backingThreadFactory_);
  [super dealloc];
}
...
void ComGoogleCommonUtilConcurrentThreadFactoryBuilder_init(ComGoogleCommonUtilConcurrentThreadFactoryBuilder *self) {
  NSObject_init(self);
  JreStrongAssign(&self->nameFormat_, nil);
  JreStrongAssign(&self->daemon_, nil);
  JreStrongAssign(&self->priority_, nil);
  JreStrongAssign(&self->uncaughtExceptionHandler_, nil);
  JreStrongAssign(&self->backingThreadFactory_, nil);
}
...
id<JavaUtilConcurrentThreadFactory> ComGoogleCommonUtilConcurrentThreadFactoryBuilder_buildWithComGoogleCommonUtilConcurrentThreadFactoryBuilder_(ComGoogleCommonUtilConcurrentThreadFactoryBuilder *builder) {
  ...
  JavaUtilConcurrentAtomicAtomicLong *count = (nameFormat != nil) ? create_JavaUtilConcurrentAtomicAtomicLong_initWithLong_(0) : nil;
  return create_ComGoogleCommonUtilConcurrentThreadFactoryBuilder_1_initWithJavaUtilConcurrentThreadFactory_withNSString_withJavaUtilConcurrentAtomicAtomicLong_withJavaLangBoolean_withJavaLangInteger_withJavaLangThread_UncaughtExceptionHandler_(backingThreadFactory, nameFormat, count, daemon, priority, uncaughtExceptionHandler);
}
...
- (void)dealloc {
  RELEASE_(val$backingThreadFactory_);
  RELEASE_(val$nameFormat_);
  RELEASE_(val$count_);
  RELEASE_(val$daemon_);
  RELEASE_(val$priority_);
  RELEASE_(val$uncaughtExceptionHandler_);
  [super dealloc];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentThreadFactoryBuilder_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, fields, 7, 0x8008, 2, 6, 2, -1, 3, -1, -1 };
...
void ComGoogleCommonUtilConcurrentThreadFactoryBuilder_1_initWithJavaUtilConcurrentThreadFactory_withNSString_withJavaUtilConcurrentAtomicAtomicLong_withJavaLangBoolean_withJavaLangInteger_withJavaLangThread_UncaughtExceptionHandler_(ComGoogleCommonUtilConcurrentThreadFactoryBuilder_1 *self, id<JavaUtilConcurrentThreadFactory> capture$0, NSString *capture$1, JavaUtilConcurrentAtomicAtomicLong *capture$2, JavaLangBoolean *capture$3, JavaLangInteger *capture$4, id<JavaLangThread_UncaughtExceptionHandler> capture$5) {
  JreStrongAssign(&self->val$backingThreadFactory_, capture$0);
  JreStrongAssign(&self->val$nameFormat_, capture$1);
  JreStrongAssign(&self->val$count_, capture$2);
  JreStrongAssign(&self->val$daemon_, capture$3);
  JreStrongAssign(&self->val$priority_, capture$4);
  JreStrongAssign(&self->val$uncaughtExceptionHandler_, capture$5);
  NSObject_init(self);
}
