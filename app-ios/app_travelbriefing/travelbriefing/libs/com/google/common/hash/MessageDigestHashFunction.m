...
//  source: ../target/dependency/com/google/common/hash/MessageDigestHashFunction.java
//
...
- (id<ComGoogleCommonHashHasher>)newHasher {
  if (supportsClone_) {
    @try {
      return create_ComGoogleCommonHashMessageDigestHashFunction_MessageDigestHasher_initWithJavaSecurityMessageDigest_withInt_((JavaSecurityMessageDigest *) cast_chk([((JavaSecurityMessageDigest *) nil_chk(prototype_)) java_clone], [JavaSecurityMessageDigest class]), bytes_);
    }
    @catch (JavaLangCloneNotSupportedException *e) {
    }
  }
  return create_ComGoogleCommonHashMessageDigestHashFunction_MessageDigestHasher_initWithJavaSecurityMessageDigest_withInt_(ComGoogleCommonHashMessageDigestHashFunction_getMessageDigestWithNSString_([((JavaSecurityMessageDigest *) nil_chk(prototype_)) getAlgorithm]), bytes_);
}

- (id)writeReplace {
  return create_ComGoogleCommonHashMessageDigestHashFunction_SerializedForm_initWithNSString_withInt_withNSString_([((JavaSecurityMessageDigest *) nil_chk(prototype_)) getAlgorithm], bytes_, toString_);
}
...
void ComGoogleCommonHashMessageDigestHashFunction_initWithNSString_withNSString_(ComGoogleCommonHashMessageDigestHashFunction *self, NSString *algorithmName, NSString *toString) {
  ...
  JreStrongAssign(&self->prototype_, ComGoogleCommonHashMessageDigestHashFunction_getMessageDigestWithNSString_(algorithmName));
...
jboolean ComGoogleCommonHashMessageDigestHashFunction_supportsCloneWithJavaSecurityMessageDigest_(JavaSecurityMessageDigest *digest) {
  ...
  @try {
    [((JavaSecurityMessageDigest *) nil_chk(digest)) java_clone];
    return true;
  }
  @catch (JavaLangCloneNotSupportedException *e) {
    return false;
...
- (id)readResolve {
  return create_ComGoogleCommonHashMessageDigestHashFunction_initWithNSString_withInt_withNSString_(algorithmName_, bytes_, toString_);
}

- (void)dealloc {
  RELEASE_(algorithmName_);
  RELEASE_(toString_);
  [super dealloc];
}
...
void ComGoogleCommonHashMessageDigestHashFunction_SerializedForm_initWithNSString_withInt_withNSString_(ComGoogleCommonHashMessageDigestHashFunction_SerializedForm *self, NSString *algorithmName, jint bytes, NSString *toString) {
  NSObject_init(self);
  JreStrongAssign(&self->algorithmName_, algorithmName);
  self->bytes_ = bytes;
