...
//  source: ../target/dependency/com/google/common/hash/AbstractCompositeHashFunction.java
//
...
- (id<ComGoogleCommonHashHasher>)newHasher {
  IOSObjectArray *hashers = [IOSObjectArray arrayWithLength:((IOSObjectArray *) nil_chk(functions_))->size_ type:ComGoogleCommonHashHasher_class_()];
  for (jint i = 0; i < hashers->size_; i++) {
    IOSObjectArray_Set(hashers, i, [((id<ComGoogleCommonHashHashFunction>) nil_chk(IOSObjectArray_Get(functions_, i))) newHasher]);
  }
  return create_ComGoogleCommonHashAbstractCompositeHashFunction_1_initWithComGoogleCommonHashAbstractCompositeHashFunction_withComGoogleCommonHashHasherArray_(self, hashers);
}
...
void ComGoogleCommonHashAbstractCompositeHashFunction_initWithComGoogleCommonHashHashFunctionArray_(ComGoogleCommonHashAbstractCompositeHashFunction *self, IOSObjectArray *functions) {
  ...
  JreStrongAssign(&self->functions_, functions);
}
...
- (id<ComGoogleCommonHashHasher>)putByteWithByte:(jbyte)b {
  {
    ...
    while (b__ < e__) {
      ...
      [((id<ComGoogleCommonHashHasher>) nil_chk(hasher)) putByteWithByte:b];
    }
  }
  return self;
}
...
- (id<ComGoogleCommonHashHasher>)putBytesWithByteArray:(IOSByteArray *)bytes {
  {
    ...
    while (b__ < e__) {
      id<ComGoogleCommonHashHasher> hasher = *b__++;
      [((id<ComGoogleCommonHashHasher>) nil_chk(hasher)) putBytesWithByteArray:bytes];
    }
  }
  return self;
}
...
- (id<ComGoogleCommonHashHasher>)putBytesWithByteArray:(IOSByteArray *)bytes
                                               ...
                                               withInt:(jint)len {
  {
    ...
    while (b__ < e__) {
      id<ComGoogleCommonHashHasher> hasher = *b__++;
      [((id<ComGoogleCommonHashHasher>) nil_chk(hasher)) putBytesWithByteArray:bytes withInt:off withInt:len];
    }
  }
  return self;
}
...
- (id<ComGoogleCommonHashHasher>)putShortWithShort:(jshort)s {
  {
    ...
    while (b__ < e__) {
      id<ComGoogleCommonHashHasher> hasher = *b__++;
      [((id<ComGoogleCommonHashHasher>) nil_chk(hasher)) putShortWithShort:s];
    }
  }
  return self;
}
...
- (id<ComGoogleCommonHashHasher>)putIntWithInt:(jint)i {
  {
    ...
    while (b__ < e__) {
      id<ComGoogleCommonHashHasher> hasher = *b__++;
      [((id<ComGoogleCommonHashHasher>) nil_chk(hasher)) putIntWithInt:i];
    }
  }
  return self;
}
...
- (id<ComGoogleCommonHashHasher>)putLongWithLong:(jlong)l {
  {
    ...
    while (b__ < e__) {
      id<ComGoogleCommonHashHasher> hasher = *b__++;
      [((id<ComGoogleCommonHashHasher>) nil_chk(hasher)) putLongWithLong:l];
    }
  }
  return self;
}
...
- (id<ComGoogleCommonHashHasher>)putFloatWithFloat:(jfloat)f {
  {
    ...
    while (b__ < e__) {
      id<ComGoogleCommonHashHasher> hasher = *b__++;
      [((id<ComGoogleCommonHashHasher>) nil_chk(hasher)) putFloatWithFloat:f];
    }
  }
  return self;
}
...
- (id<ComGoogleCommonHashHasher>)putDoubleWithDouble:(jdouble)d {
  {
    ...
    while (b__ < e__) {
      id<ComGoogleCommonHashHasher> hasher = *b__++;
      [((id<ComGoogleCommonHashHasher>) nil_chk(hasher)) putDoubleWithDouble:d];
    }
  }
  return self;
}
...
- (id<ComGoogleCommonHashHasher>)putBooleanWithBoolean:(jboolean)b {
  {
    ...
    while (b__ < e__) {
      id<ComGoogleCommonHashHasher> hasher = *b__++;
      [((id<ComGoogleCommonHashHasher>) nil_chk(hasher)) putBooleanWithBoolean:b];
    }
  }
  return self;
}
...
- (id<ComGoogleCommonHashHasher>)putCharWithChar:(jchar)c {
  {
    ...
    while (b__ < e__) {
      id<ComGoogleCommonHashHasher> hasher = *b__++;
      [((id<ComGoogleCommonHashHasher>) nil_chk(hasher)) putCharWithChar:c];
    }
  }
  return self;
}
...
- (id<ComGoogleCommonHashHasher>)putUnencodedCharsWithJavaLangCharSequence:(id<JavaLangCharSequence>)chars {
  {
    ...
    while (b__ < e__) {
      id<ComGoogleCommonHashHasher> hasher = *b__++;
      [((id<ComGoogleCommonHashHasher>) nil_chk(hasher)) putUnencodedCharsWithJavaLangCharSequence:chars];
    }
  }
  return self;
}
...
- (id<ComGoogleCommonHashHasher>)putStringWithJavaLangCharSequence:(id<JavaLangCharSequence>)chars
                                         withJavaNioCharsetCharset:(JavaNioCharsetCharset *)charset {
  {
    ...
    while (b__ < e__) {
      id<ComGoogleCommonHashHasher> hasher = *b__++;
      [((id<ComGoogleCommonHashHasher>) nil_chk(hasher)) putStringWithJavaLangCharSequence:chars withJavaNioCharsetCharset:charset];
    }
  }
  return self;
}
...
- (id<ComGoogleCommonHashHasher>)putObjectWithId:(id)instance
                   withComGoogleCommonHashFunnel:(id<ComGoogleCommonHashFunnel>)funnel {
  {
    ...
    while (b__ < e__) {
      id<ComGoogleCommonHashHasher> hasher = *b__++;
      [((id<ComGoogleCommonHashHasher>) nil_chk(hasher)) putObjectWithId:instance withComGoogleCommonHashFunnel:funnel];
    }
  }
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonHashAbstractCompositeHashFunction_1 = { "", "com.google.common.hash", ptrTable, methods, fields, 7, 0x8008, 15, 2, 27, -1, 28, -1, -1 };
...
void ComGoogleCommonHashAbstractCompositeHashFunction_1_initWithComGoogleCommonHashAbstractCompositeHashFunction_withComGoogleCommonHashHasherArray_(ComGoogleCommonHashAbstractCompositeHashFunction_1 *self, ComGoogleCommonHashAbstractCompositeHashFunction *outer$, IOSObjectArray *capture$0) {
  ...
  JreStrongAssign(&self->val$hashers_, capture$0);
  NSObject_init(self);
}
