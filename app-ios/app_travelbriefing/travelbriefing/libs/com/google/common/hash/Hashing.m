...
//  source: ../target/dependency/com/google/common/hash/Hashing.java
//
...
__attribute__((unused)) static void ComGoogleCommonHashHashing_ChecksumType_1_initWithInt_withNSString_withInt_(ComGoogleCommonHashHashing_ChecksumType_1 *self, jint param0, NSString *__name, jint __ordinal);
...
__attribute__((unused)) static void ComGoogleCommonHashHashing_ChecksumType_2_initWithInt_withNSString_withInt_(ComGoogleCommonHashHashing_ChecksumType_2 *self, jint param0, NSString *__name, jint __ordinal);
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LComGoogleCommonHashHashFunction;", 0x9, -1, -1, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonHashHashFunction;", 0x9, -1, -1, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonHashHashFunction;", 0x9, 6, 7, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonHashHashFunction;", 0x9, 6, 8, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonHashHashFunction;", 0x9, 9, 7, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonHashHashFunction;", 0x9, 9, 8, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonHashHashFunction;", 0x9, 10, 7, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonHashHashFunction;", 0x9, 10, 8, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonHashHashFunction;", 0x9, 11, 7, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonHashHashFunction;", 0x9, 11, 8, -1, -1, -1, -1 },
    { NULL, "LNSString;", 0xa, 12, 13, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonHashHashFunction;", 0x9, -1, -1, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonHashHashFunction;", 0x9, -1, -1, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonHashHashFunction;", 0x9, -1, -1, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonHashHashFunction;", 0xa, 14, 15, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonHashHashFunction;", 0x9, -1, -1, -1, -1, -1, -1 },
    { NULL, "I", 0x9, 16, 17, -1, -1, -1, -1 },
    { NULL, "I", 0x9, 16, 18, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonHashHashCode;", 0x9, 19, 20, -1, 21, -1, -1 },
    { NULL, "LComGoogleCommonHashHashCode;", 0x9, 22, 20, -1, 21, -1, -1 },
    { NULL, "I", 0x8, 23, 1, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonHashHashFunction;", 0x89, 24, 25, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonHashHashFunction;", 0x9, 24, 20, -1, 26, -1, -1 },
...
id<ComGoogleCommonHashHashFunction> ComGoogleCommonHashHashing_goodFastHashWithInt_(jint minimumBits) {
  ...
  IOSObjectArray *hashFunctions = [IOSObjectArray arrayWithLength:hashFunctionsNeeded type:ComGoogleCommonHashHashFunction_class_()];
  IOSObjectArray_Set(hashFunctions, 0, JreLoadStatic(ComGoogleCommonHashHashing_Murmur3_128Holder, GOOD_FAST_HASH_FUNCTION_128));
  jint seed = ComGoogleCommonHashHashing_GOOD_FAST_HASH_SEED;
  for (jint i = 1; i < hashFunctionsNeeded; i++) {
    seed += 1500450271;
    IOSObjectArray_Set(hashFunctions, i, ComGoogleCommonHashHashing_murmur3_128WithInt_(seed));
  }
  return create_ComGoogleCommonHashHashing_ConcatenatedHashFunction_initWithComGoogleCommonHashHashFunctionArray_(hashFunctions);
}

id<ComGoogleCommonHashHashFunction> ComGoogleCommonHashHashing_murmur3_32WithInt_(jint seed) {
  ComGoogleCommonHashHashing_initialize();
  return create_ComGoogleCommonHashMurmur3_32HashFunction_initWithInt_(seed);
}
...
id<ComGoogleCommonHashHashFunction> ComGoogleCommonHashHashing_murmur3_128WithInt_(jint seed) {
  ComGoogleCommonHashHashing_initialize();
  return create_ComGoogleCommonHashMurmur3_128HashFunction_initWithInt_(seed);
}
...
id<ComGoogleCommonHashHashFunction> ComGoogleCommonHashHashing_sipHash24WithLong_withLong_(jlong k0, jlong k1) {
  ComGoogleCommonHashHashing_initialize();
  return create_ComGoogleCommonHashSipHashFunction_initWithInt_withInt_withLong_withLong_(2, 4, k0, k1);
}
...
id<ComGoogleCommonHashHashFunction> ComGoogleCommonHashHashing_hmacMd5WithJavaSecurityKey_(id<JavaSecurityKey> key) {
  ComGoogleCommonHashHashing_initialize();
  return create_ComGoogleCommonHashMacHashFunction_initWithNSString_withJavaSecurityKey_withNSString_(@"HmacMD5", key, ComGoogleCommonHashHashing_hmacToStringWithNSString_withJavaSecurityKey_(@"hmacMd5", key));
}

id<ComGoogleCommonHashHashFunction> ComGoogleCommonHashHashing_hmacMd5WithByteArray_(IOSByteArray *key) {
  ComGoogleCommonHashHashing_initialize();
  return ComGoogleCommonHashHashing_hmacMd5WithJavaSecurityKey_(create_JavaxCryptoSpecSecretKeySpec_initWithByteArray_withNSString_(ComGoogleCommonBasePreconditions_checkNotNullWithId_(key), @"HmacMD5"));
}

id<ComGoogleCommonHashHashFunction> ComGoogleCommonHashHashing_hmacSha1WithJavaSecurityKey_(id<JavaSecurityKey> key) {
  ComGoogleCommonHashHashing_initialize();
  return create_ComGoogleCommonHashMacHashFunction_initWithNSString_withJavaSecurityKey_withNSString_(@"HmacSHA1", key, ComGoogleCommonHashHashing_hmacToStringWithNSString_withJavaSecurityKey_(@"hmacSha1", key));
}

id<ComGoogleCommonHashHashFunction> ComGoogleCommonHashHashing_hmacSha1WithByteArray_(IOSByteArray *key) {
  ComGoogleCommonHashHashing_initialize();
  return ComGoogleCommonHashHashing_hmacSha1WithJavaSecurityKey_(create_JavaxCryptoSpecSecretKeySpec_initWithByteArray_withNSString_(ComGoogleCommonBasePreconditions_checkNotNullWithId_(key), @"HmacSHA1"));
}

id<ComGoogleCommonHashHashFunction> ComGoogleCommonHashHashing_hmacSha256WithJavaSecurityKey_(id<JavaSecurityKey> key) {
  ComGoogleCommonHashHashing_initialize();
  return create_ComGoogleCommonHashMacHashFunction_initWithNSString_withJavaSecurityKey_withNSString_(@"HmacSHA256", key, ComGoogleCommonHashHashing_hmacToStringWithNSString_withJavaSecurityKey_(@"hmacSha256", key));
}

id<ComGoogleCommonHashHashFunction> ComGoogleCommonHashHashing_hmacSha256WithByteArray_(IOSByteArray *key) {
  ComGoogleCommonHashHashing_initialize();
  return ComGoogleCommonHashHashing_hmacSha256WithJavaSecurityKey_(create_JavaxCryptoSpecSecretKeySpec_initWithByteArray_withNSString_(ComGoogleCommonBasePreconditions_checkNotNullWithId_(key), @"HmacSHA256"));
}

id<ComGoogleCommonHashHashFunction> ComGoogleCommonHashHashing_hmacSha512WithJavaSecurityKey_(id<JavaSecurityKey> key) {
  ComGoogleCommonHashHashing_initialize();
  return create_ComGoogleCommonHashMacHashFunction_initWithNSString_withJavaSecurityKey_withNSString_(@"HmacSHA512", key, ComGoogleCommonHashHashing_hmacToStringWithNSString_withJavaSecurityKey_(@"hmacSha512", key));
}

id<ComGoogleCommonHashHashFunction> ComGoogleCommonHashHashing_hmacSha512WithByteArray_(IOSByteArray *key) {
  ComGoogleCommonHashHashing_initialize();
  return ComGoogleCommonHashHashing_hmacSha512WithJavaSecurityKey_(create_JavaxCryptoSpecSecretKeySpec_initWithByteArray_withNSString_(ComGoogleCommonBasePreconditions_checkNotNullWithId_(key), @"HmacSHA512"));
}
...
NSString *ComGoogleCommonHashHashing_hmacToStringWithNSString_withJavaSecurityKey_(NSString *methodName, id<JavaSecurityKey> key) {
  ComGoogleCommonHashHashing_initialize();
  return NSString_java_formatWithNSString_withNSObjectArray_(@"Hashing.%s(Key[algorithm=%s, format=%s])", [IOSObjectArray arrayWithObjects:(id[]){ methodName, [((id<JavaSecurityKey>) nil_chk(key)) getAlgorithm], [key getFormat] } count:3 type:NSObject_class_()]);
}
...
id<ComGoogleCommonHashHashFunction> ComGoogleCommonHashHashing_checksumHashFunctionWithComGoogleCommonHashHashing_ChecksumType_withNSString_(ComGoogleCommonHashHashing_ChecksumType *type, NSString *toString) {
  ComGoogleCommonHashHashing_initialize();
  return create_ComGoogleCommonHashChecksumHashFunction_initWithComGoogleCommonBaseSupplier_withInt_withNSString_(type, ((ComGoogleCommonHashHashing_ChecksumType *) nil_chk(type))->bits_, toString);
}
...
jint ComGoogleCommonHashHashing_consistentHashWithLong_withInt_(jlong input, jint buckets) {
  ...
  ComGoogleCommonHashHashing_LinearCongruentialGenerator *generator = create_ComGoogleCommonHashHashing_LinearCongruentialGenerator_initWithLong_(input);
  jint candidate = 0;
  jint next;
  while (true) {
...
ComGoogleCommonHashHashCode *ComGoogleCommonHashHashing_combineOrderedWithJavaLangIterable_(id<JavaLangIterable> hashCodes) {
  ...
  IOSByteArray *resultBytes = [IOSByteArray arrayWithLength:bits / 8];
...
ComGoogleCommonHashHashCode *ComGoogleCommonHashHashing_combineUnorderedWithJavaLangIterable_(id<JavaLangIterable> hashCodes) {
  ...
  id<JavaUtilIterator> iterator = [((id<JavaLangIterable>) nil_chk(hashCodes)) iterator];
  ComGoogleCommonBasePreconditions_checkArgumentWithBoolean_withId_([((id<JavaUtilIterator>) nil_chk(iterator)) hasNext], @"Must be at least 1 hash code to combine.");
  IOSByteArray *resultBytes = [IOSByteArray arrayWithLength:[((ComGoogleCommonHashHashCode *) nil_chk([iterator next])) bits] / 8];
  for (ComGoogleCommonHashHashCode * __strong hashCode in hashCodes) {
    IOSByteArray *nextBytes = [((ComGoogleCommonHashHashCode *) nil_chk(hashCode)) asBytes];
    ComGoogleCommonBasePreconditions_checkArgumentWithBoolean_withId_(((IOSByteArray *) nil_chk(nextBytes))->size_ == resultBytes->size_, @"All hashcodes must have the same bit length.");
    for (jint i = 0; i < nextBytes->size_; i++) {
...
id<ComGoogleCommonHashHashFunction> ComGoogleCommonHashHashing_concatenatingWithComGoogleCommonHashHashFunction_withComGoogleCommonHashHashFunction_withComGoogleCommonHashHashFunctionArray_(id<ComGoogleCommonHashHashFunction> first, id<ComGoogleCommonHashHashFunction> second, IOSObjectArray *rest) {
  ...
  return create_ComGoogleCommonHashHashing_ConcatenatedHashFunction_initWithComGoogleCommonHashHashFunctionArray_([list toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:0 type:ComGoogleCommonHashHashFunction_class_()]]);
}
...
id<ComGoogleCommonHashHashFunction> ComGoogleCommonHashHashing_concatenatingWithJavaLangIterable_(id<JavaLangIterable> hashFunctions) {
  ComGoogleCommonHashHashing_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(hashFunctions);
  id<JavaUtilList> list = create_JavaUtilArrayList_init();
...
+ (void)initialize {
  if (self == [ComGoogleCommonHashHashing_Murmur3_32Holder class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonHashHashing_Murmur3_32Holder_MURMUR3_32, new_ComGoogleCommonHashMurmur3_32HashFunction_initWithInt_(0));
    JreStrongAssign(&ComGoogleCommonHashHashing_Murmur3_32Holder_GOOD_FAST_HASH_FUNCTION_32, ComGoogleCommonHashHashing_murmur3_32WithInt_(JreLoadStatic(ComGoogleCommonHashHashing, GOOD_FAST_HASH_SEED)));
...
+ (void)initialize {
  if (self == [ComGoogleCommonHashHashing_Murmur3_128Holder class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonHashHashing_Murmur3_128Holder_MURMUR3_128, new_ComGoogleCommonHashMurmur3_128HashFunction_initWithInt_(0));
    JreStrongAssign(&ComGoogleCommonHashHashing_Murmur3_128Holder_GOOD_FAST_HASH_FUNCTION_128, ComGoogleCommonHashHashing_murmur3_128WithInt_(JreLoadStatic(ComGoogleCommonHashHashing, GOOD_FAST_HASH_SEED)));
...
+ (void)initialize {
  if (self == [ComGoogleCommonHashHashing_SipHash24Holder class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonHashHashing_SipHash24Holder_SIP_HASH_24, new_ComGoogleCommonHashSipHashFunction_initWithInt_withInt_withLong_withLong_(2, 4, (jlong) 0x0706050403020100LL, (jlong) 0x0f0e0d0c0b0a0908LL));
...
+ (void)initialize {
  if (self == [ComGoogleCommonHashHashing_Md5Holder class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonHashHashing_Md5Holder_MD5, new_ComGoogleCommonHashMessageDigestHashFunction_initWithNSString_withNSString_(@"MD5", @"Hashing.md5()"));
...
+ (void)initialize {
  if (self == [ComGoogleCommonHashHashing_Sha1Holder class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonHashHashing_Sha1Holder_SHA_1, new_ComGoogleCommonHashMessageDigestHashFunction_initWithNSString_withNSString_(@"SHA-1", @"Hashing.sha1()"));
...
+ (void)initialize {
  if (self == [ComGoogleCommonHashHashing_Sha256Holder class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonHashHashing_Sha256Holder_SHA_256, new_ComGoogleCommonHashMessageDigestHashFunction_initWithNSString_withNSString_(@"SHA-256", @"Hashing.sha256()"));
...
+ (void)initialize {
  if (self == [ComGoogleCommonHashHashing_Sha384Holder class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonHashHashing_Sha384Holder_SHA_384, new_ComGoogleCommonHashMessageDigestHashFunction_initWithNSString_withNSString_(@"SHA-384", @"Hashing.sha384()"));
...
+ (void)initialize {
  if (self == [ComGoogleCommonHashHashing_Sha512Holder class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonHashHashing_Sha512Holder_SHA_512, new_ComGoogleCommonHashMessageDigestHashFunction_initWithNSString_withNSString_(@"SHA-512", @"Hashing.sha512()"));
...
+ (void)initialize {
  if (self == [ComGoogleCommonHashHashing_Crc32cHolder class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonHashHashing_Crc32cHolder_CRC_32_C, new_ComGoogleCommonHashCrc32cHashFunction_init());
...
+ (void)initialize {
  if (self == [ComGoogleCommonHashHashing_Crc32Holder class]) {
    JreStrongAssign(&ComGoogleCommonHashHashing_Crc32Holder_CRC_32, ComGoogleCommonHashHashing_checksumHashFunctionWithComGoogleCommonHashHashing_ChecksumType_withNSString_(JreLoadEnum(ComGoogleCommonHashHashing_ChecksumType, CRC_32), @"Hashing.crc32()"));
...
+ (void)initialize {
  if (self == [ComGoogleCommonHashHashing_Adler32Holder class]) {
    JreStrongAssign(&ComGoogleCommonHashHashing_Adler32Holder_ADLER_32, ComGoogleCommonHashHashing_checksumHashFunctionWithComGoogleCommonHashHashing_ChecksumType_withNSString_(JreLoadEnum(ComGoogleCommonHashHashing_ChecksumType, ADLER_32), @"Hashing.adler32()"));
...
+ (void)initialize {
  if (self == [ComGoogleCommonHashHashing_ChecksumType class]) {
    size_t allocSize = 0;
    size_t objSize_CRC_32 = class_getInstanceSize([ComGoogleCommonHashHashing_ChecksumType_1 class]);
    allocSize += objSize_CRC_32;
    size_t objSize_ADLER_32 = class_getInstanceSize([ComGoogleCommonHashHashing_ChecksumType_2 class]);
    allocSize += objSize_ADLER_32;
    uintptr_t ptr = (uintptr_t)calloc(allocSize, 1);
    id e;
    (JreEnum(ComGoogleCommonHashHashing_ChecksumType, CRC_32) = e = objc_constructInstance([ComGoogleCommonHashHashing_ChecksumType_1 class], (void *)ptr), ptr += objSize_CRC_32);
    ComGoogleCommonHashHashing_ChecksumType_1_initWithInt_withNSString_withInt_(e, 32, @"CRC_32", 0);
    (JreEnum(ComGoogleCommonHashHashing_ChecksumType, ADLER_32) = e = objc_constructInstance([ComGoogleCommonHashHashing_ChecksumType_2 class], (void *)ptr), ptr += objSize_ADLER_32);
    ComGoogleCommonHashHashing_ChecksumType_2_initWithInt_withNSString_withInt_(e, 32, @"ADLER_32", 1);
...
- (id<JavaUtilZipChecksum>)get {
  return create_JavaUtilZipCRC32_init();
}
...
void ComGoogleCommonHashHashing_ChecksumType_1_initWithInt_withNSString_withInt_(ComGoogleCommonHashHashing_ChecksumType_1 *self, jint param0, NSString *__name, jint __ordinal) {
  ComGoogleCommonHashHashing_ChecksumType_initWithInt_withNSString_withInt_(self, param0, __name, __ordinal);
}

@implementation ComGoogleCommonHashHashing_ChecksumType_2

- (id<JavaUtilZipChecksum>)get {
  return create_JavaUtilZipAdler32_init();
}
...
void ComGoogleCommonHashHashing_ChecksumType_2_initWithInt_withNSString_withInt_(ComGoogleCommonHashHashing_ChecksumType_2 *self, jint param0, NSString *__name, jint __ordinal) {
  ComGoogleCommonHashHashing_ChecksumType_initWithInt_withNSString_withInt_(self, param0, __name, __ordinal);
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonHashHashing_FarmHashFingerprint64Holder class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonHashHashing_FarmHashFingerprint64Holder_FARMHASH_FINGERPRINT_64, new_ComGoogleCommonHashFarmHashFingerprint64_init());
...
- (jboolean)isEqual:(id)object {
  if ([object isKindOfClass:[ComGoogleCommonHashHashing_ConcatenatedHashFunction class]]) {
    ...
    return JavaUtilArrays_equalsWithNSObjectArray_withNSObjectArray_(functions_, ((ComGoogleCommonHashAbstractCompositeHashFunction *) nil_chk(other))->functions_);
  }
  return false;
}
