...
//  source: ../target/dependency/com/google/common/io/Files.java
//
...
+ (IOSObjectArray *)modesWithBoolean:(jboolean)append;
...
__attribute__((unused)) static IOSObjectArray *ComGoogleCommonIoFiles_modesWithBoolean_(jboolean append);

__attribute__((unused)) static void ComGoogleCommonIoFiles_writeWithJavaLangCharSequence_withJavaIoFile_withJavaNioCharsetCharset_withBoolean_(id<JavaLangCharSequence> from, JavaIoFile *to, JavaNioCharsetCharset *charset, jboolean append);
...
@interface ComGoogleCommonIoFiles_2 : NSObject < ComGoogleCommonIoLineProcessor > {
 @public
...
J2OBJC_FIELD_SETTER(ComGoogleCommonIoFiles_2, result_, id<JavaUtilList>)
...
@interface ComGoogleCommonIoFiles_1 : ComGoogleCommonCollectTreeTraverser
...
+ (IOSObjectArray *)modesWithBoolean:(jboolean)append {
  return ComGoogleCommonIoFiles_modesWithBoolean_(append);
}
...
+ (void)writeWithJavaLangCharSequence:(id<JavaLangCharSequence>)from
            ...
            withJavaNioCharsetCharset:(JavaNioCharsetCharset *)charset
                          withBoolean:(jboolean)append {
  ComGoogleCommonIoFiles_writeWithJavaLangCharSequence_withJavaIoFile_withJavaNioCharsetCharset_withBoolean_(from, to, charset, append);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "[LComGoogleCommonIoFileWriteMode;", 0xa, 14, 15, -1, -1, -1, -1 },
    { NULL, "[B", 0x9, 16, 5, 8, -1, -1, -1 },
    { NULL, "LNSString;", 0x9, 17, 1, 8, -1, -1, -1 },
    { NULL, "V", 0x9, 18, 19, 8, -1, -1, -1 },
    { NULL, "V", 0x9, 20, 21, 8, -1, -1, -1 },
    { NULL, "V", 0x9, 20, 22, 8, -1, -1, -1 },
    { NULL, "V", 0x9, 18, 23, 8, -1, -1, -1 },
    { NULL, "V", 0x9, 24, 23, 8, -1, -1, -1 },
    { NULL, "V", 0xa, 18, 25, 8, -1, -1, -1 },
    { NULL, "V", 0x9, 20, 26, 8, -1, -1, -1 },
    { NULL, "Z", 0x9, 27, 22, 8, -1, -1, -1 },
    { NULL, "LJavaIoFile;", 0x9, -1, -1, -1, -1, -1, -1 },
    { NULL, "V", 0x9, 28, 5, 8, -1, -1, -1 },
    { NULL, "V", 0x9, 29, 5, 8, -1, -1, -1 },
    { NULL, "V", 0x9, 30, 22, 8, -1, -1, -1 },
    { NULL, "LNSString;", 0x9, 31, 1, 8, -1, -1, -1 },
    { NULL, "LJavaUtilList;", 0x9, 32, 1, 8, 33, -1, -1 },
    { NULL, "LNSObject;", 0x9, 32, 34, 8, 35, -1, -1 },
    { NULL, "LNSObject;", 0x9, 36, 37, 8, 38, -1, -1 },
    { NULL, "LComGoogleCommonHashHashCode;", 0x9, 39, 40, 8, -1, -1, -1 },
    { NULL, "LJavaNioMappedByteBuffer;", 0x9, 41, 5, 8, -1, -1, -1 },
    { NULL, "LJavaNioMappedByteBuffer;", 0x9, 41, 42, 8, -1, -1, -1 },
    { NULL, "LJavaNioMappedByteBuffer;", 0x9, 41, 43, 44, -1, -1, -1 },
    { NULL, "LJavaNioMappedByteBuffer;", 0xa, 41, 45, 8, -1, -1, -1 },
    { NULL, "LNSString;", 0x9, 46, 47, -1, -1, -1, -1 },
    { NULL, "LNSString;", 0x9, 48, 47, -1, -1, -1, -1 },
    { NULL, "LNSString;", 0x9, 49, 47, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonCollectTreeTraverser;", 0x9, -1, -1, -1, 50, -1, -1 },
    { NULL, "LComGoogleCommonBasePredicate;", 0x9, -1, -1, -1, 51, -1, -1 },
    { NULL, "LComGoogleCommonBasePredicate;", 0x9, -1, -1, -1, 51, -1, -1 },
  };
  ...
  methods[8].selector = @selector(modesWithBoolean:);
  methods[9].selector = @selector(toByteArrayWithJavaIoFile:);
  methods[10].selector = @selector(toStringWithJavaIoFile:withJavaNioCharsetCharset:);
  methods[11].selector = @selector(writeWithByteArray:withJavaIoFile:);
  methods[12].selector = @selector(copy__WithJavaIoFile:withJavaIoOutputStream:);
  methods[13].selector = @selector(copy__WithJavaIoFile:withJavaIoFile:);
  methods[14].selector = @selector(writeWithJavaLangCharSequence:withJavaIoFile:withJavaNioCharsetCharset:);
  methods[15].selector = @selector(appendWithJavaLangCharSequence:withJavaIoFile:withJavaNioCharsetCharset:);
  methods[16].selector = @selector(writeWithJavaLangCharSequence:withJavaIoFile:withJavaNioCharsetCharset:withBoolean:);
  methods[17].selector = @selector(copy__WithJavaIoFile:withJavaNioCharsetCharset:withJavaLangAppendable:);
  methods[18].selector = @selector(equalWithJavaIoFile:withJavaIoFile:);
  methods[19].selector = @selector(createTempDir);
  methods[20].selector = @selector(touchWithJavaIoFile:);
  methods[21].selector = @selector(createParentDirsWithJavaIoFile:);
  methods[22].selector = @selector(moveWithJavaIoFile:withJavaIoFile:);
  methods[23].selector = @selector(readFirstLineWithJavaIoFile:withJavaNioCharsetCharset:);
  methods[24].selector = @selector(readLinesWithJavaIoFile:withJavaNioCharsetCharset:);
  methods[25].selector = @selector(readLinesWithJavaIoFile:withJavaNioCharsetCharset:withComGoogleCommonIoLineProcessor:);
  methods[26].selector = @selector(readBytesWithJavaIoFile:withComGoogleCommonIoByteProcessor:);
  methods[27].selector = @selector(hash__WithJavaIoFile:withComGoogleCommonHashHashFunction:);
  methods[28].selector = @selector(mapWithJavaIoFile:);
  methods[29].selector = @selector(mapWithJavaIoFile:withJavaNioChannelsFileChannel_MapMode:);
  methods[30].selector = @selector(mapWithJavaIoFile:withJavaNioChannelsFileChannel_MapMode:withLong:);
  methods[31].selector = @selector(mapWithJavaIoRandomAccessFile:withJavaNioChannelsFileChannel_MapMode:withLong:);
  methods[32].selector = @selector(simplifyPathWithNSString:);
  methods[33].selector = @selector(getFileExtensionWithNSString:);
  methods[34].selector = @selector(getNameWithoutExtensionWithNSString:);
  methods[35].selector = @selector(fileTreeTraverser);
  methods[36].selector = @selector(isDirectory);
  methods[37].selector = @selector(isFile);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "TEMP_DIR_ATTEMPTS", "I", .constantValue.asInt = ComGoogleCommonIoFiles_TEMP_DIR_ATTEMPTS, 0x1a, -1, -1, -1, -1 },
    { "FILE_TREE_TRAVERSER", "LComGoogleCommonCollectTreeTraverser;", .constantValue.asLong = 0, 0x1a, -1, 52, 53, -1 },
  };
  static const void *ptrTable[] = { "newReader", "LJavaIoFile;LJavaNioCharsetCharset;", "LJavaIoFileNotFoundException;", "newWriter", "asByteSource", "LJavaIoFile;", "readFile", "LJavaIoInputStream;J", "LJavaIoIOException;", "asByteSink", "LJavaIoFile;[LComGoogleCommonIoFileWriteMode;", "asCharSource", "asCharSink", "LJavaIoFile;LJavaNioCharsetCharset;[LComGoogleCommonIoFileWriteMode;", "modes", "Z", "toByteArray", "toString", "write", "[BLJavaIoFile;", "copy", "LJavaIoFile;LJavaIoOutputStream;", "LJavaIoFile;LJavaIoFile;", "LJavaLangCharSequence;LJavaIoFile;LJavaNioCharsetCharset;", "append", "LJavaLangCharSequence;LJavaIoFile;LJavaNioCharsetCharset;Z", "LJavaIoFile;LJavaNioCharsetCharset;LJavaLangAppendable;", "equal", "touch", "createParentDirs", "move", "readFirstLine", "readLines", "(Ljava/io/File;Ljava/nio/charset/Charset;)Ljava/util/List<Ljava/lang/String;>;", "LJavaIoFile;LJavaNioCharsetCharset;LComGoogleCommonIoLineProcessor;", "<T:Ljava/lang/Object;>(Ljava/io/File;Ljava/nio/charset/Charset;Lcom/google/common/io/LineProcessor<TT;>;)TT;", "readBytes", "LJavaIoFile;LComGoogleCommonIoByteProcessor;", "<T:Ljava/lang/Object;>(Ljava/io/File;Lcom/google/common/io/ByteProcessor<TT;>;)TT;", "hash", "LJavaIoFile;LComGoogleCommonHashHashFunction;", "map", "LJavaIoFile;LJavaNioChannelsFileChannel_MapMode;", "LJavaIoFile;LJavaNioChannelsFileChannel_MapMode;J", "LJavaIoFileNotFoundException;LJavaIoIOException;", "LJavaIoRandomAccessFile;LJavaNioChannelsFileChannel_MapMode;J", "simplifyPath", "LNSString;", "getFileExtension", "getNameWithoutExtension", "()Lcom/google/common/collect/TreeTraverser<Ljava/io/File;>;", "()Lcom/google/common/base/Predicate<Ljava/io/File;>;", &ComGoogleCommonIoFiles_FILE_TREE_TRAVERSER, "Lcom/google/common/collect/TreeTraverser<Ljava/io/File;>;", "LComGoogleCommonIoFiles_FileByteSource;LComGoogleCommonIoFiles_FileByteSink;LComGoogleCommonIoFiles_FilePredicate;" };
  static const J2ObjcClassInfo _ComGoogleCommonIoFiles = { "Files", "com.google.common.io", ptrTable, methods, fields, 7, 0x11, 38, 2, -1, 54, -1, -1, -1 };
  return &_ComGoogleCommonIoFiles;
}

+ (void)initialize {
  if (self == [ComGoogleCommonIoFiles class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonIoFiles_FILE_TREE_TRAVERSER, new_ComGoogleCommonIoFiles_1_init());
...
JavaIoBufferedReader *ComGoogleCommonIoFiles_newReaderWithJavaIoFile_withJavaNioCharsetCharset_(JavaIoFile *file, JavaNioCharsetCharset *charset) {
  ...
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(file);
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(charset);
  return create_JavaIoBufferedReader_initWithJavaIoReader_(create_JavaIoInputStreamReader_initWithJavaIoInputStream_withJavaNioCharsetCharset_(create_JavaIoFileInputStream_initWithJavaIoFile_(file), charset));
}
...
JavaIoBufferedWriter *ComGoogleCommonIoFiles_newWriterWithJavaIoFile_withJavaNioCharsetCharset_(JavaIoFile *file, JavaNioCharsetCharset *charset) {
  ...
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(file);
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(charset);
  return create_JavaIoBufferedWriter_initWithJavaIoWriter_(create_JavaIoOutputStreamWriter_initWithJavaIoOutputStream_withJavaNioCharsetCharset_(create_JavaIoFileOutputStream_initWithJavaIoFile_(file), charset));
}

ComGoogleCommonIoByteSource *ComGoogleCommonIoFiles_asByteSourceWithJavaIoFile_(JavaIoFile *file) {
  ComGoogleCommonIoFiles_initialize();
  return create_ComGoogleCommonIoFiles_FileByteSource_initWithJavaIoFile_(file);
}
...
IOSByteArray *ComGoogleCommonIoFiles_readFileWithJavaIoInputStream_withLong_(JavaIoInputStream *inArg, jlong expectedSize) {
  ...
  if (expectedSize > JavaLangInteger_MAX_VALUE) {
    @throw create_JavaLangOutOfMemoryError_initWithNSString_(JreStrcat("$J$", @"file is too large to fit in a byte array: ", expectedSize, @" bytes"));
  }
...
ComGoogleCommonIoByteSink *ComGoogleCommonIoFiles_asByteSinkWithJavaIoFile_withComGoogleCommonIoFileWriteModeArray_(JavaIoFile *file, IOSObjectArray *modes) {
  ComGoogleCommonIoFiles_initialize();
  return create_ComGoogleCommonIoFiles_FileByteSink_initWithJavaIoFile_withComGoogleCommonIoFileWriteModeArray_(file, modes);
}
...
IOSObjectArray *ComGoogleCommonIoFiles_modesWithBoolean_(jboolean append) {
  ComGoogleCommonIoFiles_initialize();
  return append ? [IOSObjectArray arrayWithObjects:(id[]){ JreLoadEnum(ComGoogleCommonIoFileWriteMode, APPEND) } count:1 type:ComGoogleCommonIoFileWriteMode_class_()] : [IOSObjectArray arrayWithLength:0 type:ComGoogleCommonIoFileWriteMode_class_()];
}
...
void ComGoogleCommonIoFiles_writeWithByteArray_withJavaIoFile_(IOSByteArray *from, JavaIoFile *to) {
  ComGoogleCommonIoFiles_initialize();
  [((ComGoogleCommonIoByteSink *) nil_chk(ComGoogleCommonIoFiles_asByteSinkWithJavaIoFile_withComGoogleCommonIoFileWriteModeArray_(to, [IOSObjectArray arrayWithLength:0 type:ComGoogleCommonIoFileWriteMode_class_()]))) writeWithByteArray:from];
}
...
void ComGoogleCommonIoFiles_copy__WithJavaIoFile_withJavaIoFile_(JavaIoFile *from, JavaIoFile *to) {
  ...
  [((ComGoogleCommonIoByteSource *) nil_chk(ComGoogleCommonIoFiles_asByteSourceWithJavaIoFile_(from))) copyToWithComGoogleCommonIoByteSink:ComGoogleCommonIoFiles_asByteSinkWithJavaIoFile_withComGoogleCommonIoFileWriteModeArray_(to, [IOSObjectArray arrayWithLength:0 type:ComGoogleCommonIoFileWriteMode_class_()])];
}
...
void ComGoogleCommonIoFiles_writeWithJavaLangCharSequence_withJavaIoFile_withJavaNioCharsetCharset_(id<JavaLangCharSequence> from, JavaIoFile *to, JavaNioCharsetCharset *charset) {
  ComGoogleCommonIoFiles_initialize();
  [((ComGoogleCommonIoCharSink *) nil_chk(ComGoogleCommonIoFiles_asCharSinkWithJavaIoFile_withJavaNioCharsetCharset_withComGoogleCommonIoFileWriteModeArray_(to, charset, [IOSObjectArray arrayWithLength:0 type:ComGoogleCommonIoFileWriteMode_class_()]))) writeWithJavaLangCharSequence:from];
}
...
void ComGoogleCommonIoFiles_appendWithJavaLangCharSequence_withJavaIoFile_withJavaNioCharsetCharset_(id<JavaLangCharSequence> from, JavaIoFile *to, JavaNioCharsetCharset *charset) {
  ComGoogleCommonIoFiles_initialize();
  ComGoogleCommonIoFiles_writeWithJavaLangCharSequence_withJavaIoFile_withJavaNioCharsetCharset_withBoolean_(from, to, charset, true);
}

void ComGoogleCommonIoFiles_writeWithJavaLangCharSequence_withJavaIoFile_withJavaNioCharsetCharset_withBoolean_(id<JavaLangCharSequence> from, JavaIoFile *to, JavaNioCharsetCharset *charset, jboolean append) {
  ComGoogleCommonIoFiles_initialize();
  [((ComGoogleCommonIoCharSink *) nil_chk(ComGoogleCommonIoFiles_asCharSinkWithJavaIoFile_withJavaNioCharsetCharset_withComGoogleCommonIoFileWriteModeArray_(to, charset, ComGoogleCommonIoFiles_modesWithBoolean_(append)))) writeWithJavaLangCharSequence:from];
}
...
jboolean ComGoogleCommonIoFiles_equalWithJavaIoFile_withJavaIoFile_(JavaIoFile *file1, JavaIoFile *file2) {
  ComGoogleCommonIoFiles_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(file1);
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(file2);
...
JavaIoFile *ComGoogleCommonIoFiles_createTempDir() {
  ComGoogleCommonIoFiles_initialize();
  JavaIoFile *baseDir = create_JavaIoFile_initWithNSString_(JavaLangSystem_getPropertyWithNSString_(@"java.io.tmpdir"));
  ...
  for (jint counter = 0; counter < ComGoogleCommonIoFiles_TEMP_DIR_ATTEMPTS; counter++) {
    JavaIoFile *tempDir = create_JavaIoFile_initWithJavaIoFile_withNSString_(baseDir, JreStrcat("$I", baseName, counter));
    if ([tempDir mkdir]) {
      return tempDir;
    }
  }
  @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$I$$$$IC", @"Failed to create directory within ", ComGoogleCommonIoFiles_TEMP_DIR_ATTEMPTS, @" attempts (tried ", baseName, @"0 to ", baseName, (ComGoogleCommonIoFiles_TEMP_DIR_ATTEMPTS - 1), ')'));
}
...
void ComGoogleCommonIoFiles_touchWithJavaIoFile_(JavaIoFile *file) {
  ...
  if (![((JavaIoFile *) nil_chk(file)) createNewFile] && ![file setLastModifiedWithLong:JavaLangSystem_currentTimeMillis()]) {
    @throw create_JavaIoIOException_initWithNSString_(JreStrcat("$@", @"Unable to update modification time of ", file));
  }
}
...
void ComGoogleCommonIoFiles_createParentDirsWithJavaIoFile_(JavaIoFile *file) {
  ...
  if (![parent isDirectory]) {
    @throw create_JavaIoIOException_initWithNSString_(JreStrcat("$@", @"Unable to create parent directories of ", file));
  }
}

void ComGoogleCommonIoFiles_moveWithJavaIoFile_withJavaIoFile_(JavaIoFile *from, JavaIoFile *to) {
  ComGoogleCommonIoFiles_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(from);
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(to);
  ComGoogleCommonBasePreconditions_checkArgumentWithBoolean_withNSString_withId_withId_(![((JavaIoFile *) nil_chk(from)) isEqual:to], @"Source %s and destination %s must be different", from, to);
  if (![from renameToWithJavaIoFile:to]) {
    ComGoogleCommonIoFiles_copy__WithJavaIoFile_withJavaIoFile_(from, to);
    if (![from delete__]) {
      if (![((JavaIoFile *) nil_chk(to)) delete__]) {
        @throw create_JavaIoIOException_initWithNSString_(JreStrcat("$@", @"Unable to delete ", to));
      }
      @throw create_JavaIoIOException_initWithNSString_(JreStrcat("$@", @"Unable to delete ", from));
    }
  }
}
...
id<JavaUtilList> ComGoogleCommonIoFiles_readLinesWithJavaIoFile_withJavaNioCharsetCharset_(JavaIoFile *file, JavaNioCharsetCharset *charset) {
  ComGoogleCommonIoFiles_initialize();
  return ComGoogleCommonIoFiles_readLinesWithJavaIoFile_withJavaNioCharsetCharset_withComGoogleCommonIoLineProcessor_(file, charset, create_ComGoogleCommonIoFiles_2_init());
}
...
JavaNioMappedByteBuffer *ComGoogleCommonIoFiles_mapWithJavaIoFile_withJavaNioChannelsFileChannel_MapMode_(JavaIoFile *file, JavaNioChannelsFileChannel_MapMode *mode) {
  ComGoogleCommonIoFiles_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(file);
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(mode);
  if (![((JavaIoFile *) nil_chk(file)) exists]) {
    @throw create_JavaIoFileNotFoundException_initWithNSString_([file description]);
  }
...
JavaNioMappedByteBuffer *ComGoogleCommonIoFiles_mapWithJavaIoFile_withJavaNioChannelsFileChannel_MapMode_withLong_(JavaIoFile *file, JavaNioChannelsFileChannel_MapMode *mode, jlong size) {
  ...
  @try {
    JavaIoRandomAccessFile *raf = ((JavaIoRandomAccessFile *) [((ComGoogleCommonIoCloser *) nil_chk(closer)) register__WithJavaIoCloseable:create_JavaIoRandomAccessFile_initWithJavaIoFile_withNSString_(file, mode == JreLoadStatic(JavaNioChannelsFileChannel_MapMode, READ_ONLY) ? @"r" : @"rw")]);
    return ComGoogleCommonIoFiles_mapWithJavaIoRandomAccessFile_withJavaNioChannelsFileChannel_MapMode_withLong_(raf, mode, size);
  }
  @catch (NSException *e) {
...
NSString *ComGoogleCommonIoFiles_simplifyPathWithNSString_(NSString *pathname) {
  ComGoogleCommonIoFiles_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(pathname);
  if (((jint) [((NSString *) nil_chk(pathname)) length]) == 0) {
    return @".";
  }
  ...
  id<JavaUtilList> path = create_JavaUtilArrayList_init();
  for (NSString * __strong component in nil_chk(components)) {
    if ([((NSString *) nil_chk(component)) isEqual:@"."]) {
      ...
      if ([path size] > 0 && ![((NSString *) nil_chk([path getWithInt:[path size] - 1])) isEqual:@".."]) {
        [path removeWithInt:[path size] - 1];
      }
      else {
        [path addWithId:@".."];
      }
  ...
  while ([((NSString *) nil_chk(result)) hasPrefix:@"/../"]) {
...
NSString *ComGoogleCommonIoFiles_getFileExtensionWithNSString_(NSString *fullName) {
  ComGoogleCommonIoFiles_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(fullName);
  NSString *fileName = [create_JavaIoFile_initWithNSString_(fullName) getName];
...
NSString *ComGoogleCommonIoFiles_getNameWithoutExtensionWithNSString_(NSString *file) {
  ComGoogleCommonIoFiles_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(file);
  NSString *fileName = [create_JavaIoFile_initWithNSString_(file) getName];
  jint dotIndex = [((NSString *) nil_chk(fileName)) java_lastIndexOf:'.'];
...
- (jlong)size {
  if (![((JavaIoFile *) nil_chk(file_)) isFile]) {
    @throw create_JavaIoFileNotFoundException_initWithNSString_([file_ description]);
  }
  return [file_ length];
}
...
void ComGoogleCommonIoFiles_FileByteSource_initWithJavaIoFile_(ComGoogleCommonIoFiles_FileByteSource *self, JavaIoFile *file) {
  ...
  JreStrongAssign(&self->file_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(file));
}
...
- (JavaIoFileOutputStream *)openStream {
  return create_JavaIoFileOutputStream_initWithJavaIoFile_withBoolean_(file_, [((ComGoogleCommonCollectImmutableSet *) nil_chk(modes_)) containsWithId:JreLoadEnum(ComGoogleCommonIoFileWriteMode, APPEND)]);
}
...
void ComGoogleCommonIoFiles_FileByteSink_initWithJavaIoFile_withComGoogleCommonIoFileWriteModeArray_(ComGoogleCommonIoFiles_FileByteSink *self, JavaIoFile *file, IOSObjectArray *modes) {
  ...
  JreStrongAssign(&self->file_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(file));
  JreStrongAssign(&self->modes_, ComGoogleCommonCollectImmutableSet_copyOfWithNSObjectArray_(modes));
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonIoFiles_2 = { "", "com.google.common.io", ptrTable, methods, fields, 7, 0x8008, 3, 1, 4, -1, 5, 6, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonIoFiles_1 = { "", "com.google.common.io", ptrTable, methods, NULL, 7, 0x8008, 3, 0, 4, -1, -1, 5, -1 };
...
+ (void)initialize {
  if (self == [ComGoogleCommonIoFiles_FilePredicate class]) {
    size_t allocSize = 0;
    size_t objSize_IS_DIRECTORY = class_getInstanceSize([ComGoogleCommonIoFiles_FilePredicate_1 class]);
    allocSize += objSize_IS_DIRECTORY;
    size_t objSize_IS_FILE = class_getInstanceSize([ComGoogleCommonIoFiles_FilePredicate_2 class]);
    allocSize += objSize_IS_FILE;
    uintptr_t ptr = (uintptr_t)calloc(allocSize, 1);
    id e;
    (JreEnum(ComGoogleCommonIoFiles_FilePredicate, IS_DIRECTORY) = e = objc_constructInstance([ComGoogleCommonIoFiles_FilePredicate_1 class], (void *)ptr), ptr += objSize_IS_DIRECTORY);
    ComGoogleCommonIoFiles_FilePredicate_1_initWithNSString_withInt_(e, @"IS_DIRECTORY", 0);
    (JreEnum(ComGoogleCommonIoFiles_FilePredicate, IS_FILE) = e = objc_constructInstance([ComGoogleCommonIoFiles_FilePredicate_2 class], (void *)ptr), ptr += objSize_IS_FILE);
    ComGoogleCommonIoFiles_FilePredicate_2_initWithNSString_withInt_(e, @"IS_FILE", 1);
