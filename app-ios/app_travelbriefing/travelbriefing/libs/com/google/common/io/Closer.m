...
//  source: ../target/dependency/com/google/common/io/Closer.java
//
...
- (void)close {
  ...
  if (thrown_ == nil && throwable != nil) {
    ...
    @throw create_JavaLangAssertionError_initWithId_(throwable);
  }
}

- (void)dealloc {
  RELEASE_(suppressor_);
  RELEASE_(stack_);
  RELEASE_(thrown_);
  [super dealloc];
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonIoCloser class]) {
    JreStrongAssign(&ComGoogleCommonIoCloser_SUPPRESSOR, ComGoogleCommonIoCloser_SuppressingSuppressor_isAvailable() ? JreLoadStatic(ComGoogleCommonIoCloser_SuppressingSuppressor, INSTANCE) : (id) JreLoadStatic(ComGoogleCommonIoCloser_LoggingSuppressor, INSTANCE));
...
ComGoogleCommonIoCloser *ComGoogleCommonIoCloser_create() {
  ...
  return create_ComGoogleCommonIoCloser_initWithComGoogleCommonIoCloser_Suppressor_(ComGoogleCommonIoCloser_SUPPRESSOR);
}
...
void ComGoogleCommonIoCloser_initWithComGoogleCommonIoCloser_Suppressor_(ComGoogleCommonIoCloser *self, id<ComGoogleCommonIoCloser_Suppressor> suppressor) {
  NSObject_init(self);
  JreStrongAssignAndConsume(&self->stack_, new_JavaUtilArrayDeque_initWithInt_(4));
  JreStrongAssign(&self->suppressor_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(suppressor));
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonIoCloser_LoggingSuppressor class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonIoCloser_LoggingSuppressor_INSTANCE, new_ComGoogleCommonIoCloser_LoggingSuppressor_init());
...
- (void)suppressWithJavaIoCloseable:(id<JavaIoCloseable>)closeable
  ...
  @try {
    [((JavaLangReflectMethod *) nil_chk(ComGoogleCommonIoCloser_SuppressingSuppressor_addSuppressed)) invokeWithId:thrown withNSObjectArray:[IOSObjectArray arrayWithObjects:(id[]){ suppressed } count:1 type:NSObject_class_()]];
  }
  @catch (NSException *e) {
...
+ (void)initialize {
  if (self == [ComGoogleCommonIoCloser_SuppressingSuppressor class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonIoCloser_SuppressingSuppressor_INSTANCE, new_ComGoogleCommonIoCloser_SuppressingSuppressor_init());
    JreStrongAssign(&ComGoogleCommonIoCloser_SuppressingSuppressor_addSuppressed, ComGoogleCommonIoCloser_SuppressingSuppressor_getAddSuppressed());
...
JavaLangReflectMethod *ComGoogleCommonIoCloser_SuppressingSuppressor_getAddSuppressed() {
  ComGoogleCommonIoCloser_SuppressingSuppressor_initialize();
  @try {
    return [NSException_class_() getMethod:@"addSuppressed" parameterTypes:[IOSObjectArray arrayWithObjects:(id[]){ NSException_class_() } count:1 type:IOSClass_class_()]];
  }
  @catch (NSException *e) {
    return nil;
  }
