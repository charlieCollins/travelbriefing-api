...
//  source: ../target/dependency/com/google/common/io/ByteStreams.java
//
...
+ (void)initialize {
  if (self == [ComGoogleCommonIoByteStreams class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonIoByteStreams_NULL_OUTPUT_STREAM, new_ComGoogleCommonIoByteStreams_1_init());
...
IOSByteArray *ComGoogleCommonIoByteStreams_createBuffer() {
  ...
  return [IOSByteArray arrayWithLength:8192];
}
...
jlong ComGoogleCommonIoByteStreams_copy__WithJavaNioChannelsReadableByteChannel_withJavaNioChannelsWritableByteChannel_(id<JavaNioChannelsReadableByteChannel> from, id<JavaNioChannelsWritableByteChannel> to) {
  ...
  if ([from isKindOfClass:[JavaNioChannelsFileChannel class]]) {
    ...
    do {
      ...
      position += copied;
      [sourceChannel positionWithLong:position];
    }
...
IOSByteArray *ComGoogleCommonIoByteStreams_toByteArrayWithJavaIoInputStream_(JavaIoInputStream *inArg) {
  ComGoogleCommonIoByteStreams_initialize();
  JavaIoByteArrayOutputStream *out = create_JavaIoByteArrayOutputStream_initWithInt_(JavaLangMath_maxWithInt_withInt_(32, [((JavaIoInputStream *) nil_chk(inArg)) available]));
...
IOSByteArray *ComGoogleCommonIoByteStreams_toByteArrayWithJavaIoInputStream_withInt_(JavaIoInputStream *inArg, jint expectedSize) {
  ComGoogleCommonIoByteStreams_initialize();
  IOSByteArray *bytes = [IOSByteArray arrayWithLength:expectedSize];
  ...
  ComGoogleCommonIoByteStreams_FastByteArrayOutputStream *out = create_ComGoogleCommonIoByteStreams_FastByteArrayOutputStream_init();
  [out writeWithInt:b];
  ComGoogleCommonIoByteStreams_copy__WithJavaIoInputStream_withJavaIoOutputStream_(inArg, out);
  IOSByteArray *result = [IOSByteArray arrayWithLength:bytes->size_ + [out size]];
...
id<ComGoogleCommonIoByteArrayDataInput> ComGoogleCommonIoByteStreams_newDataInputWithByteArray_(IOSByteArray *bytes) {
  ComGoogleCommonIoByteStreams_initialize();
  return ComGoogleCommonIoByteStreams_newDataInputWithJavaIoByteArrayInputStream_(create_JavaIoByteArrayInputStream_initWithByteArray_(bytes));
}
...
id<ComGoogleCommonIoByteArrayDataInput> ComGoogleCommonIoByteStreams_newDataInputWithByteArray_withInt_(IOSByteArray *bytes, jint start) {
  ...
  return ComGoogleCommonIoByteStreams_newDataInputWithJavaIoByteArrayInputStream_(create_JavaIoByteArrayInputStream_initWithByteArray_withInt_withInt_(bytes, start, bytes->size_ - start));
}
...
id<ComGoogleCommonIoByteArrayDataInput> ComGoogleCommonIoByteStreams_newDataInputWithJavaIoByteArrayInputStream_(JavaIoByteArrayInputStream *byteArrayInputStream) {
  ComGoogleCommonIoByteStreams_initialize();
  return create_ComGoogleCommonIoByteStreams_ByteArrayDataInputStream_initWithJavaIoByteArrayInputStream_(ComGoogleCommonBasePreconditions_checkNotNullWithId_(byteArrayInputStream));
}

id<ComGoogleCommonIoByteArrayDataOutput> ComGoogleCommonIoByteStreams_newDataOutput() {
  ComGoogleCommonIoByteStreams_initialize();
  return ComGoogleCommonIoByteStreams_newDataOutputWithJavaIoByteArrayOutputStream_(create_JavaIoByteArrayOutputStream_init());
}

id<ComGoogleCommonIoByteArrayDataOutput> ComGoogleCommonIoByteStreams_newDataOutputWithInt_(jint size) {
  ComGoogleCommonIoByteStreams_initialize();
  if (size < 0) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(NSString_java_formatWithNSString_withNSObjectArray_(@"Invalid size: %s", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(size) } count:1 type:NSObject_class_()]));
  }
  return ComGoogleCommonIoByteStreams_newDataOutputWithJavaIoByteArrayOutputStream_(create_JavaIoByteArrayOutputStream_initWithInt_(size));
}
...
id<ComGoogleCommonIoByteArrayDataOutput> ComGoogleCommonIoByteStreams_newDataOutputWithJavaIoByteArrayOutputStream_(JavaIoByteArrayOutputStream *byteArrayOutputSteam) {
  ComGoogleCommonIoByteStreams_initialize();
  return create_ComGoogleCommonIoByteStreams_ByteArrayDataOutputStream_initWithJavaIoByteArrayOutputStream_(ComGoogleCommonBasePreconditions_checkNotNullWithId_(byteArrayOutputSteam));
}
...
JavaIoInputStream *ComGoogleCommonIoByteStreams_limitWithJavaIoInputStream_withLong_(JavaIoInputStream *inArg, jlong limit) {
  ComGoogleCommonIoByteStreams_initialize();
  return create_ComGoogleCommonIoByteStreams_LimitedInputStream_initWithJavaIoInputStream_withLong_(inArg, limit);
}
...
void ComGoogleCommonIoByteStreams_readFullyWithJavaIoInputStream_withByteArray_withInt_withInt_(JavaIoInputStream *inArg, IOSByteArray *b, jint off, jint len) {
  ...
  if (read != len) {
    @throw create_JavaIoEOFException_initWithNSString_(JreStrcat("$I$I$", @"reached end of stream after reading ", read, @" bytes; ", len, @" bytes expected"));
  }
}
...
void ComGoogleCommonIoByteStreams_skipFullyWithJavaIoInputStream_withLong_(JavaIoInputStream *inArg, jlong n) {
  ...
  if (skipped < n) {
    @throw create_JavaIoEOFException_initWithNSString_(JreStrcat("$J$J$", @"reached end of stream after skipping ", skipped, @" bytes; ", n, @" bytes expected"));
  }
}
...
jint ComGoogleCommonIoByteStreams_readWithJavaIoInputStream_withByteArray_withInt_withInt_(JavaIoInputStream *inArg, IOSByteArray *b, jint off, jint len) {
  ComGoogleCommonIoByteStreams_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(inArg);
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(b);
  if (len < 0) {
    @throw create_JavaLangIndexOutOfBoundsException_initWithNSString_(@"len is negative");
  }
  jint total = 0;
  while (total < len) {
...
void ComGoogleCommonIoByteStreams_ByteArrayDataInputStream_initWithJavaIoByteArrayInputStream_(ComGoogleCommonIoByteStreams_ByteArrayDataInputStream *self, JavaIoByteArrayInputStream *byteArrayInputStream) {
  NSObject_init(self);
  JreStrongAssignAndConsume(&self->input_, new_JavaIoDataInputStream_initWithJavaIoInputStream_(byteArrayInputStream));
}
...
- (void)dealloc {
  RELEASE_(output_);
  RELEASE_(byteArrayOutputSteam_);
  [super dealloc];
}
...
void ComGoogleCommonIoByteStreams_ByteArrayDataOutputStream_initWithJavaIoByteArrayOutputStream_(ComGoogleCommonIoByteStreams_ByteArrayDataOutputStream *self, JavaIoByteArrayOutputStream *byteArrayOutputSteam) {
  NSObject_init(self);
  JreStrongAssign(&self->byteArrayOutputSteam_, byteArrayOutputSteam);
  JreStrongAssignAndConsume(&self->output_, new_JavaIoDataOutputStream_initWithJavaIoOutputStream_(byteArrayOutputSteam));
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonIoByteStreams_1 = { "", "com.google.common.io", ptrTable, methods, NULL, 7, 0x8008, 5, 0, 5, -1, -1, -1, -1 };
...
- (void)reset {
  @synchronized(self) {
    if (![((JavaIoInputStream *) nil_chk(JreLoadVolatileId(&in_))) markSupported]) {
      @throw create_JavaIoIOException_initWithNSString_(@"Mark not supported");
    }
    if (mark_ == -1) {
      @throw create_JavaIoIOException_initWithNSString_(@"Mark not set");
    }
