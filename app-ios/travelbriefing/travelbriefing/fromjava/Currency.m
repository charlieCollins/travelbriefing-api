...
//  source: ../src/main/java/com/totsp/travelbriefing/model/Currency.java
//
...
- (void)setRateWithNSString:(NSString *)rate {
  JreStrongAssign(&self->rate_, rate);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[4].selector = @selector(setCodeWithNSString:);
  methods[5].selector = @selector(getSymbol);
  methods[6].selector = @selector(setSymbolWithNSString:);
  methods[7].selector = @selector(getRate);
  methods[8].selector = @selector(setRateWithNSString:);
