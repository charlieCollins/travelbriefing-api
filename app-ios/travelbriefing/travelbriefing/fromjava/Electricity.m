...
- (void)setVoltageWithNSString:(NSString *)voltage {
  JreStrongAssign(&self->voltage_, voltage);
}
...
- (void)setFrequencyWithNSString:(NSString *)frequency {
  JreStrongAssign(&self->frequency_, frequency);
}
...
- (void)setPlugsWithNSStringArray:(IOSObjectArray *)plugs {
  JreStrongAssign(&self->plugs_, plugs);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithNSString:withNSString:withNSStringArray:);
  methods[1].selector = @selector(getVoltage);
  methods[2].selector = @selector(setVoltageWithNSString:);
  methods[3].selector = @selector(getFrequency);
  methods[4].selector = @selector(setFrequencyWithNSString:);
  methods[5].selector = @selector(getPlugs);
  methods[6].selector = @selector(setPlugsWithNSStringArray:);
