...
FOUNDATION_EXPORT jlong ComTotspTravelbriefingServiceTravelBriefingServiceCache_getCacheCountrySize();

FOUNDATION_EXPORT jlong ComTotspTravelbriefingServiceTravelBriefingServiceCache_getCacheCountryListSize();
