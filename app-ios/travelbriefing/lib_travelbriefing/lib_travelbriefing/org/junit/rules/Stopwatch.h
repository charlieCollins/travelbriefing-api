...
FOUNDATION_EXPORT OrgJunitRulesStopwatch_Clock *new_OrgJunitRulesStopwatch_Clock_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgJunitRulesStopwatch_Clock *create_OrgJunitRulesStopwatch_Clock_init();
