...
FOUNDATION_EXPORT OrgJunitValidatorAnnotationValidatorFactory *new_OrgJunitValidatorAnnotationValidatorFactory_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgJunitValidatorAnnotationValidatorFactory *create_OrgJunitValidatorAnnotationValidatorFactory_init();
