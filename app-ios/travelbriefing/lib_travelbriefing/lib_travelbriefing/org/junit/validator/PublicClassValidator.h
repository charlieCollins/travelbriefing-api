...
FOUNDATION_EXPORT OrgJunitValidatorPublicClassValidator *new_OrgJunitValidatorPublicClassValidator_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgJunitValidatorPublicClassValidator *create_OrgJunitValidatorPublicClassValidator_init();
