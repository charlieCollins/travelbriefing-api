...
FOUNDATION_EXPORT void OrgJunitRunnerFilterFactories_init(OrgJunitRunnerFilterFactories *self);

FOUNDATION_EXPORT OrgJunitRunnerFilterFactories *new_OrgJunitRunnerFilterFactories_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgJunitRunnerFilterFactories *create_OrgJunitRunnerFilterFactories_init();
