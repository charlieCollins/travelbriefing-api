...
//  source: ../target/dependency/com/google/common/graph/ConfigurableMutableNetwork.java
//
...
- (jboolean)addNodeWithId:(id)node {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_withId_(node, @"node");
  if ([self containsNodeWithId:node]) {
    return false;
  }
  ComGoogleCommonGraphConfigurableMutableNetwork_addNodeInternalWithId_(self, node);
  return true;
}
...
- (jboolean)addEdgeWithId:(id)nodeU
                   withId:(id)nodeV
                   withId:(id)edge {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_withId_(nodeU, @"nodeU");
  ComGoogleCommonBasePreconditions_checkNotNullWithId_withId_(nodeV, @"nodeV");
  ComGoogleCommonBasePreconditions_checkNotNullWithId_withId_(edge, @"edge");
  ...
  [((ComGoogleCommonGraphMapIteratorCache *) nil_chk(edgeToReferenceNode_)) putWithId:edge withId:nodeU];
  return true;
}
...
- (jboolean)removeNodeWithId:(id)node {
  ...
  [nodeConnections_ removeWithId:node];
  return true;
}
...
- (jboolean)removeEdgeWithId:(id)edge {
  ...
  id<ComGoogleCommonGraphNetworkConnections> connectionsV = [nodeConnections_ getWithId:nodeV];
  [connectionsU removeOutEdgeWithId:edge];
  [((id<ComGoogleCommonGraphNetworkConnections>) nil_chk(connectionsV)) removeInEdgeWithId:edge withBoolean:[self allowsSelfLoops] && [nodeU isEqual:nodeV]];
  [edgeToReferenceNode_ removeWithId:edge];
  return true;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LComGoogleCommonGraphNetworkConnections;", 0x2, -1, -1, -1, 12, -1, -1 },
  };
