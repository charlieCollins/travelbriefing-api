...
//  source: ../target/dependency/com/google/common/graph/ConfigurableMutableValueGraph.java
//
...
- (jboolean)addNodeWithId:(id)node {
  ...
  ComGoogleCommonGraphConfigurableMutableValueGraph_addNodeInternalWithId_(self, node);
  return true;
}
...
- (id)putEdgeValueWithId:(id)nodeU
  ...
  ComGoogleCommonBasePreconditions_checkNotNullWithId_withId_(value, @"value");
