...
//  source: ../target/dependency/com/google/common/graph/EdgesConnecting.java
//
...
void ComGoogleCommonGraphEdgesConnecting_initWithJavaUtilMap_withId_(ComGoogleCommonGraphEdgesConnecting *self, id<JavaUtilMap> nodeToEdgeMap, id targetNode) {
  ...
  JreStrongAssign(&self->nodeToOutEdge_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(nodeToEdgeMap));
