...
//  source: ../target/dependency/com/google/common/reflect/ClassPath.java
//
...
__attribute__((unused)) static void ComGoogleCommonReflectClassPath_DefaultScanner_scanDirectoryWithJavaIoFile_withJavaLangClassLoader_withNSString_(ComGoogleCommonReflectClassPath_DefaultScanner *self, JavaIoFile *directory, JavaLangClassLoader *classloader, NSString *packagePrefix);
...
- (ComGoogleCommonCollectImmutableSet *)getTopLevelClassesWithNSString:(NSString *)packageName {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(packageName);
  ...
  for (ComGoogleCommonReflectClassPath_ClassInfo * __strong classInfo in nil_chk([self getTopLevelClasses])) {
    if ([((NSString *) nil_chk([((ComGoogleCommonReflectClassPath_ClassInfo *) nil_chk(classInfo)) getPackageName])) isEqual:packageName]) {
      [((ComGoogleCommonCollectImmutableSet_Builder *) nil_chk(builder)) addWithId:classInfo];
    }
  }
...
- (ComGoogleCommonCollectImmutableSet *)getTopLevelClassesRecursiveWithNSString:(NSString *)packageName {
  ...
  ComGoogleCommonCollectImmutableSet_Builder *builder = ComGoogleCommonCollectImmutableSet_builder();
  for (ComGoogleCommonReflectClassPath_ClassInfo * __strong classInfo in nil_chk([self getTopLevelClasses])) {
    if ([((NSString *) nil_chk([((ComGoogleCommonReflectClassPath_ClassInfo *) nil_chk(classInfo)) getName])) hasPrefix:packagePrefix]) {
      [((ComGoogleCommonCollectImmutableSet_Builder *) nil_chk(builder)) addWithId:classInfo];
    }
  }
  return [((ComGoogleCommonCollectImmutableSet_Builder *) nil_chk(builder)) build];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "IS_TOP_LEVEL", "LComGoogleCommonBasePredicate;", .constantValue.asLong = 0, 0x1a, -1, 13, 14, -1 },
    { "CLASS_PATH_ATTRIBUTE_SEPARATOR", "LComGoogleCommonBaseSplitter;", .constantValue.asLong = 0, 0x1a, -1, 15, -1, -1 },
    { "CLASS_FILE_NAME_EXTENSION", "LNSString;", .constantValue.asLong = 0, 0x1a, -1, 16, -1, -1 },
    { "resources_", "LComGoogleCommonCollectImmutableSet;", .constantValue.asLong = 0, 0x12, -1, -1, 17, -1 },
  };
  static const void *ptrTable[] = { "LComGoogleCommonCollectImmutableSet;", "(Lcom/google/common/collect/ImmutableSet<Lcom/google/common/reflect/ClassPath$ResourceInfo;>;)V", "from", "LJavaLangClassLoader;", "LJavaIoIOException;", "()Lcom/google/common/collect/ImmutableSet<Lcom/google/common/reflect/ClassPath$ResourceInfo;>;", "()Lcom/google/common/collect/ImmutableSet<Lcom/google/common/reflect/ClassPath$ClassInfo;>;", "getTopLevelClasses", "LNSString;", "(Ljava/lang/String;)Lcom/google/common/collect/ImmutableSet<Lcom/google/common/reflect/ClassPath$ClassInfo;>;", "getTopLevelClassesRecursive", "getClassName", &ComGoogleCommonReflectClassPath_logger, &ComGoogleCommonReflectClassPath_IS_TOP_LEVEL, "Lcom/google/common/base/Predicate<Lcom/google/common/reflect/ClassPath$ClassInfo;>;", &ComGoogleCommonReflectClassPath_CLASS_PATH_ATTRIBUTE_SEPARATOR, &ComGoogleCommonReflectClassPath_CLASS_FILE_NAME_EXTENSION, "Lcom/google/common/collect/ImmutableSet<Lcom/google/common/reflect/ClassPath$ResourceInfo;>;", "LComGoogleCommonReflectClassPath_ResourceInfo;LComGoogleCommonReflectClassPath_ClassInfo;LComGoogleCommonReflectClassPath_Scanner;LComGoogleCommonReflectClassPath_DefaultScanner;" };
  static const J2ObjcClassInfo _ComGoogleCommonReflectClassPath = { "ClassPath", "com.google.common.reflect", ptrTable, methods, fields, 7, 0x11, 8, 5, -1, 18, -1, -1, -1 };
  return &_ComGoogleCommonReflectClassPath;
}

+ (void)initialize {
  if (self == [ComGoogleCommonReflectClassPath class]) {
    JreStrongAssign(&ComGoogleCommonReflectClassPath_logger, JavaUtilLoggingLogger_getLoggerWithNSString_([ComGoogleCommonReflectClassPath_class_() getName]));
    JreStrongAssignAndConsume(&ComGoogleCommonReflectClassPath_IS_TOP_LEVEL, new_ComGoogleCommonReflectClassPath_1_init());
    JreStrongAssign(&ComGoogleCommonReflectClassPath_CLASS_PATH_ATTRIBUTE_SEPARATOR, [((ComGoogleCommonBaseSplitter *) nil_chk(ComGoogleCommonBaseSplitter_onWithNSString_(@" "))) omitEmptyStrings]);
...
void ComGoogleCommonReflectClassPath_initWithComGoogleCommonCollectImmutableSet_(ComGoogleCommonReflectClassPath *self, ComGoogleCommonCollectImmutableSet *resources) {
  NSObject_init(self);
  JreStrongAssign(&self->resources_, resources);
}
...
ComGoogleCommonReflectClassPath *ComGoogleCommonReflectClassPath_fromWithJavaLangClassLoader_(JavaLangClassLoader *classloader) {
  ...
  ComGoogleCommonReflectClassPath_DefaultScanner *scanner = create_ComGoogleCommonReflectClassPath_DefaultScanner_init();
  ComGoogleCommonReflectClassPath_Scanner_scanWithJavaLangClassLoader_(scanner, classloader);
  return create_ComGoogleCommonReflectClassPath_initWithComGoogleCommonCollectImmutableSet_([scanner getResources]);
}

NSString *ComGoogleCommonReflectClassPath_getClassNameWithNSString_(NSString *filename) {
  ComGoogleCommonReflectClassPath_initialize();
  jint classNameEnd = ((jint) [((NSString *) nil_chk(filename)) length]) - ((jint) [((NSString *) nil_chk(ComGoogleCommonReflectClassPath_CLASS_FILE_NAME_EXTENSION)) length]);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonReflectClassPath_1 = { "", "com.google.common.reflect", ptrTable, methods, NULL, 7, 0x8008, 2, 0, 2, -1, -1, 3, -1 };
...
ComGoogleCommonReflectClassPath_ResourceInfo *ComGoogleCommonReflectClassPath_ResourceInfo_ofWithNSString_withJavaLangClassLoader_(NSString *resourceName, JavaLangClassLoader *loader) {
  ...
  if ([((NSString *) nil_chk(resourceName)) hasSuffix:ComGoogleCommonReflectClassPath_CLASS_FILE_NAME_EXTENSION]) {
    return create_ComGoogleCommonReflectClassPath_ClassInfo_initWithNSString_withJavaLangClassLoader_(resourceName, loader);
  }
  else {
    return create_ComGoogleCommonReflectClassPath_ResourceInfo_initWithNSString_withJavaLangClassLoader_(resourceName, loader);
  }
}
...
void ComGoogleCommonReflectClassPath_ResourceInfo_initWithNSString_withJavaLangClassLoader_(ComGoogleCommonReflectClassPath_ResourceInfo *self, NSString *resourceName, JavaLangClassLoader *loader) {
  NSObject_init(self);
  JreStrongAssign(&self->resourceName_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(resourceName));
  JreStrongAssign(&self->loader_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(loader));
}
...
JavaNetURL *ComGoogleCommonReflectClassPath_ResourceInfo_url(ComGoogleCommonReflectClassPath_ResourceInfo *self) {
  ...
  if (url == nil) {
    @throw create_JavaUtilNoSuchElementException_initWithNSString_(self->resourceName_);
  }
  return url;
}
...
- (NSString *)getSimpleName {
  ...
  return [className__ java_substring:((jint) [packageName length]) + 1];
}
...
void ComGoogleCommonReflectClassPath_ClassInfo_initWithNSString_withJavaLangClassLoader_(ComGoogleCommonReflectClassPath_ClassInfo *self, NSString *resourceName, JavaLangClassLoader *loader) {
  ComGoogleCommonReflectClassPath_ResourceInfo_initWithNSString_withJavaLangClassLoader_(self, resourceName, loader);
  JreStrongAssign(&self->className__, ComGoogleCommonReflectClassPath_getClassNameWithNSString_(resourceName));
}
...
void ComGoogleCommonReflectClassPath_Scanner_init(ComGoogleCommonReflectClassPath_Scanner *self) {
  NSObject_init(self);
  JreStrongAssign(&self->scannedUris_, ComGoogleCommonCollectSets_newHashSet());
}
...
void ComGoogleCommonReflectClassPath_Scanner_scanJarWithJavaIoFile_withJavaLangClassLoader_(ComGoogleCommonReflectClassPath_Scanner *self, JavaIoFile *file, JavaLangClassLoader *classloader) {
  ...
  @try {
    jarFile = create_JavaUtilJarJarFile_initWithJavaIoFile_(file);
  }
  ...
  if (classpathAttribute != nil) {
    for (NSString * __strong path in nil_chk([((ComGoogleCommonBaseSplitter *) nil_chk(JreLoadStatic(ComGoogleCommonReflectClassPath, CLASS_PATH_ATTRIBUTE_SEPARATOR))) splitWithJavaLangCharSequence:classpathAttribute])) {
      ...
      if ([((NSString *) nil_chk([((JavaNetURL *) nil_chk(url)) getProtocol])) isEqual:@"file"]) {
        [((ComGoogleCommonCollectImmutableSet_Builder *) nil_chk(builder)) addWithId:create_JavaIoFile_initWithNSString_([url getFile])];
      }
    }
  }
  return [((ComGoogleCommonCollectImmutableSet_Builder *) nil_chk(builder)) build];
    ...
    JavaNetURLClassLoader *urlClassLoader = (JavaNetURLClassLoader *) cast_chk(classloader, [JavaNetURLClassLoader class]);
    {
      ...
      while (b__ < e__) {
        ...
        if ([((NSString *) nil_chk([((JavaNetURL *) nil_chk(entry_)) getProtocol])) isEqual:@"file"]) {
          JavaIoFile *file = create_JavaIoFile_initWithNSString_([entry_ getFile]);
          if (![((JavaUtilLinkedHashMap *) nil_chk(entries)) containsKeyWithId:file]) {
            [entries putWithId:file withId:classloader];
          }
        }
      }
    }
...
JavaNetURL *ComGoogleCommonReflectClassPath_Scanner_getClassPathEntryWithJavaIoFile_withNSString_(JavaIoFile *jarFile, NSString *path) {
  ComGoogleCommonReflectClassPath_Scanner_initialize();
  return create_JavaNetURL_initWithJavaNetURL_withNSString_([((JavaNetURI *) nil_chk([((JavaIoFile *) nil_chk(jarFile)) toURI])) toURL], path);
}
...
- (ComGoogleCommonCollectImmutableSet *)getResources {
  ...
  for (id<JavaUtilMap_Entry> __strong entry_ in nil_chk([((id<ComGoogleCommonCollectSetMultimap>) nil_chk(resources_)) entries])) {
    [((ComGoogleCommonCollectImmutableSet_Builder *) nil_chk(builder)) addWithId:ComGoogleCommonReflectClassPath_ResourceInfo_ofWithNSString_withJavaLangClassLoader_([((id<JavaUtilMap_Entry>) nil_chk(entry_)) getValue], [entry_ getKey])];
  }
  return [((ComGoogleCommonCollectImmutableSet_Builder *) nil_chk(builder)) build];
}
...
- (void)scanDirectoryWithJavaLangClassLoader:(JavaLangClassLoader *)classloader
                              withJavaIoFile:(JavaIoFile *)directory {
  ComGoogleCommonReflectClassPath_DefaultScanner_scanDirectoryWithJavaIoFile_withJavaLangClassLoader_withNSString_(self, directory, classloader, @"");
}

- (void)scanDirectoryWithJavaIoFile:(JavaIoFile *)directory
            withJavaLangClassLoader:(JavaLangClassLoader *)classloader
                       withNSString:(NSString *)packagePrefix {
  ComGoogleCommonReflectClassPath_DefaultScanner_scanDirectoryWithJavaIoFile_withJavaLangClassLoader_withNSString_(self, directory, classloader, packagePrefix);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[4].selector = @selector(scanDirectoryWithJavaIoFile:withJavaLangClassLoader:withNSString:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "resources_", "LComGoogleCommonCollectSetMultimap;", .constantValue.asLong = 0, 0x12, -1, -1, 7, -1 },
  };
  ...
  static const J2ObjcClassInfo _ComGoogleCommonReflectClassPath_DefaultScanner = { "DefaultScanner", "com.google.common.reflect", ptrTable, methods, fields, 7, 0x18, 5, 1, 8, -1, -1, -1, -1 };
...
void ComGoogleCommonReflectClassPath_DefaultScanner_init(ComGoogleCommonReflectClassPath_DefaultScanner *self) {
  ComGoogleCommonReflectClassPath_Scanner_init(self);
  JreStrongAssign(&self->resources_, [((ComGoogleCommonCollectMultimapBuilder_SetMultimapBuilder *) nil_chk([((ComGoogleCommonCollectMultimapBuilder_MultimapBuilderWithKeys *) nil_chk(ComGoogleCommonCollectMultimapBuilder_hashKeys())) linkedHashSetValues])) build]);
}
...
void ComGoogleCommonReflectClassPath_DefaultScanner_scanDirectoryWithJavaIoFile_withJavaLangClassLoader_withNSString_(ComGoogleCommonReflectClassPath_DefaultScanner *self, JavaIoFile *directory, JavaLangClassLoader *classloader, NSString *packagePrefix) {
  ...
  }
  {
    ...
    while (b__ < e__) {
      ...
      if ([f isDirectory]) {
        ComGoogleCommonReflectClassPath_DefaultScanner_scanDirectoryWithJavaIoFile_withJavaLangClassLoader_withNSString_(self, f, classloader, JreStrcat("$$C", packagePrefix, name, '/'));
      }
      else {
