...
//  source: ../target/dependency/com/google/common/reflect/TypeResolver.java
//
...
- (IOSObjectArray *)captureWithJavaLangReflectTypeArray:(IOSObjectArray *)types;
...
__attribute__((unused)) static IOSObjectArray *ComGoogleCommonReflectTypeResolver_WildcardCapturer_captureWithJavaLangReflectTypeArray_(ComGoogleCommonReflectTypeResolver_WildcardCapturer *self, IOSObjectArray *types);
...
- (ComGoogleCommonReflectTypeResolver *)whereWithJavaUtilMap:(id<JavaUtilMap>)mappings {
  return create_ComGoogleCommonReflectTypeResolver_initWithComGoogleCommonReflectTypeResolver_TypeTable_(ComGoogleCommonReflectTypeResolver_TypeTable_whereWithJavaUtilMap_(nil_chk(typeTable_), mappings));
}
...
void ComGoogleCommonReflectTypeResolver_init(ComGoogleCommonReflectTypeResolver *self) {
  NSObject_init(self);
  JreStrongAssignAndConsume(&self->typeTable_, new_ComGoogleCommonReflectTypeResolver_TypeTable_init());
}
...
void ComGoogleCommonReflectTypeResolver_initWithComGoogleCommonReflectTypeResolver_TypeTable_(ComGoogleCommonReflectTypeResolver *self, ComGoogleCommonReflectTypeResolver_TypeTable *typeTable) {
  NSObject_init(self);
  JreStrongAssign(&self->typeTable_, typeTable);
}
...
ComGoogleCommonReflectTypeResolver *ComGoogleCommonReflectTypeResolver_accordingToWithJavaLangReflectType_(id<JavaLangReflectType> type) {
  ...
  return [create_ComGoogleCommonReflectTypeResolver_init() whereWithJavaUtilMap:ComGoogleCommonReflectTypeResolver_TypeMappingIntrospector_getTypeMappingsWithJavaLangReflectType_(type)];
}
...
void ComGoogleCommonReflectTypeResolver_populateTypeMappingsWithJavaUtilMap_withJavaLangReflectType_withJavaLangReflectType_(id<JavaUtilMap> mappings, id<JavaLangReflectType> from, id<JavaLangReflectType> to) {
  ...
  [create_ComGoogleCommonReflectTypeResolver_1_initWithJavaUtilMap_withJavaLangReflectType_(mappings, to) visitWithJavaLangReflectTypeArray:[IOSObjectArray arrayWithObjects:(id[]){ from } count:1 type:JavaLangReflectType_class_()]];
}
...
IOSObjectArray *ComGoogleCommonReflectTypeResolver_resolveTypesWithJavaLangReflectTypeArray_(ComGoogleCommonReflectTypeResolver *self, IOSObjectArray *types) {
  IOSObjectArray *result = [IOSObjectArray arrayWithLength:((IOSObjectArray *) nil_chk(types))->size_ type:JavaLangReflectType_class_()];
  for (jint i = 0; i < types->size_; i++) {
    IOSObjectArray_Set(result, i, [self resolveTypeWithJavaLangReflectType:IOSObjectArray_Get(types, i)]);
  }
  return result;
}
...
id<JavaLangReflectWildcardType> ComGoogleCommonReflectTypeResolver_resolveWildcardTypeWithJavaLangReflectWildcardType_(ComGoogleCommonReflectTypeResolver *self, id<JavaLangReflectWildcardType> type) {
  ...
  return create_ComGoogleCommonReflectTypes_WildcardTypeImpl_initWithJavaLangReflectTypeArray_withJavaLangReflectTypeArray_(ComGoogleCommonReflectTypeResolver_resolveTypesWithJavaLangReflectTypeArray_(self, lowerBounds), ComGoogleCommonReflectTypeResolver_resolveTypesWithJavaLangReflectTypeArray_(self, upperBounds));
}
...
id ComGoogleCommonReflectTypeResolver_expectArgumentWithIOSClass_withId_(IOSClass *type, id arg) {
  ...
  @catch (JavaLangClassCastException *e) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("@$$", arg, @" is not a ", [type getSimpleName]));
  }
}
...
- (void)visitTypeVariableWithJavaLangReflectTypeVariable:(id<JavaLangReflectTypeVariable>)typeVariable {
  [((id<JavaUtilMap>) nil_chk(val$mappings_)) putWithId:create_ComGoogleCommonReflectTypeResolver_TypeVariableKey_initWithJavaLangReflectTypeVariable_(typeVariable) withId:val$to_];
}
...
- (void)visitClassWithIOSClass:(IOSClass *)fromClass {
  ...
  @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@$@", @"No type mapping from ", fromClass, @" to ", val$to_));
}

- (void)dealloc {
  RELEASE_(val$mappings_);
  RELEASE_(val$to_);
  [super dealloc];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonReflectTypeResolver_1 = { "", "com.google.common.reflect", ptrTable, methods, fields, 7, 0x8008, 6, 2, 13, -1, 14, -1, -1 };
...
void ComGoogleCommonReflectTypeResolver_1_initWithJavaUtilMap_withJavaLangReflectType_(ComGoogleCommonReflectTypeResolver_1 *self, id<JavaUtilMap> capture$0, id<JavaLangReflectType> capture$1) {
  JreStrongAssign(&self->val$mappings_, capture$0);
  JreStrongAssign(&self->val$to_, capture$1);
...
- (id<JavaLangReflectType>)resolveInternalWithJavaLangReflectTypeVariable:(id<JavaLangReflectTypeVariable>)var
                         withComGoogleCommonReflectTypeResolver_TypeTable:(ComGoogleCommonReflectTypeResolver_TypeTable *)forDependants {
  id<JavaLangReflectType> type = [((ComGoogleCommonCollectImmutableMap *) nil_chk(map_)) getWithId:create_ComGoogleCommonReflectTypeResolver_TypeVariableKey_initWithJavaLangReflectTypeVariable_(var)];
  if (type == nil) {
    IOSObjectArray *bounds = [((id<JavaLangReflectTypeVariable>) nil_chk(var)) getBounds];
    if (((IOSObjectArray *) nil_chk(bounds))->size_ == 0) {
      return var;
    }
    IOSObjectArray *resolvedBounds = ComGoogleCommonReflectTypeResolver_resolveTypesWithJavaLangReflectTypeArray_(create_ComGoogleCommonReflectTypeResolver_initWithComGoogleCommonReflectTypeResolver_TypeTable_(forDependants), bounds);
  ...
  return [create_ComGoogleCommonReflectTypeResolver_initWithComGoogleCommonReflectTypeResolver_TypeTable_(forDependants) resolveTypeWithJavaLangReflectType:type];
}
...
void ComGoogleCommonReflectTypeResolver_TypeTable_init(ComGoogleCommonReflectTypeResolver_TypeTable *self) {
  NSObject_init(self);
  JreStrongAssign(&self->map_, ComGoogleCommonCollectImmutableMap_of());
}
...
ComGoogleCommonReflectTypeResolver_TypeTable *ComGoogleCommonReflectTypeResolver_TypeTable_whereWithJavaUtilMap_(ComGoogleCommonReflectTypeResolver_TypeTable *self, id<JavaUtilMap> mappings) {
  ...
  [((ComGoogleCommonCollectImmutableMap_Builder *) nil_chk(builder)) putAllWithJavaUtilMap:self->map_];
  for (id<JavaUtilMap_Entry> __strong mapping in nil_chk([((id<JavaUtilMap>) nil_chk(mappings)) entrySet])) {
    ...
    [builder putWithId:variable withId:type];
  }
  return create_ComGoogleCommonReflectTypeResolver_TypeTable_initWithComGoogleCommonCollectImmutableMap_([builder build]);
}
...
id<JavaLangReflectType> ComGoogleCommonReflectTypeResolver_TypeTable_resolveWithJavaLangReflectTypeVariable_(ComGoogleCommonReflectTypeResolver_TypeTable *self, id<JavaLangReflectTypeVariable> var) {
  ...
  ComGoogleCommonReflectTypeResolver_TypeTable *guarded = create_ComGoogleCommonReflectTypeResolver_TypeTable_1_initWithJavaLangReflectTypeVariable_withComGoogleCommonReflectTypeResolver_TypeTable_(var, unguarded);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonReflectTypeResolver_TypeTable_1 = { "", "com.google.common.reflect", ptrTable, methods, fields, 7, 0x8008, 2, 2, 4, -1, 5, -1, -1 };
...
void ComGoogleCommonReflectTypeResolver_TypeTable_1_initWithJavaLangReflectTypeVariable_withComGoogleCommonReflectTypeResolver_TypeTable_(ComGoogleCommonReflectTypeResolver_TypeTable_1 *self, id<JavaLangReflectTypeVariable> capture$0, ComGoogleCommonReflectTypeResolver_TypeTable *capture$1) {
  JreStrongAssign(&self->val$var_, capture$0);
  JreStrongAssign(&self->val$unguarded_, capture$1);
  ComGoogleCommonReflectTypeResolver_TypeTable_init(self);
}
...
- (void)visitClassWithIOSClass:(IOSClass *)clazz {
  [self visitWithJavaLangReflectTypeArray:[IOSObjectArray arrayWithObjects:(id[]){ [((IOSClass *) nil_chk(clazz)) getGenericSuperclass] } count:1 type:JavaLangReflectType_class_()]];
...
- (void)visitParameterizedTypeWithJavaLangReflectParameterizedType:(id<JavaLangReflectParameterizedType>)parameterizedType {
  ...
  for (jint i = 0; i < vars->size_; i++) {
    ComGoogleCommonReflectTypeResolver_TypeMappingIntrospector_mapWithComGoogleCommonReflectTypeResolver_TypeVariableKey_withJavaLangReflectType_(self, create_ComGoogleCommonReflectTypeResolver_TypeVariableKey_initWithJavaLangReflectTypeVariable_(IOSObjectArray_Get(vars, i)), IOSObjectArray_Get(typeArgs, i));
  }
  [self visitWithJavaLangReflectTypeArray:[IOSObjectArray arrayWithObjects:(id[]){ rawClass } count:1 type:JavaLangReflectType_class_()]];
  [self visitWithJavaLangReflectTypeArray:[IOSObjectArray arrayWithObjects:(id[]){ [parameterizedType getOwnerType] } count:1 type:JavaLangReflectType_class_()]];
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonReflectTypeResolver_TypeMappingIntrospector class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonReflectTypeResolver_TypeMappingIntrospector_wildcardCapturer, new_ComGoogleCommonReflectTypeResolver_WildcardCapturer_init());
...
void ComGoogleCommonReflectTypeResolver_TypeMappingIntrospector_init(ComGoogleCommonReflectTypeResolver_TypeMappingIntrospector *self) {
  ComGoogleCommonReflectTypeVisitor_init(self);
  JreStrongAssign(&self->mappings_, ComGoogleCommonCollectMaps_newHashMap());
}
...
ComGoogleCommonCollectImmutableMap *ComGoogleCommonReflectTypeResolver_TypeMappingIntrospector_getTypeMappingsWithJavaLangReflectType_(id<JavaLangReflectType> contextType) {
  ...
  ComGoogleCommonReflectTypeResolver_TypeMappingIntrospector *introspector = create_ComGoogleCommonReflectTypeResolver_TypeMappingIntrospector_init();
  [introspector visitWithJavaLangReflectTypeArray:[IOSObjectArray arrayWithObjects:(id[]){ [((ComGoogleCommonReflectTypeResolver_WildcardCapturer *) nil_chk(ComGoogleCommonReflectTypeResolver_TypeMappingIntrospector_wildcardCapturer)) captureWithJavaLangReflectType:contextType] } count:1 type:JavaLangReflectType_class_()]];
...
void ComGoogleCommonReflectTypeResolver_TypeMappingIntrospector_mapWithComGoogleCommonReflectTypeResolver_TypeVariableKey_withJavaLangReflectType_(ComGoogleCommonReflectTypeResolver_TypeMappingIntrospector *self, ComGoogleCommonReflectTypeResolver_TypeVariableKey *var, id<JavaLangReflectType> arg) {
  ...
  [self->mappings_ putWithId:var withId:arg];
}
...
- (id<JavaLangReflectType>)captureWithJavaLangReflectType:(id<JavaLangReflectType>)type {
  ...
  if ([JavaLangReflectGenericArrayType_class_() isInstance:type]) {
    ...
    return ComGoogleCommonReflectTypes_newArrayTypeWithJavaLangReflectType_([self captureWithJavaLangReflectType:[((id<JavaLangReflectGenericArrayType>) nil_chk(arrayType)) getGenericComponentType]]);
  }
  if ([JavaLangReflectParameterizedType_class_() isInstance:type]) {
    ...
    return ComGoogleCommonReflectTypes_newParameterizedTypeWithOwnerWithJavaLangReflectType_withIOSClass_withJavaLangReflectTypeArray_(ComGoogleCommonReflectTypeResolver_WildcardCapturer_captureNullableWithJavaLangReflectType_(self, [((id<JavaLangReflectParameterizedType>) nil_chk(parameterizedType)) getOwnerType]), (IOSClass *) cast_chk([parameterizedType getRawType], [IOSClass class]), ComGoogleCommonReflectTypeResolver_WildcardCapturer_captureWithJavaLangReflectTypeArray_(self, [parameterizedType getActualTypeArguments]));
  }
  if ([JavaLangReflectWildcardType_class_() isInstance:type]) {
    ...
    if (((IOSObjectArray *) nil_chk(lowerBounds))->size_ == 0) {
      IOSObjectArray *upperBounds = [wildcardType getUpperBounds];
      ...
      return ComGoogleCommonReflectTypes_newArtificialTypeVariableWithJavaLangReflectGenericDeclaration_withNSString_withJavaLangReflectTypeArray_(ComGoogleCommonReflectTypeResolver_WildcardCapturer_class_(), name, [wildcardType getUpperBounds]);
    }
    else {
      return type;
    }
  }
  @throw create_JavaLangAssertionError_initWithId_(@"must have been one of the known types");
}
...
- (IOSObjectArray *)captureWithJavaLangReflectTypeArray:(IOSObjectArray *)types {
  return ComGoogleCommonReflectTypeResolver_WildcardCapturer_captureWithJavaLangReflectTypeArray_(self, types);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LJavaLangReflectType;", 0x2, 2, 1, -1, -1, -1, 3 },
    { NULL, "[LJavaLangReflectType;", 0x2, 0, 4, -1, -1, -1, -1 },
  };
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  methods[0].selector = @selector(init);
  methods[1].selector = @selector(captureWithJavaLangReflectType:);
  methods[2].selector = @selector(captureNullableWithJavaLangReflectType:);
  methods[3].selector = @selector(captureWithJavaLangReflectTypeArray:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "id__", "LJavaUtilConcurrentAtomicAtomicInteger;", .constantValue.asLong = 0, 0x12, 5, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "capture", "LJavaLangReflectType;", "captureNullable", (void *)&ComGoogleCommonReflectTypeResolver_WildcardCapturer__Annotations$0, "[LJavaLangReflectType;", "id", "LComGoogleCommonReflectTypeResolver;" };
  static const J2ObjcClassInfo _ComGoogleCommonReflectTypeResolver_WildcardCapturer = { "WildcardCapturer", "com.google.common.reflect", ptrTable, methods, fields, 7, 0x1a, 4, 1, 6, -1, -1, -1, -1 };
...
void ComGoogleCommonReflectTypeResolver_WildcardCapturer_init(ComGoogleCommonReflectTypeResolver_WildcardCapturer *self) {
  NSObject_init(self);
  JreStrongAssignAndConsume(&self->id__, new_JavaUtilConcurrentAtomicAtomicInteger_init());
}
...
id<JavaLangReflectType> ComGoogleCommonReflectTypeResolver_WildcardCapturer_captureNullableWithJavaLangReflectType_(ComGoogleCommonReflectTypeResolver_WildcardCapturer *self, id<JavaLangReflectType> type) {
  ...
  return [self captureWithJavaLangReflectType:type];
}

IOSObjectArray *ComGoogleCommonReflectTypeResolver_WildcardCapturer_captureWithJavaLangReflectTypeArray_(ComGoogleCommonReflectTypeResolver_WildcardCapturer *self, IOSObjectArray *types) {
  IOSObjectArray *result = [IOSObjectArray arrayWithLength:((IOSObjectArray *) nil_chk(types))->size_ type:JavaLangReflectType_class_()];
  for (jint i = 0; i < types->size_; i++) {
    IOSObjectArray_Set(result, i, [self captureWithJavaLangReflectType:IOSObjectArray_Get(types, i)]);
  }
  return result;
}
...
- (NSUInteger)hash {
  return ComGoogleCommonBaseObjects_hashCodeWithNSObjectArray_([IOSObjectArray arrayWithObjects:(id[]){ [((id<JavaLangReflectTypeVariable>) nil_chk(var_)) getGenericDeclaration], [var_ getName] } count:2 type:NSObject_class_()]);
}
...
void ComGoogleCommonReflectTypeResolver_TypeVariableKey_initWithJavaLangReflectTypeVariable_(ComGoogleCommonReflectTypeResolver_TypeVariableKey *self, id<JavaLangReflectTypeVariable> var) {
  NSObject_init(self);
  JreStrongAssign(&self->var_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(var));
}
...
ComGoogleCommonReflectTypeResolver_TypeVariableKey *ComGoogleCommonReflectTypeResolver_TypeVariableKey_forLookupWithJavaLangReflectType_(id<JavaLangReflectType> t) {
  ...
  if ([JavaLangReflectTypeVariable_class_() isInstance:t]) {
    return create_ComGoogleCommonReflectTypeResolver_TypeVariableKey_initWithJavaLangReflectTypeVariable_((id<JavaLangReflectTypeVariable>) cast_check(t, JavaLangReflectTypeVariable_class_()));
  }
  else {
    return nil;
  }
