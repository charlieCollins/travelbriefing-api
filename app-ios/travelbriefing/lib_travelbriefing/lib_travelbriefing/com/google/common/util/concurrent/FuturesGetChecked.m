...
//  source: ../target/dependency/com/google/common/util/concurrent/FuturesGetChecked.java
//
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentFuturesGetChecked class]) {
    JreStrongAssign(&ComGoogleCommonUtilConcurrentFuturesGetChecked_WITH_STRING_PARAM_FIRST, [((ComGoogleCommonCollectOrdering *) nil_chk([((ComGoogleCommonCollectOrdering *) nil_chk(ComGoogleCommonCollectOrdering_natural())) onResultOfWithComGoogleCommonBaseFunction:create_ComGoogleCommonUtilConcurrentFuturesGetChecked_1_init()])) reverse]);
...
id ComGoogleCommonUtilConcurrentFuturesGetChecked_getCheckedWithComGoogleCommonUtilConcurrentFuturesGetChecked_GetCheckedTypeValidator_withJavaUtilConcurrentFuture_withIOSClass_(id<ComGoogleCommonUtilConcurrentFuturesGetChecked_GetCheckedTypeValidator> validator, id<JavaUtilConcurrentFuture> future, IOSClass *exceptionClass) {
  ...
  @catch (JavaLangInterruptedException *e) {
    ...
    @throw ComGoogleCommonUtilConcurrentFuturesGetChecked_newWithCauseWithIOSClass_withNSException_(exceptionClass, e);
  }
  @catch (JavaUtilConcurrentExecutionException *e) {
    ComGoogleCommonUtilConcurrentFuturesGetChecked_wrapAndThrowExceptionOrErrorWithNSException_withIOSClass_([((JavaUtilConcurrentExecutionException *) nil_chk(e)) getCause], exceptionClass);
...
void ComGoogleCommonUtilConcurrentFuturesGetChecked_wrapAndThrowExceptionOrErrorWithNSException_withIOSClass_(NSException *cause, IOSClass *exceptionClass) {
  ...
  @throw ComGoogleCommonUtilConcurrentFuturesGetChecked_newWithCauseWithIOSClass_withNSException_(exceptionClass, cause);
}
...
jboolean ComGoogleCommonUtilConcurrentFuturesGetChecked_hasConstructorUsableByGetCheckedWithIOSClass_(IOSClass *exceptionClass) {
  ComGoogleCommonUtilConcurrentFuturesGetChecked_initialize();
  @try {
    JavaLangException *unused = ComGoogleCommonUtilConcurrentFuturesGetChecked_newWithCauseWithIOSClass_withNSException_(exceptionClass, create_JavaLangException_init());
    return true;
  }
  ...
  for (JavaLangReflectConstructor * __strong constructor in nil_chk(ComGoogleCommonUtilConcurrentFuturesGetChecked_preferringStringsWithJavaUtilList_(constructors))) {
    ...
    if (instance != nil) {
      if ([instance getCause] == nil) {
        [instance initCauseWithNSException:cause];
      }
      return instance;
    }
  }
  @throw create_JavaLangIllegalArgumentException_initWithNSString_withNSException_(JreStrcat("$@$", @"No appropriate constructor for exception of type ", exceptionClass, @" in response to chained exception"), cause);
}
...
id ComGoogleCommonUtilConcurrentFuturesGetChecked_newFromConstructorWithJavaLangReflectConstructor_withNSException_(JavaLangReflectConstructor *constructor, NSException *cause) {
  ...
  IOSObjectArray *params = [IOSObjectArray arrayWithLength:((IOSObjectArray *) nil_chk(paramTypes))->size_ type:NSObject_class_()];
  for (jint i = 0; i < paramTypes->size_; i++) {
    ...
    if ([((IOSClass *) nil_chk(paramType)) isEqual:NSString_class_()]) {
      IOSObjectArray_Set(params, i, [((NSException *) nil_chk(cause)) description]);
    }
    else if ([paramType isEqual:NSException_class_()]) {
      IOSObjectArray_Set(params, i, cause);
    }
    else {
      return nil;
    }
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentFuturesGetChecked_GetCheckedTypeValidatorHolder class]) {
    JreStrongAssign(&ComGoogleCommonUtilConcurrentFuturesGetChecked_GetCheckedTypeValidatorHolder_CLASS_VALUE_VALIDATOR_NAME, JreStrcat("$$", [ComGoogleCommonUtilConcurrentFuturesGetChecked_GetCheckedTypeValidatorHolder_class_() getName], @"$ClassValueValidator"));
    JreStrongAssign(&ComGoogleCommonUtilConcurrentFuturesGetChecked_GetCheckedTypeValidatorHolder_BEST_VALIDATOR, ComGoogleCommonUtilConcurrentFuturesGetChecked_GetCheckedTypeValidatorHolder_getBestValidator());
...
- (void)validateClassWithIOSClass:(IOSClass *)exceptionClass {
  ...
  [ComGoogleCommonUtilConcurrentFuturesGetChecked_GetCheckedTypeValidatorHolder_WeakSetValidator_validClasses addWithId:create_JavaLangRefWeakReference_initWithId_(exceptionClass)];
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentFuturesGetChecked_GetCheckedTypeValidatorHolder_WeakSetValidator class]) {
    ...
    for (jint i = 0; i < 1; i++) {
      (ComGoogleCommonUtilConcurrentFuturesGetChecked_GetCheckedTypeValidatorHolder_WeakSetValidator_values_[i] = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
      ComGoogleCommonUtilConcurrentFuturesGetChecked_GetCheckedTypeValidatorHolder_WeakSetValidator_initWithNSString_withInt_(e, names[i], i);
    }
    JreStrongAssignAndConsume(&ComGoogleCommonUtilConcurrentFuturesGetChecked_GetCheckedTypeValidatorHolder_WeakSetValidator_validClasses, new_JavaUtilConcurrentCopyOnWriteArraySet_init());
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonUtilConcurrentFuturesGetChecked_1 = { "", "com.google.common.util.concurrent", ptrTable, methods, NULL, 7, 0x8008, 2, 0, 3, -1, -1, 4, -1 };
