...
+ (void)initialize {
  if (self == [ComGoogleCommonUtilConcurrentInterruptibleTask class]) {
    JreStrongAssign(&ComGoogleCommonUtilConcurrentInterruptibleTask_log, JavaUtilLoggingLogger_getLoggerWithNSString_([ComGoogleCommonUtilConcurrentInterruptibleTask_class_() getName]));
    {
      ComGoogleCommonUtilConcurrentInterruptibleTask_AtomicHelper *helper;
      @try {
        helper = create_ComGoogleCommonUtilConcurrentInterruptibleTask_SafeAtomicHelper_initWithJavaUtilConcurrentAtomicAtomicReferenceFieldUpdater_(JavaUtilConcurrentAtomicAtomicReferenceFieldUpdater_newUpdaterWithIOSClass_withIOSClass_withNSString_(ComGoogleCommonUtilConcurrentInterruptibleTask_class_(), JavaLangThread_class_(), @"runner"));
      }
      @catch (NSException *reflectionFailure) {
        ...
        helper = create_ComGoogleCommonUtilConcurrentInterruptibleTask_SynchronizedAtomicHelper_init();
      }
      JreStrongAssign(&ComGoogleCommonUtilConcurrentInterruptibleTask_ATOMIC_HELPER, helper);
    }
...
void ComGoogleCommonUtilConcurrentInterruptibleTask_SafeAtomicHelper_initWithJavaUtilConcurrentAtomicAtomicReferenceFieldUpdater_(ComGoogleCommonUtilConcurrentInterruptibleTask_SafeAtomicHelper *self, JavaUtilConcurrentAtomicAtomicReferenceFieldUpdater *runnerUpdater) {
  ComGoogleCommonUtilConcurrentInterruptibleTask_AtomicHelper_init(self);
  JreStrongAssign(&self->runnerUpdater_, runnerUpdater);
}
...
- (jboolean)compareAndSetRunnerWithComGoogleCommonUtilConcurrentInterruptibleTask:(ComGoogleCommonUtilConcurrentInterruptibleTask *)task
  ...
  @synchronized(task) {
    if (JreLoadVolatileId(&((ComGoogleCommonUtilConcurrentInterruptibleTask *) nil_chk(task))->runner_) == expect) {
      JreVolatileStrongAssign(&task->runner_, update);
    }
  }
  return true;
}
