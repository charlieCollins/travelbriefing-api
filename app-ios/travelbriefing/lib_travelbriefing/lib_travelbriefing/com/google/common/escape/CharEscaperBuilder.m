...
//  source: ../target/dependency/com/google/common/escape/CharEscaperBuilder.java
//
...
- (ComGoogleCommonEscapeCharEscaperBuilder *)addEscapeWithChar:(jchar)c
  ...
  [((id<JavaUtilMap>) nil_chk(map_)) putWithId:JavaLangCharacter_valueOfWithChar_(c) withId:ComGoogleCommonBasePreconditions_checkNotNullWithId_(r)];
  if (c > max_) {
    max_ = c;
  }
  return self;
...
- (ComGoogleCommonEscapeCharEscaperBuilder *)addEscapesWithCharArray:(IOSCharArray *)cs
                                                        withNSString:(NSString *)r {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(r);
  {
    IOSCharArray *a__ = cs;
    ...
    while (b__ < e__) {
      jchar c = *b__++;
      [self addEscapeWithChar:c withNSString:r];
    }
  }
  return self;
}
...
- (IOSObjectArray *)toArray {
  IOSObjectArray *result = [IOSObjectArray arrayWithLength:max_ + 1 type:IOSClass_charArray(1)];
  for (id<JavaUtilMap_Entry> __strong entry_ in nil_chk([((id<JavaUtilMap>) nil_chk(map_)) entrySet])) {
    IOSObjectArray_Set(result, [((JavaLangCharacter *) nil_chk([((id<JavaUtilMap_Entry>) nil_chk(entry_)) getKey])) charValue], [((NSString *) nil_chk([entry_ getValue])) java_toCharArray]);
  }
  return result;
}

- (ComGoogleCommonEscapeEscaper *)toEscaper {
  return create_ComGoogleCommonEscapeCharEscaperBuilder_CharArrayDecorator_initWithCharArray2_([self toArray]);
}
...
void ComGoogleCommonEscapeCharEscaperBuilder_CharArrayDecorator_initWithCharArray2_(ComGoogleCommonEscapeCharEscaperBuilder_CharArrayDecorator *self, IOSObjectArray *replacements) {
  ...
  JreStrongAssign(&self->replacements_, replacements);
