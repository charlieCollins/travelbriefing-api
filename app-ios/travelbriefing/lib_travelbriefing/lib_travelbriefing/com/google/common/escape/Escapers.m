...
//  source: ../target/dependency/com/google/common/escape/Escapers.java
//
...
- (instancetype)initWithComGoogleCommonEscapeEscapers_Builder:(ComGoogleCommonEscapeEscapers_Builder *)outer$
                                              withJavaUtilMap:(id<JavaUtilMap>)param0
                                                     withChar:(jchar)param1
                                                     withChar:(jchar)param2;
...
__attribute__((unused)) static void ComGoogleCommonEscapeEscapers_Builder_1_initWithComGoogleCommonEscapeEscapers_Builder_withJavaUtilMap_withChar_withChar_(ComGoogleCommonEscapeEscapers_Builder_1 *self, ComGoogleCommonEscapeEscapers_Builder *outer$, id<JavaUtilMap> param0, jchar param1, jchar param2);

__attribute__((unused)) static ComGoogleCommonEscapeEscapers_Builder_1 *new_ComGoogleCommonEscapeEscapers_Builder_1_initWithComGoogleCommonEscapeEscapers_Builder_withJavaUtilMap_withChar_withChar_(ComGoogleCommonEscapeEscapers_Builder *outer$, id<JavaUtilMap> param0, jchar param1, jchar param2) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonEscapeEscapers_Builder_1 *create_ComGoogleCommonEscapeEscapers_Builder_1_initWithComGoogleCommonEscapeEscapers_Builder_withJavaUtilMap_withChar_withChar_(ComGoogleCommonEscapeEscapers_Builder *outer$, id<JavaUtilMap> param0, jchar param1, jchar param2);
...
+ (void)initialize {
  if (self == [ComGoogleCommonEscapeEscapers class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonEscapeEscapers_NULL_ESCAPER, new_ComGoogleCommonEscapeEscapers_1_init());
...
ComGoogleCommonEscapeEscapers_Builder *ComGoogleCommonEscapeEscapers_builder() {
  ComGoogleCommonEscapeEscapers_initialize();
  return create_ComGoogleCommonEscapeEscapers_Builder_init();
}
...
ComGoogleCommonEscapeUnicodeEscaper *ComGoogleCommonEscapeEscapers_asUnicodeEscaperWithComGoogleCommonEscapeEscaper_(ComGoogleCommonEscapeEscaper *escaper) {
  ComGoogleCommonEscapeEscapers_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(escaper);
  ...
  @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"Cannot create a UnicodeEscaper from: ", [[((ComGoogleCommonEscapeEscaper *) nil_chk(escaper)) java_getClass] getName]));
}
...
ComGoogleCommonEscapeUnicodeEscaper *ComGoogleCommonEscapeEscapers_wrapWithComGoogleCommonEscapeCharEscaper_(ComGoogleCommonEscapeCharEscaper *escaper) {
  ComGoogleCommonEscapeEscapers_initialize();
  return create_ComGoogleCommonEscapeEscapers_2_initWithComGoogleCommonEscapeCharEscaper_(escaper);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonEscapeEscapers_1 = { "", "com.google.common.escape", ptrTable, methods, NULL, 7, 0x8008, 3, 0, 3, -1, -1, -1, -1 };
...
- (ComGoogleCommonEscapeEscapers_Builder *)setUnsafeReplacementWithNSString:(NSString *)unsafeReplacement {
  JreStrongAssign(&self->unsafeReplacement_, unsafeReplacement);
  return self;
}
...
- (ComGoogleCommonEscapeEscapers_Builder *)addEscapeWithChar:(jchar)c
  ...
  [((id<JavaUtilMap>) nil_chk(replacementMap_)) putWithId:JavaLangCharacter_valueOfWithChar_(c) withId:replacement];
  return self;
}

- (ComGoogleCommonEscapeEscaper *)build {
  return create_ComGoogleCommonEscapeEscapers_Builder_1_initWithComGoogleCommonEscapeEscapers_Builder_withJavaUtilMap_withChar_withChar_(self, replacementMap_, safeMin_, safeMax_);
}

- (void)dealloc {
  RELEASE_(replacementMap_);
  RELEASE_(unsafeReplacement_);
  [super dealloc];
}
...
void ComGoogleCommonEscapeEscapers_Builder_init(ComGoogleCommonEscapeEscapers_Builder *self) {
  NSObject_init(self);
  JreStrongAssignAndConsume(&self->replacementMap_, new_JavaUtilHashMap_init());
  self->safeMin_ = JavaLangCharacter_MIN_VALUE;
  self->safeMax_ = JavaLangCharacter_MAX_VALUE;
  JreStrongAssign(&self->unsafeReplacement_, nil);
}
...
- (instancetype)initWithComGoogleCommonEscapeEscapers_Builder:(ComGoogleCommonEscapeEscapers_Builder *)outer$
                                              withJavaUtilMap:(id<JavaUtilMap>)param0
                                                     withChar:(jchar)param1
                                                     withChar:(jchar)param2 {
  ComGoogleCommonEscapeEscapers_Builder_1_initWithComGoogleCommonEscapeEscapers_Builder_withJavaUtilMap_withChar_withChar_(self, outer$, param0, param1, param2);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonEscapeEscapers_Builder_1 = { "", "com.google.common.escape", ptrTable, methods, fields, 7, 0x8008, 2, 1, 4, -1, 5, -1, -1 };
  return &_ComGoogleCommonEscapeEscapers_Builder_1;
}

@end

void ComGoogleCommonEscapeEscapers_Builder_1_initWithComGoogleCommonEscapeEscapers_Builder_withJavaUtilMap_withChar_withChar_(ComGoogleCommonEscapeEscapers_Builder_1 *self, ComGoogleCommonEscapeEscapers_Builder *outer$, id<JavaUtilMap> param0, jchar param1, jchar param2) {
  ComGoogleCommonEscapeArrayBasedCharEscaper_initWithJavaUtilMap_withChar_withChar_(self, param0, param1, param2);
  JreStrongAssign(&self->replacementChars_, outer$->unsafeReplacement_ != nil ? [outer$->unsafeReplacement_ java_toCharArray] : nil);
}

ComGoogleCommonEscapeEscapers_Builder_1 *new_ComGoogleCommonEscapeEscapers_Builder_1_initWithComGoogleCommonEscapeEscapers_Builder_withJavaUtilMap_withChar_withChar_(ComGoogleCommonEscapeEscapers_Builder *outer$, id<JavaUtilMap> param0, jchar param1, jchar param2) {
  J2OBJC_NEW_IMPL(ComGoogleCommonEscapeEscapers_Builder_1, initWithComGoogleCommonEscapeEscapers_Builder_withJavaUtilMap_withChar_withChar_, outer$, param0, param1, param2)
}

ComGoogleCommonEscapeEscapers_Builder_1 *create_ComGoogleCommonEscapeEscapers_Builder_1_initWithComGoogleCommonEscapeEscapers_Builder_withJavaUtilMap_withChar_withChar_(ComGoogleCommonEscapeEscapers_Builder *outer$, id<JavaUtilMap> param0, jchar param1, jchar param2) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonEscapeEscapers_Builder_1, initWithComGoogleCommonEscapeEscapers_Builder_withJavaUtilMap_withChar_withChar_, outer$, param0, param1, param2)
}
...
- (IOSCharArray *)escapeWithInt:(jint)cp {
  ...
  IOSCharArray *surrogateChars = [IOSCharArray arrayWithLength:2];
  ...
  IOSCharArray *output = [IOSCharArray arrayWithLength:hiCount + loCount];
  if (hiChars != nil) {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonEscapeEscapers_2 = { "", "com.google.common.escape", ptrTable, methods, fields, 7, 0x8008, 2, 1, 2, -1, 3, -1, -1 };
...
void ComGoogleCommonEscapeEscapers_2_initWithComGoogleCommonEscapeCharEscaper_(ComGoogleCommonEscapeEscapers_2 *self, ComGoogleCommonEscapeCharEscaper *capture$0) {
  JreStrongAssign(&self->val$escaper_, capture$0);
