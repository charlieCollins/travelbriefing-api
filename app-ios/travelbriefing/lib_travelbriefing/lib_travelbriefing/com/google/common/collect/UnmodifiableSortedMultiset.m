...
//  source: ../target/dependency/com/google/common/collect/UnmodifiableSortedMultiset.java
//
...
- (id<ComGoogleCommonCollectSortedMultiset>)descendingMultiset {
  ...
  if (result == nil) {
    result = create_ComGoogleCommonCollectUnmodifiableSortedMultiset_initWithComGoogleCommonCollectSortedMultiset_([((id<ComGoogleCommonCollectSortedMultiset>) nil_chk([self delegate])) descendingMultiset]);
    JreStrongAssign(&result->descendingMultiset_, self);
    return JreStrongAssign(&descendingMultiset_, result);
  }
  return result;
}
