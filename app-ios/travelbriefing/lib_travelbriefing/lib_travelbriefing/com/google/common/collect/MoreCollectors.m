...
//  source: ../target/dependency/com/google/common/collect/MoreCollectors.java
//
...
- (JavaLangIllegalArgumentException *)multiplesWithBoolean:(jboolean)overflow {
  JavaLangStringBuilder *sb = [((JavaLangStringBuilder *) nil_chk([create_JavaLangStringBuilder_init() appendWithNSString:@"expected one element but was: <"])) appendWithId:element_];
  for (id __strong o in nil_chk(extras_)) {
    [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk(sb)) appendWithNSString:@", "])) appendWithId:o];
  }
  if (overflow) {
...
- (void)addWithId:(id)o {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(o);
  if (element_ == nil) {
    JreStrongAssign(&self->element_, o);
  }
  else if (extras_ == nil) {
    JreStrongAssignAndConsume(&extras_, new_JavaUtilArrayList_initWithInt_(ComGoogleCommonCollectMoreCollectors_ToOptionalState_MAX_EXTRAS));
    [extras_ addWithId:o];
  }
    ...
    @throw [self multiplesWithBoolean:true];
  }
}
...
- (ComGoogleCommonCollectMoreCollectors_ToOptionalState *)combineWithComGoogleCommonCollectMoreCollectors_ToOptionalState:(ComGoogleCommonCollectMoreCollectors_ToOptionalState *)other {
  if (element_ == nil) {
    ...
    if (extras_ == nil) {
      JreStrongAssignAndConsume(&extras_, new_JavaUtilArrayList_init());
    }
...
- (JavaUtilOptional *)getOptional {
  if (extras_ == nil) {
    ...
    @throw [self multiplesWithBoolean:false];
  }
}
...
void ComGoogleCommonCollectMoreCollectors_ToOptionalState_init(ComGoogleCommonCollectMoreCollectors_ToOptionalState *self) {
  NSObject_init(self);
  JreStrongAssign(&self->element_, nil);
  JreStrongAssign(&self->extras_, nil);
}
...
- (id)get {
  return create_ComGoogleCommonCollectMoreCollectors_ToOptionalState_init();
}

+ (void)initialize {
  if (self == [ComGoogleCommonCollectMoreCollectors_$Lambda$1 class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonCollectMoreCollectors_$Lambda$1_instance, new_ComGoogleCommonCollectMoreCollectors_$Lambda$1_init());
...
+ (void)initialize {
  if (self == [ComGoogleCommonCollectMoreCollectors_$Lambda$2 class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonCollectMoreCollectors_$Lambda$2_instance, new_ComGoogleCommonCollectMoreCollectors_$Lambda$2_init());
...
+ (void)initialize {
  if (self == [ComGoogleCommonCollectMoreCollectors_$Lambda$3 class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonCollectMoreCollectors_$Lambda$3_instance, new_ComGoogleCommonCollectMoreCollectors_$Lambda$3_init());
...
+ (void)initialize {
  if (self == [ComGoogleCommonCollectMoreCollectors_$Lambda$4 class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonCollectMoreCollectors_$Lambda$4_instance, new_ComGoogleCommonCollectMoreCollectors_$Lambda$4_init());
...
+ (void)initialize {
  if (self == [ComGoogleCommonCollectMoreCollectors_$Lambda$5 class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonCollectMoreCollectors_$Lambda$5_instance, new_ComGoogleCommonCollectMoreCollectors_$Lambda$5_init());
...
+ (void)initialize {
  if (self == [ComGoogleCommonCollectMoreCollectors_$Lambda$6 class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonCollectMoreCollectors_$Lambda$6_instance, new_ComGoogleCommonCollectMoreCollectors_$Lambda$6_init());
...
+ (void)initialize {
  if (self == [ComGoogleCommonCollectMoreCollectors_$Lambda$7 class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonCollectMoreCollectors_$Lambda$7_instance, new_ComGoogleCommonCollectMoreCollectors_$Lambda$7_init());
...
+ (void)initialize {
  if (self == [ComGoogleCommonCollectMoreCollectors_$Lambda$8 class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonCollectMoreCollectors_$Lambda$8_instance, new_ComGoogleCommonCollectMoreCollectors_$Lambda$8_init());
