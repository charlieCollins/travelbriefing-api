...
//  source: ../target/dependency/com/google/common/collect/CartesianList.java
//
...
- (ComGoogleCommonCollectImmutableList *)getWithInt:(jint)index {
  ...
  return create_ComGoogleCommonCollectCartesianList_1_initWithComGoogleCommonCollectCartesianList_withInt_(self, index);
}
...
id<JavaUtilList> ComGoogleCommonCollectCartesianList_createWithJavaUtilList_(id<JavaUtilList> lists) {
  ...
  ComGoogleCommonCollectImmutableList_Builder *axesBuilder = create_ComGoogleCommonCollectImmutableList_Builder_initWithInt_([((id<JavaUtilList>) nil_chk(lists)) size]);
  ...
  return create_ComGoogleCommonCollectCartesianList_initWithComGoogleCommonCollectImmutableList_([axesBuilder build]);
}
...
void ComGoogleCommonCollectCartesianList_initWithComGoogleCommonCollectImmutableList_(ComGoogleCommonCollectCartesianList *self, ComGoogleCommonCollectImmutableList *axes) {
  ...
  IOSIntArray *axesSizeProduct = [IOSIntArray arrayWithLength:[((ComGoogleCommonCollectImmutableList *) nil_chk(axes)) size] + 1];
  *IOSIntArray_GetRef(axesSizeProduct, [axes size]) = 1;
  ...
  @catch (JavaLangArithmeticException *e) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"Cartesian product too large; must have size at most Integer.MAX_VALUE");
  }
  JreStrongAssign(&self->axesSizeProduct_, axesSizeProduct);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonCollectCartesianList_1 = { "", "com.google.common.collect", ptrTable, methods, fields, 7, 0x8008, 4, 2, 4, -1, 5, 6, -1 };
