...
//  source: ../target/dependency/com/google/common/collect/RegularImmutableList.java
//
...
+ (void)initialize {
  if (self == [ComGoogleCommonCollectRegularImmutableList class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonCollectRegularImmutableList_EMPTY, new_ComGoogleCommonCollectRegularImmutableList_initWithNSObjectArray_(JreLoadStatic(ComGoogleCommonCollectObjectArrays, EMPTY_ARRAY)));
