...
//  source: ../target/dependency/com/google/common/collect/AbstractBiMap.java
//
...
- (void)setDelegatesWithJavaUtilMap:(id<JavaUtilMap>)forward
  ...
  JreStrongAssign(&delegate_, forward);
  JreRetainedWithAssign(self, &inverse_, [self makeInverseWithJavaUtilMap:backward]);
}

- (ComGoogleCommonCollectAbstractBiMap *)makeInverseWithJavaUtilMap:(id<JavaUtilMap>)backward {
  return create_ComGoogleCommonCollectAbstractBiMap_Inverse_initWithJavaUtilMap_withComGoogleCommonCollectAbstractBiMap_(backward, self);
}
...
- (void)replaceAllWithJavaUtilFunctionBiFunction:(id<JavaUtilFunctionBiFunction>)function {
  ...
  if (broken != nil) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@", @"value already present: ", [broken getValue]));
  }
}
...
- (id<JavaUtilSet>)keySet {
  ...
  return (result == nil) ? JreStrongAssignAndConsume(&keySet_, new_ComGoogleCommonCollectAbstractBiMap_KeySet_initWithComGoogleCommonCollectAbstractBiMap_(self)) : result;
}

- (id<JavaUtilSet>)values {
  id<JavaUtilSet> result = valueSet_;
  return (result == nil) ? JreStrongAssignAndConsume(&valueSet_, new_ComGoogleCommonCollectAbstractBiMap_ValueSet_initWithComGoogleCommonCollectAbstractBiMap_(self)) : result;
}

- (id<JavaUtilSet>)entrySet {
  id<JavaUtilSet> result = entrySet_;
  return (result == nil) ? JreStrongAssignAndConsume(&entrySet_, new_ComGoogleCommonCollectAbstractBiMap_EntrySet_initWithComGoogleCommonCollectAbstractBiMap_(self)) : result;
}
...
- (id<JavaUtilIterator>)entrySetIterator {
  ...
  return create_ComGoogleCommonCollectAbstractBiMap_1_initWithComGoogleCommonCollectAbstractBiMap_withJavaUtilIterator_(self, iterator);
}
...
void ComGoogleCommonCollectAbstractBiMap_initWithJavaUtilMap_withComGoogleCommonCollectAbstractBiMap_(ComGoogleCommonCollectAbstractBiMap *self, id<JavaUtilMap> backward, ComGoogleCommonCollectAbstractBiMap *forward) {
  ComGoogleCommonCollectForwardingMap_init(self);
  JreStrongAssign(&self->delegate_, backward);
  JreRetainedWithAssign(self, &self->inverse_, forward);
}
...
id ComGoogleCommonCollectAbstractBiMap_putInBothMapsWithId_withId_withBoolean_(ComGoogleCommonCollectAbstractBiMap *self, id key, id value, jboolean force) {
  ...
  if (force) {
    [((id<ComGoogleCommonCollectBiMap>) nil_chk([self inverse])) removeWithId:value];
  }
  else {
...
void ComGoogleCommonCollectAbstractBiMap_updateInverseMapWithId_withBoolean_withId_withId_(ComGoogleCommonCollectAbstractBiMap *self, id key, jboolean containedKey, id oldValue, id newValue) {
  ...
  [((id<JavaUtilMap>) nil_chk(((ComGoogleCommonCollectAbstractBiMap *) nil_chk(self->inverse_))->delegate_)) putWithId:newValue withId:key];
}
...
void ComGoogleCommonCollectAbstractBiMap_removeFromInverseMapWithId_(ComGoogleCommonCollectAbstractBiMap *self, id oldValue) {
  [((id<JavaUtilMap>) nil_chk(((ComGoogleCommonCollectAbstractBiMap *) nil_chk(self->inverse_))->delegate_)) removeWithId:oldValue];
}
...
- (jboolean)removeWithId:(id)key {
  ...
  ComGoogleCommonCollectAbstractBiMap_removeFromBothMapsWithId_(this$0_, key);
  return true;
}
...
void ComGoogleCommonCollectAbstractBiMap_ValueSet_initWithComGoogleCommonCollectAbstractBiMap_(ComGoogleCommonCollectAbstractBiMap_ValueSet *self, ComGoogleCommonCollectAbstractBiMap *outer$) {
  self->this$0_ = outer$;
  ComGoogleCommonCollectForwardingSet_init(self);
  JreStrongAssign(&self->valuesDelegate_, [((ComGoogleCommonCollectAbstractBiMap *) nil_chk(outer$->inverse_)) keySet]);
}
...
- (id<JavaUtilMap_Entry>)next {
  JreStrongAssign(&entry__, [((id<JavaUtilIterator>) nil_chk(val$iterator_)) next]);
  return create_ComGoogleCommonCollectAbstractBiMap_BiMapEntry_initWithComGoogleCommonCollectAbstractBiMap_withJavaUtilMap_Entry_(this$0_, entry__);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonCollectAbstractBiMap_1 = { "", "com.google.common.collect", ptrTable, methods, fields, 7, 0x8008, 4, 3, 5, -1, 6, 7, -1 };
...
- (jboolean)removeWithId:(id)object {
  ...
  [((id<JavaUtilMap>) nil_chk(((ComGoogleCommonCollectAbstractBiMap *) nil_chk(this$0_->inverse_))->delegate_)) removeWithId:[((id<JavaUtilMap_Entry>) nil_chk(entry_)) getValue]];
...
void ComGoogleCommonCollectAbstractBiMap_EntrySet_initWithComGoogleCommonCollectAbstractBiMap_(ComGoogleCommonCollectAbstractBiMap_EntrySet *self, ComGoogleCommonCollectAbstractBiMap *outer$) {
  self->this$0_ = outer$;
  ComGoogleCommonCollectForwardingSet_init(self);
  JreStrongAssign(&self->esDelegate_, [((id<JavaUtilMap>) nil_chk(outer$->delegate_)) entrySet]);
}
