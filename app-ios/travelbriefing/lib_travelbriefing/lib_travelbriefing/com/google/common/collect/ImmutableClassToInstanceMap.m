...
//  source: ../target/dependency/com/google/common/collect/ImmutableClassToInstanceMap.java
//
...
+ (void)initialize {
  if (self == [ComGoogleCommonCollectImmutableClassToInstanceMap class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonCollectImmutableClassToInstanceMap_EMPTY, new_ComGoogleCommonCollectImmutableClassToInstanceMap_initWithComGoogleCommonCollectImmutableMap_(ComGoogleCommonCollectImmutableMap_of()));
...
ComGoogleCommonCollectImmutableClassToInstanceMap *ComGoogleCommonCollectImmutableClassToInstanceMap_ofWithIOSClass_withId_(IOSClass *type, id value) {
  ...
  return create_ComGoogleCommonCollectImmutableClassToInstanceMap_initWithComGoogleCommonCollectImmutableMap_(map);
}

ComGoogleCommonCollectImmutableClassToInstanceMap_Builder *ComGoogleCommonCollectImmutableClassToInstanceMap_builder() {
  ComGoogleCommonCollectImmutableClassToInstanceMap_initialize();
  return create_ComGoogleCommonCollectImmutableClassToInstanceMap_Builder_init();
}
...
ComGoogleCommonCollectImmutableClassToInstanceMap *ComGoogleCommonCollectImmutableClassToInstanceMap_copyOfWithJavaUtilMap_(id<JavaUtilMap> map) {
  ...
  return [((ComGoogleCommonCollectImmutableClassToInstanceMap_Builder *) nil_chk([create_ComGoogleCommonCollectImmutableClassToInstanceMap_Builder_init() putAllWithJavaUtilMap:map])) build];
}
...
- (ComGoogleCommonCollectImmutableClassToInstanceMap_Builder *)putWithIOSClass:(IOSClass *)key
                                                                        withId:(id)value {
  [((ComGoogleCommonCollectImmutableMap_Builder *) nil_chk(mapBuilder_)) putWithId:key withId:value];
  return self;
}
...
- (ComGoogleCommonCollectImmutableClassToInstanceMap_Builder *)putAllWithJavaUtilMap:(id<JavaUtilMap>)map {
  for (id<JavaUtilMap_Entry> __strong entry_ in nil_chk([((id<JavaUtilMap>) nil_chk(map)) entrySet])) {
    ...
    [((ComGoogleCommonCollectImmutableMap_Builder *) nil_chk(mapBuilder_)) putWithId:type withId:ComGoogleCommonCollectImmutableClassToInstanceMap_Builder_castWithIOSClass_withId_(type, value)];
  }
  return self;
}
...
void ComGoogleCommonCollectImmutableClassToInstanceMap_Builder_init(ComGoogleCommonCollectImmutableClassToInstanceMap_Builder *self) {
  NSObject_init(self);
  JreStrongAssign(&self->mapBuilder_, ComGoogleCommonCollectImmutableMap_builder());
}
