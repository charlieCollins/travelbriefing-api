...
//  source: ../target/dependency/com/google/common/collect/RegularImmutableSortedSet.java
//
...
- (jboolean)containsAllWithJavaUtilCollection:(id<JavaUtilCollection>)targets {
  ...
  id<ComGoogleCommonCollectPeekingIterator> thisIterator = ComGoogleCommonCollectIterators_peekingIteratorWithJavaUtilIterator_([self iterator]);
  ...
  @try {
    while ([((id<ComGoogleCommonCollectPeekingIterator>) nil_chk(thisIterator)) hasNext]) {
      jint cmp = [self unsafeCompareWithId:[thisIterator peek] withId:target];
      if (cmp < 0) {
        [thisIterator next];
      }
      else if (cmp == 0) {
...
- (ComGoogleCommonCollectRegularImmutableSortedSet *)getSubSetWithInt:(jint)newFromIndex
  ...
  if (newFromIndex == 0 && newToIndex == [self size]) {
    ...
    return create_ComGoogleCommonCollectRegularImmutableSortedSet_initWithComGoogleCommonCollectImmutableList_withJavaUtilComparator_([((ComGoogleCommonCollectImmutableList *) nil_chk(elements_)) subListWithInt:newFromIndex withInt:newToIndex], comparator_);
  }
  else {
...
- (jint)indexOfWithId:(id)target {
  ...
  jint position;
  @try {
    position = ComGoogleCommonCollectSortedLists_binarySearchWithJavaUtilList_withId_withJavaUtilComparator_withComGoogleCommonCollectSortedLists_KeyPresentBehavior_withComGoogleCommonCollectSortedLists_KeyAbsentBehavior_(elements_, target, [self unsafeComparator], JreLoadEnum(ComGoogleCommonCollectSortedLists_KeyPresentBehavior, ANY_PRESENT), JreLoadEnum(ComGoogleCommonCollectSortedLists_KeyAbsentBehavior, INVERTED_INSERTION_INDEX));
  }
  @catch (JavaLangClassCastException *e) {
    return -1;
  }
...
- (ComGoogleCommonCollectImmutableList *)createAsList {
  return ([self size] <= 1) ? elements_ : create_ComGoogleCommonCollectImmutableSortedAsList_initWithComGoogleCommonCollectImmutableSortedSet_withComGoogleCommonCollectImmutableList_(self, elements_);
}

- (ComGoogleCommonCollectImmutableSortedSet *)createDescendingSet {
  ComGoogleCommonCollectOrdering *reversedOrder = [((ComGoogleCommonCollectOrdering *) nil_chk(ComGoogleCommonCollectOrdering_fromWithJavaUtilComparator_(comparator_))) reverse];
  return [self isEmpty] ? ComGoogleCommonCollectImmutableSortedSet_emptySetWithJavaUtilComparator_(reversedOrder) : create_ComGoogleCommonCollectRegularImmutableSortedSet_initWithComGoogleCommonCollectImmutableList_withJavaUtilComparator_([((ComGoogleCommonCollectImmutableList *) nil_chk(elements_)) reverse], reversedOrder);
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonCollectRegularImmutableSortedSet class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonCollectRegularImmutableSortedSet_NATURAL_EMPTY_SET, new_ComGoogleCommonCollectRegularImmutableSortedSet_initWithComGoogleCommonCollectImmutableList_withJavaUtilComparator_(ComGoogleCommonCollectImmutableList_of(), ComGoogleCommonCollectOrdering_natural()));
