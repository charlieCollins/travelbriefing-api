...
//  source: ../target/dependency/com/google/common/io/ByteSink.java
//
...
- (ComGoogleCommonIoCharSink *)asCharSinkWithJavaNioCharsetCharset:(JavaNioCharsetCharset *)charset {
  return create_ComGoogleCommonIoByteSink_AsCharSink_initWithComGoogleCommonIoByteSink_withJavaNioCharsetCharset_(self, charset);
}
...
- (JavaIoOutputStream *)openBufferedStream {
  ...
  return ([out isKindOfClass:[JavaIoBufferedOutputStream class]]) ? (JavaIoBufferedOutputStream *) cast_chk(out, [JavaIoBufferedOutputStream class]) : create_JavaIoBufferedOutputStream_initWithJavaIoOutputStream_(out);
}

- (void)writeWithByteArray:(IOSByteArray *)bytes {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(bytes);
...
- (JavaIoWriter *)openStream {
  return create_JavaIoOutputStreamWriter_initWithJavaIoOutputStream_withJavaNioCharsetCharset_([this$0_ openStream], charset_);
}
