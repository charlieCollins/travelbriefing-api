...
//  source: ../target/dependency/com/google/common/io/ByteSource.java
//
...
__attribute__((unused)) static void ComGoogleCommonIoByteSource_AsCharSource_initWithComGoogleCommonIoByteSource_withJavaNioCharsetCharset_(ComGoogleCommonIoByteSource_AsCharSource *self, ComGoogleCommonIoByteSource *outer$, JavaNioCharsetCharset *charset);

__attribute__((unused)) static ComGoogleCommonIoByteSource_AsCharSource *new_ComGoogleCommonIoByteSource_AsCharSource_initWithComGoogleCommonIoByteSource_withJavaNioCharsetCharset_(ComGoogleCommonIoByteSource *outer$, JavaNioCharsetCharset *charset) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonIoByteSource_AsCharSource *create_ComGoogleCommonIoByteSource_AsCharSource_initWithComGoogleCommonIoByteSource_withJavaNioCharsetCharset_(ComGoogleCommonIoByteSource *outer$, JavaNioCharsetCharset *charset);
...
- (ComGoogleCommonIoCharSource *)asCharSourceWithJavaNioCharsetCharset:(JavaNioCharsetCharset *)charset {
  return create_ComGoogleCommonIoByteSource_AsCharSource_initWithComGoogleCommonIoByteSource_withJavaNioCharsetCharset_(self, charset);
}
...
- (JavaIoInputStream *)openBufferedStream {
  ...
  return ([in isKindOfClass:[JavaIoBufferedInputStream class]]) ? (JavaIoBufferedInputStream *) cast_chk(in, [JavaIoBufferedInputStream class]) : create_JavaIoBufferedInputStream_initWithJavaIoInputStream_(in);
}

- (ComGoogleCommonIoByteSource *)sliceWithLong:(jlong)offset
                                      withLong:(jlong)length {
  return create_ComGoogleCommonIoByteSource_SlicedByteSource_initWithComGoogleCommonIoByteSource_withLong_withLong_(self, offset, length);
}
...
- (jlong)copyToWithJavaIoOutputStream:(JavaIoOutputStream *)output {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(output);
  ComGoogleCommonIoCloser *closer = ComGoogleCommonIoCloser_create();
  @try {
    JavaIoInputStream *in = ((JavaIoInputStream *) [((ComGoogleCommonIoCloser *) nil_chk(closer)) register__WithJavaIoCloseable:[self openStream]]);
...
ComGoogleCommonIoByteSource *ComGoogleCommonIoByteSource_concatWithJavaLangIterable_(id<JavaLangIterable> sources) {
  ...
  return create_ComGoogleCommonIoByteSource_ConcatenatedByteSource_initWithJavaLangIterable_(sources);
}
...
ComGoogleCommonIoByteSource *ComGoogleCommonIoByteSource_wrapWithByteArray_(IOSByteArray *b) {
  ComGoogleCommonIoByteSource_initialize();
  return create_ComGoogleCommonIoByteSource_ByteArrayByteSource_initWithByteArray_(b);
}
...
- (JavaIoReader *)openStream {
  return create_JavaIoInputStreamReader_initWithJavaIoInputStream_withJavaNioCharsetCharset_([this$0_ openStream], charset_);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonIoByteSource_AsCharSource = { "AsCharSource", "com.google.common.io", ptrTable, methods, fields, 7, 0x12, 4, 2, 4, -1, -1, -1, -1 };
...
JavaIoInputStream *ComGoogleCommonIoByteSource_SlicedByteSource_sliceStreamWithJavaIoInputStream_(ComGoogleCommonIoByteSource_SlicedByteSource *self, JavaIoInputStream *inArg) {
  if (self->offset_ > 0) {
    ...
    @catch (NSException *e) {
      ComGoogleCommonIoCloser *closer = ComGoogleCommonIoCloser_create();
      [((ComGoogleCommonIoCloser *) nil_chk(closer)) register__WithJavaIoCloseable:inArg];
      @try {
        @throw [closer rethrowWithNSException:e];
      }
      @finally {
    ...
    if (skipped < self->offset_) {
      ...
      return create_JavaIoByteArrayInputStream_initWithByteArray_([IOSByteArray arrayWithLength:0]);
    }
  }
...
- (JavaIoInputStream *)openStream {
  return create_JavaIoByteArrayInputStream_initWithByteArray_withInt_withInt_(bytes_, offset_, length_);
}
...
- (ComGoogleCommonIoByteSource *)sliceWithLong:(jlong)offset
  ...
  return create_ComGoogleCommonIoByteSource_ByteArrayByteSource_initWithByteArray_withInt_withInt_(bytes_, newOffset, (jint) length);
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonIoByteSource_EmptyByteSource class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonIoByteSource_EmptyByteSource_INSTANCE, new_ComGoogleCommonIoByteSource_EmptyByteSource_init());
...
void ComGoogleCommonIoByteSource_EmptyByteSource_init(ComGoogleCommonIoByteSource_EmptyByteSource *self) {
  ComGoogleCommonIoByteSource_ByteArrayByteSource_initWithByteArray_(self, [IOSByteArray arrayWithLength:0]);
}
...
- (JavaIoInputStream *)openStream {
  return create_ComGoogleCommonIoMultiInputStream_initWithJavaUtilIterator_([((id<JavaLangIterable>) nil_chk(sources_)) iterator]);
}
