...
//  source: ../target/dependency/com/google/common/io/CharSource.java
//
...
__attribute__((unused)) static id<JavaLangIterable> ComGoogleCommonIoCharSource_CharSequenceCharSource_lines(ComGoogleCommonIoCharSource_CharSequenceCharSource *self);

J2OBJC_TYPE_LITERAL_HEADER(ComGoogleCommonIoCharSource_CharSequenceCharSource)

@interface ComGoogleCommonIoCharSource_CharSequenceCharSource_1 : NSObject < JavaLangIterable > {
 @public
  ComGoogleCommonIoCharSource_CharSequenceCharSource *this$0_;
}
...
@interface ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1 : ComGoogleCommonCollectAbstractIterator {
 @public
  id<JavaUtilIterator> lines_;
}

- (instancetype)initWithComGoogleCommonIoCharSource_CharSequenceCharSource_1:(ComGoogleCommonIoCharSource_CharSequenceCharSource_1 *)outer$;
...
J2OBJC_EMPTY_STATIC_INIT(ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1)

J2OBJC_FIELD_SETTER(ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1, lines_, id<JavaUtilIterator>)

__attribute__((unused)) static void ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1_initWithComGoogleCommonIoCharSource_CharSequenceCharSource_1_(ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1 *self, ComGoogleCommonIoCharSource_CharSequenceCharSource_1 *outer$);

__attribute__((unused)) static ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1 *new_ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1_initWithComGoogleCommonIoCharSource_CharSequenceCharSource_1_(ComGoogleCommonIoCharSource_CharSequenceCharSource_1 *outer$) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1 *create_ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1_initWithComGoogleCommonIoCharSource_CharSequenceCharSource_1_(ComGoogleCommonIoCharSource_CharSequenceCharSource_1 *outer$);
...
- (ComGoogleCommonIoByteSource *)asByteSourceWithJavaNioCharsetCharset:(JavaNioCharsetCharset *)charset {
  return create_ComGoogleCommonIoCharSource_AsByteSource_initWithComGoogleCommonIoCharSource_withJavaNioCharsetCharset_(self, charset);
}
...
- (jlong)copyToWithJavaLangAppendable:(id<JavaLangAppendable>)appendable {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(appendable);
  ComGoogleCommonIoCloser *closer = ComGoogleCommonIoCloser_create();
  @try {
    JavaIoReader *reader = ((JavaIoReader *) [((ComGoogleCommonIoCloser *) nil_chk(closer)) register__WithJavaIoCloseable:[self openStream]]);
...
- (jlong)copyToWithComGoogleCommonIoCharSink:(ComGoogleCommonIoCharSink *)sink {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(sink);
  ComGoogleCommonIoCloser *closer = ComGoogleCommonIoCloser_create();
  @try {
    JavaIoReader *reader = ((JavaIoReader *) [((ComGoogleCommonIoCloser *) nil_chk(closer)) register__WithJavaIoCloseable:[self openStream]]);
...
- (id)readLinesWithComGoogleCommonIoLineProcessor:(id<ComGoogleCommonIoLineProcessor>)processor {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(processor);
  ComGoogleCommonIoCloser *closer = ComGoogleCommonIoCloser_create();
  @try {
    JavaIoReader *reader = ((JavaIoReader *) [((ComGoogleCommonIoCloser *) nil_chk(closer)) register__WithJavaIoCloseable:[self openStream]]);
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "J", 0x2, 4, 5, 2, -1, -1, -1 },
    { NULL, "J", 0x1, 6, 7, 2, -1, -1, -1 },
    { NULL, "J", 0x1, 6, 8, 2, -1, -1, -1 },
    { NULL, "LNSString;", 0x1, -1, -1, 2, -1, -1, -1 },
    { NULL, "LNSString;", 0x1, -1, -1, 2, -1, 9, -1 },
    { NULL, "LComGoogleCommonCollectImmutableList;", 0x1, -1, -1, 2, 10, -1, -1 },
    { NULL, "LNSObject;", 0x1, 11, 12, 2, 13, -1, -1 },
    { NULL, "Z", 0x1, -1, -1, 2, -1, -1, -1 },
    { NULL, "LComGoogleCommonIoCharSource;", 0x9, 14, 15, -1, 16, -1, -1 },
    { NULL, "LComGoogleCommonIoCharSource;", 0x9, 14, 17, -1, 18, -1, -1 },
    { NULL, "LComGoogleCommonIoCharSource;", 0x89, 14, 19, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonIoCharSource;", 0x9, 20, 21, -1, -1, -1, -1 },
  ...
  methods[4].selector = @selector(lengthIfKnown);
  methods[5].selector = @selector(length);
  methods[6].selector = @selector(countBySkippingWithJavaIoReader:);
  methods[7].selector = @selector(copyToWithJavaLangAppendable:);
  methods[8].selector = @selector(copyToWithComGoogleCommonIoCharSink:);
  methods[9].selector = @selector(read);
  methods[10].selector = @selector(readFirstLine);
  methods[11].selector = @selector(readLines);
  methods[12].selector = @selector(readLinesWithComGoogleCommonIoLineProcessor:);
  methods[13].selector = @selector(isEmpty);
  methods[14].selector = @selector(concatWithJavaLangIterable:);
  methods[15].selector = @selector(concatWithJavaUtilIterator:);
  methods[16].selector = @selector(concatWithComGoogleCommonIoCharSourceArray:);
  methods[17].selector = @selector(wrapWithJavaLangCharSequence:);
  methods[18].selector = @selector(empty);
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "asByteSource", "LJavaNioCharsetCharset;", "LJavaIoIOException;", "()Lcom/google/common/base/Optional<Ljava/lang/Long;>;", "countBySkipping", "LJavaIoReader;", "copyTo", "LJavaLangAppendable;", "LComGoogleCommonIoCharSink;", (void *)&ComGoogleCommonIoCharSource__Annotations$0, "()Lcom/google/common/collect/ImmutableList<Ljava/lang/String;>;", "readLines", "LComGoogleCommonIoLineProcessor;", "<T:Ljava/lang/Object;>(Lcom/google/common/io/LineProcessor<TT;>;)TT;", "concat", "LJavaLangIterable;", "(Ljava/lang/Iterable<+Lcom/google/common/io/CharSource;>;)Lcom/google/common/io/CharSource;", "LJavaUtilIterator;", "(Ljava/util/Iterator<+Lcom/google/common/io/CharSource;>;)Lcom/google/common/io/CharSource;", "[LComGoogleCommonIoCharSource;", "wrap", "LJavaLangCharSequence;", "LComGoogleCommonIoCharSource_AsByteSource;LComGoogleCommonIoCharSource_CharSequenceCharSource;LComGoogleCommonIoCharSource_EmptyCharSource;LComGoogleCommonIoCharSource_ConcatenatedCharSource;" };
  static const J2ObjcClassInfo _ComGoogleCommonIoCharSource = { "CharSource", "com.google.common.io", ptrTable, methods, NULL, 7, 0x401, 19, 0, -1, 22, -1, -1, -1 };
...
ComGoogleCommonIoCharSource *ComGoogleCommonIoCharSource_concatWithJavaLangIterable_(id<JavaLangIterable> sources) {
  ...
  return create_ComGoogleCommonIoCharSource_ConcatenatedCharSource_initWithJavaLangIterable_(sources);
}
...
ComGoogleCommonIoCharSource *ComGoogleCommonIoCharSource_wrapWithJavaLangCharSequence_(id<JavaLangCharSequence> charSequence) {
  ComGoogleCommonIoCharSource_initialize();
  return create_ComGoogleCommonIoCharSource_CharSequenceCharSource_initWithJavaLangCharSequence_(charSequence);
}
...
- (JavaIoInputStream *)openStream {
  return create_ComGoogleCommonIoReaderInputStream_initWithJavaIoReader_withJavaNioCharsetCharset_withInt_([this$0_ openStream], charset_, 8192);
}
...
void ComGoogleCommonIoCharSource_AsByteSource_initWithComGoogleCommonIoCharSource_withJavaNioCharsetCharset_(ComGoogleCommonIoCharSource_AsByteSource *self, ComGoogleCommonIoCharSource *outer$, JavaNioCharsetCharset *charset) {
  ...
  JreStrongAssign(&self->charset_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(charset));
}
...
- (JavaIoReader *)openStream {
  return create_ComGoogleCommonIoCharSequenceReader_initWithJavaLangCharSequence_(seq_);
}
...
- (jboolean)isEmpty {
  return [((id<JavaLangCharSequence>) nil_chk(seq_)) length] == 0;
}

- (jlong)length {
  return [((id<JavaLangCharSequence>) nil_chk(seq_)) length];
}

- (ComGoogleCommonBaseOptional *)lengthIfKnown {
  return ComGoogleCommonBaseOptional_ofWithId_(JavaLangLong_valueOfWithLong_((jlong) [((id<JavaLangCharSequence>) nil_chk(seq_)) length]));
}

- (id<JavaLangIterable>)lines {
  return ComGoogleCommonIoCharSource_CharSequenceCharSource_lines(self);
}

- (NSString *)readFirstLine {
  id<JavaUtilIterator> lines = [((id<JavaLangIterable>) nil_chk(ComGoogleCommonIoCharSource_CharSequenceCharSource_lines(self))) iterator];
  return [((id<JavaUtilIterator>) nil_chk(lines)) hasNext] ? [lines next] : nil;
}

- (ComGoogleCommonCollectImmutableList *)readLines {
  return ComGoogleCommonCollectImmutableList_copyOfWithJavaLangIterable_(ComGoogleCommonIoCharSource_CharSequenceCharSource_lines(self));
}

- (id)readLinesWithComGoogleCommonIoLineProcessor:(id<ComGoogleCommonIoLineProcessor>)processor {
  for (NSString * __strong line in nil_chk(ComGoogleCommonIoCharSource_CharSequenceCharSource_lines(self))) {
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LNSString;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LComGoogleCommonCollectImmutableList;", 0x1, -1, -1, -1, 3, -1, -1 },
  ...
  methods[6].selector = @selector(lines);
  methods[7].selector = @selector(readFirstLine);
  methods[8].selector = @selector(readLines);
  methods[9].selector = @selector(readLinesWithComGoogleCommonIoLineProcessor:);
  methods[10].selector = @selector(description);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "LINE_SPLITTER", "LComGoogleCommonBaseSplitter;", .constantValue.asLong = 0, 0x1a, -1, 9, -1, -1 },
  ...
  static const J2ObjcClassInfo _ComGoogleCommonIoCharSource_CharSequenceCharSource = { "CharSequenceCharSource", "com.google.common.io", ptrTable, methods, fields, 7, 0xa, 11, 2, 10, -1, -1, -1, -1 };
...
+ (void)initialize {
  if (self == [ComGoogleCommonIoCharSource_CharSequenceCharSource class]) {
    JreStrongAssign(&ComGoogleCommonIoCharSource_CharSequenceCharSource_LINE_SPLITTER, ComGoogleCommonBaseSplitter_onPatternWithNSString_(@"\x0d\n|\n|\x0d"));
...
void ComGoogleCommonIoCharSource_CharSequenceCharSource_initWithJavaLangCharSequence_(ComGoogleCommonIoCharSource_CharSequenceCharSource *self, id<JavaLangCharSequence> seq) {
  ComGoogleCommonIoCharSource_init(self);
  JreStrongAssign(&self->seq_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(seq));
}
...
id<JavaLangIterable> ComGoogleCommonIoCharSource_CharSequenceCharSource_lines(ComGoogleCommonIoCharSource_CharSequenceCharSource *self) {
  return create_ComGoogleCommonIoCharSource_CharSequenceCharSource_1_initWithComGoogleCommonIoCharSource_CharSequenceCharSource_(self);
}
...
- (id<JavaUtilIterator>)iterator {
  return create_ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1_initWithComGoogleCommonIoCharSource_CharSequenceCharSource_1_(self);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "this$0_", "LComGoogleCommonIoCharSource_CharSequenceCharSource;", .constantValue.asLong = 0, 0x1012, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "()Ljava/util/Iterator<Ljava/lang/String;>;", "LComGoogleCommonIoCharSource_CharSequenceCharSource;", "lines", "Ljava/lang/Object;Ljava/lang/Iterable<Ljava/lang/String;>;" };
  static const J2ObjcClassInfo _ComGoogleCommonIoCharSource_CharSequenceCharSource_1 = { "", "com.google.common.io", ptrTable, methods, fields, 7, 0x8008, 2, 1, 1, -1, 2, 3, -1 };
...
@implementation ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1

- (instancetype)initWithComGoogleCommonIoCharSource_CharSequenceCharSource_1:(ComGoogleCommonIoCharSource_CharSequenceCharSource_1 *)outer$ {
  ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1_initWithComGoogleCommonIoCharSource_CharSequenceCharSource_1_(self, outer$);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  methods[0].selector = @selector(initWithComGoogleCommonIoCharSource_CharSequenceCharSource_1:);
  methods[1].selector = @selector(computeNext);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "lines_", "LJavaUtilIterator;", .constantValue.asLong = 0, 0x0, -1, -1, 0, -1 },
  };
  static const void *ptrTable[] = { "Ljava/util/Iterator<Ljava/lang/String;>;", "LComGoogleCommonIoCharSource_CharSequenceCharSource_1;", "iterator", "Lcom/google/common/collect/AbstractIterator<Ljava/lang/String;>;" };
  static const J2ObjcClassInfo _ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1 = { "", "com.google.common.io", ptrTable, methods, fields, 7, 0x8008, 2, 1, 1, -1, 2, 3, -1 };
  return &_ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1;
}

@end

void ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1_initWithComGoogleCommonIoCharSource_CharSequenceCharSource_1_(ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1 *self, ComGoogleCommonIoCharSource_CharSequenceCharSource_1 *outer$) {
  ComGoogleCommonCollectAbstractIterator_init(self);
  JreStrongAssign(&self->lines_, [((id<JavaLangIterable>) nil_chk([((ComGoogleCommonBaseSplitter *) nil_chk(JreLoadStatic(ComGoogleCommonIoCharSource_CharSequenceCharSource, LINE_SPLITTER))) splitWithJavaLangCharSequence:outer$->this$0_->seq_])) iterator]);
}

ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1 *new_ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1_initWithComGoogleCommonIoCharSource_CharSequenceCharSource_1_(ComGoogleCommonIoCharSource_CharSequenceCharSource_1 *outer$) {
  J2OBJC_NEW_IMPL(ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1, initWithComGoogleCommonIoCharSource_CharSequenceCharSource_1_, outer$)
}

ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1 *create_ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1_initWithComGoogleCommonIoCharSource_CharSequenceCharSource_1_(ComGoogleCommonIoCharSource_CharSequenceCharSource_1 *outer$) {
  J2OBJC_CREATE_IMPL(ComGoogleCommonIoCharSource_CharSequenceCharSource_1_1, initWithComGoogleCommonIoCharSource_CharSequenceCharSource_1_, outer$)
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonIoCharSource_EmptyCharSource class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonIoCharSource_EmptyCharSource_INSTANCE, new_ComGoogleCommonIoCharSource_EmptyCharSource_init());
...
- (JavaIoReader *)openStream {
  return create_ComGoogleCommonIoMultiReader_initWithJavaUtilIterator_([((id<JavaLangIterable>) nil_chk(sources_)) iterator]);
}
...
void ComGoogleCommonIoCharSource_ConcatenatedCharSource_initWithJavaLangIterable_(ComGoogleCommonIoCharSource_ConcatenatedCharSource *self, id<JavaLangIterable> sources) {
  ComGoogleCommonIoCharSource_init(self);
  JreStrongAssign(&self->sources_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(sources));
}
