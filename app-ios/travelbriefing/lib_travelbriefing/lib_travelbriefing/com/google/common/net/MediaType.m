...
//  source: ../target/dependency/com/google/common/net/MediaType.java
//
...
- (ComGoogleCommonBaseOptional *)charset {
  ComGoogleCommonCollectImmutableSet *charsetValues = ComGoogleCommonCollectImmutableSet_copyOfWithJavaUtilCollection_([((ComGoogleCommonCollectImmutableListMultimap *) nil_chk(parameters_)) getWithId:ComGoogleCommonNetMediaType_CHARSET_ATTRIBUTE]);
  switch ([((ComGoogleCommonCollectImmutableSet *) nil_chk(charsetValues)) size]) {
    case 0:
    return ComGoogleCommonBaseOptional_absent();
    case 1:
    return ComGoogleCommonBaseOptional_ofWithId_(JavaNioCharsetCharset_forNameWithNSString_(ComGoogleCommonCollectIterables_getOnlyElementWithJavaLangIterable_(charsetValues)));
    default:
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@", @"Multiple charset values defined: ", charsetValues));
  }
}
...
- (ComGoogleCommonNetMediaType *)withParameterWithNSString:(NSString *)attribute
                                              withNSString:(NSString *)value {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(attribute);
  ...
  for (id<JavaUtilMap_Entry> __strong entry_ in nil_chk([((ComGoogleCommonCollectImmutableListMultimap *) nil_chk(parameters_)) entries])) {
    ...
    if (![((NSString *) nil_chk(normalizedAttribute)) isEqual:key]) {
      [((ComGoogleCommonCollectImmutableListMultimap_Builder *) nil_chk(builder)) putWithId:key withId:[entry_ getValue]];
    }
  }
  [((ComGoogleCommonCollectImmutableListMultimap_Builder *) nil_chk(builder)) putWithId:normalizedAttribute withId:ComGoogleCommonNetMediaType_normalizeParameterValueWithNSString_withNSString_(normalizedAttribute, value)];
  ComGoogleCommonNetMediaType *mediaType = create_ComGoogleCommonNetMediaType_initWithNSString_withNSString_withComGoogleCommonCollectImmutableListMultimap_(type_, subtype_, [builder build]);
...
- (ComGoogleCommonNetMediaType *)withCharsetWithJavaNioCharsetCharset:(JavaNioCharsetCharset *)charset {
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(charset);
  return [self withParameterWithNSString:ComGoogleCommonNetMediaType_CHARSET_ATTRIBUTE withNSString:[((JavaNioCharsetCharset *) nil_chk(charset)) name]];
}
...
- (NSUInteger)hash {
  jint h = hashCode_;
  if (h == 0) {
    h = ComGoogleCommonBaseObjects_hashCodeWithNSObjectArray_([IOSObjectArray arrayWithObjects:(id[]){ type_, subtype_, ComGoogleCommonNetMediaType_parametersAsMap(self) } count:3 type:NSObject_class_()]);
    hashCode_ = h;
  }
  return h;
}
...
- (NSString *)description {
  ...
  if (result == nil) {
    ...
    JreVolatileStrongAssign(&toString_, result);
  }
  return result;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "PARAMETER_JOINER", "LComGoogleCommonBaseJoiner_MapJoiner;", .constantValue.asLong = 0, 0x1a, -1, 147, -1, -1 },
  };
  static const void *ptrTable[] = { "createConstant", "LNSString;LNSString;", "createConstantUtf8", "addKnownType", "LComGoogleCommonNetMediaType;", "LNSString;LNSString;LComGoogleCommonCollectImmutableListMultimap;", "(Ljava/lang/String;Ljava/lang/String;Lcom/google/common/collect/ImmutableListMultimap<Ljava/lang/String;Ljava/lang/String;>;)V", "()Lcom/google/common/collect/ImmutableListMultimap<Ljava/lang/String;Ljava/lang/String;>;", "()Ljava/util/Map<Ljava/lang/String;Lcom/google/common/collect/ImmutableMultiset<Ljava/lang/String;>;>;", "()Lcom/google/common/base/Optional<Ljava/nio/charset/Charset;>;", "withParameters", "LComGoogleCommonCollectMultimap;", "(Lcom/google/common/collect/Multimap<Ljava/lang/String;Ljava/lang/String;>;)Lcom/google/common/net/MediaType;", "withParameter", "withCharset", "LJavaNioCharsetCharset;", "is", "create", "createApplicationType", "LNSString;", "createAudioType", "createImageType", "createTextType", "createVideoType", "LNSString;LNSString;LComGoogleCommonCollectMultimap;", "(Ljava/lang/String;Ljava/lang/String;Lcom/google/common/collect/Multimap<Ljava/lang/String;Ljava/lang/String;>;)Lcom/google/common/net/MediaType;", "normalizeToken", "normalizeParameterValue", "parse", "equals", "LNSObject;", (void *)&ComGoogleCommonNetMediaType__Annotations$0, "hashCode", "toString", "escapeAndQuote", &ComGoogleCommonNetMediaType_CHARSET_ATTRIBUTE, &ComGoogleCommonNetMediaType_UTF_8_CONSTANT_PARAMETERS, "Lcom/google/common/collect/ImmutableListMultimap<Ljava/lang/String;Ljava/lang/String;>;", &ComGoogleCommonNetMediaType_TOKEN_MATCHER, &ComGoogleCommonNetMediaType_QUOTED_TEXT_MATCHER, &ComGoogleCommonNetMediaType_LINEAR_WHITE_SPACE, &ComGoogleCommonNetMediaType_APPLICATION_TYPE, &ComGoogleCommonNetMediaType_AUDIO_TYPE, &ComGoogleCommonNetMediaType_IMAGE_TYPE, &ComGoogleCommonNetMediaType_TEXT_TYPE, &ComGoogleCommonNetMediaType_VIDEO_TYPE, &ComGoogleCommonNetMediaType_WILDCARD, &ComGoogleCommonNetMediaType_KNOWN_TYPES, "Ljava/util/Map<Lcom/google/common/net/MediaType;Lcom/google/common/net/MediaType;>;", &ComGoogleCommonNetMediaType_ANY_TYPE, &ComGoogleCommonNetMediaType_ANY_TEXT_TYPE, &ComGoogleCommonNetMediaType_ANY_IMAGE_TYPE, &ComGoogleCommonNetMediaType_ANY_AUDIO_TYPE, &ComGoogleCommonNetMediaType_ANY_VIDEO_TYPE, &ComGoogleCommonNetMediaType_ANY_APPLICATION_TYPE, &ComGoogleCommonNetMediaType_CACHE_MANIFEST_UTF_8, &ComGoogleCommonNetMediaType_CSS_UTF_8, &ComGoogleCommonNetMediaType_CSV_UTF_8, &ComGoogleCommonNetMediaType_HTML_UTF_8, &ComGoogleCommonNetMediaType_I_CALENDAR_UTF_8, &ComGoogleCommonNetMediaType_PLAIN_TEXT_UTF_8, &ComGoogleCommonNetMediaType_TEXT_JAVASCRIPT_UTF_8, &ComGoogleCommonNetMediaType_TSV_UTF_8, &ComGoogleCommonNetMediaType_VCARD_UTF_8, &ComGoogleCommonNetMediaType_WML_UTF_8, &ComGoogleCommonNetMediaType_XML_UTF_8, &ComGoogleCommonNetMediaType_VTT_UTF_8, &ComGoogleCommonNetMediaType_BMP, &ComGoogleCommonNetMediaType_CRW, &ComGoogleCommonNetMediaType_GIF, &ComGoogleCommonNetMediaType_ICO, &ComGoogleCommonNetMediaType_JPEG, &ComGoogleCommonNetMediaType_PNG, &ComGoogleCommonNetMediaType_PSD, &ComGoogleCommonNetMediaType_SVG_UTF_8, &ComGoogleCommonNetMediaType_TIFF, &ComGoogleCommonNetMediaType_WEBP, &ComGoogleCommonNetMediaType_MP4_AUDIO, &ComGoogleCommonNetMediaType_MPEG_AUDIO, &ComGoogleCommonNetMediaType_OGG_AUDIO, &ComGoogleCommonNetMediaType_WEBM_AUDIO, &ComGoogleCommonNetMediaType_L24_AUDIO, &ComGoogleCommonNetMediaType_BASIC_AUDIO, &ComGoogleCommonNetMediaType_AAC_AUDIO, &ComGoogleCommonNetMediaType_VORBIS_AUDIO, &ComGoogleCommonNetMediaType_WMA_AUDIO, &ComGoogleCommonNetMediaType_WAX_AUDIO, &ComGoogleCommonNetMediaType_VND_REAL_AUDIO, &ComGoogleCommonNetMediaType_VND_WAVE_AUDIO, &ComGoogleCommonNetMediaType_MP4_VIDEO, &ComGoogleCommonNetMediaType_MPEG_VIDEO, &ComGoogleCommonNetMediaType_OGG_VIDEO, &ComGoogleCommonNetMediaType_QUICKTIME, &ComGoogleCommonNetMediaType_WEBM_VIDEO, &ComGoogleCommonNetMediaType_WMV, &ComGoogleCommonNetMediaType_FLV_VIDEO, &ComGoogleCommonNetMediaType_THREE_GPP_VIDEO, &ComGoogleCommonNetMediaType_THREE_GPP2_VIDEO, &ComGoogleCommonNetMediaType_APPLICATION_XML_UTF_8, &ComGoogleCommonNetMediaType_ATOM_UTF_8, &ComGoogleCommonNetMediaType_BZIP2, &ComGoogleCommonNetMediaType_DART_UTF_8, &ComGoogleCommonNetMediaType_APPLE_PASSBOOK, &ComGoogleCommonNetMediaType_EOT, &ComGoogleCommonNetMediaType_EPUB, &ComGoogleCommonNetMediaType_FORM_DATA, &ComGoogleCommonNetMediaType_KEY_ARCHIVE, &ComGoogleCommonNetMediaType_APPLICATION_BINARY, &ComGoogleCommonNetMediaType_GZIP, &ComGoogleCommonNetMediaType_JAVASCRIPT_UTF_8, &ComGoogleCommonNetMediaType_JSON_UTF_8, &ComGoogleCommonNetMediaType_MANIFEST_JSON_UTF_8, &ComGoogleCommonNetMediaType_KML, &ComGoogleCommonNetMediaType_KMZ, &ComGoogleCommonNetMediaType_MBOX, &ComGoogleCommonNetMediaType_APPLE_MOBILE_CONFIG, &ComGoogleCommonNetMediaType_MICROSOFT_EXCEL, &ComGoogleCommonNetMediaType_MICROSOFT_POWERPOINT, &ComGoogleCommonNetMediaType_MICROSOFT_WORD, &ComGoogleCommonNetMediaType_NACL_APPLICATION, &ComGoogleCommonNetMediaType_NACL_PORTABLE_APPLICATION, &ComGoogleCommonNetMediaType_OCTET_STREAM, &ComGoogleCommonNetMediaType_OGG_CONTAINER, &ComGoogleCommonNetMediaType_OOXML_DOCUMENT, &ComGoogleCommonNetMediaType_OOXML_PRESENTATION, &ComGoogleCommonNetMediaType_OOXML_SHEET, &ComGoogleCommonNetMediaType_OPENDOCUMENT_GRAPHICS, &ComGoogleCommonNetMediaType_OPENDOCUMENT_PRESENTATION, &ComGoogleCommonNetMediaType_OPENDOCUMENT_SPREADSHEET, &ComGoogleCommonNetMediaType_OPENDOCUMENT_TEXT, &ComGoogleCommonNetMediaType_PDF, &ComGoogleCommonNetMediaType_POSTSCRIPT, &ComGoogleCommonNetMediaType_PROTOBUF, &ComGoogleCommonNetMediaType_RDF_XML_UTF_8, &ComGoogleCommonNetMediaType_RTF_UTF_8, &ComGoogleCommonNetMediaType_SFNT, &ComGoogleCommonNetMediaType_SHOCKWAVE_FLASH, &ComGoogleCommonNetMediaType_SKETCHUP, &ComGoogleCommonNetMediaType_SOAP_XML_UTF_8, &ComGoogleCommonNetMediaType_TAR, &ComGoogleCommonNetMediaType_WOFF, &ComGoogleCommonNetMediaType_WOFF2, &ComGoogleCommonNetMediaType_XHTML_UTF_8, &ComGoogleCommonNetMediaType_XRD_UTF_8, &ComGoogleCommonNetMediaType_ZIP, (void *)&ComGoogleCommonNetMediaType__Annotations$1, (void *)&ComGoogleCommonNetMediaType__Annotations$2, &ComGoogleCommonNetMediaType_PARAMETER_JOINER, "LComGoogleCommonNetMediaType_Tokenizer;" };
  static const J2ObjcClassInfo _ComGoogleCommonNetMediaType = { "MediaType", "com.google.common.net", ptrTable, methods, fields, 7, 0x11, 30, 114, -1, 148, -1, -1, -1 };
  return &_ComGoogleCommonNetMediaType;
}

+ (void)initialize {
  if (self == [ComGoogleCommonNetMediaType class]) {
    JreStrongAssign(&ComGoogleCommonNetMediaType_UTF_8_CONSTANT_PARAMETERS, ComGoogleCommonCollectImmutableListMultimap_ofWithId_withId_(ComGoogleCommonNetMediaType_CHARSET_ATTRIBUTE, ComGoogleCommonBaseAscii_toLowerCaseWithNSString_([((JavaNioCharsetCharset *) nil_chk(JreLoadStatic(ComGoogleCommonBaseCharsets, UTF_8))) name])));
    JreStrongAssign(&ComGoogleCommonNetMediaType_TOKEN_MATCHER, [((ComGoogleCommonBaseCharMatcher *) nil_chk([((ComGoogleCommonBaseCharMatcher *) nil_chk([((ComGoogleCommonBaseCharMatcher *) nil_chk(ComGoogleCommonBaseCharMatcher_ascii())) and__WithComGoogleCommonBaseCharMatcher:[((ComGoogleCommonBaseCharMatcher *) nil_chk(ComGoogleCommonBaseCharMatcher_javaIsoControl())) negate]])) and__WithComGoogleCommonBaseCharMatcher:ComGoogleCommonBaseCharMatcher_isNotWithChar_(' ')])) and__WithComGoogleCommonBaseCharMatcher:ComGoogleCommonBaseCharMatcher_noneOfWithJavaLangCharSequence_(@"()<>@,;:\\\"/[]?=")]);
    JreStrongAssign(&ComGoogleCommonNetMediaType_QUOTED_TEXT_MATCHER, [((ComGoogleCommonBaseCharMatcher *) nil_chk(ComGoogleCommonBaseCharMatcher_ascii())) and__WithComGoogleCommonBaseCharMatcher:ComGoogleCommonBaseCharMatcher_noneOfWithJavaLangCharSequence_(@"\"\\\x0d")]);
    JreStrongAssign(&ComGoogleCommonNetMediaType_LINEAR_WHITE_SPACE, ComGoogleCommonBaseCharMatcher_anyOfWithJavaLangCharSequence_(@" \t\x0d\n"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_KNOWN_TYPES, ComGoogleCommonCollectMaps_newHashMap());
    JreStrongAssign(&ComGoogleCommonNetMediaType_ANY_TYPE, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_WILDCARD, ComGoogleCommonNetMediaType_WILDCARD));
    JreStrongAssign(&ComGoogleCommonNetMediaType_ANY_TEXT_TYPE, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_TEXT_TYPE, ComGoogleCommonNetMediaType_WILDCARD));
    JreStrongAssign(&ComGoogleCommonNetMediaType_ANY_IMAGE_TYPE, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_IMAGE_TYPE, ComGoogleCommonNetMediaType_WILDCARD));
    JreStrongAssign(&ComGoogleCommonNetMediaType_ANY_AUDIO_TYPE, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_AUDIO_TYPE, ComGoogleCommonNetMediaType_WILDCARD));
    JreStrongAssign(&ComGoogleCommonNetMediaType_ANY_VIDEO_TYPE, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_VIDEO_TYPE, ComGoogleCommonNetMediaType_WILDCARD));
    JreStrongAssign(&ComGoogleCommonNetMediaType_ANY_APPLICATION_TYPE, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, ComGoogleCommonNetMediaType_WILDCARD));
    JreStrongAssign(&ComGoogleCommonNetMediaType_CACHE_MANIFEST_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_TEXT_TYPE, @"cache-manifest"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_CSS_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_TEXT_TYPE, @"css"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_CSV_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_TEXT_TYPE, @"csv"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_HTML_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_TEXT_TYPE, @"html"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_I_CALENDAR_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_TEXT_TYPE, @"calendar"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_PLAIN_TEXT_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_TEXT_TYPE, @"plain"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_TEXT_JAVASCRIPT_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_TEXT_TYPE, @"javascript"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_TSV_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_TEXT_TYPE, @"tab-separated-values"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_VCARD_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_TEXT_TYPE, @"vcard"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_WML_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_TEXT_TYPE, @"vnd.wap.wml"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_XML_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_TEXT_TYPE, @"xml"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_VTT_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_TEXT_TYPE, @"vtt"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_BMP, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_IMAGE_TYPE, @"bmp"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_CRW, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_IMAGE_TYPE, @"x-canon-crw"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_GIF, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_IMAGE_TYPE, @"gif"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_ICO, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_IMAGE_TYPE, @"vnd.microsoft.icon"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_JPEG, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_IMAGE_TYPE, @"jpeg"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_PNG, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_IMAGE_TYPE, @"png"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_PSD, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_IMAGE_TYPE, @"vnd.adobe.photoshop"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_SVG_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_IMAGE_TYPE, @"svg+xml"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_TIFF, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_IMAGE_TYPE, @"tiff"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_WEBP, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_IMAGE_TYPE, @"webp"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_MP4_AUDIO, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_AUDIO_TYPE, @"mp4"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_MPEG_AUDIO, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_AUDIO_TYPE, @"mpeg"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_OGG_AUDIO, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_AUDIO_TYPE, @"ogg"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_WEBM_AUDIO, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_AUDIO_TYPE, @"webm"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_L24_AUDIO, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_AUDIO_TYPE, @"l24"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_BASIC_AUDIO, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_AUDIO_TYPE, @"basic"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_AAC_AUDIO, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_AUDIO_TYPE, @"aac"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_VORBIS_AUDIO, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_AUDIO_TYPE, @"vorbis"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_WMA_AUDIO, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_AUDIO_TYPE, @"x-ms-wma"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_WAX_AUDIO, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_AUDIO_TYPE, @"x-ms-wax"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_VND_REAL_AUDIO, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_AUDIO_TYPE, @"vnd.rn-realaudio"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_VND_WAVE_AUDIO, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_AUDIO_TYPE, @"vnd.wave"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_MP4_VIDEO, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_VIDEO_TYPE, @"mp4"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_MPEG_VIDEO, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_VIDEO_TYPE, @"mpeg"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_OGG_VIDEO, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_VIDEO_TYPE, @"ogg"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_QUICKTIME, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_VIDEO_TYPE, @"quicktime"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_WEBM_VIDEO, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_VIDEO_TYPE, @"webm"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_WMV, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_VIDEO_TYPE, @"x-ms-wmv"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_FLV_VIDEO, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_VIDEO_TYPE, @"x-flv"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_THREE_GPP_VIDEO, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_VIDEO_TYPE, @"3gpp"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_THREE_GPP2_VIDEO, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_VIDEO_TYPE, @"3gpp2"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_APPLICATION_XML_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"xml"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_ATOM_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"atom+xml"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_BZIP2, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"x-bzip2"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_DART_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"dart"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_APPLE_PASSBOOK, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"vnd.apple.pkpass"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_EOT, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"vnd.ms-fontobject"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_EPUB, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"epub+zip"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_FORM_DATA, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"x-www-form-urlencoded"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_KEY_ARCHIVE, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"pkcs12"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_APPLICATION_BINARY, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"binary"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_GZIP, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"x-gzip"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_JAVASCRIPT_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"javascript"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_JSON_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"json"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_MANIFEST_JSON_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"manifest+json"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_KML, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"vnd.google-earth.kml+xml"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_KMZ, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"vnd.google-earth.kmz"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_MBOX, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"mbox"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_APPLE_MOBILE_CONFIG, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"x-apple-aspen-config"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_MICROSOFT_EXCEL, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"vnd.ms-excel"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_MICROSOFT_POWERPOINT, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"vnd.ms-powerpoint"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_MICROSOFT_WORD, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"msword"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_NACL_APPLICATION, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"x-nacl"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_NACL_PORTABLE_APPLICATION, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"x-pnacl"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_OCTET_STREAM, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"octet-stream"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_OGG_CONTAINER, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"ogg"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_OOXML_DOCUMENT, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"vnd.openxmlformats-officedocument.wordprocessingml.document"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_OOXML_PRESENTATION, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"vnd.openxmlformats-officedocument.presentationml.presentation"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_OOXML_SHEET, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"vnd.openxmlformats-officedocument.spreadsheetml.sheet"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_OPENDOCUMENT_GRAPHICS, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"vnd.oasis.opendocument.graphics"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_OPENDOCUMENT_PRESENTATION, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"vnd.oasis.opendocument.presentation"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_OPENDOCUMENT_SPREADSHEET, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"vnd.oasis.opendocument.spreadsheet"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_OPENDOCUMENT_TEXT, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"vnd.oasis.opendocument.text"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_PDF, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"pdf"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_POSTSCRIPT, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"postscript"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_PROTOBUF, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"protobuf"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_RDF_XML_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"rdf+xml"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_RTF_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"rtf"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_SFNT, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"font-sfnt"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_SHOCKWAVE_FLASH, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"x-shockwave-flash"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_SKETCHUP, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"vnd.sketchup.skp"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_SOAP_XML_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"soap+xml"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_TAR, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"x-tar"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_WOFF, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"font-woff"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_WOFF2, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"font-woff2"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_XHTML_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"xhtml+xml"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_XRD_UTF_8, ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"xrd+xml"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_ZIP, ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(ComGoogleCommonNetMediaType_APPLICATION_TYPE, @"zip"));
    JreStrongAssign(&ComGoogleCommonNetMediaType_PARAMETER_JOINER, [((ComGoogleCommonBaseJoiner *) nil_chk(ComGoogleCommonBaseJoiner_onWithNSString_(@"; "))) withKeyValueSeparatorWithNSString:@"="]);
...
ComGoogleCommonNetMediaType *ComGoogleCommonNetMediaType_createConstantWithNSString_withNSString_(NSString *type, NSString *subtype) {
  ...
  return ComGoogleCommonNetMediaType_addKnownTypeWithComGoogleCommonNetMediaType_(create_ComGoogleCommonNetMediaType_initWithNSString_withNSString_withComGoogleCommonCollectImmutableListMultimap_(type, subtype, ComGoogleCommonCollectImmutableListMultimap_of()));
}
...
ComGoogleCommonNetMediaType *ComGoogleCommonNetMediaType_createConstantUtf8WithNSString_withNSString_(NSString *type, NSString *subtype) {
  ComGoogleCommonNetMediaType_initialize();
  return ComGoogleCommonNetMediaType_addKnownTypeWithComGoogleCommonNetMediaType_(create_ComGoogleCommonNetMediaType_initWithNSString_withNSString_withComGoogleCommonCollectImmutableListMultimap_(type, subtype, ComGoogleCommonNetMediaType_UTF_8_CONSTANT_PARAMETERS));
}
...
ComGoogleCommonNetMediaType *ComGoogleCommonNetMediaType_addKnownTypeWithComGoogleCommonNetMediaType_(ComGoogleCommonNetMediaType *mediaType) {
  ComGoogleCommonNetMediaType_initialize();
  [((id<JavaUtilMap>) nil_chk(ComGoogleCommonNetMediaType_KNOWN_TYPES)) putWithId:mediaType withId:mediaType];
  return mediaType;
}
...
id<JavaUtilMap> ComGoogleCommonNetMediaType_parametersAsMap(ComGoogleCommonNetMediaType *self) {
  return ComGoogleCommonCollectMaps_transformValuesWithJavaUtilMap_withComGoogleCommonBaseFunction_([((ComGoogleCommonCollectImmutableListMultimap *) nil_chk(self->parameters_)) asMap], create_ComGoogleCommonNetMediaType_1_init());
}

ComGoogleCommonNetMediaType *ComGoogleCommonNetMediaType_createWithNSString_withNSString_(NSString *type, NSString *subtype) {
  ComGoogleCommonNetMediaType_initialize();
  return ComGoogleCommonNetMediaType_createWithNSString_withNSString_withComGoogleCommonCollectMultimap_(type, subtype, ComGoogleCommonCollectImmutableListMultimap_of());
}
...
ComGoogleCommonNetMediaType *ComGoogleCommonNetMediaType_createWithNSString_withNSString_withComGoogleCommonCollectMultimap_(NSString *type, NSString *subtype, id<ComGoogleCommonCollectMultimap> parameters) {
  ComGoogleCommonNetMediaType_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(type);
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(subtype);
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(parameters);
  ...
  for (id<JavaUtilMap_Entry> __strong entry_ in nil_chk([((id<ComGoogleCommonCollectMultimap>) nil_chk(parameters)) entries])) {
    ...
    [((ComGoogleCommonCollectImmutableListMultimap_Builder *) nil_chk(builder)) putWithId:attribute withId:ComGoogleCommonNetMediaType_normalizeParameterValueWithNSString_withNSString_(attribute, [entry_ getValue])];
  }
  ComGoogleCommonNetMediaType *mediaType = create_ComGoogleCommonNetMediaType_initWithNSString_withNSString_withComGoogleCommonCollectImmutableListMultimap_(normalizedType, normalizedSubtype, [((ComGoogleCommonCollectImmutableListMultimap_Builder *) nil_chk(builder)) build]);
  return ComGoogleCommonBaseMoreObjects_firstNonNullWithId_withId_([((id<JavaUtilMap>) nil_chk(ComGoogleCommonNetMediaType_KNOWN_TYPES)) getWithId:mediaType], mediaType);
}
...
ComGoogleCommonNetMediaType *ComGoogleCommonNetMediaType_parseWithNSString_(NSString *input) {
  ...
  ComGoogleCommonNetMediaType_Tokenizer *tokenizer = create_ComGoogleCommonNetMediaType_Tokenizer_initWithNSString_(input);
  @try {
    ...
    while ([tokenizer hasMore]) {
      [tokenizer consumeTokenIfPresentWithComGoogleCommonBaseCharMatcher:ComGoogleCommonNetMediaType_LINEAR_WHITE_SPACE];
      [tokenizer consumeCharacterWithChar:';'];
      [tokenizer consumeTokenIfPresentWithComGoogleCommonBaseCharMatcher:ComGoogleCommonNetMediaType_LINEAR_WHITE_SPACE];
      ...
      if ('"' == [tokenizer previewChar]) {
        [tokenizer consumeCharacterWithChar:'"'];
        JavaLangStringBuilder *valueBuilder = create_JavaLangStringBuilder_init();
        while ('"' != [tokenizer previewChar]) {
          if ('\\' == [tokenizer previewChar]) {
            [tokenizer consumeCharacterWithChar:'\\'];
            [valueBuilder appendWithChar:[tokenizer consumeCharacterWithComGoogleCommonBaseCharMatcher:ComGoogleCommonBaseCharMatcher_ascii()]];
          }
          else {
            [valueBuilder appendWithNSString:[tokenizer consumeTokenWithComGoogleCommonBaseCharMatcher:ComGoogleCommonNetMediaType_QUOTED_TEXT_MATCHER]];
          }
        }
      ...
      [((ComGoogleCommonCollectImmutableListMultimap_Builder *) nil_chk(parameters)) putWithId:attribute withId:value];
    }
  ...
  @catch (JavaLangIllegalStateException *e) {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_withNSException_(JreStrcat("$$C", @"Could not parse '", input, '\''), e);
  }
}

NSString *ComGoogleCommonNetMediaType_computeToString(ComGoogleCommonNetMediaType *self) {
  JavaLangStringBuilder *builder = [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk([create_JavaLangStringBuilder_init() appendWithNSString:self->type_])) appendWithChar:'/'])) appendWithNSString:self->subtype_];
  if (![((ComGoogleCommonCollectImmutableListMultimap *) nil_chk(self->parameters_)) isEmpty]) {
    ...
    id<ComGoogleCommonCollectMultimap> quotedParameters = ComGoogleCommonCollectMultimaps_transformValuesWithComGoogleCommonCollectListMultimap_withComGoogleCommonBaseFunction_(self->parameters_, create_ComGoogleCommonNetMediaType_2_init());
    [((ComGoogleCommonBaseJoiner_MapJoiner *) nil_chk(ComGoogleCommonNetMediaType_PARAMETER_JOINER)) appendToWithJavaLangStringBuilder:builder withJavaLangIterable:[((id<ComGoogleCommonCollectMultimap>) nil_chk(quotedParameters)) entries]];
  }
...
NSString *ComGoogleCommonNetMediaType_escapeAndQuoteWithNSString_(NSString *value) {
  ComGoogleCommonNetMediaType_initialize();
  JavaLangStringBuilder *escaped = [create_JavaLangStringBuilder_initWithInt_(((jint) [((NSString *) nil_chk(value)) length]) + 16) appendWithChar:'"'];
  for (jint i = 0; i < ((jint) [value length]); i++) {
    jchar ch = [value charAtWithInt:i];
    if (ch == 0x000d || ch == '\\' || ch == '"') {
      [((JavaLangStringBuilder *) nil_chk(escaped)) appendWithChar:'\\'];
    }
    [((JavaLangStringBuilder *) nil_chk(escaped)) appendWithChar:ch];
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonNetMediaType_1 = { "", "com.google.common.net", ptrTable, methods, NULL, 7, 0x8008, 2, 0, 3, -1, 4, 5, -1 };
...
- (jboolean)hasMore {
  return (position_ >= 0) && (position_ < ((jint) [((NSString *) nil_chk(input_)) length]));
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonNetMediaType_2 = { "", "com.google.common.net", ptrTable, methods, NULL, 7, 0x8008, 2, 0, 2, -1, 3, 4, -1 };
