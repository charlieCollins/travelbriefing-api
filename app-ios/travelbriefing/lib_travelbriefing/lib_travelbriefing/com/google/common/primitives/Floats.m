...
//  source: ../target/dependency/com/google/common/primitives/Floats.java
//
...
IOSFloatArray *ComGoogleCommonPrimitivesFloats_concatWithFloatArray2_(IOSObjectArray *arrays) {
  ...
  IOSFloatArray *result = [IOSFloatArray arrayWithLength:length];
  jint pos = 0;
  {
    IOSObjectArray *a__ = arrays;
    IOSFloatArray * const *b__ = ((IOSObjectArray *) nil_chk(a__))->buffer_;
...
NSString *ComGoogleCommonPrimitivesFloats_joinWithNSString_withFloatArray_(NSString *separator, IOSFloatArray *array) {
  ...
  [builder appendWithFloat:IOSFloatArray_Get(array, 0)];
  for (jint i = 1; i < array->size_; i++) {
    [((JavaLangStringBuilder *) nil_chk([builder appendWithNSString:separator])) appendWithFloat:IOSFloatArray_Get(array, i)];
  }
...
IOSFloatArray *ComGoogleCommonPrimitivesFloats_toArrayWithJavaUtilCollection_(id<JavaUtilCollection> collection) {
  ...
  IOSFloatArray *array = [IOSFloatArray arrayWithLength:len];
...
id<JavaUtilList> ComGoogleCommonPrimitivesFloats_asListWithFloatArray_(IOSFloatArray *backingArray) {
  ...
  return create_ComGoogleCommonPrimitivesFloats_FloatArrayAsList_initWithFloatArray_(backingArray);
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonPrimitivesFloats_FloatConverter class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonPrimitivesFloats_FloatConverter_INSTANCE, new_ComGoogleCommonPrimitivesFloats_FloatConverter_init());
...
+ (void)initialize {
  if (self == [ComGoogleCommonPrimitivesFloats_LexicographicalComparator class]) {
    ...
    for (jint i = 0; i < 1; i++) {
      (ComGoogleCommonPrimitivesFloats_LexicographicalComparator_values_[i] = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
      ComGoogleCommonPrimitivesFloats_LexicographicalComparator_initWithNSString_withInt_(e, names[i], i);
    }
...
- (id<JavaUtilList>)subListWithInt:(jint)fromIndex
  ...
  return create_ComGoogleCommonPrimitivesFloats_FloatArrayAsList_initWithFloatArray_withInt_withInt_(array_, start_ + fromIndex, start_ + toIndex);
}
...
- (NSString *)description {
  ...
  [((JavaLangStringBuilder *) nil_chk([builder appendWithChar:'['])) appendWithFloat:IOSFloatArray_Get(nil_chk(array_), start_)];
  for (jint i = start_ + 1; i < end_; i++) {
    [((JavaLangStringBuilder *) nil_chk([builder appendWithNSString:@", "])) appendWithFloat:IOSFloatArray_Get(array_, i)];
  }
