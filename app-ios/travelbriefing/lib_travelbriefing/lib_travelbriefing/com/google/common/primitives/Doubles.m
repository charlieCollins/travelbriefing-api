...
//  source: ../target/dependency/com/google/common/primitives/Doubles.java
//
...
+ (void)initialize {
  if (self == [ComGoogleCommonPrimitivesDoubles class]) {
    JreStrongAssign(&ComGoogleCommonPrimitivesDoubles_FLOATING_POINT_PATTERN, ComGoogleCommonPrimitivesDoubles_fpPattern());
...
IOSDoubleArray *ComGoogleCommonPrimitivesDoubles_concatWithDoubleArray2_(IOSObjectArray *arrays) {
  ...
  IOSDoubleArray *result = [IOSDoubleArray arrayWithLength:length];
  jint pos = 0;
  {
    IOSObjectArray *a__ = arrays;
    IOSDoubleArray * const *b__ = ((IOSObjectArray *) nil_chk(a__))->buffer_;
...
NSString *ComGoogleCommonPrimitivesDoubles_joinWithNSString_withDoubleArray_(NSString *separator, IOSDoubleArray *array) {
  ...
  JavaLangStringBuilder *builder = create_JavaLangStringBuilder_initWithInt_(array->size_ * 12);
  [builder appendWithDouble:IOSDoubleArray_Get(array, 0)];
  for (jint i = 1; i < array->size_; i++) {
    [((JavaLangStringBuilder *) nil_chk([builder appendWithNSString:separator])) appendWithDouble:IOSDoubleArray_Get(array, i)];
  }
...
IOSDoubleArray *ComGoogleCommonPrimitivesDoubles_toArrayWithJavaUtilCollection_(id<JavaUtilCollection> collection) {
  ...
  IOSDoubleArray *array = [IOSDoubleArray arrayWithLength:len];
...
id<JavaUtilList> ComGoogleCommonPrimitivesDoubles_asListWithDoubleArray_(IOSDoubleArray *backingArray) {
  ...
  return create_ComGoogleCommonPrimitivesDoubles_DoubleArrayAsList_initWithDoubleArray_(backingArray);
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonPrimitivesDoubles_DoubleConverter class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonPrimitivesDoubles_DoubleConverter_INSTANCE, new_ComGoogleCommonPrimitivesDoubles_DoubleConverter_init());
...
+ (void)initialize {
  if (self == [ComGoogleCommonPrimitivesDoubles_LexicographicalComparator class]) {
    ...
    for (jint i = 0; i < 1; i++) {
      (ComGoogleCommonPrimitivesDoubles_LexicographicalComparator_values_[i] = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
      ComGoogleCommonPrimitivesDoubles_LexicographicalComparator_initWithNSString_withInt_(e, names[i], i);
    }
...
- (id<JavaUtilList>)subListWithInt:(jint)fromIndex
  ...
  return create_ComGoogleCommonPrimitivesDoubles_DoubleArrayAsList_initWithDoubleArray_withInt_withInt_(array_, start_ + fromIndex, start_ + toIndex);
}
...
- (NSString *)description {
  JavaLangStringBuilder *builder = create_JavaLangStringBuilder_initWithInt_([self size] * 12);
  [((JavaLangStringBuilder *) nil_chk([builder appendWithChar:'['])) appendWithDouble:IOSDoubleArray_Get(nil_chk(array_), start_)];
  for (jint i = start_ + 1; i < end_; i++) {
    [((JavaLangStringBuilder *) nil_chk([builder appendWithNSString:@", "])) appendWithDouble:IOSDoubleArray_Get(array_, i)];
  }
