...
//  source: ../target/dependency/com/google/common/primitives/Booleans.java
//
...
IOSBooleanArray *ComGoogleCommonPrimitivesBooleans_concatWithBooleanArray2_(IOSObjectArray *arrays) {
  ...
  IOSBooleanArray *result = [IOSBooleanArray arrayWithLength:length];
  jint pos = 0;
  {
    IOSObjectArray *a__ = arrays;
    IOSBooleanArray * const *b__ = ((IOSObjectArray *) nil_chk(a__))->buffer_;
...
NSString *ComGoogleCommonPrimitivesBooleans_joinWithNSString_withBooleanArray_(NSString *separator, IOSBooleanArray *array) {
  ...
  JavaLangStringBuilder *builder = create_JavaLangStringBuilder_initWithInt_(array->size_ * 7);
  [builder appendWithBoolean:IOSBooleanArray_Get(array, 0)];
  for (jint i = 1; i < array->size_; i++) {
    [((JavaLangStringBuilder *) nil_chk([builder appendWithNSString:separator])) appendWithBoolean:IOSBooleanArray_Get(array, i)];
  }
...
IOSBooleanArray *ComGoogleCommonPrimitivesBooleans_toArrayWithJavaUtilCollection_(id<JavaUtilCollection> collection) {
  ...
  IOSBooleanArray *array = [IOSBooleanArray arrayWithLength:len];
...
id<JavaUtilList> ComGoogleCommonPrimitivesBooleans_asListWithBooleanArray_(IOSBooleanArray *backingArray) {
  ...
  return create_ComGoogleCommonPrimitivesBooleans_BooleanArrayAsList_initWithBooleanArray_(backingArray);
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonPrimitivesBooleans_BooleanComparator class]) {
    ...
    id e;
    (JreEnum(ComGoogleCommonPrimitivesBooleans_BooleanComparator, TRUE_FIRST) = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
    ComGoogleCommonPrimitivesBooleans_BooleanComparator_initWithInt_withNSString_withNSString_withInt_(e, 1, @"Booleans.trueFirst()", @"TRUE_FIRST", 0);
    (JreEnum(ComGoogleCommonPrimitivesBooleans_BooleanComparator, FALSE_FIRST) = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
    ComGoogleCommonPrimitivesBooleans_BooleanComparator_initWithInt_withNSString_withNSString_withInt_(e, -1, @"Booleans.falseFirst()", @"FALSE_FIRST", 1);
...
+ (void)initialize {
  if (self == [ComGoogleCommonPrimitivesBooleans_LexicographicalComparator class]) {
    ...
    for (jint i = 0; i < 1; i++) {
      (ComGoogleCommonPrimitivesBooleans_LexicographicalComparator_values_[i] = e = objc_constructInstance(self, (void *)ptr), ptr += objSize);
      ComGoogleCommonPrimitivesBooleans_LexicographicalComparator_initWithNSString_withInt_(e, names[i], i);
    }
...
- (id<JavaUtilList>)subListWithInt:(jint)fromIndex
  ...
  return create_ComGoogleCommonPrimitivesBooleans_BooleanArrayAsList_initWithBooleanArray_withInt_withInt_(array_, start_ + fromIndex, start_ + toIndex);
}
...
- (NSString *)description {
  JavaLangStringBuilder *builder = create_JavaLangStringBuilder_initWithInt_([self size] * 7);
  [builder appendWithNSString:IOSBooleanArray_Get(nil_chk(array_), start_) ? @"[true" : @"[false"];
  for (jint i = start_ + 1; i < end_; i++) {
    [builder appendWithNSString:IOSBooleanArray_Get(array_, i) ? @", true" : @", false"];
  }
