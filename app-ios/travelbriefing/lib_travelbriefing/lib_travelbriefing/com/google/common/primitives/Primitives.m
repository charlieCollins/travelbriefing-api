  ...
  if (self == [ComGoogleCommonPrimitivesPrimitives class]) {
    {
      ...
      JreStrongAssign(&ComGoogleCommonPrimitivesPrimitives_PRIMITIVE_TO_WRAPPER_TYPE, JavaUtilCollections_unmodifiableMapWithJavaUtilMap_(primToWrap));
      JreStrongAssign(&ComGoogleCommonPrimitivesPrimitives_WRAPPER_TO_PRIMITIVE_TYPE, JavaUtilCollections_unmodifiableMapWithJavaUtilMap_(wrapToPrim));
    }
