...
//  source: ../target/dependency/com/google/common/eventbus/SubscriberRegistry.java
//
...
- (void)register__WithId:(id)listener {
  ...
  for (id<JavaUtilMap_Entry> __strong entry_ in nil_chk([((id<JavaUtilMap>) nil_chk([((id<ComGoogleCommonCollectMultimap>) nil_chk(listenerMethods)) asMap])) entrySet])) {
    ...
    if (eventSubscribers == nil) {
      JavaUtilConcurrentCopyOnWriteArraySet *newSet = create_JavaUtilConcurrentCopyOnWriteArraySet_init();
...
- (void)unregisterWithId:(id)listener {
  ...
  for (id<JavaUtilMap_Entry> __strong entry_ in nil_chk([((id<JavaUtilMap>) nil_chk([((id<ComGoogleCommonCollectMultimap>) nil_chk(listenerMethods)) asMap])) entrySet])) {
    ...
    if (currentSubscribers == nil || ![currentSubscribers removeAllWithJavaUtilCollection:listenerMethodsForType]) {
      @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@$", @"missing event subscriber for an annotated method. Is ", listener, @" registered?"));
    }
  }
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonEventbusSubscriberRegistry class]) {
    JreStrongAssign(&ComGoogleCommonEventbusSubscriberRegistry_subscriberMethodsCache, [((ComGoogleCommonCacheCacheBuilder *) nil_chk([((ComGoogleCommonCacheCacheBuilder *) nil_chk(ComGoogleCommonCacheCacheBuilder_newBuilder())) weakKeys])) buildWithComGoogleCommonCacheCacheLoader:create_ComGoogleCommonEventbusSubscriberRegistry_1_init()]);
    JreStrongAssign(&ComGoogleCommonEventbusSubscriberRegistry_flattenHierarchyCache, [((ComGoogleCommonCacheCacheBuilder *) nil_chk([((ComGoogleCommonCacheCacheBuilder *) nil_chk(ComGoogleCommonCacheCacheBuilder_newBuilder())) weakKeys])) buildWithComGoogleCommonCacheCacheLoader:create_ComGoogleCommonEventbusSubscriberRegistry_2_init()]);
...
void ComGoogleCommonEventbusSubscriberRegistry_initWithComGoogleCommonEventbusEventBus_(ComGoogleCommonEventbusSubscriberRegistry *self, ComGoogleCommonEventbusEventBus *bus) {
  NSObject_init(self);
  JreStrongAssign(&self->subscribers_, ComGoogleCommonCollectMaps_newConcurrentMap());
  ...
  for (IOSClass * __strong supertype in nil_chk(supertypes)) {
    {
      ...
      while (b__ < e__) {
        ...
        if ([((JavaLangReflectMethod *) nil_chk(method)) isAnnotationPresentWithIOSClass:ComGoogleCommonEventbusSubscribe_class_()] && ![method isSynthetic]) {
          ...
          ComGoogleCommonEventbusSubscriberRegistry_MethodIdentifier *ident = create_ComGoogleCommonEventbusSubscriberRegistry_MethodIdentifier_initWithJavaLangReflectMethod_(method);
          if (![((id<JavaUtilMap>) nil_chk(identifiers)) containsKeyWithId:ident]) {
            [identifiers putWithId:ident withId:method];
          }
        }
      }
    }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonEventbusSubscriberRegistry_1 = { "", "com.google.common.eventbus", ptrTable, methods, NULL, 7, 0x8008, 2, 0, 4, -1, -1, 5, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonEventbusSubscriberRegistry_2 = { "", "com.google.common.eventbus", ptrTable, methods, NULL, 7, 0x8008, 2, 0, 3, -1, -1, 4, -1 };
...
- (NSUInteger)hash {
  return ComGoogleCommonBaseObjects_hashCodeWithNSObjectArray_([IOSObjectArray arrayWithObjects:(id[]){ name_, parameterTypes_ } count:2 type:NSObject_class_()]);
}
...
void ComGoogleCommonEventbusSubscriberRegistry_MethodIdentifier_initWithJavaLangReflectMethod_(ComGoogleCommonEventbusSubscriberRegistry_MethodIdentifier *self, JavaLangReflectMethod *method) {
  NSObject_init(self);
  JreStrongAssign(&self->name_, [((JavaLangReflectMethod *) nil_chk(method)) getName]);
  JreStrongAssign(&self->parameterTypes_, JavaUtilArrays_asListWithNSObjectArray_([method getParameterTypes]));
}
