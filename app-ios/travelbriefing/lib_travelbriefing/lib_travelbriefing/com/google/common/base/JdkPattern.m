...
//  source: ../target/dependency/com/google/common/base/JdkPattern.java
//
...
- (ComGoogleCommonBaseCommonMatcher *)matcherWithJavaLangCharSequence:(id<JavaLangCharSequence>)t {
  return create_ComGoogleCommonBaseJdkPattern_JdkMatcher_initWithJavaUtilRegexMatcher_([((JavaUtilRegexPattern *) nil_chk(pattern_)) matcherWithJavaLangCharSequence:t]);
}
...
void ComGoogleCommonBaseJdkPattern_JdkMatcher_initWithJavaUtilRegexMatcher_(ComGoogleCommonBaseJdkPattern_JdkMatcher *self, JavaUtilRegexMatcher *matcher) {
  ...
  JreStrongAssign(&self->matcher_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(matcher));
}
