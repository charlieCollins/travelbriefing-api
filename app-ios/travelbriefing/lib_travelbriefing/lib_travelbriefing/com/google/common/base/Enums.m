...
//  source: ../target/dependency/com/google/common/base/Enums.java
//
...
+ (void)initialize {
  if (self == [ComGoogleCommonBaseEnums class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonBaseEnums_enumConstantCache, new_JavaUtilWeakHashMap_init());
...
id<JavaUtilMap> ComGoogleCommonBaseEnums_populateCacheWithIOSClass_(IOSClass *enumClass) {
  ...
  for (JavaLangEnum * __strong enumInstance in nil_chk(JavaUtilEnumSet_allOfWithIOSClass_(enumClass))) {
    [result putWithId:[((JavaLangEnum *) nil_chk(enumInstance)) name] withId:create_JavaLangRefWeakReference_initWithId_(enumInstance)];
  }
  [((id<JavaUtilMap>) nil_chk(ComGoogleCommonBaseEnums_enumConstantCache)) putWithId:enumClass withId:result];
  return result;
}
...
ComGoogleCommonBaseConverter *ComGoogleCommonBaseEnums_stringConverterWithIOSClass_(IOSClass *enumClass) {
  ComGoogleCommonBaseEnums_initialize();
  return create_ComGoogleCommonBaseEnums_StringConverter_initWithIOSClass_(enumClass);
}
...
void ComGoogleCommonBaseEnums_StringConverter_initWithIOSClass_(ComGoogleCommonBaseEnums_StringConverter *self, IOSClass *enumClass) {
  ...
  JreStrongAssign(&self->enumClass_, ComGoogleCommonBasePreconditions_checkNotNullWithId_(enumClass));
}
