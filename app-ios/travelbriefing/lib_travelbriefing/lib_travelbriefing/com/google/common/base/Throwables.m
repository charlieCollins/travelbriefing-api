...
//  source: ../target/dependency/com/google/common/base/Throwables.java
//
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LNSString;", 0x9, 21, 2, -1, -1, -1, -1 },
    { NULL, "LJavaUtilList;", 0x9, 22, 2, -1, 23, -1, -1 },
    { NULL, "Z", 0x9, -1, -1, -1, -1, -1, -1 },
    { NULL, "LJavaUtilList;", 0xa, 24, 2, -1, 23, -1, -1 },
    { NULL, "LNSObject;", 0x8a, 25, 26, -1, -1, -1, -1 },
    { NULL, "LNSObject;", 0xa, -1, -1, -1, -1, 27, -1 },
    { NULL, "LJavaLangReflectMethod;", 0xa, -1, -1, -1, -1, 28, -1 },
    { NULL, "LJavaLangReflectMethod;", 0xa, -1, -1, -1, -1, 29, -1 },
    { NULL, "LJavaLangReflectMethod;", 0x8a, 30, 31, 32, 33, 34, -1 },
  };
  ...
  methods[10].selector = @selector(getStackTraceAsStringWithNSException:);
  methods[11].selector = @selector(lazyStackTraceWithNSException:);
  methods[12].selector = @selector(lazyStackTraceIsLazy);
  methods[13].selector = @selector(jlaStackTraceWithNSException:);
  methods[14].selector = @selector(invokeAccessibleNonThrowingMethodWithJavaLangReflectMethod:withId:withNSObjectArray:);
  methods[15].selector = @selector(getJLA);
  methods[16].selector = @selector(getGetMethod);
  methods[17].selector = @selector(getSizeMethod);
  methods[18].selector = @selector(getJlaMethodWithNSString:withIOSClassArray:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "JAVA_LANG_ACCESS_CLASSNAME", "LNSString;", .constantValue.asLong = 0, 0x1a, -1, 35, -1, -1 },
    { "SHARED_SECRETS_CLASSNAME", "LNSString;", .constantValue.asLong = 0, 0x18, -1, 36, -1, -1 },
    { "jla", "LNSObject;", .constantValue.asLong = 0, 0x1a, -1, 37, -1, 38 },
    { "getStackTraceElementMethod", "LJavaLangReflectMethod;", .constantValue.asLong = 0, 0x1a, -1, 39, -1, 40 },
    { "getStackTraceDepthMethod", "LJavaLangReflectMethod;", .constantValue.asLong = 0, 0x1a, -1, 41, -1, 42 },
  };
  static const void *ptrTable[] = { "throwIfInstanceOf", "LNSException;LIOSClass;", "LNSException;", "<X:Ljava/lang/Throwable;>(Ljava/lang/Throwable;Ljava/lang/Class<TX;>;)V^TX;", "propagateIfInstanceOf", (void *)&ComGoogleCommonBaseThrowables__Annotations$0, (void *)&ComGoogleCommonBaseThrowables__Annotations$1, "throwIfUnchecked", "propagateIfPossible", (void *)&ComGoogleCommonBaseThrowables__Annotations$2, (void *)&ComGoogleCommonBaseThrowables__Annotations$3, (void *)&ComGoogleCommonBaseThrowables__Annotations$4, "LNSException;LIOSClass;LIOSClass;", "LNSException;LNSException;", "<X1:Ljava/lang/Throwable;X2:Ljava/lang/Throwable;>(Ljava/lang/Throwable;Ljava/lang/Class<TX1;>;Ljava/lang/Class<TX2;>;)V^TX1;^TX2;", (void *)&ComGoogleCommonBaseThrowables__Annotations$5, "propagate", (void *)&ComGoogleCommonBaseThrowables__Annotations$6, "getRootCause", "getCausalChain", "(Ljava/lang/Throwable;)Ljava/util/List<Ljava/lang/Throwable;>;", "getStackTraceAsString", "lazyStackTrace", "(Ljava/lang/Throwable;)Ljava/util/List<Ljava/lang/StackTraceElement;>;", "jlaStackTrace", "invokeAccessibleNonThrowingMethod", "LJavaLangReflectMethod;LNSObject;[LNSObject;", (void *)&ComGoogleCommonBaseThrowables__Annotations$7, (void *)&ComGoogleCommonBaseThrowables__Annotations$8, (void *)&ComGoogleCommonBaseThrowables__Annotations$9, "getJlaMethod", "LNSString;[LIOSClass;", "LJavaLangThreadDeath;", "(Ljava/lang/String;[Ljava/lang/Class<*>;)Ljava/lang/reflect/Method;", (void *)&ComGoogleCommonBaseThrowables__Annotations$10, &ComGoogleCommonBaseThrowables_JAVA_LANG_ACCESS_CLASSNAME, &ComGoogleCommonBaseThrowables_SHARED_SECRETS_CLASSNAME, &ComGoogleCommonBaseThrowables_jla, (void *)&ComGoogleCommonBaseThrowables__Annotations$11, &ComGoogleCommonBaseThrowables_getStackTraceElementMethod, (void *)&ComGoogleCommonBaseThrowables__Annotations$12, &ComGoogleCommonBaseThrowables_getStackTraceDepthMethod, (void *)&ComGoogleCommonBaseThrowables__Annotations$13 };
  static const J2ObjcClassInfo _ComGoogleCommonBaseThrowables = { "Throwables", "com.google.common.base", ptrTable, methods, fields, 7, 0x11, 19, 5, -1, -1, -1, -1, -1 };
  return &_ComGoogleCommonBaseThrowables;
}

+ (void)initialize {
  if (self == [ComGoogleCommonBaseThrowables class]) {
    JreStrongAssign(&ComGoogleCommonBaseThrowables_jla, ComGoogleCommonBaseThrowables_getJLA());
    JreStrongAssign(&ComGoogleCommonBaseThrowables_getStackTraceElementMethod, (ComGoogleCommonBaseThrowables_jla == nil) ? nil : ComGoogleCommonBaseThrowables_getGetMethod());
    JreStrongAssign(&ComGoogleCommonBaseThrowables_getStackTraceDepthMethod, (ComGoogleCommonBaseThrowables_jla == nil) ? nil : ComGoogleCommonBaseThrowables_getSizeMethod());
...
void ComGoogleCommonBaseThrowables_propagateIfPossibleWithNSException_withIOSClass_withIOSClass_(NSException *throwable, IOSClass *declaredType1, IOSClass *declaredType2) {
  ComGoogleCommonBaseThrowables_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(declaredType2);
...
JavaLangRuntimeException *ComGoogleCommonBaseThrowables_propagateWithNSException_(NSException *throwable) {
  ComGoogleCommonBaseThrowables_initialize();
  ComGoogleCommonBaseThrowables_throwIfUncheckedWithNSException_(throwable);
  @throw create_JavaLangRuntimeException_initWithNSException_(throwable);
}
...
id<JavaUtilList> ComGoogleCommonBaseThrowables_getCausalChainWithNSException_(NSException *throwable) {
  ComGoogleCommonBaseThrowables_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(throwable);
  id<JavaUtilList> causes = create_JavaUtilArrayList_initWithInt_(4);
  while (throwable != nil) {
...
id<JavaUtilList> ComGoogleCommonBaseThrowables_jlaStackTraceWithNSException_(NSException *t) {
  ComGoogleCommonBaseThrowables_initialize();
  ComGoogleCommonBasePreconditions_checkNotNullWithId_(t);
  return create_ComGoogleCommonBaseThrowables_1_initWithNSException_(t);
}
...
id ComGoogleCommonBaseThrowables_getJLA() {
  ...
  @try {
    ...
    JavaLangReflectMethod *langAccess = [((IOSClass *) nil_chk(sharedSecrets)) getMethod:@"getJavaLangAccess" parameterTypes:[IOSObjectArray arrayWithLength:0 type:IOSClass_class_()]];
    return [((JavaLangReflectMethod *) nil_chk(langAccess)) invokeWithId:nil withNSObjectArray:[IOSObjectArray arrayWithLength:0 type:NSObject_class_()]];
  }
...
JavaLangReflectMethod *ComGoogleCommonBaseThrowables_getGetMethod() {
  ComGoogleCommonBaseThrowables_initialize();
  return ComGoogleCommonBaseThrowables_getJlaMethodWithNSString_withIOSClassArray_(@"getStackTraceElement", [IOSObjectArray arrayWithObjects:(id[]){ NSException_class_(), [IOSClass intClass] } count:2 type:IOSClass_class_()]);
}

JavaLangReflectMethod *ComGoogleCommonBaseThrowables_getSizeMethod() {
  ComGoogleCommonBaseThrowables_initialize();
  return ComGoogleCommonBaseThrowables_getJlaMethodWithNSString_withIOSClassArray_(@"getStackTraceDepth", [IOSObjectArray arrayWithObjects:(id[]){ NSException_class_() } count:1 type:IOSClass_class_()]);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleCommonBaseThrowables_1 = { "", "com.google.common.base", ptrTable, methods, fields, 7, 0x8008, 3, 1, 2, -1, 3, 4, -1 };
