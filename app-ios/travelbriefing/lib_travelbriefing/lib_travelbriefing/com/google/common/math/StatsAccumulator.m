...
//  source: ../target/dependency/com/google/common/math/StatsAccumulator.java
//
...
- (ComGoogleCommonMathStats *)snapshot {
  return create_ComGoogleCommonMathStats_initWithLong_withDouble_withDouble_withDouble_withDouble_(count_, mean_, sumOfSquaresOfDeltas_, min_, max_);
}
