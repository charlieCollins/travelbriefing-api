...
//  source: ../target/dependency/com/google/common/math/LinearTransformation.java
//
...
ComGoogleCommonMathLinearTransformation_LinearTransformationBuilder *ComGoogleCommonMathLinearTransformation_mappingWithDouble_withDouble_(jdouble x1, jdouble y1) {
  ...
  return create_ComGoogleCommonMathLinearTransformation_LinearTransformationBuilder_initWithDouble_withDouble_(x1, y1);
}
...
ComGoogleCommonMathLinearTransformation *ComGoogleCommonMathLinearTransformation_verticalWithDouble_(jdouble x) {
  ...
  return create_ComGoogleCommonMathLinearTransformation_VerticalLinearTransformation_initWithDouble_(x);
}
...
ComGoogleCommonMathLinearTransformation *ComGoogleCommonMathLinearTransformation_horizontalWithDouble_(jdouble y) {
  ...
  jdouble slope = 0.0;
  return create_ComGoogleCommonMathLinearTransformation_RegularLinearTransformation_initWithDouble_withDouble_(slope, y);
}
...
- (ComGoogleCommonMathLinearTransformation *)and__WithDouble:(jdouble)x2
  ...
  if (x2 == x1_) {
    ...
    return create_ComGoogleCommonMathLinearTransformation_VerticalLinearTransformation_initWithDouble_(x1_);
  }
  else {
...
- (ComGoogleCommonMathLinearTransformation *)withSlopeWithDouble:(jdouble)slope {
  ...
  if (ComGoogleCommonMathDoubleUtils_isFiniteWithDouble_(slope)) {
    ...
    return create_ComGoogleCommonMathLinearTransformation_RegularLinearTransformation_initWithDouble_withDouble_(slope, yIntercept);
  }
  else {
    return create_ComGoogleCommonMathLinearTransformation_VerticalLinearTransformation_initWithDouble_(x1_);
  }
...
- (NSString *)description {
  return NSString_java_formatWithNSString_withNSObjectArray_(@"y = %g * x + %g", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_(slope_), JavaLangDouble_valueOfWithDouble_(yIntercept_) } count:2 type:NSObject_class_()]);
}
...
void ComGoogleCommonMathLinearTransformation_RegularLinearTransformation_initWithDouble_withDouble_(ComGoogleCommonMathLinearTransformation_RegularLinearTransformation *self, jdouble slope, jdouble yIntercept) {
  ...
  JreVolatileStrongAssign(&self->inverse_, nil);
}
...
void ComGoogleCommonMathLinearTransformation_RegularLinearTransformation_initWithDouble_withDouble_withComGoogleCommonMathLinearTransformation_(ComGoogleCommonMathLinearTransformation_RegularLinearTransformation *self, jdouble slope, jdouble yIntercept, ComGoogleCommonMathLinearTransformation *inverse) {
  ...
  self->slope_ = slope;
  self->yIntercept_ = yIntercept;
  JreVolatileStrongAssign(&self->inverse_, inverse);
}
...
ComGoogleCommonMathLinearTransformation *ComGoogleCommonMathLinearTransformation_RegularLinearTransformation_createInverse(ComGoogleCommonMathLinearTransformation_RegularLinearTransformation *self) {
  if (self->slope_ != 0.0) {
    return create_ComGoogleCommonMathLinearTransformation_RegularLinearTransformation_initWithDouble_withDouble_withComGoogleCommonMathLinearTransformation_(1.0 / self->slope_, -1.0 * self->yIntercept_ / self->slope_, self);
  }
  else {
    return create_ComGoogleCommonMathLinearTransformation_VerticalLinearTransformation_initWithDouble_withComGoogleCommonMathLinearTransformation_(self->yIntercept_, self);
  }
}
...
- (NSString *)description {
  return NSString_java_formatWithNSString_withNSObjectArray_(@"x = %g", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangDouble_valueOfWithDouble_(x_) } count:1 type:NSObject_class_()]);
}
...
ComGoogleCommonMathLinearTransformation *ComGoogleCommonMathLinearTransformation_VerticalLinearTransformation_createInverse(ComGoogleCommonMathLinearTransformation_VerticalLinearTransformation *self) {
  return create_ComGoogleCommonMathLinearTransformation_RegularLinearTransformation_initWithDouble_withDouble_withComGoogleCommonMathLinearTransformation_(0.0, self->x_, self);
}
...
+ (void)initialize {
  if (self == [ComGoogleCommonMathLinearTransformation_NaNLinearTransformation class]) {
    JreStrongAssignAndConsume(&ComGoogleCommonMathLinearTransformation_NaNLinearTransformation_INSTANCE, new_ComGoogleCommonMathLinearTransformation_NaNLinearTransformation_init());
