...
- (void)beginArray {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_BEGIN_ARRAY) {
    ...
    *IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1) = 0;
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected BEGIN_ARRAY but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
  }
}
...
- (void)endArray {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_END_ARRAY) {
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected END_ARRAY but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
  }
}
...
- (void)beginObject {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_BEGIN_OBJECT) {
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected BEGIN_OBJECT but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
  }
}
...
- (void)endObject {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_END_OBJECT) {
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected END_OBJECT but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
  }
}
...
- (NSString *)nextName {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_UNQUOTED_NAME) {
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected a name but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
  }
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
...
- (NSString *)nextString {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_UNQUOTED) {
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected a string but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
  }
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
  (*IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1))++;
  return result;
...
- (jboolean)nextBoolean {
  ...
  @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected a boolean but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
}
...
- (void)nextNull {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_NULL) {
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected null but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
  }
}
...
- (jdouble)nextDouble {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_NUMBER) {
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected a double but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
  }
  ...
  if (!lenient_ && (JavaLangDouble_isNaNWithDouble_(result) || JavaLangDouble_isInfiniteWithDouble_(result))) {
    @throw create_ComGoogleGsonStreamMalformedJsonException_initWithNSString_(JreStrcat("$D$", @"JSON forbids NaN and infinities: ", result, ComGoogleGsonStreamJsonReader_locationString(self)));
  }
  JreStrongAssign(&peekedString_, nil);
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
  (*IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1))++;
...
- (jlong)nextLong {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_NUMBER) {
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected a long but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
  }
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_BUFFERED;
  jdouble asDouble = JavaLangDouble_parseDoubleWithNSString_(peekedString_);
  jlong result = JreFpToLong(asDouble);
  if (result != asDouble) {
    @throw create_JavaLangNumberFormatException_initWithNSString_(JreStrcat("$$$", @"Expected a long but was ", peekedString_, ComGoogleGsonStreamJsonReader_locationString(self)));
  }
  JreStrongAssign(&peekedString_, nil);
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
  (*IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1))++;
...
- (jint)nextInt {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_LONG) {
    ...
    if (peekedLong_ != result) {
      @throw create_JavaLangNumberFormatException_initWithNSString_(JreStrcat("$J$", @"Expected an int but was ", peekedLong_, ComGoogleGsonStreamJsonReader_locationString(self)));
    }
    peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
    (*IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1))++;
    return result;
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_NUMBER) {
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected an int but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
  }
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_BUFFERED;
  jdouble asDouble = JavaLangDouble_parseDoubleWithNSString_(peekedString_);
  result = JreFpToInt(asDouble);
  if (result != asDouble) {
    @throw create_JavaLangNumberFormatException_initWithNSString_(JreStrcat("$$$", @"Expected an int but was ", peekedString_, ComGoogleGsonStreamJsonReader_locationString(self)));
  }
  JreStrongAssign(&peekedString_, nil);
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
  (*IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1))++;
...
jint ComGoogleGsonStreamJsonReader_nextNonWhitespaceWithBoolean_(ComGoogleGsonStreamJsonReader *self, jboolean throwOnEof) {
  ...
  if (throwOnEof) {
    @throw create_JavaIoEOFException_initWithNSString_(JreStrcat("$$", @"End of input", ComGoogleGsonStreamJsonReader_locationString(self)));
  }
  else {
    return -1;
  }
...
JavaIoIOException *ComGoogleGsonStreamJsonReader_syntaxErrorWithNSString_(ComGoogleGsonStreamJsonReader *self, NSString *message) {
  @throw create_ComGoogleGsonStreamMalformedJsonException_initWithNSString_(JreStrcat("$$", message, ComGoogleGsonStreamJsonReader_locationString(self)));
}
...
- (void)promoteNameToValueWithComGoogleGsonStreamJsonReader:(ComGoogleGsonStreamJsonReader *)reader {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_DOUBLE_QUOTED_NAME) {
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected a name but was ", [reader peek], ComGoogleGsonStreamJsonReader_locationString(reader)));
  }
}
