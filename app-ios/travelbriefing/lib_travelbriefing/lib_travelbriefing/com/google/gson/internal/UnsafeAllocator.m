...
//  source: ../target/dependency/com/google/gson/internal/UnsafeAllocator.java
//
...
void ComGoogleGsonInternalUnsafeAllocator_assertInstantiableWithIOSClass_(IOSClass *c) {
  ...
  if (JavaLangReflectModifier_isInterfaceWithInt_(modifiers)) {
    @throw create_JavaLangUnsupportedOperationException_initWithNSString_(JreStrcat("$$", @"Interface can't be instantiated! Interface name: ", [c getName]));
  }
  if (JavaLangReflectModifier_isAbstractWithInt_(modifiers)) {
    @throw create_JavaLangUnsupportedOperationException_initWithNSString_(JreStrcat("$$", @"Abstract class can't be instantiated! Class name: ", [c getName]));
  }
}
