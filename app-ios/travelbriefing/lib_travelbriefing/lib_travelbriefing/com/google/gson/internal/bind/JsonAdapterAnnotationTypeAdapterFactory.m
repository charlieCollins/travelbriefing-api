...
//  source: ../target/dependency/com/google/gson/internal/bind/JsonAdapterAnnotationTypeAdapterFactory.java
//
...
- (ComGoogleGsonTypeAdapter *)getTypeAdapterWithComGoogleGsonInternalConstructorConstructor:(ComGoogleGsonInternalConstructorConstructor *)constructorConstructor
  ...
  if ([instance isKindOfClass:[ComGoogleGsonTypeAdapter class]]) {
    ...
    typeAdapter = create_ComGoogleGsonInternalBindTreeTypeAdapter_initWithComGoogleGsonJsonSerializer_withComGoogleGsonJsonDeserializer_withComGoogleGsonGson_withComGoogleGsonReflectTypeToken_withComGoogleGsonTypeAdapterFactory_(serializer, deserializer, gson, type, nil);
  }
  else {
    @throw create_JavaLangIllegalArgumentException_initWithNSString_(@"@JsonAdapter value must be TypeAdapter, TypeAdapterFactory, JsonSerializer or JsonDeserializer reference.");
  }
