...
//  source: ../target/dependency/okhttp3/CacheControl.java
//
...
@class Okhttp3CacheControl_Builder;
...
FOUNDATION_EXPORT void Okhttp3CacheControl_initWithOkhttp3CacheControl_Builder_(Okhttp3CacheControl *self, Okhttp3CacheControl_Builder *builder);

FOUNDATION_EXPORT Okhttp3CacheControl *new_Okhttp3CacheControl_initWithOkhttp3CacheControl_Builder_(Okhttp3CacheControl_Builder *builder) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT Okhttp3CacheControl *create_Okhttp3CacheControl_initWithOkhttp3CacheControl_Builder_(Okhttp3CacheControl_Builder *builder);
