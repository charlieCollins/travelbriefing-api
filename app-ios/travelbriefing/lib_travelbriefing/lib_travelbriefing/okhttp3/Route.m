...
//  source: ../target/dependency/okhttp3/Route.java
//
...
- (NSString *)description {
  return JreStrcat("$@C", @"Route{", inetSocketAddress_, '}');
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOkhttp3Address;LJavaNetProxy;LJavaNetInetSocketAddress;", "equals", "LNSObject;", "hashCode", "toString" };
  static const J2ObjcClassInfo _Okhttp3Route = { "Route", "okhttp3", ptrTable, methods, fields, 7, 0x11, 8, 3, -1, -1, -1, -1, -1 };
