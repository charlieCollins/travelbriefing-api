...
//  source: ../target/dependency/okhttp3/MultipartBody.java
//
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[5].selector = @selector(headers);
  ...
  static const J2ObjcClassInfo _Okhttp3MultipartBody_Part = { "Part", "okhttp3", ptrTable, methods, fields, 7, 0x19, 7, 2, 6, -1, -1, -1, -1 };
