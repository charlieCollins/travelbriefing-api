...
FOUNDATION_EXPORT void Okhttp3HttpUrl_initWithOkhttp3HttpUrl_Builder_(Okhttp3HttpUrl *self, Okhttp3HttpUrl_Builder *builder);

FOUNDATION_EXPORT Okhttp3HttpUrl *new_Okhttp3HttpUrl_initWithOkhttp3HttpUrl_Builder_(Okhttp3HttpUrl_Builder *builder) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT Okhttp3HttpUrl *create_Okhttp3HttpUrl_initWithOkhttp3HttpUrl_Builder_(Okhttp3HttpUrl_Builder *builder);
...
@interface Okhttp3HttpUrl_Builder_ParseResult : JavaLangEnum < NSCopying >
