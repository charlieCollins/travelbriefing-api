...
FOUNDATION_EXPORT Okhttp3InternalHttpRealInterceptorChain *new_Okhttp3InternalHttpRealInterceptorChain_initWithJavaUtilList_withOkhttp3InternalConnectionStreamAllocation_withOkhttp3InternalHttpHttpCodec_withOkhttp3Connection_withInt_withOkhttp3Request_(id<JavaUtilList> interceptors, Okhttp3InternalConnectionStreamAllocation *streamAllocation, id<Okhttp3InternalHttpHttpCodec> httpCodec, id<Okhttp3Connection> connection, jint index, Okhttp3Request *request) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT Okhttp3InternalHttpRealInterceptorChain *create_Okhttp3InternalHttpRealInterceptorChain_initWithJavaUtilList_withOkhttp3InternalConnectionStreamAllocation_withOkhttp3InternalHttpHttpCodec_withOkhttp3Connection_withInt_withOkhttp3Request_(id<JavaUtilList> interceptors, Okhttp3InternalConnectionStreamAllocation *streamAllocation, id<Okhttp3InternalHttpHttpCodec> httpCodec, id<Okhttp3Connection> connection, jint index, Okhttp3Request *request);
