...
//  source: ../target/dependency/okhttp3/internal/http/BridgeInterceptor.java
//
...
- (Okhttp3Response *)interceptWithOkhttp3Interceptor_Chain:(id<Okhttp3Interceptor_Chain>)chain {
  ...
  if ([userRequest headerWithNSString:@"Accept-Encoding"] == nil && [userRequest headerWithNSString:@"Range"] == nil) {
