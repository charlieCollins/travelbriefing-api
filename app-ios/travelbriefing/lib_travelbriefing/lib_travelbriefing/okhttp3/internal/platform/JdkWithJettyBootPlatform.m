...
//  source: ../target/dependency/okhttp3/internal/platform/JdkWithJettyBootPlatform.java
//
...
- (NSString *)getSelectedProtocolWithJavaxNetSslSSLSocket:(JavaxNetSslSSLSocket *)socket {
  @try {
    ...
    if (!((Okhttp3InternalPlatformJdkWithJettyBootPlatform_JettyNegoProvider *) nil_chk(provider))->unsupported_ && provider->selected_ == nil) {
      [((Okhttp3InternalPlatformPlatform *) nil_chk(Okhttp3InternalPlatformPlatform_get())) logWithInt:Okhttp3InternalPlatformPlatform_INFO withNSString:@"ALPN callback dropped: HTTP/2 is disabled. Is alpn-boot on the boot class path?" withNSException:nil];
      return nil;
    }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "unsupported_", "Z", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "selected_", "LNSString;", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "LJavaUtilList;", "(Ljava/util/List<Ljava/lang/String;>;)V", "invoke", "LNSObject;LJavaLangReflectMethod;[LNSObject;", "LNSException;", "Ljava/util/List<Ljava/lang/String;>;", "LOkhttp3InternalPlatformJdkWithJettyBootPlatform;" };
