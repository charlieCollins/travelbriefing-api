...
FOUNDATION_EXPORT void Okhttp3InternalCacheCacheStrategy_initWithOkhttp3Request_withOkhttp3Response_(Okhttp3InternalCacheCacheStrategy *self, Okhttp3Request *networkRequest, Okhttp3Response *cacheResponse);

FOUNDATION_EXPORT Okhttp3InternalCacheCacheStrategy *new_Okhttp3InternalCacheCacheStrategy_initWithOkhttp3Request_withOkhttp3Response_(Okhttp3Request *networkRequest, Okhttp3Response *cacheResponse) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT Okhttp3InternalCacheCacheStrategy *create_Okhttp3InternalCacheCacheStrategy_initWithOkhttp3Request_withOkhttp3Response_(Okhttp3Request *networkRequest, Okhttp3Response *cacheResponse);
