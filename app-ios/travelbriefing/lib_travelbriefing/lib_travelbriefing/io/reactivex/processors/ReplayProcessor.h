...
@interface IoReactivexProcessorsReplayProcessor_UnboundedReplayBuffer : JavaUtilConcurrentAtomicAtomicReference < IoReactivexProcessorsReplayProcessor_ReplayBuffer > {
 @public
...
@interface IoReactivexProcessorsReplayProcessor_SizeBoundReplayBuffer : JavaUtilConcurrentAtomicAtomicReference < IoReactivexProcessorsReplayProcessor_ReplayBuffer > {
 @public
  jint maxSize_;
  jint size_;
  volatile_id head_;
...
@interface IoReactivexProcessorsReplayProcessor_SizeAndTimeBoundReplayBuffer : JavaUtilConcurrentAtomicAtomicReference < IoReactivexProcessorsReplayProcessor_ReplayBuffer > {
 @public
  jint maxSize_;
  jlong maxAge_;
