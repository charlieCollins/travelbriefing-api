...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[12].selector = @selector(hasSubscription);
  methods[13].selector = @selector(assertSubscribed);
  methods[14].selector = @selector(assertNotSubscribed);
  methods[15].selector = @selector(assertOfWithIoReactivexFunctionsConsumer:);
  methods[16].selector = @selector(setInitialFusionModeWithInt:);
  methods[17].selector = @selector(assertFusionModeWithInt:);
  methods[18].selector = @selector(fusionModeToStringWithInt:);
  methods[19].selector = @selector(assertFuseable);
  methods[20].selector = @selector(assertNotFuseable);
  methods[21].selector = @selector(onSuccessWithId:);
...
+ (void)initialize {
  if (self == [IoReactivexObserversTestObserver_EmptyObserver class]) {
    ...
    for (jint i = 0; i < 1; i++) {
      ...
      IoReactivexObserversTestObserver_EmptyObserver_initWithNSString_withInt_(e, names[i], i);
    }
