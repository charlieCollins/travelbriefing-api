...
@interface IoReactivexScheduler_1 : NSObject < JavaLangRunnable > {
 @public
  id<JavaLangRunnable> val$decoratedRun_;
  IoReactivexScheduler_Worker *val$w_;
}
...
J2OBJC_EMPTY_STATIC_INIT(IoReactivexScheduler_1)

__attribute__((unused)) static void IoReactivexScheduler_1_initWithJavaLangRunnable_withIoReactivexScheduler_Worker_(IoReactivexScheduler_1 *self, id<JavaLangRunnable> capture$0, IoReactivexScheduler_Worker *capture$1);

__attribute__((unused)) static IoReactivexScheduler_1 *new_IoReactivexScheduler_1_initWithJavaLangRunnable_withIoReactivexScheduler_Worker_(id<JavaLangRunnable> capture$0, IoReactivexScheduler_Worker *capture$1) NS_RETURNS_RETAINED;

__attribute__((unused)) static IoReactivexScheduler_1 *create_IoReactivexScheduler_1_initWithJavaLangRunnable_withIoReactivexScheduler_Worker_(id<JavaLangRunnable> capture$0, IoReactivexScheduler_Worker *capture$1);
...
- (id<IoReactivexDisposablesDisposable>)scheduleDirectWithJavaLangRunnable:(id<JavaLangRunnable>)run
  ...
  [((IoReactivexScheduler_Worker *) nil_chk(w)) scheduleWithJavaLangRunnable:create_IoReactivexScheduler_1_initWithJavaLangRunnable_withIoReactivexScheduler_Worker_(decoratedRun, w) withLong:delay withJavaUtilConcurrentTimeUnit:unit];
  return w;
}
...
@implementation IoReactivexScheduler_1

- (instancetype)initWithJavaLangRunnable:(id<JavaLangRunnable>)capture$0
         withIoReactivexScheduler_Worker:(IoReactivexScheduler_Worker *)capture$1 {
  IoReactivexScheduler_1_initWithJavaLangRunnable_withIoReactivexScheduler_Worker_(self, capture$0, capture$1);
  return self;
}

- (void)run {
  @try {
    [((id<JavaLangRunnable>) nil_chk(val$decoratedRun_)) run];
  }
  @finally {
    [((IoReactivexScheduler_Worker *) nil_chk(val$w_)) dispose];
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "val$w_", "LIoReactivexScheduler_Worker;", .constantValue.asLong = 0, 0x1012, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "LIoReactivexScheduler;", "scheduleDirectWithJavaLangRunnable:withLong:withJavaUtilConcurrentTimeUnit:" };
  static const J2ObjcClassInfo _IoReactivexScheduler_1 = { "", "io.reactivex", ptrTable, methods, fields, 7, 0x8018, 2, 2, 0, -1, 1, -1, -1 };
  return &_IoReactivexScheduler_1;
}

@end

void IoReactivexScheduler_1_initWithJavaLangRunnable_withIoReactivexScheduler_Worker_(IoReactivexScheduler_1 *self, id<JavaLangRunnable> capture$0, IoReactivexScheduler_Worker *capture$1) {
  JreStrongAssign(&self->val$decoratedRun_, capture$0);
  JreStrongAssign(&self->val$w_, capture$1);
  NSObject_init(self);
}

IoReactivexScheduler_1 *new_IoReactivexScheduler_1_initWithJavaLangRunnable_withIoReactivexScheduler_Worker_(id<JavaLangRunnable> capture$0, IoReactivexScheduler_Worker *capture$1) {
  J2OBJC_NEW_IMPL(IoReactivexScheduler_1, initWithJavaLangRunnable_withIoReactivexScheduler_Worker_, capture$0, capture$1)
}

IoReactivexScheduler_1 *create_IoReactivexScheduler_1_initWithJavaLangRunnable_withIoReactivexScheduler_Worker_(id<JavaLangRunnable> capture$0, IoReactivexScheduler_Worker *capture$1) {
  J2OBJC_CREATE_IMPL(IoReactivexScheduler_1, initWithJavaLangRunnable_withIoReactivexScheduler_Worker_, capture$0, capture$1)
}
