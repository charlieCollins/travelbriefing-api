...
#include "io/reactivex/internal/util/OpenHashSet.h"
...
- (void)disposeWithIoReactivexInternalUtilOpenHashSet:(IoReactivexInternalUtilOpenHashSet *)set {
  ...
  if (errors != nil) {
    if ([errors size] == 1) {
      @throw IoReactivexInternalUtilExceptionHelper_wrapOrThrowWithNSException_([errors getWithInt:0]);
    }
