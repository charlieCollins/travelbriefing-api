...
//  source: ../target/dependency/io/reactivex/internal/observers/InnerQueuedObserverSupport.java
//
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[1].selector = @selector(innerErrorWithIoReactivexInternalObserversInnerQueuedObserver:withNSException:);
