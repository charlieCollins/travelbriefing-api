...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexObserver;", "(Lio/reactivex/Observer<-TT;>;)V", "requestFusion", "I", "complete", "LNSObject;", "(TT;)V", "error", "LNSException;", "LJavaLangException;", "()TT;", "Lio/reactivex/Observer<-TT;>;", "value", "TT;", "<T:Ljava/lang/Object;>Lio/reactivex/internal/observers/BasicIntQueueDisposable<TT;>;" };
