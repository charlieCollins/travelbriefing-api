...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexFunctionsAction;", "LIoReactivexFunctionsConsumer;LIoReactivexFunctionsAction;", "(Lio/reactivex/functions/Consumer<-Ljava/lang/Throwable;>;Lio/reactivex/functions/Action;)V", "accept", "LNSException;", "onError", "onSubscribe", "LIoReactivexDisposablesDisposable;", "Lio/reactivex/functions/Consumer<-Ljava/lang/Throwable;>;", "Ljava/util/concurrent/atomic/AtomicReference<Lio/reactivex/disposables/Disposable;>;Lio/reactivex/CompletableObserver;Lio/reactivex/disposables/Disposable;Lio/reactivex/functions/Consumer<Ljava/lang/Throwable;>;" };
  static const J2ObjcClassInfo _IoReactivexInternalObserversCallbackCompletableObserver = { "CallbackCompletableObserver", "io.reactivex.internal.observers", ptrTable, methods, fields, 7, 0x11, 8, 3, -1, -1, -1, 9, -1 };
