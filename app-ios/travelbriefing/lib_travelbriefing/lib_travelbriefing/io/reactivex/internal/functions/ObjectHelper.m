...
@interface IoReactivexInternalFunctionsObjectHelper_1 : NSObject < IoReactivexFunctionsBiPredicate >
...
J2OBJC_EMPTY_STATIC_INIT(IoReactivexInternalFunctionsObjectHelper_1)

__attribute__((unused)) static void IoReactivexInternalFunctionsObjectHelper_1_init(IoReactivexInternalFunctionsObjectHelper_1 *self);

__attribute__((unused)) static IoReactivexInternalFunctionsObjectHelper_1 *new_IoReactivexInternalFunctionsObjectHelper_1_init() NS_RETURNS_RETAINED;

__attribute__((unused)) static IoReactivexInternalFunctionsObjectHelper_1 *create_IoReactivexInternalFunctionsObjectHelper_1_init();
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _IoReactivexInternalFunctionsObjectHelper = { "ObjectHelper", "io.reactivex.internal.functions", ptrTable, methods, fields, 7, 0x11, 9, 1, -1, -1, -1, -1, -1 };
  return &_IoReactivexInternalFunctionsObjectHelper;
}

+ (void)initialize {
  if (self == [IoReactivexInternalFunctionsObjectHelper class]) {
    JreStrongAssignAndConsume(&IoReactivexInternalFunctionsObjectHelper_EQUALS, new_IoReactivexInternalFunctionsObjectHelper_1_init());
...
@implementation IoReactivexInternalFunctionsObjectHelper_1

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  IoReactivexInternalFunctionsObjectHelper_1_init(self);
  return self;
}
J2OBJC_IGNORE_DESIGNATED_END
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _IoReactivexInternalFunctionsObjectHelper_1 = { "", "io.reactivex.internal.functions", ptrTable, methods, NULL, 7, 0x8018, 2, 0, 2, -1, -1, 3, -1 };
  return &_IoReactivexInternalFunctionsObjectHelper_1;
}

@end

void IoReactivexInternalFunctionsObjectHelper_1_init(IoReactivexInternalFunctionsObjectHelper_1 *self) {
  NSObject_init(self);
}

IoReactivexInternalFunctionsObjectHelper_1 *new_IoReactivexInternalFunctionsObjectHelper_1_init() {
  J2OBJC_NEW_IMPL(IoReactivexInternalFunctionsObjectHelper_1, init)
}

IoReactivexInternalFunctionsObjectHelper_1 *create_IoReactivexInternalFunctionsObjectHelper_1_init() {
  J2OBJC_CREATE_IMPL(IoReactivexInternalFunctionsObjectHelper_1, init)
}
