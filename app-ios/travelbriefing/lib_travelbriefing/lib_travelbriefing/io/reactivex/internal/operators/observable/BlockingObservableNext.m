...
//  source: ../target/dependency/io/reactivex/internal/operators/observable/BlockingObservableNext.java
//
...
J2OBJC_FIELD_SETTER(IoReactivexInternalOperatorsObservableBlockingObservableNext_NextIterator, error_, NSException *)
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "onError", "LNSException;", "onNext", "LIoReactivexNotification;", "(Lio/reactivex/Notification<TT;>;)V", "LJavaLangInterruptedException;", "()Lio/reactivex/Notification<TT;>;", "Ljava/util/concurrent/BlockingQueue<Lio/reactivex/Notification<TT;>;>;", "LIoReactivexInternalOperatorsObservableBlockingObservableNext;", "<T:Ljava/lang/Object;>Lio/reactivex/observers/DisposableObserver<Lio/reactivex/Notification<TT;>;>;" };
