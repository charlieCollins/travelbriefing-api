...
//  source: ../target/dependency/io/reactivex/internal/operators/observable/ObservableGroupBy.java
//
...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  for (IoReactivexInternalOperatorsObservableObservableGroupBy_GroupedUnicast * __strong e in list) {
    [((IoReactivexInternalOperatorsObservableObservableGroupBy_GroupedUnicast *) nil_chk(e)) onErrorWithNSException:t];
  }
...
- (void)onErrorWithNSException:(NSException *)e {
  [((IoReactivexInternalOperatorsObservableObservableGroupBy_State *) nil_chk(state_)) onErrorWithNSException:e];
}
...
- (void)subscribeWithIoReactivexObserver:(id<IoReactivexObserver>)s {
  if ([((JavaUtilConcurrentAtomicAtomicBoolean *) nil_chk(once_)) compareAndSetWithBoolean:false withBoolean:true]) {
    ...
    IoReactivexInternalDisposablesEmptyDisposable_errorWithNSException_withIoReactivexObserver_(create_JavaLangIllegalStateException_initWithNSString_(@"Only one Observer allowed!"), s);
  }
}
