...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableOnBackpressureBufferStrategy_initWithOrgReactivestreamsPublisher_withLong_withIoReactivexFunctionsAction_withIoReactivexBackpressureOverflowStrategy_(self, source, bufferSize, onOverflow, strategy);
  return self;
}

- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableOnBackpressureBufferStrategy_OnBackpressureBufferStrategySubscriber_initWithOrgReactivestreamsSubscriber_withIoReactivexFunctionsAction_withIoReactivexBackpressureOverflowStrategy_withLong_(s, onOverflow_, strategy_, bufferSize_)];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithOrgReactivestreamsPublisher:withLong:withIoReactivexFunctionsAction:withIoReactivexBackpressureOverflowStrategy:);
...
IoReactivexInternalOperatorsFlowableFlowableOnBackpressureBufferStrategy *new_IoReactivexInternalOperatorsFlowableFlowableOnBackpressureBufferStrategy_initWithOrgReactivestreamsPublisher_withLong_withIoReactivexFunctionsAction_withIoReactivexBackpressureOverflowStrategy_(id<OrgReactivestreamsPublisher> source, jlong bufferSize, id<IoReactivexFunctionsAction> onOverflow, IoReactivexBackpressureOverflowStrategy *strategy) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableOnBackpressureBufferStrategy, initWithOrgReactivestreamsPublisher_withLong_withIoReactivexFunctionsAction_withIoReactivexBackpressureOverflowStrategy_, source, bufferSize, onOverflow, strategy)
}
...
IoReactivexInternalOperatorsFlowableFlowableOnBackpressureBufferStrategy *create_IoReactivexInternalOperatorsFlowableFlowableOnBackpressureBufferStrategy_initWithOrgReactivestreamsPublisher_withLong_withIoReactivexFunctionsAction_withIoReactivexBackpressureOverflowStrategy_(id<OrgReactivestreamsPublisher> source, jlong bufferSize, id<IoReactivexFunctionsAction> onOverflow, IoReactivexBackpressureOverflowStrategy *strategy) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableOnBackpressureBufferStrategy, initWithOrgReactivestreamsPublisher_withLong_withIoReactivexFunctionsAction_withIoReactivexBackpressureOverflowStrategy_, source, bufferSize, onOverflow, strategy)
}
...
- (void)drain {
  ...
  for (; ; ) {
    ...
    while (e != r) {
      ...
      id v;
      @synchronized(dq) {
        v = [((id<JavaUtilDeque>) nil_chk(dq)) poll];
      }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LIoReactivexFunctionsAction;LIoReactivexBackpressureOverflowStrategy;J", "(Lorg/reactivestreams/Subscriber<-TT;>;Lio/reactivex/functions/Action;Lio/reactivex/BackpressureOverflowStrategy;J)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "request", "J", "clear", "LJavaUtilDeque;", "(Ljava/util/Deque<TT;>;)V", "Lorg/reactivestreams/Subscriber<-TT;>;", "Ljava/util/Deque<TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableOnBackpressureBufferStrategy;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicInteger;Lorg/reactivestreams/Subscriber<TT;>;Lorg/reactivestreams/Subscription;" };
