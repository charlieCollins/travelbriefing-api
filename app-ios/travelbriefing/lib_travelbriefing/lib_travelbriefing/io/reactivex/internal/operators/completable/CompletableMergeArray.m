...
//  source: ../target/dependency/io/reactivex/internal/operators/completable/CompletableMergeArray.java
//
  ...
  [((id<IoReactivexCompletableObserver>) nil_chk(s)) onSubscribeWithIoReactivexDisposablesDisposable:set];
  {
    ...
    while (b__ < e__) {
      ...
      if (c == nil) {
        ...
        [shared onErrorWithNSException:npe];
        return;
      }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexCompletableObserver;LJavaUtilConcurrentAtomicAtomicBoolean;LIoReactivexDisposablesCompositeDisposable;I", "onSubscribe", "LIoReactivexDisposablesDisposable;", "onError", "LNSException;", "LIoReactivexInternalOperatorsCompletableCompletableMergeArray;" };
