...
@interface IoReactivexInternalOperatorsParallelParallelRunOn_BaseRunOnSubscriber : JavaUtilConcurrentAtomicAtomicInteger < OrgReactivestreamsSubscriber, OrgReactivestreamsSubscription, JavaLangRunnable > {
 @public
  jint prefetch_;
  jint limit_;
...
J2OBJC_FIELD_SETTER(IoReactivexInternalOperatorsParallelParallelRunOn_BaseRunOnSubscriber, error_, NSException *)
