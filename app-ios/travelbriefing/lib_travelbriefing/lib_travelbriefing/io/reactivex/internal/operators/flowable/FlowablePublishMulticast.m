...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowablePublishMulticast_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_withBoolean_(self, source, selector, prefetch, delayError);
  return self;
}
...
- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  ...
  [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:mp];
}
...
IoReactivexInternalOperatorsFlowableFlowablePublishMulticast *new_IoReactivexInternalOperatorsFlowableFlowablePublishMulticast_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_withBoolean_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> selector, jint prefetch, jboolean delayError) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowablePublishMulticast, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_withBoolean_, source, selector, prefetch, delayError)
}

IoReactivexInternalOperatorsFlowableFlowablePublishMulticast *create_IoReactivexInternalOperatorsFlowableFlowablePublishMulticast_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_withBoolean_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> selector, jint prefetch, jboolean delayError) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowablePublishMulticast, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_withBoolean_, source, selector, prefetch, delayError)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LIoReactivexInternalOperatorsFlowableFlowablePublishMulticast_MulticastProcessor;", "(Lorg/reactivestreams/Subscriber<-TR;>;Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastProcessor<*>;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TR;)V", "onError", "LNSException;", "request", "J", "Lorg/reactivestreams/Subscriber<-TR;>;", "Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastProcessor<*>;", "LIoReactivexInternalOperatorsFlowableFlowablePublishMulticast;", "<R:Ljava/lang/Object;>Ljava/lang/Object;Lorg/reactivestreams/Subscriber<TR;>;Lorg/reactivestreams/Subscription;" };
    ...
    if (q != nil && n != 0) {
      ...
      while (e != r) {
        ...
        if (d && !delayError_) {
          NSException *ex = error_;
          if (ex != nil) {
            [self errorAllWithNSException:ex];
            return;
          }
        }
        id v;
...
- (void)errorAllWithNSException:(NSException *)ex {
  {
    ...
    while (b__ < e__) {
      IoReactivexInternalOperatorsFlowableFlowablePublishMulticast_MulticastSubscription *ms = *b__++;
      if ([((IoReactivexInternalOperatorsFlowableFlowablePublishMulticast_MulticastSubscription *) nil_chk(ms)) get] != JavaLangLong_MIN_VALUE) {
        [((id<OrgReactivestreamsSubscriber>) nil_chk(ms->actual_)) onErrorWithNSException:ex];
      }
    }
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[11].selector = @selector(errorAllWithNSException:);
