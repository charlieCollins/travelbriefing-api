...
- (void)onErrorWithNSException:(NSException *)t {
  IoReactivexNotification *v = IoReactivexNotification_createOnErrorWithNSException_(t);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexObserver;", "(Lio/reactivex/Observer<-Lio/reactivex/Notification<TT;>;>;)V", "onSubscribe", "LIoReactivexDisposablesDisposable;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lio/reactivex/Observer<-Lio/reactivex/Notification<TT;>;>;", "LIoReactivexInternalOperatorsObservableObservableMaterialize;", "<T:Ljava/lang/Object;>Ljava/lang/Object;Lio/reactivex/Observer<TT;>;Lio/reactivex/disposables/Disposable;" };
