...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
                                           withLong:(jlong)n {
  IoReactivexInternalOperatorsFlowableFlowableSkip_initWithOrgReactivestreamsPublisher_withLong_(self, source, n);
  return self;
}

- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableSkip_SkipSubscriber_initWithOrgReactivestreamsSubscriber_withLong_(s, n_)];
}
...
void IoReactivexInternalOperatorsFlowableFlowableSkip_initWithOrgReactivestreamsPublisher_withLong_(IoReactivexInternalOperatorsFlowableFlowableSkip *self, id<OrgReactivestreamsPublisher> source, jlong n) {
  IoReactivexInternalOperatorsFlowableAbstractFlowableWithUpstream_initWithOrgReactivestreamsPublisher_(self, source);
  self->n_ = n;
}

IoReactivexInternalOperatorsFlowableFlowableSkip *new_IoReactivexInternalOperatorsFlowableFlowableSkip_initWithOrgReactivestreamsPublisher_withLong_(id<OrgReactivestreamsPublisher> source, jlong n) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableSkip, initWithOrgReactivestreamsPublisher_withLong_, source, n)
}

IoReactivexInternalOperatorsFlowableFlowableSkip *create_IoReactivexInternalOperatorsFlowableFlowableSkip_initWithOrgReactivestreamsPublisher_withLong_(id<OrgReactivestreamsPublisher> source, jlong n) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableSkip, initWithOrgReactivestreamsPublisher_withLong_, source, n)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;J", "(Lorg/reactivestreams/Subscriber<-TT;>;J)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "request", "J", "Lorg/reactivestreams/Subscriber<-TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableSkip;", "<T:Ljava/lang/Object;>Ljava/lang/Object;Lorg/reactivestreams/Subscriber<TT;>;Lorg/reactivestreams/Subscription;" };
