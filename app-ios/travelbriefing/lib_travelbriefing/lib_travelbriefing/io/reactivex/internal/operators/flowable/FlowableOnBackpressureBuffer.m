...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableOnBackpressureBuffer_initWithOrgReactivestreamsPublisher_withInt_withBoolean_withBoolean_withIoReactivexFunctionsAction_(self, source, bufferSize, unbounded, delayError, onOverflow);
  return self;
}

- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableOnBackpressureBuffer_BackpressureBufferSubscriber_initWithOrgReactivestreamsSubscriber_withInt_withBoolean_withBoolean_withIoReactivexFunctionsAction_(s, bufferSize_, unbounded_, delayError_, onOverflow_)];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithOrgReactivestreamsPublisher:withInt:withBoolean:withBoolean:withIoReactivexFunctionsAction:);
...
IoReactivexInternalOperatorsFlowableFlowableOnBackpressureBuffer *new_IoReactivexInternalOperatorsFlowableFlowableOnBackpressureBuffer_initWithOrgReactivestreamsPublisher_withInt_withBoolean_withBoolean_withIoReactivexFunctionsAction_(id<OrgReactivestreamsPublisher> source, jint bufferSize, jboolean unbounded, jboolean delayError, id<IoReactivexFunctionsAction> onOverflow) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableOnBackpressureBuffer, initWithOrgReactivestreamsPublisher_withInt_withBoolean_withBoolean_withIoReactivexFunctionsAction_, source, bufferSize, unbounded, delayError, onOverflow)
}
...
IoReactivexInternalOperatorsFlowableFlowableOnBackpressureBuffer *create_IoReactivexInternalOperatorsFlowableFlowableOnBackpressureBuffer_initWithOrgReactivestreamsPublisher_withInt_withBoolean_withBoolean_withIoReactivexFunctionsAction_(id<OrgReactivestreamsPublisher> source, jint bufferSize, jboolean unbounded, jboolean delayError, id<IoReactivexFunctionsAction> onOverflow) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableOnBackpressureBuffer, initWithOrgReactivestreamsPublisher_withInt_withBoolean_withBoolean_withIoReactivexFunctionsAction_, source, bufferSize, unbounded, delayError, onOverflow)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;IZZLIoReactivexFunctionsAction;", "(Lorg/reactivestreams/Subscriber<-TT;>;IZZLio/reactivex/functions/Action;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "request", "J", "checkTerminated", "ZZLOrgReactivestreamsSubscriber;", "(ZZLorg/reactivestreams/Subscriber<-TT;>;)Z", "requestFusion", "I", "LJavaLangException;", "()TT;", "Lorg/reactivestreams/Subscriber<-TT;>;", "Lio/reactivex/internal/fuseable/SimplePlainQueue<TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableOnBackpressureBuffer;", "<T:Ljava/lang/Object;>Lio/reactivex/internal/subscriptions/BasicIntQueueSubscription<TT;>;Lorg/reactivestreams/Subscriber<TT;>;" };
