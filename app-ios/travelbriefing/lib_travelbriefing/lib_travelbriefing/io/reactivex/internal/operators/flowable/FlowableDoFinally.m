...
//  source: ../target/dependency/io/reactivex/internal/operators/flowable/FlowableDoFinally.java
//
...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableDoFinally_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsAction_(self, source, onFinally);
  return self;
}

- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  if ([IoReactivexInternalFuseableConditionalSubscriber_class_() isInstance:s]) {
    [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableDoFinally_DoFinallyConditionalSubscriber_initWithIoReactivexInternalFuseableConditionalSubscriber_withIoReactivexFunctionsAction_((id<IoReactivexInternalFuseableConditionalSubscriber>) cast_check(s, IoReactivexInternalFuseableConditionalSubscriber_class_()), onFinally_)];
  }
  else {
    [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableDoFinally_DoFinallySubscriber_initWithOrgReactivestreamsSubscriber_withIoReactivexFunctionsAction_(s, onFinally_)];
  }
}
...
void IoReactivexInternalOperatorsFlowableFlowableDoFinally_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsAction_(IoReactivexInternalOperatorsFlowableFlowableDoFinally *self, id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsAction> onFinally) {
...
IoReactivexInternalOperatorsFlowableFlowableDoFinally *new_IoReactivexInternalOperatorsFlowableFlowableDoFinally_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsAction_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsAction> onFinally) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableDoFinally, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsAction_, source, onFinally)
}

IoReactivexInternalOperatorsFlowableFlowableDoFinally *create_IoReactivexInternalOperatorsFlowableFlowableDoFinally_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsAction_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsAction> onFinally) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableDoFinally, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsAction_, source, onFinally)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LIoReactivexFunctionsAction;", "(Lorg/reactivestreams/Subscriber<-TT;>;Lio/reactivex/functions/Action;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "request", "J", "requestFusion", "I", "LJavaLangException;", "()TT;", "Lorg/reactivestreams/Subscriber<-TT;>;", "Lio/reactivex/internal/fuseable/QueueSubscription<TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableDoFinally;", "<T:Ljava/lang/Object;>Lio/reactivex/internal/subscriptions/BasicIntQueueSubscription<TT;>;Lorg/reactivestreams/Subscriber<TT;>;" };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexInternalFuseableConditionalSubscriber;LIoReactivexFunctionsAction;", "(Lio/reactivex/internal/fuseable/ConditionalSubscriber<-TT;>;Lio/reactivex/functions/Action;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "tryOnNext", "(TT;)Z", "onError", "LNSException;", "request", "J", "requestFusion", "I", "LJavaLangException;", "()TT;", "Lio/reactivex/internal/fuseable/ConditionalSubscriber<-TT;>;", "Lio/reactivex/internal/fuseable/QueueSubscription<TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableDoFinally;", "<T:Ljava/lang/Object;>Lio/reactivex/internal/subscriptions/BasicIntQueueSubscription<TT;>;Lio/reactivex/internal/fuseable/ConditionalSubscriber<TT;>;" };
