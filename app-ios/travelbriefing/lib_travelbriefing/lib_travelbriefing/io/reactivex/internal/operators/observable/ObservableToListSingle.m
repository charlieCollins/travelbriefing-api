...
//  source: ../target/dependency/io/reactivex/internal/operators/observable/ObservableToListSingle.java
//
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexSingleObserver;LJavaUtilCollection;", "(Lio/reactivex/SingleObserver<-TU;>;TU;)V", "onSubscribe", "LIoReactivexDisposablesDisposable;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lio/reactivex/SingleObserver<-TU;>;", "TU;", "LIoReactivexInternalOperatorsObservableObservableToListSingle;", "<T:Ljava/lang/Object;U::Ljava/util/Collection<-TT;>;>Ljava/lang/Object;Lio/reactivex/Observer<TT;>;Lio/reactivex/disposables/Disposable;" };
