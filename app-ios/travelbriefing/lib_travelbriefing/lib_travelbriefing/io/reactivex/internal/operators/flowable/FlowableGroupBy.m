...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableGroupBy_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withIoReactivexFunctionsFunction_withInt_withBoolean_(self, source, keySelector, valueSelector, bufferSize, delayError);
  return self;
}

- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableGroupBy_GroupBySubscriber_initWithOrgReactivestreamsSubscriber_withIoReactivexFunctionsFunction_withIoReactivexFunctionsFunction_withInt_withBoolean_(s, keySelector_, valueSelector_, bufferSize_, delayError_)];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithOrgReactivestreamsPublisher:withIoReactivexFunctionsFunction:withIoReactivexFunctionsFunction:withInt:withBoolean:);
...
IoReactivexInternalOperatorsFlowableFlowableGroupBy *new_IoReactivexInternalOperatorsFlowableFlowableGroupBy_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withIoReactivexFunctionsFunction_withInt_withBoolean_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> keySelector, id<IoReactivexFunctionsFunction> valueSelector, jint bufferSize, jboolean delayError) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableGroupBy, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withIoReactivexFunctionsFunction_withInt_withBoolean_, source, keySelector, valueSelector, bufferSize, delayError)
}
...
IoReactivexInternalOperatorsFlowableFlowableGroupBy *create_IoReactivexInternalOperatorsFlowableFlowableGroupBy_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withIoReactivexFunctionsFunction_withInt_withBoolean_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> keySelector, id<IoReactivexFunctionsFunction> valueSelector, jint bufferSize, jboolean delayError) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableGroupBy, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withIoReactivexFunctionsFunction_withInt_withBoolean_, source, keySelector, valueSelector, bufferSize, delayError)
}
...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  for (IoReactivexInternalOperatorsFlowableFlowableGroupBy_GroupedUnicast * __strong g in nil_chk([((id<JavaUtilMap>) nil_chk(groups_)) values])) {
    [((IoReactivexInternalOperatorsFlowableFlowableGroupBy_GroupedUnicast *) nil_chk(g)) onErrorWithNSException:t];
  }
  [groups_ clear];
...
- (void)onErrorWithNSException:(NSException *)e {
  [((IoReactivexInternalOperatorsFlowableFlowableGroupBy_State *) nil_chk(state_)) onErrorWithNSException:e];
}
...
- (void)subscribeWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  if ([((JavaUtilConcurrentAtomicAtomicBoolean *) nil_chk(once_)) compareAndSetWithBoolean:false withBoolean:true]) {
    ...
    IoReactivexInternalSubscriptionsEmptySubscription_errorWithNSException_withOrgReactivestreamsSubscriber_(create_JavaLangIllegalStateException_initWithNSString_(@"Only one Subscriber allowed!"), s);
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "ILIoReactivexInternalOperatorsFlowableFlowableGroupBy_GroupBySubscriber;LNSObject;Z", "(ILio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber<*TK;TT;>;TK;Z)V", "request", "J", "subscribe", "LOrgReactivestreamsSubscriber;", "(Lorg/reactivestreams/Subscriber<-TT;>;)V", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "checkTerminated", "ZZLOrgReactivestreamsSubscriber;Z", "(ZZLorg/reactivestreams/Subscriber<-TT;>;Z)Z", "requestFusion", "I", "()TT;", "TK;", "Lio/reactivex/internal/queue/SpscLinkedArrayQueue<TT;>;", "Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber<*TK;TT;>;", "Ljava/util/concurrent/atomic/AtomicReference<Lorg/reactivestreams/Subscriber<-TT;>;>;", "LIoReactivexInternalOperatorsFlowableFlowableGroupBy;", "<T:Ljava/lang/Object;K:Ljava/lang/Object;>Lio/reactivex/internal/subscriptions/BasicIntQueueSubscription<TT;>;Lorg/reactivestreams/Publisher<TT;>;" };
