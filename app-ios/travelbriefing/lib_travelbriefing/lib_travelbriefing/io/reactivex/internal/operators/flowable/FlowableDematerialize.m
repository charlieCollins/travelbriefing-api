...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source {
  IoReactivexInternalOperatorsFlowableFlowableDematerialize_initWithOrgReactivestreamsPublisher_(self, source);
  return self;
}

- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableDematerialize_DematerializeSubscriber_initWithOrgReactivestreamsSubscriber_(s)];
}
...
void IoReactivexInternalOperatorsFlowableFlowableDematerialize_initWithOrgReactivestreamsPublisher_(IoReactivexInternalOperatorsFlowableFlowableDematerialize *self, id<OrgReactivestreamsPublisher> source) {
  IoReactivexInternalOperatorsFlowableAbstractFlowableWithUpstream_initWithOrgReactivestreamsPublisher_(self, source);
}

IoReactivexInternalOperatorsFlowableFlowableDematerialize *new_IoReactivexInternalOperatorsFlowableFlowableDematerialize_initWithOrgReactivestreamsPublisher_(id<OrgReactivestreamsPublisher> source) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableDematerialize, initWithOrgReactivestreamsPublisher_, source)
}

IoReactivexInternalOperatorsFlowableFlowableDematerialize *create_IoReactivexInternalOperatorsFlowableFlowableDematerialize_initWithOrgReactivestreamsPublisher_(id<OrgReactivestreamsPublisher> source) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableDematerialize, initWithOrgReactivestreamsPublisher_, source)
}
...
- (void)onNextWithId:(IoReactivexNotification *)t {
  if (done_) {
    if ([((IoReactivexNotification *) nil_chk(t)) isOnError]) {
      IoReactivexPluginsRxJavaPlugins_onErrorWithNSException_([t getError]);
    }
    return;
  }
  if ([((IoReactivexNotification *) nil_chk(t)) isOnError]) {
    [((id<OrgReactivestreamsSubscription>) nil_chk(s_)) cancel];
    [self onErrorWithNSException:[t getError]];
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;", "(Lorg/reactivestreams/Subscriber<-TT;>;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LIoReactivexNotification;", "(Lio/reactivex/Notification<TT;>;)V", "onError", "LNSException;", "request", "J", "Lorg/reactivestreams/Subscriber<-TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableDematerialize;", "<T:Ljava/lang/Object;>Ljava/lang/Object;Lorg/reactivestreams/Subscriber<Lio/reactivex/Notification<TT;>;>;Lorg/reactivestreams/Subscription;" };
