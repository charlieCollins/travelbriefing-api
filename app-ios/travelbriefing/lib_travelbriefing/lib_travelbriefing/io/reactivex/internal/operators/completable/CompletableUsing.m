...
- (void)subscribeActualWithIoReactivexCompletableObserver:(id<IoReactivexCompletableObserver>)observer {
  ...
  @catch (NSException *ex) {
    ...
    IoReactivexInternalDisposablesEmptyDisposable_errorWithNSException_withIoReactivexCompletableObserver_(ex, observer);
    return;
  }
  ...
  @catch (NSException *ex) {
    ...
    if (eager_) {
      ...
      @catch (NSException *exc) {
        ...
        IoReactivexInternalDisposablesEmptyDisposable_errorWithNSException_withIoReactivexCompletableObserver_(create_IoReactivexExceptionsCompositeException_initWithNSExceptionArray_([IOSObjectArray arrayWithObjects:(id[]){ ex, exc } count:2 type:NSException_class_()]), observer);
        return;
      }
    }
    IoReactivexInternalDisposablesEmptyDisposable_errorWithNSException_withIoReactivexCompletableObserver_(ex, observer);
