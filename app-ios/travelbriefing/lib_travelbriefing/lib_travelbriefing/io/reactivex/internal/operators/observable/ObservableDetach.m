...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  JreStrongAssign(&self->s_, JreLoadEnum(IoReactivexInternalUtilEmptyComponent, INSTANCE));
  JreStrongAssign(&self->actual_, IoReactivexInternalUtilEmptyComponent_asObserver());
  [((id<IoReactivexObserver>) nil_chk(a)) onErrorWithNSException:t];
}
