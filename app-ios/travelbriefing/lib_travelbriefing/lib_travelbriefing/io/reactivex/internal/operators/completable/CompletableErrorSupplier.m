...
//  source: ../target/dependency/io/reactivex/internal/operators/completable/CompletableErrorSupplier.java
//
...
- (void)subscribeActualWithIoReactivexCompletableObserver:(id<IoReactivexCompletableObserver>)s {
  ...
  IoReactivexInternalDisposablesEmptyDisposable_errorWithNSException_withIoReactivexCompletableObserver_(error, s);
}
