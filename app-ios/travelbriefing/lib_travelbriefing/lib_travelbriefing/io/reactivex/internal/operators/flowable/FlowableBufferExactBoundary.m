...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableBufferExactBoundary_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_(self, source, boundary, bufferSupplier);
  return self;
}

- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableBufferExactBoundary_BufferExactBoundarySubscriber_initWithOrgReactivestreamsSubscriber_withJavaUtilConcurrentCallable_withOrgReactivestreamsPublisher_(create_IoReactivexSubscribersSerializedSubscriber_initWithOrgReactivestreamsSubscriber_(s), bufferSupplier_, boundary_)];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithOrgReactivestreamsPublisher:withOrgReactivestreamsPublisher:withJavaUtilConcurrentCallable:);
...
IoReactivexInternalOperatorsFlowableFlowableBufferExactBoundary *new_IoReactivexInternalOperatorsFlowableFlowableBufferExactBoundary_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_(id<OrgReactivestreamsPublisher> source, id<OrgReactivestreamsPublisher> boundary, id<JavaUtilConcurrentCallable> bufferSupplier) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableBufferExactBoundary, initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_, source, boundary, bufferSupplier)
}

IoReactivexInternalOperatorsFlowableFlowableBufferExactBoundary *create_IoReactivexInternalOperatorsFlowableFlowableBufferExactBoundary_initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_(id<OrgReactivestreamsPublisher> source, id<OrgReactivestreamsPublisher> boundary, id<JavaUtilConcurrentCallable> bufferSupplier) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableBufferExactBoundary, initWithOrgReactivestreamsPublisher_withOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_, source, boundary, bufferSupplier)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LJavaUtilConcurrentCallable;LOrgReactivestreamsPublisher;", "(Lorg/reactivestreams/Subscriber<-TU;>;Ljava/util/concurrent/Callable<TU;>;Lorg/reactivestreams/Publisher<TB;>;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "request", "J", "accept", "LOrgReactivestreamsSubscriber;LJavaUtilCollection;", "(Lorg/reactivestreams/Subscriber<-TU;>;TU;)Z", "Ljava/util/concurrent/Callable<TU;>;", "Lorg/reactivestreams/Publisher<TB;>;", "TU;", "LIoReactivexInternalOperatorsFlowableFlowableBufferExactBoundary;", "<T:Ljava/lang/Object;U::Ljava/util/Collection<-TT;>;B:Ljava/lang/Object;>Lio/reactivex/internal/subscribers/QueueDrainSubscriber<TT;TU;TU;>;Lorg/reactivestreams/Subscriber<TT;>;Lorg/reactivestreams/Subscription;Lio/reactivex/disposables/Disposable;" };
...
- (void)onErrorWithNSException:(NSException *)t {
  [((IoReactivexInternalOperatorsFlowableFlowableBufferExactBoundary_BufferExactBoundarySubscriber *) nil_chk(parent_)) onErrorWithNSException:t];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexInternalOperatorsFlowableFlowableBufferExactBoundary_BufferExactBoundarySubscriber;", "(Lio/reactivex/internal/operators/flowable/FlowableBufferExactBoundary$BufferExactBoundarySubscriber<TT;TU;TB;>;)V", "onNext", "LNSObject;", "(TB;)V", "onError", "LNSException;", "Lio/reactivex/internal/operators/flowable/FlowableBufferExactBoundary$BufferExactBoundarySubscriber<TT;TU;TB;>;", "LIoReactivexInternalOperatorsFlowableFlowableBufferExactBoundary;", "<T:Ljava/lang/Object;U::Ljava/util/Collection<-TT;>;B:Ljava/lang/Object;>Lio/reactivex/subscribers/DisposableSubscriber<TB;>;" };
