  ...
  for (; ; ) {
    ...
    if (q1 != nil && q2 != nil) {
      for (; ; ) {
        ...
        if (ex != nil) {
          [self cancelAndClear];
          [((id<IoReactivexSingleObserver>) nil_chk(actual_)) onErrorWithNSException:[error_ terminate]];
          return;
        }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[6].selector = @selector(innerErrorWithNSException:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
