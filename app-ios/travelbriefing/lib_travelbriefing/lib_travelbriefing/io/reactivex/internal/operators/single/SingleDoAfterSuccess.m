...
//  source: ../target/dependency/io/reactivex/internal/operators/single/SingleDoAfterSuccess.java
//
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexSingleObserver;LIoReactivexFunctionsConsumer;", "(Lio/reactivex/SingleObserver<-TT;>;Lio/reactivex/functions/Consumer<-TT;>;)V", "onSubscribe", "LIoReactivexDisposablesDisposable;", "onSuccess", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lio/reactivex/SingleObserver<-TT;>;", "Lio/reactivex/functions/Consumer<-TT;>;", "LIoReactivexInternalOperatorsSingleSingleDoAfterSuccess;", "<T:Ljava/lang/Object;>Ljava/lang/Object;Lio/reactivex/SingleObserver<TT;>;Lio/reactivex/disposables/Disposable;" };
