...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableFlatMapCompletable_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withBoolean_withInt_(self, source, mapper, delayErrors, maxConcurrency);
  return self;
}

- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)observer {
  [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableFlatMapCompletable_FlatMapCompletableMainSubscriber_initWithOrgReactivestreamsSubscriber_withIoReactivexFunctionsFunction_withBoolean_withInt_(observer, mapper_, delayErrors_, maxConcurrency_)];
}
...
IoReactivexInternalOperatorsFlowableFlowableFlatMapCompletable *new_IoReactivexInternalOperatorsFlowableFlowableFlatMapCompletable_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withBoolean_withInt_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> mapper, jboolean delayErrors, jint maxConcurrency) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableFlatMapCompletable, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withBoolean_withInt_, source, mapper, delayErrors, maxConcurrency)
}
...
IoReactivexInternalOperatorsFlowableFlowableFlatMapCompletable *create_IoReactivexInternalOperatorsFlowableFlowableFlatMapCompletable_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withBoolean_withInt_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> mapper, jboolean delayErrors, jint maxConcurrency) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableFlatMapCompletable, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withBoolean_withInt_, source, mapper, delayErrors, maxConcurrency)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[12].selector = @selector(innerErrorWithIoReactivexInternalOperatorsFlowableFlowableFlatMapCompletable_FlatMapCompletableMainSubscriber_InnerConsumer:withNSException:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LIoReactivexFunctionsFunction;ZI", "(Lorg/reactivestreams/Subscriber<-TT;>;Lio/reactivex/functions/Function<-TT;+Lio/reactivex/CompletableSource;>;ZI)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "request", "J", "LJavaLangException;", "()TT;", "requestFusion", "I", "innerComplete", "LIoReactivexInternalOperatorsFlowableFlowableFlatMapCompletable_FlatMapCompletableMainSubscriber_InnerConsumer;", "innerError", "LIoReactivexInternalOperatorsFlowableFlowableFlatMapCompletable_FlatMapCompletableMainSubscriber_InnerConsumer;LNSException;", "Lorg/reactivestreams/Subscriber<-TT;>;", "Lio/reactivex/functions/Function<-TT;+Lio/reactivex/CompletableSource;>;", "LIoReactivexInternalOperatorsFlowableFlowableFlatMapCompletable;", "<T:Ljava/lang/Object;>Lio/reactivex/internal/subscriptions/BasicIntQueueSubscription<TT;>;Lorg/reactivestreams/Subscriber<TT;>;" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsFlowableFlowableFlatMapCompletable_FlatMapCompletableMainSubscriber = { "FlatMapCompletableMainSubscriber", "io.reactivex.internal.operators.flowable", ptrTable, methods, fields, 7, 0x18, 13, 8, 21, 16, -1, 22, -1 };
...
- (void)onErrorWithNSException:(NSException *)e {
  [this$0_ innerErrorWithIoReactivexInternalOperatorsFlowableFlowableFlatMapCompletable_FlatMapCompletableMainSubscriber_InnerConsumer:self withNSException:e];
}
