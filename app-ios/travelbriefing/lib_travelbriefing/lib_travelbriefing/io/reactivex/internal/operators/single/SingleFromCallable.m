...
//  source: ../target/dependency/io/reactivex/internal/operators/single/SingleFromCallable.java
//
...
- (void)subscribeActualWithIoReactivexSingleObserver:(id<IoReactivexSingleObserver>)s {
  ...
  @try {
    ...
    if (v != nil) {
      ...
      [s onErrorWithNSException:create_JavaLangNullPointerException_initWithNSString_(@"The callable returned a null value")];
    }
  }
  @catch (NSException *e) {
