...
@interface IoReactivexInternalOperatorsFlowableFlowableDoOnLifecycle_SubscriptionLambdaSubscriber : NSObject < OrgReactivestreamsSubscriber, OrgReactivestreamsSubscription > {
 @public
...
J2OBJC_FIELD_SETTER(IoReactivexInternalOperatorsFlowableFlowableDoOnLifecycle_SubscriptionLambdaSubscriber, s_, id<OrgReactivestreamsSubscription>)
