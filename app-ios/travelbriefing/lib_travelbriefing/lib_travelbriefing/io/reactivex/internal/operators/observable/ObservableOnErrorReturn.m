...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  @catch (NSException *e) {
    ...
    [((id<IoReactivexObserver>) nil_chk(actual_)) onErrorWithNSException:create_IoReactivexExceptionsCompositeException_initWithNSExceptionArray_([IOSObjectArray arrayWithObjects:(id[]){ t, e } count:2 type:NSException_class_()])];
    return;
  }
  if (v == nil) {
    JavaLangNullPointerException *e = create_JavaLangNullPointerException_initWithNSString_(@"The supplied value is null");
    [e initCauseWithNSException:t];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexObserver;LIoReactivexFunctionsFunction;", "(Lio/reactivex/Observer<-TT;>;Lio/reactivex/functions/Function<-Ljava/lang/Throwable;+TT;>;)V", "onSubscribe", "LIoReactivexDisposablesDisposable;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lio/reactivex/Observer<-TT;>;", "Lio/reactivex/functions/Function<-Ljava/lang/Throwable;+TT;>;", "LIoReactivexInternalOperatorsObservableObservableOnErrorReturn;", "<T:Ljava/lang/Object;>Ljava/lang/Object;Lio/reactivex/Observer<TT;>;Lio/reactivex/disposables/Disposable;" };
