...
@interface IoReactivexInternalOperatorsMaybeMaybeDelayOtherPublisher_OtherSubscriber : JavaUtilConcurrentAtomicAtomicReference < OrgReactivestreamsSubscriber > {
 @public
...
J2OBJC_FIELD_SETTER(IoReactivexInternalOperatorsMaybeMaybeDelayOtherPublisher_OtherSubscriber, error_, NSException *)
