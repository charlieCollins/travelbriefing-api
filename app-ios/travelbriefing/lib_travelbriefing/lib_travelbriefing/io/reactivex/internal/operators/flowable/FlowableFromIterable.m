...
//  source: ../target/dependency/io/reactivex/internal/operators/flowable/FlowableFromIterable.java
//
...
- (void)fastPath {
  ...
  for (; ; ) {
    ...
    if (t == nil) {
      [((id<OrgReactivestreamsSubscriber>) nil_chk(a)) onErrorWithNSException:create_JavaLangNullPointerException_initWithNSString_(@"Iterator.next() returned a null value")];
      return;
    }
    else {
...
- (void)fastPath {
  ...
  for (; ; ) {
    ...
    if (t == nil) {
      [((id<IoReactivexInternalFuseableConditionalSubscriber>) nil_chk(a)) onErrorWithNSException:create_JavaLangNullPointerException_initWithNSString_(@"Iterator.next() returned a null value")];
      return;
    }
    else {
