...
//  source: ../target/dependency/io/reactivex/internal/operators/maybe/MaybePeek.java
//
...
- (void)onSubscribeWithIoReactivexDisposablesDisposable:(id<IoReactivexDisposablesDisposable>)d {
  if (IoReactivexInternalDisposablesDisposableHelper_validateWithIoReactivexDisposablesDisposable_withIoReactivexDisposablesDisposable_(self->d_, d)) {
    ...
    @catch (NSException *ex) {
      ...
      IoReactivexInternalDisposablesEmptyDisposable_errorWithNSException_withIoReactivexMaybeObserver_(ex, actual_);
      return;
    }
...
- (void)onSuccessWithId:(id)value {
  ...
  @catch (NSException *ex) {
    IoReactivexExceptionsExceptions_throwIfFatalWithNSException_(ex);
    [self onErrorInnerWithNSException:ex];
    return;
  }
  JreStrongAssign(&self->d_, JreLoadEnum(IoReactivexInternalDisposablesDisposableHelper, DISPOSED));
...
- (void)onErrorWithNSException:(NSException *)e {
  ...
  [self onErrorInnerWithNSException:e];
}

- (void)onErrorInnerWithNSException:(NSException *)e {
  @try {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[6].selector = @selector(onErrorInnerWithNSException:);
  ...
  static const void *ptrTable[] = { "LIoReactivexMaybeObserver;LIoReactivexInternalOperatorsMaybeMaybePeek;", "(Lio/reactivex/MaybeObserver<-TT;>;Lio/reactivex/internal/operators/maybe/MaybePeek<TT;>;)V", "onSubscribe", "LIoReactivexDisposablesDisposable;", "onSuccess", "LNSObject;", "(TT;)V", "onError", "LNSException;", "onErrorInner", "Lio/reactivex/MaybeObserver<-TT;>;", "Lio/reactivex/internal/operators/maybe/MaybePeek<TT;>;", "LIoReactivexInternalOperatorsMaybeMaybePeek;", "<T:Ljava/lang/Object;>Ljava/lang/Object;Lio/reactivex/MaybeObserver<TT;>;Lio/reactivex/disposables/Disposable;" };
