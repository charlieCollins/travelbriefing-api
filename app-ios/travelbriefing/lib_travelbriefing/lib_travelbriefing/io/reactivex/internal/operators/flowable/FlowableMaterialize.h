...
FOUNDATION_EXPORT void IoReactivexInternalOperatorsFlowableFlowableMaterialize_initWithOrgReactivestreamsPublisher_(IoReactivexInternalOperatorsFlowableFlowableMaterialize *self, id<OrgReactivestreamsPublisher> source);

FOUNDATION_EXPORT IoReactivexInternalOperatorsFlowableFlowableMaterialize *new_IoReactivexInternalOperatorsFlowableFlowableMaterialize_initWithOrgReactivestreamsPublisher_(id<OrgReactivestreamsPublisher> source) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT IoReactivexInternalOperatorsFlowableFlowableMaterialize *create_IoReactivexInternalOperatorsFlowableFlowableMaterialize_initWithOrgReactivestreamsPublisher_(id<OrgReactivestreamsPublisher> source);
