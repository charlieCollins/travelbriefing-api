...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableWindow_initWithOrgReactivestreamsPublisher_withLong_withLong_withInt_(self, source, size, skip, bufferSize);
  return self;
}

- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  if (skip_ == size_) {
    [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableWindow_WindowExactSubscriber_initWithOrgReactivestreamsSubscriber_withLong_withInt_(s, size_, bufferSize_)];
  }
  else if (skip_ > size_) {
    [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableWindow_WindowSkipSubscriber_initWithOrgReactivestreamsSubscriber_withLong_withLong_withInt_(s, size_, skip_, bufferSize_)];
  }
  else {
    [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableWindow_WindowOverlapSubscriber_initWithOrgReactivestreamsSubscriber_withLong_withLong_withInt_(s, size_, skip_, bufferSize_)];
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithOrgReactivestreamsPublisher:withLong:withLong:withInt:);
...
void IoReactivexInternalOperatorsFlowableFlowableWindow_initWithOrgReactivestreamsPublisher_withLong_withLong_withInt_(IoReactivexInternalOperatorsFlowableFlowableWindow *self, id<OrgReactivestreamsPublisher> source, jlong size, jlong skip, jint bufferSize) {
...
IoReactivexInternalOperatorsFlowableFlowableWindow *new_IoReactivexInternalOperatorsFlowableFlowableWindow_initWithOrgReactivestreamsPublisher_withLong_withLong_withInt_(id<OrgReactivestreamsPublisher> source, jlong size, jlong skip, jint bufferSize) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableWindow, initWithOrgReactivestreamsPublisher_withLong_withLong_withInt_, source, size, skip, bufferSize)
}

IoReactivexInternalOperatorsFlowableFlowableWindow *create_IoReactivexInternalOperatorsFlowableFlowableWindow_initWithOrgReactivestreamsPublisher_withLong_withLong_withInt_(id<OrgReactivestreamsPublisher> source, jlong size, jlong skip, jint bufferSize) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableWindow, initWithOrgReactivestreamsPublisher_withLong_withLong_withInt_, source, size, skip, bufferSize)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;JI", "(Lorg/reactivestreams/Subscriber<-Lio/reactivex/Flowable<TT;>;>;JI)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "request", "J", "Lorg/reactivestreams/Subscriber<-Lio/reactivex/Flowable<TT;>;>;", "Lio/reactivex/processors/UnicastProcessor<TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableWindow;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicInteger;Lorg/reactivestreams/Subscriber<TT;>;Lorg/reactivestreams/Subscription;Ljava/lang/Runnable;" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsFlowableFlowableWindow_WindowExactSubscriber = { "WindowExactSubscriber", "io.reactivex.internal.operators.flowable", ptrTable, methods, fields, 7, 0x18, 8, 9, 13, -1, -1, 14, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;JJI", "(Lorg/reactivestreams/Subscriber<-Lio/reactivex/Flowable<TT;>;>;JJI)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "request", "J", "Lorg/reactivestreams/Subscriber<-Lio/reactivex/Flowable<TT;>;>;", "Lio/reactivex/processors/UnicastProcessor<TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableWindow;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicInteger;Lorg/reactivestreams/Subscriber<TT;>;Lorg/reactivestreams/Subscription;Ljava/lang/Runnable;" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsFlowableFlowableWindow_WindowSkipSubscriber = { "WindowSkipSubscriber", "io.reactivex.internal.operators.flowable", ptrTable, methods, fields, 7, 0x18, 8, 11, 13, -1, -1, 14, -1 };
...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  for (id<OrgReactivestreamsProcessor> __strong w in nil_chk(windows_)) {
    [((id<OrgReactivestreamsProcessor>) nil_chk(w)) onErrorWithNSException:t];
  }
  [windows_ clear];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;JJI", "(Lorg/reactivestreams/Subscriber<-Lio/reactivex/Flowable<TT;>;>;JJI)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "checkTerminated", "ZZLOrgReactivestreamsSubscriber;LIoReactivexInternalQueueSpscLinkedArrayQueue;", "(ZZLorg/reactivestreams/Subscriber<*>;Lio/reactivex/internal/queue/SpscLinkedArrayQueue<*>;)Z", "request", "J", "Lorg/reactivestreams/Subscriber<-Lio/reactivex/Flowable<TT;>;>;", "Lio/reactivex/internal/queue/SpscLinkedArrayQueue<Lio/reactivex/processors/UnicastProcessor<TT;>;>;", "Ljava/util/ArrayDeque<Lio/reactivex/processors/UnicastProcessor<TT;>;>;", "LIoReactivexInternalOperatorsFlowableFlowableWindow;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicInteger;Lorg/reactivestreams/Subscriber<TT;>;Lorg/reactivestreams/Subscription;Ljava/lang/Runnable;" };
