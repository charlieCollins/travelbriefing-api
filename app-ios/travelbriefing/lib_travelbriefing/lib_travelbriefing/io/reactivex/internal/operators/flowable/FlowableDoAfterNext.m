...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableDoAfterNext_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsConsumer_(self, source, onAfterNext);
  return self;
}

- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  if ([IoReactivexInternalFuseableConditionalSubscriber_class_() isInstance:s]) {
    [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableDoAfterNext_DoAfterConditionalSubscriber_initWithIoReactivexInternalFuseableConditionalSubscriber_withIoReactivexFunctionsConsumer_((id<IoReactivexInternalFuseableConditionalSubscriber>) cast_check(s, IoReactivexInternalFuseableConditionalSubscriber_class_()), onAfterNext_)];
  }
  else {
    [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableDoAfterNext_DoAfterSubscriber_initWithOrgReactivestreamsSubscriber_withIoReactivexFunctionsConsumer_(s, onAfterNext_)];
  }
}
...
void IoReactivexInternalOperatorsFlowableFlowableDoAfterNext_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsConsumer_(IoReactivexInternalOperatorsFlowableFlowableDoAfterNext *self, id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsConsumer> onAfterNext) {
...
IoReactivexInternalOperatorsFlowableFlowableDoAfterNext *new_IoReactivexInternalOperatorsFlowableFlowableDoAfterNext_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsConsumer_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsConsumer> onAfterNext) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableDoAfterNext, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsConsumer_, source, onAfterNext)
}

IoReactivexInternalOperatorsFlowableFlowableDoAfterNext *create_IoReactivexInternalOperatorsFlowableFlowableDoAfterNext_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsConsumer_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsConsumer> onAfterNext) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableDoAfterNext, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsConsumer_, source, onAfterNext)
}
