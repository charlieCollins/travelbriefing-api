...
//  source: ../target/dependency/io/reactivex/internal/operators/observable/ObservableAmb.java
//
  ...
  if (sources == nil) {
    ...
    @try {
      for (id<IoReactivexObservableSource> __strong p in nil_chk(sourcesIterable_)) {
        if (p == nil) {
          IoReactivexInternalDisposablesEmptyDisposable_errorWithNSException_withIoReactivexObserver_(create_JavaLangNullPointerException_initWithNSString_(@"One of the sources is null"), s);
          return;
        }
