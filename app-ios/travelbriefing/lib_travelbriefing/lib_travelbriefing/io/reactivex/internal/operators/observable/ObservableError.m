...
//  source: ../target/dependency/io/reactivex/internal/operators/observable/ObservableError.java
//
...
- (void)subscribeActualWithIoReactivexObserver:(id<IoReactivexObserver>)s {
  ...
  IoReactivexInternalDisposablesEmptyDisposable_errorWithNSException_withIoReactivexObserver_(error, s);
}
