...
FOUNDATION_EXPORT void IoReactivexInternalOperatorsFlowableFlowableTake_initWithOrgReactivestreamsPublisher_withLong_(IoReactivexInternalOperatorsFlowableFlowableTake *self, id<OrgReactivestreamsPublisher> source, jlong limit);

FOUNDATION_EXPORT IoReactivexInternalOperatorsFlowableFlowableTake *new_IoReactivexInternalOperatorsFlowableFlowableTake_initWithOrgReactivestreamsPublisher_withLong_(id<OrgReactivestreamsPublisher> source, jlong limit) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT IoReactivexInternalOperatorsFlowableFlowableTake *create_IoReactivexInternalOperatorsFlowableFlowableTake_initWithOrgReactivestreamsPublisher_withLong_(id<OrgReactivestreamsPublisher> source, jlong limit);
...
@interface IoReactivexInternalOperatorsFlowableFlowableTake_TakeSubscriber : JavaUtilConcurrentAtomicAtomicBoolean < OrgReactivestreamsSubscriber, OrgReactivestreamsSubscription > {
 @public
  jboolean done_;
