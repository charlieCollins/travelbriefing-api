...
- (void)subscribeWithOrgReactivestreamsPublisherArray:(IOSObjectArray *)sources
  ...
  for (jint i = 0; i < n; i++) {
    if (JreLoadVolatileBoolean(&done_) || JreLoadVolatileBoolean(&cancelled_) || (!delayErrors_ && [((IoReactivexInternalUtilAtomicThrowable *) nil_chk(errors_)) get] != nil)) {
      return;
    }
  ...
  for (; ; ) {
    ...
    while (r != e) {
      ...
      if (!delayErrors_ && [((IoReactivexInternalUtilAtomicThrowable *) nil_chk(errors_)) get] != nil) {
        [self cancelAll];
        [((id<OrgReactivestreamsSubscriber>) nil_chk(a)) onErrorWithNSException:[((IoReactivexInternalUtilAtomicThrowable *) nil_chk(errors_)) terminate]];
        return;
      }
      ...
      for (jint j = 0; j < n; j++) {
        ...
        if (IOSObjectArray_Get(nil_chk(values), j) == nil) {
          ...
          @catch (NSException *ex) {
            ...
            [((IoReactivexInternalUtilAtomicThrowable *) nil_chk(errors_)) addThrowableWithNSException:ex];
            if (!delayErrors_) {
              [self cancelAll];
              [((id<OrgReactivestreamsSubscriber>) nil_chk(a)) onErrorWithNSException:[errors_ terminate]];
              return;
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[4].selector = @selector(errorWithIoReactivexInternalOperatorsFlowableFlowableZip_ZipSubscriber:withNSException:);
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LIoReactivexFunctionsFunction;IIZ", "(Lorg/reactivestreams/Subscriber<-TR;>;Lio/reactivex/functions/Function<-[Ljava/lang/Object;+TR;>;IIZ)V", "subscribe", "[LOrgReactivestreamsPublisher;I", "([Lorg/reactivestreams/Publisher<+TT;>;I)V", "request", "J", "error", "LIoReactivexInternalOperatorsFlowableFlowableZip_ZipSubscriber;LNSException;", "(Lio/reactivex/internal/operators/flowable/FlowableZip$ZipSubscriber<TT;TR;>;Ljava/lang/Throwable;)V", "Lorg/reactivestreams/Subscriber<-TR;>;", "[Lio/reactivex/internal/operators/flowable/FlowableZip$ZipSubscriber<TT;TR;>;", "Lio/reactivex/functions/Function<-[Ljava/lang/Object;+TR;>;", "LIoReactivexInternalOperatorsFlowableFlowableZip;", "<T:Ljava/lang/Object;R:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicInteger;Lorg/reactivestreams/Subscription;" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsFlowableFlowableZip_ZipCoordinator = { "ZipCoordinator", "io.reactivex.internal.operators.flowable", ptrTable, methods, fields, 7, 0x18, 7, 10, 13, -1, -1, 14, -1 };
...
void IoReactivexInternalOperatorsFlowableFlowableZip_ZipCoordinator_initWithOrgReactivestreamsSubscriber_withIoReactivexFunctionsFunction_withInt_withInt_withBoolean_(IoReactivexInternalOperatorsFlowableFlowableZip_ZipCoordinator *self, id<OrgReactivestreamsSubscriber> actual, id<IoReactivexFunctionsFunction> zipper, jint n, jint prefetch, jboolean delayErrors) {
  ...
  for (jint i = 0; i < n; i++) {
    IOSObjectArray_SetAndConsume(a, i, new_IoReactivexInternalOperatorsFlowableFlowableZip_ZipSubscriber_initWithIoReactivexInternalOperatorsFlowableFlowableZip_ZipCoordinator_withInt_withInt_(self, prefetch, i));
  }
...
- (instancetype)initWithIoReactivexInternalOperatorsFlowableFlowableZip_ZipCoordinator:(IoReactivexInternalOperatorsFlowableFlowableZip_ZipCoordinator *)parent
                                                                               withInt:(jint)prefetch
                                                                               withInt:(jint)index {
  IoReactivexInternalOperatorsFlowableFlowableZip_ZipSubscriber_initWithIoReactivexInternalOperatorsFlowableFlowableZip_ZipCoordinator_withInt_withInt_(self, parent, prefetch, index);
  return self;
}
...
- (void)onErrorWithNSException:(NSException *)t {
  [((IoReactivexInternalOperatorsFlowableFlowableZip_ZipCoordinator *) nil_chk(parent_)) errorWithIoReactivexInternalOperatorsFlowableFlowableZip_ZipSubscriber:self withNSException:t];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  methods[0].selector = @selector(initWithIoReactivexInternalOperatorsFlowableFlowableZip_ZipCoordinator:withInt:withInt:);
  ...
  static const void *ptrTable[] = { "LIoReactivexInternalOperatorsFlowableFlowableZip_ZipCoordinator;II", "(Lio/reactivex/internal/operators/flowable/FlowableZip$ZipCoordinator<TT;TR;>;II)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "request", "J", "Lio/reactivex/internal/operators/flowable/FlowableZip$ZipCoordinator<TT;TR;>;", "Lio/reactivex/internal/fuseable/SimpleQueue<TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableZip;", "<T:Ljava/lang/Object;R:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicReference<Lorg/reactivestreams/Subscription;>;Lorg/reactivestreams/Subscriber<TT;>;Lorg/reactivestreams/Subscription;" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsFlowableFlowableZip_ZipSubscriber = { "ZipSubscriber", "io.reactivex.internal.operators.flowable", ptrTable, methods, fields, 7, 0x18, 7, 9, 13, -1, -1, 14, -1 };
...
IoReactivexInternalOperatorsFlowableFlowableZip_ZipSubscriber *new_IoReactivexInternalOperatorsFlowableFlowableZip_ZipSubscriber_initWithIoReactivexInternalOperatorsFlowableFlowableZip_ZipCoordinator_withInt_withInt_(IoReactivexInternalOperatorsFlowableFlowableZip_ZipCoordinator *parent, jint prefetch, jint index) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableZip_ZipSubscriber, initWithIoReactivexInternalOperatorsFlowableFlowableZip_ZipCoordinator_withInt_withInt_, parent, prefetch, index)
}

IoReactivexInternalOperatorsFlowableFlowableZip_ZipSubscriber *create_IoReactivexInternalOperatorsFlowableFlowableZip_ZipSubscriber_initWithIoReactivexInternalOperatorsFlowableFlowableZip_ZipCoordinator_withInt_withInt_(IoReactivexInternalOperatorsFlowableFlowableZip_ZipCoordinator *parent, jint prefetch, jint index) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableZip_ZipSubscriber, initWithIoReactivexInternalOperatorsFlowableFlowableZip_ZipCoordinator_withInt_withInt_, parent, prefetch, index)
}
