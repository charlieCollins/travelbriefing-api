...
//  source: ../target/dependency/io/reactivex/internal/operators/parallel/ParallelCollect.java
//
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexParallelParallelFlowable;LJavaUtilConcurrentCallable;LIoReactivexFunctionsBiConsumer;", "(Lio/reactivex/parallel/ParallelFlowable<+TT;>;Ljava/util/concurrent/Callable<+TC;>;Lio/reactivex/functions/BiConsumer<-TC;-TT;>;)V", "subscribe", "[LOrgReactivestreamsSubscriber;", "([Lorg/reactivestreams/Subscriber<-TC;>;)V", "reportError", "[LOrgReactivestreamsSubscriber;LNSException;", "([Lorg/reactivestreams/Subscriber<*>;Ljava/lang/Throwable;)V", "Lio/reactivex/parallel/ParallelFlowable<+TT;>;", "Ljava/util/concurrent/Callable<+TC;>;", "Lio/reactivex/functions/BiConsumer<-TC;-TT;>;", "LIoReactivexInternalOperatorsParallelParallelCollect_ParallelCollectSubscriber;", "<T:Ljava/lang/Object;C:Ljava/lang/Object;>Lio/reactivex/parallel/ParallelFlowable<TC;>;" };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LNSObject;LIoReactivexFunctionsBiConsumer;", "(Lorg/reactivestreams/Subscriber<-TC;>;TC;Lio/reactivex/functions/BiConsumer<-TC;-TT;>;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lio/reactivex/functions/BiConsumer<-TC;-TT;>;", "TC;", "LIoReactivexInternalOperatorsParallelParallelCollect;", "<T:Ljava/lang/Object;C:Ljava/lang/Object;>Lio/reactivex/internal/subscribers/DeferredScalarSubscriber<TT;TC;>;" };
