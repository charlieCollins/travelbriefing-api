        ...
        if ([((id<JavaUtilList>) nil_chk(list)) size] != index) {
          if (min == nil) {
            ...
            @catch (NSException *exc) {
              ...
              [((id<OrgReactivestreamsSubscriber>) nil_chk(a)) onErrorWithNSException:[error_ get]];
              return;
            }
            if (smaller) {
              min = b;
...
- (void)onErrorWithNSException:(NSException *)t {
  [((IoReactivexInternalOperatorsParallelParallelSortedJoin_SortedJoinSubscription *) nil_chk(parent_)) innerErrorWithNSException:t];
}
