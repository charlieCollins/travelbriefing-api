...
//  source: ../target/dependency/io/reactivex/internal/operators/flowable/FlowableTake.java
//
...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableTake_initWithOrgReactivestreamsPublisher_withLong_(self, source, limit);
  return self;
}
...
void IoReactivexInternalOperatorsFlowableFlowableTake_initWithOrgReactivestreamsPublisher_withLong_(IoReactivexInternalOperatorsFlowableFlowableTake *self, id<OrgReactivestreamsPublisher> source, jlong limit) {
  IoReactivexInternalOperatorsFlowableAbstractFlowableWithUpstream_initWithOrgReactivestreamsPublisher_(self, source);
  self->limit_ = limit;
}

IoReactivexInternalOperatorsFlowableFlowableTake *new_IoReactivexInternalOperatorsFlowableFlowableTake_initWithOrgReactivestreamsPublisher_withLong_(id<OrgReactivestreamsPublisher> source, jlong limit) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableTake, initWithOrgReactivestreamsPublisher_withLong_, source, limit)
}

IoReactivexInternalOperatorsFlowableFlowableTake *create_IoReactivexInternalOperatorsFlowableFlowableTake_initWithOrgReactivestreamsPublisher_withLong_(id<OrgReactivestreamsPublisher> source, jlong limit) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableTake, initWithOrgReactivestreamsPublisher_withLong_, source, limit)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;J", "(Lorg/reactivestreams/Subscriber<-TT;>;J)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "request", "J", "Lorg/reactivestreams/Subscriber<-TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableTake;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicBoolean;Lorg/reactivestreams/Subscriber<TT;>;Lorg/reactivestreams/Subscription;" };
