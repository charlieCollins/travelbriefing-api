...
//  source: ../target/dependency/io/reactivex/internal/operators/maybe/MaybeDelayOtherPublisher.java
//
...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  if (e == nil) {
    ...
    [((id<IoReactivexMaybeObserver>) nil_chk(actual_)) onErrorWithNSException:create_IoReactivexExceptionsCompositeException_initWithNSExceptionArray_([IOSObjectArray arrayWithObjects:(id[]){ e, t } count:2 type:NSException_class_()])];
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexMaybeObserver;", "(Lio/reactivex/MaybeObserver<-TT;>;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "onError", "LNSException;", "Lio/reactivex/MaybeObserver<-TT;>;", "value", "TT;", "LIoReactivexInternalOperatorsMaybeMaybeDelayOtherPublisher;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicReference<Lorg/reactivestreams/Subscription;>;Lorg/reactivestreams/Subscriber<Ljava/lang/Object;>;" };
