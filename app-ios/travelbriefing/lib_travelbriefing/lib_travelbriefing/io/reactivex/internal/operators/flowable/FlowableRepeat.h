...
FOUNDATION_EXPORT void IoReactivexInternalOperatorsFlowableFlowableRepeat_initWithOrgReactivestreamsPublisher_withLong_(IoReactivexInternalOperatorsFlowableFlowableRepeat *self, id<OrgReactivestreamsPublisher> source, jlong count);

FOUNDATION_EXPORT IoReactivexInternalOperatorsFlowableFlowableRepeat *new_IoReactivexInternalOperatorsFlowableFlowableRepeat_initWithOrgReactivestreamsPublisher_withLong_(id<OrgReactivestreamsPublisher> source, jlong count) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT IoReactivexInternalOperatorsFlowableFlowableRepeat *create_IoReactivexInternalOperatorsFlowableFlowableRepeat_initWithOrgReactivestreamsPublisher_withLong_(id<OrgReactivestreamsPublisher> source, jlong count);
...
@interface IoReactivexInternalOperatorsFlowableFlowableRepeat_RepeatSubscriber : JavaUtilConcurrentAtomicAtomicInteger < OrgReactivestreamsSubscriber > {
 @public
