...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[5].selector = @selector(errorWithIoReactivexInternalOperatorsMaybeMaybeEqualSingle_EqualObserver:withNSException:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
  ...
  static const void *ptrTable[] = { "LIoReactivexSingleObserver;LIoReactivexFunctionsBiPredicate;", "(Lio/reactivex/SingleObserver<-Ljava/lang/Boolean;>;Lio/reactivex/functions/BiPredicate<-TT;-TT;>;)V", "subscribe", "LIoReactivexMaybeSource;LIoReactivexMaybeSource;", "(Lio/reactivex/MaybeSource<+TT;>;Lio/reactivex/MaybeSource<+TT;>;)V", "error", "LIoReactivexInternalOperatorsMaybeMaybeEqualSingle_EqualObserver;LNSException;", "(Lio/reactivex/internal/operators/maybe/MaybeEqualSingle$EqualObserver<TT;>;Ljava/lang/Throwable;)V", "Lio/reactivex/SingleObserver<-Ljava/lang/Boolean;>;", "Lio/reactivex/internal/operators/maybe/MaybeEqualSingle$EqualObserver<TT;>;", "Lio/reactivex/functions/BiPredicate<-TT;-TT;>;", "LIoReactivexInternalOperatorsMaybeMaybeEqualSingle;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicInteger;Lio/reactivex/disposables/Disposable;" };
...
- (void)onErrorWithNSException:(NSException *)e {
  [((IoReactivexInternalOperatorsMaybeMaybeEqualSingle_EqualCoordinator *) nil_chk(parent_)) errorWithIoReactivexInternalOperatorsMaybeMaybeEqualSingle_EqualObserver:self withNSException:e];
}
