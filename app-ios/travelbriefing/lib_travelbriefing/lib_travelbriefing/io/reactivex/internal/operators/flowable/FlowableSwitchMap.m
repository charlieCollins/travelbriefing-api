...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableSwitchMap_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_withBoolean_(self, source, mapper, bufferSize, delayErrors);
  return self;
}
...
- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  ...
  [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableSwitchMap_SwitchMapSubscriber_initWithOrgReactivestreamsSubscriber_withIoReactivexFunctionsFunction_withInt_withBoolean_(s, mapper_, bufferSize_, delayErrors_)];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithOrgReactivestreamsPublisher:withIoReactivexFunctionsFunction:withInt:withBoolean:);
...
IoReactivexInternalOperatorsFlowableFlowableSwitchMap *new_IoReactivexInternalOperatorsFlowableFlowableSwitchMap_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_withBoolean_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> mapper, jint bufferSize, jboolean delayErrors) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableSwitchMap, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_withBoolean_, source, mapper, bufferSize, delayErrors)
}

IoReactivexInternalOperatorsFlowableFlowableSwitchMap *create_IoReactivexInternalOperatorsFlowableFlowableSwitchMap_initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_withBoolean_(id<OrgReactivestreamsPublisher> source, id<IoReactivexFunctionsFunction> mapper, jint bufferSize, jboolean delayErrors) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableSwitchMap, initWithOrgReactivestreamsPublisher_withIoReactivexFunctionsFunction_withInt_withBoolean_, source, mapper, bufferSize, delayErrors)
}
...
- (void)onErrorWithNSException:(NSException *)t {
  if (!JreLoadVolatileBoolean(&done_) && [((IoReactivexInternalUtilAtomicThrowable *) nil_chk(error_)) addThrowableWithNSException:t]) {
    if (!delayErrors_) {
      [self disposeInner];
    }
    ...
    if (JreLoadVolatileBoolean(&done_)) {
      if (delayErrors_) {
        if ([((JavaUtilConcurrentAtomicAtomicReference *) nil_chk(active_)) get] == nil) {
          NSException *err = [((IoReactivexInternalUtilAtomicThrowable *) nil_chk(error_)) get];
          if (err != nil) {
            [((id<OrgReactivestreamsSubscriber>) nil_chk(a)) onErrorWithNSException:[error_ terminate]];
          }
          else {
    ...
    if (q != nil) {
      ...
      while (e != r) {
        ...
        @catch (NSException *ex) {
          ...
          [inner cancel];
          [((IoReactivexInternalUtilAtomicThrowable *) nil_chk(error_)) addThrowableWithNSException:ex];
          d = true;
          v = nil;
        }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LIoReactivexFunctionsFunction;IZ", "(Lorg/reactivestreams/Subscriber<-TR;>;Lio/reactivex/functions/Function<-TT;+Lorg/reactivestreams/Publisher<+TR;>;>;IZ)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "request", "J", "Lorg/reactivestreams/Subscriber<-TR;>;", "Lio/reactivex/functions/Function<-TT;+Lorg/reactivestreams/Publisher<+TR;>;>;", "Ljava/util/concurrent/atomic/AtomicReference<Lio/reactivex/internal/operators/flowable/FlowableSwitchMap$SwitchMapInnerSubscriber<TT;TR;>;>;", &IoReactivexInternalOperatorsFlowableFlowableSwitchMap_SwitchMapSubscriber_CANCELLED, "Lio/reactivex/internal/operators/flowable/FlowableSwitchMap$SwitchMapInnerSubscriber<Ljava/lang/Object;Ljava/lang/Object;>;", "LIoReactivexInternalOperatorsFlowableFlowableSwitchMap;", "<T:Ljava/lang/Object;R:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicInteger;Lorg/reactivestreams/Subscriber<TT;>;Lorg/reactivestreams/Subscription;" };
...
- (void)onErrorWithNSException:(NSException *)t {
  IoReactivexInternalOperatorsFlowableFlowableSwitchMap_SwitchMapSubscriber *p = parent_;
  if (index_ == JreLoadVolatileLong(&((IoReactivexInternalOperatorsFlowableFlowableSwitchMap_SwitchMapSubscriber *) nil_chk(p))->unique_) && [((IoReactivexInternalUtilAtomicThrowable *) nil_chk(p->error_)) addThrowableWithNSException:t]) {
    if (!p->delayErrors_) {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexInternalOperatorsFlowableFlowableSwitchMap_SwitchMapSubscriber;JI", "(Lio/reactivex/internal/operators/flowable/FlowableSwitchMap$SwitchMapSubscriber<TT;TR;>;JI)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TR;)V", "onError", "LNSException;", "Lio/reactivex/internal/operators/flowable/FlowableSwitchMap$SwitchMapSubscriber<TT;TR;>;", "Lio/reactivex/internal/fuseable/SimpleQueue<TR;>;", "LIoReactivexInternalOperatorsFlowableFlowableSwitchMap;", "<T:Ljava/lang/Object;R:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicReference<Lorg/reactivestreams/Subscription;>;Lorg/reactivestreams/Subscriber<TR;>;" };
