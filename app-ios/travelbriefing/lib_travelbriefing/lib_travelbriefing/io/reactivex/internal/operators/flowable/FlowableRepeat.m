...
//  source: ../target/dependency/io/reactivex/internal/operators/flowable/FlowableRepeat.java
//
...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableRepeat_initWithOrgReactivestreamsPublisher_withLong_(self, source, count);
  return self;
}
...
void IoReactivexInternalOperatorsFlowableFlowableRepeat_initWithOrgReactivestreamsPublisher_withLong_(IoReactivexInternalOperatorsFlowableFlowableRepeat *self, id<OrgReactivestreamsPublisher> source, jlong count) {
  IoReactivexInternalOperatorsFlowableAbstractFlowableWithUpstream_initWithOrgReactivestreamsPublisher_(self, source);
  self->count_ = count;
}

IoReactivexInternalOperatorsFlowableFlowableRepeat *new_IoReactivexInternalOperatorsFlowableFlowableRepeat_initWithOrgReactivestreamsPublisher_withLong_(id<OrgReactivestreamsPublisher> source, jlong count) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableRepeat, initWithOrgReactivestreamsPublisher_withLong_, source, count)
}

IoReactivexInternalOperatorsFlowableFlowableRepeat *create_IoReactivexInternalOperatorsFlowableFlowableRepeat_initWithOrgReactivestreamsPublisher_withLong_(id<OrgReactivestreamsPublisher> source, jlong count) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableRepeat, initWithOrgReactivestreamsPublisher_withLong_, source, count)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;JLIoReactivexInternalSubscriptionsSubscriptionArbiter;LOrgReactivestreamsPublisher;", "(Lorg/reactivestreams/Subscriber<-TT;>;JLio/reactivex/internal/subscriptions/SubscriptionArbiter;Lorg/reactivestreams/Publisher<+TT;>;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "Lorg/reactivestreams/Subscriber<-TT;>;", "Lorg/reactivestreams/Publisher<+TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableRepeat;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicInteger;Lorg/reactivestreams/Subscriber<TT;>;" };
