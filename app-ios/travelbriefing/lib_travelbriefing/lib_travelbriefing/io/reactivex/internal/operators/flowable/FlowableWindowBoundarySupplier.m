...
//  source: ../target/dependency/io/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier.java
//
...
- (instancetype)initWithOrgReactivestreamsPublisher:(id<OrgReactivestreamsPublisher>)source
  ...
  IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySupplier_initWithOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_withInt_(self, source, other, bufferSize);
  return self;
}

- (void)subscribeActualWithOrgReactivestreamsSubscriber:(id<OrgReactivestreamsSubscriber>)s {
  [((id<OrgReactivestreamsPublisher>) nil_chk(source_)) subscribeWithOrgReactivestreamsSubscriber:create_IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySupplier_WindowBoundaryMainSubscriber_initWithOrgReactivestreamsSubscriber_withJavaUtilConcurrentCallable_withInt_(create_IoReactivexSubscribersSerializedSubscriber_initWithOrgReactivestreamsSubscriber_(s), other_, bufferSize_)];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithOrgReactivestreamsPublisher:withJavaUtilConcurrentCallable:withInt:);
...
void IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySupplier_initWithOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_withInt_(IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySupplier *self, id<OrgReactivestreamsPublisher> source, id<JavaUtilConcurrentCallable> other, jint bufferSize) {
...
IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySupplier *new_IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySupplier_initWithOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_withInt_(id<OrgReactivestreamsPublisher> source, id<JavaUtilConcurrentCallable> other, jint bufferSize) {
  J2OBJC_NEW_IMPL(IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySupplier, initWithOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_withInt_, source, other, bufferSize)
}

IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySupplier *create_IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySupplier_initWithOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_withInt_(id<OrgReactivestreamsPublisher> source, id<JavaUtilConcurrentCallable> other, jint bufferSize) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySupplier, initWithOrgReactivestreamsPublisher_withJavaUtilConcurrentCallable_withInt_, source, other, bufferSize)
}
...
- (void)onErrorWithNSException:(NSException *)t {
  ...
  done_ = true;
  [((IoReactivexInternalOperatorsFlowableFlowableWindowBoundarySupplier_WindowBoundaryMainSubscriber *) nil_chk(parent_)) onErrorWithNSException:t];
}
