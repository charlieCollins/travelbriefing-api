...
- (void)onErrorWithNSException:(NSException *)e {
  ...
  IoReactivexInternalUtilHalfSerializer_onErrorWithIoReactivexObserver_withNSException_withJavaUtilConcurrentAtomicAtomicInteger_withIoReactivexInternalUtilAtomicThrowable_(actual_, e, self, error_);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "onSubscribe", "LIoReactivexDisposablesDisposable;", "onNext", "LNSObject;", "onError", "LNSException;", "Lio/reactivex/internal/operators/observable/ObservableRepeatWhen$RepeatWhenObserver<TT;>;", "LIoReactivexInternalOperatorsObservableObservableRepeatWhen_RepeatWhenObserver;", "Ljava/util/concurrent/atomic/AtomicReference<Lio/reactivex/disposables/Disposable;>;Lio/reactivex/Observer<Ljava/lang/Object;>;" };
