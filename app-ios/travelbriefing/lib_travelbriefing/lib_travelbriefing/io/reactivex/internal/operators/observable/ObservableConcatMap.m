...
//  source: ../target/dependency/io/reactivex/internal/operators/observable/ObservableConcatMap.java
//
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexObserver;LIoReactivexInternalOperatorsObservableObservableConcatMap_SourceObserver;", "(Lio/reactivex/Observer<-TU;>;Lio/reactivex/internal/operators/observable/ObservableConcatMap$SourceObserver<**>;)V", "onSubscribe", "LIoReactivexDisposablesDisposable;", "onNext", "LNSObject;", "(TU;)V", "onError", "LNSException;", "Lio/reactivex/Observer<-TU;>;", "Lio/reactivex/internal/operators/observable/ObservableConcatMap$SourceObserver<**>;", "LIoReactivexInternalOperatorsObservableObservableConcatMap_SourceObserver;", "<U:Ljava/lang/Object;>Ljava/lang/Object;Lio/reactivex/Observer<TU;>;" };
...
- (void)onErrorWithNSException:(NSException *)e {
  if ([((IoReactivexInternalUtilAtomicThrowable *) nil_chk(error_)) addThrowableWithNSException:e]) {
    JreAssignVolatileBoolean(&done_, true);
    [self drain];
  }
  else {
...
- (void)drain {
  ...
  for (; ; ) {
    if (!JreLoadVolatileBoolean(&active_)) {
      ...
      if (!tillTheEnd_) {
        NSException *ex = [((IoReactivexInternalUtilAtomicThrowable *) nil_chk(error)) get];
        if (ex != nil) {
          [((id<IoReactivexInternalFuseableSimpleQueue>) nil_chk(queue)) clear];
          [((id<IoReactivexObserver>) nil_chk(actual)) onErrorWithNSException:[error terminate]];
          return;
        }
      }
      jboolean d = JreLoadVolatileBoolean(&done_);
      ...
      @catch (NSException *ex) {
        ...
        [((IoReactivexInternalUtilAtomicThrowable *) nil_chk(error)) addThrowableWithNSException:ex];
        [((id<IoReactivexObserver>) nil_chk(actual)) onErrorWithNSException:[error terminate]];
        return;
      }
      ...
      if (d && empty) {
        ...
        if (ex != nil) {
          [((id<IoReactivexObserver>) nil_chk(actual)) onErrorWithNSException:ex];
        }
        else {
...
- (void)onErrorWithNSException:(NSException *)e {
  ...
  if ([((IoReactivexInternalUtilAtomicThrowable *) nil_chk(((IoReactivexInternalOperatorsObservableObservableConcatMap_ConcatMapDelayErrorObserver *) nil_chk(p))->error_)) addThrowableWithNSException:e]) {
    if (!p->tillTheEnd_) {
