...
//  source: ../target/dependency/io/reactivex/internal/operators/flowable/FlowableSamplePublisher.java
//
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[8].selector = @selector(errorWithNSException:);
  ...
  static const void *ptrTable[] = { "LOrgReactivestreamsSubscriber;LOrgReactivestreamsPublisher;", "(Lorg/reactivestreams/Subscriber<-TT;>;Lorg/reactivestreams/Publisher<*>;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "setOther", "request", "J", "error", "Lorg/reactivestreams/Subscriber<-TT;>;", "Lorg/reactivestreams/Publisher<*>;", "Ljava/util/concurrent/atomic/AtomicReference<Lorg/reactivestreams/Subscription;>;", "LIoReactivexInternalOperatorsFlowableFlowableSamplePublisher;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicReference<TT;>;Lorg/reactivestreams/Subscriber<TT;>;Lorg/reactivestreams/Subscription;" };
...
- (void)onErrorWithNSException:(NSException *)t {
  [((IoReactivexInternalOperatorsFlowableFlowableSamplePublisher_SamplePublisherSubscriber *) nil_chk(parent_)) errorWithNSException:t];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LIoReactivexInternalOperatorsFlowableFlowableSamplePublisher_SamplePublisherSubscriber;", "(Lio/reactivex/internal/operators/flowable/FlowableSamplePublisher$SamplePublisherSubscriber<TT;>;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onNext", "LNSObject;", "onError", "LNSException;", "Lio/reactivex/internal/operators/flowable/FlowableSamplePublisher$SamplePublisherSubscriber<TT;>;", "LIoReactivexInternalOperatorsFlowableFlowableSamplePublisher;", "<T:Ljava/lang/Object;>Ljava/lang/Object;Lorg/reactivestreams/Subscriber<Ljava/lang/Object;>;" };
