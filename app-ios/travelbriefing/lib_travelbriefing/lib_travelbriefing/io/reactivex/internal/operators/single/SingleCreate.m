...
//  source: ../target/dependency/io/reactivex/internal/operators/single/SingleCreate.java
//
...
- (void)onSuccessWithId:(id)value {
  if ([self get] != JreLoadEnum(IoReactivexInternalDisposablesDisposableHelper, DISPOSED)) {
    ...
    if (d != JreLoadEnum(IoReactivexInternalDisposablesDisposableHelper, DISPOSED)) {
      @try {
        if (value == nil) {
          [((id<IoReactivexSingleObserver>) nil_chk(actual_)) onErrorWithNSException:create_JavaLangNullPointerException_initWithNSString_(@"onSuccess called with null. Null values are generally not allowed in 2.x operators and sources.")];
        }
        else {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "actual_", "LIoReactivexSingleObserver;", .constantValue.asLong = 0, 0x10, -1, -1, 11, -1 },
  ...
  static const void *ptrTable[] = { "LIoReactivexSingleObserver;", "(Lio/reactivex/SingleObserver<-TT;>;)V", "onSuccess", "LNSObject;", "(TT;)V", "onError", "LNSException;", "setDisposable", "LIoReactivexDisposablesDisposable;", "setCancellable", "LIoReactivexFunctionsCancellable;", "Lio/reactivex/SingleObserver<-TT;>;", "LIoReactivexInternalOperatorsSingleSingleCreate;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicReference<Lio/reactivex/disposables/Disposable;>;Lio/reactivex/SingleEmitter<TT;>;Lio/reactivex/disposables/Disposable;" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsSingleSingleCreate_Emitter = { "Emitter", "io.reactivex.internal.operators.single", ptrTable, methods, fields, 7, 0x18, 7, 2, 12, -1, -1, 13, -1 };
