...
#include "io/reactivex/internal/operators/observable/ObservableFlatMapCompletable.h"
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[8].selector = @selector(innerErrorWithIoReactivexInternalOperatorsObservableObservableFlatMapCompletableCompletable_FlatMapCompletableMainObserver_InnerObserver:withNSException:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
  ...
  static const void *ptrTable[] = { "LIoReactivexCompletableObserver;LIoReactivexFunctionsFunction;Z", "(Lio/reactivex/CompletableObserver;Lio/reactivex/functions/Function<-TT;+Lio/reactivex/CompletableSource;>;Z)V", "onSubscribe", "LIoReactivexDisposablesDisposable;", "onNext", "LNSObject;", "(TT;)V", "onError", "LNSException;", "innerComplete", "LIoReactivexInternalOperatorsObservableObservableFlatMapCompletableCompletable_FlatMapCompletableMainObserver_InnerObserver;", "innerError", "LIoReactivexInternalOperatorsObservableObservableFlatMapCompletableCompletable_FlatMapCompletableMainObserver_InnerObserver;LNSException;", "Lio/reactivex/functions/Function<-TT;+Lio/reactivex/CompletableSource;>;", "LIoReactivexInternalOperatorsObservableObservableFlatMapCompletableCompletable;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicInteger;Lio/reactivex/disposables/Disposable;Lio/reactivex/Observer<TT;>;" };
  static const J2ObjcClassInfo _IoReactivexInternalOperatorsObservableObservableFlatMapCompletableCompletable_FlatMapCompletableMainObserver = { "FlatMapCompletableMainObserver", "io.reactivex.internal.operators.observable", ptrTable, methods, fields, 7, 0x18, 9, 7, 14, 10, -1, 15, -1 };
...
- (void)onErrorWithNSException:(NSException *)e {
  [this$0_ innerErrorWithIoReactivexInternalOperatorsObservableObservableFlatMapCompletableCompletable_FlatMapCompletableMainObserver_InnerObserver:self withNSException:e];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "onSubscribe", "LIoReactivexDisposablesDisposable;", "onError", "LNSException;", "Lio/reactivex/internal/operators/observable/ObservableFlatMapCompletableCompletable$FlatMapCompletableMainObserver<TT;>;", "LIoReactivexInternalOperatorsObservableObservableFlatMapCompletableCompletable_FlatMapCompletableMainObserver;", "Ljava/util/concurrent/atomic/AtomicReference<Lio/reactivex/disposables/Disposable;>;Lio/reactivex/CompletableObserver;Lio/reactivex/disposables/Disposable;" };
