...
@interface IoReactivexInternalOperatorsFlowableFlowableSamplePublisher_SamplePublisherSubscriber : JavaUtilConcurrentAtomicAtomicReference < OrgReactivestreamsSubscriber, OrgReactivestreamsSubscription > {
 @public
...
@interface IoReactivexInternalOperatorsFlowableFlowableSamplePublisher_SamplerSubscriber : NSObject < OrgReactivestreamsSubscriber > {
 @public
