...
//  source: ../target/dependency/io/reactivex/internal/queue/SpscLinkedArrayQueue.java
//

#include "J2ObjC_source.h"
#include "io/reactivex/internal/queue/SpscLinkedArrayQueue.h"
#include "io/reactivex/internal/util/Pow2.h"
...
__attribute__((unused)) static JavaUtilConcurrentAtomicAtomicReferenceArray *IoReactivexInternalQueueSpscLinkedArrayQueue_lvNextWithJavaUtilConcurrentAtomicAtomicReferenceArray_(IoReactivexInternalQueueSpscLinkedArrayQueue *self, JavaUtilConcurrentAtomicAtomicReferenceArray *curr);
...
- (JavaUtilConcurrentAtomicAtomicReferenceArray *)lvNextWithJavaUtilConcurrentAtomicAtomicReferenceArray:(JavaUtilConcurrentAtomicAtomicReferenceArray *)curr {
  return IoReactivexInternalQueueSpscLinkedArrayQueue_lvNextWithJavaUtilConcurrentAtomicAtomicReferenceArray_(self, curr);
}
...
- (id)poll {
  ...
  if (nil != e && !isNextBuffer) {
    ...
    return IoReactivexInternalQueueSpscLinkedArrayQueue_newBufferPollWithJavaUtilConcurrentAtomicAtomicReferenceArray_withLong_withInt_(self, IoReactivexInternalQueueSpscLinkedArrayQueue_lvNextWithJavaUtilConcurrentAtomicAtomicReferenceArray_(self, buffer), index, mask);
  }
  return nil;
}
...
- (id)peek {
  ...
  if (e == IoReactivexInternalQueueSpscLinkedArrayQueue_HAS_NEXT) {
    return IoReactivexInternalQueueSpscLinkedArrayQueue_newBufferPeekWithJavaUtilConcurrentAtomicAtomicReferenceArray_withLong_withInt_(self, IoReactivexInternalQueueSpscLinkedArrayQueue_lvNextWithJavaUtilConcurrentAtomicAtomicReferenceArray_(self, buffer), index, mask);
  }
  return e;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "MAX_LOOK_AHEAD_STEP", "I", .constantValue.asLong = 0, 0x18, -1, 36, -1, -1 },
...
JavaUtilConcurrentAtomicAtomicReferenceArray *IoReactivexInternalQueueSpscLinkedArrayQueue_lvNextWithJavaUtilConcurrentAtomicAtomicReferenceArray_(IoReactivexInternalQueueSpscLinkedArrayQueue *self, JavaUtilConcurrentAtomicAtomicReferenceArray *curr) {
  return (JavaUtilConcurrentAtomicAtomicReferenceArray *) cast_chk(IoReactivexInternalQueueSpscLinkedArrayQueue_lvElementWithJavaUtilConcurrentAtomicAtomicReferenceArray_withInt_(curr, IoReactivexInternalQueueSpscLinkedArrayQueue_calcDirectOffsetWithInt_([((JavaUtilConcurrentAtomicAtomicReferenceArray *) nil_chk(curr)) length] - 1)), [JavaUtilConcurrentAtomicAtomicReferenceArray class]);
}
