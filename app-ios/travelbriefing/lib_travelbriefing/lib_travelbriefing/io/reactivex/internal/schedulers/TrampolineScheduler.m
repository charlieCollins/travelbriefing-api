...
@interface IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_1 : NSObject < JavaLangRunnable > {
 @public
  IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker *this$0_;
  IoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable *val$timedRunnable_;
}
...
- (instancetype)initWithIoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker:(IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker *)outer$
                       withIoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable:(IoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable *)capture$0;

- (void)run;

@end

J2OBJC_EMPTY_STATIC_INIT(IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_1)

__attribute__((unused)) static void IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_1_initWithIoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_withIoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable_(IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_1 *self, IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker *outer$, IoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable *capture$0);

__attribute__((unused)) static IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_1 *new_IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_1_initWithIoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_withIoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable_(IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker *outer$, IoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable *capture$0) NS_RETURNS_RETAINED;

__attribute__((unused)) static IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_1 *create_IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_1_initWithIoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_withIoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable_(IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker *outer$, IoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable *capture$0);
...
- (id<IoReactivexDisposablesDisposable>)enqueueWithJavaLangRunnable:(id<JavaLangRunnable>)action
  ...
  if ([((JavaUtilConcurrentAtomicAtomicInteger *) nil_chk(wip_)) getAndIncrement] == 0) {
    ...
    return IoReactivexDisposablesDisposables_fromRunnableWithJavaLangRunnable_(create_IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_1_initWithIoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_withIoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable_(self, timedRunnable));
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "schedule", "LJavaLangRunnable;", "LJavaLangRunnable;JLJavaUtilConcurrentTimeUnit;", "enqueue", "LJavaLangRunnable;J", "Ljava/util/concurrent/PriorityBlockingQueue<Lio/reactivex/internal/schedulers/TrampolineScheduler$TimedRunnable;>;", "LIoReactivexInternalSchedulersTrampolineScheduler;" };
  static const J2ObjcClassInfo _IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker = { "TrampolineWorker", "io.reactivex.internal.schedulers", ptrTable, methods, fields, 7, 0x18, 6, 4, 6, -1, -1, -1, -1 };
...
@implementation IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_1

- (instancetype)initWithIoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker:(IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker *)outer$
                       withIoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable:(IoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable *)capture$0 {
  IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_1_initWithIoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_withIoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable_(self, outer$, capture$0);
  return self;
}

- (void)run {
  JreAssignVolatileBoolean(&((IoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable *) nil_chk(val$timedRunnable_))->disposed_, true);
  [((JavaUtilConcurrentPriorityBlockingQueue *) nil_chk(this$0_->queue_)) removeWithId:val$timedRunnable_];
}

- (void)dealloc {
  RELEASE_(this$0_);
  RELEASE_(val$timedRunnable_);
  [super dealloc];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "val$timedRunnable_", "LIoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable;", .constantValue.asLong = 0, 0x1012, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "LIoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker;", "enqueueWithJavaLangRunnable:withLong:" };
  static const J2ObjcClassInfo _IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_1 = { "", "io.reactivex.internal.schedulers", ptrTable, methods, fields, 7, 0x8018, 2, 2, 0, -1, 1, -1, -1 };
  return &_IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_1;
}
...
void IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_1_initWithIoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_withIoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable_(IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_1 *self, IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker *outer$, IoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable *capture$0) {
  ...
  JreStrongAssign(&self->val$timedRunnable_, capture$0);
  NSObject_init(self);
}

IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_1 *new_IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_1_initWithIoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_withIoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable_(IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker *outer$, IoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable *capture$0) {
  J2OBJC_NEW_IMPL(IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_1, initWithIoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_withIoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable_, outer$, capture$0)
}

IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_1 *create_IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_1_initWithIoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_withIoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable_(IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker *outer$, IoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable *capture$0) {
  J2OBJC_CREATE_IMPL(IoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_1, initWithIoReactivexInternalSchedulersTrampolineScheduler_TrampolineWorker_withIoReactivexInternalSchedulersTrampolineScheduler_TimedRunnable_, outer$, capture$0)
}
