...
//  source: ../target/dependency/io/reactivex/internal/subscribers/BasicFuseableConditionalSubscriber.java
//
...
@implementation IoReactivexInternalSubscribersBasicFuseableConditionalSubscriber
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithIoReactivexInternalFuseableConditionalSubscriber:);
  ...
  methods[5].selector = @selector(failWithNSException:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "actual_", "LIoReactivexInternalFuseableConditionalSubscriber;", .constantValue.asLong = 0, 0x14, -1, -1, 16, -1 },
  ...
  static const void *ptrTable[] = { "LIoReactivexInternalFuseableConditionalSubscriber;", "(Lio/reactivex/internal/fuseable/ConditionalSubscriber<-TR;>;)V", "onSubscribe", "LOrgReactivestreamsSubscription;", "onError", "LNSException;", "fail", "transitiveBoundaryFusion", "I", "request", "J", "offer", "LNSObject;", "(TR;)Z", "LNSObject;LNSObject;", "(TR;TR;)Z", "Lio/reactivex/internal/fuseable/ConditionalSubscriber<-TR;>;", "Lio/reactivex/internal/fuseable/QueueSubscription<TT;>;", "<T:Ljava/lang/Object;R:Ljava/lang/Object;>Ljava/lang/Object;Lio/reactivex/internal/fuseable/ConditionalSubscriber<TT;>;Lio/reactivex/internal/fuseable/QueueSubscription<TR;>;" };
  static const J2ObjcClassInfo _IoReactivexInternalSubscribersBasicFuseableConditionalSubscriber = { "BasicFuseableConditionalSubscriber", "io.reactivex.internal.subscribers", ptrTable, methods, fields, 7, 0x401, 14, 5, -1, -1, -1, 18, -1 };
  return &_IoReactivexInternalSubscribersBasicFuseableConditionalSubscriber;
}

@end

void IoReactivexInternalSubscribersBasicFuseableConditionalSubscriber_initWithIoReactivexInternalFuseableConditionalSubscriber_(IoReactivexInternalSubscribersBasicFuseableConditionalSubscriber *self, id<IoReactivexInternalFuseableConditionalSubscriber> actual) {
  NSObject_init(self);
  JreStrongAssign(&self->actual_, actual);
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(IoReactivexInternalSubscribersBasicFuseableConditionalSubscriber)
