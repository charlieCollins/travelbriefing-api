...
@interface IoReactivexInternalSubscribersBlockingBaseSubscriber : JavaUtilConcurrentCountDownLatch < OrgReactivestreamsSubscriber > {
 @public
  id value_;
  NSException *error_;
...
J2OBJC_FIELD_SETTER(IoReactivexInternalSubscribersBlockingBaseSubscriber, error_, NSException *)
J2OBJC_FIELD_SETTER(IoReactivexInternalSubscribersBlockingBaseSubscriber, s_, id<OrgReactivestreamsSubscription>)
