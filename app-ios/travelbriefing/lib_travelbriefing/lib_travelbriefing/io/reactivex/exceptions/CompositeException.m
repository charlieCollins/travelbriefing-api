...
//  source: ../target/dependency/io/reactivex/exceptions/CompositeException.java
//
...
J2OBJC_FIELD_SETTER(IoReactivexExceptionsCompositeException, cause_CompositeException_, NSException *)
...
__attribute__((unused)) static void IoReactivexExceptionsCompositeException_appendStackTraceWithJavaLangStringBuilder_withNSException_withNSString_(IoReactivexExceptionsCompositeException *self, JavaLangStringBuilder *b, NSException *ex, NSString *prefix);

__attribute__((unused)) static id<JavaUtilList> IoReactivexExceptionsCompositeException_getListOfCausesWithNSException_(IoReactivexExceptionsCompositeException *self, NSException *ex);

__attribute__((unused)) static NSException *IoReactivexExceptionsCompositeException_getRootCauseWithNSException_(IoReactivexExceptionsCompositeException *self, NSException *e);
...
- (instancetype)initWithNSExceptionArray:(IOSObjectArray *)exceptions {
  IoReactivexExceptionsCompositeException_initWithNSExceptionArray_(self, exceptions);
  return self;
}

- (instancetype)initWithJavaLangIterable:(id<JavaLangIterable>)errors {
  ...
  @synchronized(self) {
    if (cause_CompositeException_ == nil) {
      ...
      for (NSException * __strong e in nil_chk(exceptions_)) {
        ...
        id<JavaUtilList> listOfCauses = IoReactivexExceptionsCompositeException_getListOfCausesWithNSException_(self, e);
        ...
        chain = IoReactivexExceptionsCompositeException_getRootCauseWithNSException_(self, chain);
      }
...
- (void)appendStackTraceWithJavaLangStringBuilder:(JavaLangStringBuilder *)b
                                  withNSException:(NSException *)ex
                                     withNSString:(NSString *)prefix {
  IoReactivexExceptionsCompositeException_appendStackTraceWithJavaLangStringBuilder_withNSException_withNSString_(self, b, ex, prefix);
}

- (id<JavaUtilList>)getListOfCausesWithNSException:(NSException *)ex {
  return IoReactivexExceptionsCompositeException_getListOfCausesWithNSException_(self, ex);
}
...
- (NSException *)getRootCauseWithNSException:(NSException *)e {
  return IoReactivexExceptionsCompositeException_getRootCauseWithNSException_(self, e);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LNSException;", 0x2, 13, 11, -1, -1, -1, -1 },
  };
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  methods[0].selector = @selector(initWithNSExceptionArray:);
  ...
  methods[9].selector = @selector(appendStackTraceWithJavaLangStringBuilder:withNSException:withNSString:);
  methods[10].selector = @selector(getListOfCausesWithNSException:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "cause_CompositeException_", "LNSException;", .constantValue.asLong = 0, 0x2, 15, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "[LNSException;", "LJavaLangIterable;", "(Ljava/lang/Iterable<+Ljava/lang/Throwable;>;)V", "()Ljava/util/List<Ljava/lang/Throwable;>;", "printStackTrace", "LJavaIoPrintStream;", "LJavaIoPrintWriter;", "LIoReactivexExceptionsCompositeException_PrintStreamOrWriter;", "appendStackTrace", "LJavaLangStringBuilder;LNSException;LNSString;", "getListOfCauses", "LNSException;", "(Ljava/lang/Throwable;)Ljava/util/List<Ljava/lang/Throwable;>;", "getRootCause", "Ljava/util/List<Ljava/lang/Throwable;>;", "cause", "LIoReactivexExceptionsCompositeException_PrintStreamOrWriter;LIoReactivexExceptionsCompositeException_WrappedPrintStream;LIoReactivexExceptionsCompositeException_WrappedPrintWriter;LIoReactivexExceptionsCompositeException_CompositeExceptionCausalChain;" };
...
void IoReactivexExceptionsCompositeException_initWithNSExceptionArray_(IoReactivexExceptionsCompositeException *self, IOSObjectArray *exceptions) {
  IoReactivexExceptionsCompositeException_initWithJavaLangIterable_(self, exceptions == nil ? JavaUtilArrays_asListWithNSObjectArray_([IOSObjectArray arrayWithObjects:(id[]){ create_JavaLangNullPointerException_initWithNSString_(@"exceptions was null") } count:1 type:JavaLangNullPointerException_class_()]) : JavaUtilArrays_asListWithNSObjectArray_(exceptions));
}

IoReactivexExceptionsCompositeException *new_IoReactivexExceptionsCompositeException_initWithNSExceptionArray_(IOSObjectArray *exceptions) {
  J2OBJC_NEW_IMPL(IoReactivexExceptionsCompositeException, initWithNSExceptionArray_, exceptions)
}

IoReactivexExceptionsCompositeException *create_IoReactivexExceptionsCompositeException_initWithNSExceptionArray_(IOSObjectArray *exceptions) {
  J2OBJC_CREATE_IMPL(IoReactivexExceptionsCompositeException, initWithNSExceptionArray_, exceptions)
}
...
void IoReactivexExceptionsCompositeException_printStackTraceWithIoReactivexExceptionsCompositeException_PrintStreamOrWriter_(IoReactivexExceptionsCompositeException *self, IoReactivexExceptionsCompositeException_PrintStreamOrWriter *s) {
  ...
  for (NSException * __strong ex in nil_chk(self->exceptions_)) {
    ...
    IoReactivexExceptionsCompositeException_appendStackTraceWithJavaLangStringBuilder_withNSException_withNSString_(self, b, ex, @"\t");
    i++;
  }
  [((IoReactivexExceptionsCompositeException_PrintStreamOrWriter *) nil_chk(s)) printlnWithId:[b description]];
}

void IoReactivexExceptionsCompositeException_appendStackTraceWithJavaLangStringBuilder_withNSException_withNSString_(IoReactivexExceptionsCompositeException *self, JavaLangStringBuilder *b, NSException *ex, NSString *prefix) {
  ...
  if ([ex getCause] != nil) {
    ...
    IoReactivexExceptionsCompositeException_appendStackTraceWithJavaLangStringBuilder_withNSException_withNSString_(self, b, [ex getCause], @"");
  }
}

id<JavaUtilList> IoReactivexExceptionsCompositeException_getListOfCausesWithNSException_(IoReactivexExceptionsCompositeException *self, NSException *ex) {
  ...
  if (root == nil || root == ex) {
    ...
    while (true) {
      [list addWithId:root];
      NSException *cause = [root getCause];
...
NSException *IoReactivexExceptionsCompositeException_getRootCauseWithNSException_(IoReactivexExceptionsCompositeException *self, NSException *e) {
