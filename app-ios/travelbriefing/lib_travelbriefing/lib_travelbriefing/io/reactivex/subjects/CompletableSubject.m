...
#include "io/reactivex/subjects/CompletableSubject.h"
  ...
  if ([((JavaUtilConcurrentAtomicAtomicBoolean *) nil_chk(once_)) compareAndSetWithBoolean:false withBoolean:true]) {
    JreStrongAssign(&self->error_, e);
    {
      ...
      while (b__ < e__) {
        ...
        [((id<IoReactivexCompletableObserver>) nil_chk(((IoReactivexSubjectsCompletableSubject_CompletableDisposable *) nil_chk(md))->actual_)) onErrorWithNSException:e];
      }
    }
  }
  else {
