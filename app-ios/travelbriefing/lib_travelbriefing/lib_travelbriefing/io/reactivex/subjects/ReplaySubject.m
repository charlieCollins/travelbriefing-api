...
//  source: ../target/dependency/io/reactivex/subjects/ReplaySubject.java
//
...
#include "io/reactivex/subjects/ReplaySubject.h"
        ...
        if (index + 1 == s) {
          ...
          if (index + 1 == s) {
            if (IoReactivexInternalUtilNotificationLite_isCompleteWithId_(o)) {
              ...
              [((id<IoReactivexObserver>) nil_chk(a)) onErrorWithNSException:IoReactivexInternalUtilNotificationLite_getErrorWithId_(o)];
            }
            JreStrongAssign(&rs->index_, nil);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[7].selector = @selector(replayWithIoReactivexSubjectsReplaySubject_ReplayDisposable:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "size_", "I", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "head_", "LIoReactivexSubjectsReplaySubject_TimedNode;", .constantValue.asLong = 0, 0x40, -1, -1, 12, -1 },
    { "tail_", "LIoReactivexSubjectsReplaySubject_TimedNode;", .constantValue.asLong = 0, 0x0, -1, -1, 12, -1 },
    { "done_", "Z", .constantValue.asLong = 0, 0x40, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "IJLJavaUtilConcurrentTimeUnit;LIoReactivexScheduler;", "add", "LNSObject;", "(TT;)V", "addFinal", "()TT;", "getValues", "[LNSObject;", "([TT;)[TT;", "replay", "LIoReactivexSubjectsReplaySubject_ReplayDisposable;", "(Lio/reactivex/subjects/ReplaySubject$ReplayDisposable<TT;>;)V", "Lio/reactivex/subjects/ReplaySubject$TimedNode<Ljava/lang/Object;>;", "LIoReactivexSubjectsReplaySubject;", "<T:Ljava/lang/Object;>Ljava/util/concurrent/atomic/AtomicReference<Ljava/lang/Object;>;Lio/reactivex/subjects/ReplaySubject$ReplayBuffer<TT;>;" };
  static const J2ObjcClassInfo _IoReactivexSubjectsReplaySubject_SizeAndTimeBoundReplayBuffer = { "SizeAndTimeBoundReplayBuffer", "io.reactivex.subjects", ptrTable, methods, fields, 7, 0x18, 9, 9, 13, -1, -1, 14, -1 };
