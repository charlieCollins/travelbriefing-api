...
//  source: ../target/dependency/retrofit2/ServiceMethod.java
//
...
- (void)parseMethodAnnotationWithJavaLangAnnotationAnnotation:(id<JavaLangAnnotationAnnotation>)annotation;

- (void)parseHttpMethodAndPathWithNSString:(NSString *)httpMethod
                              withNSString:(NSString *)value
                               withBoolean:(jboolean)hasBody;

- (Okhttp3Headers *)parseHeadersWithNSStringArray:(IOSObjectArray *)headers;

- (Retrofit2ParameterHandler *)parseParameterWithInt:(jint)p
                             withJavaLangReflectType:(id<JavaLangReflectType>)parameterType
...
- (Retrofit2ParameterHandler *)parseParameterAnnotationWithInt:(jint)p
                         ...
                         withJavaLangAnnotationAnnotationArray:(IOSObjectArray *)annotations
                              withJavaLangAnnotationAnnotation:(id<JavaLangAnnotationAnnotation>)annotation;
...
- (JavaLangRuntimeException *)methodErrorWithNSException:(NSException *)cause
                                            withNSString:(NSString *)message
                                       withNSObjectArray:(IOSObjectArray *)args;

- (JavaLangRuntimeException *)parameterErrorWithNSException:(NSException *)cause
                                                    withInt:(jint)p
                                               withNSString:(NSString *)message
                                          withNSObjectArray:(IOSObjectArray *)args;
...
__attribute__((unused)) static JavaLangRuntimeException *Retrofit2ServiceMethod_Builder_methodErrorWithNSException_withNSString_withNSObjectArray_(Retrofit2ServiceMethod_Builder *self, NSException *cause, NSString *message, IOSObjectArray *args);

__attribute__((unused)) static JavaLangRuntimeException *Retrofit2ServiceMethod_Builder_parameterErrorWithNSException_withInt_withNSString_withNSObjectArray_(Retrofit2ServiceMethod_Builder *self, NSException *cause, jint p, NSString *message, IOSObjectArray *args);
...
- (instancetype)initWithRetrofit2ServiceMethod_Builder:(Retrofit2ServiceMethod_Builder *)builder {
  Retrofit2ServiceMethod_initWithRetrofit2ServiceMethod_Builder_(self, builder);
  return self;
}

- (Okhttp3Request *)toRequestWithNSObjectArray:(IOSObjectArray *)args {
...
- (id)toResponseWithOkhttp3ResponseBody:(Okhttp3ResponseBody *)body {
...
+ (IOSClass *)boxIfPrimitiveWithIOSClass:(IOSClass *)type {
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LOkhttp3Request;", 0x80, 2, 3, 4, -1, -1, -1 },
    { NULL, "LNSObject;", 0x0, 5, 6, 4, 7, -1, -1 },
    { NULL, "LJavaUtilSet;", 0x8, 8, 9, -1, 10, -1, -1 },
    { NULL, "LIOSClass;", 0x8, 11, 12, -1, 13, -1, -1 },
  };
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "PARAM", "LNSString;", .constantValue.asLong = 0, 0x18, -1, 14, -1, -1 },
    { "PARAM_URL_REGEX", "LJavaUtilRegexPattern;", .constantValue.asLong = 0, 0x18, -1, 15, -1, -1 },
    { "PARAM_NAME_REGEX", "LJavaUtilRegexPattern;", .constantValue.asLong = 0, 0x18, -1, 16, -1, -1 },
    { "callFactory_", "LOkhttp3Call_Factory;", .constantValue.asLong = 0, 0x10, -1, -1, -1, -1 },
    { "callAdapter_", "LRetrofit2CallAdapter;", .constantValue.asLong = 0, 0x10, -1, -1, 17, -1 },
    { "baseUrl_", "LOkhttp3HttpUrl;", .constantValue.asLong = 0, 0x12, -1, -1, -1, -1 },
    { "responseConverter_", "LRetrofit2Converter;", .constantValue.asLong = 0, 0x12, -1, -1, 18, -1 },
    ...
    { "parameterHandlers_", "[LRetrofit2ParameterHandler;", .constantValue.asLong = 0, 0x12, -1, -1, 19, -1 },
  };
  static const void *ptrTable[] = { "LRetrofit2ServiceMethod_Builder;", "(Lretrofit2/ServiceMethod$Builder<TR;TT;>;)V", "toRequest", "[LNSObject;", "LJavaIoIOException;", "toResponse", "LOkhttp3ResponseBody;", "(Lokhttp3/ResponseBody;)TR;", "parsePathParameters", "LNSString;", "(Ljava/lang/String;)Ljava/util/Set<Ljava/lang/String;>;", "boxIfPrimitive", "LIOSClass;", "(Ljava/lang/Class<*>;)Ljava/lang/Class<*>;", &Retrofit2ServiceMethod_PARAM, &Retrofit2ServiceMethod_PARAM_URL_REGEX, &Retrofit2ServiceMethod_PARAM_NAME_REGEX, "Lretrofit2/CallAdapter<TR;TT;>;", "Lretrofit2/Converter<Lokhttp3/ResponseBody;TR;>;", "[Lretrofit2/ParameterHandler<*>;", "<R:Ljava/lang/Object;T:Ljava/lang/Object;>Ljava/lang/Object;" };
  static const J2ObjcClassInfo _Retrofit2ServiceMethod = { "ServiceMethod", "retrofit2", ptrTable, methods, fields, 7, 0x10, 5, 15, -1, 0, -1, 20, -1 };
...
- (Retrofit2ServiceMethod *)build {
  ...
  if (responseType_ == (id) Retrofit2Response_class_() || responseType_ == (id) Okhttp3Response_class_()) {
    @throw Retrofit2ServiceMethod_Builder_methodErrorWithNSString_withNSObjectArray_(self, JreStrcat("C$$", '\'', [((IOSClass *) nil_chk(Retrofit2Utils_getRawTypeWithJavaLangReflectType_(responseType_))) getName], @"' is not a valid response body type. Did you mean ResponseBody?"), [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  }
  ...
  if (httpMethod_ == nil) {
    @throw Retrofit2ServiceMethod_Builder_methodErrorWithNSString_withNSObjectArray_(self, @"HTTP method annotation is required (e.g., @GET, @POST, etc.).", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  }
  if (!hasBody_) {
    if (isMultipart_) {
      @throw Retrofit2ServiceMethod_Builder_methodErrorWithNSString_withNSObjectArray_(self, @"Multipart can only be specified on HTTP methods with request body (e.g., @POST).", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    if (isFormEncoded_) {
      @throw Retrofit2ServiceMethod_Builder_methodErrorWithNSString_withNSObjectArray_(self, @"FormUrlEncoded can only be specified on HTTP methods with request body (e.g., @POST).", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
  }
  ...
  for (jint p = 0; p < parameterCount; p++) {
    ...
    if (Retrofit2Utils_hasUnresolvableTypeWithJavaLangReflectType_(parameterType)) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"Parameter type must not include a type variable or wildcard: %s", [IOSObjectArray arrayWithObjects:(id[]){ parameterType } count:1 type:NSObject_class_()]);
    }
    IOSObjectArray *parameterAnnotations = IOSObjectArray_Get(parameterAnnotationsArray_, p);
    if (parameterAnnotations == nil) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"No Retrofit annotation found.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
  ...
  if (relativeUrl_ == nil && !gotUrl_) {
    @throw Retrofit2ServiceMethod_Builder_methodErrorWithNSString_withNSObjectArray_(self, @"Missing either @%s URL or @Url parameter.", [IOSObjectArray arrayWithObjects:(id[]){ httpMethod_ } count:1 type:NSObject_class_()]);
  }
  if (!isFormEncoded_ && !isMultipart_ && !hasBody_ && gotBody_) {
    @throw Retrofit2ServiceMethod_Builder_methodErrorWithNSString_withNSObjectArray_(self, @"Non-body HTTP method cannot contain @Body.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  }
  if (isFormEncoded_ && !gotField_) {
    @throw Retrofit2ServiceMethod_Builder_methodErrorWithNSString_withNSObjectArray_(self, @"Form-encoded method must contain at least one @Field.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  }
  if (isMultipart_ && !gotPart_) {
    @throw Retrofit2ServiceMethod_Builder_methodErrorWithNSString_withNSObjectArray_(self, @"Multipart method must contain at least one @Part.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  }
...
- (JavaLangRuntimeException *)methodErrorWithNSException:(NSException *)cause
                                            withNSString:(NSString *)message
                                       withNSObjectArray:(IOSObjectArray *)args {
  return Retrofit2ServiceMethod_Builder_methodErrorWithNSException_withNSString_withNSObjectArray_(self, cause, message, args);
}
...
- (JavaLangRuntimeException *)parameterErrorWithNSException:(NSException *)cause
                                               ...
                                               withNSString:(NSString *)message
                                          withNSObjectArray:(IOSObjectArray *)args {
  return Retrofit2ServiceMethod_Builder_parameterErrorWithNSException_withInt_withNSString_withNSObjectArray_(self, cause, p, message, args);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[11].selector = @selector(methodErrorWithNSException:withNSString:withNSObjectArray:);
  methods[12].selector = @selector(parameterErrorWithNSException:withInt:withNSString:withNSObjectArray:);
  ...
  static const void *ptrTable[] = { "LRetrofit2Retrofit;LJavaLangReflectMethod;", "()Lretrofit2/CallAdapter<TT;TR;>;", "parseMethodAnnotation", "LJavaLangAnnotationAnnotation;", "parseHttpMethodAndPath", "LNSString;LNSString;Z", "parseHeaders", "[LNSString;", "parseParameter", "ILJavaLangReflectType;[LJavaLangAnnotationAnnotation;", "(ILjava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;)Lretrofit2/ParameterHandler<*>;", "parseParameterAnnotation", "ILJavaLangReflectType;[LJavaLangAnnotationAnnotation;LJavaLangAnnotationAnnotation;", "(ILjava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;Ljava/lang/annotation/Annotation;)Lretrofit2/ParameterHandler<*>;", "validatePathName", "ILNSString;", "()Lretrofit2/Converter<Lokhttp3/ResponseBody;TT;>;", "methodError", "LNSString;[LNSObject;", "LNSException;LNSString;[LNSObject;", "parameterError", "LNSException;ILNSString;[LNSObject;", "ILNSString;[LNSObject;", "Ljava/util/Set<Ljava/lang/String;>;", "[Lretrofit2/ParameterHandler<*>;", "Lretrofit2/Converter<Lokhttp3/ResponseBody;TT;>;", "Lretrofit2/CallAdapter<TT;TR;>;", "LRetrofit2ServiceMethod;", "<T:Ljava/lang/Object;R:Ljava/lang/Object;>Ljava/lang/Object;" };
...
id<Retrofit2CallAdapter> Retrofit2ServiceMethod_Builder_createCallAdapter(Retrofit2ServiceMethod_Builder *self) {
  ...
  if (Retrofit2Utils_hasUnresolvableTypeWithJavaLangReflectType_(returnType)) {
    @throw Retrofit2ServiceMethod_Builder_methodErrorWithNSString_withNSObjectArray_(self, @"Method return type must not include a type variable or wildcard: %s", [IOSObjectArray arrayWithObjects:(id[]){ returnType } count:1 type:NSObject_class_()]);
  }
  if (returnType == (id) [IOSClass voidClass]) {
    @throw Retrofit2ServiceMethod_Builder_methodErrorWithNSString_withNSObjectArray_(self, @"Service methods cannot return void.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  }
  ...
  @catch (JavaLangRuntimeException *e) {
    @throw Retrofit2ServiceMethod_Builder_methodErrorWithNSException_withNSString_withNSObjectArray_(self, e, @"Unable to create call adapter for %s", [IOSObjectArray arrayWithObjects:(id[]){ returnType } count:1 type:NSObject_class_()]);
  }
}
...
void Retrofit2ServiceMethod_Builder_parseMethodAnnotationWithJavaLangAnnotationAnnotation_(Retrofit2ServiceMethod_Builder *self, id<JavaLangAnnotationAnnotation> annotation) {
  if ([Retrofit2HttpDELETE_class_() isInstance:annotation]) {
    ...
    if (![JavaLangVoid_class_() isEqual:self->responseType_]) {
      @throw Retrofit2ServiceMethod_Builder_methodErrorWithNSString_withNSObjectArray_(self, @"HEAD method must use Void as response type.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
  }
    ...
    if (((IOSObjectArray *) nil_chk(headersToParse))->size_ == 0) {
      @throw Retrofit2ServiceMethod_Builder_methodErrorWithNSString_withNSObjectArray_(self, @"@Headers annotation is empty.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    ...
    if (self->isFormEncoded_) {
      @throw Retrofit2ServiceMethod_Builder_methodErrorWithNSString_withNSObjectArray_(self, @"Only one encoding annotation is allowed.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
...
void Retrofit2ServiceMethod_Builder_parseHttpMethodAndPathWithNSString_withNSString_withBoolean_(Retrofit2ServiceMethod_Builder *self, NSString *httpMethod, NSString *value, jboolean hasBody) {
  if (self->httpMethod_ != nil) {
    @throw Retrofit2ServiceMethod_Builder_methodErrorWithNSString_withNSObjectArray_(self, @"Only one HTTP method is allowed. Found: %s and %s.", [IOSObjectArray arrayWithObjects:(id[]){ self->httpMethod_, httpMethod } count:2 type:NSObject_class_()]);
  }
  ...
  if (question != -1 && question < ((jint) [value length]) - 1) {
    ...
    if ([((JavaUtilRegexMatcher *) nil_chk(queryParamMatcher)) find]) {
      @throw Retrofit2ServiceMethod_Builder_methodErrorWithNSString_withNSObjectArray_(self, @"URL query string \"%s\" must not have replace block. For dynamic query parameters use @Query.", [IOSObjectArray arrayWithObjects:(id[]){ queryParams } count:1 type:NSObject_class_()]);
    }
  }
  ...
  Okhttp3Headers_Builder *builder = create_Okhttp3Headers_Builder_init();
  {
    ...
    while (b__ < e__) {
      ...
      if (colon == -1 || colon == 0 || colon == ((jint) [header length]) - 1) {
        @throw Retrofit2ServiceMethod_Builder_methodErrorWithNSString_withNSObjectArray_(self, @"@Headers value must be in the form \"Name: Value\". Found: \"%s\"", [IOSObjectArray arrayWithObjects:(id[]){ header } count:1 type:NSObject_class_()]);
      }
      ...
      if ([@"Content-Type" java_equalsIgnoreCase:headerName]) {
        ...
        if (type == nil) {
          @throw Retrofit2ServiceMethod_Builder_methodErrorWithNSString_withNSObjectArray_(self, @"Malformed content type: %s", [IOSObjectArray arrayWithObjects:(id[]){ headerValue } count:1 type:NSObject_class_()]);
        }
...
Retrofit2ParameterHandler *Retrofit2ServiceMethod_Builder_parseParameterWithInt_withJavaLangReflectType_withJavaLangAnnotationAnnotationArray_(Retrofit2ServiceMethod_Builder *self, jint p, id<JavaLangReflectType> parameterType, IOSObjectArray *annotations) {
  Retrofit2ParameterHandler *result = nil;
  {
    ...
    while (b__ < e__) {
      ...
      if (result != nil) {
        @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"Multiple Retrofit annotations found, only one allowed.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
      }
...
Retrofit2ParameterHandler *Retrofit2ServiceMethod_Builder_parseParameterAnnotationWithInt_withJavaLangReflectType_withJavaLangAnnotationAnnotationArray_withJavaLangAnnotationAnnotation_(Retrofit2ServiceMethod_Builder *self, jint p, id<JavaLangReflectType> type, IOSObjectArray *annotations, id<JavaLangAnnotationAnnotation> annotation) {
  if ([Retrofit2HttpUrl_class_() isInstance:annotation]) {
    if (self->gotUrl_) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"Multiple @Url method annotations found.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    if (self->gotPath_) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"@Path parameters may not be used with @Url.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    if (self->gotQuery_) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"A @Url parameter must not come after a @Query", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    if (self->relativeUrl_ != nil) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"@Url cannot be used with @%s URL", [IOSObjectArray arrayWithObjects:(id[]){ self->httpMethod_ } count:1 type:NSObject_class_()]);
    }
    self->gotUrl_ = true;
    if (type == (id) Okhttp3HttpUrl_class_() || type == (id) NSString_class_() || type == (id) JavaNetURI_class_() || ([type isKindOfClass:[IOSClass class]] && [@"android.net.Uri" isEqual:[((IOSClass *) nil_chk(((IOSClass *) cast_chk(type, [IOSClass class])))) getName]])) {
      ...
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"@Url must be okhttp3.HttpUrl, String, java.net.URI, or android.net.Uri type.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
  }
  else if ([Retrofit2HttpPath_class_() isInstance:annotation]) {
    if (self->gotQuery_) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"A @Path parameter must not come after a @Query.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    if (self->gotUrl_) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"@Path parameters may not be used with @Url.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    if (self->relativeUrl_ == nil) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"@Path can only be used with relative url on @%s", [IOSObjectArray arrayWithObjects:(id[]){ self->httpMethod_ } count:1 type:NSObject_class_()]);
    }
    self->gotPath_ = true;
    ...
    if ([JavaLangIterable_class_() isAssignableFrom:rawParameterType]) {
      if (!([JavaLangReflectParameterizedType_class_() isInstance:type])) {
        @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, JreStrcat("$$$$", [((IOSClass *) nil_chk(rawParameterType)) getSimpleName], @" must include generic type (e.g., ", [rawParameterType getSimpleName], @"<String>)"), [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
      }
    ...
    if (![JavaUtilMap_class_() isAssignableFrom:rawParameterType]) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"@QueryMap parameter type must be Map.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    ...
    if (!([JavaLangReflectParameterizedType_class_() isInstance:mapType])) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"Map must include generic types (e.g., Map<String, String>)", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    ...
    if (NSString_class_() != (id) keyType) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, JreStrcat("$@", @"@QueryMap keys must be of type String: ", keyType), [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    ...
    IOSClass *rawParameterType = Retrofit2Utils_getRawTypeWithJavaLangReflectType_(type);
    if (![JavaUtilMap_class_() isAssignableFrom:rawParameterType]) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"@HeaderMap parameter type must be Map.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    id<JavaLangReflectType> mapType = Retrofit2Utils_getSupertypeWithJavaLangReflectType_withIOSClass_withIOSClass_(type, rawParameterType, JavaUtilMap_class_());
    if (!([JavaLangReflectParameterizedType_class_() isInstance:mapType])) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"Map must include generic types (e.g., Map<String, String>)", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    ...
    id<JavaLangReflectType> keyType = Retrofit2Utils_getParameterUpperBoundWithInt_withJavaLangReflectParameterizedType_(0, parameterizedType);
    if (NSString_class_() != (id) keyType) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, JreStrcat("$@", @"@HeaderMap keys must be of type String: ", keyType), [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    id<JavaLangReflectType> valueType = Retrofit2Utils_getParameterUpperBoundWithInt_withJavaLangReflectParameterizedType_(1, parameterizedType);
    id<Retrofit2Converter> valueConverter = [((Retrofit2Retrofit *) nil_chk(self->retrofit_)) stringConverterWithJavaLangReflectType:valueType withJavaLangAnnotationAnnotationArray:annotations];
    ...
    if (!self->isFormEncoded_) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"@Field parameters can only be used with form encoding.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    ...
    if (!self->isFormEncoded_) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"@FieldMap parameters can only be used with form encoding.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    IOSClass *rawParameterType = Retrofit2Utils_getRawTypeWithJavaLangReflectType_(type);
    if (![JavaUtilMap_class_() isAssignableFrom:rawParameterType]) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"@FieldMap parameter type must be Map.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    id<JavaLangReflectType> mapType = Retrofit2Utils_getSupertypeWithJavaLangReflectType_withIOSClass_withIOSClass_(type, rawParameterType, JavaUtilMap_class_());
    if (!([JavaLangReflectParameterizedType_class_() isInstance:mapType])) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"Map must include generic types (e.g., Map<String, String>)", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    ...
    id<JavaLangReflectType> keyType = Retrofit2Utils_getParameterUpperBoundWithInt_withJavaLangReflectParameterizedType_(0, parameterizedType);
    if (NSString_class_() != (id) keyType) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, JreStrcat("$@", @"@FieldMap keys must be of type String: ", keyType), [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    id<JavaLangReflectType> valueType = Retrofit2Utils_getParameterUpperBoundWithInt_withJavaLangReflectParameterizedType_(1, parameterizedType);
    id<Retrofit2Converter> valueConverter = [((Retrofit2Retrofit *) nil_chk(self->retrofit_)) stringConverterWithJavaLangReflectType:valueType withJavaLangAnnotationAnnotationArray:annotations];
    self->gotField_ = true;
    ...
    if (!self->isMultipart_) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"@Part parameters can only be used with multipart encoding.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    ...
    if ([((NSString *) nil_chk(partName)) java_isEmpty]) {
      if ([JavaLangIterable_class_() isAssignableFrom:rawParameterType]) {
        ...
        if (![Okhttp3MultipartBody_Part_class_() isAssignableFrom:Retrofit2Utils_getRawTypeWithJavaLangReflectType_(iterableType)]) {
          @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"@Part annotation must supply a name or use MultipartBody.Part parameter type.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
        }
      ...
      if ([JavaLangIterable_class_() isAssignableFrom:rawParameterType]) {
        ...
        id<JavaLangReflectType> iterableType = Retrofit2Utils_getParameterUpperBoundWithInt_withJavaLangReflectParameterizedType_(0, parameterizedType);
        if ([Okhttp3MultipartBody_Part_class_() isAssignableFrom:Retrofit2Utils_getRawTypeWithJavaLangReflectType_(iterableType)]) {
          @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
        }
    ...
    if (!self->isMultipart_) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"@PartMap parameters can only be used with multipart encoding.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    self->gotPart_ = true;
    IOSClass *rawParameterType = Retrofit2Utils_getRawTypeWithJavaLangReflectType_(type);
    if (![JavaUtilMap_class_() isAssignableFrom:rawParameterType]) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"@PartMap parameter type must be Map.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    id<JavaLangReflectType> mapType = Retrofit2Utils_getSupertypeWithJavaLangReflectType_withIOSClass_withIOSClass_(type, rawParameterType, JavaUtilMap_class_());
    if (!([JavaLangReflectParameterizedType_class_() isInstance:mapType])) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"Map must include generic types (e.g., Map<String, String>)", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    ...
    id<JavaLangReflectType> keyType = Retrofit2Utils_getParameterUpperBoundWithInt_withJavaLangReflectParameterizedType_(0, parameterizedType);
    if (NSString_class_() != (id) keyType) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, JreStrcat("$@", @"@PartMap keys must be of type String: ", keyType), [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    id<JavaLangReflectType> valueType = Retrofit2Utils_getParameterUpperBoundWithInt_withJavaLangReflectParameterizedType_(1, parameterizedType);
    if ([Okhttp3MultipartBody_Part_class_() isAssignableFrom:Retrofit2Utils_getRawTypeWithJavaLangReflectType_(valueType)]) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"@PartMap values cannot be MultipartBody.Part. Use @Part List<Part> or a different value type instead.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    ...
    if (self->isFormEncoded_ || self->isMultipart_) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"@Body parameters cannot be used with form or multi-part encoding.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    if (self->gotBody_) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"Multiple @Body method annotations found.", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    }
    ...
    @catch (JavaLangRuntimeException *e) {
      @throw Retrofit2ServiceMethod_Builder_parameterErrorWithNSException_withInt_withNSString_withNSObjectArray_(self, e, p, @"Unable to create @Body converter for %s", [IOSObjectArray arrayWithObjects:(id[]){ type } count:1 type:NSObject_class_()]);
    }
    self->gotBody_ = true;
...
void Retrofit2ServiceMethod_Builder_validatePathNameWithInt_withNSString_(Retrofit2ServiceMethod_Builder *self, jint p, NSString *name) {
  if (![((JavaUtilRegexMatcher *) nil_chk([((JavaUtilRegexPattern *) nil_chk(JreLoadStatic(Retrofit2ServiceMethod, PARAM_NAME_REGEX))) matcherWithJavaLangCharSequence:name])) matches]) {
    @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"@Path parameter name must match %s. Found: %s", [IOSObjectArray arrayWithObjects:(id[]){ [((JavaUtilRegexPattern *) nil_chk(JreLoadStatic(Retrofit2ServiceMethod, PARAM_URL_REGEX))) pattern], name } count:2 type:NSObject_class_()]);
  }
  if (![((id<JavaUtilSet>) nil_chk(self->relativeUrlParamNames_)) containsWithId:name]) {
    @throw Retrofit2ServiceMethod_Builder_parameterErrorWithInt_withNSString_withNSObjectArray_(self, p, @"URL \"%s\" does not contain \"{%s}\".", [IOSObjectArray arrayWithObjects:(id[]){ self->relativeUrl_, name } count:2 type:NSObject_class_()]);
  }
}
...
id<Retrofit2Converter> Retrofit2ServiceMethod_Builder_createResponseConverter(Retrofit2ServiceMethod_Builder *self) {
  ...
  @catch (JavaLangRuntimeException *e) {
    @throw Retrofit2ServiceMethod_Builder_methodErrorWithNSException_withNSString_withNSObjectArray_(self, e, @"Unable to create converter for %s", [IOSObjectArray arrayWithObjects:(id[]){ self->responseType_ } count:1 type:NSObject_class_()]);
  }
}
...
JavaLangRuntimeException *Retrofit2ServiceMethod_Builder_methodErrorWithNSString_withNSObjectArray_(Retrofit2ServiceMethod_Builder *self, NSString *message, IOSObjectArray *args) {
  return Retrofit2ServiceMethod_Builder_methodErrorWithNSException_withNSString_withNSObjectArray_(self, nil, message, args);
}

JavaLangRuntimeException *Retrofit2ServiceMethod_Builder_methodErrorWithNSException_withNSString_withNSObjectArray_(Retrofit2ServiceMethod_Builder *self, NSException *cause, NSString *message, IOSObjectArray *args) {
  message = NSString_java_formatWithNSString_withNSObjectArray_(message, args);
  return create_JavaLangIllegalArgumentException_initWithNSString_withNSException_(JreStrcat("$$$C$", message, @"\n    for method ", [((IOSClass *) nil_chk([((JavaLangReflectMethod *) nil_chk(self->method_)) getDeclaringClass])) getSimpleName], '.', [self->method_ getName]), cause);
}

JavaLangRuntimeException *Retrofit2ServiceMethod_Builder_parameterErrorWithNSException_withInt_withNSString_withNSObjectArray_(Retrofit2ServiceMethod_Builder *self, NSException *cause, jint p, NSString *message, IOSObjectArray *args) {
  return Retrofit2ServiceMethod_Builder_methodErrorWithNSException_withNSString_withNSObjectArray_(self, cause, JreStrcat("$$IC", message, @" (parameter #", (p + 1), ')'), args);
}
