...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LNSObject;", 0x8, 26, 27, -1, 28, -1, -1 },
    { NULL, "Z", 0x8, 29, 30, -1, 31, -1, -1 },
    { NULL, "LOkhttp3ResponseBody;", 0x8, 32, 33, 34, -1, -1, -1 },
    { NULL, "V", 0x8, 35, 36, -1, 37, -1, -1 },
    { NULL, "LJavaLangReflectType;", 0x8, 38, 39, -1, -1, -1, -1 },
    { NULL, "Z", 0x8, 40, 1, -1, -1, -1, -1 },
    { NULL, "LJavaLangReflectType;", 0x8, 41, 1, -1, -1, -1, -1 },
  };
...
IOSClass *Retrofit2Utils_getRawTypeWithJavaLangReflectType_(id<JavaLangReflectType> type) {
  ...
  if (type == nil) @throw create_JavaLangNullPointerException_initWithNSString_(@"type == null");
  ...
  if ([JavaLangReflectParameterizedType_class_() isInstance:type]) {
    ...
    id<JavaLangReflectType> rawType = [parameterizedType getRawType];
  ...
  if ([JavaLangReflectGenericArrayType_class_() isInstance:type]) {
    id<JavaLangReflectType> componentType = [((id<JavaLangReflectGenericArrayType>) cast_check(type, JavaLangReflectGenericArrayType_class_())) getGenericComponentType];
  ...
  if ([JavaLangReflectWildcardType_class_() isInstance:type]) {
    return Retrofit2Utils_getRawTypeWithJavaLangReflectType_(IOSObjectArray_Get(nil_chk([((id<JavaLangReflectWildcardType>) cast_check(type, JavaLangReflectWildcardType_class_())) getUpperBounds]), 0));
  }
  @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@$$", @"Expected a Class, ParameterizedType, or GenericArrayType, but <", type, @"> is of type ", [[type java_getClass] getName]));
}
